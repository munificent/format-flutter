...
class _${blockName}DefaultsM3 extends InputDecorationTheme {
  ...
  BorderSide? get activeIndicatorBorder => MaterialStateBorderSide.resolveWith((Set<MaterialState> states) {
    ...
    if (states.contains(MaterialState.error)) {
      if (states.contains(MaterialState.hovered)) {
        return ${border(
        'md.comp.filled-text-field.error.hover.active-indicator',
      )};
      }
      if (states.contains(MaterialState.focused)) {
        return ${mergedBorder(
        'md.comp.filled-text-field.error.focus.active-indicator',
        'md.comp.filled-text-field.focus.active-indicator',
      )};
      }
  ...
  BorderSide? get outlineBorder => MaterialStateBorderSide.resolveWith((Set<MaterialState> states) {
    ...
    if (states.contains(MaterialState.error)) {
      ...
      if (states.contains(MaterialState.focused)) {
        ...
        'md.comp.outlined-text-field.focus.outline',
      )};
      }
  ...
  @override
  Color? get prefixIconColor => MaterialStateColor.resolveWith((Set<MaterialState> states) {${componentColor(
    ...
    if (states.contains(MaterialState.error)) {
      if (states.contains(MaterialState.hovered)) {
        return ${componentColor(
              'md.comp.filled-text-field.error.hover.leading-icon',
            )};
      }
      if (states.contains(MaterialState.focused)) {
        return ${componentColor(
              'md.comp.filled-text-field.error.focus.leading-icon',
            )};
      }
      return ${componentColor('md.comp.filled-text-field.error.leading-icon')};
    }'''}${componentColor('md.comp.filled-text-field.hover.leading-icon') == componentColor(
                'md.comp.filled-text-field.leading-icon',
              ) ? '' : '''
    if (states.contains(MaterialState.hovered)) {
      return ${componentColor('md.comp.filled-text-field.hover.leading-icon')};
    }'''}${componentColor('md.comp.filled-text-field.focus.leading-icon') == componentColor(
                'md.comp.filled-text-field.leading-icon',
              ) ? '' : '''
    if (states.contains(MaterialState.focused)) {
  ...
  Color? get suffixIconColor => MaterialStateColor.resolveWith((Set<MaterialState> states) {
    ...
    if (states.contains(MaterialState.error)) {${componentColor(
    ...
    }${componentColor('md.comp.filled-text-field.hover.trailing-icon') == componentColor(
                'md.comp.filled-text-field.trailing-icon',
              ) ? '' : '''
    if (states.contains(MaterialState.hovered)) {
      return ${componentColor('md.comp.filled-text-field.hover.trailing-icon')};
    }'''}${componentColor('md.comp.filled-text-field.focus.trailing-icon') == componentColor(
                'md.comp.filled-text-field.trailing-icon',
              ) ? '' : '''
    if (states.contains(MaterialState.focused)) {
  ...
  TextStyle? get helperStyle => MaterialStateTextStyle.resolveWith((Set<MaterialState> states) {
    ...
    }${componentColor('md.comp.filled-text-field.hover.supporting-text') == componentColor(
                'md.comp.filled-text-field.supporting-text',
              ) ? '' : '''
    if (states.contains(MaterialState.hovered)) {
      return textStyle.copyWith(color: ${componentColor(
    ...
    }'''}${componentColor('md.comp.filled-text-field.focus.supporting-text') == componentColor(
                'md.comp.filled-text-field.supporting-text',
              ) ? '' : '''
    if (states.contains(MaterialState.focused)) {
      return textStyle.copyWith(color: ${componentColor(
  ...
  TextStyle? get errorStyle => MaterialStateTextStyle.resolveWith((Set<MaterialState> states) {
    final TextStyle textStyle = ${textStyle(
        "md.comp.filled-text-field.supporting-text",
      )} ?? const TextStyle();${componentColor(
    ...
    }'''}${componentColor('md.comp.filled-text-field.error.focus.supporting-text') == componentColor(
                'md.comp.filled-text-field.error.supporting-text',
              ) ? '' : '''
    if (states.contains(MaterialState.focused)) {
      return textStyle.copyWith(color: ${componentColor(
