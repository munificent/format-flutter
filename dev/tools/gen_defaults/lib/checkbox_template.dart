...
class _${blockName}DefaultsM3 extends CheckboxThemeData {
    ...
    return MaterialStateBorderSide.resolveWith((Set<MaterialState> states) {
      if (states.contains(MaterialState.disabled)) {
        if (states.contains(MaterialState.selected)) {
          return const BorderSide(width: ${getToken(
        'md.comp.checkbox.unselected.disabled.outline.width',
      )}, color: Colors.transparent);
        }
        return BorderSide(width: ${getToken(
        'md.comp.checkbox.unselected.disabled.outline.width',
      )}, color: ${componentColor(
        'md.comp.checkbox.unselected.disabled.outline',
      )}.withOpacity(${getToken(
      ...
      if (states.contains(MaterialState.error)) {
        ...
        'md.comp.checkbox.unselected.error.outline',
      )});
      }
      if (states.contains(MaterialState.pressed)) {
        ...
        'md.comp.checkbox.unselected.pressed.outline',
      )});
      }
      if (states.contains(MaterialState.hovered)) {
        ...
        'md.comp.checkbox.unselected.hover.outline',
      )});
      }
      if (states.contains(MaterialState.focused)) {
        ...
        'md.comp.checkbox.unselected.focus.outline',
      )});
      }
      return BorderSide(width: ${getToken(
        'md.comp.checkbox.unselected.outline.width',
      )}, color: ${componentColor('md.comp.checkbox.unselected.outline')});
    });
  }
  ...
  MaterialStateProperty<Color> get fillColor {
    return MaterialStateProperty.resolveWith((Set<MaterialState> states) {
      if (states.contains(MaterialState.disabled)) {
        ...
        'md.comp.checkbox.selected.disabled.container',
      )};
        }
  ...
  MaterialStateProperty<Color> get overlayColor {
    return MaterialStateProperty.resolveWith((Set<MaterialState> states) {
      if (states.contains(MaterialState.error)) {
        if (states.contains(MaterialState.pressed)) {
          return ${componentColor(
        'md.comp.checkbox.error.pressed.state-layer',
      )};
        }
        if (states.contains(MaterialState.hovered)) {
      ...
      if (states.contains(MaterialState.selected)) {
        if (states.contains(MaterialState.pressed)) {
          return ${componentColor(
        'md.comp.checkbox.selected.pressed.state-layer',
      )};
        }
        if (states.contains(MaterialState.hovered)) {
          return ${componentColor(
        'md.comp.checkbox.selected.hover.state-layer',
      )};
        }
        if (states.contains(MaterialState.focused)) {
          return ${componentColor(
        'md.comp.checkbox.selected.focus.state-layer',
      )};
        }
        return Colors.transparent;
      }
      if (states.contains(MaterialState.pressed)) {
        return ${componentColor(
        'md.comp.checkbox.unselected.pressed.state-layer',
      )};
      }
      if (states.contains(MaterialState.hovered)) {
        return ${componentColor(
        'md.comp.checkbox.unselected.hover.state-layer',
      )};
      }
      if (states.contains(MaterialState.focused)) {
        return ${componentColor(
        'md.comp.checkbox.unselected.focus.state-layer',
      )};
      }
      return Colors.transparent;
    });
  ...
  @override
  double get splashRadius => ${getToken(
  ...
  OutlinedBorder get shape => const RoundedRectangleBorder(
    borderRadius: BorderRadius.all(Radius.circular(${getToken(
        'md.comp.checkbox.unselected.outline.width',
      )})),
  );
}
