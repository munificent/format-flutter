...
''';
  ...
  String _textTheme(String name, String baseline) {
    final StringBuffer theme = StringBuffer(
      'static const TextTheme $name = TextTheme(\n',
    );
    theme.writeln(
      '    displayLarge: ${_textStyleDef(
        'md.sys.typescale.display-large',
        '$name displayLarge 2021',
        baseline,
      )},',
    );
    theme.writeln(
      '    displayMedium: ${_textStyleDef(
        'md.sys.typescale.display-medium',
        '$name displayMedium 2021',
        baseline,
      )},',
    );
    theme.writeln(
      '    displaySmall: ${_textStyleDef(
        'md.sys.typescale.display-small',
        '$name displaySmall 2021',
        baseline,
      )},',
    );
    theme.writeln(
      '    headlineLarge: ${_textStyleDef(
        'md.sys.typescale.headline-large',
        '$name headlineLarge 2021',
        baseline,
      )},',
    );
    theme.writeln(
      '    headlineMedium: ${_textStyleDef(
        'md.sys.typescale.headline-medium',
        '$name headlineMedium 2021',
        baseline,
      )},',
    );
    theme.writeln(
      '    headlineSmall: ${_textStyleDef(
        'md.sys.typescale.headline-small',
        '$name headlineSmall 2021',
        baseline,
      )},',
    );
    theme.writeln(
      '    titleLarge: ${_textStyleDef(
        'md.sys.typescale.title-large',
        '$name titleLarge 2021',
        baseline,
      )},',
    );
    theme.writeln(
      '    titleMedium: ${_textStyleDef(
        'md.sys.typescale.title-medium',
        '$name titleMedium 2021',
        baseline,
      )},',
    );
    theme.writeln(
      '    titleSmall: ${_textStyleDef(
        'md.sys.typescale.title-small',
        '$name titleSmall 2021',
        baseline,
      )},',
    );
    theme.writeln(
      '    labelLarge: ${_textStyleDef(
        'md.sys.typescale.label-large',
        '$name labelLarge 2021',
        baseline,
      )},',
    );
    theme.writeln(
      '    labelMedium: ${_textStyleDef(
        'md.sys.typescale.label-medium',
        '$name labelMedium 2021',
        baseline,
      )},',
    );
    theme.writeln(
      '    labelSmall: ${_textStyleDef(
        'md.sys.typescale.label-small',
        '$name labelSmall 2021',
        baseline,
      )},',
    );
    theme.writeln(
      '    bodyLarge: ${_textStyleDef(
    ...
    theme.writeln(
      '    bodyMedium: ${_textStyleDef(
        'md.sys.typescale.body-medium',
        '$name bodyMedium 2021',
        baseline,
      )},',
    );
    theme.writeln(
      '    bodySmall: ${_textStyleDef(
