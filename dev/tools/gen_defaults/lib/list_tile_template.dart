...
class _${blockName}DefaultsM3 extends ListTileThemeData {
  ...
  @override
  TextStyle? get titleTextStyle => ${textStyle("$tokenGroup.label-text")}!.copyWith(color: ${componentColor(
        '$tokenGroup.label-text',
      )});

  @override
  TextStyle? get subtitleTextStyle => ${textStyle("$tokenGroup.supporting-text")}!.copyWith(color: ${componentColor(
  ...
  TextStyle? get leadingAndTrailingTextStyle => ${textStyle(
      ...
      )}!.copyWith(color: ${componentColor('$tokenGroup.trailing-supporting-text')});
