...
// END GENERATED TOKEN PROPERTIES''';
  ...
  Future<void> updateFile() async {
    ...
    if (beginPreviousBlock != -1) {
      ...
      contentAfterBlock = contents.substring(
        endPreviousBlock + endComment.length,
      );
    } else {
  ...
  /// See also:
  ///   * [componentColor], that provides support for an optional opacity.
  String? colorOrTransparent(String token) => color(
    token,
    'Colors.transparent',
  );
  ...
  String shape(String componentToken, [String prefix = 'const ']) {
    final Map<String, dynamic> shape = getToken(
      getToken('$componentToken.shape') as String,
