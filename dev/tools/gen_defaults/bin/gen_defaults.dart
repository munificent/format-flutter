...
Future<void> main(List<String> args) async {
  ...
  for (final FileSystemEntity tokenFile in Directory(dataDir).listSync()) {
    final Map<String, dynamic> tokenFileTokens = _readTokenFile(
      tokenFile as File,
    );
  ...
  final Map<String, dynamic> colorLightTokens = _readTokenFile(
    File('$dataDir/color_light.json'),
  );
  final Map<String, dynamic> colorDarkTokens = _readTokenFile(
    File('$dataDir/color_dark.json'),
  );
  ...
  BottomAppBarTemplate(
    'BottomAppBar',
    '$materialLib/bottom_app_bar.dart',
    tokens,
  ).updateFile();
  ...
  DatePickerTemplate(
    'DatePicker',
    '$materialLib/date_picker_theme.dart',
    tokens,
  ).updateFile();
  DialogFullscreenTemplate(
    'DialogFullscreen',
    '$materialLib/dialog.dart',
    tokens,
  ).updateFile();
  ...
  ExpansionTileTemplate(
    'ExpansionTile',
    '$materialLib/expansion_tile.dart',
    tokens,
  ).updateFile();
  ...
  NavigationBarTemplate(
    'NavigationBar',
    '$materialLib/navigation_bar.dart',
    tokens,
  ).updateFile();
  ...
  SurfaceTintTemplate(
    'SurfaceTint',
    '$materialLib/elevation_overlay.dart',
    tokens,
  ).updateFile();
