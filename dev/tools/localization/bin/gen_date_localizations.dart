...
Future<void> main(List<String> rawArgs) async {
  ...
  final List<Object?> packages =
      (json.decode(packageConfigFile.readAsStringSync()) as Map<String, Object?>)['packages']! as List<Object?>;
...
/// supported by flutter_localizations.''');
  ...
  if (writeToFile) {
    final File dateLocalizationsFile = File(
      path.join('packages', 'flutter_localizations', 'lib', 'src', 'l10n', 'generated_date_localizations.dart'),
    );
