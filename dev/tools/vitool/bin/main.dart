...
void main(List<String> args) {
  ...
  parser.addFlag('help', abbr: 'h', negatable: false, help: "Display the tool's usage instructions and quit.");
  ...
  final List<FrameData> frames = <FrameData>[for (final String filePath in argResults.rest) interpretSvg(filePath)];
