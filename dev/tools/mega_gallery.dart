...
void main(List<String> args) {
  ...
  final Directory source = Directory(
    _normalize('dev/integration_tests/flutter_gallery'),
  );
  ...
  print('Stats:');
  print(
    '  packages/flutter            : ${getStatsFor(Directory(
          "packages/flutter",
        ))}',
  );
  print(
    '  dev/integration_tests/flutter_gallery    : ${getStatsFor(Directory(
...
void _copyGallery(Directory galleryDir, int index) {
  ...
  _file(dest, 'main.dart').writeAsBytesSync(
    _file(lib, 'main.dart').readAsBytesSync(),
  );
}
...
Directory _dir(Directory parent, String name) => Directory(
