...
TaskFunction createGalleryTransitionHybridBuildTest(List<String> args, {bool semanticsEnabled = false}) {
  return GalleryTransitionBuildTest(
    args,
...
class GalleryTransitionTest {
  ...
  Future<TaskResult> call() async {
    ...
    final Map<String, dynamic> summary =
        json.decode(file('$testOutputDirectory/$timelineSummaryFile.json').readAsStringSync()) as Map<String, dynamic>;
...
class GalleryTransitionBuildTest extends BuildTestTask {
  ...
  void copyArtifacts() {
    ...
    if (deviceOperatingSystem == DeviceOperatingSystem.android) {
      ...
      recursiveCopy(Directory('${galleryDirectory.path}/build/ios/iphoneos'), Directory(applicationBinaryPath!));
    }
  }
