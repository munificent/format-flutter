...
''', flush: true);
      ...
      await pluginImplPubspec.writeAsString(
      ...
      await pluginInterfacePubspec.writeAsString(
      ...
      final File appPubspec = File(
        path.join(tempDir.absolute.path, 'app', 'pubspec.yaml'),
      );
      ...
      Future<void> waitOrExit(Future<void> future) async {
        final dynamic result =
            await Future.any<dynamic>(<Future<dynamic>>[future, run.exitCode]);
        if (result is int) {
