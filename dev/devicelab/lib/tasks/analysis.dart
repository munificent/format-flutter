...
Directory get _megaGalleryDirectory => dir(
  path.join(Directory.systemTemp.path, 'mega_gallery'),
);
...
Future<TaskResult> analyzerBenchmarkTask() async {
  ...
  final Map<String, dynamic> data = <String, dynamic>{
    ...
    ...(await _run(_FlutterRepoBenchmark(watch: true))).asMap(
      'flutter_repo',
      'watch',
    ),
    ...(await _run(_MegaGalleryBenchmark())).asMap('mega_gallery', 'batch'),
    ...(await _run(_MegaGalleryBenchmark(watch: true))).asMap(
      'mega_gallery',
      'watch',
    ),
  };
