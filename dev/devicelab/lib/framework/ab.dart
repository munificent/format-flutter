...
class ABTest {
  ...
  ABTest.fromJsonMap(Map<String, dynamic> jsonResults)
    : localEngine = jsonResults[kLocalEngineKeyName] as String,
      ...
      _aResults = _convertFrom(
        jsonResults[kAResultsKeyName] as Map<String, dynamic>,
      ),
      _bResults = _convertFrom(
        jsonResults[kBResultsKeyName] as Map<String, dynamic>,
      );
  ...
  Set<String> get _allScoreKeys {
    return <String>{..._aResults.keys, ..._bResults.keys};
  }
...
Map<String, _ScoreSummary> _summarize(Map<String, List<double>> results) {
  return results.map<String, _ScoreSummary>(
    (String scoreKey, List<double> values) {
