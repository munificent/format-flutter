...
Future<void> _runABTest({
  ...
  for (int i = 1; i <= runsPerTest; i++) {
    ...
    final TaskResult defaultEngineResult = await runTask(taskName, silent: silent, deviceId: deviceId);
...
ArgParser createArgParser(List<String> taskNames) {
  return ArgParser()
    ...
    ..addOption('service-account-token-file', help: '[Flutter infrastructure] Authentication for uploading results.')
