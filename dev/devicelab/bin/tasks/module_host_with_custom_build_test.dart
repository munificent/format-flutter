...
Future<void> main() async {
  await task(() async {
    ...
    try {
      ...
      mkdir(hostAppDir);
      recursiveCopy(Directory(
        path.join(flutterDirectory.path, 'dev', 'integration_tests', 'module_host_with_custom_build_v2_embedding'),
      ), hostAppDir);
      ...
      Future<void> clean() async {
        ...
        await inDirectory(hostAppDir, () async {
          await exec(gradlewExecutable, <String>['clean'], environment: <String, String>{'JAVA_HOME': javaHome});
        });
      }
      ...
      checkCollectionContains<String>(<String>[...flutterAssets, ...debugAssets], await getFilesInApk(demoDebugApk));
      ...
      checkCollectionContains<String>(<String>[...flutterAssets, ...debugAssets], await getFilesInApk(demoDebugApk2));
      ...
      checkCollectionContains<String>(<String>[...flutterAssets, ...debugAssets], await getFilesInApk(demoStagingApk));
