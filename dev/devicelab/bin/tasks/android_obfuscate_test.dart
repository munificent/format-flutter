  ...
  await task(() async {
    try {
      ...
      await runProjectTest((FlutterProject flutterProject) async {
        ...
        await inDirectory(flutterProject.rootPath, () async {
          ...
          final String response =
              await eval('grep', <String>[flutterProject.name, 'lib/armeabi-v7a/libapp.so'], canFail: true);
      ...
      await runModuleProjectTest((FlutterModuleProject flutterProject) async {
        ...
        checkCollectionContains<String>(<String>[...flutterAssets, 'jni/armeabi-v7a/libapp.so'], aarFiles);
        ...
        await inDirectory(flutterProject.rootPath, () async {
          ...
          final String response =
              await eval('grep', <String>[flutterProject.name, 'jni/armeabi-v7a/libapp.so'], canFail: true);
          if (response.trim().contains('matches')) {
