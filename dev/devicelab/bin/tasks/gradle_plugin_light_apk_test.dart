  ...
  await task(() async {
    try {
      ...
      await runProjectTest((FlutterProject project) async {
        ...
        final String? errorMessage = validateSnapshotDependency(
          project,
          'kernel_blob.bin',
        );
      ...
      await runProjectTest((FlutterProject project) async {
        ...
        final Directory pluginDir = Directory(
          path.join(tempDir.path, 'plugin_under_test'),
        );
