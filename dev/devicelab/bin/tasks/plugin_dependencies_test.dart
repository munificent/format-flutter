...
''', flush: true);
      ...
      final File pluginBKotlinClass = File(
        path.join(pluginBDirectory.path, 'android', 'src', 'main', 'kotlin', 'DummyPluginBClass.kt'),
      );
...
''', flush: true);
      ...
      final File pluginAKotlinClass = File(
        path.join(pluginADirectory.path, 'android', 'src', 'main', 'kotlin', 'DummyPluginAClass.kt'),
      );
...
''', flush: true);
      ...
      final File flutterPluginsDependenciesFile = File(path.join(exampleApp.path, '.flutter-plugins-dependencies'));
      ...
      final bool pluginAExampleApk = exists(File(
        path.join(pluginADirectory.path, 'example', 'build', 'app', 'outputs', 'apk', 'release', 'app-release.apk'),
      ));
