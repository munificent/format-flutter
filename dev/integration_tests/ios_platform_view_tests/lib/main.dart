        ...
        children: <Widget>[
          TextButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute<MergeThreadTestPage>(builder: (BuildContext context) => const MergeThreadTestPage()),
              );
            },
          ),
          ...
          TextButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute<FocusTestPage>(builder: (BuildContext context) => const FocusTestPage()),
              );
            },
          ),
          TextButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute<ZOrderTestPage>(builder: (BuildContext context) => const ZOrderTestPage()),
              );
            },
          ),
        ],
          ...
          children: <Widget>[
            Visibility(
              ...
              child: const SizedBox(
                width: 500,
                height: 500,
                child: UiKitView(viewType: 'platform_view', creationParamsCodec: StandardMessageCodec()),
              ),
            ),
            TextButton(
              onPressed: () {
                showDialog(
                  ...
                  builder: (BuildContext context) {
                    return const SizedBox(
                      width: 250,
                      height: 250,
                      child: UiKitView(viewType: 'platform_button', creationParamsCodec: StandardMessageCodec()),
                    );
                  },
                );
