...
void main() {
  ...
  test('fetchSpellCheckSuggestions returns null with no misspelled words', () async {
    ...
    expect(defaultSpellCheckService.lastSavedResults!.suggestionSpans, equals(spellCheckSuggestionSpans));
  });
  ...
  test('fetchSpellCheckSuggestions does not correct results when Gboard not ignoring composing region', () async {
  ...
  test('fetchSpellCheckSuggestions merges results when Gboard ignoring composing region', () async {
    ...
    defaultSpellCheckService.lastSavedResults = SpellCheckResults(text, modifiedSpellCheckSuggestionSpans);
