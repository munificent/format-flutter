...
Future<void> main() async {
  testWidgets(
    'Expansion panel demo: radio tile selection changes on tap',
...
Finder get _radioFinder => find.byWidgetPredicate(
  (Widget w) => w is Radio<Location>,
);

List<RadioListTile<Location>>
get _radioListTiles => List<RadioListTile<Location>>.from(
  _radioListTilesFinder.evaluate().map<Widget>((Element e) => e.widget),
);

Finder get _radioListTilesFinder => find.byWidgetPredicate(
