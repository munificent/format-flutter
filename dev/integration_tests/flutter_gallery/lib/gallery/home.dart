    ...
    return Center(
      child: Container(
        ...
        decoration: const BoxDecoration(
          image: DecorationImage(image: AssetImage('logos/flutter_white/logo.png', package: _kGalleryAssetsPackage)),
        ),
      ),
    );
  }
...
class _DemoItem extends StatelessWidget {
  ...
  void _launchDemo(BuildContext context) {
    if (demo != null) {
      Timeline.instantSync('Start Transition', arguments: <String, String>{'from': '/', 'to': demo!.routeName});
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(
                    demo!.title,
                    style:
                        theme.textTheme.titleMedium!.copyWith(color: isDark ? Colors.white : const Color(0xFF202124)),
                  ),
                  if (demo!.subtitle != null)
                    Text(
                      demo!.subtitle!,
                      style:
                          theme.textTheme.bodyMedium!.copyWith(color: isDark ? Colors.white : const Color(0xFF60646B)),
                    ),
                ],
              ),
            ),
