    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          ...
          Expanded(
            child: Container(
              decoration: const BoxDecoration(border: Border(bottom: BorderSide(color: Color(0xFFBCBBC1), width: 0.0))),
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Icon(CupertinoIcons.info, color: CupertinoTheme.of(context).primaryColor),
                  ),
                ],
              ),
            ),
