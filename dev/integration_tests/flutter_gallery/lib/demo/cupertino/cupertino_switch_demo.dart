            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Semantics(
                  container: true,
                  child: const Column(
                    children: <Widget>[CupertinoSwitch(value: true, onChanged: null), Text('Disabled - On')],
                  ),
                ),
                Semantics(
                  container: true,
                  child: const Column(
                    children: <Widget>[CupertinoSwitch(value: false, onChanged: null), Text('Disabled - Off')],
                  ),
                ),
              ],
            ),
