        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            if (icon != null)
              SizedBox(
                width: 72.0,
                child: IconButton(icon: Icon(icon), color: themeData.primaryColor, onPressed: onPressed),
              ),
          ],
        ),
      ),
...
class ContactsDemoState extends State<ContactsDemo> {
  ...
  Widget build(BuildContext context) {
    return Theme(
      data: ThemeData(brightness: Brightness.light, primarySwatch: Colors.indigo, platform: Theme.of(context).platform),
      child: Scaffold(
              ...
              delegate: SliverChildListDelegate(<Widget>[
                  ...
                  child: _ContactCategory(
                    ...
                    children: <Widget>[
                      ...
                      _ContactItem(
                        ...
                        onPressed: () {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(content: Text('A messaging app appears.')),
                          );
                        },
                ...
                _ContactCategory(
                  ...
                  children: <Widget>[
                    _ContactItem(
                      ...
                      onPressed: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('Here, your e-mail application would open.')),
                        );
                      },
                    ...
                    _ContactItem(
                      ...
                      onPressed: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('Summon your favorite e-mail application here.')),
                        );
                      },
                ...
                _ContactCategory(
                  ...
                  children: <Widget>[
                    ...
                    _ContactItem(
                      ...
                      lines: const <String>['1600 Amphitheater Parkway', 'Mountain View, CA', 'Work'],
                    ),
                    _ContactItem(
                      icon: Icons.map,
                      tooltip: 'Open map',
                ...
                _ContactCategory(
                  ...
                  children: <Widget>[
                    ...
                    _ContactItem(lines: const <String>['First day in office', 'January 20th, 2015']),
