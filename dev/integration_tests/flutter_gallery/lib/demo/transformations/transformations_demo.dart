...
class _TransformationsDemoState extends State<TransformationsDemo> {
  ...
  bool _reset = false;
  Board _board = Board(boardRadius: _kBoardRadius, hexagonRadius: _kHexagonRadius, hexagonMargin: _kHexagonMargin);
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(
            ...
            tooltip: 'Help',
            onPressed: () {
              showDialog<Column>(context: context, builder: (BuildContext context) => instructionDialog);
            },
          ),
        ],
      ),
      body: LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          ...
          return GestureTransformable(
            ...
            boundaryRect:
                Rect.fromLTWH(-visibleSize.width / 2, -visibleSize.height / 2, visibleSize.width, visibleSize.height),
