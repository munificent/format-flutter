...
class _GestureTransformableState extends State<GestureTransformable> with TickerProviderStateMixin {
    ...
    return GestureDetector(
      ...
      onTapDown: widget.onTapDown == null
          ...
          : (TapDownDetails details) {
              widget.onTapDown!(
                TapDownDetails(globalPosition: fromViewport(details.globalPosition - getOffset(context), _transform)),
              );
            },
      ...
      onVerticalDragDown: widget.onVerticalDragDown == null
          ...
          : (DragDownDetails details) {
              widget.onVerticalDragDown!(
                DragDownDetails(globalPosition: fromViewport(details.globalPosition - getOffset(context), _transform)),
              );
            },
      onVerticalDragStart: widget.onVerticalDragStart == null
          ...
          : (DragStartDetails details) {
              widget.onVerticalDragStart!(
                DragStartDetails(globalPosition: fromViewport(details.globalPosition - getOffset(context), _transform)),
              );
            },
      ...
      child: ClipRect(
        ...
        child: Transform(
          ...
          child: SizedBox(height: widget.size.height, width: widget.size.width, child: widget.child),
        ),
      ),
    );
  }
  ...
  Matrix4 matrixTranslate(Matrix4 matrix, Offset? translation) {
    ...
    final bool inBoundaries = translationBoundaries.contains(Offset(nextTranslation.dx, nextTranslation.dy));
    if (!inBoundaries) {
      return matrix;
    }
  ...
  void _animateResetInitialize() {
    _controllerReset.reset();
    _animationReset = Matrix4Tween(begin: _transform, end: _initialTransform).animate(_controllerReset);
