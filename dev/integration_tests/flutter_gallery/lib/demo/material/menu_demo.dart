          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              trailing: PopupMenuButton<String>(
                ...
                onSelected: showMenuSelection,
                itemBuilder: (BuildContext context) => <PopupMenuItem<String>>[
                      PopupMenuItem<String>(value: _simpleValue1, child: const Text('Context menu item one')),
                      const PopupMenuItem<String>(enabled: false, child: Text('A disabled menu item')),
                      PopupMenuItem<String>(value: _simpleValue3, child: const Text('Context menu item three')),
                    ],
              ),
            ),
            // Pressing the PopupMenuButton on the right of this item shows
            ...
            PopupMenuButton<String>(
              ...
              onSelected: showMenuSelection,
              child: ListTile(title: const Text('An item with a simple menu'), subtitle: Text(_simpleValue!)),
              itemBuilder: (BuildContext context) => <PopupMenuItem<String>>[
