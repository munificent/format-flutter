                    ...
                    children: <Widget>[
                      ...
                      Align(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child:
                              Icon(Icons.check_circle, color: _isSelected ? colorScheme.primary : Colors.transparent),
                        ),
                      ),
                    ],
                  ),
...
class SectionTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child:
          Align(alignment: Alignment.centerLeft, child: Text(title!, style: Theme.of(context).textTheme.titleMedium)),
    );
  }
}
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text(destination.description, style: descriptionStyle.copyWith(color: Colors.black54)),
                ),
      ...
      body: Scrollbar(
        child: ListView(
          ...
          children: destinations.map<Widget>((TravelDestination destination) {
            ...
            return Container(margin: const EdgeInsets.only(bottom: 8.0), child: child);
          }).toList(),
        ),
      ),
    );
