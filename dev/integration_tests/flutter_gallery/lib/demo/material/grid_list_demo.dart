      ...
      child: ClipRect(
        child: Transform(
          transform: Matrix4.identity()
            ...
            ..scale(_scale),
          child: Image.asset(widget.photo!.assetName!, package: widget.photo!.assetPackage, fit: BoxFit.cover),
        ),
      ),
    );
  }
    ...
    Navigator.push(context, MaterialPageRoute<void>(
      builder: (BuildContext context) {
        return Scaffold(
          ...
          body: SizedBox.expand(child: Hero(tag: photo.tag!, child: GridPhotoViewer(photo: photo))),
        );
      },
    ));
  }
        ...
        actions: <Widget>[
          ...
          PopupMenuButton<GridDemoTileStyle>(
            ...
            itemBuilder: (BuildContext context) => <PopupMenuItem<GridDemoTileStyle>>[
                  const PopupMenuItem<GridDemoTileStyle>(value: GridDemoTileStyle.imageOnly, child: Text('Image only')),
                  const PopupMenuItem<GridDemoTileStyle>(value: GridDemoTileStyle.oneLine, child: Text('One line')),
                  const PopupMenuItem<GridDemoTileStyle>(value: GridDemoTileStyle.twoLine, child: Text('Two line')),
                ],
          ),
        ],
      ),
