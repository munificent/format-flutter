      ...
      body: ListView(
        ...
        children: <Widget>[
                  ...
                  showDemoDialog<String>(
                    ...
                    child: SimpleDialog(
                      ...
                      children: <Widget>[
                        ...
                        DialogDemoItem(icon: Icons.add_circle, text: 'add account', color: theme.disabledColor),
                      ],
                    ),
                  );
                },
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  showTimePicker(context: context, initialTime: _selectedTime!).then((TimeOfDay? value) {
