    ...
    return Semantics(
      ...
      child: Dismissible(
        ...
        background: ColoredBox(
          ...
          child: const Center(child: ListTile(leading: Icon(Icons.delete, color: Colors.white, size: 36.0))),
        ),
        secondaryBackground: ColoredBox(
          color: theme.primaryColor,
          child: const Center(child: ListTile(trailing: Icon(Icons.archive, color: Colors.white, size: 36.0))),
        ),
        child: Container(
          decoration:
