...
Future<void> setClipboard(String message) async {
  ...
  Future<void> completeSetClipboard([Object? _]) async {
    await kSemanticsChannel.invokeMethod<dynamic>(
      'setClipboard',
  ...
  group('AccessibilityBridge', () {
    ...
    group('SelectionControls', () {
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          final Finder checkbox = find.byKey(
            const ValueKey<String>(checkboxKeyValue),
          );
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          final Finder switchFinder = find.byKey(
            const ValueKey<String>(switchKeyValue),
          );
      ...
      testWidgets('Switch can be labeled', (WidgetTester tester) async {
        final Finder switchFinder = find.byKey(
          const ValueKey<String>(labeledSwitchKeyValue),
        );
    ...
    group('Popup Controls', () {
      ...
      testWidgets('Popup Menu has correct Android semantics', (
        ...
        final Finder popupButton = find.byKey(
          const ValueKey<String>(popupButtonKeyValue),
        );
        ...
        try {
          for (final String item in popupItems) {
            expect(
              await getSemantics(
                find.byKey(ValueKey<String>('$popupKeyValue.$item')),
                tester,
              ),
              hasAndroidSemantics(
                className: AndroidClassName.button,
          ...
          await tester.tap(
            find.byKey(ValueKey<String>('$popupKeyValue.${popupItems.first}')),
          );
          await tester.pumpAndSettle();
      ...
      testWidgets('Dropdown Menu has correct Android semantics', (
        ...
        final Finder dropdownButton = find.byKey(
          const ValueKey<String>(dropdownButtonKeyValue),
        );
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          final Finder alertButton = find.byKey(
            const ValueKey<String>(alertButtonKeyValue),
          );
          ...
          try {
            ...
            for (final String item in <String>['Title', 'Body1', 'Body2']) {
              expect(
                await getSemantics(
                  find.byKey(ValueKey<String>('$alertKeyValue.$item')),
                  tester,
                ),
                hasAndroidSemantics(
                  className: AndroidClassName.view,
    ...
    group('Headings', () {
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          expect(
            await getSemantics(
              find.byKey(const ValueKey<String>(appBarTitleKeyValue)),
              tester,
            ),
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          expect(
            await getSemantics(
              find.byKey(const ValueKey<String>(bodyTextKeyValue)),
              tester,
            ),
