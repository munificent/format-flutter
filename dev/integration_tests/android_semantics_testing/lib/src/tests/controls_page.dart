...
class _SelectionControlsPageState extends State<SelectionControlsPage> {
  static const ValueKey<String> checkbox1Key = ValueKey<String>(
    checkboxKeyValue,
  );
  static const ValueKey<String> checkbox2Key = ValueKey<String>(
    disabledCheckboxKeyValue,
  );
  ...
  static const ValueKey<String> labeledSwitchKey = ValueKey<String>(
