  ...
  group(
    ...
    () {
      ...
      test('creates state file if provided correct inputs', () async {
          ...
          FakeCommand(
            ...
            onRun: () {
              ...
              depsFile.writeAsStringSync(
                generateMockDeps(previousDartRevision),
              );
            },
          ),
          const FakeCommand(
        ...
        expect(stdio.error, isNot(
          contains('Tried to tag the branch point, however the target version'),
        ));
      ...
      test(
        ...
        () async {
          ...
          expect(
            (await startContext.engine.checkoutDirectory).path,
            equals(engine.path),
          );
          expect(
            (await startContext.framework.checkoutDirectory).path,
