...
void main() {
  test(
    ...
    () async {
      ...
      final Directory flutterRoot = _flutterRootFromDartBinary(fileSystem.file(platform.executable));
      ...
      runner.addCommand(CodesignCommand(checkouts: checkouts, framework: framework, flutterRoot: flutterRoot));
