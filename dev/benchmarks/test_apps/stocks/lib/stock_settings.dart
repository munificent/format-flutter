  ...
  Widget buildSettingsPane(BuildContext context) {
    final List<Widget> rows = <Widget>[
      ...
      ListTile(
        ...
        trailing: Switch(value: widget.configuration.backupMode == BackupMode.enabled, onChanged: _handleBackupChanged),
      ),
      ListTile(
        ...
        trailing:
            Switch(value: widget.configuration.showPerformanceOverlay, onChanged: _handleShowPerformanceOverlayChanged),
      ),
      ListTile(
        ...
        trailing:
            Switch(value: widget.configuration.showSemanticsDebugger, onChanged: _handleShowSemanticsDebuggerChanged),
      ),
    ];
    assert(
      () {
        ...
        rows.addAll(<Widget>[
          ListTile(
            ...
            trailing: Switch(value: widget.configuration.debugShowGrid, onChanged: _handleShowGridChanged),
          ),
          ListTile(
            ...
            trailing: Switch(value: widget.configuration.debugShowSizes, onChanged: _handleShowSizesChanged),
          ),
          ListTile(
            ...
            trailing: Switch(value: widget.configuration.debugShowBaselines, onChanged: _handleShowBaselinesChanged),
          ),
          ListTile(
            ...
            trailing: Switch(value: widget.configuration.debugShowLayers, onChanged: _handleShowLayersChanged),
          ),
          ListTile(
            ...
            trailing: Switch(value: widget.configuration.debugShowPointers, onChanged: _handleShowPointersChanged),
          ),
          ListTile(
            ...
            trailing: Switch(value: widget.configuration.debugShowRainbow, onChanged: _handleShowRainbowChanged),
          ),
        ]);
        return true;
      }(),
