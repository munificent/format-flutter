        ...
        Column(
          ...
          children: List<Widget>.generate(
            ...
            (int r) => Row(
              ...
              children: List<Widget>.generate(
                cols,
                (int c) => Container(decoration: decoration, child: Text('text', style: TextStyle(fontSize: fontSize))),
              ),
            ),
          ),
        ),
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                ...
                Checkbox(value: _complexChild, onChanged: (bool? b) => setState(() => _complexChild = b ?? false)),
