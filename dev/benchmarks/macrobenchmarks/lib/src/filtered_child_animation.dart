...
class _FilteredChildAnimationPageState extends State<FilteredChildAnimationPage>
  ...
  static Widget _makeChild(int rows, int cols, double fontSize, bool complex) {
    final BoxDecoration decoration = BoxDecoration(
      color: Colors.green,
      boxShadow:
          complex ? <BoxShadow>[const BoxShadow(blurRadius: 10.0)] : null,
            ...
            Row(
              ...
              children: <Widget>[
                ...
                Checkbox(
                  ...
                  onChanged: (bool? b) => _setFilterType(
                        FilterType.opacity,
                        b ?? false,
                      ),
                ),
