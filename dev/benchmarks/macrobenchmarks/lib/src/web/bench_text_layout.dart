...
class ParagraphGenerator {
  ...
  ui.Paragraph generate(String text, {int? maxLines, bool hasEllipsis = false}) {
    final ui.ParagraphBuilder builder = ui.ParagraphBuilder(
      ui.ParagraphStyle(fontFamily: 'sans-serif', maxLines: maxLines, ellipsis: hasEllipsis ? '...' : null),
    )
...
class BenchBuildColorsGrid extends WidgetBuildRecorder {
  BenchBuildColorsGrid.canvas() : _mode = _TestMode.useCanvasTextLayout, super(name: canvasBenchmarkName);

  BenchBuildColorsGrid.canvasKit() : _mode = _TestMode.useCanvasKit, super(name: canvasKitBenchmarkName);
  ...
  void frameDidDraw() {
    ...
    if (showWidget && _mode != _TestMode.useCanvasKit) {
      profile!.addDataPoint('text_layout', Duration(microseconds: _textLayoutMicros.toInt()), reported: true);
    }
    super.frameDidDraw();
  }
