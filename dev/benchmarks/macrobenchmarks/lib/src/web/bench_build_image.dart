...
class _RotatingWidgetState extends State<_RotatingWidget> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    controller = AnimationController(duration: const Duration(milliseconds: 200), vsync: this)..repeat();
  }
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget? child) {
        return Transform(transform: Matrix4.identity()..rotateZ(2 * math.pi * controller.value), child: widget.child);
      },
    );
  }
}
