  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        ...
        body: Row(
          children: <Widget>[
            Expanded(child: FirstComponentList(showNavBottomBar: true, scaffoldKey: scaffoldKey, showSecondList: true)),
      ...
      child: IntrinsicWidth(
        child: Column(
          ...
          children: <Widget>[
            ...
            colDivider,
            FilledButton.tonal(onPressed: isDisabled ? null : () {}, child: const Text('Filled tonal')),
            colDivider,
          ...
          SizedBox(
            ...
            child: Scaffold(
              floatingActionButton:
                  FloatingActionButton(onPressed: () {}, elevation: 0.0, child: const Icon(Icons.add)),
    ...
    return ComponentDecoration(
      ...
      child: Column(
        children: <Widget>[
          ...
          colDivider,
          AppBar(title: const Text('Small'), leading: const BackButton(), actions: actions, centerTitle: false),
          colDivider,
          SizedBox(
            height: 100,
    ...
    return FocusTraversalGroup(
      child: Card(
        ...
        child: Padding(
          ...
          child: Center(
            child: Column(
              children: <Widget>[Text(label, style: Theme.of(context).textTheme.titleLarge), colDivider, ...children],
            ),
          ),
        ),
      ),
