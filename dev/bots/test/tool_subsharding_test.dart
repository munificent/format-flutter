...
void main() {
  group('generateMetrics', () {
    ...
    test('empty metrics', () async {
      ...
      final TestFileReporterResults result = TestFileReporterResults.fromFile(
        file,
      );
    ...
    test('has failed stack traces', () async {
      ...
      expect(
        result.errors[0].contains('Expected: <true>  Actual: <false>'),
        true,
      );
      expect(
        result.errors[1].contains('Expected: <false>  Actual: <true>'),
        true,
      );
