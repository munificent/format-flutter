  ...
  Widget buildDrawerColorRadioItem(
    ...
    return ListTile(
      ...
      onTap: enabled
          ...
          : null,
      trailing: Radio<MaterialColor>(value: itemValue, groupValue: currentValue, onChanged: enabled ? onChanged : null),
    );
  }
  ...
  Widget buildDrawerDirectionRadioItem(
    ...
    return ListTile(
      ...
      onTap: enabled
          ...
          : null,
      trailing:
          Radio<DismissDirection>(value: itemValue, groupValue: currentValue, onChanged: enabled ? onChanged : null),
    );
  }
  ...
  Widget buildFontRadioItem(
    ...
    return ListTile(
      ...
      onTap: enabled
          ...
          : null,
      trailing: Radio<TextAlign>(value: itemValue, groupValue: currentValue, onChanged: enabled ? onChanged : null),
    );
  }
    ...
    final Widget card = Dismissible(
      ...
      child: Card(
        ...
        child: Container(
          ...
          child: _editable
              ? Center(child: TextField(key: GlobalObjectKey(cardModel), controller: cardModel.textController))
        ...
        child: SingleChildScrollView(
          child: Container(
            ...
            child: Row(
              children: <Widget>[
                leftArrowIcon,
                Expanded(child: Text(backgroundMessage, style: backgroundTextStyle, textAlign: TextAlign.center)),
                rightArrowIcon,
              ],
            ),
          ),
