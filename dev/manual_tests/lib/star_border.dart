                ...
                children: <Widget>[
                  Container(
                    ...
                    decoration: ShapeDecoration(
                      ...
                      shape: lerpBorder(StarBorder.polygon(
                      ...
                      ), _model._lerpTarget, _model._lerpAmount, to: _model.lerpTo)!,
                    ),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          Text(label),
          Expanded(
            child: Slider(label: value.toStringAsFixed(1), onChanged: onChanged, min: min, max: max, value: value),
          ),
    ...
    case LerpTarget.roundedRect:
      if (to) {
        return border.lerpTo(
          const RoundedRectangleBorder(side: lerpToBorder, borderRadius: BorderRadius.all(Radius.circular(10))),
          t,
        );
      } else {
