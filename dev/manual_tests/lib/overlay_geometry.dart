...
class Marker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Positioned(
      ...
      height: size,
      child: IgnorePointer(
        child: CustomPaint(painter: _MarkerPainter(size: size, type: type)),
      ),
    );
  }
}
...
class OverlayGeometryAppState extends State<OverlayGeometryApp> {
  ...
  void handleTapUp(GlobalKey target, Offset globalPosition) {
    setState(() {
      ...
      markers[MarkerType.bottomRight] = box.localToGlobal(
          ...
          body: Container(
            ...
            child: NotificationListener<ScrollNotification>(
              ...
              child: ListView.custom(
                childrenDelegate:
                    CardBuilder(cardModels: cardModels, onTapUp: handleTapUp),
              ),
            ),
          ),
        ),
