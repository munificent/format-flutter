...
final MaterialColor m2Swatch = MaterialColor(
  m2SwatchColors[500]!.value,
  m2SwatchColors,
);
                      ...
                      Expanded(
                        child: SliderTheme(
                          ...
                          child: Slider(
                            ...
                            onChanged: (double value) {
                              widget.model.density = widget.model.density
                                  .copyWith(
                                    horizontal: value,
                    ...
                    children: <Widget>[
                      ...
                      Expanded(
                        child: SliderTheme(
                          data: controlTheme,
                          child: Slider(
                            label: widget.model.density.vertical
                                .toStringAsFixed(1),
                            min: VisualDensity.minimumDensity,
                            max: VisualDensity.maximumDensity,
                            onChanged: (double value) {
          ...
          body: DefaultTextStyle(
            ...
            child: Theme(
              ...
              child: Directionality(
                textDirection: _model.rtl
                    ? TextDirection.rtl
                    : TextDirection.ltr,
                child: MediaQuery(
                  data: MediaQuery.of(context).copyWith(
                    textScaleFactor: _model.size,
                  ),
