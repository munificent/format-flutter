    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          const GradientRow(
            leftColor: Color(0xFFFF0000),
            rightColor: Color(0xFF00FF00),
          ),
          const GradientRow(
            leftColor: Color(0xFF0000FF),
            rightColor: Color(0xFFFFFF00),
          ),
          const GradientRow(
            leftColor: Color(0xFFFF0000),
            rightColor: Color(0xFF0000FF),
          ),
          const GradientRow(
            leftColor: Color(0xFF00FF00),
            rightColor: Color(0xFFFFFF00),
          ),
          const GradientRow(
            leftColor: Color(0xFF0000FF),
