...
Future<void> main(List<String> args) async {
  ...
  final Snapshot snapshot = Snapshot.fromJson(
  ...
  for (final String forbiddenType in options.forbiddenTypes) {
    ...
    if (!await validateType(forbiddenType, options.packageConfig)) {
      foundForbiddenTypes.add(
        'Forbidden type "$forbiddenType" does not seem to exist.',
      );
      continue;
    }
...
Future<bool> validateType(String forbiddenType, File packageConfigFile) async {
  ...
  final Uri packageUri = Uri.parse(
    forbiddenType.substring(0, forbiddenType.indexOf('::')),
  );
  final String typeName = forbiddenType.substring(
    forbiddenType.indexOf('::') + 2,
  );
