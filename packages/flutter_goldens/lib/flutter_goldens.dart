...
Future<void> testExecutable(
  ...
  if (FlutterPostSubmitFileComparator.isAvailableForEnvironment(platform)) {
    goldenFileComparator =
        await FlutterPostSubmitFileComparator.fromDefaultComparator(
      platform,
    ...
    goldenFileComparator =
        await FlutterPreSubmitFileComparator.fromDefaultComparator(
      platform,
      namePrefix: namePrefix,
    );
...
abstract class FlutterGoldenFileComparator extends GoldenFileComparator {
  ...
  static Directory getBaseDirectory(
    ...
    final Directory flutterRoot = fs.directory(
      platform.environment[_kFlutterRootKey],
    );
    ...
    if (suffix != null) {
      ...
      comparisonRoot = flutterRoot.childDirectory(
        fs.path.join('bin', 'cache', 'pkg', 'skia_goldens'),
      );
    }
...
class FlutterPostSubmitFileComparator extends FlutterGoldenFileComparator {
  ...
  static bool isAvailableForEnvironment(Platform platform) {
    final bool
    luciPostSubmit = platform.environment.containsKey('SWARMING_TASK_ID') &&
