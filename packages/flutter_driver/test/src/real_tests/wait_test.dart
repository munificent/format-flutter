...
void main() {
  group('WaitForCondition', () {
    ...
    test('WaitForCondition deserialize', () {
      ...
      final WaitForCondition waitForCondition = WaitForCondition.deserialize(
        jsonMap,
      );
  ...
  group('NoTransientCallbacksCondition', () {
    ...
    test('NoTransientCallbacksCondition deserialize', () {
      ...
      final NoTransientCallbacks condition = NoTransientCallbacks.deserialize(
        jsonMap,
      );
    ...
    test('NoTransientCallbacksCondition deserialize error', () {
      expect(
        () => NoTransientCallbacks.deserialize(<String, String>{
  ...
  group('NoPendingFrameCondition', () {
    ...
    test('NoPendingFrameCondition deserialize error', () {
      expect(
        () => NoPendingFrame.deserialize(<String, String>{
          'conditionName': 'Unknown',
        }),
        throwsA(predicate<SerializationException>(
          (SerializationException e) =>
  ...
  group('FirstFrameRasterizedCondition', () {
    ...
    test('FirstFrameRasterizedCondition deserialize', () {
      ...
      final FirstFrameRasterized condition = FirstFrameRasterized.deserialize(
        jsonMap,
      );
    ...
    test('FirstFrameRasterizedCondition deserialize error', () {
      expect(
        () => FirstFrameRasterized.deserialize(<String, String>{
          'conditionName': 'Unknown',
        }),
        throwsA(predicate<SerializationException>(
          (SerializationException e) =>
  ...
  group('CombinedCondition', () {
    test('CombinedCondition serialize', () {
      const CombinedCondition combinedCondition = CombinedCondition(
    ...
    test('CombinedCondition deserialize - empty condition list', () {
      ...
      final CombinedCondition condition = CombinedCondition.deserialize(
        jsonMap,
      );
    ...
    test('CombinedCondition deserialize - no condition list', () {
      final CombinedCondition condition = CombinedCondition.deserialize(
        <String, String>{'conditionName': 'CombinedCondition'},
      );
      expect(condition.conditions, equals(<SerializableWaitCondition>[]));
