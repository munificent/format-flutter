...
class VMServiceFlutterDriver extends FlutterDriver {
  ...
  VMServiceFlutterDriver.connectedTo(
    ...
    _logFilePathName = p.join(
      testOutputsDirectory,
      'flutter_driver_commands_$_driverId.log',
    );
  }
  ...
  static Future<FlutterDriver> connect({
    ...
    Future<void> waitForServiceExtension() async {
      ...
      isolateAddedSubscription = client.onIsolateEvent.listen((vms.Event data) {
      ...
      }, onError: extensionAdded.completeError, cancelOnError: true);
...
''';
  ...
  Future<void> forceGC() async {
    try {
      await _serviceClient.callMethod(
