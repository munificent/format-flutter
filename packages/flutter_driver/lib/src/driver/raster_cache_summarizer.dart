...
class RasterCacheSummarizer {
  ...
  double computePercentileLayerCount(double percentile) => _computePercentile(
    _layerCounts,
    percentile,
  );

  /// The [percentile]-th percentile `LayerMemory` over the cache events.
  double computePercentileLayerMemory(double percentile) => _computePercentile(
    _layerMemories,
    percentile,
  );

  /// The [percentile]-th percentile `PictureCount` over the cache events.
  double computePercentilePictureCount(double percentile) => _computePercentile(
    _pictureCounts,
    percentile,
  );

  /// The [percentile]-th percentile `PictureMemory` over the cache events.
  double computePercentilePictureMemory(
    double percentile,
