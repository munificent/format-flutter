...
void main() {
  group('TestDisplay', () {
    ...
    testWidgets(
      'resetting devicePixelRatio also resets view.devicePixelRatio',
      (WidgetTester tester) async {
        verifyPropertyReset(
          tester: tester,
          fakeValue: trueDisplay().devicePixelRatio + 1,
    ...
    testWidgets(
      'updating devicePixelRatio also updates view.devicePixelRatio',
      (WidgetTester tester) async {
...
Matcher matchesSnapshot(DisplaySnapshot expected) => _DisplaySnapshotMatcher(
  expected,
);
