...
void main() {
  ...
  testWidgets(
    'localToGlobal and globalToLocal calculate correct results',
    (WidgetTester tester) async {
      ...
      expect(
        binding.localToGlobal(const Offset(0, -50), renderView),
        Offset.zero,
      );
      expect(
        binding.localToGlobal(Offset.zero, renderView),
        const Offset(0, 100),
      );
      expect(
        binding.localToGlobal(const Offset(200, 100), renderView),
        const Offset(400, 300),
      );
      expect(
        binding.localToGlobal(const Offset(150, 75), renderView),
        const Offset(300, 250),
      );
      expect(
        binding.localToGlobal(const Offset(400, 200), renderView),
        const Offset(800, 500),
      );
      expect(
        binding.localToGlobal(const Offset(400, 400), renderView),
        const Offset(800, 900),
      );

      expect(
        binding.globalToLocal(Offset.zero, renderView),
        const Offset(0, -50),
      );
      expect(
        binding.globalToLocal(const Offset(0, 100), renderView),
        Offset.zero,
      );
      expect(
        binding.globalToLocal(const Offset(400, 300), renderView),
        const Offset(200, 100),
      );
      expect(
        binding.globalToLocal(const Offset(300, 250), renderView),
        const Offset(150, 75),
      );
      expect(
        binding.globalToLocal(const Offset(800, 500), renderView),
        const Offset(400, 200),
      );
      expect(
        binding.globalToLocal(const Offset(800, 900), renderView),
