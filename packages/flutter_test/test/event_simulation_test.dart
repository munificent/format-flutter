...
void main() {
  testWidgets('simulates keyboard events (RawEvent)', (
    ...
    for (final String platform in platforms) {
      ...
      for (int i = 0; i < events.length; ++i) {
        ...
        if (i < 4) {
          expect(
            events[i].data.isModifierPressed(
  ...
  testWidgets(
    'simulates keyboard events (KeyData then RawKeyEvent)',
  ...
  testWidgets(
    'simulates using the correct transit mode: rawKeyData',
    (WidgetTester tester) async {
      debugKeyEventSimulatorTransitModeOverride = KeyDataTransitMode.rawKeyData;
  ...
  testWidgets(
    'simulates using the correct transit mode: keyDataThenRawKeyData',
    (WidgetTester tester) async {
      debugKeyEventSimulatorTransitModeOverride =
          KeyDataTransitMode.keyDataThenRawKeyData;
