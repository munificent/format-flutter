...
void main() {
  group('text contrast guideline', () {
    testWidgets(
      'black text on white background - Text Widget - direct style',
    ...
    testWidgets(
      'White text on white background fails contrast test',
      (WidgetTester tester) async {
        final SemanticsHandle handle = tester.ensureSemantics();
        await tester.pumpWidget(_boilerplate(Container(
          width: 200.0,
    ...
    testWidgets(
      'Material text field - amber on amber',
      (WidgetTester tester) async {
        final SemanticsHandle handle = tester.ensureSemantics();
        await tester.pumpWidget(_boilerplate(Container(
          width: 200.0,
            ...
            child: Padding(
              ...
              child: Semantics(
                ...
                child: Container(
                  ...
                  color: Colors.amberAccent,
                  child:
                      const Text('this', style: TextStyle(color: Colors.amber)),
                ),
              ),
            ),
          ),
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        final SemanticsHandle handle = tester.ensureSemantics();
        await tester.pumpWidget(_boilerplate(SizedBox(
          width: 100,
          child: TextField(
            controller: TextEditingController(text: 'this is a test'),
          ),
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(_boilerplate(Semantics(
          ...
          container: true,
          child:
              const SizedBox(width: 200.0, height: 200.0, child: Placeholder()),
        )));
  ...
  group('custom minimum contrast guideline', () {
    ...
    Widget rowWidget(List<Widget> widgets) => _boilerplate(
      Row(children: widgets),
    );

    final Finder findIcons = find.byWidgetPredicate(
      (Widget widget) => widget is Icon,
    );
    final Finder findTexts = find.byWidgetPredicate(
    ...
    testWidgets('Guideline ignores widgets of other types', (
      ...
      await expectLater(tester, doesNotMeetGuideline(
    ...
    testWidgets('Custom minimum ratio - Icons', (WidgetTester tester) async {
      ...
      await expectLater(tester, meetsGuideline(
        CustomMinimumContrastGuideline(finder: findIcons, minimumRatio: 3.0),
      ));
    });
    ...
    testWidgets('Custom minimum ratio - Texts', (WidgetTester tester) async {
      ...
      await expectLater(tester, meetsGuideline(
        CustomMinimumContrastGuideline(finder: findTexts, minimumRatio: 3.0),
      ));
    });
  ...
  group('tap target size guideline', () {
    ...
    testWidgets(
      'Tappable box at 48 by 48 shrunk by transform',
      (WidgetTester tester) async {
        final SemanticsHandle handle = tester.ensureSemantics();
    ...
    testWidgets(
      'Too small tap target fails with the correct message',
      (WidgetTester tester) async {
        final SemanticsHandle handle = tester.ensureSemantics();
        await tester.pumpWidget(_boilerplate(SizedBox(
          width: 48.0,
    ...
    testWidgets('Box that overlaps edge of window is skipped', (
      ...
      await tester.pumpWidget(MaterialApp(
        home: Stack(
          children: <Widget>[Positioned(left: 0.0, top: -1.0, child: smallBox)],
        ),
      ));
      ...
      await tester.pumpWidget(MaterialApp(
        home: Stack(
          children: <Widget>[Positioned(left: -1.0, top: 0.0, child: smallBox)],
        ),
      ));
      ...
      await tester.pumpWidget(MaterialApp(
        home: Stack(
          children: <Widget>[Positioned(bottom: -1.0, child: smallBox)],
        ),
      ));
      ...
      await tester.pumpWidget(MaterialApp(
        home:
            Stack(children: <Widget>[Positioned(right: -1.0, child: smallBox)]),
      ));
    ...
    testWidgets(
      'Tap size test can handle partially off-screen items',
      (WidgetTester tester) async {
  ...
  group('Labeled tappable node guideline', () {
    ...
    testWidgets(
      'Fails if long-press has no label',
      (WidgetTester tester) async {
        final SemanticsHandle handle = tester.ensureSemantics();
        await tester.pumpWidget(_boilerplate(Semantics(
          container: true,
    ...
    testWidgets(
      'Passes if tap is merged into labeled node',
      (WidgetTester tester) async {
        final SemanticsHandle handle = tester.ensureSemantics();
        await tester.pumpWidget(_boilerplate(Semantics(
          container: true,
    ...
    testWidgets(
      'Passes if text field does not have label',
      (WidgetTester tester) async {
        final SemanticsHandle handle = tester.ensureSemantics();
