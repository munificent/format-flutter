    ...
    group('compare', () {
      ...
      group('fails', () {
        test('and generates correct output in the correct base location', () async {
          ...
          await expectLater(() => doComparison(), throwsA(
            isFlutterError.having((FlutterError error) => error.message, 'message', contains('% diff detected')),
          ));
        ...
        test('when golden file does not exist', () async {
          await expectLater(() => doComparison(), throwsA(isA<TestFailure>().having(
        ...
        test('when golden bytes are empty', () async {
          ...
          await expectLater(() => doComparison(), throwsA(
            isFlutterError.having((FlutterError error) => error.message, 'message', contains('null image provided')),
          ));
        });
      });
    });
