  ...
  group('image', () {
    testWidgets('finds Image widgets', (WidgetTester tester) async {
      await tester.pumpWidget(
        _boilerplate(Image(image: FileImage(File('test')))),
      );
    ...
    testWidgets('finds Button widgets with Image', (WidgetTester tester) async {
      ...
      expect(
        find.widgetWithImage(ElevatedButton, FileImage(File('test'))),
        findsOneWidget,
      );
    });
  });
    ...
    testWidgets('finds Text.rich widgets', (WidgetTester tester) async {
      await tester.pumpWidget(_boilerplate(
        const Text.rich(TextSpan(
          text: 't',
          children: <TextSpan>[TextSpan(text: 'e'), TextSpan(text: 'st')],
        )),
      ));
    ...
    group('findRichText', () {
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          await tester.pumpWidget(
            _boilerplate(const Text('test', semanticsLabel: 'foo')),
          );
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          await tester.pumpWidget(_boilerplate(
            const Text.rich(TextSpan(
              text: 't',
              children: <TextSpan>[TextSpan(text: 'est'), TextSpan(text: '3')],
            )),
          ));
  ...
  group('semantics', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        final SemanticsHandle semanticsHandle = tester.ensureSemantics();
        await tester.pumpWidget(
          _boilerplate(const SimpleCustomSemanticsWidget('Foo')),
        );
