...
void main() {
  testWidgets('WidgetTester.drag must break the offset into multiple parallel components if '
    ...
    const List<TestDragData> offsetResults = <TestDragData>[
      ...
      TestDragData(Offset(10.0, 10.0), Offset(20.0, 5.0), <Offset>[Offset(10.0, 2.5), Offset(10.0, 2.5)]),
      TestDragData(Offset(10.0, 10.0), Offset(5.0, 20.0), <Offset>[Offset(2.5, 10.0), Offset(2.5, 10.0)]),
      ...
      TestDragData(Offset(10.0, 10.0), Offset(20.0, 20.0), <Offset>[Offset(10.0, 10.0), Offset(10.0, 10.0)]),
      ...
      TestDragData(Offset(12.0, 5.0), Offset(20.0, 5.0), <Offset>[Offset(12.0, 3.0), Offset(8.0, 2.0)]),
      TestDragData(Offset(12.0, 5.0), Offset(5.0, 20.0), <Offset>[Offset(1.25, 5.0), Offset(3.75, 15.0)]),
      TestDragData(Offset(5.0, 12.0), Offset(5.0, 20.0), <Offset>[Offset(3.0, 12.0), Offset(2.0, 8.0)]),
      TestDragData(Offset(5.0, 12.0), Offset(20.0, 5.0), <Offset>[Offset(5.0, 1.25), Offset(15.0, 3.75)]),
      TestDragData(Offset(18.0, 18.0), Offset(0.0, 150.0), <Offset>[Offset(0.0, 18.0), Offset(0.0, 132.0)]),
      TestDragData(Offset(18.0, 18.0), Offset(0.0, -150.0), <Offset>[Offset(0.0, -18.0), Offset(0.0, -132.0)]),
      TestDragData(Offset(18.0, 18.0), Offset(-150.0, 0.0), <Offset>[Offset(-18.0, 0.0), Offset(-132.0, 0.0)]),
      TestDragData(Offset.zero, Offset(-150.0, 0.0), <Offset>[Offset(-150.0, 0.0)]),
      TestDragData(Offset(18.0, 18.0), Offset(-32.0, 0.0), <Offset>[Offset(-18.0, 0.0), Offset(-14.0, 0.0)]),
    ];
  ...
  testWidgets('WidgetTester.fling produces strictly monotonically increasing timestamps, '
    ...
    await tester.pumpWidget(Directionality(
      textDirection: TextDirection.ltr,
      child: Listener(onPointerMove: (PointerMoveEvent event) => logs.add(event.timeStamp), child: const Text('test')),
    ));
  ...
  testWidgets('WidgetTester.tap appears in stack trace on error', (WidgetTester tester) async {
    ...
    final TestGesture gesture = await tester.startGesture(tester.getCenter(find.text('target')), pointer: 1);
    ...
    final int tapFrame = stackTrace!.frames.indexWhere((Frame frame) => frame.member == 'WidgetController.tap');
  ...
  group('SemanticsController', () {
    group('find', () {
      ...
      testWidgets('throws when there are multiple results from the finder', (WidgetTester tester) async {
        await tester.pumpWidget(
          const MaterialApp(home: Scaffold(body: Row(children: <Widget>[Text('hello'), Text('hello')]))),
        );
      ...
      testWidgets('Returns the correct SemanticsData', (WidgetTester tester) async {
        await tester.pumpWidget(
          MaterialApp(home: Scaffold(body: OutlinedButton(onPressed: () {}, child: const Text('hello')))),
        );
      ...
      testWidgets('Returns merged SemanticsData', (WidgetTester tester) async {
        ...
        await tester.pumpWidget(MaterialApp(
          home: Scaffold(
            body: Semantics(
              label: 'A',
              child: Semantics(label: 'B', child: Semantics(key: key, label: 'C', child: Container())),
            ),
          ),
        ));
    ...
    group('simulatedTraversal', () {
      ...
      testWidgets('produces expected traversal', (WidgetTester tester) async {
        ...
        expect(tester.semantics.simulatedAccessibilityTraversal(), orderedEquals(fullTraversalMatchers));
      });
      ...
      testWidgets('returns traversal between `start` and `end` if both are provided', (WidgetTester tester) async {
        ...
        expect(
          tester.semantics.simulatedAccessibilityTraversal(start: find.byType(TextField), end: find.byType(Slider)),
          orderedEquals(expectedMatchers),
        );
      });
      ...
      testWidgets('can do fuzzy traversal match with `containsAllInOrder`', (WidgetTester tester) async {
        ...
        final Iterable<Matcher> expectedMatchers = <Matcher>[...fullTraversalMatchers]
          ..removeAt(0)
          ..removeLast()
          ..mapIndexed<Matcher?>((int i, Matcher element) => i.isEven ? element : null).whereNotNull();

        expect(tester.semantics.simulatedAccessibilityTraversal(), containsAllInOrder(expectedMatchers));
      });
    });
  });
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            const _SemanticsTestCard(label: 'TextField', widget: TextField()),
            _SemanticsTestCard(label: 'Off Switch', widget: Switch(value: false, onChanged: (bool value) {})),
            ...
            _SemanticsTestCard(label: 'Slider', widget: Slider(value: .5, onChanged: (double value) {})),
            _SemanticsTestCard(label: 'Enabled Button', widget: TextButton(onPressed: () {}, child: const Text('Tap'))),
            ...
            _SemanticsTestCard(
              label: 'Checked Radio',
              widget: Radio<String>(value: 'checked', groupValue: 'checked', onChanged: (String? value) {}),
            ),
            _SemanticsTestCard(
              label: 'Unchecked Radio',
              widget: Radio<String>(value: 'unchecked', groupValue: 'checked', onChanged: (String? value) {}),
            ),
          ],
        ),
      ),
