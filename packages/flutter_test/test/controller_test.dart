...
void main() {
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      const List<TestDragData> offsetResults = <TestDragData>[
        ...
        TestDragData(Offset(10.0, 10.0), Offset(8.0, 3.0), <Offset>[
          Offset(8.0, 3.0),
        ]),
        TestDragData(Offset(10.0, 10.0), Offset(3.0, 8.0), <Offset>[
          Offset(3.0, 8.0),
        ]),
        ...
        TestDragData(Offset(10.0, 10.0), Offset(0.0, 5.0), <Offset>[
          Offset(0.0, 5.0),
        ]),

        //// Varying touch slops
        TestDragData(Offset(12.0, 5.0), Offset(0.0, 5.0), <Offset>[
          Offset(0.0, 5.0),
        ]),
        ...
        TestDragData(Offset.zero, Offset(-150.0, 0.0), <Offset>[
          Offset(-150.0, 0.0),
        ]),
  ...
  testWidgets('WidgetTester.tap must respect buttons', (
    WidgetTester tester,
  ) async {
    ...
    await tester.pumpWidget(Directionality(
      ...
      child: Listener(
        onPointerDown:
            (PointerDownEvent event) => logs.add('down ${event.buttons}'),
        onPointerMove:
            (PointerMoveEvent event) => logs.add('move ${event.buttons}'),
  ...
  testWidgets('WidgetTester.press must respect buttons', (
    WidgetTester tester,
  ) async {
    final List<String> logs = <String>[];
  ...
  testWidgets('WidgetTester.longPress must respect buttons', (
    WidgetTester tester,
  ) async {
    final List<String> logs = <String>[];
  ...
  testWidgets('WidgetTester.drag must respect buttons', (
    WidgetTester tester,
  ) async {
    final List<String> logs = <String>[];
  ...
  testWidgets('WidgetTester.drag works with trackpad kind', (
    WidgetTester tester,
  ) async {
    final List<String> logs = <String>[];
    ...
    await tester.pumpWidget(Directionality(
      ...
      child: Listener(
        ...
        onPointerPanZoomStart:
            (PointerPanZoomStartEvent event) => logs.add('panZoomStart'),
        onPointerPanZoomUpdate: (PointerPanZoomUpdateEvent event) => logs.add(
          'panZoomUpdate ${event.pan}',
        ),
        onPointerPanZoomEnd:
            (PointerPanZoomEndEvent event) => logs.add('panZoomEnd'),
        child: const Text('test'),
      ),
    ));
  ...
  testWidgets('WidgetTester.fling must respect buttons', (
    WidgetTester tester,
  ) async {
    final List<String> logs = <String>[];
  ...
  testWidgets('WidgetTester.timedDrag must respect buttons', (
    WidgetTester tester,
  ) async {
    final List<String> logs = <String>[];
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(Directionality(
        ...
        child: Listener(
          onPointerDown:
              (PointerDownEvent event) => logs.add('down ${event.pointer}'),
          child: const Text('test'),
        ),
      ));
  ...
  testWidgets('ensureVisible: scrolls to make widget visible', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    'platformDispatcher exposes the platformDispatcher from binding',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'view exposes the implicitView from platformDispatcher',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'viewOf finds a view when the view is implicit',
    (WidgetTester tester) async {
      await tester.pumpWidget(
  ...
  group('SemanticsController', () {
    group('find', () {
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          expect(
            () => tester.semantics.find(find.text('hello')),
            throwsStateError,
          );
        },
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          await tester.pumpWidget(
            const MaterialApp(
              home: Scaffold(
                body: Row(children: <Widget>[Text('hello'), Text('hello')]),
              ),
            ),
          );
    ...
    group('simulatedTraversal', () {
      ...
      testWidgets('produces expected traversal', (WidgetTester tester) async {
        await tester.pumpWidget(
          const MaterialApp(home: _SemanticsTestWidget()),
        );
      ...
      testWidgets(
        'starts traversal at semantics node for `start`',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            const MaterialApp(home: _SemanticsTestWidget()),
          );
      ...
      testWidgets(
        'throws StateError if `start` not found in traversal',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            const MaterialApp(home: _SemanticsTestWidget()),
          );
      ...
      testWidgets(
        'ends traversal at semantics node for `end`',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            const MaterialApp(home: _SemanticsTestWidget()),
          );
      ...
      testWidgets(
        'throws StateError if `end` not found in traversal',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            const MaterialApp(home: _SemanticsTestWidget()),
          );
      ...
      testWidgets(
        'can do fuzzy traversal match with `containsAllInOrder`',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            const MaterialApp(home: _SemanticsTestWidget()),
          );
