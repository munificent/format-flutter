...
void main() {
  testWidgets(
    'Caught exceptions are caught by the test framework',
  ...
  testWidgets(
    'Mock MessageHandler is set correctly',
    (WidgetTester tester) async {
      final TestDefaultBinaryMessenger binaryMessenger =
          TestDefaultBinaryMessenger(WorkingTestDelegate());
      binaryMessenger.setMockMessageHandler(
        '',
        (ByteData? message) async => ByteData.sublistView(
          Uint8List.fromList(<int>[2, 3, 4]),
        ),
      );
