...
void main() {
  ...
  testWidgets(
    'TestPlatformDispatcher can fake locale',
  ...
  testWidgets(
    'TestPlatformDispatcher can fake locales',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'TestPlatformDispatcher can fake text scale factor',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'TestPlatformDispatcher can fake brieflyShowPassword',
    (WidgetTester tester) async {
      verifyPropertyFaked<bool>(
        tester: tester,
  ...
  testWidgets(
    'TestPlatformDispatcher can fake default route name',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'TestPlatformDispatcher.view getter returns the implicit view',
    (WidgetTester tester) async {
      expect(
  ...
  group('TestPlatformDispatcher with unsupported Display API', () {
    testWidgets(
      'can initialize with empty displays',
      (WidgetTester tester) async {
        expect(() {
    ...
    testWidgets(
      'can initialize with mismatched displays',
      (WidgetTester tester) async {
        expect(() {
          TestPlatformDispatcher(
            platformDispatcher: _FakePlatformDispatcher(
    ...
    testWidgets(
      'creates test views for all views',
      (WidgetTester tester) async {
    ...
    group('creates TestFlutterViews', () {
      testWidgets(
        'that defaults to the correct devicePixelRatio',
        (WidgetTester tester) async {
      ...
      testWidgets(
        'with working devicePixelRatio setter',
        (WidgetTester tester) async {
          const double expectedDpr = 2.5;
      ...
      testWidgets(
        'with working resetDevicePixelRatio',
        (WidgetTester tester) async {
...
class _FakeFlutterView extends Fake implements FlutterView {
  _FakeFlutterView({this.devicePixelRatio = 1, Display? display})
    : _display = display;
