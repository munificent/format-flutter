...
abstract final class KeyEventSimulator {
  ...
  static Map<String, dynamic> getKeyData(
    ...
    void assignWeb() {
      final _WebKeyLocationPair keyLocation = _getWebKeyLocation(
        key,
        resultCharacter,
      );
  ...
  static Future<bool> simulateKeyDownEvent(
    ...
    switch (_transitMode) {
      ...
      case KeyDataTransitMode.keyDataThenRawKeyData:
        ...
        final bool resultByKeyEvent = ServicesBinding.instance.keyEventManager
            .handleKeyData(ui.KeyData(
              type: ui.KeyEventType.down,
              physical:
                  (physicalKey ?? _findPhysicalKey(logicalKey)).usbHidUsage,
