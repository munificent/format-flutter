...
class FakeViewPadding implements ViewPadding {
  ...
  FakeViewPadding._wrap(ViewPadding base) : left = base.left, top = base.top, right = base.right, bottom = base.bottom;
...
class TestPlatformDispatcher implements PlatformDispatcher {
  ...
  TestPlatformDispatcher({required PlatformDispatcher platformDispatcher}) : _platformDispatcher = platformDispatcher {
  ...
  TestFlutterView? get implicitView {
    return _platformDispatcher.implicitView != null ? _testViews[_platformDispatcher.implicitView!.viewId]! : null;
  }
  ...
  bool get nativeSpellCheckServiceDefined =>
      _nativeSpellCheckServiceDefinedTestValue ?? _platformDispatcher.nativeSpellCheckServiceDefined;
  ...
  @override
  Locale? computePlatformResolvedLocale(List<Locale> supportedLocales) => _platformDispatcher
  ...
  void _updateViewsAndDisplays() {
    ...
    for (final FlutterView view in _platformDispatcher.views) {
      ...
      if (!_testViews.containsKey(view.viewId)) {
        _testViews[view.viewId] = TestFlutterView(view: view, platformDispatcher: this, display: display);
      }
    }
  ...
  String? get systemFontFamily {
    return _forceSystemFontFamilyToBeNull ? null : _systemFontFamily ?? _platformDispatcher.systemFontFamily;
  }
