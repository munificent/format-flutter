...
///  * [moreOrLessEquals], which is for [double]s.
///  * [offsetMoreOrLessEquals], which is for [Offset]s.
Matcher matrixMoreOrLessEquals(
  Matrix4 value, {
  double epsilon = precisionErrorTolerance,
}) {
...
Matcher offsetMoreOrLessEquals(
  Offset value, {
  double epsilon = precisionErrorTolerance,
}) {
...
bool _hasAncestorOfType(Finder finder, Type targetType) {
  return _hasAncestorMatching(
    finder,
    (Widget widget) => widget.runtimeType == targetType,
  );
}
  ...
  static Object _normalize(Object value, {bool expected = true}) {
    ...
    if (value is Iterable<String>) {
      return value.map<String>(
        (dynamic item) => _normalizeString(item.toString()),
      );
    }
    throw ArgumentError(
...
class _HasGoodToStringDeep extends Matcher {
  ...
  Description describeMismatch(
    ...
    if (matchState.containsKey(_toStringDeepErrorDescriptionKey)) {
      return mismatchDescription.add(
        matchState[_toStringDeepErrorDescriptionKey] as String,
      );
    }
    return mismatchDescription;
  }
  ...
  bool matches(covariant Finder finder, Map<dynamic, dynamic> matchState) {
    ...
    if (nodes.length != 1) {
      return failWithDescription(
        matchState,
        'did not have a exactly one child element',
      );
    }
...
abstract class _MatchRenderObject<
  M extends RenderObject,
...
class _RendersOnPhysicalModel
  ...
  bool renderObjectMatchesT(
    ...
    if (borderRadius != null && renderObject.borderRadius != borderRadius) {
      return failWithDescription(
        matchState,
        'had borderRadius: ${renderObject.borderRadius}',
      );
    }
    ...
    if (elevation != null && renderObject.elevation != elevation) {
      return failWithDescription(
        matchState,
        'had elevation: ${renderObject.elevation}',
      );
    }
  ...
  bool renderObjectMatchesM(
    ...
    if (renderObject.clipper.runtimeType != ShapeBorderClipper) {
      return failWithDescription(
        matchState,
        'clipper was: ${renderObject.clipper}',
      );
    }
  ...
  bool assertRoundedRectangle(
    ...
    if (shapeClipper.shape.runtimeType != RoundedRectangleBorder) {
      return failWithDescription(
        matchState,
        'had shape border: ${shapeClipper.shape}',
      );
    }
    ...
    if (border.borderRadius != borderRadius) {
      return failWithDescription(
        matchState,
        'had borderRadius: ${border.borderRadius}',
      );
    }
    return true;
  }
...
class _ClipsWithBoundingRect
  ...
  bool renderObjectMatchesT(
    Map<dynamic, dynamic> matchState,
    RenderClipRect renderObject,
  ) {
    if (renderObject.clipper != null) {
      return failWithDescription(
        matchState,
        'had a non null clipper ${renderObject.clipper}',
      );
    }
    return true;
  }
  ...
  bool renderObjectMatchesM(
    ...
    if (border.borderRadius != BorderRadius.zero) {
      return failWithDescription(
        matchState,
        'borderRadius was: ${border.borderRadius}',
      );
    }
    return true;
  }
...
class _ColorMatcher extends Matcher {
  const _ColorMatcher({required this.targetColor});
...
class _MatchesSemanticsData extends Matcher {
  ...
  Description describe(Description description) {
    ...
    if (attributedIncreasedValue != null) {
      description.add(
        ' with attributedIncreasedValue: $attributedIncreasedValue',
      );
    }
    ...
    if (attributedDecreasedValue != null) {
      description.add(
        ' with attributedDecreasedValue: $attributedDecreasedValue',
      );
    }
    if (tooltip != null) {
    ...
    if (actions.isNotEmpty) {
      ...
      if (expectedActions.isNotEmpty) {
        description.add(
          ' with actions: ${_createEnumsSummary(expectedActions)} ',
        );
      }
    ...
    if (flags.isNotEmpty) {
      ...
      if (notExpectedFlags.isNotEmpty) {
        description.add(
          ' without flags: ${_createEnumsSummary(notExpectedFlags)} ',
        );
      }
    }
  ...
  bool matches(dynamic node, Map<dynamic, dynamic> matchState) {
    ...
    if (attributedLabel != null &&
      ...
      return failWithDescription(
        matchState,
        'attributedLabel was: ${data.attributedLabel}',
      );
    }
    ...
    if (attributedHint != null &&
        (attributedHint!.string != data.attributedHint.string ||
            !_stringAttributesEqual(
              ...
              data.attributedHint.attributes,
            ))) {
      return failWithDescription(
        matchState,
        'attributedHint was: ${data.attributedHint}',
      );
    }
    ...
    if (attributedValue != null &&
      ...
      return failWithDescription(
        matchState,
        'attributedValue was: ${data.attributedValue}',
      );
    }
    if (increasedValue != null && increasedValue != data.increasedValue) {
      return failWithDescription(
        matchState,
        'increasedValue was: ${data.increasedValue}',
      );
    }
    if (attributedIncreasedValue != null &&
    ...
    if (decreasedValue != null && decreasedValue != data.decreasedValue) {
      return failWithDescription(
        matchState,
        'decreasedValue was: ${data.decreasedValue}',
      );
    }
    if (attributedDecreasedValue != null &&
    ...
    if (textDirection != null && textDirection != data.textDirection) {
      return failWithDescription(
        matchState,
        'textDirection was: $textDirection',
      );
    }
    ...
    if (currentValueLength != null &&
      ...
      return failWithDescription(
        matchState,
        'currentValueLength was: ${data.currentValueLength}',
      );
    }
    if (maxValueLength != null && maxValueLength != data.maxValueLength) {
      return failWithDescription(
        matchState,
        'maxValueLength was: ${data.maxValueLength}',
      );
    }
    if (actions.isNotEmpty) {
      ...
      if (unexpectedActions.isNotEmpty || missingActions.isNotEmpty) {
        return failWithDescription(
          matchState,
          'missing actions: ${_createEnumsSummary(
            missingActions,
          )} unexpected actions: ${_createEnumsSummary(unexpectedActions)}',
        );
      }
    }
    if (customActions != null || hintOverrides != null) {
      ...
      if (expectedCustomActions.length != providedCustomActions.length) {
        return failWithDescription(
          matchState,
          'custom actions were: $providedCustomActions',
        );
      }
    ...
    if (flags.isNotEmpty) {
      ...
      if (unexpectedFlags.isNotEmpty || missingFlags.isNotEmpty) {
        return failWithDescription(
          matchState,
          'missing flags: ${_createEnumsSummary(
            missingFlags,
          )} unexpected flags: ${_createEnumsSummary(unexpectedFlags)}',
        );
      }
    }
  ...
  static String _createEnumsSummary<T extends Object>(List<T> enums) {
    ...
    if (T == SemanticsAction) {
      return '[${(enums as List<SemanticsAction>).map(
        (SemanticsAction d) => d.name,
      ).join(', ')}]';
    } else {
      return '[${(enums as List<SemanticsFlag>).map(
        (SemanticsFlag d) => d.name,
      ).join(', ')}]';
    }
  }
}
