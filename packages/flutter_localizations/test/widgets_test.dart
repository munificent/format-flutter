...
void main() {
  ...
  testWidgets('Synchronously loaded localizations in a WidgetsApp', (WidgetTester tester) async {
    ...
    Future<void> pumpTest(Locale locale) async {
      await tester.pumpWidget(Localizations(locale: locale, delegates: delegates, child: const SyncLoadTest()));
    }
  ...
  testWidgets('Localizations with multiple sync delegates', (WidgetTester tester) async {
    await tester.pumpWidget(buildFrame(
      delegates: <LocalizationsDelegate<dynamic>>[SyncTestLocalizationsDelegate(), SyncMoreLocalizationsDelegate()],
  ...
  testWidgets('Localizations sync delegate shouldReload returns true', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(buildFrame(
      delegates: <LocalizationsDelegate<dynamic>>[originalDelegate, SyncMoreLocalizationsDelegate()],
      locale: const Locale('en', 'US'),
      buildContent: (BuildContext context) {
        return Column(
          children: <Widget>[
    ...
    await tester.pumpWidget(buildFrame(
      delegates: <LocalizationsDelegate<dynamic>>[modifiedDelegate, SyncMoreLocalizationsDelegate()],
      locale: const Locale('en', 'US'),
      buildContent: (BuildContext context) {
        return Column(
          children: <Widget>[
  ...
  testWidgets('Localizations async delegate shouldReload returns true', (WidgetTester tester) async {
    await tester.pumpWidget(buildFrame(
      delegates: <LocalizationsDelegate<dynamic>>[AsyncTestLocalizationsDelegate(), AsyncMoreLocalizationsDelegate()],
      locale: const Locale('en', 'US'),
      buildContent: (BuildContext context) {
        return Column(
          children: <Widget>[
    ...
    await tester.pumpWidget(buildFrame(
      delegates: <LocalizationsDelegate<dynamic>>[modifiedDelegate, AsyncMoreLocalizationsDelegate()],
      locale: const Locale('en', 'US'),
      buildContent: (BuildContext context) {
        return Column(
          children: <Widget>[
  ...
  testWidgets('supportedLocales and defaultLocaleChangeHandler', (WidgetTester tester) async {
    await tester.pumpWidget(buildFrame(
      supportedLocales: const <Locale>[Locale('zh', 'CN'), Locale('en', 'GB'), Locale('en', 'CA')],
      buildContent: (BuildContext context) {
        return Text(Localizations.localeOf(context).toString());
      },
    ));
  ...
  testWidgets('WidgetsApp overrides DefaultWidgetLocalizations', (WidgetTester tester) async {
    await tester.pumpWidget(buildFrame(
      // Accept whatever locale we're given
      localeResolutionCallback: (Locale? locale, Iterable<Locale> supportedLocales) => locale,
      delegates: <OnlyRTLDefaultWidgetsLocalizationsDelegate>[const OnlyRTLDefaultWidgetsLocalizationsDelegate()],
      buildContent: (BuildContext context) {
        final Locale locale = Localizations.localeOf(context);
        final TextDirection direction = WidgetsLocalizations.of(context).textDirection;
        return Text('$locale $direction');
  ...
  testWidgets('WidgetsApp EdgeCase Chinese', (WidgetTester tester) async {
    ...
    await tester.binding
        .setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'zh', scriptCode: 'Hant', countryCode: 'US')]);
    await tester.pumpAndSettle();
    expect(find.text('zh_Hant_TW'), findsOneWidget);

    await tester.binding.setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'zh', scriptCode: 'Hant')]);
    await tester.pumpAndSettle();
    expect(find.text('zh_Hant_TW'), findsOneWidget);

    await tester.binding
        .setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'zh', scriptCode: 'Hant', countryCode: 'TW')]);
    await tester.pumpAndSettle();
    expect(find.text('zh_Hant_TW'), findsOneWidget);

    await tester.binding.setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'zh', countryCode: 'TW')]);
    await tester.pumpAndSettle();
    expect(find.text('zh_Hant_TW'), findsOneWidget);

    await tester.binding.setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'zh', countryCode: 'HK')]);
    await tester.pumpAndSettle();
    expect(find.text('zh_Hant_HK'), findsOneWidget);

    await tester.binding
        .setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'zh', scriptCode: 'Hans', countryCode: 'HK')]);
    await tester.pumpAndSettle();
    expect(find.text('zh_Hans_CN'), findsOneWidget);

    await tester.binding.setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'zh', countryCode: 'CN')]);
    await tester.pumpAndSettle();
    expect(find.text('zh_Hans_CN'), findsOneWidget);

    await tester.binding.setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'en', countryCode: 'US')]);
    await tester.pumpAndSettle();
    expect(find.text('zh'), findsOneWidget);
    ...
    await tester.binding
        .setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'en', scriptCode: 'Hans', countryCode: 'TW')]);
    await tester.pumpAndSettle();
    expect(find.text('zh_Hant_TW'), findsOneWidget);

    await tester.binding.setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'en', countryCode: 'TW')]);
    await tester.pumpAndSettle();
    expect(find.text('zh_Hant_TW'), findsOneWidget);

    await tester.binding.setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'en', countryCode: 'HK')]);
    await tester.pumpAndSettle();
    expect(find.text('zh_Hant_HK'), findsOneWidget);
  });
  ...
  testWidgets('WidgetsApp Android', (WidgetTester tester) async {
    ...
    await tester.binding.setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'fr', countryCode: 'CH')]);
    await tester.pumpAndSettle();
  ...
  testWidgets('WidgetsApp Android', (WidgetTester tester) async {
    await tester.pumpWidget(buildFrame(
      supportedLocales: const <Locale>[Locale('en'), Locale('de', 'DE'), Locale('es', 'ES'), Locale('it', 'IT')],
      buildContent: (BuildContext context) {
        final Locale locale = Localizations.localeOf(context);
        return Text('$locale');
      },
  ...
  testWidgets('WidgetsApp Country-only fallback', (WidgetTester tester) async {
    ...
    await tester.binding.setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'ar', countryCode: 'CH')]);
    await tester.pumpAndSettle();
    expect(find.text('de_CH'), findsOneWidget);

    await tester.binding.setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'ar', countryCode: 'FR')]);
    await tester.pumpAndSettle();
    expect(find.text('fr_FR'), findsOneWidget);

    await tester.binding.setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'ar', countryCode: 'US')]);
    await tester.pumpAndSettle();
    expect(find.text('en_US'), findsOneWidget);

    await tester.binding.setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'es', countryCode: 'US')]);
    await tester.pumpAndSettle();
  ...
  testWidgets('WidgetsApp Common cases', (WidgetTester tester) async {
    ...
    await tester.binding.setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'en', countryCode: 'CA')]);
    await tester.pumpAndSettle();
    expect(find.text('en_CA'), findsOneWidget);

    await tester.binding.setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'en', countryCode: 'AU')]);
    await tester.pumpAndSettle();
    ...
    await tester.binding.setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'ar', countryCode: 'IQ')]);
    await tester.pumpAndSettle();
    expect(find.text('ar_IQ'), findsOneWidget);

    await tester.binding.setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'es', countryCode: 'ES')]);
    await tester.pumpAndSettle();
    ...
    await tester.binding.setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'pa', countryCode: 'US')]);
    await tester.pumpAndSettle();
    expect(find.text('pa'), findsOneWidget);

    await tester.binding.setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'hi', countryCode: 'IN')]);
    await tester.pumpAndSettle();
