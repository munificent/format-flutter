...
class SyncTestLocalizationsDelegate
  ...
  @override
  Future<TestLocalizations> load(Locale locale) => TestLocalizations.loadSync(
    locale,
    prefix,
  );
...
class AsyncTestLocalizationsDelegate
  ...
  @override
  Future<TestLocalizations> load(Locale locale) => TestLocalizations.loadAsync(
    locale,
    prefix,
  );
...
class SyncMoreLocalizationsDelegate
  ...
  @override
  Future<MoreLocalizations> load(Locale locale) => MoreLocalizations.loadSync(
    locale,
  );
...
class AsyncMoreLocalizationsDelegate
    extends LocalizationsDelegate<MoreLocalizations> {
  @override
  Future<MoreLocalizations> load(Locale locale) => MoreLocalizations.loadAsync(
    locale,
  );
...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      >[SyncTestLocalizationsDelegate(), DefaultWidgetsLocalizations.delegate];
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        find.text('en_US'),
        findsOneWidget,
      ); // default test locale is US english
  ...
  testWidgets(
    'supportedLocales and defaultLocaleChangeHandler',
    (WidgetTester tester) async {
      await tester.pumpWidget(buildFrame(
  ...
  testWidgets(
    'WidgetsApp DefaultWidgetLocalizations',
    (WidgetTester tester) async {
      await tester.pumpAndSettle();
      await tester.pumpWidget(buildFrame(
        // Accept whatever locale we're given
  ...
  testWidgets('WidgetsApp Unicode tr35 2', (WidgetTester tester) async {
    ...
    await tester.binding
        .setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'zh')]);
    await tester.pumpAndSettle();
  ...
  // reversed.
  testWidgets(
    'WidgetsApp EdgeCase ReverseChinese',
    (WidgetTester tester) async {
      await tester.pumpWidget(buildFrame(
        supportedLocales: const <Locale>[
          Locale.fromSubtags(
  ...
  testWidgets('WidgetsApp Common cases', (WidgetTester tester) async {
    ...
    await tester.binding
        .setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'en')]);
    await tester.pumpAndSettle();
    expect(find.text('en_US'), findsOneWidget);
    ...
    await tester.binding
        .setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'ar')]);
    await tester.pumpAndSettle();
    expect(find.text('ar_SA'), findsOneWidget);
    ...
    await tester.binding
        .setLocales(const <Locale>[Locale.fromSubtags(languageCode: 'es')]);
    await tester.pumpAndSettle();
