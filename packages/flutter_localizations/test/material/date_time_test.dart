...
void main() {
  group(GlobalMaterialLocalizations, () {
    ...
    test(
      'fails when neither language code nor exact locale are available',
      () async {
    ...
    group('formatMinute', () {
      test('formats English', () async {
        ...
        expect(
          localizations.formatMinute(const TimeOfDay(hour: 1, minute: 32)),
          '32',
        );
      });
    });
    ...
    group('formatTimeOfDay', () {
      ...
      testWidgets(
        'formats ${TimeOfDayFormat.h_colon_mm_space_a}',
      ...
      testWidgets(
        'formats ${TimeOfDayFormat.HH_colon_mm}',
        (WidgetTester tester) async {
          expect(
            await formatTimeOfDay(
              tester,
      ...
      testWidgets(
        'formats ${TimeOfDayFormat.H_colon_mm}',
        (WidgetTester tester) async {
          expect(
            await formatTimeOfDay(
              tester,
      ...
      testWidgets(
        'formats ${TimeOfDayFormat.HH_dot_mm}',
        (WidgetTester tester) async {
          expect(
            await formatTimeOfDay(
              tester,
      ...
      testWidgets(
        'formats ${TimeOfDayFormat.frenchCanadian}',
        (WidgetTester tester) async {
          expect(
            await formatTimeOfDay(
              tester,
  ...
  testWidgets(
    'cy is initialized correctly by Flutter when DateFormat is used',
    (WidgetTester tester) async {
      late DateFormat dateFormat;
      ...
      expect(
        dateFormat.format(DateTime(2023, 4, 10, 2, 32)),
        equals('10 Ebr 2023'),
      );
    },
  );
