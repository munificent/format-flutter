...
void main() {
  for (final String language in kMaterialSupportedLanguages) {
    testWidgets('translations exist for $language', (
      ...
      expect(
        localizations.selectedRowCountTitle(0),
        isNot(contains(r'$selectedRowCount')),
      );
      expect(
        localizations.selectedRowCountTitle(1),
        isNot(contains(r'$selectedRowCount')),
      );
      expect(
      ...
      expect(
        localizations.selectedRowCountTitle(100),
        isNot(contains(r'$selectedRowCount')),
      );
      ...
      expect(
        localizations.pageRowsInfoTitle(1, 10, 100, true),
      ...
      expect(
        localizations.tabLabel(tabIndex: 2, tabCount: 5),
      ...
      expect(
        () => localizations.tabLabel(tabIndex: 0, tabCount: 5),
        throwsAssertionError,
      );
      expect(
        () => localizations.tabLabel(tabIndex: 2, tabCount: 0),
        throwsAssertionError,
      );

      expect(
        localizations.formatHour(const TimeOfDay(hour: 10, minute: 0)),
        isNotNull,
      );
      expect(
        localizations.formatMinute(const TimeOfDay(hour: 10, minute: 0)),
        isNotNull,
      );
  ...
  testWidgets(
    'translations spot check expansionTileExpandedHint',
  ...
  testWidgets('spot check selectedRowCount translations', (
    ...
    expect(
      localizations.selectedRowCountTitle(123456789),
    ...
    expect(
      localizations.selectedRowCountTitle(10),
      '10 elementos seleccionados',
    );
    expect(
      localizations.selectedRowCountTitle(15),
      '15 elementos seleccionados',
    );
    expect(
      localizations.selectedRowCountTitle(29),
      '29 elementos seleccionados',
    );
    expect(
      localizations.selectedRowCountTitle(10000),
      '10.000 elementos seleccionados',
    );
    expect(
      localizations.selectedRowCountTitle(10019),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      MaterialLocalizations localizations =
          await GlobalMaterialLocalizations.delegate.load(const Locale('en'));
      expect(
        localizations.formatMediumDate(DateTime(2015, 7, 23)),
        'Thu, Jul 23',
      );
      expect(
        localizations.formatFullDate(DateTime(2015, 7, 23)),
        'Thursday, July 23, 2015',
      );

      localizations = await GlobalMaterialLocalizations.delegate.load(
        const Locale('en', 'GB'),
      );
      expect(
        localizations.formatMediumDate(DateTime(2015, 7, 23)),
