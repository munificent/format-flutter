...
void main() {
  ...
  testWidgets(
    'locale parameter overrides ambient locale',
  ...
  testWidgets(
    'textDirection parameter overrides ambient textDirection',
    (WidgetTester tester) async {
      Widget buildFrame(bool useMaterial3) {
        return MaterialApp(
          theme: ThemeData(useMaterial3: useMaterial3),
  ...
  testWidgets(
    'textDirection parameter takes precedence over locale parameter',
    (WidgetTester tester) async {
      Widget buildFrame(bool useMaterial3) {
        return MaterialApp(
          theme: ThemeData(useMaterial3: useMaterial3),
