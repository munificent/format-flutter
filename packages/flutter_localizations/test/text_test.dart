...
void main() {
  testWidgets('Text baseline with CJK locale', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      supportedLocales: const <Locale>[Locale('en', 'US'), Locale('es', 'ES'), Locale('zh', 'CN')],
              ...
              return PopupMenuButton<int>(
                ...
                itemBuilder: (BuildContext context) {
                  return <PopupMenuItem<int>>[
                    ...
                    const PopupMenuItem<int>(value: 2, child: Text('你好，世界', style: TextStyle(color: Colors.blue))),
                  ];
                },
              );
            },
