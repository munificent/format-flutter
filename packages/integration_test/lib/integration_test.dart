    ...
    tearDownAll(() async {
      ...
      try {
        await integrationTestChannel
            .invokeMethod<void>('allTestsFinished', <String, dynamic>{
              'results':
...
''');
  ...
  ViewConfiguration createViewConfiguration() {
    ...
    return TestViewConfiguration.fromView(size: size, view: view);
  }
  ...
  static IntegrationTestWidgetsFlutterBinding
  ...
  Future<Map<String, dynamic>> callback(Map<String, String> params) async {
    return callbackManager.callback(
      params,
      this, /* as IntegrationTestResults */
    );
  }
  ...
  Future<_GarbageCollectionInfo> _runAndGetGCInfo(
    ...
    final vm.Timeline timeline =
        await traceTimeline(action, streams: <String>['GC']);
