...
class FlutterDebugAdapter extends FlutterBaseDebugAdapter with VmServiceInfoFileUtils {
  ...
  Future<void> attachImpl() async {
    ...
    if (vmServiceUri != null && vmServiceInfoFile != null) {
      sendConsoleOutput('To attach, provide only one (or neither) of vmServiceUri/vmServiceInfoFile');
  ...
  /// them.
  @override
  Future<void> customRequest(Request request, RawRequestArguments? args, void Function(Object?) sendResponse) async {
  ...
  /// to the running app.
  @override
  Future<void> restartRequest(Request request, RestartArguments? args, void Function() sendResponse) async {
  ...
  Future<Object?> sendFlutterRequest(String method, Map<String, Object?>? params) async {
    ...
    sendFlutterMessage(<String, Object?>{'id': id, 'method': method, 'params': params});
  ...
  Future<void> _connectDebugger(Uri vmServiceUri) async {
    if (enableDebugger) {
      ...
      sendEvent(
        RawEventBody(<String, Object?>{'vmServiceUri': vmServiceUri.toString()}),
  ...
  void _handleJsonEvent(String event, Map<String, Object?>? params) {
    ...
    if (_eventsToForwardToClient.contains(event)) {
      ...
      sendEvent(RawEventBody(<String, Object?>{'event': event, 'params': params}), eventType: 'flutter.forwardedEvent');
    }
  }
  ...
  void _handleJsonRequest(Object id, String method, Map<String, Object?>? params) {
    ...
    void sendResponseToFlutter(Object? id, Object? value, {bool error = false}) {
      sendFlutterMessage(<String, Object?>{'id': id, if (error) 'error': value else 'result': value});
    }
  ...
  void handleStdout(String data) {
    ...
    try {
      ...
      if (data.contains('Waiting for connection from Dart debug extension')) {
        launchProgress?.update(message: 'Please click the Dart Debug extension button in the spawned browser window');
      }
  ...
  Future<void> _performRestart(bool fullRestart, [String? reason]) async {
    ...
    final DapProgressReporter progress = startProgressNotification(progressId, 'Flutter', message: progressMessage);
