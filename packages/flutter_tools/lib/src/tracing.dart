  ...
  Future<Map<String, Object?>> stopTracingAndDownloadTimeline({
    ...
    if (awaitFirstFrame) {
      ...
      try {
        ...
        try {
          await vmService.service.streamListen(
...
Future<void> downloadStartupTrace(
  ...
  final Map<String, Object?> timeline = await tracing
      .stopTracingAndDownloadTimeline(awaitFirstFrame: awaitFirstFrame);
  ...
  int? extractInstantEventTimestamp(String eventName) {
    ...
    final List<Map<String, Object?>> events = List<Map<String, Object?>>.from(
      traceEvents,
    );
  ...
  final int? frameworkInitTimestampMicros = extractInstantEventTimestamp(
    kFrameworkInitEventName,
  );

  if (engineEnterTimestampMicros == null) {
    logger.printTrace(
      'Engine start event is missing in the timeline: $timeline',
    );
    throwToolExit(
