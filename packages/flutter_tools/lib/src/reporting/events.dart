...
class CommandResultEvent extends UsageEvent {
  CommandResultEvent(super.commandPath, super.result) : super(flutterUsage: globals.flutterUsage);
  ...
  void send() {
    ...
    try {
      ...
      flutterUsage.sendEvent('tool-command-max-rss', category, label: parameter, value: maxRss);
...
class AnalyticsConfigEvent extends UsageEvent {
  ...
  }) : super('analytics', 'enabled', label: enabled ? 'true' : 'false', flutterUsage: globals.flutterUsage);
}
...
class NullSafetyAnalysisEvent implements UsageEvent {
  NullSafetyAnalysisEvent(this.packageConfig, this.nullSafetyMode, this.currentPackage, this.flutterUsage);
  ...
  void send() {
    ...
    flutterUsage.sendEvent(
      ...
      'stats',
      parameters:
          CustomDimensions(nullSafeMigratedLibraries: migrated, nullSafeTotalLibraries: packageConfig.packages.length),
    );
