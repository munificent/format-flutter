...
class TestCompiler {
  ...
  TestCompiler(
    ...
    final Directory outputDillDirectory = globals.fs.systemTempDirectory
  ...
  Future<void> _onCompilationRequest(CompilationRequest request) async {
    ...
    while (compilationQueue.isNotEmpty) {
      ...
      if (flutterProject != null) {
        ...
        invalidatedRegistrantFiles.add(
          flutterProject!.dartPluginRegistrant.absolute.uri,
        );
      }
      ...
      if (outputPath == null || compilerOutput!.errorCount > 0) {
        ...
        if (shouldCopyDillFile) {
          final String path = request.mainUri.toFilePath(
