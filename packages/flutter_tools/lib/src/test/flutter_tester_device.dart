...
class FlutterTesterTestDevice extends TestDevice {
  ...
  @protected
  @visibleForTesting
  Future<HttpServer> bind(InternetAddress? host, int port) => HttpServer.bind(
    host,
    port,
  );
  ...
  Future<StreamChannel<String>> get remoteChannel async {
    ...
    try {
      ...
      throw TestDeviceException(
        'Unable to connect to flutter_tester process: $error',
        stackTrace,
      );
    }
  }
  ...
  void _pipeStandardStreamsToConsole({
    ...
    for (final Stream<List<int>> stream in <Stream<List<int>>>[
      ...
      stream.transform<String>(utf8.decoder).transform<
        String
