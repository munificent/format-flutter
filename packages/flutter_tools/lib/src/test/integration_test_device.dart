...
class IntegrationTestTestDevice implements TestDevice {
  ...
  Future<StreamChannel<String>> start(String entrypointPath) async {
    ...
    _applicationPackage = await ApplicationPackageFactory.instance
    ...
    final vm_service.IsolateRef isolateRef =
        await vmService.findExtensionIsolate(kIntegrationTestMethod);
    ...
    final Stream<String> remoteMessages = vmService.service.onExtensionEvent
        .where(
          (vm_service.Event e) => e.extensionKind == kIntegrationTestExtension,
        )
        .map(
          (vm_service.Event e) =>
    ...
    remoteMessages.listen(
      ...
      onError: (Object error, StackTrace stack) => controller.local.sink
