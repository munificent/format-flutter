  ...
  Future<WebMemoryFS> initialize({
    ...
    for (final String testFilePath in testFiles) {
      ...
      final File generatedFile = _fileSystem.file(_fileSystem.path.join(
        ...
        '${relativeTestSegments.join('_')}.test.dart',
      ));
      generatedFile
        ..createSync(recursive: true)
    ...
    final ResidentCompiler residentCompiler = ResidentCompiler(
      ...
      dartDefines: buildInfo.dartDefines,
      librariesSpec: _artifacts.getHostArtifact(
    ...
    final File codeFile = outputDirectory.childFile(
      '${output.outputFilename}.sources',
    );
    final File manifestFile = outputDirectory.childFile(
      '${output.outputFilename}.json',
    );
    final File sourcemapFile = outputDirectory.childFile(
      '${output.outputFilename}.map',
    );
    final File metadataFile = outputDirectory.childFile(
