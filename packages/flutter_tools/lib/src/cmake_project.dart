...
class WindowsProject extends FlutterProjectPlatform
  ...
  @override
  File get generatedCmakeConfigFile => ephemeralDirectory.childFile(
    'generated_config.cmake',
  );

  @override
  File get generatedPluginCmakeFile => managedDirectory.childFile(
  ...
  File get runnerFlutterWindowFile => runnerDirectory.childFile(
    'flutter_window.cpp',
  );
  ...
  @override
  Directory get pluginSymlinkDirectory => ephemeralDirectory.childDirectory(
    '.plugin_symlinks',
  );
  ...
  Directory get managedDirectory => _editableDirectory.childDirectory(
    'flutter',
  );
