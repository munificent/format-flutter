...
Future<void> buildWindows(
  ...
  final File appFile = buildDirectory.childDirectory('runner').childDirectory(
  ...
  if (assembleProject.existsSync()) {
    ...
    for (final String line in assembleProject.readAsLinesSync()) {
      ...
      if (commandMatch != null) {
        ...
        final RegExpMatch? assembleCallMatch = assembleCallRegex.firstMatch(
          line,
        );
