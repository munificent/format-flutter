...
class VisualStudioValidator extends DoctorValidator {
  ...
  Future<ValidationResult> validate() async {
    ...
    if (_visualStudio.isInstalled) {
      ...
      messages.add(ValidationMessage(_userMessages.visualStudioLocation(
        _visualStudio.installLocation ?? 'unknown',
      )));
      ...
      if (!_visualStudio.isAtLeastMinimumVersion) {
        ...
        messages.add(ValidationMessage.error(_userMessages.visualStudioTooOld(
        ...
        status = ValidationType.partial;
        messages.add(
          ValidationMessage.hint(_userMessages.windows10SdkNotFound),
        );
      }
      versionInfo =
