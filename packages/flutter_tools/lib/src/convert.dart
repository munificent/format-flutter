...
class Utf8Decoder extends Converter<List<int>, String> {
  ...
  static const cnv.Utf8Decoder _systemDecoder = cnv.Utf8Decoder(
    allowMalformed: true,
  );
  ...
  @override
  ByteConversionSink startChunkedConversion(Sink<String> sink) => _systemDecoder
  ...
  @override
  Converter<List<int>, T> fuse<T>(Converter<String, T> other) => _systemDecoder
      .fuse(other);
}
