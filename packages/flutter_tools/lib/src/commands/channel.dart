...
class ChannelCommand extends FlutterCommand {
  ...
  Future<void> _switchChannel(String branchName) async {
    ...
    globals.printStatus(
      "Successfully switched to flutter channel '$branchName'.",
    );
    globals.printStatus(
  ...
  static Future<void> _checkout(String branchName) async {
    ...
    RunResult runResult = await globals.processUtils
        .run(<String>['git', 'fetch'], workingDirectory: Cache.flutterRoot);
