...
class AssembleCommand extends FlutterCommand {
  AssembleCommand({bool verboseHelp = false, required BuildSystem buildSystem}) : _buildSystem = buildSystem {
    ...
    argParser.addOption('performance-measurement-file', help: 'Output individual target performance to a JSON file.');
    argParser.addMultiOption(
      'input',
      abbr: 'i',
  ...
  Environment _createEnvironment() {
    ...
    final Environment result = Environment(
      ...
      engineVersion: artifacts.isLocalEngine ? null : globals.flutterVersion.engineRevision,
  ...
  Map<String, String> _parseDefines(List<String> values) {
    ...
    if (argumentResults.wasParsed(FlutterOptions.kExtraGenSnapshotOptions)) {
      results[kExtraGenSnapshotOptions] = (argumentResults[FlutterOptions.kExtraGenSnapshotOptions] as List<String>)
          .join(',');
    }
