...
class AssembleCommand extends FlutterCommand {
  ...
  Future<Set<DevelopmentArtifact>> get requiredArtifacts async {
    ...
    final DevelopmentArtifact? artifact = artifactFromTargetPlatform(
      targetPlatform,
    );
    if (artifact != null) {
  ...
  Future<FlutterCommandResult> runCommand() async {
    ...
    if (argumentResults.wasParsed('performance-measurement-file')) {
      final File outFile = globals.fs.file(
        argumentResults['performance-measurement-file'],
      );
    ...
    if (argumentResults.wasParsed('depfile')) {
      ...
      _environment.depFileService.writeToFile(
        depfile,
        globals.fs.file(depfileFile),
      );
    }
