...
class EmulatorsCommand extends FlutterCommand {
  ...
  Future<FlutterCommandResult> runCommand() async {
    ...
    if (argumentResults.wasParsed('launch')) {
      ...
      final String? searchText = argumentResults.rest.isNotEmpty ? argumentResults.rest.first : null;
  ...
  Future<void> _listEmulators(String? searchText) async {
    ...
    if (emulators.isEmpty) {
      ...
      _printEmulatorList(emulators, '${emulators.length} available ${pluralize('emulator', emulators.length)}:');
    }
  }
