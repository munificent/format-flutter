...
class BuildLinuxCommand extends BuildSubCommand {
  BuildLinuxCommand({
    ...
    final String defaultTargetPlatform = (_operatingSystemUtils.hostPlatform == HostPlatform.linux_arm64)
        ? 'linux-arm64'
        : 'linux-x64';
    argParser.addOption(
      'target-platform',
  ...
  @override
  Future<Set<DevelopmentArtifact>> get requiredArtifacts async => <DevelopmentArtifact>{DevelopmentArtifact.linux};
  ...
  Future<FlutterCommandResult> runCommand() async {
    ...
    final bool needCrossBuild = _operatingSystemUtils.hostPlatform.platformName != targetPlatform.simpleName;
    ...
    await buildLinux(
      ...
      buildInfo,
      target: targetFile,
      sizeAnalyzer: SizeAnalyzer(fileSystem: globals.fs, logger: globals.logger, flutterUsage: globals.flutterUsage),
