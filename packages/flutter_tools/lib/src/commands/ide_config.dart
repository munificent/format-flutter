...
class IdeConfigCommand extends FlutterCommand {
  ...
  Directory get _flutterRoot => globals.fs.directory(
  ...
  void _handleTemplateUpdate() {
    ...
    for (final File srcFile in flutterFiles) {
      ...
      final Directory finalDestinationDir = globals.fs.directory(
        finalDestinationFile.dirname,
      );
  ...
  Future<FlutterCommandResult> runCommand() async {
    ...
    final String? error = _validateFlutterDir(
      dirPath,
