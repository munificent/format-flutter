...
Future<void> buildMacOS({
  ...
  final List<ProjectMigrator> migrators = <ProjectMigrator>[
    RemoveMacOSFrameworkLinkAndEmbeddingMigration(flutterProject.macos, globals.logger, globals.flutterUsage),
  ...
  final XcodeProjectInfo? projectInfo =
      await globals.xcodeProjectInterpreter?.getInfo(xcodeProject.parent.path, projectFilename: xcodeProjectName);
  ...
  if (buildInfo.codeSizeDirectory != null && sizeAnalyzer != null) {
    ...
    globals.printStatus('A summary of your macOS bundle analysis can be found at: ${outputFile.path}');
