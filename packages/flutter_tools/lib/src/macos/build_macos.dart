...
Future<void> buildMacOS({
  ...
  final Directory flutterBuildDir = globals.fs.directory(
  ...
  final String? xcodeProjectName = xcodeProject.existsSync()
      ? xcodeProject.basename
      : null;
  final XcodeProjectInfo? projectInfo = await globals.xcodeProjectInterpreter
      ?.getInfo(xcodeProject.parent.path, projectFilename: xcodeProjectName);
  ...
  try {
    result = await globals.processUtils.stream(
      <String>[
        ...
        '-destination',
        'platform=macOS',
        'OBJROOT=${globals.fs.path.join(
          flutterBuildDir.absolute.path,
          'Build',
          'Intermediates.noindex',
        )}',
        'SYMROOT=${globals.fs.path.join(
          flutterBuildDir.absolute.path,
          'Build',
          'Products',
        )}',
  ...
  if (buildInfo.codeSizeDirectory != null && sizeAnalyzer != null) {
    ...
    final Directory candidateDirectory = globals.fs.directory(globals.fs.path
