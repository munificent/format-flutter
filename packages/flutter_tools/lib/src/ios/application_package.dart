...
class BuildableIOSApp extends IOSApp {
  ...
  Directory get appDeltaDirectory => globals.fs.directory(
    globals.fs.path.join(getIosBuildDirectory(), 'app-delta'),
  );
  ...
  String get archiveBundleOutputPath => globals.fs.path.setExtension(
    archiveBundlePath,
    '.xcarchive',
  );
  ...
  String get projectLaunchImageDirName => _projectImageAssetDirName(
    _launchImageAsset,
  );

  String
  get templateAppIconDirNameForContentsJson => _templateImageAssetDirNameForContentsJson(
    _appIconAsset,
  );

  String
  get templateLaunchImageDirNameForContentsJson => _templateImageAssetDirNameForContentsJson(
    _launchImageAsset,
  );

  Future<String>
  get templateAppIconDirNameForImages async => _templateImageAssetDirNameForImages(
    _appIconAsset,
  );

  Future<String>
  get templateLaunchImageDirNameForImages async => _templateImageAssetDirNameForImages(
    _launchImageAsset,
  );
  ...
  String _projectImageAssetDirName(String asset) => globals.fs.path.join(
    'ios',
    'Runner',
    'Assets.xcassets',
    asset,
  ...
  String _templateImageAssetDirNameForContentsJson(String asset) => globals
      .fs
      .path
      .join(
        Cache.flutterRoot!,
