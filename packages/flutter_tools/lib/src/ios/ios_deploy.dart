...
class IOSDeploy {
  ...
  Future<bool> isAppInstalled({
    ...
    final RunResult result =
        await _processUtils.run(launchCommand, environment: iosDeployEnv);
  ...
  String _monitorFailure(String stdout) => _monitorIOSDeployFailure(
    stdout,
    _logger,
  );
}
...
class IOSDeployDebugger {
  ...
  static final RegExp _lldbPlatformSelect = RegExp(
  ...
  static final RegExp _lldbProcessExit = RegExp(
  ...
  Future<bool> launchAndAttach() async {
    ...
    try {
      _iosDeployProcess =
          await _processUtils.start(_launchCommand, environment: _iosDeployEnv);
      ...
      final StreamSubscription<String> stdoutSubscription = _iosDeployProcess!
          ...
          .listen((String line) {
            ...
            if (_debuggerState == _IOSDeployDebuggerState.launching) {
              ...
              _logger.printTrace(
                'Debugger state set to ${attachSuccess ? 'attached' : 'detached'}.',
              );
