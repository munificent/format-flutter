...
class DartPluginRegistrantTarget extends Target {
  ...
  Future<void> build(Environment environment) async {
    ...
    final PackageConfig packageConfig =
        await loadPackageConfigWithLogging(project.packageConfigFile, logger: environment.logger);
    ...
    final String mainFileUriString = packageConfig.toPackageUri(mainFileUri)?.toString() ?? mainFileUri.toString();
  ...
  bool canSkip(Environment environment) {
    ...
    final TargetPlatform? targetPlatform = platformName == null ? null : getTargetPlatformForName(platformName);
  ...
  @override
  List<Source> get inputs => <Source>[const Source.pattern('{PROJECT_DIR}/.dart_tool/package_config_subset')];
  ...
  List<Source> get outputs => <Source>[
    const Source.pattern('{PROJECT_DIR}/.dart_tool/flutter_build/dart_plugin_registrant.dart', optional: true),
  ];
}
