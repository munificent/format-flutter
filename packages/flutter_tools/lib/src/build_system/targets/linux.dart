...
class UnpackLinux extends Target {
  ...
  Future<void> build(Environment environment) async {
    ...
    final Directory outputDirectory = environment.fileSystem.directory(
      environment.fileSystem.path.join(environment.projectDir.path, 'linux', 'flutter', 'ephemeral'),
    );
    final Depfile depfile = unpackDesktopArtifacts(
      ...
      icuDataPath: environment.artifacts.getArtifactPath(Artifact.icuData, platform: targetPlatform),
    );
...
abstract class BundleLinuxAssets extends Target {
  ...
  @override
  List<Target> get dependencies => <Target>[const KernelSnapshot(), UnpackLinux(targetPlatform)];
  ...
  Future<void> build(Environment environment) async {
    ...
    final Depfile depfile = await copyAssets(
      ...
      additionalContent: <String, DevFSContent>{'version.json': DevFSStringContent(versionInfo)},
...
class ProfileBundleLinuxAssets extends BundleLinuxAssets {
  ...
  @override
  List<Target> get dependencies => <Target>[...super.dependencies, LinuxAotBundle(AotElfProfile(targetPlatform))];
}
...
class ReleaseBundleLinuxAssets extends BundleLinuxAssets {
  ...
  @override
  List<Target> get dependencies => <Target>[...super.dependencies, LinuxAotBundle(AotElfRelease(targetPlatform))];
}
