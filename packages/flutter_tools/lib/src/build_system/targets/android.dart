...
abstract class AndroidAssetBundle extends Target {
  ...
  @override
  List<Source> get inputs => const <Source>[Source.pattern('{BUILD_DIR}/app.dill'), ...IconTreeShaker.inputs];
  ...
  Future<void> build(Environment environment) async {
    ...
    if (buildMode == BuildMode.debug) {
      ...
      environment.fileSystem.file(vmSnapshotData).copySync(outputDirectory.childFile('vm_snapshot_data').path);
...
class ProfileAndroidApplication extends CopyFlutterAotBundle {
  ...
  @override
  List<Target> get dependencies => const <Target>[AotElfProfile(TargetPlatform.android_arm), AotAndroidAssetBundle()];
}
...
class ReleaseAndroidApplication extends CopyFlutterAotBundle {
  ...
  @override
  List<Target> get dependencies => const <Target>[AotElfRelease(TargetPlatform.android_arm), AotAndroidAssetBundle()];
}
