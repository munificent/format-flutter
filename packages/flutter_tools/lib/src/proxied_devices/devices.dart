...
class ProxiedDevices extends DeviceDiscovery {
  ...
  }) async => _filterDevices(_devices ?? await discoverDevices(), filter);
  ...
  ProxiedDevice deviceFromDaemonResult(Map<String, Object?> device) {
    final Map<String, Object?> capabilities = _cast<Map<String, Object?>>(
      device['capabilities'],
    );
...
class ProxiedDevice extends Device {
  ...
  Future<LaunchResult> startApp(
    ...
    final Uri? vmServiceUri = vmServiceUriStr == null
        ? null
  ...
  Future<String> applicationPackageId(
    ...
    if (rollingHashResultJson == null) {
      ...
      final BlockHashes rollingHashResult = BlockHashes.fromJson(
...
class _ProxiedLogReader extends DeviceLogReader {
  ...
  void dispose() {
    if (_id != null) {
      connection
          .sendRequest('device.logReader.stop', <String, Object?>{'id': _id});
    }
  }
}
  ...
  Future<ServerSocket> _startProxyServer(
    ...
    serverSocket.listen(
      (Socket socket) async {
        ...
        unawaited(socket.done
            ...
            .whenComplete(() {
              ...
              unawaited(connection.sendRequest(
                'proxy.disconnect',
                <String, Object>{'id': id},
              ).then(
                (Object? obj) => obj,
      ...
      onError: (Object error, StackTrace stackTrace) {
        ...
        _logger.printTrace(
          'Server socket error: $error, stack trace: $stackTrace',
        );
      },
    );
...
class ProxiedDartDevelopmentService implements DartDevelopmentService {
  ...
  Future<void> startDartDevelopmentService(
    ...
    final int? remoteVMServicePort = _proxiedPortForwarder.originalRemotePort(
      vmServiceUri.port,
    );
    ...
    final Uri remoteVMServiceUri = vmServiceUri.replace(
      port: remoteVMServicePort,
    );
  ...
  void setExternalDevToolsUri(Uri uri) {
    connection.sendRequest(
      ...
      <String, Object?>{'deviceId': deviceId, 'uri': uri.toString()},
    );
  }
}
