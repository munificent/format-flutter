...
abstract class WebCompilerConfig {
  ...
  Map<String, Object> get buildEventAnalyticsValues => <String, Object>{'wasm-compile': isWasm};
}
...
class JsCompilerConfig extends WebCompilerConfig {
  ...
  factory JsCompilerConfig.fromBuildSystemEnvironment(Map<String, String> defines) => JsCompilerConfig(
...
class WasmCompilerConfig extends WebCompilerConfig {
  const WasmCompilerConfig({required this.omitTypeChecks, required this.wasmOpt});
  ...
  List<String> toCommandOptions() => <String>[if (omitTypeChecks) '--omit-type-checks'];
