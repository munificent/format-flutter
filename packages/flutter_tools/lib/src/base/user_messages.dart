...
class UserMessages {
  ...
  String androidMissingSdkInstructions(Platform platform) =>
      ...
      '(or visit ${_androidSdkInstallUrl(
        platform,
  ...
  String androidSdkBuildToolsOutdated(
    ...
    Platform platform,
      ...
      'To update the Android SDK visit ${_androidSdkInstallUrl(
        platform,
      )} for detailed instructions.';
  ...
  String flutterMissPlatformProjects(
    List<String> unsupportedDevicesType,
