...
Please provide a valid TCP port (an integer between 0 and 65535, inclusive).
  ...
  Future<int> attach({
    ...
    if (supportsServiceProtocol) {
      ...
      unawaited(_connectionResult!.debugConnection!.onDone.whenComplete(
        _cleanupAndExit,
      ));
      ...
      if (!debuggingOptions.startPaused || !supportsServiceProtocol) {
        ...
        resumeSub = _vmService.service.onDebugEvent.listen(
          (vmservice.Event event) {
