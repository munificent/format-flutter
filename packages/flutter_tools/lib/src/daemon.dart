...
class DaemonStreams {
  DaemonStreams(Stream<List<int>> rawInputStream, StreamSink<List<int>> outputSink, {required Logger logger})
...
class DaemonConnection {
  ...
  void sendEvent(String name, [Object? params, List<int>? binary]) {
    _daemonStreams.send(<String, Object?>{'event': name, if (params != null) 'params': params}, binary);
  }
