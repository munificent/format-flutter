    ...
    for (final DeferredComponent component in components) {
      ...
      if (!androidFiles.verifyFilesExist()) {
        ...
        final Map<String, List<File>> results =
            await androidFiles.generateFiles(alternateAndroidDir: outputDir, clearAlternateOutputDir: true);
...
class _DeferredComponentAndroidFiles {
  ...
  File get androidManifestFile => componentDir.childDirectory('src').childDirectory('main').childFile(
    'AndroidManifest.xml',
  );
  ...
  Future<List<File>> _setupComponentFiles(Directory outputDir) async {
    ...
    final File tempAndroidManifest = outputDir.childDirectory('src').childDirectory('main').childFile(
      'AndroidManifest.xml',
    );
