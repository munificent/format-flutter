...
class AndroidStudioValidator extends DoctorValidator {
  AndroidStudioValidator(this._studio, {required FileSystem fileSystem, required UserMessages userMessages})
...
class NoAndroidStudioValidator extends DoctorValidator {
  NoAndroidStudioValidator({required Config config, required Platform platform, required UserMessages userMessages})
    : _config = config,
      _platform = platform,
      _userMessages = userMessages,
      super('Android Studio');
