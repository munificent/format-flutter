...
class AndroidStudioValidator extends DoctorValidator {
    ...
    return <DoctorValidator>[
      if (studios.isEmpty)
        ...
        ...studios.map<DoctorValidator>(
          (AndroidStudio studio) => AndroidStudioValidator(
            studio,
            fileSystem: fileSystem,
            userMessages: userMessages,
          ),
  ...
  Future<ValidationResult> validate() async {
    ...
    messages.add(
      ValidationMessage(_userMessages.androidStudioLocation(_studio.directory)),
    );
...
class NoAndroidStudioValidator extends DoctorValidator {
  ...
  Future<ValidationResult> validate() async {
    ...
    final String? cfgAndroidStudio =
        _config.getValue('android-studio-dir') as String?;
