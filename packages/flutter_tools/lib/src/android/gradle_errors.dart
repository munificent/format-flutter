...
final GradleHandledError licenseNotAcceptedHandler = GradleHandledError(
  ...
  handler: ({
    ...
    final RegExp licenseFailure = RegExp(
...
final RegExp _undefinedTaskPattern = RegExp(
  r'Task .+ not found in root project.',
);
...
final GradleHandledError minSdkVersionHandler = GradleHandledError(
  ...
  handler: ({
    ...
    globals.printBox(
      'The plugin ${minSdkVersionMatch?.group(
        3,
...
final GradleHandledError minCompileSdkVersionHandler = GradleHandledError(
  ...
  handler: ({
    ...
    final Match? minCompileSdkVersionMatch = _minCompileSdkVersionPattern
        .firstMatch(line);
