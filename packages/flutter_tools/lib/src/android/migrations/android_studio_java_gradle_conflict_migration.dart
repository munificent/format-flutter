...
@visibleForTesting
const String androidStudioNotFound = 'Android Studio version could not be detected, '
...
@visibleForTesting
const String javaVersionNot17 = 'Version of Java is different than impacted version, no migration attempted.';
@visibleForTesting
...
class AndroidStudioJavaGradleConflictMigration extends ProjectMigrator {
  ...
  String migrateFileContents(String fileContents) {
    ...
    if (gradleDistributionUrl == null || gradleDistributionUrl.groupCount < 1 || gradleDistributionUrl[1] == null) {
