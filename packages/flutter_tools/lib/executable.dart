...
List<FlutterCommand> generateCommands({required bool verboseHelp, required bool verbose}) => <FlutterCommand>[
  AnalyzeCommand(
    verboseHelp: verboseHelp,
    ...
    allProjectValidators: <ProjectValidator>[
      ...
      VariableDumpMachineProjectValidator(logger: globals.logger, fileSystem: globals.fs, platform: globals.platform),
    ],
