...
Future<void> main(List<String> args) {
  return runInContext<void>(() => run(args), overrides: <Type, Generator>{Usage: () => DisabledUsage()});
}
...
Future<void> writeDepfile(AssetBundle assets, String outputManifest, String depfilePath) async {
  final Depfile depfileContent = Depfile(assets.inputFiles, <libfs.File>[globals.fs.file(outputManifest)]);
  final DepfileService depfileService = DepfileService(fileSystem: globals.fs, logger: globals.logger);
