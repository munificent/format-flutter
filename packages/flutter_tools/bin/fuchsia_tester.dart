...
void main(List<String> args) {
  runInContext<void>(() => run(args), overrides: <Type, Generator>{Usage: () => DisabledUsage()});
}
...
Future<void> run(List<String> args) async {
  ...
  try {
    ...
    final Directory sdkRootDest = globals.fs.directory(artifacts.getArtifactPath(Artifact.flutterPatchedSdkPath));
