...
List<FakeDeviceJsonData> fakeDevices = <FakeDeviceJsonData>[
  FakeDeviceJsonData(FakeDevice('ephemeral', 'ephemeral', type: PlatformType.android), <String, Object>{
    'name': 'ephemeral',
    'id': 'ephemeral',
    'isSupported': true,
...
class FakeDevice extends Device {
  FakeDevice(
    ...
    LaunchResult? launchResult,
       ...
       super(id, platformType: type, category: Category.mobile, ephemeral: ephemeral);
...
class FakePollingDeviceDiscovery extends PollingDeviceDiscovery {
  FakePollingDeviceDiscovery({this.requiresExtendedWirelessDeviceDiscovery = false}) : super('mock');
