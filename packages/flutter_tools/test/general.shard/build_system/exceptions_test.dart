...
void main() {
  test('Exceptions', () {
    ...
    final MisplacedOutputException misplacedOutputException = MisplacedOutputException('foo', 'example');
    final MissingDefineException missingDefineException = MissingDefineException('foobar', 'example');
    ...
    expect(missingDefineException.toString(), 'Target example required define foobar but it was not provided');
  });
}
