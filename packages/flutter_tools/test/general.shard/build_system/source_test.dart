...
void main() {
  ...
  test(
    ...
    () => testbed.run(() {
      ...
      expect(
        visitor.sources.single.resolveSymbolicLinksSync(),
  ...
  test(
    ...
    () => testbed.run(() {
      const Source missingSource = Source.pattern(
        '{PROJECT_DIR}/foo',
        optional: true,
      );
  ...
  test(
    ...
    () => testbed.run(() {
      environment.buildDir.childFile('foo.d').writeAsStringSync(
        'a.dart : c.dart',
      );
