...
''');
  ...
  testWithoutContext(
    ...
    () {
      ...
      final File outputFile =
          fileSystem.directory(r'Hello Flutter').childFile('b.txt').absolute
            ..createSync();
      ...
      expect(
        outputDepfile.readAsStringSync(),
  ...
  testWithoutContext('Can escape depfile with spaces in directory names', () {
    ...
    expect(
      outputDepfile.readAsStringSync(),
      contains(r'/Hello\ Flutter/a.txt'),
    );
    expect(
      outputDepfile.readAsStringSync(),
      contains(r'/Hello\ Flutter/b.txt'),
    );
  });
...
''');
    ...
    expect(depfile.inputs.map((File file) => file.path), <String>[
      fileSystem.path.absolute(
        fileSystem.path.join('Users', 'foo', 'collection.dart'),
      ),
      fileSystem.path.absolute(
        fileSystem.path.join('Users', 'foo', 'algorithms.dart'),
      ),
      fileSystem.path.absolute(
