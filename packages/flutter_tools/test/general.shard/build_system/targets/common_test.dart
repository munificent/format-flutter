...
void main() {
  ...
  testWithoutContext(
    ...
    () async {
      ...
      await const KernelSnapshot().build(
        androidEnvironment..defines[kExtraFrontEndOptions] = '',
      );
  ...
  testWithoutContext(
    ...
    () async {
      ...
      await const KernelSnapshot().build(
        androidEnvironment
          ..defines[kTargetPlatform] = getNameForTargetPlatform(
  ...
  testUsingContext('AotElfProfile Produces correct output directory', () async {
    ...
    androidEnvironment.buildDir.childFile('app.dill').createSync(
      recursive: true,
    );

    await const AotElfProfile(TargetPlatform.android_arm).build(
      androidEnvironment,
    );
  ...
  testUsingContext(
    ...
    () async {
      ...
      await const AotElfRelease(TargetPlatform.android_arm).build(
        androidEnvironment,
      );
  ...
  testUsingContext(
    ...
    () async {
      ...
      expect(
        const AotElfProfile(TargetPlatform.android_arm).build(
          androidEnvironment,
        ),
        throwsA(isA<MissingDefineException>()),
      );
  ...
  testUsingContext(
    ...
    () async {
      expect(
        const AotAssemblyProfile().build(androidEnvironment),
        throwsException,
      );
    },
    overrides: <Type, Generator>{
