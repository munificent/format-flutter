...
void main() {
  testWithoutContext(
    ...
    () async {
      ...
      expect(
        fileSystem.file(r'C:\windows\flutter\ephemeral\flutter_export.h'),
        exists,
      );
      expect(
        fileSystem.file(r'C:\windows\flutter\ephemeral\flutter_messenger.h'),
        exists,
      );
      expect(
        fileSystem.file(r'C:\windows\flutter\ephemeral\flutter_windows.dll'),
        exists,
      );
      ...
      expect(
        fileSystem.file(r'C:\windows\flutter\ephemeral\flutter_windows.h'),
        exists,
      );
      expect(
        fileSystem.file('C:\\windows\\flutter\\ephemeral\\$icuData'),
        exists,
      );
      expect(fileSystem.file(
      ...
      final File outputDepfile = environment.buildDir.childFile(
  ...
  testUsingContext(
    ...
    () async {
      ...
      expect(
        fileSystem.file(r'C:\flutter_assets\io.flutter.shaders.json'),
        exists,
      );
      expect(
        fileSystem.file(
          r'C:\flutter_assets\io.flutter.shaders.json',
        ).readAsStringSync(),
        '{"data":{"A":"B"}}',
      );
    },
  ...
  testUsingContext(
    ...
    () async {
      ...
      expect(
        fileSystem.file(r'C:\flutter_assets\kernel_blob.bin').existsSync(),
        false,
      );
      expect(fileSystem.file(r'C:\flutter_assets\AssetManifest.json'), exists);
    },
