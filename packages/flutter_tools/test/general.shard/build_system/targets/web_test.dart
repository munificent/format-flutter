...
void main() {
  ...
  final Platform windows = FakePlatform(operatingSystem: 'windows', environment: <String, String>{});
    ...
    testbed = Testbed(
      setup: () {
        ...
        environment = Environment.test(
          ...
          defines: <String, String>{kTargetFile: globals.fs.path.join('foo', 'lib', 'main.dart')},
...
''');
  ...
  test(
    ...
    () => testbed.run(() async {
      ...
      expect(generated, contains('ui.webOnlyWarmupEngine('));
      expect(generated, contains('entrypoint.main as _'));
    }, overrides: <Type, Generator>{Platform: () => windows, TemplateRenderer: () => const MustacheTemplateRenderer()}),
  );
  ...
  test(
    ...
    () => testbed.run(() {
      ...
      final String result = generateServiceWorker(fileGeneratorsPath, <String, String>{
        '/foo': 'abcd',
      }, <String>[], serviceWorkerStrategy: ServiceWorkerStrategy.none);
  ...
  test(
    ...
    () => testbed.run(() {
      ...
      final String result = generateServiceWorker(fileGeneratorsPath, <String, String>{
        '/foo': 'abcd',
      }, <String>[], serviceWorkerStrategy: ServiceWorkerStrategy.offlineFirst);
  ...
  test(
    ...
    () => testbed.run(() async {
      ...
      final String fileGeneratorsPath = environment.artifacts.getArtifactPath(Artifact.flutterToolsFileGenerators);
      final String flutterJsContents = flutter_js.generateFlutterJsFile(fileGeneratorsPath);
      expect(environment.outputDir.childFile('flutter.js').readAsStringSync(), equals(flutterJsContents));
    }),
  );
  ...
  test(
    ...
    () => testbed.run(() async {
      ...
      final File canvasKitOutputBefore = environment.outputDir.childDirectory('canvaskit').childFile('canvaskit.wasm');
      ...
      final File canvasKitOutputAfter = environment.outputDir.childDirectory('canvaskit').childFile('canvaskit.wasm');
