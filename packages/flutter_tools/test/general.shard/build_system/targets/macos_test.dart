...
void main() {
  ...
  testUsingContext(
    ...
    () async {
      binary.createSync(recursive: true);
      final File entitlements = environment.outputDir.childFile(
        'entitlements.txt',
      );
      final File withoutEntitlements = environment.outputDir.childFile(
  ...
  testUsingContext(
    ...
    () async {
      fileSystem.directory(artifacts.getArtifactPath(
        Artifact.flutterMacOSFramework,
        mode: BuildMode.debug,
      )).createSync();
      final String inputKernel = fileSystem.path.join(
  ...
  testUsingContext(
    ...
    () async {
      ...
      final File outputFramework = fileSystem.file(fileSystem.path.join(
        environment.outputDir.path,
        'App.framework',
        'App',
      ));
  ...
  testUsingContext(
    ...
    () async {
      ...
      expect(usage.events, contains(
        const TestUsageEvent('assemble', 'macos-archive', label: 'success'),
      ));
    },
    overrides: <Type, Generator>{
      FileSystem: () => fileSystem,
    ...
    () async {
      ...
      processManager.addCommand(FakeCommand(
        command: <String>[
          ...
          '-o',
          environment.buildDir.childDirectory('App.framework').childFile(
            'App',
          ).path,
        ],
      ));
      ...
      processManager.addCommands(<FakeCommand>[
        FakeCommand(
          command: <String>[
            ...
            '--assembly=${environment.buildDir.childFile(
        ...
        FakeCommand(
          command: <String>[
            'lipo',
            environment.buildDir.childFile(
