...
void main() {
  ...
  group('syslog stream', () {
    ...
    testWithoutContext(
      'decodeSyslog passes through un-decodeable lines as-is',
      () {
...
''',
  ...
  group('VM service', () {
    ...
    testWithoutContext(
      ...
      () async {
        ...
        final Stream<String> debuggingLogs = Stream<String>.fromIterable(
          <String>['Message from debugger'],
        );
        ...
        await expectLater(
          logReader.logLines,
          emitsInAnyOrder(<Matcher>[equals('Message from debugger')]),
        );
      },
    );
  });
  ...
  group('debugger stream', () {
    ...
    testWithoutContext('errors on debugger stream closes log stream', () async {
      final Stream<String> debuggingLogs = Stream<String>.error(
        'ios-deploy error',
      );
      final IOSDeviceLogReader logReader = IOSDeviceLogReader.test(
        iMobileDevice: IMobileDevice(
      ...
      logReader.logLines.listen(
        null,
        onError: (Object error) => streamComplete.complete(),
      );
      logReader.debuggerStream = iosDeployDebugger;
      ...
      () async {
        ...
        await asyncGuard(
          () async {
            ...
            final FakeIOSDeployDebugger iosDeployDebugger =
  ...
  group('both syslog and debugger stream', () {
    testWithoutContext(
      'useBothLogDeviceReaders is true when CI option is true and sdk is at least 16',
      () {
        final IOSDeviceLogReader logReader = IOSDeviceLogReader.test(
          iMobileDevice: IMobileDevice(
            artifacts: artifacts,
    ...
    testWithoutContext(
      'useBothLogDeviceReaders is false when sdk is less than 16',
      () {
        final IOSDeviceLogReader logReader = IOSDeviceLogReader.test(
          iMobileDevice: IMobileDevice(
            artifacts: artifacts,
    ...
    testWithoutContext(
      'useBothLogDeviceReaders is false when CI option is false',
      () {
        final IOSDeviceLogReader logReader = IOSDeviceLogReader.test(
          iMobileDevice: IMobileDevice(
            artifacts: artifacts,
    ...
    testWithoutContext(
      'syslog only sends flutter messages to stream when useBothLogDeviceReaders is true',
      () async {
        processManager.addCommand(FakeCommand(
          command: <String>[ideviceSyslogPath, '-u', '1234'],
          stdout: '''
...
''',
    ...
    testWithoutContext(
      'IOSDeviceLogReader uses both syslog and ios-deploy debugger',
      () async {
        processManager.addCommand(FakeCommand(
          command: <String>[ideviceSyslogPath, '-u', '1234'],
          stdout: '''
...
''',
    ...
    testWithoutContext(
      'IOSDeviceLogReader only uses ios-deploy debugger when useBothLogDeviceReaders is false',
      () async {
        final Stream<String> debuggingLogs = Stream<String>.fromIterable(
          <String>[
            '(lldb) 2023-05-30 13:48:52.461894-0500 Runner[2019:1101495] [VERBOSE-2:FlutterDarwinContextMetalImpeller.mm(39)] Using the Impeller rendering backend.',
