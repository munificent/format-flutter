...
void main() {
  ...
  testWithoutContext('Android installation instructions', () {
    ...
    checkInstallationURL(
      (Platform platform) => userMessages.androidMissingSdkInstructions(
        platform,
      ),
    );
    checkInstallationURL(
    ...
    checkInstallationURL(
      (Platform platform) => userMessages.androidMissingSdkManager(
        '/',
        platform,
      ),
    );
    checkInstallationURL(
      (Platform platform) => userMessages.androidCannotRunSdkManager(
        '/',
        '',
        platform,
      ),
    ...
    checkInstallationURL(
      (Platform platform) => userMessages.androidSdkBuildToolsOutdated(
        0,
        '',
        platform,
      ),
    ...
    checkInstallationURL(
      (Platform platform) => userMessages.androidStudioInstallation(platform),
    );
  });
