...
void main() {
  ...
  group('GenSnapshot', () {
    ...
    testWithoutContext('iOS arm64', () async {
      ...
      processManager.addCommand(FakeCommand(
        command: <String>['${genSnapshotPath}_arm64', '--additional_arg'],
      ));
  ...
  group('AOTSnapshotter', () {
    ...
    testWithoutContext('builds iOS snapshot with dwarfStackTraces', () async {
      final String outputPath = fileSystem.path.join('build', 'foo');
      final String assembly = fileSystem.path.join(
        outputPath,
        'snapshot_assembly.S',
      );
      final String debugPath = fileSystem.path.join(
        'foo',
