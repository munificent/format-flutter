...
CommandHelp _createCommandHelp({required bool ansi, required int wrapColumn}) {
  ...
  return CommandHelp(
    ...
    platform: platform,
    outputPreferences:
        OutputPreferences.test(showColor: ansi, wrapColumn: wrapColumn),
  );
}
...
void _testMessageLength({
  ...
  expect(
    commandHelp.hWithDetails.toString().length,
    lessThanOrEqualTo(expectedWidth),
  );
  expect(
    commandHelp.hWithoutDetails.toString().length,
    lessThanOrEqualTo(expectedWidth),
  );
  expect(commandHelp.i.toString().length, lessThanOrEqualTo(expectedWidth));
    ...
    group('toString', () {
      testWithoutContext(
        ...
        () {
          ...
          expect(
            commandHelpOption.toString(),
            endsWith(AnsiTerminal.resetBold),
          );
        },
      );
      ...
      testWithoutContext(
        ...
        () {
          ...
          expect(
            ...
            endsWith('\x1B[90m(debugInvertOversizedImages)\x1B[39m\x1B[22m'),
          );
          expect(
            commandHelp.L.toString(),
            endsWith('\x1B[90m(debugDumpLayerTree)\x1B[39m\x1B[22m'),
          );
          expect(commandHelp.P.toString(), endsWith(
            '\x1B[90m(WidgetsApp.showPerformanceOverlay)\x1B[39m\x1B[22m',
          ));
          expect(
            commandHelp.S.toString(),
            endsWith('\x1B[90m(debugDumpSemantics)\x1B[39m\x1B[22m'),
          );
          expect(
          ...
          expect(
            ...
            endsWith('\x1B[90m(debugProfileWidgetBuilds)\x1B[39m\x1B[22m'),
          );
          expect(
            commandHelp.b.toString(),
            endsWith('\x1B[90m(debugBrightnessOverride)\x1B[39m\x1B[22m'),
          );
          expect(
            commandHelp.f.toString(),
            endsWith('\x1B[90m(debugDumpFocusTree)\x1B[39m\x1B[22m'),
          );
          expect(commandHelp.i.toString(), endsWith(
            '\x1B[90m(WidgetsApp.showWidgetInspectorOverride)\x1B[39m\x1B[22m',
          ));
          expect(
            commandHelp.o.toString(),
            endsWith('\x1B[90m(defaultTargetPlatform)\x1B[39m\x1B[22m'),
          );
          expect(
            commandHelp.p.toString(),
            endsWith('\x1B[90m(debugPaintSizeEnabled)\x1B[39m\x1B[22m'),
          );
          expect(
            commandHelp.t.toString(),
            endsWith('\x1B[90m(debugDumpRenderTree)\x1B[39m\x1B[22m'),
          );
          expect(
            commandHelp.w.toString(),
            endsWith('\x1B[90m(debugDumpApp)\x1B[39m\x1B[22m'),
          );
        },
      );
      ...
      testWithoutContext(
        ...
        () {
          ...
          expect(commandHelp.M.toString(), equals(
          ...
          expect(
            commandHelp.R.toString(),
            equals('\x1B[1mR\x1B[22m Hot restart.'),
          );
          ...
          expect(
            commandHelp.c.toString(),
            equals('\x1B[1mc\x1B[22m Clear the screen'),
          );
          expect(commandHelp.d.toString(), equals(
          ...
          expect(commandHelp.q.toString(), equals(
      ...
      testWithoutContext(
        ...
        () {
          ...
          expect(
            commandHelp.g.toString(),
            equals('g Run source code generators.'),
          );
          expect(
            commandHelp.hWithDetails.toString(),
          ...
          expect(
            commandHelp.r.toString(),
            equals('r Hot reload. $fire$fire$fire'),
          );
          expect(
            commandHelp.s.toString(),
