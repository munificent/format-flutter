...
void main() {
  ...
  group('host platform', () {
    ...
    testWithoutContext(
      'Linux name when reading "/etc/os-release" fails',
      () async {
    ...
    testWithoutContext('Windows validates paths when unzipping', () {
      ...
      expect(() => utils.unzip(fakeZipFile, targetDirectory), throwsA(
      ...
      fakeProcessManager.addCommands(<FakeCommand>[
        FakeCommand(
          ...
          onRun: () {
            ...
            tempDirectory.childDirectory('dirA').childFile('fileA').createSync(
              recursive: true,
            );
            tempDirectory.childDirectory('dirB').childFile('fileB').createSync(
              recursive: true,
            );
          },
        ),
