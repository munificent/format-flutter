...
class MockFlutterDebugAdapter extends FlutterDebugAdapter {
  ...
  Stream<Map<String, Object?>> get dapToClientProgressEvents {
    ...
    return dapToClientMessages.where(
      (Map<String, Object?> message) => progressEventTypes.contains(
  ...
  List<String> get dapToFlutterRequests => dapToFlutterMessages.map(
    (Map<String, Object?> message) => message['method'] as String?,
  ).whereNotNull().toList();
