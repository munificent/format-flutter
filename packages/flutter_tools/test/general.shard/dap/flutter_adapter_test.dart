  ...
  group('flutter adapter', () {
    ...
    group('launchRequest', () {
      test('runs "flutter run" with --machine', () async {
        ...
        final FlutterLaunchRequestArguments args =
            FlutterLaunchRequestArguments(cwd: '/project', program: 'foo.dart');
      ...
      group('supportsRestartRequest', () {
        void testRestartSupport(bool supportsRestart) {
          test(
            'notifies client for supportsRestart: $supportsRestart',
            () async {
              final MockFlutterDebugAdapter adapter = MockFlutterDebugAdapter(
                fileSystem: MemoryFileSystem.test(style: fsStyle),
                platform: platform,
              ...
              final Future<CapabilitiesEventBody> capabilitiesUpdate =
    ...
    group('attachRequest', () {
      test('runs "flutter attach" with --machine', () async {
        ...
        final FlutterAttachRequestArguments args =
            FlutterAttachRequestArguments(cwd: '/project');
      ...
      test(
        'runs "flutter attach" with --debug-uri if vmServiceUri is passed',
        () async {
          final MockFlutterDebugAdapter adapter = MockFlutterDebugAdapter(
            fileSystem: MemoryFileSystem.test(style: fsStyle),
            platform: platform,
      ...
      test(
        'runs "flutter attach" with --debug-uri if vmServiceInfoFile exists',
        () async {
          final MockFlutterDebugAdapter adapter = MockFlutterDebugAdapter(
            fileSystem: MemoryFileSystem.test(style: fsStyle),
            platform: platform,
    ...
    group('maps org-dartlang-sdk paths', () {
      ...
      test('dart:ui file path to URI', () async {
        expect(
          adapter.convertPathToOrgDartlangSdk(fs.path.join(
            flutterRoot,
            'bin',
            'cache',
            'pkg',
