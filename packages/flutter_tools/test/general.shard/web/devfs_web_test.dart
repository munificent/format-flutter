...
void main() {
  ...
  setUpAll(() async {
    packages = PackageConfig(<Package>[Package('flutter_tools', Uri.file('/flutter_tools/lib/').normalizePath())]);
  });
  ...
  test(
    ...
    () => testbed.run(() async {
      ...
      final File manifestMissingOffset = globals.fs.file('manifestA')..writeAsStringSync(json.encode(<String, Object>{
      ...
      final File manifestOutOfBounds = globals.fs.file('manifest')..writeAsStringSync(json.encode(<String, Object>{
        '/foo.js': <String, Object>{
          'code': <int>[0, 100],
          'sourcemap': <int>[0],
          'metadata': <int>[0],
  ...
  test(
    ...
    () => testbed.run(() async {
      ...
      final File sourcemap = globals.fs.file('sourcemap')..writeAsStringSync('{}');
      final File metadata = globals.fs.file('metadata')..writeAsStringSync('{}');
      final File manifest = globals.fs.file('manifest')..writeAsStringSync(json.encode(<String, Object>{
        '/foo.js': <String, Object>{
      ...
      final Response response = await webAssetServer.handleRequest(Request('GET', Uri.parse('http://foobar/foo.js')));
  ...
  test(
    ...
    () => testbed.run(() async {
      ...
      final Response response =
          await webAssetServer.handleRequest(Request('GET', Uri.parse('http://foobar////foo.png')));
  ...
  test(
    ...
    () => testbed.run(() async {
      ...
      final File source = globals.fs.file(globals.fs.path.join('web', 'foo.png'))
        ...
        ..writeAsBytesSync(kTransparentImage);
      final Response response =
          await webAssetServer.handleRequest(Request('GET', Uri.parse('http://foobar/base/path/foo.png')));
  ...
  test(
    ...
    () => testbed.run(() async {
      ...
      final Response response =
          await webAssetServer.handleRequest(Request('GET', Uri.parse('http://foobar/base/path/')));
  ...
  test(
    ...
    () => testbed.run(() async {
      ...
      final Response response = await webAssetServer.handleRequest(Request('GET', Uri.parse('http://foobar/')));
  ...
  test(
    ...
    () => testbed.run(() async {
      ...
      final Response cachedResponse = await webAssetServer.handleRequest(Request(
        'GET',
  ...
  test(
    ...
    () => testbed.run(() async {
      ...
      final Response response = await webAssetServer.handleRequest(Request('GET', Uri.parse('http://foobar/bar/baz')));
  ...
  test(
    ...
    () => testbed.run(() async {
      ...
      Response response =
          await webAssetServer.handleRequest(Request('GET', Uri.parse('http://foobar/assets/foo/bar.png')));
      expect(response.statusCode, HttpStatus.notFound);

      response =
          await webAssetServer.handleRequest(Request('GET', Uri.parse('http://foobar/packages/foo/bar.dart.js')));
      expect(response.statusCode, HttpStatus.notFound);

      webAssetServer.basePath = 'base/path';

      response =
          await webAssetServer.handleRequest(Request('GET', Uri.parse('http://foobar/base/path/assets/foo/bar.png')));
      expect(response.statusCode, HttpStatus.notFound);
  ...
  test(
    ...
    () => testbed.run(() async {
      ...
      final Response response =
          await webAssetServer.handleRequest(Request('GET', Uri.parse('http://foobar/foo.dart.js')));
  ...
  test(
    ...
    () => testbed.run(() async {
      ...
      webAssetServer.write(source, manifest, sourcemap, metadata);
      final Response response =
          await webAssetServer.handleRequest(Request('GET', Uri.parse('http://localhost/foo.js')));
  ...
  test(
    ...
    () => testbed.run(() async {
      final File source =
          globals.fs.file(globals.fs.path.join('build', 'flutter_assets', Uri.encodeFull('abcd象形字.png')))
            ..createSync(recursive: true)
            ..writeAsBytesSync(kTransparentImage);
      final Response response = await webAssetServer.handleRequest(
        Request('GET', Uri.parse('http://foobar/assets/abcd%25E8%25B1%25A1%25E5%25BD%25A2%25E5%25AD%2597.png')),
      );
  ...
  test(
    ...
    () => testbed.run(() async {
      final File source = globals.fs.file(globals.fs.path.join('web', 'foo.png'))
        ..createSync(recursive: true)
        ..writeAsBytesSync(kTransparentImage);
      final Response response = await webAssetServer.handleRequest(Request('GET', Uri.parse('http://foobar/foo.png')));
  ...
  test(
    ...
    () => testbed.run(() async {
      final File source = globals.fs.file(globals.fs.path.join('build', 'flutter_assets', 'foo.png'))
        ...
        ..writeAsBytesSync(kTransparentImage);
      final Response response =
          await webAssetServer.handleRequest(Request('GET', Uri.parse('http://foobar/assets/foo.png')));
  ...
  test(
    ...
    () => testbed.run(() async {
      ...
      final Response response = await webAssetServer.handleRequest(Request('GET', Uri.parse('http://foobar/foo.dart')));
  ...
  test(
    ...
    () => testbed.run(() async {
      final File source = globals.fs.file(globals.fs.path.join('web', 'foo.js'))..createSync(recursive: true);
  ...
  test(
    ...
    () => testbed.run(() async {
      ...
      final Response response =
          await webAssetServer.handleRequest(Request('GET', Uri.parse('http://foobar/assets/fooπ')));
      final String etag = response.headers[HttpHeaders.etagHeader]!;
  ...
  test(
    ...
    () => testbed.run(() async {
      ...
      final Response response =
          await webAssetServer.handleRequest(Request('GET', Uri.parse('http:///packages/flutter_tools/foo.dart')));
  ...
  test(
    ...
    () => testbed.run(() async {
      final File outputFile = globals.fs.file(globals.fs.path.join('lib', 'main.dart'))..createSync(recursive: true);
      outputFile.parent.childFile('a.sources').writeAsStringSync('');
      outputFile.parent.childFile('a.json').writeAsStringSync('{}');
      outputFile.parent.childFile('a.map').writeAsStringSync('{}');
      outputFile.parent.childFile('a.metadata').writeAsStringSync('{}');

      final ResidentCompiler residentCompiler = FakeResidentCompiler()..output = const CompilerOutput('a', 0, <Uri>[]);
      ...
      final WebDevFS webDevFS = WebDevFS(
        ...
        buildInfo: const BuildInfo(BuildMode.debug, '', treeShakeIcons: false, nullSafetyMode: NullSafetyMode.unsound),
        enableDwds: false,
        enableDds: false,
        entrypoint: Uri.base,
        testMode: true,
      ...
      final String webPrecompiledSdk = globals.artifacts!.getHostArtifact(HostArtifact.webPrecompiledSdk).path;
      final String webPrecompiledSdkSourcemaps =
          globals.artifacts!.getHostArtifact(HostArtifact.webPrecompiledSdkSourcemaps).path;
      final String webPrecompiledCanvaskitSdk =
          globals.artifacts!.getHostArtifact(HostArtifact.webPrecompiledCanvaskitSdk).path;
      final String webPrecompiledCanvaskitSdkSourcemaps =
          globals.artifacts!.getHostArtifact(HostArtifact.webPrecompiledCanvaskitSdkSourcemaps).path;
      ...
      expect(await webDevFS.webAssetServer.dartSourceContents('web_entrypoint.dart'), contains('GENERATED'));
  ...
  test(
    ...
    () => testbed.run(() async {
      ...
      globals.fs.currentDirectory.childDirectory('lib').childFile('web_entrypoint.dart')
        ..createSync(recursive: true)
        ..writeAsStringSync('GENERATED');
      final String webPrecompiledSdk = globals.artifacts!.getHostArtifact(HostArtifact.webPrecompiledSoundSdk).path;
      final String webPrecompiledSdkSourcemaps =
          globals.artifacts!.getHostArtifact(HostArtifact.webPrecompiledSoundSdkSourcemaps).path;
      final String webPrecompiledCanvaskitSdk =
          globals.artifacts!.getHostArtifact(HostArtifact.webPrecompiledCanvaskitSoundSdk).path;
      final String webPrecompiledCanvaskitSdkSourcemaps =
          globals.artifacts!.getHostArtifact(HostArtifact.webPrecompiledCanvaskitSoundSdkSourcemaps).path;
      globals.fs.file(webPrecompiledSdk)
        ..createSync(recursive: true)
        ..writeAsStringSync('HELLO');
      globals.fs.file(webPrecompiledSdkSourcemaps)
      ...
      await FakeAsync().run<Future<void>>((FakeAsync time) {
        ...
        final Future<void> done = webDevFS.create().then<void>((Uri _) {
          ...
          Future<vm_service.VmService> vmServiceFactory(
            ...
            return Future<vm_service.VmService>.delayed(const Duration(seconds: 2), () => FakeVmService());
          }
  ...
  test(
    ...
    () => testbed.run(() async {
      final Response response =
          await webAssetServer.handleRequest(Request('POST', Uri.parse('http://foobar/something')));
  ...
  test(
    ...
    () => testbed.run(() async {
      final Response response = await releaseAssetServer.handle(Request('POST', Uri.parse('http://foobar/something')));
      expect(response.statusCode, 404);
    }),
  );
...
class FakeDwds extends Fake implements Dwds {
  FakeDwds(this.connectedAppsIterable) : connectedApps = Stream<AppConnection>.fromIterable(connectedAppsIterable);
  ...
  @override
  Future<DebugConnection> debugConnection(AppConnection appConnection) => Future<DebugConnection>.value(
    FakeDebugConnection(),
  );
}
