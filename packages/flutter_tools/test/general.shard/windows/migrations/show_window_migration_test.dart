...
void main() {
  group('Windows Flutter show window migration', () {
    ...
    testWithoutContext('skipped if already migrated', () {
      const String flutterWindowContents = '  flutter_controller_->engine()->SetNextFrameCallback([&]() {\n'
          '    this->Show();\n'
          '  });\n'
          '\n'
    ...
    testWithoutContext('migrates project to ensure window is shown', () {
      ...
      expect(
        ...
        contains('windows/runner/flutter_window.cpp does not ensure the show window callback is called, updating.'),
      );
    });
