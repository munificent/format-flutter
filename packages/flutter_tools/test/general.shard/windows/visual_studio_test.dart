...
void main() {
  group('Visual Studio', () {
    testWithoutContext(
      ...
      () {
        ...
        expect(() => visualStudio.isInstalled, throwsToolExit(
    ...
    testWithoutContext(
      ...
      () {
        ...
        final Map<String, dynamic> response = Map<String, dynamic>.of(
    ...
    testWithoutContext(
      ...
      () {
        ...
        expect(
          ...
          equals('Visual Studio Community 2019'),
        );
    ...
    testWithoutContext(
      ...
      () {
        ...
        // Return a different version for queries without the required packages.
        final Map<String, dynamic> incompleteVersionResponse =
            <String, dynamic>{
          'installationPath': visualStudioPath,
          'displayName': 'Visual Studio Community 2019',
        ...
        expect(
          visualStudio.displayName,
          equals('Visual Studio Community 2017'),
        );
    ...
    testWithoutContext(
      'SDK version returns the latest version when present',
      () {
        final VisualStudioFixture fixture = setUpVisualStudio();
        final VisualStudio visualStudio = fixture.visualStudio;
  ...
  group('Correctly handles bad UTF-8 from vswhere.exe output', () {
    ...
    testWithoutContext(
      'Throws ToolExit on bad UTF-8 in installationVersion',
      () {
        final Map<String, dynamic> response = Map<String, dynamic>.of(
          _defaultResponse,
    ...
    testWithoutContext(
      "Ignores bad UTF-8 in catalog's productDisplayVersion",
      () {
