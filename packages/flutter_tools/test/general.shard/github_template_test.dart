  ...
  group('GitHub template creator', () {
    ...
    group('sanitized error message', () {
      ...
      testWithoutContext('SocketException', () {
        expect(GitHubTemplateCreator.sanitizedCrashException(SocketException(
          'message',
...
#1      _rootRunUnary (dart:async/zone.dart:1141:38)''');
        expect(GitHubTemplateCreator.sanitizedCrashException(DevFSException(
          'message',
...
''');
          ...
          final File pluginsFile = projectDirectory.childFile(
            '.flutter-plugins',
          );
...
project_type: app
        ''');
          ...
          final String actualURL = await creator
          ...
          final String? actualBody =
              Uri.parse(actualURL).queryParameters['body'];
