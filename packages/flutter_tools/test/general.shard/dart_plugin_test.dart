  ...
  group('Dart plugin registrant', () {
    ...
    setUp(() async {
      ...
      flutterProject = FakeFlutterProject()
        ...
        ..flutterPluginsDependenciesFile = directory.childFile(
          '.flutter-plugins-dependencies',
        )
        ..dartPluginRegistrant = directory.childFile(
    ...
    group('resolvePlatformImplementation', () {
      ...
      testWithoutContext('selects inline implementation on mobile', () async {
        ...
        resolutions = resolvePlatformImplementation(<Plugin>[
          Plugin.fromYaml(
            'url_launcher',
            '',
            YamlMap.wrap(<String, dynamic>{
...
''',
          ...
          final Directory libDir = flutterProject.directory.childDirectory(
            'lib',
          );
...
''');
          final PackageConfig packageConfig =
              await loadPackageConfigWithLogging(flutterProject.directory
                  .childDirectory('.dart_tool')
                  .childFile(
                    'package_config.json',
                  ), logger: globals.logger, throwOnError: false);
