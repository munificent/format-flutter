  ...
  group('FlutterCommandRunner', () {
    ...
    group('run', () {
      testUsingContext(
        ...
        () async {
          final FlutterCommandRunner runner = createTestCommandRunner(
            DummyFlutterCommand(),
      ...
      testUsingContext(
        ...
        () async {
          final FlutterCommand command = DummyFlutterCommand(
      ...
      group('getRepoPackages', () {
        ...
        setUp(() {
          ...
          fileSystem.directory(
            fileSystem.path.join(_kFlutterRoot, 'examples'),
          ).createSync(recursive: true);
          fileSystem.directory(
            fileSystem.path.join(_kFlutterRoot, 'packages'),
          ).createSync(recursive: true);
          fileSystem.directory(
          ...
          fileSystem.file(
            fileSystem.path.join(_kFlutterRoot, 'dev', 'tools', 'pubspec.yaml'),
          ).createSync();
        ...
        testUsingContext(
          ...
          () {
            ...
            expect(packagePaths, <String>[
              ...
              fileSystem.directory(
                fileSystem.path.join(_kFlutterRoot, 'dev', 'tools'),
              ).path,
            ]);
          },
          overrides: <Type, Generator>{
