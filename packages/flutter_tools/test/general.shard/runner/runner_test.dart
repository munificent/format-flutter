  ...
  group('runner', () {
    ...
    testUsingContext(
      ...
      () async {
        ...
        // attempt.
        final CrashingUsage crashingUsage =
            globals.flutterUsage as CrashingUsage;
        expect(
          crashingUsage.sentException.toString(),
    ...
    testUsingContext(
      ...
      () async {
        ...
        expect(errorText, containsIgnoringWhitespace(
        ...
        expect(
          sentDetails.stackTrace.toString(),
    ...
    group('in directory without permission', () {
      setUp(() {
        ...
        final Directory currentDirectory = fileSystem.directory(
          '/current_directory',
        );
      ...
      testUsingContext(
        ...
        () async {
          ...
          final File log = globals.fs.systemTempDirectory.childFile(
            'flutter_01.log',
          );
          final String logContents = log.readAsStringSync();
          expect(logContents, contains(kCustomBugInstructions));
...
class CrashingUsage implements Usage {
  CrashingUsage()
    : _impl = Usage(versionOverride: '[user-branch]', runningOnBot: true);
  ...
  @override
  void sendCommand(String command, {CustomDimensions? parameters}) => _impl
      .sendCommand(command, parameters: parameters);
