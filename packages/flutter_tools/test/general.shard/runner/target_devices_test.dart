...
void main() {
  testWithoutContext(
    ...
    () async {
      ...
      expect(
        targetDevices is TargetDevicesWithExtendedWirelessDeviceDiscovery,
        true,
      );
    },
  );
  ...
  testWithoutContext(
    'Ensure factory returns default when not on MacOS',
    () async {
      final BufferLogger logger = BufferLogger.test();
  ...
  group('findAllTargetDevices on non-MacOS platform', () {
    ...
    final FakeDevice attachedAndroidDevice1 = FakeDevice(
      deviceName: 'target-device-1',
    );
    final FakeDevice attachedAndroidDevice2 = FakeDevice(
    ...
    final FakeDevice wirelessAndroidDevice1 = FakeDevice.wireless(
      deviceName: 'target-device-5',
    );
    final FakeDevice wirelessAndroidDevice2 = FakeDevice.wireless(
    ...
    final FakeDevice fuchsiaDevice = FakeDevice.fuchsia(
      deviceName: 'target-device-10',
    );

    final FakeDevice exactMatchAndroidDevice = FakeDevice(
...
'''));
    ...
    testUsingContext(
      'ensure refresh when deviceDiscoveryTimeout is provided',
      () async {
        final BufferLogger logger = BufferLogger.test();
        final TestDeviceManager deviceManager = TestDeviceManager(
          logger: logger,
...
'''));
        ...
        testUsingContext('when no devices match', () async {
          ...
          final FakeDevice device2 = FakeDevice.wireless(
...
'''));
        ...
        testUsingContext(
          'when matching device is unsupported by flutter',
          () async {
            deviceManager.androidDiscoverer.deviceList = <Device>[
...
'''));
    ...
    group('finds single device', () {
      ...
      group('with hasSpecifiedDeviceId', () {
        ...
        testUsingContext(
          'when matching device is unsupported by project',
          () async {
            deviceManager.androidDiscoverer.deviceList = <Device>[
...
'''));
  ...
  group('findAllTargetDevices on mac platform', () {
    ...
    final FakeIOSDevice attachedIOSDevice1 = FakeIOSDevice(
      deviceName: 'target-device-1',
    );
    final FakeIOSDevice attachedIOSDevice2 = FakeIOSDevice(
      deviceName: 'target-device-2',
    );
    ...
    final FakeIOSDevice exactMatchAttachedIOSDevice = FakeIOSDevice(
      deviceName: 'target-device',
    );
...
'''));
        ...
        testUsingContext(
          'when only matching device is dev mode disabled',
          () async {
            deviceManager.iosDiscoverer.deviceList = <Device>[
...
'''));
        ...
        testUsingContext(
          'when one of the matching devices has dev mode disabled',
          () async {
            deviceManager.iosDiscoverer.deviceList = <Device>[
              FakeIOSDevice(
                deviceName: 'target-device-1',
...
'''));
        ...
        testUsingContext(
          'when all matching devices are dev mode disabled',
          () async {
            deviceManager.iosDiscoverer.deviceList = <Device>[
              FakeIOSDevice(
                deviceName: 'target-device-1',
...
'''));
        ...
        testUsingContext(
          'when multiple but only one attached ephemeral',
          () async {
            deviceManager.iosDiscoverer.deviceList = <Device>[
              nonEphemeralDevice,
              attachedIOSDevice1,
...
'''));
          ...
          expect(
            devices?.first.connectionInterface,
            DeviceConnectionInterface.wireless,
          );
          expect(deviceManager.iosDiscoverer.devicesCalled, 1);
          expect(deviceManager.iosDiscoverer.discoverDevicesCalled, 1);
        ...
        testUsingContext(
          'when partially matching single wireless devices',
          () async {
...
'''));
        ...
        testUsingContext(
          'when partially matching single attached device',
          () async {
            deviceManager.iosDiscoverer.deviceList = <Device>[
              attachedIOSDevice1,
            ];
        ...
        testUsingContext(
          ...
          () async {
            final FakeDevice androidDevice = FakeDevice(
              deviceName: 'target-device-android',
            );
            deviceManager.androidDiscoverer.deviceList = <Device>[
              androidDevice,
            ];
...
'''));
        ...
        testUsingContext(
          'when matching single non-ephemeral attached device',
          () async {
            deviceManager.iosDiscoverer.deviceList = <Device>[
              nonEphemeralDevice,
            ];
...
class TestDeviceManager extends DeviceManager {
  ...
  final TestPollingDeviceDiscovery androidDiscoverer =
      TestPollingDeviceDiscovery('android');
...
class FakeDevice extends Fake implements Device {
  ...
  @override
  Future<String>
  get targetPlatformDisplayName async => getNameForTargetPlatform(
