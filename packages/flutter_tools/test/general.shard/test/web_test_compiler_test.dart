...
void main() {
  testUsingContext('web test compiler issues valid compile command', () async {
    ...
    final Config config = Config(Config.kFlutterSettings, fileSystem: fileSystem, logger: logger, platform: platform);
    ...
    const BuildInfo buildInfo = BuildInfo(BuildMode.debug, '', treeShakeIcons: false);
