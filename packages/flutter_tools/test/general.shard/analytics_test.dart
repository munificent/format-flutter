  ...
  group('analytics', () {
    ...
    testUsingContext(
      ...
      overrides: <Type, Generator>{
        FlutterVersion: () => FakeFlutterVersion(),
        Config: () => testConfig,
        Platform: () => FakePlatform(environment: <String, String>{'FLUTTER_ANALYTICS_LOG_FILE': 'test'}),
        FileSystem: () => fs,
  ...
  group('analytics with fakes', () {
    ...
    testUsingContext(
      ...
      () async {
        ...
        expect(
          testUsage.timings,
          contains(const TestTimingEvent('flutter', 'doctor', Duration(milliseconds: 1000), label: 'success')),
        );
      },
      overrides: <Type, Generator>{
    ...
    testUsingContext(
      ...
      () async {
        ...
        expect(
          testUsage.timings,
          contains(const TestTimingEvent('flutter', 'doctor', Duration(milliseconds: 1000), label: 'warning')),
        );
      },
      overrides: <Type, Generator>{
        AndroidStudio: () => androidStudio,
    ...
    testUsingContext(
      ...
      overrides: <Type, Generator>{
        ...
        ProcessManager: () => FakeProcessManager.any(),
        SystemClock: () => fakeClock,
        Platform: () => FakePlatform(environment: <String, String>{'FLUTTER_ANALYTICS_LOG_FILE': 'analytics.log'}),
        Stdio: () => fakeStdio,
      },
    );
