...
void main() {
  for (final bool asyncScanning in <bool>[true, false]) {
    testWithoutContext(
      'No last compile, asyncScanning: $asyncScanning',
      () async {
    ...
    testWithoutContext(
      'Empty project, asyncScanning: $asyncScanning',
      () async {
        final FileSystem fileSystem = MemoryFileSystem.test();
        final ProjectFileInvalidator projectFileInvalidator =
            ProjectFileInvalidator(
    ...
    testWithoutContext(
      ...
      () async {
        final DateTime past = DateTime.now().subtract(
    ...
    testWithoutContext(
      ...
      () async {
        ...
        final InvalidationResult
        nextInvalidationResult = await projectFileInvalidator.findInvalidated(
        ...
        expect(
          nextInvalidationResult.packageConfig,
