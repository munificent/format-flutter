...
void main() {
  group('fuchsia device', () {
    ...
    testWithoutContext(
      'lists nothing when workflow cannot list devices',
      () async {
  ...
  group('displays friendly error when', () {
    ...
    testUsingContext(
      ...
      overrides: <Type, Generator>{
        ProcessManager: () => processManager,
        FuchsiaArtifacts:
            () => FuchsiaArtifacts(sshConfig: artifactFile, ffx: artifactFile),
        FuchsiaSdk: () => FakeFuchsiaSdk(),
      },
    );
  ...
  ''';
      ...
      testUsingContext(
        ...
        overrides: <Type, Generator>{
          ProcessManager: () => processManager,
          SystemClock:
              () => SystemClock.fixed(DateTime(2018, 11, 9, 1, 25, 45)),
          FuchsiaArtifacts:
      ...
      testUsingContext(
        ...
        overrides: <Type, Generator>{
          ProcessManager: () => processManager,
          SystemClock:
              () => SystemClock.fixed(DateTime(2018, 11, 9, 1, 29, 45)),
          FuchsiaArtifacts:
              () => FuchsiaArtifacts(sshConfig: sshConfig, ffx: ffx),
        },
      );
  ...
  group('portForwarder', () {
    ...
    testUsingContext(
      ...
      () async {
        ...
        await expectLater(
          () => device.portForwarder.unforward(
            ForwardedPort(/*hostPort=*/ 0, /*devicePort=*/ 1),
          ),
          throwsToolExit(
            message:
  ...
  group('FuchsiaIsolateDiscoveryProtocol', () {
    ...
    testUsingContext(
      ...
      () async {
        ...
        expect(
          uri.toString(),
          'http://${InternetAddress.loopbackIPv4.address}:0/',
        );
      },
    );
