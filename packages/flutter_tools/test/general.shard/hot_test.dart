...
void main() {
  group('validateReloadReport', () {
    testUsingContext('invalid', () async {
      ...
      expect(HotRunner.validateReloadReport(vm_service.ReloadReport.parse(
        <String, dynamic>{'type': 'ReloadReport', 'success': true},
      )), true);
    });
      ...
      testUsingContext(
        ...
        () async {
          ...
          final OperationResult result = await HotRunner(
            ...
            ) async => ReassembleResult(<FlutterView?, FlutterVmService?>{
              null: null,
            }, false, true),
          ).restart();
          expect(result.isOk, false);
    ...
    group('successful hot restart', () {
      ...
      testUsingContext(
        ...
        () async {
          ...
          final FakeStopwatchFactory fakeStopwatchFactory =
          ...
          (fakeFlutterDevice.devFS! as FakeDevFs).baseUri = Uri.parse(
            'file:///base_uri',
          );
    ...
    group('hot reload that failed to sync dev fs', () {
      ...
      testUsingContext(
        ...
        () async {
          ...
          await expectLater(runner.restart(), throwsA(isA<Exception>().having(
            (Exception e) => e.toString(),
            'message',
            'Exception: updateDevFS failed',
          )));
