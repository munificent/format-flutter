...
void main() {
  ...
  testWithoutContext(
    'getDartNameForDarwinArch returns name used in Dart SDK',
    () {
  ...
  testWithoutContext('getNameForTargetPlatform on Darwin arches', () {
    expect(getNameForTargetPlatform(
      TargetPlatform.ios,
    ...
    expect(
      getNameForTargetPlatform(TargetPlatform.android),
      isNot(contains('ios')),
    );
  });
  ...
  testWithoutContext('defaultIOSArchsForEnvironment', () {
    ...
    expect(
      defaultIOSArchsForEnvironment(EnvironmentType.physical, Artifacts.test())
          .single,
      DarwinArch.arm64,
    );
  ...
  testWithoutContext(
    ...
    () {
      ...
      expect(
        encodeDartDefines(<String>['true', 'false', 'flase']),
  ...
  testWithoutContext(
    'decodeDartDefines decodes base64 encoded dart defines',
    () {
      expect(
