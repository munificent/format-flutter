...
void main() {
  testWithoutContext('state can be set and persists', () {
    ...
    final PersistentToolState state1 = PersistentToolState.test(directory: directory, logger: BufferLogger.test());
    ...
    final PersistentToolState state2 = PersistentToolState.test(directory: directory, logger: BufferLogger.test());
