...
void main() {
  ...
  testUsingContext(
    ...
    () async {
      ...
      fakeVmServiceHost = FakeVmServiceHost(
        requests: kAttachExpectations.toList(),
      );
      setupMocks();
    ...
    () async {
      ...
      expect(
        await fileSystem.file(
          fileSystem.path.join('build', 'cache.dill'),
        ).readAsString(),
        'ABC',
      );
    },
  ...
  testUsingContext(
    ...
    () async {
      ...
      expect(
        await fileSystem.file(
          fileSystem.path.join('build', 'cache.dill.track.dill'),
        ).readAsString(),
        'ABC',
      );
    },
  ...
  testUsingContext(
    ...
    () async {
      ...
      fileSystem.file(globals.fs.path.join('lib', 'main.dart')).createSync(
        recursive: true,
      );
...
''');
  ...
  testUsingContext(
    ...
    () async {
      ...
      DebuggingOptions debuggingOptions = DebuggingOptions.enabled(
        BuildInfo.debug,
        port: '65536',
      );
