...
void main() {
  group('CachedArtifacts', () {
    ...
    testWithoutContext('getArtifactPath', () {
      ...
      expect(xcframeworkPath, fileSystem.path.join(
        'root',
        'bin',
        'cache',
        'artifacts',
      ...
      expect(actualReleaseFrameworkArtifact, anyOf(
    ...
    testWithoutContext('precompiled web artifact paths are correct', () {
      ...
      expect(
        artifacts.getHostArtifact(
          HostArtifact.webPrecompiledSdkSourcemaps,
        ).path,
      ...
      expect(
        artifacts.getHostArtifact(
          HostArtifact.webPrecompiledSoundSdkSourcemaps,
        ).path,
  ...
  group('LocalEngineArtifacts', () {
    ...
    setUp(() {
      ...
      artifacts = CachedLocalWebSdkArtifacts(
        ...
        webSdkPath: fileSystem.path.join(
          fileSystem.currentDirectory.path,
          'out',
          'wasm_release',
        ),
    ...
    testWithoutContext(
      'Finds dart-sdk in windows prebuilts for web platform',
      () async {
        artifacts = CachedLocalWebSdkArtifacts(
          parent: CachedLocalEngineArtifacts(
            fileSystem.path.join(
    ...
    testWithoutContext(
      'Finds dart-sdk in macos prebuilts for web platform',
      () async {
        artifacts = CachedLocalWebSdkArtifacts(
          parent: CachedLocalEngineArtifacts(
            fileSystem.path.join(
