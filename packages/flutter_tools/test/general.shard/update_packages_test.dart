  ...
  testWithoutContext(
    ...
    () {
      ...
      final Directory extra = flutterSdk
          ...
          .childDirectory('extra')..createSync(recursive: true);
...
''');
      ...
      expect(
        fileSystem.directory('${result.path}/bin/cache/pkg/sky_engine'),
        exists,
      );

      // The flutter pubspec exists
      final File pubspecFile = fileSystem.file(
        '${result.path}/packages/flutter/pubspec.yaml',
      );
