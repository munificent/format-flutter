...
void main() {
  ...
  setUp(() {
    ...
    fakeVmServiceHost = FakeVmServiceHost(
      requests: <VmServiceExpectation>[
        ...
        const FakeVmServiceRequest(method: 'streamListen', args: <String, Object>{'streamId': 'Extension'}),
      ],
    );
  });
  ...
  testUsingContext('will not start when package missing', () async {
    await expectLater(
      ...
      throwsA(isA<TestDeviceException>().having(
  ...
  testUsingContext(
    ...
    () async {
      final TestDevice testDevice = IntegrationTestTestDevice(
        id: 1,
        device:
            FakeDevice('ephemeral', 'ephemeral', type: PlatformType.android, launchResult: LaunchResult.succeeded()),
        debuggingOptions: DebuggingOptions.enabled(BuildInfo.debug),
        userIdentifier: '',
        compileExpression: null,
      );
  ...
  testUsingContext(
    ...
    () async {
      final TestDevice testDevice = IntegrationTestTestDevice(
        id: 1,
        device: FakeDevice('ephemeral', 'ephemeral', type: PlatformType.android, launchResult: LaunchResult.failed()),
        debuggingOptions: DebuggingOptions.enabled(BuildInfo.debug),
        userIdentifier: '',
        compileExpression: null,
      );
