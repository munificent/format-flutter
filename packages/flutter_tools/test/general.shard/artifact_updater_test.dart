...
void main() {
  ...
  testWithoutContext(
    ...
    () async {
      ...
      final MemoryFileSystem fileSystem = MemoryFileSystem.test();
      final BufferLogger logger = BufferLogger.test();
      final Directory tempStorage = fileSystem.currentDirectory.childDirectory(
        'temp',
      );
      ...
      operatingSystemUtils.unzipCallbacks[localZipPath] =
        ...
        desiredArtifact = outputDirectory.childFile('artifact.bin')
          ..createSync();
      ...
      final File staleEntitlementsFile = fileSystem.file(
        'out/path/to/entitlements.txt',
      ...
      httpClient: FakeHttpClient.list(<FakeRequest>[
        FakeRequest(
          ...
          response: const FakeResponse(
            headers: <String, List<String>>{'x-goog-hash': <String>[]},
          ),
        ),
      ]),
      tempStorage: fileSystem.currentDirectory.childDirectory('temp')
...
class FakeOperatingSystemUtils extends Fake implements OperatingSystemUtils {
  ...
  void unpack(File gzippedTarFile, Directory targetDirectory) {
    ...
    targetDirectory.childFile(gzippedTarFile.fileSystem.path
        .basenameWithoutExtension(gzippedTarFile.path)).createSync();
  }
}
