...
final Platform macPlatform = FakePlatform(operatingSystem: 'macos', environment: <String, String>{'HOME': '/foo/bar'});
...
void main() {
  ...
  testWithoutContext('can locate installations on macOS from Spotlight', () {
    ...
    final String ultimateRandomLocation = fileSystem.path.join('/', 'random', 'IntelliJ UE (stable).app');
    ...
    final Iterable<IntelliJValidatorOnMac> validators = IntelliJValidator.installedValidators(
      ...
      plistParser: FakePlistParser(<String, String>{PlistParser.kCFBundleShortVersionStringKey: '2020.10'}),
    ...
    final IntelliJValidatorOnMac ultimate =
        validators.where((IntelliJValidatorOnMac validator) => validator.id == 'IntelliJIdea').single;
  ...
  testWithoutContext('Intellij plugins path checking on mac with JetBrains toolbox override', () async {
    ...
    final IntelliJValidatorOnMac validator = IntelliJValidatorOnMac(
      ...
      homeDirPath: '/foo/bar',
      userMessages: UserMessages(),
      plistParser: FakePlistParser(<String, String>{'JetBrainsToolboxApp': '/path/to/JetBrainsToolboxApp'}),
    );
