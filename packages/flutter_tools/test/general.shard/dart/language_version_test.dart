...
''');
    ...
    expect(
      determineLanguageVersion(file, null, flutterRoot),
      LanguageVersion(2, 9),
    );
  });
...
''');
      ...
      expect(
        determineLanguageVersion(file, package, flutterRoot),
        LanguageVersion(2, 7),
      );
    },
  );
...
''');
  ...
  testWithoutContext(
    ...
    () {
      ...
      expect(
        determineLanguageVersion(errorFile, package, flutterRoot),
        testCurrentLanguageVersion,
      );
    },
  );
  ...
  testWithoutContext(
    'Can parse Dart language version with pre/post suffix',
    () {
      final FileSystem fileSystem = MemoryFileSystem.test();
      setUpLanguageVersion(fileSystem, '2.13.0-150.0.dev');

      expect(
        currentLanguageVersion(fileSystem, flutterRoot),
