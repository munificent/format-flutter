...
void main() {
  ...
  group('gradleErrors', () {
    testWithoutContext('list of errors', () {
      ...
      expect(gradleErrors, equals(<GradleHandledError>[
...
> A failure occurred while executing com.android.build.gradle.internal.tasks.Workers$ActionFacade
   > com.android.builder.dexing.DexArchiveMergerException: Error while merging dex archives:
    ...
    testUsingContext(
      'retries if multidex support enabled',
      () async {
        const String errorMessage = r'''
Caused by: com.android.tools.r8.utils.b: Cannot fit requested classes in a single dex file (# methods: 85091 > 65536)
  at com.android.tools.r8.utils.T0.error(SourceFile:1)
...
''', flush: true);
        ...
        expect(
          testLogger.statusText,
          contains('android/app/src/main/java/io/flutter/app/FlutterMultiDexApplication.java'),
        );
      },
    ...
    testUsingContext(
      'exits if multidex support skipped',
      () async {
        const String errorMessage = r'''
Caused by: com.android.tools.r8.utils.b: Cannot fit requested classes in a single dex file (# methods: 85091 > 65536)
  at com.android.tools.r8.utils.T0.error(SourceFile:1)
...
''';
  ...
  group('flavor undefined', () {
    testWithoutContext('pattern', () {
      expect(flavorUndefinedHandler.test('Task assembleFooRelease not found in root project.'), isTrue);
      expect(flavorUndefinedHandler.test('Task assembleBarRelease not found in root project.'), isTrue);
      expect(flavorUndefinedHandler.test('Task assembleBar not found in root project.'), isTrue);
      expect(flavorUndefinedHandler.test('Task assembleBar_foo not found in root project.'), isTrue);
    });
...
assembleProfile
  ...
  group('transform input issue', () {
    testWithoutContext('pattern', () {
      expect(transformInputIssueHandler.test('https://issuetracker.google.com/issues/158753935'), isTrue);
    });
  ...
  group('Dependency mismatch', () {
    testWithoutContext('pattern', () {
      expect(lockFileDepMissingHandler.test('''
* What went wrong:
...
> Could not resolve all artifacts for configuration ':app:debugRuntimeClasspath'.
   ...
   > Resolved 'androidx.customview:customview:1.0.0' which is not part of the dependency lock state'''), isTrue);
    });
  ...
  group('Incompatible Kotlin version', () {
    testWithoutContext('pattern', () {
      expect(incompatibleKotlinVersionHandler.test(
...
''';
  ...
  group('Java 11 requirement', () {
    testWithoutContext('pattern', () {
      expect(jvm11RequiredHandler.test('''
* What went wrong:
...
> Failed to apply plugin 'com.android.internal.library'.
   > Android Gradle plugin requires Java 11 to run. You are currently using Java 1.8.
     You can try some of the following options:
       ...
       - changing `org.gradle.java.home` in `gradle.properties`.'''), isTrue);
    });
  ...
  group('SSLException', () {
    testWithoutContext('pattern', () {
      expect(sslExceptionHandler.test(r'''
...
at org.gradle.wrapper.Install.createDist(Install.java:48)
at org.gradle.wrapper.WrapperExecutor.execute(WrapperExecutor.java:128)
at org.gradle.wrapper.GradleWrapperMain.main(GradleWrapperMain.java:61)'''), isTrue);
...
at java.base/sun.security.ssl.SSLTransport.decode(SSLTransport.java:108)'''), isTrue);
    });
  ...
  group('Zip exception', () {
    testWithoutContext('pattern', () {
      expect(zipExceptionHandler.test(r'''
