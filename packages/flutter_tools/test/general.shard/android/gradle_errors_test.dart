...
at org.gradle.wrapper.GradleWrapperMain.main(GradleWrapperMain.java:61)''';
        ...
        expect(
          formatTestErrorMessage(errorMessage, networkErrorHandler),
          isTrue,
        );
        expect(
    ...
    testUsingContext(
      'retries if remote host terminated ssl handshake',
      () async {
        const String errorMessage = r'''
...
> Could not resolve all files for configuration ':classpath'.
  ...
  group('multidex errors', () {
    testUsingContext(
      'exits if multidex AndroidManifest not detected',
      () async {
        const String errorMessage = r'''
...
> A failure occurred while executing com.android.build.gradle.internal.tasks.Workers$ActionFacade
   > com.android.builder.dexing.DexArchiveMergerException: Error while merging dex archives:
     ...
     Learn how to resolve this issue at https://developer.android.com/tools/building/multidex.html''';
        ...
        expect(
          formatTestErrorMessage(errorMessage, multidexErrorHandler),
          isTrue,
        );
        expect(
...
''', flush: true);
    ...
    testUsingContext(
      'exits if multidex support disabled',
      () async {
        const String errorMessage = r'''
Caused by: com.android.tools.r8.utils.b: Cannot fit requested classes in a single dex file (# methods: 85091 > 65536)
  at com.android.tools.r8.utils.T0.error(SourceFile:1)
...
> A failure occurred while executing com.android.build.gradle.internal.tasks.Workers$ActionFacade
  ...
  group('permission errors', () {
    testUsingContext(
      'throws toolExit if gradle is missing execute permissions',
      () async {
        const String errorMessage = '''
Permission denied
...
''';
        expect(
          formatTestErrorMessage(errorMessage, permissionDeniedErrorHandler),
          isTrue,
        );
        expect(
...
''';
  ...
  group('license not accepted', () {
    testWithoutContext('pattern', () {
      expect(licenseNotAcceptedHandler.test(
  ...
  group('flavor undefined', () {
    testWithoutContext('pattern', () {
      expect(flavorUndefinedHandler.test(
...
assembleProfile
  ...
  group('transform input issue', () {
    testWithoutContext('pattern', () {
      expect(transformInputIssueHandler.test(
