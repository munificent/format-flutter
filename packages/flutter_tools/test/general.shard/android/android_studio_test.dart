  ...
  group('installation detection on MacOS', () {
    ...
    testUsingContext(
      ...
      () {
        ...
        fileSystem.directory(studioInApplicationPlistFolder).createSync(
          recursive: true,
        );
    ...
    testUsingContext(
      ...
      () {
        ...
        fileSystem.directory(applicationPlistFolder).createSync(
          recursive: true,
        );
        ...
        fileSystem.directory(homeDirectoryPlistFolder).createSync(
          recursive: true,
        );
    ...
    testUsingContext(
      ...
      () {
        ...
        fileSystem.directory(randomLocation1PlistFolder).createSync(
          recursive: true,
        );
        ...
        plistUtils.fileContents[randomLocation1PlistPath] =
        ...
        fileSystem.directory(randomLocation2PlistFolder).createSync(
          recursive: true,
        );
        ...
        plistUtils.fileContents[randomLocation2PlistPath] =
            macStudioInfoPlist4_1;
    ...
    testUsingContext(
      ...
      () {
        ...
        processManager.addCommands(<FakeCommand>[
          ...
          FakeCommand(
            command: <String>[studioInApplicationJavaBinary, '-version'],
          ),
        ]);
  ...
  group('installation detection on Windows', () {
    ...
    testUsingContext(
      ...
      () {
        ...
        fileSystem.directory(r'C:\Program Files\AndroidStudio').createSync(
          recursive: true,
        );
    ...
    testUsingContext(
      ...
      () {
        fileSystem.file(
          r'C:\Users\Dash\AppData\Local\Google\AndroidStudio4.2\.home',
        )
          ..createSync(recursive: true)
          ..writeAsStringSync(r'C:\Program Files\AndroidStudio');
        fileSystem.directory(r'C:\Program Files\AndroidStudio').createSync(
    ...
    testUsingContext(
      ...
      () {
        fileSystem.file(
          r'C:\Users\Dash\AppData\Local\Google\AndroidStudio\.home',
        )
          ..createSync(recursive: true)
          ..writeAsStringSync(r'C:\Program Files\AndroidStudio');
        fileSystem.directory(r'C:\Program Files\AndroidStudio').createSync(
  ...
  group('latestValid', () {
    ...
    testUsingContext(
      ...
      () {
        ...
        expect(AndroidStudio.allInstalled().length, 3);
        expect(
          AndroidStudio.latestValid()!.directory,
    ...
    testUsingContext(
      ...
      () {
        ...
        fileSystem.file(
          r'C:\Users\Dash\AppData\Local\Google\AndroidStudio4.0\.home',
        )
          ..createSync(recursive: true)
          ..writeAsStringSync(r'C:\Program Files\AndroidStudio4.0');
        fileSystem.directory(r'C:\Program Files\AndroidStudio4.0').createSync(
          recursive: true,
        );
    ...
    testUsingContext(
      ...
      () {
        ...
        fileSystem.directory(configuredAndroidStudioDir).createSync(
          recursive: true,
        );
        (globals.processManager as FakeProcessManager).excludedExecutables.add(
          fileSystem.path.join(
            configuredAndroidStudioDir,
            'jbr',
            'bin',
            'java',
          ),
        ...
        for (final String javaPath in validJavaPaths) {
          (globals.processManager as FakeProcessManager).addCommand(FakeCommand(
            command: <String>[fileSystem.path.join(javaPath), '-version'],
          ));
        }
    ...
    testUsingContext(
      ...
      () async {
        ...
        expect(
          fileSystem.directory(configuredAndroidStudioDir).existsSync(),
          false,
        );
