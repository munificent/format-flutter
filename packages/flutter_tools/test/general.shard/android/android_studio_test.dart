...
void main() {
  group('installation detection on MacOS', () {
    ...
    setUp(() {
      ...
      platform = FakePlatform(operatingSystem: 'macos', environment: <String, String>{'HOME': homeMac});
    ...
    testUsingContext(
      ...
      () {
        ...
        final AndroidStudio studio =
            AndroidStudio.fromMacOSBundle(fileSystem.directory(studioInApplicationPlistFolder).parent.path)!;

        expect(studio, isNotNull);
        expect(
          studio.pluginsPath,
          equals(fileSystem.path.join(homeMac, 'Library', 'Application Support', 'Google', 'AndroidStudio4.1')),
        );
    ...
    testUsingContext(
      ...
      () {
        ...
        expect(
          studio.pluginsPath,
          equals(fileSystem.path.join(homeMac, 'Library', 'Application Support', 'Google', 'AndroidStudio2020.3')),
        );
        expect(studio.validationMessages, <String>['Java version 123']);
      },
      overrides: <Type, Generator>{
    ...
    testUsingContext(
      ...
      () {
        ...
        expect(
          studio.pluginsPath,
          equals(fileSystem.path.join(homeMac, 'Library', 'Application Support', 'AndroidStudioPreview2022.3')),
        );
        expect(studio.validationMessages, <String>['Java version 123']);
      },
      overrides: <Type, Generator>{
    ...
    testUsingContext(
      ...
      () {
        ...
        const Map<String, Object> jetbrainsInfoPlist = <String, Object>{'JetBrainsToolboxApp': 'ignored'};
    ...
    testUsingContext(
      ...
      () {
        ...
        final String studioInApplication = fileSystem.path.join('/', 'Application', 'Android Studio.app');
        final String studioInApplicationPlistFolder = fileSystem.path.join(studioInApplication, 'Contents');
        fileSystem.directory(studioInApplicationPlistFolder).createSync(recursive: true);
        final String plistFilePath = fileSystem.path.join(studioInApplicationPlistFolder, 'Info.plist');
        plistUtils.fileContents[plistFilePath] = macStudioInfoPlist4_1;

        // Two in random location only Spotlight knows about.
        final String randomLocation1 = fileSystem.path.join('/', 'random', 'Android Studio Preview.app');
        ...
        final String randomLocation2 = fileSystem.path.join('/', 'random', 'Android Studio with Blaze.app');
        ...
        processManager.addCommands(<FakeCommand>[
          FakeCommand(
            command: const <String>['mdfind', 'kMDItemCFBundleIdentifier="com.google.android.studio*"'],
            stdout: '$randomLocation1\n$randomLocation2\n$studioInApplication',
          ),
          FakeCommand(command: <String>[fileSystem.path.join(randomLocation1, 'Contents', javaBin), '-version']),
          FakeCommand(command: <String>[fileSystem.path.join(randomLocation2, 'Contents', javaBin), '-version']),
          FakeCommand(command: <String>[fileSystem.path.join(studioInApplicationPlistFolder, javaBin), '-version']),
        ]);
    ...
    testUsingContext(
      ...
      () {
        ...
        processManager.addCommand(
          FakeCommand(command: <String>[fileSystem.path.join(jdkPath, 'bin', 'java'), '-version'], stderr: '123'),
        );
        final AndroidStudio studio =
            AndroidStudio.fromMacOSBundle(fileSystem.directory(studioInApplicationPlistFolder).parent.path)!;
    ...
    testUsingContext(
      ...
      () {
        ...
        final String studioInApplicationPlistFolder = fileSystem.path.join(extractedDownloadZip, 'Contents');
        fileSystem.directory(studioInApplicationPlistFolder).createSync(recursive: true);
        final String plistFilePath = fileSystem.path.join(studioInApplicationPlistFolder, 'Info.plist');
        plistUtils.fileContents[plistFilePath] = macStudioInfoPlist2022_1;
  ...
  group('installation detection on Linux', () {
    ...
    testUsingContext(
      ...
      () {
        ...
        fileSystem.file(fileSystem.path.join(configuredStudioInstallPath, 'jbr', 'bin', 'java')).createSync(
          recursive: true,
        );
  ...
  group('latestValid', () {
    ...
    testUsingContext(
      'choses the install with the latest version',
      () {
