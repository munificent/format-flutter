...
void main() {
  ...
  testWithoutContext(
    'licensesAccepted works for all licenses accepted',
    () async {
      sdk.sdkManagerPath = '/foo/bar/sdkmanager';
      const String output = '''
...
''';
  ...
  testWithoutContext(
    'licensesAccepted sets environment for finding java',
    () async {
  ...
  testWithoutContext(
    'licensesAccepted works for some licenses accepted',
    () async {
      sdk.sdkManagerPath = '/foo/bar/sdkmanager';
      const String output = '''
[=======================================] 100% Computing updates...
...
''';
  ...
  testWithoutContext(
    'licensesAccepted works for no licenses accepted',
    () async {
      sdk.sdkManagerPath = '/foo/bar/sdkmanager';
      const String output = '''
[=======================================] 100% Computing updates...
...
''';
  ...
  testWithoutContext(
    'runLicenseManager handles broken pipe without ArgumentError',
    () async {
      sdk.sdkManagerPath = '/foo/bar/sdkmanager';
  ...
  testWithoutContext(
    'runLicenseManager errors when sdkmanager exits non-zero',
    () async {
  ...
  testUsingContext('detects minimum required SDK and buildtools', () async {
    ...
    expect(validationResult.messages.any(
      (ValidationMessage message) => message.message == errorMessage,
    ), isFalse);
  });
  ...
  testUsingContext('detects minimum required java version', () async {
    ...
    final String errorMessage = UserMessages().androidJavaMinimumVersion(
      javaVersionText,
    );
