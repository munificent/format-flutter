...
void main() {
  ...
  testUsingContext(
    ...
    () async {
      ...
      final File buildGradleTemplate = deferredComponentDir.childFile(
        'build.gradle.tmpl',
      );
  ...
  testWithoutContext('androidComponentSetup all files exist passes', () async {
    final Directory templatesDir = flutterRootDir
        ...
        .childDirectory('deferred_component');
    final File buildGradleTemplate = templatesDir.childFile(
      'build.gradle.tmpl',
    );
  ...
  testWithoutContext('androidStringMapping creates new file', () async {
    ...
    final Directory baseModuleDir = projectDir
        .childDirectory('android')
        .childDirectory('app');
