...
void main() {
  ...
  testWithoutContext('writeCache passes', () async {
    ...
    final File expectedFile = env.projectDir.childFile(
...
''');
      ...
      expect(
        logger.statusText,
        contains('Errors checking the following files:'),
      );
      expect(logger.statusText, contains(
...
''');
      ...
      expect(
        logger.statusText.contains('Errors checking the following files:'),
        false,
      );
    },
  );
  ...
  testWithoutContext('androidStringMapping modifies strings file', () async {
    ...
    final Directory baseModuleDir = env.projectDir
