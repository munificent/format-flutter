  ...
  group('AndroidSdk', () {
    ...
    testUsingContext(
      ...
      () {
        ...
        expect(sdk.sdkManagerPath, fileSystem.path.join(
          sdk.directory.path,
          'cmdline-tools',
          'latest',
          'bin',
    ...
    testUsingContext(
      ...
      () {
        final Directory sdkDir = createBrokenSdkDirectory(
          fileSystem: fileSystem,
        );
        processManager.addCommand(
          const FakeCommand(
    ...
    testUsingContext(
      ...
      () {
        ...
        expect(sdk.avdManagerPath, fileSystem.path.join(
          sdk.directory.path,
          'cmdline-tools',
          'latest',
          'bin',
...
Directory createBrokenSdkDirectory({
  ...
  final Directory dir = fileSystem.systemTempDirectory.createTempSync(
...
Directory createSdkDirectory({
  ...
  void createDir(Directory dir, String path) {
    final Directory directory = dir.fileSystem.directory(
      dir.fileSystem.path.join(dir.path, path),
    );
