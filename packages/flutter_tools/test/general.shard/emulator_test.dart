...
void main() {
  ...
  group('ios_emulators', () {
    testUsingContext(
      ...
      () async {
        fileSystem.directory('/fake/Xcode.app/Contents/Developer/Applications/Simulator.app').createSync(
          recursive: true,
        );
        fakeProcessManager.addCommands(<FakeCommand>[
          ...
          const FakeCommand(
            command: <String>['open', '-n', '-a', '/fake/Xcode.app/Contents/Developer/Applications/Simulator.app'],
          ),
          const FakeCommand(
            command: <String>['open', '-a', '/fake/Xcode.app/Contents/Developer/Applications/Simulator.app'],
          ),
        ]);
