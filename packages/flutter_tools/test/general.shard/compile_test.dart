...
void main() {
  ...
  testWithoutContext('toMultiRootPath maps different URIs', () async {
    expect(toMultiRootPath(Uri.parse('file:///a/b/c'), 'scheme', <String>[
      '/a/b',
    ], false), 'scheme:///c');
    expect(toMultiRootPath(Uri.parse('file:///d/b/c'), 'scheme', <String>[
      '/a/b',
    ], false), 'file:///d/b/c');
    expect(toMultiRootPath(Uri.parse('file:///a/b/c'), 'scheme', <String>[
      '/d/b',
    ...
    expect(
      toMultiRootPath(Uri.parse('file:///a/b/c'), null, <String>[], false),
      'file:///a/b/c',
    );
    expect(toMultiRootPath(
      Uri.parse('org-dartlang-app:///a/b/c'),
      null,
      <String>[],
      false,
  ...
  testWithoutContext('buildModeOptions removes matching product define', () {
    expect(
      ...
      <String>['-Ddart.vm.profile=false', '--enable-asserts'],
    );
  });
  ...
  testWithoutContext(
    ...
    () {
      expect(
        ...
        <String>['-Ddart.vm.product=false', '--enable-asserts'],
      );
    },
  );
  ...
  testWithoutContext(
    ...
    () {
      expect(buildModeOptions(BuildMode.profile, <String>[
