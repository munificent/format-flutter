...
void main() {
  ...
  testWithoutContext('compile expression fails if not previously compiled', () async {
    final CompilerOutput? result =
        await generator.compileExpression('2+2', null, null, null, null, null, null, null, null, false);
  ...
  testWithoutContext('compile expression can compile single expression', () async {
    ...
    await generator.recompile(
      ...
      generator.compileExpression('2+2', null, null, null, null, null, null, null, null, false).then(
  ...
  testWithoutContext('compile expressions without awaiting', () async {
    ...
    unawaited(generator.recompile(
      ...
      compileExpressionResponseCompleter1.complete(
        Future<List<int>>.value(utf8.encode('result def\nline1\nline2\ndef /path/to/main.dart.dill.incremental 0\n')),
      );
    }));

    // The test manages timing via completers.
    final Completer<bool> lastExpressionCompleted = Completer<bool>();
    unawaited(generator.compileExpression('0+1', null, null, null, null, null, null, null, null, false).then(
      (CompilerOutput? outputExpression) {
        expect(outputExpression, isNotNull);
    ...
    // The test manages timing via completers.
    unawaited(generator.compileExpression('1+1', null, null, null, null, null, null, null, null, false).then(
      (CompilerOutput? outputExpression) {
        expect(outputExpression, isNotNull);
