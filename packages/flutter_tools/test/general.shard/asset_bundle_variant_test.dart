...
void main() {
  ...
  Future<Map<Object?, Object?>> extractAssetManifestSmcBinFromBundle(
    ...
    final ByteData asByteData = ByteData.view(
      Uint8List.fromList(manifest).buffer,
    );
...
''');
    ...
    testWithoutContext(
      ...
      () async {
        ...
        expect(
          jsonManifest,
          equals(_assetManifestBinToJson(expectedAssetManifest)),
        );
      },
    );
    ...
    testWithoutContext(
      'Main assets are not included if the file does not exist',
      () async {
...
Map<Object, Object> _assetManifestBinToJson(Map<Object, Object> manifest) {
  List<Object> convertList(List<Object> variants) => variants.map(
    (Object variant) => (variant as Map<Object?, Object?>)['asset']!,
  ).toList();

  return manifest.map(
    (Object key, Object value) => MapEntry<Object, Object>(
      key,
      convertList(value as List<Object>),
    ),
  );
}
