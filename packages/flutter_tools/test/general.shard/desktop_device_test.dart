...
void main() {
  ...
  testWithoutContext('createDevFSWriter returns a LocalDevFSWriter', () {
    ...
    expect(
      device.createDevFSWriter(FakeApplicationPackage(), ''),
  ...
  testWithoutContext(
    'Desktop devices that support impeller pass through the enable-impeller flag',
    () async {
      final FakeProcessManager processManager = FakeProcessManager.list(
        <FakeCommand>[
          const FakeCommand(
  ...
  testWithoutContext(
    'Desktop devices that do not support impeller ignore the enable-impeller flag',
    () async {
      final FakeProcessManager processManager = FakeProcessManager.list(
        <FakeCommand>[
          const FakeCommand(
