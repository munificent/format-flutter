...
void main() {
  ...
  testUsingContext(
    ...
    () async {
      ...
      final CmakeBasedProject cmakeProject = WindowsProject.fromFlutter(
        project,
      );
      const BuildInfo buildInfo = BuildInfo(
        BuildMode.release,
...
class _FakeProject implements CmakeBasedProject {
  ...
  @override
  File get generatedCmakeConfigFile => _ephemeralDirectory.childFile(
    'generated_config.cmake',
  );

  @override
  File get generatedPluginCmakeFile => _managedDirectory.childFile(
    'generated_plugins.cmake',
  );

  @override
  Directory get pluginSymlinkDirectory => _ephemeralDirectory.childDirectory(
    '.plugin_symlinks',
  );
  ...
  Directory get _managedDirectory => _editableDirectory.childDirectory(
    'flutter',
  );
  Directory get _ephemeralDirectory => _managedDirectory.childDirectory(
    'ephemeral',
  );
}
