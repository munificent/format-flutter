...
void main() {
  ...
  testUsingContext('generates config', () async {
    ...
    writeGeneratedCmakeConfig(_kTestFlutterRoot, cmakeProject, buildInfo, environment);
  ...
  testUsingContext('config escapes backslashes', () async {
    ...
    writeGeneratedCmakeConfig(_kTestWindowsFlutterRoot, cmakeProject, buildInfo, environment);
  ...
  testUsingContext('generated config uses build name', () async {
    final FlutterProject project = FlutterProject.fromDirectoryTest(fileSystem.currentDirectory);
    final CmakeBasedProject cmakeProject = _FakeProject.fromFlutter(project);
    const BuildInfo buildInfo = BuildInfo(BuildMode.release, null, buildName: '1.2.3', treeShakeIcons: false);
    final Map<String, String> environment = <String, String>{};
  ...
  testUsingContext('generated config uses build number', () async {
    final FlutterProject project = FlutterProject.fromDirectoryTest(fileSystem.currentDirectory);
    final CmakeBasedProject cmakeProject = _FakeProject.fromFlutter(project);
    const BuildInfo buildInfo = BuildInfo(BuildMode.release, null, buildNumber: '4', treeShakeIcons: false);
    final Map<String, String> environment = <String, String>{};
  ...
  testUsingContext('generated config uses build number over pubspec version', () async {
    ...
    final FlutterProject project = FlutterProject.fromDirectoryTest(fileSystem.currentDirectory);
    final CmakeBasedProject cmakeProject = _FakeProject.fromFlutter(project);
    const BuildInfo buildInfo = BuildInfo(BuildMode.release, null, buildNumber: '5', treeShakeIcons: false);
    final Map<String, String> environment = <String, String>{};
  ...
  testUsingContext(
    ...
    () async {
      final FlutterProject project = FlutterProject.fromDirectoryTest(fileSystem.currentDirectory);
      final CmakeBasedProject cmakeProject = _FakeProject.fromFlutter(project);
      const BuildInfo buildInfo = BuildInfo(BuildMode.release, null, buildName: 'hello.world', treeShakeIcons: false);
      final Map<String, String> environment = <String, String>{};
