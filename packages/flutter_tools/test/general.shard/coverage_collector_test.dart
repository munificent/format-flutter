...
void main() {
  testWithoutContext(
    ...
    () async {
      ...
      final Map<String, Object?> result = await collect(Uri(), <String>{
        'foo',
            ...
            jsonResponse: SourceReport(
              ranges: <SourceReportRange>[
                SourceReportRange(
                  ...
                  compiled: true,
                  coverage:
                      SourceReportCoverage(hits: <int>[1, 3], misses: <int>[2]),
                ),
              ],
              scripts: <ScriptRef>[
                ScriptRef(uri: 'package:foo/foo.dart', id: '1'),
  ...
  testWithoutContext(
    'Coverage collector with libraryFilters and null libraryNames',
    () async {
      final FakeVmServiceHost fakeVmServiceHost = FakeVmServiceHost(
        requests: <VmServiceExpectation>[
          FakeVmServiceRequest(
  ...
  testWithoutContext('Coverage collector with branch coverage', () async {
            ...
            ranges: <SourceReportRange>[
              SourceReportRange(
                ...
                coverage:
                    SourceReportCoverage(hits: <int>[1, 3], misses: <int>[2]),
                branchCoverage:
                    SourceReportCoverage(hits: <int>[4, 6], misses: <int>[5]),
              ),
            ],
            scripts: <ScriptRef>[
              ScriptRef(uri: 'package:foo/foo.dart', id: '1'),
    ...
    final Map<String, Object?> result = await collect(Uri(), <String>{
      'foo',
    }, serviceOverride: fakeVmServiceHost.vmService, branchCoverage: true);
