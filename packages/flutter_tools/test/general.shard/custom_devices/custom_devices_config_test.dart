...
void main() {
  ...
  testWithoutContext(
    ...
    () {
      ...
      writeCustomDevicesConfigFile(
        directory,
        json: <String, dynamic>{'test': 'testvalue'},
      );
  ...
  testWithoutContext(
    'CustomDevicesConfig logs error when id is not a string',
    () {
      final BufferLogger logger = BufferLogger.test();
      final MemoryFileSystem fileSystem = MemoryFileSystem.test();
      final Directory directory = fileSystem.directory('custom_devices_config');
  ...
  testWithoutContext(
    'CustomDevicesConfig loads config when postBuild is null',
    () {
      final BufferLogger logger = BufferLogger.test();
      final MemoryFileSystem fileSystem = MemoryFileSystem.test();
      final Directory directory = fileSystem.directory('custom_devices_config');
  ...
  testWithoutContext(
    'CustomDevicesConfig loads config without port forwarding',
    () {
      final BufferLogger logger = BufferLogger.test();
      final MemoryFileSystem fileSystem = MemoryFileSystem.test();
      final Directory directory = fileSystem.directory('custom_devices_config');
