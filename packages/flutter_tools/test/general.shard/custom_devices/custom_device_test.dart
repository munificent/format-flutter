...
void main() {
  ...
  final CustomDeviceConfig disabledTestConfig = testConfig.copyWith(
    enabled: false,
  );
  ...
  testWithoutContext(
    ...
    () async {
      ...
      _writeCustomDevicesConfigFile(dir, <CustomDeviceConfig>[
        disabledTestConfig,
      ]);
  ...
  testWithoutContext(
    ...
    () async {
      ...
      final FlutterProject flutterProject = _setUpFlutterProject(
  ...
  testUsingContext(
    ...
    () async {
      ...
      expect(
        await device.installApp(PrebuiltLinuxApp(executable: 'exe')),
        true,
      );
  ...
  testWithoutContext(
    ...
    () async {
      ...
      expect(
        launchResult.vmServiceUri,
        Uri.parse('http://127.0.0.1:12345/abcd/'),
      );
  ...
  testUsingContext(
    ...
    () async {
      ...
      final PrebuiltLinuxApp app = PrebuiltLinuxApp(
        executable: 'testexecutable',
      );

      final Directory configFileDir = fs.directory('custom_devices_config_dir');
      _writeCustomDevicesConfigFile(configFileDir, <CustomDeviceConfig>[
        testConfig,
      ]);
  ...
  testWithoutContext(
    ...
    () async {
      ...
      logReader.listenToProcessOutput(FakeProcess(
