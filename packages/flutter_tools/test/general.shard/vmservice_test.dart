...
void main() {
  ...
  testWithoutContext(
    'VM Service registers flutterMemoryInfo service',
    () async {
  ...
  testWithoutContext(
    'VmService registers flutterGetIOSBuildOptions service',
    () async {
      final MockVMService mockVMService = MockVMService();
      ...
      expect(
        mockVMService.services,
        containsPair(kFlutterGetIOSBuildOptionsServiceName, kFlutterToolAlias),
      );
    },
  );

  testWithoutContext(
    'VmService registers flutterGetAndroidBuildVariants service',
    () async {
      final MockVMService mockVMService = MockVMService();
      final FlutterProject mockedFlutterProject = MockFlutterProject();
      await setUpVmService(
      ...
      expect(mockVMService.services, containsPair(
  ...
  testWithoutContext(
    'VM Service throws tool exit on service registration failure.',
    () async {
      final MockVMService mockVMService = MockVMService()
  ...
  testWithoutContext(
    'VM Service registers flutterPrintStructuredErrorLogMethod',
    () async {
      final MockVMService mockVMService = MockVMService();
      await setUpVmService(
        printStructuredErrorLogMethod: (vm_service.Event event) async =>
            'hello',
        vmService: mockVMService,
      );
      expect(
  ...
  testUsingContext(
    ...
    () {
      ...
      FakeAsync().run((FakeAsync time) {
        ...
        expect(statusText, containsIgnoringWhitespace(
  ...
  testWithoutContext(
    'flushUIThreadTasks forwards arguments correctly',
    () async {
      final Completer<String> completer = Completer<String>();
      final vm_service.VmService vmService = vm_service.VmService(
        const Stream<String>.empty(),
      ...
      expect(rawRequest, allOf(<Matcher>[
        ...
        containsPair(
          'params',
          allOf(<Matcher>[containsPair('isolateId', 'def')]),
        ),
      ]));
    },
  );
  ...
  testWithoutContext(
    ...
    () async {
      ...
      final vm_service.ServiceCallback cb =
          vmService.serviceCallBacks[kFlutterGetIOSBuildOptionsServiceName]!;
      ...
      expect(
        result['buildConfigurations'],
        expectedProjectInfo.buildConfigurations,
      );
  ...
  testWithoutContext(
    'VmService forward flutterGetAndroidBuildVariants request and response correctly',
    () async {
      final MockVMService vmService = MockVMService();
      final List<String> expectedOptions = <String>[
        'debug',
        'release',
        'profile',
      ];
      ...
      final vm_service.ServiceCallback cb = vmService
    ...
    () async {
      ...
      expect(
        await fakeVmServiceHost.vmService
            .flutterDebugDumpSemanticsTreeInTraversalOrder(isolateId: '1'),
        '',
      );
      expect(fakeVmServiceHost.hasRemainingExpectations, false);
    },
  ...
  testWithoutContext(
    ...
    () async {
      ...
      expect(
        await fakeVmServiceHost.vmService
            .flutterDebugDumpSemanticsTreeInInverseHitTestOrder(isolateId: '1'),
        '',
      );
      expect(fakeVmServiceHost.hasRemainingExpectations, false);
    },
  ...
  testWithoutContext('flutterDebugDumpApp handles missing method', () async {
    ...
    expect(
      await fakeVmServiceHost.vmService.flutterDebugDumpApp(isolateId: '1'),
      '',
    );
    expect(fakeVmServiceHost.hasRemainingExpectations, false);
  });
  ...
  testWithoutContext(
    ...
    () async {
      ...
      final Map<String, Object?>? skSLs =
          await fakeVmServiceHost.vmService.getSkSLs(viewId: '1234');
      expect(skSLs, isNull);
      ...
      final Map<String, Object?>? rasterStats = await fakeVmServiceHost
          .vmService
  ...
  testWithoutContext(
    'getIsolateOrNull returns null if service disappears ',
    () async {
      final FakeVmServiceHost fakeVmServiceHost = FakeVmServiceHost(
        requests: <VmServiceExpectation>[
          const FakeVmServiceRequest(
      ...
      final vm_service.Isolate? isolate =
          await fakeVmServiceHost.vmService.getIsolateOrNull('isolate/123');
      expect(isolate, null);
  ...
  testWithoutContext(
    ...
    () async {
      ...
      expect(
        await fakeVmServiceHost.vmService.getFlutterViews(delay: Duration.zero),
        isNotEmpty,
      );
      expect(fakeVmServiceHost.hasRemainingExpectations, false);
    },
  ...
  testWithoutContext(
    'getFlutterViews does not poll if returnEarly is true',
    () async {
      final FakeVmServiceHost fakeVmServiceHost = FakeVmServiceHost(
        requests: <VmServiceExpectation>[
          const FakeVmServiceRequest(
      ...
      expect(
        await fakeVmServiceHost.vmService.getFlutterViews(returnEarly: true),
        isEmpty,
      );
      expect(fakeVmServiceHost.hasRemainingExpectations, false);
    },
  ...
  group('findExtensionIsolate', () {
    testWithoutContext(
      ...
      () async {
        ...
        final vm_service.IsolateRef isolateRef = await fakeVmServiceHost
            .vmService
  ...
  testUsingContext(
    ...
    () async {
      ...
      await expectLater(
        () => connectToVmService(
          Uri.parse('http://localhost:8181/foo'),
