...
void main() {
  ...
  group('packages get/upgrade', () {
    ...
    Future<String> createProjectWithPlugin(
      String plugin, {
      ...
      final File pubspec = globals.fs.file(
        globals.fs.path.join(projectPath, 'pubspec.yaml'),
      );
    ...
    void expectContains(String projectPath, String relPath, String substring) {
      ...
      expect(
        globals.fs.file(
          globals.fs.path.join(projectPath, relPath),
        ).readAsStringSync(),
        contains(substring),
    ...
    void removeGeneratedFiles(String projectPath) {
      ...
      for (final String path in allFiles) {
        final File file = globals.fs.file(
          globals.fs.path.join(projectPath, path),
        );
    ...
    testUsingContext(
      ...
      () async {
        ...
        final String exampleProjectPath = globals.fs.path.join(
          projectPath,
          'example',
        );
    ...
    testUsingContext(
      ...
      () async {
        ...
        expect(
          (await getCommand.usageValues).commandPackagesProjectModule,
          false,
        );
      },
      overrides: <Type, Generator>{
  ...
  group('packages test/pub', () {
    ...
    testUsingContext(
      ...
      () async {
        Cache.flutterRoot = '';
        globals.fs.directory('/packages/flutter_tools').createSync(
          recursive: true,
        );
    ...
    testUsingContext(
      ...
      () async {
        ...
        await createTestCommandRunner(PackagesCommand()).run(<String>[
          'packages',
          '--verbose',
          'pub',
          'run',
