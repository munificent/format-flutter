  ...
  group('Usage', () {
    ...
    testUsingContext(
      ...
      () async {
        ...
        expect(
          (await command.usageValues).commandBuildAppBundleTargetPlatform,
    ...
    testUsingContext(
      ...
      () async {
        ...
        final BuildAppBundleCommand commandDefault =
            await runBuildAppBundleCommand(projectPath);
        expect(
          (await commandDefault.usageValues).commandBuildAppBundleBuildMode,
          'release',
        );
        ...
        expect(
          (await commandInDebug.usageValues).commandBuildAppBundleBuildMode,
          'debug',
        );
