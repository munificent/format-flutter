  ...
  group('UpgradeCommandRunner', () {
    ...
    testUsingContext(
      ...
      () async {
        ...
        final Future<FlutterCommandResult> result = fakeCommandRunner
            .runCommand(
              force: false,
              continueFlow: false,
              testFlow: false,
    ...
    testUsingContext(
      ...
      () async {
        ...
        expect(
          ...
          contains('Flutter is already up to date'),
        );
        expect(processManager, hasNoRemainingExpectations);
      },
      ...
      group('full command', () {
        ...
        testUsingContext(
          ...
          () async {
            ...
            await createTestCommandRunner(upgradeCommand)
                .run(<String>['upgrade', '--continue']);
