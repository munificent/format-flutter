...
void main() {
  testWithoutContext('analyze generate correct errors message', () async {
    expect(AnalyzeBase.generateErrorsMessage(issueCount: 0, seconds: '0.1'), 'No issues found! (ran in 0.1s)');
  ...
  group('analyze command', () {
    ...
    testUsingContext('--flutter-repo analyzes everything in the flutterRoot', () async {
      ...
      final Map<String, Object?> setAnalysisRootsCommand =
          jsonDecode(await streamController.stream.transform(utf8.decoder).elementAt(2)) as Map<String, Object?>;
