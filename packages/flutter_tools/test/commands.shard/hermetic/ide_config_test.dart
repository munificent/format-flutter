...
void main() {
  group('ide_config', () {
    ...
    Map<String, String> getManifest(
      ...
      final String basePath = globals.fs.path.relative(
        base.path,
        from: tempDir.absolute.path,
      );
    ...
    Future<void> updateIdeConfig({
      ...
      for (final String path in expectedContents.keys) {
        final String absPath = globals.fs.path.join(
    ...
    testUsingContext(
      ...
      () async {
        ...
        flutterManifest.remove(
          globals.fs.path.join('packages', 'new', 'deep.iml'),
        );
        populateDir(flutterManifest);
        final Map<String, String> updatedTemplates = getManifest(
          intellijDir,
