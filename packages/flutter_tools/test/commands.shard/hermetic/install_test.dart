  ...
  group('install', () {
    ...
    testUsingContext(
      ...
      () async {
        ...
        expect(
          () async => createTestCommandRunner(command).run(<String>['install', '--device-user', '10']),
    ...
    testUsingContext(
      ...
      () async {
        ...
        expect(
          () async => createTestCommandRunner(command).run(<String>['install', '--use-application-binary', 'bogus']),
