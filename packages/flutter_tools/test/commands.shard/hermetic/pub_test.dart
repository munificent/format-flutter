...
void main() {
  ...
  testUsingContext('pub shows help', () async {
    Object? usage;
    final PackagesCommand command = PackagesCommand(usagePrintFn: (Object? object) => usage = object);
...
class FakePub extends Fake implements Pub {
  ...
  Future<void> interactively(
    ...
    if (project != null) {
      fileSystem.directory(project.directory).childDirectory('.dart_tool').childFile('package_config.json')
        ..createSync(recursive: true)
