...
void main() {
  ...
  testUsingContext(
    ...
    () async {
      ...
      final PackagesGetCommand command = PackagesGetCommand(
        'get',
        '',
        PubContext.pubGet,
      );
  ...
  testUsingContext(
    ...
    () async {
      ...
      expect(
        await rootProject.packageConfigFile.readAsString(),
  ...
  testUsingContext(
    ...
    () async {
      fileSystem.currentDirectory.childFile('pubspec.yaml').createSync();
      fileSystem.currentDirectory.childDirectory('example').createSync(
        recursive: true,
      );
