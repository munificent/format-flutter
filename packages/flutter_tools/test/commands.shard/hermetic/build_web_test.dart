...
void main() {
  ...
  testUsingContext(
    ...
    () async {
      ...
      expect(
        () => runner.run(<String>['build', 'web', '--debug', '--no-pub']),
  ...
  testUsingContext(
    ...
    () async {
      ...
      final Directory buildDir = fileSystem.directory(
        fileSystem.path.join('build', 'web'),
      );
  ...
  testUsingContext(
    ...
    () async {
      ...
      final Directory buildDir = fileSystem.directory(
        fileSystem.path.join(newBuildDir),
      );
  ...
  testUsingContext(
    ...
    () async {
      ...
      expect(buildInfo.dartDefines, contains(startsWith(
  ...
  testUsingContext(
    ...
    () async {
      ...
      expect(
        ...
        contains('FLUTTER_WEB_CANVASKIT_URL=abcdefg'),
      );
    },
    overrides: <Type, Generator>{
      Platform: () => fakePlatform,
...
''');
  fileSystem.file(fileSystem.path.join('lib', 'main.dart')).writeAsStringSync(
    'void main() { }',
  );
}
