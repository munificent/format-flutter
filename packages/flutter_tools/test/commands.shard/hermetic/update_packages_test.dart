    ...
    testUsingContext(
      ...
      () async {
        ...
        await createTestCommandRunner(command)
            .run(<String>['update-packages', '--force-upgrade']);
        expect(pub.pubGetDirectories, equals(<String>[
          '/.tmp_rand0/flutter_update_packages.rand0/synthetic_package',
          '/flutter/examples',
          '/flutter/packages/flutter',
    ...
    testUsingContext(
      ...
      () async {
        ...
        expect(
          ...
          equals(<String>['$dir/synthetic_package']),
        );
      },
      overrides: <Type, Generator>{
        Pub: () => pub,
...
class FakePub extends Fake implements Pub {
  ...
  Future<void> get({
    ...
    pubspecYamls.add(
      project.directory.childFile('pubspec.yaml').readAsStringSync(),
    );
...
sdks:
  dart: ">=2.14.0 <3.0.0"
''');
    fileSystem.currentDirectory.childDirectory('.dart_tool').childFile(
      'package_config.json',
    )
      ..createSync(recursive: true)
