...
void main() {
  group('update-packages', () {
    ...
    testUsingContext(
      ...
      () async {
        final UpdatePackagesCommand command = UpdatePackagesCommand();
        await createTestCommandRunner(command).run(<String>['update-packages', '--force-upgrade', '--jobs=1']);
        expect(pub.pubGetDirectories, equals(<String>[
          '/.tmp_rand0/flutter_update_packages.rand0/synthetic_package',
          '/flutter/examples',
          '/flutter/packages/flutter',
    ...
    testUsingContext(
      ...
      () async {
        ...
        expect(pub.pubGetDirectories, equals(<String>['/.tmp_rand0/flutter_update_packages.rand0/synthetic_package']));
        expect(
          pub.pubBatchDirectories,
          equals(<String>['/.tmp_rand0/flutter_update_packages.rand0/synthetic_package']),
        );
    ...
    testUsingContext(
      ...
      () async {
        final UpdatePackagesCommand command = UpdatePackagesCommand();
        await createTestCommandRunner(command)
            .run(<String>['update-packages', '--cherry-pick-package=vector_math', '--cherry-pick-version=2.0.9']);
        expect(pub.pubGetDirectories, equals(<String>[
          '/.tmp_rand0/flutter_update_packages.rand0/synthetic_package',
          '/flutter/examples',
          '/flutter/packages/flutter',
    ...
    testUsingContext(
      ...
      () async {
        ...
        expect(
          ...
          equals(<String>['$dir/synthetic_package', '/flutter/examples', '/flutter/packages/flutter']),
        );
