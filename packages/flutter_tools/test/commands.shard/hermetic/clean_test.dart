...
void main() {
  group('clean command', () {
    ...
    setUp(() {
      ...
      xcode = Xcode.test(processManager: FakeProcessManager.any(), xcodeProjectInterpreter: xcodeProjectInterpreter);
    });
    ...
    group('general', () {
      ...
      testUsingContext(
        ...
        () async {
          ...
          final CleanCommand command = CleanCommand();
          expect(() => createTestCommandRunner(command).run(<String>['clean', '--scheme']), throwsUsageException());
          expect(() => createTestCommandRunner(command).run(<String>['clean', '--scheme=unknown']), throwsToolExit());
        },
        overrides: <Type, Generator>{
          FileSystem: () => fs,
          ProcessManager: () => FakeProcessManager.any(),
    ...
    group('Windows', () {
      ...
      testUsingContext(
        ...
        () async {
          ...
          exceptionHandler.addError(file, FileSystemOp.delete, const FileSystemException('Deletion failed'));
