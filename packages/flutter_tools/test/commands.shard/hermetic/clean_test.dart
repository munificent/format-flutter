    ...
    group('general', () {
      ...
      testUsingContext(
        ...
        () async {
          ...
          expect(
            xcodeProjectInterpreter.workspaces,
            const <CleanWorkspaceCall>[],
          );
        },
        overrides: <Type, Generator>{
...
FlutterProject setupProjectUnderTest(
  ...
  projectUnderTest.ios.generatedEnvironmentVariableExportScript.createSync(
    recursive: true,
  );
  projectUnderTest.ios.deprecatedCompiledDartFramework.createSync(
    recursive: true,
  );
  projectUnderTest.ios.deprecatedProjectFlutterFramework.createSync(
    recursive: true,
  );
