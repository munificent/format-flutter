...
void main() {
  ...
  void createMinimalMockProjectFiles() {
    fileSystem.directory(
      fileSystem.path.join('macos', 'Runner.xcworkspace'),
  ...
  FakeCommand setUpFakeXcodeBuildHandler(
    ...
    return FakeCommand(
      command: <String>[
        ...
        '-destination',
        'platform=macOS',
        'OBJROOT=${fileSystem.path.join(
          flutterBuildDir.absolute.path,
          'Build',
          'Intermediates.noindex',
        )}',
        'SYMROOT=${fileSystem.path.join(
          flutterBuildDir.absolute.path,
          'Build',
          'Products',
        )}',
...
''',
  ...
  testUsingContext(
    ...
    () async {
      ...
      fileSystem.directory(
        fileSystem.path.join('macos', 'RenamedProj.xcodeproj'),
      ).createSync(recursive: true);
      fileSystem.directory(
  ...
  testUsingContext(
    ...
    () async {
      ...
      final List<String> contents = fileSystem.file(
  ...
  testUsingContext(
    ...
    () async {
      macosPlatformCustomEnv.environment = Map<String, String>.unmodifiable(<
        String,
        String
  ...
  testUsingContext(
    ...
    () async {
      ...
      expect(
        usage.events,
        contains(const TestUsageEvent('code-size-analysis', 'macos')),
      );
    },
    overrides: <Type, Generator>{
      FileSystem: () => fileSystem,
