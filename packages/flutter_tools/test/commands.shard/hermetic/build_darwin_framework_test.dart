...
void main() {
    ...
    group('podspec', () {
      ...
      testUsingContext(
        ...
        () async {
          ...
          expect(() => command.produceFlutterPodspec(BuildMode.debug, outputDirectory), throwsToolExit(
            message:
      ...
      testUsingContext(
        ...
        () async {
          ...
          const GitTagVersion gitTagVersion = GitTagVersion(x: 1, y: 13, z: 10, hotfix: 13, commits: 2);
      ...
      group('is created', () {
        ...
        group('on master channel', () {
          testUsingContext(
            'created when forced',
            () async {
              const GitTagVersion gitTagVersion = GitTagVersion(x: 1, y: 13, z: 11, hotfix: 13, commits: 100);
              final FakeFlutterVersion fakeFlutterVersion = FakeFlutterVersion(
                gitTagVersion: gitTagVersion,
                frameworkVersion: frameworkVersion,
              );
        ...
        group('not on master channel', () {
          ...
          setUp(() {
            const GitTagVersion gitTagVersion = GitTagVersion(x: 1, y: 13, z: 11, hotfix: 13, commits: 0);
            fakeFlutterVersion = FakeFlutterVersion(gitTagVersion: gitTagVersion, frameworkVersion: frameworkVersion);
          });
          ...
          testUsingContext(
            ...
            () async {
              ...
              expect(
                podspecContents,
                contains("'$storageBaseUrl/flutter_infra_release/flutter/$engineRevision/ios/artifacts.zip'"),
              );
            },
            overrides: <Type, Generator>{
              FileSystem: () => memoryFileSystem,
          ...
          testUsingContext(
            ...
            () async {
              ...
              expect(
                podspecContents,
                contains("'$storageBaseUrl/flutter_infra_release/flutter/$engineRevision/ios-profile/artifacts.zip'"),
              );
            },
            overrides: <Type, Generator>{
              FileSystem: () => memoryFileSystem,
          ...
          testUsingContext(
            ...
            () async {
              ...
              expect(
                podspecContents,
                contains("'$storageBaseUrl/flutter_infra_release/flutter/$engineRevision/ios-release/artifacts.zip'"),
              );
            },
            overrides: <Type, Generator>{
              FileSystem: () => memoryFileSystem,
        ...
        group('not on master channel', () {
          ...
          testUsingContext(
            ...
            () async {
              ...
              expect(
                podspecContents,
                contains("'$storageBaseUrl/flutter_infra_release/flutter/$engineRevision/darwin-x64/artifacts.zip'"),
              );
            },
            overrides: <Type, Generator>{
              FileSystem: () => memoryFileSystem,
          ...
          testUsingContext(
            ...
            () async {
              ...
              final File expectedPodspec = outputDirectory.childFile('FlutterMacOS.podspec');
              final String podspecContents = expectedPodspec.readAsStringSync();
              expect(podspecContents, contains(
  ...
  group('XCFrameworks', () {
    ...
    testWithoutContext('created', () async {
      ...
      await BuildFrameworkCommand.produceXCFramework(<Directory>[
        frameworkA,
        frameworkB,
      ], 'Combine', output, fakeProcessManager);
