...
class FakeTerminal implements Terminal {
  ...
  @override
  String color(String message, TerminalColor color) => terminal.color(
    message,
    color,
  );
...
class FakeCommandRunner extends FlutterCommandRunner {
  ...
  Future<void> runCommand(ArgResults topLevelResults) async {
    final Logger logger = (topLevelResults['verbose'] as bool)
  ...
  group('linux', () {
    ...
    testUsingContext(
      ...
      () async {
        ...
        await expectLater(runner
            .run(const <String>['custom-devices', '--help']), completes);
    ...
    testUsingContext(
      ...
      () async {
        ...
        await expectLater(runner
            .run(const <String>['custom-devices']), completes);
        expect(logger.statusText, contains(
          'Makes changes to the config file at "/.flutter_custom_devices.json".',
        ));
      },
    ...
    testUsingContext(
      ...
      () async {
        ...
        expect(config.devices, contains(CustomDeviceConfig(
          id: 'testid',
          label: 'testlabel',
          sdkNameAndVersion: 'testsdknameandversion',
          enabled: true,
    ...
    testUsingContext(
      ...
      () async {
        ...
        expect(config.devices, contains(
    ...
    testUsingContext(
      ...
      () async {
        ...
        await expectLater(runner.run(const <String>[
          'custom-devices',
          'delete',
          '-d',
          'testid',
    ...
    testUsingContext(
      ...
      () async {
        ...
        await expectLater(runner
            .run(const <String>['custom-devices', 'delete']), throwsToolExit());

        final Uint8List contentsAfter =
            fs.file('.flutter_custom_devices.json').readAsBytesSync();
        expect(contentsBefore, equals(contentsAfter));
        expect(
          fs.file('.flutter_custom_devices.json.bak').existsSync(),
          isFalse,
        );
      },
    );
    ...
    testUsingContext(
      ...
      () async {
        ...
        fs.file('.flutter_custom_devices.json').writeAsStringSync(
          '{"custom-devices": {}}',
        );
    ...
    testUsingContext(
      ...
      () async {
        ...
        await expectLater(runner
            .run(const <String>['custom-devices', 'list']), completes);
        expect(logger.statusText, contains(
    ...
    testUsingContext('custom-devices list command lists all devices', () async {
      ...
      CustomDevicesConfig.test(
        ...
        ..add(CustomDeviceConfig.exampleUnix.copyWith(
          id: 'testid',
          label: 'testlabel',
          enabled: true,
        ))
    ...
    testUsingContext(
      ...
      () async {
        ...
        await expectLater(runner
            .run(const <String>['custom-devices', 'reset']), completes);
        expect(logger.statusText, contains(
