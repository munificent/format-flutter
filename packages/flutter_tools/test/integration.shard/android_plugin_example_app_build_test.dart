...
void main() {
  ...
  setUp(() async {
    tempDirPluginMethodChannels = createResolvedTempDirectorySync(
      'flutter_plugin_test.',
    );
    tempDirPluginFfi = createResolvedTempDirectorySync(
      'flutter_ffi_plugin_test.',
    );
  });
  ...
  Future<void> testPlugin({
    ...
    final Directory exampleAppDir = tempDir
    ...
    fileSystem.directory(
      fileSystem.path.join(exampleAppDir.path, 'android', 'gradle', 'wrapper'),
...
android.enableR8=true''');
  ...
  test(
    'FFI plugin example can be built using current Flutter Gradle plugin',
    () async {
