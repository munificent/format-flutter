...
void main() {
  ...
  testWithoutContext(
    'Can parse and output summaries for code coverage',
    () async {
...
''');
      ...
      final String dartScript = fileSystem.path.join(
        getFlutterRoot(),
        'bin',
        'dart',
      );
      ...
      final ProcessResult result = await const LocalProcessManager()
          .run(<String>[dartScript, coverageScript, coverageFile.path]);
