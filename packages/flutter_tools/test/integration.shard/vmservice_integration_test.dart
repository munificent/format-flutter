...
void main() {
  group('Flutter Tool VMService method', () {
    ...
    testWithoutContext('flutterGetIOSBuildOptions can be called', () async {
      final Response response = await vmService.callServiceExtension('s0.flutterGetIOSBuildOptions');
      expect(response.type, 'Success');
    });
    ...
    testWithoutContext('ext.flutter.debugPaint can toggle debug painting', () async {
      ...
      final Response response = await vmService.callServiceExtension('ext.flutter.debugPaint', isolateId: isolate.id);
