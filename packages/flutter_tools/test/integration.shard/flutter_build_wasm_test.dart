...
void main() {
  ...
  setUp(() async {
    ...
    processManager
        .runSync(<String>[flutterBin, 'create', '--platforms=web', 'test_app'], workingDirectory: tempDir.path);
  });
  ...
  test('building web with --wasm produces expected files', () async {
    final ProcessResult result = processManager.runSync(
      ...
      environment: <String, String>{flutterWebWasm.environmentOverride!: 'true'},
    );
    expect(result, const ProcessResultMatcher());

    final Directory appBuildDir = fileSystem.directory(fileSystem.path.join(exampleAppDir.path, 'build', 'web_wasm'));
