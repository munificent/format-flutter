...
void main() {
  ...
  testWithoutContext('device.getDevices', () async {
    ...
    final Stream<Map<String, Object?>?> stream = stdout.stream.map<Map<String, Object?>?>(parseFlutterResponse).where(
      (Map<String, Object?>? value) => value != null,
    );
    ...
    daemonProcess.stdin.writeln('[${jsonEncode(<String, dynamic>{'id': 1, 'method': 'device.enable'})}]');
    ...
    daemonProcess.stdin.writeln('[${jsonEncode(<String, dynamic>{'id': 2, 'method': 'device.getDevices'})}]');
