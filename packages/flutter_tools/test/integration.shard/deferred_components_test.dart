...
void main() {
  ...
  testWithoutContext(
    'simple build appbundle android-arm64 target succeeds',
    () async {
      ...
      final File outputFile = fileSystem.file(
        fileSystem.path.join(tempDir.path, outputFilePath),
      );
      ...
      expect(
        archive.findFile('base/lib/arm64-v8a/libflutter.so') != null,
        true,
      );
      expect(
  ...
  testWithoutContext('simple build appbundle all targets succeeds', () async {
    ...
    expect(
      archive.findFile('component1/lib/arm64-v8a/libapp.so-2.part.so') != null,
      true,
    );

    expect(archive.findFile('base/lib/armeabi-v7a/libapp.so') != null, true);
    expect(
      archive.findFile('base/lib/armeabi-v7a/libflutter.so') != null,
      true,
    );
    expect(
  ...
  testWithoutContext(
    'simple build appbundle no-deferred-components succeeds',
    () async {
      final DeferredComponentsProject project = DeferredComponentsProject(
        BasicDeferredComponentsConfig(),
      );
  ...
  testWithoutContext(
    ...
    () async {
      ...
      expect(
        result.stdout.toString().contains('New loading units were found:'),
        false,
      );
      expect(result.stdout.toString().contains(
  ...
  testWithoutContext(
    ...
    () async {
      ...
      expect(
        result.stdout.toString(),
        contains('Newly generated android files:'),
      );
  ...
  testWithoutContext(
    'simple build appbundle mismatched golden fails',
    () async {
      final DeferredComponentsProject project = DeferredComponentsProject(
        MismatchedGoldenDeferredComponentsConfig(),
      );
