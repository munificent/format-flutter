...
void main() {
  ...
  test(
    'error logged when plugin Android compileSdkVersion higher than project',
    () async {
      ...
      final RegExp androidCompileSdkVersionRegExp = RegExp(
        r'compileSdkVersion ([0-9]+|flutter.compileSdkVersion)',
      );
      ...
      final Directory pluginExampleAppDir = pluginAppDir.childDirectory(
        'example',
      );
