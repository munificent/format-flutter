...
class GenL10nProject extends Project {
  ...
  Future<void> setUpIn(
    ...
    this.dir = dir;
    writeFile(
      fileSystem.path.join(dir.path, 'lib', 'l10n', 'app_en.arb'),
      appEn,
    );
    writeFile(
      fileSystem.path.join(dir.path, 'lib', 'l10n', 'app_en_CA.arb'),
      appEnCa,
    );
    writeFile(
      fileSystem.path.join(dir.path, 'lib', 'l10n', 'app_en_GB.arb'),
      appEnGb,
    );
    writeFile(
      fileSystem.path.join(dir.path, 'lib', 'l10n', 'app_es.arb'),
      appEs,
    );
    writeFile(
      fileSystem.path.join(dir.path, 'lib', 'l10n', 'app_es_419.arb'),
      appEs419,
    );
    writeFile(
      fileSystem.path.join(dir.path, 'lib', 'l10n', 'app_zh.arb'),
      appZh,
    );
    writeFile(
      fileSystem.path.join(dir.path, 'lib', 'l10n', 'app_zh_Hant.arb'),
      appZhHant,
    );
    writeFile(
      fileSystem.path.join(dir.path, 'lib', 'l10n', 'app_zh_Hans.arb'),
      appZhHans,
    );
    writeFile(
