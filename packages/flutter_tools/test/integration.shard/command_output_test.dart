...
void main() {
  ...
  testWithoutContext(
    'Flutter help is shown with -? command line argument',
    () async {
      final String flutterBin = fileSystem.path.join(
        getFlutterRoot(),
        'bin',
  ...
  testWithoutContext('flutter doctor is not verbose', () async {
    ...
    final ProcessResult result = await processManager
        .run(<String>[flutterBin, 'doctor', '-v']);
  ...
  testWithoutContext('flutter doctor -vv super verbose', () async {
    ...
    final ProcessResult result = await processManager
        .run(<String>[flutterBin, 'doctor', '-vv']);
  ...
  testWithoutContext('flutter run --machine uses AppRunLogger', () async {
    ...
    try {
      ...
      directory.childDirectory('lib').childFile('main.dart').createSync(
        recursive: true,
      );
      final String flutterBin = fileSystem.path.join(
        getFlutterRoot(),
  ...
  testWithoutContext('flutter attach --machine uses AppRunLogger', () async {
    ...
    final ProcessResult result = await processManager
        .run(<String>[flutterBin, 'attach', '--machine', '-v']);
  ...
  testWithoutContext(
    ...
    () async {
      ...
      final ProcessResult result = await processManager
          .run(<String>[flutterBin, '--version', '--machine']);
  ...
  testWithoutContext(
    ...
    () async {
      ...
      final String helloWorld = fileSystem.path.join(
        getFlutterRoot(),
        'examples',
        'hello_world',
      );
