...
void main() {
  ...
  testWithoutContext('gradle task exists named print<mode>ApplicationId that prints application id', () async {
    ...
    const List<String> expectedLines = <String>['ApplicationId: com.example.testapp'];
