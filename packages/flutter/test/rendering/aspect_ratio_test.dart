...
void main() {
  ...
  test('RenderAspectRatio: Intrinsic sizing 2.0', () {
    final RenderAspectRatio box = RenderAspectRatio(aspectRatio: 2.0, child: RenderSizedBox(const Size(90.0, 70.0)));
  ...
  test('RenderAspectRatio: Intrinsic sizing 0.5', () {
    final RenderAspectRatio box = RenderAspectRatio(aspectRatio: 0.5, child: RenderSizedBox(const Size(90.0, 70.0)));
  ...
  test('RenderAspectRatio: Sizing', () {
    ...
    layout(outside = RenderConstrainedOverflowBox(child: inside = RenderAspectRatio(aspectRatio: 1.0)));
    pumpFrame();
