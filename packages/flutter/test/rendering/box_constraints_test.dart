...
void main() {
  ...
  test('BoxConstraints copyWith', () {
    const BoxConstraints constraints = BoxConstraints(minWidth: 3.0, maxWidth: 7.0, minHeight: 11.0, maxHeight: 17.0);
  ...
  test('BoxConstraints lerp with unbounded width', () {
    const BoxConstraints constraints1 = BoxConstraints(minWidth: double.infinity, minHeight: 10.0, maxHeight: 20.0);
    const BoxConstraints constraints2 = BoxConstraints(minWidth: double.infinity, minHeight: 20.0, maxHeight: 30.0);
    const BoxConstraints constraints3 = BoxConstraints(minWidth: double.infinity, minHeight: 15.0, maxHeight: 25.0);
    expect(BoxConstraints.lerp(constraints1, constraints2, 0.5), constraints3);
  });

  test('BoxConstraints lerp with unbounded height', () {
    const BoxConstraints constraints1 = BoxConstraints(minWidth: 10.0, maxWidth: 20.0, minHeight: double.infinity);
    const BoxConstraints constraints2 = BoxConstraints(minWidth: 20.0, maxWidth: 30.0, minHeight: double.infinity);
    const BoxConstraints constraints3 = BoxConstraints(minWidth: 15.0, maxWidth: 25.0, minHeight: double.infinity);
    expect(BoxConstraints.lerp(constraints1, constraints2, 0.5), constraints3);
  });

  test('BoxConstraints lerp from bounded to unbounded', () {
    const BoxConstraints constraints1 = BoxConstraints(minWidth: double.infinity, minHeight: double.infinity);
    const BoxConstraints constraints2 = BoxConstraints(minWidth: 20.0, maxWidth: 30.0, minHeight: double.infinity);
    const BoxConstraints constraints3 = BoxConstraints(minWidth: double.infinity, minHeight: 20.0, maxHeight: 30.0);
  ...
  test('BoxConstraints normalize', () {
    const BoxConstraints constraints = BoxConstraints(minWidth: 3.0, maxWidth: 2.0, minHeight: 11.0, maxHeight: 18.0);
