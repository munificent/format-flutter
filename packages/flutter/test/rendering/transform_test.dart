...
void main() {
  ...
  test('RenderTransform - identity', () {
    ...
    expect(
      inner.globalToLocal(const Offset(100.0, 100.0)),
      equals(const Offset(100.0, 100.0)),
    );
    expect(
      inner.globalToLocal(const Offset(25.0, 75.0)),
      equals(const Offset(25.0, 75.0)),
    );
    expect(
      inner.globalToLocal(const Offset(50.0, 50.0)),
      equals(const Offset(50.0, 50.0)),
    );
    expect(inner.localToGlobal(Offset.zero), equals(Offset.zero));
    expect(
      inner.localToGlobal(const Offset(100.0, 100.0)),
      equals(const Offset(100.0, 100.0)),
    );
    expect(
      inner.localToGlobal(const Offset(25.0, 75.0)),
      equals(const Offset(25.0, 75.0)),
    );
    expect(
      inner.localToGlobal(const Offset(50.0, 50.0)),
      equals(const Offset(50.0, 50.0)),
    );
  });
  ...
  test('RenderTransform - translation', () {
    ...
    expect(
      inner.globalToLocal(Offset.zero),
      equals(const Offset(-50.0, -200.0)),
    );
    expect(
      inner.globalToLocal(const Offset(100.0, 100.0)),
  ...
  test('RenderTransform - translation with internal offset', () {
    ...
    expect(
      inner.globalToLocal(Offset.zero),
      equals(const Offset(-70.0, -200.0)),
    );
    expect(
      inner.globalToLocal(const Offset(100.0, 100.0)),
  ...
  test('RenderTransform - rotation', () {
    ...
    expect(
      round(inner.globalToLocal(Offset.zero)),
      equals(const Offset(100.0, 100.0)),
    );
    expect(
    ...
    expect(
      round(inner.globalToLocal(const Offset(25.0, 75.0))),
      equals(const Offset(75.0, 25.0)),
    );
    expect(
      round(inner.globalToLocal(const Offset(50.0, 50.0))),
      equals(const Offset(50.0, 50.0)),
    );
    expect(
      round(inner.localToGlobal(Offset.zero)),
      equals(const Offset(100.0, 100.0)),
    );
    expect(
    ...
    expect(
      round(inner.localToGlobal(const Offset(25.0, 75.0))),
      equals(const Offset(75.0, 25.0)),
    );
    expect(
      round(inner.localToGlobal(const Offset(50.0, 50.0))),
      equals(const Offset(50.0, 50.0)),
    );
  });
  ...
  test('RenderTransform - perspective - globalToLocal', () {
    ...
    final RenderBox sizer = RenderTransform(
      transform: rotateAroundXAxis(
        math.pi * 0.25,
      ), // at pi/4, we are about 70 pixels high
      alignment: Alignment.center,
      child: inner = RenderSizedBox(const Size(100.0, 100.0)),
    );
    layout(
    ...
    expect(
      round(inner.globalToLocal(const Offset(25.0, 50.0))),
  ...
  test('RenderTransform - perspective - localToGlobal', () {
    ...
    final RenderBox sizer = RenderTransform(
      transform: rotateAroundXAxis(
        math.pi * 0.4999,
      ), // at pi/2, we're seeing the box on its edge,
      alignment: Alignment.center,
      child: inner = RenderSizedBox(const Size(100.0, 100.0)),
    );
    layout(
    ...
    expect(
      inner.localToGlobal(const Offset(25.0, 50.0)),
      equals(const Offset(25.0, 50.0)),
    );
    expect(
      round(inner.localToGlobal(const Offset(25.0, 75.0))),
    ...
    expect(
      round(inner.localToGlobal(const Offset(25.0, 100.0))),
      equals(const Offset(25.0, 50.0)),
    );
  });
}
