...
void main() {
  ...
  group('Throws when illegal mutations are attempted: ', () {
    ...
    test('on disposed render objects', () {
      ...
      expect(error, isFlutterError);
      expect((error! as FlutterError).message, equalsIgnoringWhitespace(
    ...
    test('marking itself dirty in performLayout', () {
      ...
      expect(catchLayoutError(block).message, equalsIgnoringWhitespace(
    ...
    test('marking an out-of-band mutation in performLayout', () {
      ...
      child2.child = child21 = RenderLayoutTestBox(
        () {},
        onPerformLayout: child11.markNeedsLayout,
      );
      ...
      expect(error?.message, equalsIgnoringWhitespace(
        'A RenderLayoutTestBox was mutated in RenderLayoutTestBox.performLayout.\n'
