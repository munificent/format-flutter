...
void main() {
  ...
  test('Table control test: constrained flex columns', () {
    ...
    final List<RenderBox> children = List<RenderBox>.generate(
      6,
      (_) => RenderPositionedBox(),
    );
  ...
  test('Table flex sizing', () {
    const BoxConstraints cellConstraints = BoxConstraints.tightFor(
      width: 100,
      height: 100,
    );
    final RenderTable table = RenderTable(
      ...
      children: <List<RenderBox>>[
        List<RenderBox>.generate(
          7,
          (int _) => RenderConstrainedBox(
            additionalConstraints: cellConstraints,
          ),
        ),
      ],
  ...
  test('Table paints a borderRadius', () {
    ...
    expect(
      ...
      paints
        ...
        ..drrect(
          outer:
              RRect.fromLTRBR(0.0, 0.0, 800.0, 0.0, const Radius.circular(8.0)),
