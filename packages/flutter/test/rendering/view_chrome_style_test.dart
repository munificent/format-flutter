  ...
  group('SystemChrome - style', () {
    ...
    void setupTestDevice(WidgetTester tester) {
      ...
      tester.view
        ...
        ..physicalSize = const Size(deviceWidth * devicePixelRatio, deviceHeight * devicePixelRatio);
    }
    ...
    group('navigation color (Android only)', () {
      testWidgets("systemNavigationBarColor isn't set for non Android device", (WidgetTester tester) async {
        setupTestDevice(tester);
        await tester.pumpWidget(
          const AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      testWidgets("systemNavigationBarColor isn't set for unannotated view", (WidgetTester tester) async {
        await tester.pumpWidget(const SizedBox.expand());
        await tester.pumpAndSettle();
      ...
      testWidgets('systemNavigationBarColor is set for annotated view', (WidgetTester tester) async {
        setupTestDevice(tester);
        await tester.pumpWidget(
          const AnnotatedRegion<SystemUiOverlayStyle>(
            value: SystemUiOverlayStyle(systemNavigationBarColor: Colors.blue),
        ...
        await tester.pumpWidget(
          const Column(
            children: <Widget>[
              Expanded(
                child: AnnotatedRegion<SystemUiOverlayStyle>(
                  value: SystemUiOverlayStyle(systemNavigationBarColor: Colors.blue, statusBarColor: Colors.blue),
                  child: SizedBox.expand(),
                ),
              ),
              Expanded(
                child: AnnotatedRegion<SystemUiOverlayStyle>(
                  value: SystemUiOverlayStyle(systemNavigationBarColor: Colors.green, statusBarColor: Colors.green),
                  child: SizedBox.expand(),
                ),
              ),
            ],
