...
void main() {
  test('list body and paragraph intrinsics', () {
    ...
    final RenderListBody testBlock = RenderListBody(
      children: <RenderBox>[paragraph],
    );

    final double textWidth = paragraph.getMaxIntrinsicWidth(double.infinity);
    final double oneLineTextHeight = paragraph.getMinIntrinsicHeight(
      double.infinity,
    );
    final double constrainedWidth = textWidth * 0.9;
    final double wrappedTextWidth = paragraph.getMinIntrinsicWidth(
      double.infinity,
    );
    final double twoLinesTextHeight = paragraph.getMinIntrinsicHeight(
      constrainedWidth,
    );
    ...
    expect(
      paragraph.getMaxIntrinsicHeight(constrainedWidth),
    ...
    expect(
      testBlock.getMinIntrinsicWidth(double.infinity),
      equals(wrappedTextWidth),
    );
    expect(testBlock.getMaxIntrinsicWidth(double.infinity), equals(textWidth));
    expect(
      testBlock.getMinIntrinsicHeight(double.infinity),
      equals(oneLineTextHeight),
    );
    expect(
      testBlock.getMinIntrinsicHeight(constrainedWidth),
      equals(twoLinesTextHeight),
    );
    expect(
      testBlock.getMaxIntrinsicHeight(double.infinity),
      equals(oneLineTextHeight),
    );
    expect(
      testBlock.getMaxIntrinsicHeight(constrainedWidth),
      equals(twoLinesTextHeight),
    );
    ...
    expect(
      testBlock.getMinIntrinsicHeight(wrappedTextWidth),
      equals(twoLinesTextHeight),
    );
    expect(
      testBlock.getMaxIntrinsicHeight(wrappedTextWidth),
      equals(twoLinesTextHeight),
    );
