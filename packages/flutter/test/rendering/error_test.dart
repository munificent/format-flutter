...
void main() {
  ...
  testWidgets('test draw error paragraph', (WidgetTester tester) async {
    ...
    final Widget error = Builder(
      builder: (BuildContext context) => throw 'pillow',
    );

    await tester.pumpWidget(
      Center(child: SizedBox(width: 100.0, child: error)),
    );
    ...
    await tester.pumpWidget(
      Center(child: SizedBox(height: 100.0, child: error)),
    );
