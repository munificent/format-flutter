...
void main() {
  testWidgets('overflow indicator is not shown when not overflowing', (WidgetTester tester) async {
    await tester.pumpWidget(const Center(child: UnconstrainedBox(child: SizedBox(width: 200.0, height: 200.0))));
  ...
  testWidgets('overflow indicator is not shown when constraint size is zero.', (WidgetTester tester) async {
    await tester.pumpWidget(
      const Center(child: SizedBox(height: 0.0, child: UnconstrainedBox(child: SizedBox(width: 200.0, height: 200.0)))),
    );
