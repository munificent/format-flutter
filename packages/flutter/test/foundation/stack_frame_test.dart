...
const List<StackFrame> stackFrames = <StackFrame>[
  ...
  StackFrame(
    ...
    line: 4286,
    column: 5,
    source: '#7      ComponentElement._firstBuild (package:flutter/src/widgets/framework.dart:4286:5)',
  ),
  StackFrame(
    number: 8,
    className: 'StatefulElement',
    ...
    line: 4461,
    column: 11,
    source: '#8      StatefulElement._firstBuild (package:flutter/src/widgets/framework.dart:4461:11)',
  ),
  StackFrame(
    number: 9,
    className: 'ComponentElement',
...
const List<StackFrame> asyncStackFrames = <StackFrame>[
  ...
  StackFrame(
    ...
    line: 239,
    column: 25,
    source: '#31     _runMainZoned.<anonymous closure>.<anonymous closure> (dart:ui/hooks.dart:239:25)',
  ),
  StackFrame(
    number: 32,
    method: '_rootRun',
  ...
  StackFrame(
    ...
    line: 307,
    column: 19,
    source: '#37     _startIsolate.<anonymous closure> (dart:isolate-patch/isolate_patch.dart:307:19)',
  ),
  StackFrame(
    number: 38,
    ...
    line: 174,
    column: 12,
    source: '#38     _RawReceivePortImpl._handleMessage (dart:isolate-patch/isolate_patch.dart:174:12)',
  ),
];
...
const List<StackFrame> stackFrameNoColsFrames = <StackFrame>[
  ...
  StackFrame(
    ...
    line: 239,
    column: -1,
    source: '#2      _runMainZoned.<anonymous closure>.<anonymous closure> (dart:ui/hooks.dart:239)',
  ),
  StackFrame(
    number: 3,
    method: '_rootRun',
  ...
  StackFrame(
    ...
    line: 174,
    column: -1,
    source: '#9      _RawReceivePortImpl._handleMessage (dart:isolate-patch/isolate_patch.dart:174)',
  ),
];
