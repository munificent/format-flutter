...
void main() {
  ...
  test('The Caching Iterable: take and skip', () {
    ...
    final Iterable<int> result = integers.takeWhile((int i) => i < 4).skipWhile(
      (int i) => i < 3,
    );
  ...
  test('The Caching Iterable: expand', () {
    ...
    final Iterable<int> expanded1 = integers.expand<int>(
      (int i) => <int>[i, i],
    );
    ...
    final Iterable<int> expanded2 = integers.expand<int>(
      (int i) => <int>[i, i],
    );
