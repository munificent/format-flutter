...
Future<void> main() async {
  ...
  test('Error reporting - assert with long message', () async {
    expect(console, isEmpty);
    FlutterError.dumpErrorToConsole(FlutterErrorDetails(exception: getAssertionErrorWithLongMessage()));
    expect(
      console.join('\n'),
      matches(
  ...
  test('Error reporting - assert with no message', () async {
    ...
    console.clear();
    FlutterError.dumpErrorToConsole(FlutterErrorDetails(exception: getAssertionErrorWithoutMessage()));
    expect(
      console.join('\n'),
      matches(
...
#10      Element.inflateWidget (package:flutter/src/widgets/framework.dart:3276:14)''';
    ...
    expect(console, isEmpty);
    FlutterError.dumpErrorToConsole(
      FlutterErrorDetails(exception: AssertionError('Test assertion'), stack: StackTrace.fromString(stackString)),
    );
