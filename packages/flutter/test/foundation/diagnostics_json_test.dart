...
void main() {
  ...
  group('Serialization', () {
    ...
    test('filterProperties - sublist', () {
      ...
      expect(properties.every(
        (Map<String, Object?> property) => property['type'] == 'StringProperty',
      ), isTrue);
    });
      ...
      final Map<String, Object?> result = testTree
          ...
          .toJsonMap(TestDiagnosticsSerializationDelegate(
            ...
            childFilter: (List<DiagnosticsNode> nodes, DiagnosticsNode owner) {
              return nodes.where(
                (DiagnosticsNode node) => node.getProperties().isEmpty,
              ).toList();
            },
          ));
      final List<Map<String, Object?>> children =
    ...
    test('filterChildren - replace', () {
      final Map<String, Object?> result = testTree
          ...
          .toJsonMap(TestDiagnosticsSerializationDelegate(
            ...
            childFilter: (List<DiagnosticsNode> nodes, DiagnosticsNode owner) {
              return nodes.expand(
                (DiagnosticsNode node) => node.getChildren(),
              ).toList();
            },
          ));
      final List<Map<String, Object?>> children =
    ...
    test('delegateForAddingNodes', () {
      ...
      expect(properties, hasLength(7));
      expect(properties.every(
        (Map<String, Object?> property) => !property.containsKey('properties'),
      ), isTrue);

      final List<Map<String, Object?>> children =
          result['children']! as List<Map<String, Object?>>;
      expect(children, hasLength(3));
      expect(children.every(
