...
void main() {
  group(PhysicalKeyboardKey, () {
    test('Various classes of keys can be looked up by code.', () async {
      // Check a letter key
      expect(
        PhysicalKeyboardKey.findKeyByCode(0x00070004),
        equals(PhysicalKeyboardKey.keyA),
      );
      // Check a control key
      expect(
        PhysicalKeyboardKey.findKeyByCode(0x00070029),
        equals(PhysicalKeyboardKey.escape),
      );
      // Check a modifier key
      expect(
        PhysicalKeyboardKey.findKeyByCode(0x000700e1),
    ...
    test('Values are equal', () async {
      ...
      expect(
        const PhysicalKeyboardKey(0x12345) == PhysicalKeyboardKey(0x12345),
        true,
      );
    });
    test('debugNames', () async {
      ...
      expect(
        const PhysicalKeyboardKey(0x12345).debugName,
  ...
  group(LogicalKeyboardKey, () {
    ...
    test('Control characters are recognized as such', () async {
      ...
      expect(
        LogicalKeyboardKey.isControlCharacter('\x08'),
        isTrue,
      ); // BACKSPACE
      expect(LogicalKeyboardKey.isControlCharacter('\x09'), isTrue); // TAB
      expect(
        LogicalKeyboardKey.isControlCharacter('\x0a'),
        isTrue,
      ); // LINE FEED
      ...
      expect(LogicalKeyboardKey.isControlCharacter('~'), isFalse);
      expect(
        LogicalKeyboardKey.isControlCharacter('\xa0'),
        isFalse,
      ); // NO-BREAK SPACE
    });
    ...
    test('Basic synonyms can be looked up.', () async {
      expect(
        LogicalKeyboardKey.shiftLeft.synonyms.first,
        equals(LogicalKeyboardKey.shift),
      );
      expect(
        LogicalKeyboardKey.controlLeft.synonyms.first,
        equals(LogicalKeyboardKey.control),
      );
      expect(
        LogicalKeyboardKey.altLeft.synonyms.first,
        equals(LogicalKeyboardKey.alt),
      );
      expect(
        LogicalKeyboardKey.metaLeft.synonyms.first,
        equals(LogicalKeyboardKey.meta),
      );
      expect(
        LogicalKeyboardKey.shiftRight.synonyms.first,
        equals(LogicalKeyboardKey.shift),
      );
      expect(
        LogicalKeyboardKey.controlRight.synonyms.first,
        equals(LogicalKeyboardKey.control),
      );
      expect(
        LogicalKeyboardKey.altRight.synonyms.first,
        equals(LogicalKeyboardKey.alt),
      );
      expect(
        LogicalKeyboardKey.metaRight.synonyms.first,
        equals(LogicalKeyboardKey.meta),
      );
    });
    ...
    test('debugName', () async {
      ...
      expect(
        const LogicalKeyboardKey(0x100012345).debugName,
