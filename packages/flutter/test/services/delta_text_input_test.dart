  ...
  group('DeltaTextInputClient', () {
    ...
    test(
      ...
      () async {
        ...
        // differently from others.
        expect(record[0].exception.toString(), matches(
          RegExp(r'\bThe delta range: TextRange\(start: 0, end: 5\)(?!\w)'),
        ));
        expect(record[0].exception.toString(), matches(
    ...
    test(
      ...
      () async {
        ...
        expect(record[0].exception.toString(), matches(
          RegExp(r'\bis not within the bounds of text: hello of length: 5\b'),
        ));
      },
    );
    ...
    test(
      ...
      () async {
        ...
        // differently from others.
        expect(record[0].exception.toString(), matches(
          RegExp(r'\bThe composing range: TextRange\(start: 0, end: 6\)(?!\w)'),
        ));
        expect(record[0].exception.toString(), matches(
          RegExp(r'\bis not within the bounds of text: world of length: 5\b'),
        ));
      },
    );
  });
