...
void main() {
  ...
  group('TextInput message channels', () {
    ...
    test(
      ...
      () async {
        ...
        fakeTextChannel.validateOutgoingMethodCalls(<MethodCall>[
          MethodCall('TextInput.setClient', <dynamic>[
            1,
            client.configuration.toJson(),
          ]),
        ]);
    ...
    test(
      'Invalid TextRange fails loudly when being converted to JSON',
      () async {
        ...
        final FakeTextInputClient client = FakeTextInputClient(
          const TextEditingValue(text: 'test3'),
        );
        ...
        expect(record[0].exception.toString(), matches(
  ...
  group('TextInputConfiguration', () {
    ...
    test('basic structure', () async {
      ...
      const TextInputType signed = TextInputType.numberWithOptions(
        signed: true,
      );
      const TextInputType signed2 = TextInputType.numberWithOptions(
        signed: true,
      );
  ...
  group('Scribble interactions', () {
    ...
    test(
      ...
      () async {
        ...
        ByteData? messageBytes = const JSONMessageCodec()
            .encodeMessage(<String, dynamic>{
              'args': <dynamic>[1, 0, 1],
    ...
    test('TextInputClient focusElement', () async {
      ...
      final FakeScribbleElement targetElement = FakeScribbleElement(
      ...
      final FakeScribbleElement otherElement = FakeScribbleElement(
        elementIdentifier: 'other',
      );
      TextInput.registerScribbleElement(
    ...
    test('TextInputClient requestElementsInRect', () async {
      ...
      <FakeScribbleElement>[...targetElements, ...otherElements].forEach(
        registerElements,
      );
      ...
      expect(responses.first.first, containsAllInOrder(<dynamic>[
      ...
      expect(responses.first.last, containsAllInOrder(<dynamic>[
  ...
  group('TextInputControl', () {
    ...
    test('both input controls receive requests', () async {
      ...
      expect(
        fakeTextChannel.outgoingCalls.last.method,
      ...
      expect(
        fakeTextChannel.outgoingCalls.last.arguments,
