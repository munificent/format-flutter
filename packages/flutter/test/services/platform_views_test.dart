...
void main() {
  ...
  group('Android', () {
    ...
    test('create Android view of unregistered type', () async {
      await expectLater(
        () => PlatformViewsService.initAndroidView(id: 0, viewType: 'web', layoutDirection: TextDirection.ltr).create(
      ...
      try {
        await PlatformViewsService.initSurfaceAndroidView(id: 0, viewType: 'web', layoutDirection: TextDirection.ltr)
      ...
      try {
        await PlatformViewsService.initAndroidView(id: 1, viewType: 'web', layoutDirection: TextDirection.ltr).create(
    ...
    test('create VD-fallback Android views', () async {
      ...
      await PlatformViewsService.initAndroidView(id: 0, viewType: 'webview', layoutDirection: TextDirection.ltr).create(
        size: const Size(100.0, 100.0),
      );
      await PlatformViewsService.initAndroidView(id: 1, viewType: 'webview', layoutDirection: TextDirection.rtl).create(
    ...
    test('dispose clears focusCallbacks', () async {
      ...
      await viewController.dispose();
      final ByteData message = SystemChannels.platform_views.codec.encodeMethodCall(const MethodCall('viewFocused', 0));
    ...
    test('OnPlatformViewCreated callback', () async {
      ...
      await Future.wait(<Future<void>>[controller3.create(size: const Size(100.0, 200.0)), controller3.dispose()]);
  ...
  group('iOS', () {
    ...
    test('create iOS view of unregistered type', () async {
      expect(() {
        return PlatformViewsService.initUiKitView(id: 0, viewType: 'web', layoutDirection: TextDirection.ltr);
      }, throwsA(isA<PlatformException>()));
    });
    ...
    test('create iOS views', () async {
      ...
      expect(
        ...
        unorderedEquals(<FakeUiKitView>[const FakeUiKitView(0, 'webview'), const FakeUiKitView(1, 'webview')]),
      );
    });
    ...
    test('dispose iOS view', () async {
      ...
      final UiKitViewController viewController =
          await PlatformViewsService.initUiKitView(id: 1, viewType: 'webview', layoutDirection: TextDirection.ltr);

      viewController.dispose();
      expect(viewsController.views, unorderedEquals(<FakeUiKitView>[const FakeUiKitView(0, 'webview')]));
    });
