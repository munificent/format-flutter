...
void main() {
  ...
  group('MethodChannel', () {
    ...
    test('can invoke method and get error', () async {
      ...
      expect(() => channel.invokeMethod<dynamic>('sayHello', 'hello'), throwsA(isA<PlatformException>()
    ...
    test('can invoke unimplemented method', () async {
      ...
      expect(() => channel.invokeMethod<void>('sayHello', 'hello'), throwsA(isA<MissingPluginException>().having(
    ...
    test('can handle method call with expressive error result', () async {
      ...
      expect(() => jsonMethod.decodeEnvelope(envelope!), throwsA(isA<PlatformException>().having(
    ...
    test('can check the mock handler', () async {
      ...
      expect(
        TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger.checkMockMessageHandler(channel.name, null),
        true,
      );
