...
void main() {
  test('MouseTrackerAnnotation has correct toString', () {
    final MouseTrackerAnnotation annotation1 = MouseTrackerAnnotation(onEnter: (_) {}, onExit: (_) {});
    expect(
    ...
    expect(annotation2.toString(), equals('MouseTrackerAnnotation#${shortHash(annotation2)}(callbacks: <none>)'));

    final MouseTrackerAnnotation annotation3 = MouseTrackerAnnotation(onEnter: (_) {}, cursor: SystemMouseCursors.grab);
    expect(
