...
void main() {
  group('RestorationManager', () {
    testWidgets('root bucket retrieval', (WidgetTester tester) async {
      ...
      final RestorationBucket child = rootBucket!.claimChild(
        'child1',
        debugOwner: null,
      );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        RestorationBucket? rootBucket;
        manager.rootBucket.then(
          (RestorationBucket? bucket) => rootBucket = bucket,
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        manager.rootBucket.then(
          (RestorationBucket? bucket) => rootBucket2 = bucket,
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final RestorationBucket newChild = newRoot!.claimChild(
          'childFoo',
          debugOwner: null,
        );
  ...
  test('debugIsSerializableForRestoration', () {
    ...
    expect(
      debugIsSerializableForRestoration(<String, int>{'v1': 10, 'v2': 23}),
      isTrue,
    );
