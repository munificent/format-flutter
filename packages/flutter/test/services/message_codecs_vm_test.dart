...
void main() {
  ...
  group('Standard message codec', () {
    ...
    test('should encode integers correctly at boundary cases', () {
      ...
      checkEncoding<dynamic>(standard, -0x7fffffff - 2, <int>[4, 0xff, 0xff, 0xff, 0x7f, 0xff, 0xff, 0xff, 0xff]);
      checkEncoding<dynamic>(standard, 0x7fffffff, <int>[3, 0xff, 0xff, 0xff, 0x7f]);
      checkEncoding<dynamic>(standard, 0x7fffffff + 1, <int>[4, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00]);
      ...
      checkEncoding<dynamic>(standard, 0x7fffffffffffffff, <int>[4, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x7f]);
      checkEncoding<dynamic>(standard, 0x7fffffffffffffff + 1, <int>[
        4,
        0x00,
        0x00,
