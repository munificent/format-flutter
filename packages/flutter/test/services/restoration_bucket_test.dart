...
void main() {
  ...
  test('child bucket values', () {
    ...
    manager.doSerialization();
    expect(
      ((rootRawData[childrenMapKey] as Map<String, dynamic>)['child1'] as Map<String, dynamic>).containsKey('foo'),
      isFalse,
    );
    expect(manager.updateScheduled, isFalse);
    ...
    manager.doSerialization();
    expect((((rootRawData[childrenMapKey] as Map<String, dynamic>)['child1'] as Map<String, dynamic>)[valuesMapKey]
  ...
  test('claim child that is already claimed throws if not given up', () {
    ...
    expect(
      () => manager.doSerialization(),
      throwsA(isFlutterError.having((FlutterError error) => error.message, 'message', equals(
  ...
  test('claim child that is already claimed does not throw if given up', () {
    ...
    manager.doSerialization();
    expect(manager.updateScheduled, isFalse);
    expect((((rawData[childrenMapKey] as Map<String, dynamic>)['child1'] as Map<String, dynamic>)[valuesMapKey]
  ...
  test('adopt child that already had a parent', () {
    ...
    expect(
      ((rawData[childrenMapKey] as Map<String, dynamic>)['child1'] as Map<String, dynamic>).containsKey(childrenMapKey),
      isFalse,
