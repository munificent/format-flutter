...
void main() {
  group('RawKeyboard', () {
    testWidgets('The correct character is produced', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('CapsLock should not be release when remapped on Web', (
      WidgetTester _,
    ) async {
    ...
    testWidgets('Allows inconsistent modifier for Android', (
      WidgetTester _,
    ) async {
      // Use `testWidgets` for clean-ups.
      final List<RawKeyEvent> events = <RawKeyEvent>[];
    ...
    testWidgets('Allows inconsistent modifier for Web - Alt graph', (
      WidgetTester _,
    ) async {
    ...
    testWidgets('Allows inconsistent modifier for Web - Alt right', (
      WidgetTester _,
    ) async {
      // Regression test for https://github.com/flutter/flutter/issues/113836
      final List<RawKeyEvent> events = <RawKeyEvent>[];
  ...
  group('RawKeyEventDataAndroid', () {
    ...
    test('Control keyboard keys are correctly translated', () {
      final RawKeyEvent escapeKeyEvent = RawKeyEvent.fromMessage(
    ...
    test('Modifier keyboard keys are correctly translated', () {
      final RawKeyEvent shiftLeftKeyEvent = RawKeyEvent.fromMessage(
        const <String, dynamic>{
          'type': 'keydown',
          'keymap': 'android',
          'keyCode': 59,
    ...
    test('DPAD keys from a joystick give physical key mappings', () {
      final RawKeyEvent joystickDpadDown = RawKeyEvent.fromMessage(
        const <String, dynamic>{
          'type': 'keydown',
          'keymap': 'android',
          'keyCode': 20,
    ...
    test('DPAD center from a game pad gives physical key mappings', () {
      final RawKeyEvent joystickDpadCenter = RawKeyEvent.fromMessage(
        const <String, dynamic>{
          'type': 'keydown',
          'keymap': 'android',
    ...
    test('Repeat count is passed correctly', () {
      final RawKeyEvent repeatCountEvent = RawKeyEvent.fromMessage(
        <String, dynamic>{
          'type': 'keydown',
          'keymap': 'android',
          'keyCode': 29,
  ...
  group('RawKeyEventDataFuchsia', () {
    ...
    test('Control keyboard keys are correctly translated', () {
      final RawKeyEvent escapeKeyEvent = RawKeyEvent.fromMessage(const <
        String,
        dynamic
      >{'type': 'keydown', 'keymap': 'fuchsia', 'hidUsage': 0x00070029});
      final RawKeyEventDataFuchsia data =
    ...
    test('Modifier keyboard keys are correctly translated', () {
      final RawKeyEvent shiftLeftKeyEvent = RawKeyEvent.fromMessage(const <
        String,
        dynamic
      >{'type': 'keydown', 'keymap': 'fuchsia', 'hidUsage': 0x000700e1});
      final RawKeyEventDataFuchsia data =
  ...
  group('RawKeyEventDataMacOs', () {
    ...
    test('Lower letter keys are correctly translated', () {
      final RawKeyEvent keyAEvent = RawKeyEvent.fromMessage(
        const <String, dynamic>{
          'type': 'keydown',
          'keymap': 'macos',
          'keyCode': 0x00000000,
    ...
    test('Unprintable keyboard keys are correctly translated', () {
      final RawKeyEvent leftArrowKey = RawKeyEvent.fromMessage(
        const <String, dynamic>{
          'type': 'keydown',
          'keymap': 'macos',
          'keyCode': 0x0000007B,
    ...
    test('Prioritize logical key from specifiedLogicalKey', () {
      final RawKeyEvent digit1FromFrench = RawKeyEvent.fromMessage(
        const <String, dynamic>{
          'type': 'keydown',
          'keymap': 'macos',
          'keyCode': 0x00000012,
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          RawKeyboardListener(focusNode: node, child: Container()),
        );
        node.requestFocus();
  ...
  group('RawKeyEventDataLinux-GLFW', () {
    ...
    test('data.equality', () {
      ...
      expect(
        ...
        isNot(equals(
          RawKeyEventDataLinux(keyHelper: KeyHelper('glfw'), isDown: true),
        )),
      );
    });
  ...
  group('RawKeyEventDataLinux-GTK', () {
    ...
    test('data.equality', () {
      ...
      expect(
        ...
        isNot(equals(
          RawKeyEventDataLinux(keyHelper: KeyHelper('gtk'), isDown: true),
        )),
      );
    });
  ...
  group('RawKeyEventDataWeb', () {
    ...
    test('Modifier keyboard keys are correctly translated', () {
      final RawKeyEvent shiftKeyEvent = RawKeyEvent.fromMessage(
        const <String, Object?>{
          'type': 'keydown',
          'keymap': 'web',
          'code': 'ShiftLeft',
    ...
    test('Arrow keys from a keyboard give correct physical key mappings', () {
      final RawKeyEvent arrowKeyDown = RawKeyEvent.fromMessage(
        const <String, Object?>{
          'type': 'keydown',
          'keymap': 'web',
          'code': 'ArrowDown',
