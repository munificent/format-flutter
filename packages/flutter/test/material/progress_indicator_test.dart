...
void main() {
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(Theme(
        ...
        child: const Directionality(
          ...
          child: Center(
            child: SizedBox(width: 200.0, child: LinearProgressIndicator()),
          ),
        ),
      ));
      ...
      await tester.pumpWidget(Theme(
        data: theme.copyWith(
          progressIndicatorTheme:
              const ProgressIndicatorThemeData(linearMinHeight: 2.0),
        ),
        child: const Directionality(
          textDirection: TextDirection.ltr,
          child: Center(
  ...
  testWidgets('LinearProgressIndicator paint (RTL)', (
    ...
    expect(
      ...
      paints
        ..rect(rect: const Rect.fromLTRB(0.0, 0.0, 200.0, 4.0))
        ..rect(
          rect: Rect.fromLTRB(200.0 - animationValue * 200.0, 0.0, 200.0, 4.0),
        ),
    );
  ...
  testWidgets(
    'LinearProgressIndicator with colors',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'CircularProgressIndicator stroke width',
    (WidgetTester tester) async {
      ...
      expect(
        find.byType(CircularProgressIndicator),
        paints..arc(strokeWidth: 16.0),
      );
    },
  );

  testWidgets(
    'CircularProgressIndicator strokeAlign',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        Theme(data: theme, child: const CircularProgressIndicator()),
      );
      ...
      await tester.pumpWidget(Theme(
        data: theme,
        child: const CircularProgressIndicator(strokeAlign: 2.0),
      ));
      expect(
        find.byType(CircularProgressIndicator),
  ...
  testWidgets(
    'CircularProgressIndicator with strokeCap',
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        const CircularProgressIndicator(strokeCap: StrokeCap.butt),
      );
      expect(
        find.byType(CircularProgressIndicator),
        paints..arc(strokeCap: StrokeCap.butt),
  ...
  testWidgets('CircularProgressIndicator paint colors', (
    ...
    // With just color provided
    await tester.pumpWidget(
      Theme(data: theme, child: const CircularProgressIndicator(color: red)),
    );
    expect(
      find.byType(CircularProgressIndicator),
      paintsExactlyCountTimes(#drawArc, 1),
    ...
    await tester.pumpWidget(Theme(
      data: theme,
      child:
          const CircularProgressIndicator(backgroundColor: green, color: blue),
    ));
    expect(
      find.byType(CircularProgressIndicator),
  ...
  testWidgets(
    'RefreshProgressIndicator paint colors',
    (WidgetTester tester) async {
      const Color green = Color(0xFF00FF00);
      const Color blue = Color(0xFF0000FF);
      const Color red = Color(0xFFFF0000);
      ...
      // With just color provided
      await tester.pumpWidget(
        Theme(data: theme, child: const RefreshProgressIndicator(color: red)),
      );
      expect(
        find.byType(RefreshProgressIndicator),
        paintsExactlyCountTimes(#drawArc, 1),
      ...
      await tester.pumpWidget(Theme(
        data: theme,
        child:
            const RefreshProgressIndicator(color: blue, backgroundColor: green),
      ));
      expect(
        find.byType(RefreshProgressIndicator),
        paintsExactlyCountTimes(#drawArc, 1),
  ...
  testWidgets(
    'RefreshProgressIndicator with a round indicator',
    (WidgetTester tester) async {
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(Theme(
        ...
        child: const Directionality(
          textDirection: TextDirection.ltr,
          child: Center(
            child: SizedBox(width: 200.0, child: RefreshProgressIndicator()),
          ),
        ),
      ));
  ...
  testWidgets(
    'LinearProgressIndicator with height 12.0',
    (WidgetTester tester) async {
      await tester.pumpWidget(Theme(
        data: theme,
        child: const Directionality(
  ...
  testWidgets(
    'LinearProgressIndicator with default height',
    (WidgetTester tester) async {
      await tester.pumpWidget(Theme(
        data: theme,
        child: const Directionality(
  ...
  testWidgets(
    'LinearProgressIndicator can be made accessible',
    (WidgetTester tester) async {
      final SemanticsHandle handle = tester.ensureSemantics();
  ...
  testWidgets(
    'RefreshProgressIndicator can be made accessible',
    (WidgetTester tester) async {
      final SemanticsHandle handle = tester.ensureSemantics();
      final GlobalKey key = GlobalKey();
      const String label = 'Label';
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await expectLater(await animationSheet.collate(20), matchesGoldenFile(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        theme: ThemeData(),
        home: const Scaffold(
          body: Material(child: CircularProgressIndicator.adaptive()),
        ),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(home: Theme(data: theme, child: progressTheme)),
      );
      final Widget wrappedTheme = progressTheme.wrap(
        builderContext,
        Container(),
      );
