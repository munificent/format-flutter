...
class FeedbackTester {
  ...
  Future<void> _handler(MethodCall methodCall) async {
    ...
    if (methodCall.method == 'SystemSound.play' && methodCall.arguments == SystemSoundType.click.toString()) {
      _clickSoundCount++;
    }
  }
  ...
  /// Stops tracking.
  void dispose() {
    assert(TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger.checkMockMessageHandler(
