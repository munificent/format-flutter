...
void main() {
  testWidgets('TextButton, TextButton.icon defaults', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      MaterialApp(theme: theme, home: Center(child: TextButton(onPressed: () {}, child: const Text('button')))),
    );

    final Finder buttonMaterial = find.descendant(of: find.byType(TextButton), matching: find.byType(Material));
    ...
    // Disabled TextButton
    await tester.pumpWidget(
      MaterialApp(theme: theme, home: const Center(child: TextButton(onPressed: null, child: Text('button')))),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        ...
        home: Scaffold(
          body: Center(child: TextButton(onPressed: () {}, focusNode: focusNode, child: const Text('TextButton'))),
        ),
      ));
            ...
            child: TextButtonTheme(
              ...
              child: Builder(
                builder: (BuildContext context) {
                  return TextButton(onPressed: () {}, focusNode: focusNode, child: const Text('TextButton'));
                },
              ),
            ),
          ),
  ...
  testWidgets('TextButton has no clip by default', (WidgetTester tester) async {
    await tester.pumpWidget(Directionality(
      ...
      child: TextButton(child: Container(), onPressed: () {/* to make sure the button is enabled */}),
    ));
  ...
  testWidgets('Does TextButton scale with font scale changes', (WidgetTester tester) async {
    ...
    const Size textButtonSize = bool.hasEnvironment('SKPARAGRAPH_REMOVE_ROUNDING_HACK')
        ? Size(68.5, 48.0)
        : Size(69.0, 48.0);
    const Size textSize = bool.hasEnvironment('SKPARAGRAPH_REMOVE_ROUNDING_HACK') ? Size(52.5, 18.0) : Size(53.0, 18.0);
    ...
    (WidgetTester tester) async {
      ...
      Widget buildFrame({VoidCallback? onPressed, VoidCallback? onLongPress}) {
        return Directionality(
          textDirection: TextDirection.ltr,
          child: TextButton(onPressed: onPressed, onLongPress: onLongPress, child: const Text('button')),
        );
      }
          ...
          testWidgets(testName, (WidgetTester tester) async {
            await tester.pumpWidget(MaterialApp(
              theme: ThemeData(
                ...
                textButtonTheme: TextButtonThemeData(style: TextButton.styleFrom(minimumSize: const Size(64, 36))),
              ),
              home: Builder(
                builder: (BuildContext context) {
                  return MediaQuery(
                    ...
                    child: Directionality(
                      ...
                      child: Scaffold(
                        body: Center(
                          child: icon == null
                              ? TextButton(key: buttonKey, onPressed: () {}, child: const Text('button', key: labelKey))
                              : TextButton.icon(
                                  key: buttonKey,
                                  onPressed: () {},
                                  icon: icon,
  ...
  testWidgets('M3 TextButton has correct default padding', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: Scaffold(body: Center(child: TextButton(key: key, onPressed: () {}, child: const Text('TextButton')))),
    ));
  ...
  testWidgets('M3 TextButton.icon has correct default padding', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: Scaffold(
        body: Center(
          child:
              TextButton.icon(key: key, onPressed: () {}, icon: const Icon(Icons.add), label: const Text('TextButton')),
        ),
      ),
    ));
      ...
      home: Scaffold(
        body: Column(
          ...
          children: <Widget>[
            ...
            TextButton(
              style: TextButton.styleFrom(minimumSize: const Size(200, 200), maximumSize: const Size(200, 200)),
              onPressed: () {},
  ...
  Future<void> testStatesController(Widget? icon, WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      home: Center(
        child: icon == null
            ? TextButton(statesController: controller, onPressed: () {}, child: const Text('button'))
            : TextButton.icon(statesController: controller, onPressed: () {}, icon: icon, label: const Text('button')),
      ),
    ));
    ...
    await tester.pumpWidget(MaterialApp(
      home: Center(
        child: icon == null
            ? TextButton(statesController: controller, onPressed: null, child: const Text('button'))
            : TextButton.icon(statesController: controller, onPressed: null, icon: icon, label: const Text('button')),
      ),
    ));
    await tester.pumpAndSettle();
  ...
  testWidgets('Disabled TextButton statesController', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      home: Center(child: TextButton(statesController: controller, onPressed: null, child: const Text('button'))),
    ));
    expect(controller.value, <MaterialState>{MaterialState.disabled});
    expect(count, 1);
  });
  ...
  testWidgets('icon color can be different from the text color', (WidgetTester tester) async {
    ...
    Finder buttonMaterial = find.descendant(of: find.byKey(iconButtonKey), matching: find.byType(Material));
    ...
    buttonMaterial = find.descendant(of: find.byKey(iconButtonKey), matching: find.byType(Material));
