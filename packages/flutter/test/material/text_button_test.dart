...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await gesture.moveTo(
        tester.getCenter(find.byType(TextButton)) - const Offset(1, 1),
      );
      await tester.pumpAndSettle();
  ...
  group('Default TextButton padding for textScaleFactor, textDirection', () {
    ...
    final Map<double, double> textPaddingWithoutIconHorizontal = <
      double,
      double
    >{0.5: 8, 1: 8, 1.25: 8, 1.5: 8, 2: 8, 2.5: 6, 3: 4, 4: 4};
  ...
  testWidgets('Fixed size TextButtons', (WidgetTester tester) async {
    ...
    expect(
      tester.getSize(find.widgetWithText(TextButton, '100x100')),
      const Size(100, 100),
    );
    expect(tester.getSize(find.widgetWithText(TextButton, '200xh')).width, 200);
    expect(
      tester.getSize(find.widgetWithText(TextButton, 'wx200')).height,
      200,
    );
  });
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        tester.getSize(find.widgetWithText(TextButton, '200x200')),
        const Size(200, 200),
      );
      expect(
        tester.getSize(find.widgetWithText(TextButton, '200,200')),
        const Size(200, 200),
      );
    },
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(Directionality(
        ...
        child: TextButton(
          style:
              TextButton.styleFrom(enabledMouseCursor: SystemMouseCursors.text),
          onPressed: () {},
          child: const Text('button'),
        ),
      ));
