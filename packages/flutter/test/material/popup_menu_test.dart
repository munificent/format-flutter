...
void main() {
  ...
  testWidgets(
    'disabled PopupMenuButton is not focusable',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'PopupMenuItem can have both onTap and value',
    (WidgetTester tester) async {
      final List<int> menuItemTapCounters = <int>[0, 0];
      String? selected;
  ...
  testWidgets('PopupMenu positioning', (WidgetTester tester) async {
    ...
    Future<void> openMenu(
      ...
      return TestAsyncUtils.guard<void>(() async {
        await tester.pumpWidget(
          Container(),
        ); // reset in case we had a menu up already
        await tester.pumpWidget(TestApp(
          textDirection: textDirection,
    ...
    Future<void> testPositioningDown(
      ...
      return TestAsyncUtils.guard<void>(() async {
        ...
        do {
          ...
          final Rect newRect = tester.getRect(
            find.byWidgetPredicate(popupMenu),
          );
      ...
      home: MediaQuery(
        ...
        child: Material(
          child: PopupMenuButton<int>(
            ...
            child:
                const SizedBox(height: 100.0, width: 100.0, child: Text('XXX')),
          ),
        ),
      ),
    ));
  ...
  testWidgets('Popup Menu Offset Test', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      MaterialApp(home: Scaffold(body: Material(child: buildMenuButton()))),
    );
    ...
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        body:
            Material(child: buildMenuButton(offset: const Offset(50.0, 50.0))),
      ),
    ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        tester.getSize(find.widgetWithText(InkWell, 'Item 3')).height,
        100,
      );
  ...
  testWidgets('PopupMenuItem custom padding', (WidgetTester tester) async {
    ...
    expect(
      tester.widget<Container>(
        find.widgetWithText(Container, 'Item 0'),
      ).padding,
      EdgeInsets.zero,
    );
    expect(
      tester.widget<Container>(
        find.widgetWithText(Container, 'Item 1'),
      ).padding,
      EdgeInsets.zero,
    );
    expect(
      tester.widget<Container>(
        find.widgetWithText(Container, 'Item 2'),
      ).padding,
      const EdgeInsets.all(20),
    );
    expect(
      tester.widget<Container>(
        find.widgetWithText(Container, 'Item 3'),
      ).padding,
      const EdgeInsets.all(20),
    );
  });
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        tester.getSize(find.widgetWithText(InkWell, 'Item 0').at(1)).height,
        56,
      );
      expect(
        tester.getSize(find.widgetWithText(InkWell, 'Item 1').at(1)).height,
        60,
      );
      expect(
        tester.getSize(find.widgetWithText(InkWell, 'Item 2').at(1)).height,
        75,
      );
      expect(
        tester.getSize(find.widgetWithText(InkWell, 'Item 3').at(1)).height,
        100,
      );
  ...
  testWidgets('PopupMenuButton default tooltip', (WidgetTester tester) async {
    ...
    expect(
      find.byTooltip(const DefaultMaterialLocalizations().showMenuTooltip),
      findsNWidgets(3),
    );
  });
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset topRightOfMenu = tester.getTopRight(
        find.byType(SingleChildScrollView),
      );
      final Offset bottomRightOfMenu = tester.getBottomRight(
        find.byType(SingleChildScrollView),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset popupMenu = tester.getTopRight(
        find.byType(SingleChildScrollView),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        button,
        Offset(800.0 - padding.right, padding.top),
      ); // The topPadding is 32.0.

      final Offset popupMenuTopRight = tester.getTopRight(
        find.byType(SingleChildScrollView),
      );
      ...
      final Offset popupMenuTopLeft = tester.getTopLeft(
        find.byType(SingleChildScrollView),
      );
      expect(popupMenuTopLeft, Offset(padding.left + 8.0, padding.top + 8.0));

      final Offset popupMenuBottomLeft = tester.getBottomLeft(
        find.byType(SingleChildScrollView),
      );
      expect(
        popupMenuBottomLeft,
  ...
  group('feedback', () {
    ...
    testWidgets(
      'PopupMenuButton enableFeedback works properly',
      (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      Offset popupMenu = tester.getTopLeft(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
          ...
          home: Scaffold(
            body: Center(
              child: PopupMenuButton<String>(
                ...
                itemBuilder:
                    (_) => <PopupMenuEntry<String>>[const PopupMenuDivider()],
              ),
            ),
          ),
        ));
      ...
      expect(
        tester.widget<InkWell>(find.byType(InkWell)).radius,
        testSplashRadius,
      );
    },
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        tester.getSize(find.widgetWithText(menuItemType, 'Item 0')).width,
        500,
      );
    },
  );
  ...
  testWidgets('Can change menu position and offset', (
    ...
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        body:
            Material(child: buildMenuButton(position: PopupMenuPosition.over)),
      ),
    ));
    ...
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        body:
            Material(child: buildMenuButton(position: PopupMenuPosition.under)),
      ),
    ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        buildPopupMenu(themeIconSize: 30.0, iconSize: 50.0),
      );
      await tester.pumpAndSettle();
  ...
  testWidgets('Popup menu with RouteSettings', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: const Material(
        child:
            Center(child: ElevatedButton(onPressed: null, child: Text('Go'))),
      ),
    ));
  ...
  testWidgets(
    'Popup menu is positioned under the child',
    (WidgetTester tester) async {
      final Key popupButtonKey = UniqueKey();
          ...
          child: Column(
            children: <Widget>[
              PopupMenuButton<void>(
                ...
                itemBuilder: (BuildContext context) {
                  return <PopupMenuEntry<void>>[
                    const PopupMenuItem<void>(child: Text('Example')),
                  ];
                },
      ...
      final Offset menuTopLeft = tester.getTopLeft(
        find.bySemanticsLabel('Popup menu'),
      );
