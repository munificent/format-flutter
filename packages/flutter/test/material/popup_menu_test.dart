...
void main() {
          ...
          children: <Widget>[
            ...
            PopupMenuButton<int>(
              ...
              itemBuilder: (BuildContext context) {
                ...
                return <PopupMenuEntry<int>>[const PopupMenuItem<int>(value: 1, child: Text('Tap me please!'))];
              },
            ),
            PopupMenuButton<int>(
              key: withCallbackKey,
              itemBuilder: (BuildContext context) {
                return <PopupMenuEntry<int>>[const PopupMenuItem<int>(value: 1, child: Text('Tap me, too!'))];
              },
              onOpened: () => opens++,
            ),
          ],
  ...
  testWidgets('disabled PopupMenuButton will not call itemBuilder, onOpened, onSelected or onCanceled', (
    WidgetTester tester,
  ) async {
          ...
          children: <Widget>[
            PopupMenuButton<int>(
              ...
              itemBuilder: (BuildContext context) {
                itemBuilderCalled = true;
                return <PopupMenuEntry<int>>[
                  PopupMenuItem<int>(enabled: false, value: 1, child: Text('Tap me please!', key: childKey)),
                ];
              },
            ),
          ],
  ...
  group('PopupMenuButton with Icon', () {
    ...
    testWidgets('PopupMenuButton creates IconButton when given an icon', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(home: Scaffold(appBar: AppBar(actions: <Widget>[button]))));
    ...
    Future<void> openMenu(TextDirection textDirection, Alignment alignment) async {
      return TestAsyncUtils.guard<void>(() async {
        ...
        await tester.pumpWidget(
          TestApp(textDirection: textDirection, child: Align(alignment: alignment, child: testButton)),
        );
  ...
  testWidgets('Popup Menu Offset Test', (WidgetTester tester) async {
    ...
    expect(
      tester.getTopLeft(find.byWidgetPredicate((Widget w) => '${w.runtimeType}' == '_PopupMenu<int?>')),
    ...
    await tester.pumpWidget(
      MaterialApp(home: Scaffold(body: Material(child: buildMenuButton(offset: const Offset(50.0, 50.0))))),
    );
          ...
          itemBuilder: (BuildContext context) {
            return <PopupMenuItem<int>>[
              PopupMenuItem<int>(
                value: 1,
                child: Row(
                  children: <Widget>[Semantics(child: const Text('test1')), Semantics(child: const Text('test2'))],
                ),
              ),
            ];
          },
          ...
          child: PopupMenuButton<String>(
            ...
            itemBuilder: (BuildContext context) {
              return <PopupMenuEntry<String>>[
                ...
                const PopupMenuItem<String>(height: 50, value: '1', child: SizedBox(height: 40, child: Text('Item 1'))),
                // This menu item's height parameter specifies its minimum height, so the
                // overall height of the menu item will be 75.
                const PopupMenuItem<String>(height: 75, value: '2', child: SizedBox(child: Text('Item 2'))),
                // This menu item's height will be 100.
                const PopupMenuItem<String>(value: '3', child: SizedBox(height: 100, child: Text('Item 3'))),
              ];
            },
          ),
        ),
      ...
      home: Scaffold(
        body: Center(
          child: PopupMenuButton<String>(
            ...
            itemBuilder: (BuildContext context) {
              return <PopupMenuEntry<String>>[
                const PopupMenuItem<String>(padding: EdgeInsets.zero, value: '0', child: Text('Item 0')),
                const PopupMenuItem<String>(padding: EdgeInsets.zero, height: 0, value: '0', child: Text('Item 1')),
                const PopupMenuItem<String>(padding: EdgeInsets.all(20), value: '0', child: Text('Item 2')),
            ...
            child: PopupMenuButton<String>(
              ...
              itemBuilder: (BuildContext context) {
                return <PopupMenuEntry<String>>[
                  ...
                  const CheckedPopupMenuItem<String>(checked: true, value: '0', child: Text('Item 0')),
                  // This menu item's height parameter specifies its minimum height. The
      ...
      home: Scaffold(
        body: Center(
          child: PopupMenuButton<String>(
            ...
            itemBuilder: (BuildContext context) {
              return <PopupMenuEntry<String>>[
                const CheckedPopupMenuItem<String>(padding: EdgeInsets.zero, value: '0', child: Text('Item 0')),
                const CheckedPopupMenuItem<String>(
                ...
                const CheckedPopupMenuItem<String>(padding: EdgeInsets.all(20), value: '0', child: Text('Item 2')),
                const CheckedPopupMenuItem<String>(
                  padding: EdgeInsets.all(20),
                  height: 100,
                  value: '0',
              ...
              return ElevatedButton(
                onPressed: () {
                  showMenu<int>(
                    ...
                    items: <PopupMenuItem<int>>[const PopupMenuItem<int>(value: 1, child: Text('1'))],
                  );
                },
                child: const Text('Show Menu'),
              );
        ...
        body: Align(
          ...
          child: Material(
            child: MouseRegion(
              ...
              child: PopupMenuItem<int>(key: key, mouseCursor: SystemMouseCursors.text, value: 1, child: Container()),
            ),
          ),
        ),
      ),
      ...
      home: Scaffold(
        body: Align(
          ...
          child: Material(
            child: MouseRegion(
              cursor: SystemMouseCursors.forbidden,
              child: CheckedPopupMenuItem<int>(key: key, value: 1, enabled: false, child: Container()),
            ),
          ),
        ),
      ),
  ...
  testWidgets('Vertically long PopupMenu does not overlap with the status bar and bottom notch', (
    ...
    await tester.pumpWidget(MaterialApp(
      builder: (BuildContext context, Widget? child) {
        return MediaQuery(
          data: const MediaQueryData(padding: EdgeInsets.only(top: windowPaddingTop, bottom: windowPaddingBottom)),
          child: child!,
        );
      },
      home: Scaffold(
        ...
        body: PopupMenuButton<int>(
          child: const Text('Show Menu'),
          itemBuilder: (BuildContext context) =>
              Iterable<PopupMenuItem<int>>.generate(20, (int i) => PopupMenuItem<int>(value: i, child: Text('Item $i')))
                  .toList(),
        ),
      ),
    ));
        ...
        home: Scaffold(
          appBar: AppBar(
            ...
            actions: <Widget>[
              PopupMenuButton<int>(
                child:
                    SizedBox(key: buttonKey, height: height, width: width, child: const ColoredBox(color: Colors.pink)),
        ...
        home: Scaffold(
          body: Center(
            child: PopupMenuButton<String>(
              iconSize: iconSize,
              itemBuilder:
                  (_) => <PopupMenuEntry<String>>[const PopupMenuItem<String>(value: 'value', child: Text('child'))],
            ),
          ),
        ),
      ));
        ...
        body: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              PopupMenuButton<int>(
                child: SizedBox(key: buttonKey, height: 10.0, width: 10.0, child: const ColoredBox(color: Colors.pink)),
                itemBuilder: (BuildContext context) => <PopupMenuEntry<int>>[
                      const PopupMenuItem<int>(value: 1, child: Text('-1-')),
                      const PopupMenuItem<int>(value: 2, child: Text('-2-')),
                    ],
  ...
  testWidgets('PopupMenuButton custom splash radius', (WidgetTester tester) async {
    ...
    expect(tester.widget<InkResponse>(find.byType(InkResponse)).radius, Material.defaultSplashRadius);
      ...
      home: Scaffold(
        body: Center(
          child: PopupMenuButton<String>(
            ...
            itemBuilder:
                (_) => <PopupMenuEntry<String>>[const PopupMenuItem<String>(value: 'value', child: Text('Item 0'))],
          ),
        ),
      ),
    ));
  ...
  testWidgets('Can change menu position and offset', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      MaterialApp(home: Scaffold(body: Material(child: buildMenuButton(position: PopupMenuPosition.over)))),
    );
    ...
    await tester.pumpWidget(
      MaterialApp(home: Scaffold(body: Material(child: buildMenuButton(position: PopupMenuPosition.under)))),
    );
        ...
        child: Column(
          children: <Widget>[
            PopupMenuButton<void>(
              key: popupButtonKey,
              itemBuilder: (BuildContext context) {
                return <PopupMenuEntry<void>>[const PopupMenuItem<void>(height: 1000, child: Text('Example'))];
              },
            ),
          ],
        ),
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: Material(
        child: Column(
          children: <Widget>[
            ScrollbarTheme(
              data: scrollbarTheme.copyWith(thumbColor: const MaterialStatePropertyAll<Color?>(Color(0xff0000ff))),
              child: PopupMenuButton<void>(
                key: popupButtonKey,
                itemBuilder: (BuildContext context) {
                  return <PopupMenuEntry<void>>[const PopupMenuItem<void>(height: 1000, child: Text('Example'))];
                    ...
                    PopupMenuItem<int>(
                      onTap: () {
                        showModalBottomSheet(
                          context: context,
                          builder: (BuildContext context) {
                            return const SizedBox(height: 200.0, child: Center(child: Text('ModalBottomSheet')));
                          },
                        );
                      },
                      value: 10,
