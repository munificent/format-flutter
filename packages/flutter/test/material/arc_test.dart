...
void main() {
  ...
  test('MaterialRectArcTween', () {
    ...
    expect(sameRect(
      tween.lerp(0.25),
      const Rect.fromLTRB(120.0, 113.0, 259.0, 237.0),
    ), isTrue);
    expect(sameRect(
      tween.lerp(0.75),
      const Rect.fromLTRB(42.3, 206.5, 153.5, 354.7),
    ), isTrue);
    expect(tween.lerp(1.0), end);
    ...
    expect(sameRect(
      tween.lerp(0.25),
      const Rect.fromLTRB(92.0, 262.0, 203.0, 388.0),
    ), isTrue);
    expect(sameRect(
      tween.lerp(0.75),
      const Rect.fromLTRB(169.7, 168.5, 308.5, 270.3),
    ), isTrue);
    expect(tween.lerp(1.0), begin);
  });
}
