...
void main() {
  ...
  test('Typography lerp special cases', () {
    ...
    expect(
      identical(Typography.lerp(typography, typography, 0.5), typography),
      true,
    );
  });
  ...
  test(
    'Typography on iOS defaults to the correct SF font family based on size',
    () {
  ...
  testWidgets('Typography implements debugFillProperties', (
    ...
    expect(nonDefaultPropertyNames, <String>[
      'black',
      'white',
      'englishLike',
      'dense',
  ...
  test('englishLike2018 TextTheme matches Material Design spec', () {
    ...
    final TextTheme theme = Typography.englishLike2018.merge(
  ...
  test('englishLike2021 TextTheme matches Material Design 3 spec', () {
    ...
    final TextTheme theme = Typography.englishLike2021.merge(
      Typography.blackMountainView,
    );
    ...
    expect(
      theme.displayLarge!.leadingDistribution,
    ...
    expect(
      theme.displayMedium!.leadingDistribution,
      TextLeadingDistribution.even,
    );
    ...
    expect(
      theme.displaySmall!.leadingDistribution,
      TextLeadingDistribution.even,
    );
    ...
    expect(
      theme.headlineLarge!.leadingDistribution,
      TextLeadingDistribution.even,
    );
    ...
    expect(
      theme.headlineMedium!.leadingDistribution,
      TextLeadingDistribution.even,
    );
    ...
    expect(
      theme.headlineSmall!.leadingDistribution,
      TextLeadingDistribution.even,
    );
    ...
    expect(
      theme.titleMedium!.leadingDistribution,
      TextLeadingDistribution.even,
    );
    ...
    expect(
      theme.labelMedium!.leadingDistribution,
      TextLeadingDistribution.even,
    );
