...
void main() {
  group('$ReorderableListView', () {
    ...
    group('in vertical mode', () {
      ...
      testWidgets('properly determines the vertical drop area extents', (
        ...
        double getListHeight() {
          final RenderSliverList listScrollView = tester.renderObject(
        ...
        TestGesture drag = await tester.startGesture(
          tester.getCenter(find.text('Normal item')),
        );
        await tester.pump(kLongPressTimeout + kPressTimeout);
        await tester.pumpAndSettle();
        expect(getListHeight(), kDraggingListHeight);
      ...
      testWidgets(
        'Vertical drag in progress golden image',
        (WidgetTester tester) async {
      ...
      testWidgets(
        'Preserves children states when rebuilt',
        (WidgetTester tester) async {
        ...
        Widget buildWithScrollController(ScrollController controller) {
          return MaterialApp(
            home: PrimaryScrollController(
              ...
              child:
                  SizedBox(height: 100.0, width: 100.0, child: reorderableList),
            ),
          );
        }
      ...
      group('Accessibility (a11y/Semantics)', () {
        ...
        const CustomSemanticsAction moveToStart = CustomSemanticsAction(
          label: 'Move to the start',
        );
        const CustomSemanticsAction moveToEnd = CustomSemanticsAction(
          label: 'Move to the end',
        );
        const CustomSemanticsAction moveUp = CustomSemanticsAction(
          label: 'Move up',
        );
        const CustomSemanticsAction moveDown = CustomSemanticsAction(
          label: 'Move down',
        );
        ...
        testWidgets(
          ...
          (WidgetTester tester) async {
            ...
            await tester.pumpWidget(MaterialApp(
              home:
                  SizedBox(height: itemHeight * 10, child: reorderableListView),
            ));
    ...
    group('in horizontal mode', () {
      ...
      testWidgets(
        'Horizontal drag in progress golden image',
        (WidgetTester tester) async {
          debugDisableShadows = false;
          final Widget reorderableListView = ReorderableListView(
            scrollDirection: Axis.horizontal,
      ...
      group('Accessibility (a11y/Semantics)', () {
        ...
        const CustomSemanticsAction moveLeft = CustomSemanticsAction(
          label: 'Move left',
        );
        const CustomSemanticsAction moveRight = CustomSemanticsAction(
          label: 'Move right',
        );
    ...
    group('Padding', () {
      ...
      testWidgets('Padding with header or footer', (WidgetTester tester) async {
        ...
        // Vertical Header
        await tester.pumpWidget(
          build(padding: padding, header: verticalHeader),
        );
        expect(
          tester.getRect(find.byKey(headerKey)),
        ...
        // Vertical Footer
        await tester.pumpWidget(
          build(padding: padding, footer: verticalFooter),
        );
        expect(
    ...
    testWidgets('Animation test when placing an item in place', (
      ...
      Offset getTestItemPosition() {
        final RenderBox testItem = tester.renderObject<RenderBox>(
          find.byKey(testItemKey),
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          tester.getTopRight(dragHandle).dx,
    ...
    testWidgets('Horizontal list renders drag handle in correct position', (
      ...
      expect(
        tester.getBottomRight(dragHandle).dy,
  ...
  testWidgets('ReorderableListView auto scrolls speed is configurable', (
    ...
    Future<double> pumpListAndDrag({
      required double autoScrollerVelocityScalar,
    }) async {
    ...
    expect(
      offsetForFastScroller / offsetForSlowScroller,
