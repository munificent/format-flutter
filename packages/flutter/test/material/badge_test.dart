...
void main() {
  ...
  testWidgets('Large Badge textStyle and colors', (WidgetTester tester) async {
    ...
    expect(
      tester.renderObject(find.byType(Badge)),
      paints..rrect(color: black),
    );
  });
  ...
  testWidgets('Large Badge alignment', (WidgetTester tester) async {
    ...
    expect(
      box,
      paints..rrect(rrect: RRect.fromLTRBR(0, 0, 16, 16, badgeRadius)),
    );
    ...
    expect(
      box,
      paints..rrect(rrect: RRect.fromLTRBR(200 - 16, 0, 200, 16, badgeRadius)),
    );
    ...
    expect(
      ...
      paints
        ..rrect(
          rrect: RRect.fromLTRBR(200 - 16, 100 - 8, 200, 100 + 8, badgeRadius),
        ),
    );
    ...
    expect(
      box,
      paints..rrect(rrect: RRect.fromLTRBR(0, 200 - 16, 16, 200, badgeRadius)),
    );
    ...
    expect(
      ...
      paints
        ..rrect(
          rrect: RRect.fromLTRBR(100 - 8, 200 - 16, 100 + 8, 200, badgeRadius),
        ),
    );
    ...
    expect(
      ...
      paints
        ..rrect(
          rrect: RRect.fromLTRBR(100 - 8, 0, 100 + 8, 16, badgeRadius).shift(
            offset,
          ),
        ),
    );
    ...
    expect(
      ...
      paints
        ..rrect(
          rrect:
              RRect.fromLTRBR(200 - 16, 0, 200, 16, badgeRadius).shift(offset),
        ),
    );
    ...
    expect(
      ...
      paints
        ..rrect(
          rrect: RRect.fromLTRBR(0, 100 - 8, 16, 100 + 8, badgeRadius).shift(
            offset,
          ),
        ),
    );
    ...
    expect(
      ...
      paints
        ..rrect(
          rrect:
              RRect.fromLTRBR(0, 200 - 16, 16, 200, badgeRadius).shift(offset),
        ),
    );
  ...
  testWidgets('Small Badge alignment', (WidgetTester tester) async {
    ...
    expect(
      ...
      paints
        ..rrect(
          rrect: RRect.fromLTRBR(200 - 6, 100 - 3, 200, 100 + 3, badgeRadius),
        ),
    );
    ...
    expect(
      ...
      paints
        ..rrect(
          rrect: RRect.fromLTRBR(100 - 3, 200 - 6, 100 + 3, 200, badgeRadius),
        ),
    );
