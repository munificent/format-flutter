...
void main() {
  ...
  testWidgets(
    'InkWell only onTapDown enables gestures',
  ...
  testWidgets('ink well changes color on pressed with overlayColor', (
    ...
    expect(
      inkFeatures,
      paints
        ..rect(rect: const Rect.fromLTRB(0, 0, 100, 100), color: pressedColor),
    );
    await gesture.up();
  });
  ...
  testWidgets('InkWell customBorder clips for focus highlight', (
    ...
    final Path expectedClipPath = Path()
      ..addRRect(
        RRect.fromRectAndRadius(expectedClipRect, const Radius.circular(50.0)),
      );
  ...
  testWidgets(
    'InkResponse highlightShape can be updated',
    (WidgetTester tester) async {
      FocusManager.instance.highlightStrategy =
          FocusHighlightStrategy.alwaysTraditional;
      final FocusNode focusNode = FocusNode(debugLabel: 'Ink Focus');
  ...
  testWidgets(
    'InkWell borderRadius can be updated',
    (WidgetTester tester) async {
      FocusManager.instance.highlightStrategy =
          FocusHighlightStrategy.alwaysTraditional;
      final FocusNode focusNode = FocusNode(debugLabel: 'Ink Focus');
  ...
  testWidgets(
    'InkWell customBorder can be updated',
    (WidgetTester tester) async {
      FocusManager.instance.highlightStrategy =
          FocusHighlightStrategy.alwaysTraditional;
      final FocusNode focusNode = FocusNode(debugLabel: 'Ink Focus');
      ...
      Path expectedClipPath = Path()
        ..addRRect(
          RRect.fromRectAndRadius(expectedClipRect, const Radius.circular(20)),
        );
      expect(
        inkFeatures,
        paints
      ...
      expectedClipPath = Path()
        ..addRRect(
          RRect.fromRectAndRadius(expectedClipRect, const Radius.circular(40)),
        );
      expect(
        inkFeatures,
        paints
  ...
  testWidgets('InkWell splash customBorder can be updated', (
    ...
    expect(
      inkFeatures,
      paintsExactlyCountTimes(#clipPath, 2),
  ...
  testWidgets('excludeFromSemantics', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Directionality(
      textDirection: TextDirection.ltr,
      child:
          Material(child: InkWell(onTap: () {}, child: const Text('Button'))),
    ));
  ...
  testWidgets(
    "ink response doesn't focus when disabled",
    (WidgetTester tester) async {
      FocusManager.instance.highlightStrategy =
          FocusHighlightStrategy.alwaysTouch;
      final FocusNode focusNode = FocusNode(debugLabel: 'Ink Focus');
      ...
      await tester.pumpWidget(Material(
        child: MediaQuery(
          ...
          child: Directionality(
            textDirection: TextDirection.ltr,
            child:
                InkWell(focusNode: focusNode, child: Container(key: childKey)),
          ),
        ),
      ));
      await tester.pumpAndSettle();
  ...
  testWidgets(
    "ink response doesn't hover when disabled",
    (WidgetTester tester) async {
      FocusManager.instance.highlightStrategy =
          FocusHighlightStrategy.alwaysTouch;
      final FocusNode focusNode = FocusNode(debugLabel: 'Ink Focus');
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final MaterialInkController material = Material.of(
        tester.element(find.byKey(innerKey)),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final MaterialInkController material = Material.of(
        tester.element(find.byKey(leftKey)),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(doubleInkWellRow(
        leftWidth: 110,
        rightWidth: 90,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await gesture.moveTo(
        tester.getCenter(find.byType(InkWell)) - const Offset(1, 1),
      );
      await tester.pumpAndSettle();
