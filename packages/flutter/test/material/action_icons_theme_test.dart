...
void main() {
  ...
  testWidgetsWithLeakTracking(
    'Default ActionIconThemeData debugFillProperties',
    (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
    ...
    (WidgetTester tester) async {
      ...
      expect(description, <dynamic>[
        ...
        allOf(
          startsWith('endDrawerButtonIconBuilder:'),
          containsBuilderCallback,
        ),
      ]);
    },
  );
  ...
  testWidgetsWithLeakTracking(
    'Action buttons use ThemeData action icon theme',
    (WidgetTester tester) async {
