...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      const BorderSide disabledBorderSide = BorderSide(
      ...
      const BorderSide pressedBorderSide = BorderSide(
        ...
        for (final TextDirection textDirection in textDirectionOptions) {
          for (final Widget? icon in iconOptions) {
            ...
            testWidgets(testName, (WidgetTester tester) async {
              ...
              final double expectedPaddingTop =
  ...
  testWidgets('Fixed size OutlinedButtons', (WidgetTester tester) async {
    ...
    expect(
      tester.getSize(find.widgetWithText(OutlinedButton, '100x100')),
      const Size(100, 100),
    );
    expect(
      tester.getSize(find.widgetWithText(OutlinedButton, '200xh')).width,
      200,
    );
    expect(
      tester.getSize(find.widgetWithText(OutlinedButton, 'wx200')).height,
      200,
    );
  });
  ...
  testWidgets(
    'OutlinedButton.icon icon,label layout',
    (WidgetTester tester) async {
      final Key buttonKey = UniqueKey();
  ...
  testWidgets('Fixed size OutlinedButton, same as minimumSize == maximumSize', (
    ...
    expect(
      tester.getSize(find.widgetWithText(OutlinedButton, '200x200')),
      const Size(200, 200),
    );
    expect(
      tester.getSize(find.widgetWithText(OutlinedButton, '200,200')),
      const Size(200, 200),
    );
  });
  ...
  testWidgets(
    'OutlinedButton.icon statesController',
    (WidgetTester tester) async {
