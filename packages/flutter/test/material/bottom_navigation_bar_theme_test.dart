...
void main() {
  ...
  testWidgets('BottomNavigationBar is themeable', (WidgetTester tester) async {
    ...
    expect(tester.firstWidget<Transform>(findAlarmTransform).transform, equals(
      Matrix4.diagonal3(Vector3.all(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      // Unselected label has a font size of 22 but is scaled down to be font size 21.
      expect(
        tester.firstWidget<Transform>(findDescendantOfBottomNavigationBar(find
            .ancestor(
              of: find.text('Alarm'),
              matching: find.byType(Transform),
            ))).transform,
