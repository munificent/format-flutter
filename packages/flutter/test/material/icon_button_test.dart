...
void main() {
  ...
  testWidgets('test icon is findable by key', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(wrap(
      useMaterial3: true,
      child:
          IconButton(key: key, onPressed: () {}, icon: const Icon(Icons.link)),
    ));
  ...
  testWidgets(
    'test default icon buttons are sized up to 48',
  ...
  testWidgets(
    'test small icons are sized up to 48dp',
    (WidgetTester tester) async {
      final bool material3 = theme.useMaterial3;
      await tester.pumpWidget(wrap(
        useMaterial3: material3,
  ...
  testWidgets(
    'IconButton with explicit splash radius - M2',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'IconButton Semantics (enabled) - M2',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'IconButton Semantics (disabled) - M2',
    (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgets(
    'IconButton Semantics (selected) - M3',
    (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgets(
    'IconButton loses focus when disabled.',
    (WidgetTester tester) async {
  ...
  group('feedback', () {
    ...
    testWidgets(
      'IconButton with enabled feedback',
      (WidgetTester tester) async {
        final Widget button = Directionality(
          textDirection: TextDirection.ltr,
          child: Center(
    ...
    testWidgets(
      'IconButton with enabled feedback by default',
      (WidgetTester tester) async {
        final Widget button = Directionality(
          textDirection: TextDirection.ltr,
          child: Center(
  ...
  testWidgets(
    'IconButton responds to density changes.',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'IconButton.mouseCursor changes cursor on hover',
    (WidgetTester tester) async {
      // Test argument works
      await tester.pumpWidget(MaterialApp(
        theme: theme,
  ...
  testWidgets(
    'disabled IconButton has basic mouse cursor',
    (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        theme: theme,
        home: const Material(
  ...
  testWidgets('IconButton defaults - M3', (WidgetTester tester) async {
    final ThemeData themeM3 = ThemeData.from(
      colorScheme: colorScheme,
      useMaterial3: true,
    );
  ...
  testWidgets('IconButton default overlayColor resolves pressed state', (
    ...
    expect(
      overlayColor(),
      paints..rect(color: theme.colorScheme.onSurfaceVariant.withOpacity(0.12)),
    );
  });
  ...
  testWidgets('IconButton.filledTonal defaults - M3', (
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: const Center(
        child:
            IconButton.filledTonal(onPressed: null, icon: Icon(Icons.ac_unit)),
      ),
    ));
  ...
  testWidgets('IconButton.outlined defaults - M3', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      theme: themeM3,
      home: const Center(
        child: IconButton.outlined(onPressed: null, icon: Icon(Icons.ac_unit)),
      ),
    ));
    ...
    expect(material.elevation, 0.0);
    expect(material.shadowColor, Colors.transparent);
    expect(material.shape, StadiumBorder(
  ...
  testWidgets(
    'Does IconButton contribute semantics - M3',
    (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
      await tester.pumpWidget(Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgets(
    'Override IconButton default padding - M3',
    (WidgetTester tester) async {
      ...
      final Padding paddingWidget1 = tester.widget<Padding>(find.descendant(
        of: find.byType(IconButton),
      ...
      final Padding paddingWidget2 = tester.widget<Padding>(find.descendant(
        of: find.byType(IconButton),
        matching: find.byType(Padding),
      ));
      ...
      final Padding paddingWidget3 = tester.widget<Padding>(find.descendant(
        of: find.byType(IconButton),
        matching: find.byType(Padding),
      ));
