...
void main() {
  ...
  testWidgets('test icon is findable by key', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      wrap(useMaterial3: true, child: IconButton(key: key, onPressed: () {}, icon: const Icon(Icons.link))),
    );
  ...
  testWidgets('test small icons are sized up to 48dp', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(wrap(
      useMaterial3: material3,
      child: IconButton(iconSize: 10.0, onPressed: mockOnPressedFunction.handler, icon: const Icon(Icons.link)),
    ));
    ...
    await tester.pumpWidget(Directionality(
      ...
      child: Material(
        child: Row(
          ...
          children: <Widget>[IconButton(onPressed: mockOnPressedFunction.handler, icon: const Icon(Icons.ac_unit))],
        ),
      ),
    ));
  ...
  testWidgets('test default padding', (WidgetTester tester) async {
    await tester.pumpWidget(wrap(
      useMaterial3: theme.useMaterial3,
      child: IconButton(onPressed: mockOnPressedFunction.handler, icon: const Icon(Icons.ac_unit), iconSize: 80.0),
    ));
  ...
  testWidgets('test tooltip', (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
      theme: theme,
      home: Material(
        child: Center(child: IconButton(onPressed: mockOnPressedFunction.handler, icon: const Icon(Icons.ac_unit))),
      ),
    ));
  ...
  testWidgets('IconButton with explicit splashColor and highlightColor - M2', (WidgetTester tester) async {
    ...
    buttonWidget = wrap(
      useMaterial3: false,
      child: IconButton(icon: const Icon(Icons.android), onPressed: () {/* enable the button */}),
    );

    await tester.pumpWidget(Theme(
      data: ThemeData(highlightColor: themeHighlightColor1, splashColor: themeSplashColor1, useMaterial3: false),
      child: buttonWidget,
    ));
    ...
    await tester.pumpWidget(Theme(
      data: ThemeData(highlightColor: themeHighlightColor2, splashColor: themeSplashColor2, useMaterial3: false),
  ...
  testWidgets('IconButton with explicit splash radius - M2', (WidgetTester tester) async {
    ...
    expect(Material.of(tester.element(find.byType(IconButton))), paints..circle(radius: splashRadius));
  ...
  testWidgets('IconButton Semantics (enabled) - M2', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(wrap(
      useMaterial3: false,
      child: IconButton(onPressed: mockOnPressedFunction.handler, icon: const Icon(Icons.link, semanticLabel: 'link')),
    ));
  ...
  testWidgets('IconButton loses focus when disabled.', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(wrap(
      useMaterial3: theme.useMaterial3,
      child: IconButton(focusNode: focusNode, autofocus: true, onPressed: () {}, icon: const Icon(Icons.link)),
    ));
    ...
    await tester.pumpWidget(wrap(
      useMaterial3: theme.useMaterial3,
      child: IconButton(focusNode: focusNode, autofocus: true, onPressed: null, icon: const Icon(Icons.link)),
    ));
    await tester.pump();
  ...
  testWidgets("Disabled IconButton can't be traversed to when disabled.", (WidgetTester tester) async {
    ...
    await tester.pumpWidget(wrap(
      ...
      child: Column(
        children: <Widget>[
          IconButton(focusNode: focusNode1, autofocus: true, onPressed: () {}, icon: const Icon(Icons.link)),
  ...
  group('feedback', () {
    ...
    testWidgets('IconButton with disabled feedback', (WidgetTester tester) async {
      final Widget button = Directionality(
        textDirection: TextDirection.ltr,
        child: Center(child: IconButton(onPressed: () {}, enableFeedback: false, icon: const Icon(Icons.link))),
      );
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: const Material(
        child: Directionality(
          textDirection: TextDirection.ltr,
          child: Center(
            child: IconButton(onPressed: null, mouseCursor: SystemMouseCursors.none, icon: Icon(Icons.play_arrow)),
          ),
        ),
      ),
    ));
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: Material(
        child: Directionality(
          ...
          child: Center(
            child:
                IconButton(onPressed: () {}, mouseCursor: SystemMouseCursors.none, icon: const Icon(Icons.play_arrow)),
          ),
        ),
      ),
    ));
  ...
  testWidgets('IconTheme opacity test', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      theme: theme,
      home: Scaffold(
        body: Center(child: IconButton(icon: const Icon(Icons.add), color: Colors.purple, onPressed: () {})),
      ),
    ));
  ...
  testWidgets('IconButton defaults - M3', (WidgetTester tester) async {
    ...
    // Enabled IconButton
    await tester.pumpWidget(
      MaterialApp(theme: themeM3, home: Center(child: IconButton(onPressed: () {}, icon: const Icon(Icons.ac_unit)))),
    );
    ...
    // Disabled IconButton
    await tester.pumpWidget(
      MaterialApp(theme: themeM3, home: const Center(child: IconButton(onPressed: null, icon: Icon(Icons.ac_unit)))),
    );
        ...
        body: Center(
          child: Builder(
            builder: (BuildContext context) {
              return IconButton(onPressed: () {}, focusNode: focusNode, icon: const Icon(Icons.add));
            },
          ),
        ),
      ),
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: Scaffold(
        body: Center(
          child: Builder(
            builder: (BuildContext context) {
              return IconButton.filled(onPressed: () {}, focusNode: focusNode, icon: const Icon(Icons.add));
            },
          ),
        ),
      ),
  ...
  testWidgets('Toggleable IconButton.fill defaults - M3', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      theme: themeM3,
      home: Center(child: IconButton.filled(isSelected: true, onPressed: () {}, icon: const Icon(Icons.ac_unit))),
    ));
    ...
    await tester.pumpWidget(MaterialApp(
      theme: themeM3,
      home: Center(child: IconButton.filled(isSelected: false, onPressed: () {}, icon: const Icon(Icons.ac_unit))),
    ));
    ...
    await tester.pumpWidget(MaterialApp(
      theme: themeM3,
      home: const Center(child: IconButton.filled(isSelected: true, onPressed: null, icon: Icon(Icons.ac_unit))),
    ));
  ...
  testWidgets('IconButton.filledTonal defaults - M3', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      theme: themeM3,
      home: Center(child: IconButton.filledTonal(onPressed: () {}, icon: const Icon(Icons.ac_unit))),
    ));
    ...
    await tester.pumpWidget(MaterialApp(
      theme: themeM3,
      home: const Center(child: IconButton.filledTonal(onPressed: null, icon: Icon(Icons.ac_unit))),
    ));
  ...
  testWidgets('IconButton.filledTonal default overlayColor resolves pressed state', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: Scaffold(
        body: Center(
          child: Builder(
            builder: (BuildContext context) {
              return IconButton.filledTonal(onPressed: () {}, focusNode: focusNode, icon: const Icon(Icons.add));
            },
          ),
        ),
      ),
    ...
    expect(
      ...
      paints
        ..rect()
        ..rect(color: theme.colorScheme.onSecondaryContainer.withOpacity(0.12)),
    );
    // Remove pressed and hovered states
    await gesture.up();
    await tester.pumpAndSettle();
  ...
  testWidgets('Toggleable IconButton.filledTonal defaults - M3', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      theme: themeM3,
      home: Center(child: IconButton.filledTonal(isSelected: true, onPressed: () {}, icon: const Icon(Icons.ac_unit))),
    ));
    ...
    await tester.pumpWidget(MaterialApp(
      theme: themeM3,
      home: Center(child: IconButton.filledTonal(isSelected: false, onPressed: () {}, icon: const Icon(Icons.ac_unit))),
    ));
    ...
    await tester.pumpWidget(MaterialApp(
      theme: themeM3,
      home: const Center(child: IconButton.filledTonal(isSelected: true, onPressed: null, icon: Icon(Icons.ac_unit))),
    ));
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: Scaffold(
        body: Center(
          child: Builder(
            builder: (BuildContext context) {
              return IconButton.outlined(onPressed: () {}, focusNode: focusNode, icon: const Icon(Icons.add));
            },
          ),
        ),
      ),
  ...
  testWidgets('Toggleable IconButton.outlined defaults - M3', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      theme: themeM3,
      home: Center(child: IconButton.outlined(isSelected: true, onPressed: () {}, icon: const Icon(Icons.ac_unit))),
    ));
    ...
    await tester.pumpWidget(MaterialApp(
      theme: themeM3,
      home: Center(child: IconButton.outlined(isSelected: false, onPressed: () {}, icon: const Icon(Icons.ac_unit))),
    ));
    ...
    await tester.pumpWidget(MaterialApp(
      theme: themeM3,
      home: const Center(child: IconButton.outlined(isSelected: true, onPressed: null, icon: Icon(Icons.ac_unit))),
    ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        ...
        home: Scaffold(
          body: Center(child: IconButton(onPressed: () {}, focusNode: focusNode, icon: const Icon(Icons.ac_unit))),
        ),
      ));
      ...
      home: StatefulBuilder(
        builder: (BuildContext context, StateSetter setState) {
          return Scaffold(
            body: Center(
              child: IconButton(
                style: ButtonStyle(foregroundColor: MaterialStateProperty.resolveWith<Color>(getIconColor)),
  ...
  testWidgets('Override IconButton default padding - M3', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: Scaffold(
        body: Center(
          child: IconButton(padding: const EdgeInsets.all(20), onPressed: () {}, icon: const Icon(Icons.ac_unit)),
        ),
      ),
    ));
  ...
  testWidgets('Default IconButton is not selectable - M3', (WidgetTester tester) async {
    ...
    Material buttonMaterial() {
      return tester.widget<Material>(find.descendant(of: find.byType(IconButton), matching: find.byType(Material)));
    }
  ...
  testWidgets('The visualDensity of M3 IconButton can be configured by IconButtonTheme, '
    ...
    Future<void> buildTest({VisualDensity? iconButtonThemeVisualDensity, VisualDensity? themeVisualDensity}) async {
      return tester.pumpWidget(MaterialApp(
        ...
        home: Material(child: Center(child: IconButton(onPressed: () {}, icon: const Icon(Icons.play_arrow)))),
      ));
    }
  ...
  group('IconTheme tests in Material 3', () {
    ...
    testWidgets('Theme IconButtonTheme overrides IconTheme in Material3', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        theme: ThemeData.from(colorScheme: const ColorScheme.light(), useMaterial3: true).copyWith(
          ...
          iconButtonTheme:
              IconButtonThemeData(style: IconButton.styleFrom(foregroundColor: Colors.green, iconSize: 27)),
        ),
        home: IconButton(icon: const Icon(Icons.account_box), onPressed: () {}),
      ));
    ...
    testWidgets('White icon color defined by users shows correctly in Material3', (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        theme: ThemeData.from(colorScheme: const ColorScheme.dark(), useMaterial3: true).copyWith(
...
Widget wrap({required Widget child, required bool useMaterial3}) {
  return useMaterial3
      ...
      : FocusTraversalGroup(
          policy: ReadingOrderTraversalPolicy(),
          child: Directionality(textDirection: TextDirection.ltr, child: Material(child: Center(child: child))),
        );
}
