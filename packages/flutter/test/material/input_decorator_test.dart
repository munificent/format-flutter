...
TextStyle getLabelStyle(WidgetTester tester) {
  return tester.firstWidget<AnimatedDefaultTextStyle>(
    find.ancestor(of: find.text('label'), matching: find.byType(AnimatedDefaultTextStyle)),
  ).style;
}
  ...
  for (final bool useMaterial3 in <bool>[true, false]) {
    testWidgets('InputDecorator input/label text layout', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(buildInputDecorator(
        ...
        isEmpty: true,
        // isFocused: false (default)
        decoration: const InputDecoration(labelText: 'label', floatingLabelBehavior: FloatingLabelBehavior.always),
      ));
      await tester.pumpAndSettle();
      ...
      await tester.pumpWidget(buildInputDecorator(
        useMaterial3: useMaterial3,
        // isFocused: false (default)
        decoration: const InputDecoration(labelText: 'label', floatingLabelBehavior: FloatingLabelBehavior.never),
      ));
      await tester.pumpAndSettle();
      ...
      await tester.pumpWidget(buildInputDecorator(
        useMaterial3: useMaterial3,
        isEmpty: true,
        decoration: const InputDecoration(labelText: 'label', alignLabelWithHint: true, hintText: 'hint'),
      ));
      await tester.pumpAndSettle();
      expect(tester.getSize(find.byType(InputDecorator)), const Size(800.0, 56.0));
      if (!useMaterial3) {
    ...
    testWidgets('InputDecorator floating label animation duration and curve', (WidgetTester tester) async {
      Future<void> pumpInputDecorator({required bool isFocused}) async {
        return tester.pumpWidget(buildInputDecorator(
          isEmpty: true,
          isFocused: isFocused,
          decoration: const InputDecoration(labelText: 'label', floatingLabelBehavior: FloatingLabelBehavior.auto),
        ));
      }
              ...
              home: Material(
                child: Directionality(
                  ...
                  child: TextField(
                    ...
                    maxLines: 8,
                    decoration:
                        InputDecoration(labelText: 'label', alignLabelWithHint: alignLabelWithHint, hintText: 'hint'),
    ...
    testWidgets('InputDecorator error/helper/counter layout', (WidgetTester tester) async {
      await tester.pumpWidget(buildInputDecorator(
        ...
        // isFocused: false (default)
        decoration:
            const InputDecoration(labelText: 'label', helperText: 'helper', counterText: 'counter', filled: true),
      ));
    ...
    testWidgets('InputDecorator counter text, widget, and null', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        buildFrame(counterText: counterText, counter: counter, buildCounter: buildCounter, maxLength: maxLength),
      );
      ...
      // counterText.
      await tester.pumpWidget(buildFrame(counterText: counterText, buildCounter: buildCounter, maxLength: maxLength));
    ...
    testWidgets('InputDecoration helperMaxLines', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(buildInputDecorator(
        ...
        isEmpty: true,
        // isFocused: false (default)
        decoration: const InputDecoration(labelText: 'label', helperText: kHelper3, helperMaxLines: 3, filled: true),
      ));
      ...
      await tester.pumpWidget(buildInputDecorator(
        ...
        isEmpty: true,
        // isFocused: false (default)
        decoration: const InputDecoration(labelText: 'label', helperText: kHelper3, helperMaxLines: 2, filled: true),
      ));
      ...
      await tester.pumpWidget(buildInputDecorator(
        ...
        isEmpty: true,
        // isFocused: false (default)
        decoration: const InputDecoration(labelText: 'label', helperText: kHelper2, helperMaxLines: 3, filled: true),
      ));
      ...
      await tester.pumpWidget(buildInputDecorator(
        ...
        isEmpty: true,
        // isFocused: false (default)
        decoration: const InputDecoration(labelText: 'label', helperText: kHelper1, helperMaxLines: 3, filled: true),
      ));
    ...
    testWidgets('InputDecorator icon/prefix/suffix', (WidgetTester tester) async {
      await tester.pumpWidget(buildInputDecorator(
        ...
        // isEmpty: false (default)
        // isFocused: false (default)
        decoration: const InputDecoration(prefixText: 'p', suffixText: 's', icon: Icon(Icons.android), filled: true),
      ));
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(MaterialApp(
          theme: theme,
          home: Material(child: TextField(focusNode: focusNode, decoration: const InputDecoration(labelText: 'label'))),
        ));
    ...
    testWidgets('InputDecorator tall prefix', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(buildInputDecorator(
        ...
        // isEmpty: false (default)
        // isFocused: false (default)
        decoration: const InputDecoration(prefix: SizedBox(key: pKey, height: 100, width: 10), filled: true),
    ...
    testWidgets('InputDecorator prefixIcon/suffixIcon', (WidgetTester tester) async {
      await tester.pumpWidget(buildInputDecorator(
        ...
        // isFocused: false (default)
        decoration:
            const InputDecoration(prefixIcon: Icon(Icons.pages), suffixIcon: Icon(Icons.satellite), filled: true),
      ));
    ...
    testWidgets('prefix/suffix icons are centered when smaller than 48 by 48', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(buildInputDecorator(
        useMaterial3: useMaterial3,
        decoration: const InputDecoration(
          prefixIcon: Padding(padding: EdgeInsets.all(16.0), child: SizedBox(width: 8.0, height: 8.0, key: prefixKey)),
          filled: true,
        ),
      ));
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(buildInputDecorator(
          useMaterial3: useMaterial3,
          decoration:
              const InputDecoration(prefixIcon: SizedBox(width: 100.0, height: 100.0, key: prefixKey), filled: true),
        ));
    ...
    group('constraints', () {
      testWidgets('No InputDecorator constraints', (WidgetTester tester) async {
        await tester.pumpWidget(buildInputDecorator(useMaterial3: useMaterial3));
      ...
      testWidgets('InputDecoratorThemeData constraints', (WidgetTester tester) async {
        await tester.pumpWidget(buildInputDecorator(
          useMaterial3: useMaterial3,
          theme: ThemeData(
            inputDecorationTheme: const InputDecorationTheme(constraints: BoxConstraints(maxWidth: 300, maxHeight: 40)),
          ),
        ));
      ...
      testWidgets('InputDecorator constraints', (WidgetTester tester) async {
        await tester.pumpWidget(buildInputDecorator(
          ...
          decoration: const InputDecoration(constraints: BoxConstraints(maxWidth: 200, maxHeight: 32)),
        ));
    ...
    group('textAlignVertical position', () {
      group('simple case', () {
        ...
        testWidgets('works with density and content padding', (WidgetTester tester) async {
          ...
          await tester.pumpWidget(Center(
            child: SizedBox(
              ...
              child: buildInputDecorator(
                ...
                // isFocused: false (default)
                expands: true,
                decoration: const InputDecoration(border: InputBorder.none, contentPadding: contentPadding),
                textAlignVertical: TextAlignVertical.center,
                visualDensity: visualDensity,
          ...
          final double childTop = visualDensity.baseSizeAdjustment.dy / 2.0 + contentPadding.top + childMargin;

          expect(tester.getTopLeft(find.byKey(key)).dy, tester.getTopLeft(find.byKey(containerKey)).dy + childTop);
        });
      });
    ...
    group('OutlineInputBorder', () {
      group('default alignment', () {
        ...
        testWidgets('Floating label for filled input decoration is aligned with text', (WidgetTester tester) async {
          await tester.pumpWidget(buildInputDecorator(
            useMaterial3: useMaterial3,
            decoration: const InputDecoration(prefixIcon: Icon(Icons.ac_unit), labelText: 'label', filled: true),
            isFocused: true,
          ));
    ...
    group('inputText width', () {
      ...
      testWidgets('filled textField', (WidgetTester tester) async {
        await tester.pumpWidget(
          buildInputDecorator(useMaterial3: useMaterial3, decoration: const InputDecoration(filled: true)),
        );
        expect(tester.getSize(find.byType(InputDecorator)), const Size(800.0, 48.0));
        expect(tester.getTopLeft(find.text('text')).dx, 12.0);
        expect(tester.getTopRight(find.text('text')).dx, 788.0);
      ...
      testWidgets('filled textField with prefix and suffix icons', (WidgetTester tester) async {
        await tester.pumpWidget(buildInputDecorator(
          useMaterial3: useMaterial3,
          decoration:
              const InputDecoration(filled: true, prefixIcon: Icon(Icons.visibility), suffixIcon: Icon(Icons.close)),
        ));
        expect(tester.getSize(find.byType(InputDecorator)), const Size(800.0, 48.0));
        expect(tester.getTopLeft(find.text('text')).dx, 48.0);
        expect(tester.getTopRight(find.text('text')).dx, 752.0);
    ...
    group('floatingLabelAlignment', () {
      ...
      group('LTR with icon aligned', () {
        testWidgets('start', (WidgetTester tester) async {
          await tester.pumpWidget(buildInputDecoratorWithFloatingLabel(
            textDirection: TextDirection.ltr,
            hasIcon: true,
    ...
    testWidgets('InputDecorator prefix/suffix dense layout', (WidgetTester tester) async {
      await tester.pumpWidget(buildInputDecorator(
        ...
        // isEmpty: false (default)
        isFocused: true,
        decoration: const InputDecoration(isDense: true, prefixText: 'p', suffixText: 's', filled: true),
      ));
    ...
    testWidgets('contentPadding smaller than kMinInteractiveDimension', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(buildInputDecorator(
        ...
        // isFocused: false (default)
        decoration:
            const InputDecoration(hintText: 'hint', contentPadding: EdgeInsets.symmetric(vertical: verticalPadding)),
      ));
    ...
    testWidgets('InputDecorator with baseStyle', (WidgetTester tester) async {
      ...
      expect(
        tester.getSize(find.byType(InputDecorator)),
        Size(800.0, useMaterial3 ? 50.0 : kMinInteractiveDimension),
    ...
    test('InputDecorationTheme copyWith correctly copies and replaces values', () {
      const InputDecorationTheme original = InputDecorationTheme(focusColor: Colors.orange, fillColor: Colors.green);
      final InputDecorationTheme copy = original.copyWith(focusColor: Colors.yellow, fillColor: Colors.blue);
    ...
    testWidgets('InputDecorationTheme.inputDecoration with MaterialState', (WidgetTester tester) async {
      ...
      // InputDecorationTheme arguments define InputDecoration properties.
      InputDecoration decoration = const InputDecoration().applyDefaults(InputDecorationTheme(
        labelStyle: themeStyle,
        helperStyle: themeStyle,
        hintStyle: themeStyle,
        errorStyle: themeStyle,
        ...
        child: Directionality(
          ...
          child: UnconstrainedBox(
            child: ConstrainedBox(
              ...
              child: const InputDecorator(decoration: InputDecoration(labelText: 'XP', border: OutlineInputBorder())),
            ),
          ),
        ),
      ));
    ...
    testWidgets('InputDecorator OutlineBorder focused label with icon', (WidgetTester tester) async {
                ...
                child: RepaintBoundary(
                  child: InputDecorator(
                    ...
                    decoration: InputDecoration(
                      ...
                      border: OutlineInputBorder(borderRadius: BorderRadius.circular(30.0), gapPadding: 0.0),
                    ),
                  ),
                ),
              ),
      ...
      await expectLater(find.byType(InputDecorator), matchesGoldenFile('input_decorator.outline_label.ltr.png'));

      await tester.pumpWidget(buildFrame(TextDirection.rtl));
      await expectLater(find.byType(InputDecorator), matchesGoldenFile('input_decorator.outline_label.rtl.png'));
    });
    ...
    testWidgets('InputDecorator OutlineBorder focused label with icon', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(buildFrame(TextDirection.ltr));
      await expectLater(find.byType(InputDecorator), matchesGoldenFile('input_decorator.outline_icon_label.ltr.png'));

      await tester.pumpWidget(buildFrame(TextDirection.rtl));
      await expectLater(find.byType(InputDecorator), matchesGoldenFile('input_decorator.outline_icon_label.rtl.png'));
    });
    ...
    testWidgets('InputDecorator draws and animates hoverColor', (WidgetTester tester) async {
      ...
      Future<void> pumpDecorator({required bool hovering, bool enabled = true, bool filled = true}) async {
        return tester.pumpWidget(buildInputDecorator(
          useMaterial3: useMaterial3,
          isHovering: hovering,
          decoration: InputDecoration(
    ...
    testWidgets('InputDecorator draws and animates focusColor', (WidgetTester tester) async {
      ...
      Future<void> pumpDecorator({required bool focused, bool enabled = true, bool filled = true}) async {
        return tester.pumpWidget(buildInputDecorator(
          useMaterial3: useMaterial3,
          isFocused: focused,
          decoration: InputDecoration(
    ...
    testWidgets('InputDecoration default border uses colorScheme', (WidgetTester tester) async {
      ...
      // Enabled
      await tester.pumpWidget(buildInputDecorator(useMaterial3: useMaterial3, theme: theme));
      await tester.pumpAndSettle();
      expect(getBorderColor(tester), enabledColor);

      // Filled
      await tester.pumpWidget(
        buildInputDecorator(useMaterial3: useMaterial3, theme: theme, decoration: const InputDecoration(filled: true)),
      );
      await tester.pumpAndSettle();
      expect(getBorderColor(tester), useMaterial3 ? theme.colorScheme.onSurfaceVariant : theme.hintColor);

      // Hovering
      await tester.pumpWidget(buildInputDecorator(useMaterial3: useMaterial3, theme: theme, isHovering: true));
      await tester.pumpAndSettle();
      expect(getBorderColor(tester), hoverColor);

      // Focused
      await tester.pumpWidget(buildInputDecorator(useMaterial3: useMaterial3, theme: theme, isFocused: true));
      await tester.pumpAndSettle();
    ...
    testWidgets('InputDecoration borders', (WidgetTester tester) async {
      const InputBorder errorBorder = OutlineInputBorder(borderSide: BorderSide(color: Colors.red, width: 1.5));
      const InputBorder focusedBorder = OutlineInputBorder(borderSide: BorderSide(color: Colors.green, width: 4.0));
      const InputBorder focusedErrorBorder = OutlineInputBorder(borderSide: BorderSide(color: Colors.teal, width: 5.0));
      const InputBorder disabledBorder = OutlineInputBorder(borderSide: BorderSide(color: Colors.grey, width: 0.0));
      const InputBorder enabledBorder = OutlineInputBorder(borderSide: BorderSide(color: Colors.blue, width: 2.5));
    ...
    testWidgets('rounded OutlineInputBorder with zero padding just wraps the label', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(buildInputDecorator(
        ...
        decoration: InputDecoration(
          ...
          fillColor: const Color(0xFF00FF00),
          labelText: labelText,
          border: OutlineInputBorder(borderRadius: BorderRadius.circular(borderRadius), gapPadding: 0.0),
        ),
      ));
    ...
    test('InputBorder equality', () {
      ...
      expect(outlineInputBorder, isNot(
        const OutlineInputBorder(
      ...
      expect(underlineInputBorder, isNot(
        const UnderlineInputBorder(
          borderSide: BorderSide(color: Colors.red),
          borderRadius: BorderRadius.only(topLeft: Radius.circular(5.0), topRight: Radius.circular(5.0)),
        ),
    ...
    test('InputBorder hashCodes', () {
      ...
      expect(outlineInputBorder.hashCode, isNot(
        const OutlineInputBorder(
          borderRadius: BorderRadius.all(Radius.circular(9.0)),
          borderSide: BorderSide(color: Colors.red),
          gapPadding: 32.0,
      ...
      expect(underlineInputBorder.hashCode, isNot(
        const UnderlineInputBorder(
          borderSide: BorderSide(color: Colors.red),
          borderRadius: BorderRadius.only(topLeft: Radius.circular(5.0), topRight: Radius.circular(5.0)),
        ).hashCode,
    ...
    testWidgets('uses alphabetic baseline for CJK layout', (WidgetTester tester) async {
      ...
      Widget buildFrame(bool alignLabelWithHint) {
        return MaterialApp(
          theme: ThemeData(textTheme: typography.dense),
          home: Material(
            child: Directionality(
              textDirection: TextDirection.ltr,
              child: TextField(
    ...
    testWidgets('InputDecorator floating label width scales when focused', (WidgetTester tester) async {
      ...
      expect(find.text(longStringA), paints..clipRect(rect: const Rect.fromLTWH(0, 0, 100.0, 16.0)));
      ...
      expect(
        ...
        paints
          ..something((Symbol methodName, List<dynamic> arguments) {
            ...
            const double width = bool.hasEnvironment('SKPARAGRAPH_REMOVE_ROUNDING_HACK') ? 100 / 0.75 : 133.0;
      ...
      await tester.pumpWidget(MaterialApp(
        ...
        home: StatefulBuilder(
          builder: (BuildContext context, StateSetter setter) {
            setState = setter;
            return InputDecorator(textAlignVertical: alignment, decoration: const InputDecoration(hintText: hintText));
          },
        ),
      ));
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        await tester.pumpWidget(MaterialApp(
          home: Material(
            child: Center(
              child: SizedBox(width: 200, height: 28, child: TextField(controller: TextEditingController(text: 'A'))),
            ),
          ),
        ));
                ...
                child: Center(
                  child: Row(
                    children: <Widget>[
                      ...
                      SizedBox(width: 35.0, child: IntrinsicHeight(child: TextField(key: intrinsicHeightKey))),
                    ],
                  ),
                ),
              );
          ...
          const MaterialApp(
            home: Center(
              child: Directionality(
                ...
                child: InputDecorator(
                  decoration: InputDecoration(),
                  child: Stack(children: <Widget>[SizedBox(height: 0), Positioned(bottom: 5, child: Text('ok'))]),
                ),
              ),
            ),
          ),
