...
TextStyle getLabelStyle(WidgetTester tester) {
  return tester.firstWidget<AnimatedDefaultTextStyle>(find.ancestor(
    of: find.text('label'),
  ...
  for (final bool useMaterial3 in <bool>[true, false]) {
    ...
    group('alignLabelWithHint', () {
      ...
      group('expands true', () {
        ...
        testWidgets(
          'multiline TextField with outline border',
          (WidgetTester tester) async {
            const String text = 'text';
            final FocusNode focusNode = FocusNode();
            final TextEditingController controller = TextEditingController();
    ...
    testWidgets(
      'InputDecorator with no input border',
      (WidgetTester tester) async {
        // Label is visible, hint is not (opacity 0.0).
        await tester.pumpWidget(buildInputDecorator(
          useMaterial3: useMaterial3,
    ...
    testWidgets(
      'InputDecorator counter text, widget, and null',
      (WidgetTester tester) async {
        Widget buildFrame({
        ...
        // shows nothing.
        await tester.pumpWidget(
          buildFrame(counterText: '', maxLength: maxLength),
        );
    ...
    testWidgets(
      'InputDecorator prefix/suffix texts',
      (WidgetTester tester) async {
        await tester.pumpWidget(buildInputDecorator(
          useMaterial3: useMaterial3,
          // isEmpty: false (default)
    ...
    testWidgets('InputDecorator suffixIconColor in M3 error state', (
      WidgetTester tester,
    ) async {
    ...
    group('constraints', () {
      testWidgets('No InputDecorator constraints', (WidgetTester tester) async {
        await tester.pumpWidget(
          buildInputDecorator(useMaterial3: useMaterial3),
        );
      ...
      testWidgets(
        'InputDecoratorThemeData constraints',
        (WidgetTester tester) async {
          await tester.pumpWidget(buildInputDecorator(
            useMaterial3: useMaterial3,
            theme: ThemeData(
    ...
    group('textAlignVertical position', () {
      ...
      group('prefix', () {
        ...
        testWidgets(
          'InputDecorator tall prefix align center',
          (WidgetTester tester) async {
            const Key pKey = Key('p');
            const String text = 'text';
            await tester.pumpWidget(buildInputDecorator(
        ...
        testWidgets(
          'InputDecorator tall prefix align bottom',
          (WidgetTester tester) async {
            const Key pKey = Key('p');
            const String text = 'text';
            await tester.pumpWidget(buildInputDecorator(
    ...
    group('OutlineInputBorder', () {
      group('default alignment', () {
        ...
        testWidgets(
          'Centers when border and contentPadding',
          (WidgetTester tester) async {
            await tester.pumpWidget(buildInputDecorator(
              useMaterial3: useMaterial3,
              decoration: const InputDecoration(
      ...
      group('3 point interpolation alignment', () {
        ...
        testWidgets(
          'padding exceeds middle keeps top at middle',
          (WidgetTester tester) async {
            await tester.pumpWidget(buildInputDecorator(
              useMaterial3: useMaterial3,
              expands: true,
    ...
    testWidgets(
      'FloatingLabelAlignment.toString()',
      (WidgetTester tester) async {
        expect(
    ...
    group('inputText width', () {
      ...
      testWidgets(
        'filled textField with prefix and suffix icons',
        (WidgetTester tester) async {
          await tester.pumpWidget(buildInputDecorator(
            useMaterial3: useMaterial3,
            decoration: const InputDecoration(
    ...
    testWidgets('InputDecorator with baseStyle', (WidgetTester tester) async {
      ...
      expect(
        ...
        useMaterial3 ? 16.0 : 10.0,
      );
      expect(tester.getSize(find.text('text')).height, 10.0);
      expect(
        tester.getTopLeft(find.text('hint')).dy,
        useMaterial3 ? 28 : 24.75,
      );
      expect(
        tester.getTopLeft(find.text('label')).dy,
        useMaterial3 ? 17 : 19.0,
      );
      expect(
    ...
    testWidgets('InputDecorator with empty border and label', (
      ...
      await tester.pumpWidget(buildInputDecorator(
        ...
        // isFocused: false (default)
        decoration:
            const InputDecoration(labelText: 'label', border: InputBorder.none),
      ));
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        final Color fillColor = useMaterial3
        ...
        final Color enabledBorderColor = useMaterial3
            ? const Color(0xffffffff)
        ...
        final Color blendedHoverColor = useMaterial3
            ? const Color(0xff000000)
            : const Color(0x74004400);
    ...
    testWidgets(
      'InputDecorator draws and animates focusColor',
      (WidgetTester tester) async {
    ...
    testWidgets('InputDecorationTheme.toString()', (WidgetTester tester) async {
      ...
      expect(
        const InputDecorationTheme(contentPadding: EdgeInsets.only(left: 5.0))
            .toString(),
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        // Enabled
        await tester.pumpWidget(
          buildInputDecorator(useMaterial3: useMaterial3, theme: theme),
        );
        await tester.pumpAndSettle();
    ...
    testWidgets(
      'InputDecorator floating label Y coordinate',
      (WidgetTester tester) async {
            ...
            ..something((Symbol methodName, List<dynamic> arguments) {
              ...
              const double width =
                  bool.hasEnvironment('SKPARAGRAPH_REMOVE_ROUNDING_HACK')
                      ? 100 / 0.75
                      : 133.0;
              expect(clipRect, rectMoreOrLessEquals(
                const Rect.fromLTWH(0, 0, width, 16.0),
                epsilon: 1e-5,
              ));
              return true;
            }),
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          getLabelRect(tester).width,
          lessThanOrEqualTo(floatedLabelWidth),
        );
          ...
          home: Material(
            child: Center(
              child: SizedBox(
                width: 200,
                height: 28,
                child: TextField(controller: TextEditingController(text: 'A')),
              ),
            ),
          ),
        ));
                ...
                child: Directionality(
                  ...
                  child: InputDecorator(
                    ...
                    child: Stack(
                      children: <Widget>[
                        SizedBox(height: 0),
                        Positioned(bottom: 5, child: Text('ok')),
                      ],
                    ),
                  ),
                ),
    ...
    testWidgets(
      'min intrinsic height for TextField with icon',
      (WidgetTester tester) async {
        // Regression test for: https://github.com/flutter/flutter/issues/87403
        await tester.pumpWidget(MaterialApp(
          home: Material(
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(buildInputDecorator(
          ...
          decoration:
              const InputDecoration(label: Text.rich(TextSpan(text: 'label'))),
        ));
