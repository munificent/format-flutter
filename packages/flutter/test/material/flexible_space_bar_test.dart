...
void main() {
  testWidgets('FlexibleSpaceBar centers title on iOS', (
    ...
    for (final TargetPlatform platform in <TargetPlatform>[
      ...
      await tester.pumpWidget(MaterialApp(
        ...
        home: Scaffold(
          appBar:
              AppBar(flexibleSpace: const FlexibleSpaceBar(title: Text('X'))),
        ),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final RenderBox clipRect = tester.renderObject(
        find.byType(ClipRect).first,
      );
      final Transform transform = tester.firstWidget(find.descendant(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final dynamic backgroundOpacity = tester.firstWidget(find
          .byWidgetPredicate(
            (Widget widget) =>
        ...
        body: CustomScrollView(
          slivers: <Widget>[
            const SliverAppBar(
              ...
              title: Text('Title'),
              flexibleSpace:
                  FlexibleSpaceBar(background: Text('Expanded title')),
            ),
            SliverList(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        ...
        rectMoreOrLessEquals(Rect.fromLTRB(
          0,
  ...
  testWidgets('FlexibleSpaceBar scaled title', (WidgetTester tester) async {
    ...
    await expectLater(flexibleSpaceBar, matchesGoldenFile(
  ...
  testWidgets(
    'FlexibleSpaceBar rebuilds when scrolling.',
    (WidgetTester tester) async {
      ...
      for (int i = 0; i < 20; i++) {
        await tester.drag(
          find.byKey(SubCategoryScreenView.scrollKey),
          const Offset(0, -50.0),
        );
        await tester.pumpAndSettle();
      }
      ...
      body: CustomScrollView(
        ...
        slivers: <Widget>[
          SliverAppBar(
            ...
            flexibleSpace: const FlexibleSpaceBar(
              background:
                  AspectRatio(aspectRatio: 1.7, child: RebuildTracker()),
            ),
          ),
