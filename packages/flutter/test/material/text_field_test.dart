...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      tester.testTextInput.updateEditingValue(
        const TextEditingValue(text: testValue),
      );
      await tester.pump();
      ...
      tester.testTextInput.updateEditingValue(
        const TextEditingValue(text: newValue),
      );
      await tester.pump();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      gesture =
          await tester.startGesture(startBlah1, kind: PointerDeviceKind.mouse);
      await tester.pump();
      await gesture.up();
      ...
      // Cut the first word.
      gesture =
          await tester.startGesture(midBlah1, kind: PointerDeviceKind.mouse);
      await tester.pump();
      await gesture.up();
      await tester.pump(const Duration(milliseconds: 100));
      await gesture.down(startBlah1);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(home: Material(child: TextField(focusNode: focusNode))),
      );
  ...
  testWidgets('TextField has consistent size', (WidgetTester tester) async {
    ...
    RenderBox findTextFieldBox() => tester.renderObject(
  ...
  testWidgets('cursor has expected radius value', (WidgetTester tester) async {
    await tester.pumpWidget(
      overlay(child: const TextField(cursorRadius: Radius.circular(3.0))),
    );
  ...
  testWidgets(
    'clipBehavior has expected defaults',
    (WidgetTester tester) async {
      await tester.pumpWidget(overlay(child: const TextField()));
  ...
  testWidgets('Overflow clipBehavior none golden', (WidgetTester tester) async {
    ...
    final EditableText editableText = tester.firstWidget(
      find.byType(EditableText),
    );
  ...
  testWidgets('text selection style 1', (WidgetTester tester) async {
    ...
    final Offset textfieldStart = tester.getTopLeft(
      find.byKey(const Key('field0')),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(overlay(
        child:
            const TextField(textDirection: TextDirection.rtl, maxLines: null),
      ));
  ...
  testWidgets('enableInteractiveSelection = false, tap', (
    ...
    await tester.pumpWidget(overlay(
      child:
          TextField(controller: controller, enableInteractiveSelection: false),
    ));
    expect(controller.selection.baseOffset, -1);
    expect(controller.selection.extentOffset, -1);
  ...
  testWidgets('Read only text field basic', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      overlay(child: TextField(controller: controller, readOnly: true)),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(home: Material(child: TextField(readOnly: true))),
      );
  ...
  testWidgets('Swapping controllers should update selection', (
    ...
    controller = TextEditingController.fromValue(controller.value.copyWith(
  ...
  testWidgets(
    'Dragging in opposite direction also works',
    (WidgetTester tester) async {
      final TextEditingController controller = TextEditingController();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset textFieldLeftPosition = tester.getTopLeft(
        find.byType(TextField),
      );
      expect(endpoints[0].point.dx - textFieldLeftPosition.dx, isPositive);
      final Offset textFieldRightPosition = tester.getTopRight(
        find.byType(TextField),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset pos = textOffsetToPosition(
        tester,
        controller.text.indexOf('v'),
      );
      // The first tap.
      ...
      expect(
        controller.selection,
        const TextSelection(baseOffset: 19, extentOffset: 27),
      );
      ...
      expect(
        controller.selection,
        const TextSelection(baseOffset: 19, extentOffset: 47),
      );
      ...
      expect(
        controller.selection,
        const TextSelection(baseOffset: 15, extentOffset: 27),
      );
      ...
      expect(
        controller.selection,
        const TextSelection(baseOffset: 3, extentOffset: 27),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        controller.selection,
        const TextSelection(baseOffset: 27, extentOffset: 15),
      );
      ...
      expect(
        controller.selection,
        const TextSelection(baseOffset: 27, extentOffset: 3),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        overlay(child: TextField(controller: controller)),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(find.text('Select all'), findsOneWidget);
      final Offset firstLineToolbarTopLeft = tester.getTopLeft(
        find.text('Select all'),
      );
      final Offset firstLineTopLeft = textOffsetToPosition(
        tester,
        testValue.indexOf('a'),
      );
      ...
      expect(find.text('Select all'), findsOneWidget);
      final Offset penultimateLineToolbarTopLeft = tester.getTopLeft(
        find.text('Select all'),
      );
      final Offset penultimateLineTopLeft = textOffsetToPosition(
        tester,
        testValue.indexOf('p'),
      );
      expect(
        penultimateLineToolbarTopLeft.dy,
      ...
      expect(find.text('Select all'), findsOneWidget);
      final Offset lastLineToolbarTopLeft = tester.getTopLeft(
        find.text('Select all'),
      );
      final Offset lastLineTopLeft = textOffsetToPosition(
        tester,
        testValue.indexOf('p'),
      );
      expect(lastLineToolbarTopLeft.dy, lessThan(lastLineTopLeft.dy));
      expect(
        lastLineToolbarTopLeft.dy,
  ...
  testWidgets(
    'An obscured TextField is selectable by default',
    (WidgetTester tester) async {
      // This is a regression test for
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        overlay(child: TextField(controller: controller, obscureText: true)),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        expandedTextFieldBuilder(expands: true, maxLines: null),
      );
      ...
      expect(() async {
        await tester.pumpWidget(
          expandedTextFieldBuilder(expands: true, maxLines: 4),
        );
      }, throwsAssertionError);
      expect(() async {
        await tester.pumpWidget(
  ...
  testWidgets(
    'Multiline text when wrapped in IntrinsicHeight',
    (WidgetTester tester) async {
      ...
      RenderBox findEditableText() => tester.renderObject(
        find.byType(EditableText),
      );
        ...
        child: Column(
          ...
          children: <Widget>[
            TextFormField(
              ...
              decoration:
                  InputDecoration(counterText: '', errorText: errorText),
            ),
          ],
        ),
      );
  ...
  testWidgets('Growable TextField when content height exceeds parent', (
    ...
    await tester.pumpWidget(
      containedTextFieldBuilder(counter: Container(height: counterHeight)),
    );
    expect(findEditableText(), equals(inputBox));
    ...
    // inside the parent as well.
    await tester.pumpWidget(
      containedTextFieldBuilder(helperText: 'I am helperText'),
    );
    expect(findEditableText(), equals(inputBox));
    const double helperTextSpace = 12.0;
    expect(
      inputBox.size.height,
      height - padding - helperTextSpace - subtextGap,
    );
    ...
    await tester.pumpWidget(
      containedTextFieldBuilder(labelText: 'I am labelText'),
    );
  ...
  testWidgets('Multiline hint text will wrap up to maxLines', (
    ...
    expect(
      findHintText(multipleLineText).size.width,
  ...
  testWidgets('Can drag handles to change selection in multiline', (
    ...
    final Offset firstPos = textOffsetToPosition(
      tester,
      testValue.indexOf('First'),
    );
    final Offset secondPos = textOffsetToPosition(
      tester,
      testValue.indexOf('Second'),
    );
    final Offset thirdPos = textOffsetToPosition(
      tester,
      testValue.indexOf('Third'),
    );
    final Offset middleStringPos = textOffsetToPosition(
      tester,
      testValue.indexOf('irst'),
    );
    ...
    expect(
      controller.selection,
      const TextSelection(baseOffset: 39, extentOffset: 44),
    );
    ...
    expect(
      controller.selection,
      const TextSelection(baseOffset: 39, extentOffset: 50),
    );
  ...
  testWidgets('Can scroll multiline input', (WidgetTester tester) async {
    ...
    final Offset firstPos = textOffsetToPosition(
      tester,
      kMoreThanFourLines.indexOf('First'),
    );
    final Offset fourthPos = textOffsetToPosition(
      tester,
      kMoreThanFourLines.indexOf('Fourth'),
    );
    expect(firstPos.dx, fourthPos.dx);
    expect(firstPos.dy, lessThan(fourthPos.dy));
    expect(inputBox.hitTest(
      BoxHitTestResult(),
    ...
    Offset newFirstPos = textOffsetToPosition(
      tester,
      kMoreThanFourLines.indexOf('First'),
    );
    Offset newFourthPos = textOffsetToPosition(
      tester,
      kMoreThanFourLines.indexOf('Fourth'),
    );
    ...
    expect(controller.text.substring(
    ...
    newFirstPos = textOffsetToPosition(
      tester,
      kMoreThanFourLines.indexOf('First'),
    );
    newFourthPos = textOffsetToPosition(
      tester,
      kMoreThanFourLines.indexOf('Fourth'),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(overlay(
        child: TextField(
          decoration:
              InputDecoration(helperText: 'helper text', helperStyle: style),
        ),
      ));
      final Text helperText = tester.widget(find.text('helper text'));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(overlay(
        child: TextField(
          decoration:
              InputDecoration(hintText: 'Placeholder', hintStyle: hintStyle),
        ),
      ));
  ...
  testWidgets(
    'TextField with specified prefixStyle',
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(overlay(
        child: TextField(
          decoration:
              InputDecoration(prefixText: 'Prefix:', prefixStyle: prefixStyle),
        ),
      ));
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(overlay(
        child: TextField(
          ...
          decoration:
              const InputDecoration(prefixText: 'Prefix', suffixText: 'Suffix'),
        ),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(overlay(
        child: TextField(
          decoration:
              InputDecoration(suffixText: '.com', suffixStyle: suffixStyle),
        ),
      ));
  ...
  testWidgets('Text field scrolls the caret into view', (
    ...
    ScrollableState scrollableState = tester.firstState(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        overlay(child: TextField(controller: controller, maxLines: 6)),
      );
  ...
  testWidgets('maxLength limits input with surrogate pairs.', (
    ...
    await tester.enterText(
      find.byType(TextField),
      '${surrogatePair}0123456789101112',
    );
  ...
  testWidgets('maxLength limits input with grapheme clusters.', (
    ...
    await tester.enterText(
      find.byType(TextField),
      '${graphemeCluster}0123456789101112',
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(boilerplate(
        child: TextField(controller: textController, maxLength: 10),
      ));
  ...
  testWidgets(
    'maxLength still works with other formatters',
    (WidgetTester tester) async {
      final TextEditingController textController = TextEditingController();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        counterTextWidget.style!.color,
        isNot(equals(Colors.deepPurpleAccent)),
      );
    },
  );

  testWidgets(
    'maxLength shows warning in Material 3',
    (WidgetTester tester) async {
      final TextEditingController textController = TextEditingController();
  ...
  testWidgets(
    'TextField identifies as text field in semantics',
    (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgets('Disabled text field does not have tap action', (
    ...
    await tester.pumpWidget(
      const MaterialApp(
        home: Material(
          child: Center(child: TextField(maxLength: 10, enabled: false)),
        ),
      ),
    );
    ...
    expect(
      semantics,
      isNot(includesNodeWith(actions: <SemanticsAction>[SemanticsAction.tap])),
    );
    semantics.dispose();
  });
  ...
  testWidgets('Readonly text field does not have tap action', (
    ...
    await tester.pumpWidget(
      const MaterialApp(
        home: Material(
          child: Center(child: TextField(maxLength: 10, readOnly: true)),
        ),
      ),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        ...
        home: Material(
          child:
              Center(child: TextField(controller: controller, enabled: false)),
        ),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        home: Material(
          child: RawKeyboardListener(focusNode: focusNode, child: textField),
        ),
      ));
      focusNode.requestFocus();
      await tester.pump();
  ...
  testWidgets('Caret works when maxLines is null', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      overlay(child: TextField(controller: controller, maxLines: null)),
    );
          ...
          children: <Widget>[
            Expanded(
              child: TextField(
                ...
                style:
                    const TextStyle(fontFamily: 'FlutterTest', fontSize: 12.0),
                strutStyle: StrutStyle.disabled,
              ),
            ),
            const Text(
            ...
            Expanded(
              child: TextField(
                ...
                // https://github.com/flutter/flutter/issues/122066 is resolved.
                style:
                    const TextStyle(fontFamily: 'FlutterTest', fontSize: 36.0),
                strutStyle: StrutStyle.disabled,
              ),
            ),
          ],
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(overlay(
        child: TextField(
          ...
          controller: controller,
          decoration:
              const InputDecoration(hintText: 'hint', labelText: 'label'),
        ),
      ));
  ...
  testWidgets('TextField semantics', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      overlay(child: TextField(key: key, controller: controller)),
    );
  ...
  testWidgets('TextField change selection with semantics', (
    ...
    semanticsOwner.performAction(
      inputFieldId,
      SemanticsAction.setSelection,
      <dynamic, dynamic>{'base': 4, 'extent': 4},
    );
    await tester.pump();
    ...
    semanticsOwner.performAction(
      inputFieldId,
      SemanticsAction.setSelection,
      <dynamic, dynamic>{'base': 0, 'extent': 0},
    );
    await tester.pump();
    expect(controller.selection, const TextSelection.collapsed(offset: 0));
    ...
    semanticsOwner.performAction(
      inputFieldId,
      SemanticsAction.setSelection,
      <dynamic, dynamic>{'base': 0, 'extent': 5},
    );
    await tester.pump();
    expect(
      controller.selection,
  ...
  testWidgets(
    'When clipboard empty, no semantics paste option',
    (WidgetTester tester) async {
      const String textInTextField = 'Hello';
      ...
      child: Builder(
        builder: (BuildContext context) {
          return MediaQuery(
            ...
            child:
                TextField(focusNode: focusNode, autofocus: true, enabled: true),
          );
        },
      ),
    ));
  ...
  testWidgets(
    'InputDecoration errorText semantics',
    (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
      final TextEditingController controller = TextEditingController();
      final Key key = UniqueKey();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpAndSettle();
      await tester.enterText(
        find.byKey(textField2),
        '2',
      ); //scroll textField2 into view
      await tester.pumpAndSettle();
      await tester.enterText(
        find.byKey(textField1),
        '3',
            ...
            child: Column(
              ...
              children: <Widget>[
                IntrinsicWidth(
                  stepWidth: stepWidth,
                  child:
                      TextField(textAlign: textAlign, cursorWidth: cursorWidth),
                ),
              ],
            ),
          ),
  ...
  testWidgets('TextField style is merged with theme', (
    ...
    expect(
      editableText.style.shadows,
      themeData.textTheme.titleMedium!.shadows,
    );
    expect(
  ...
  testWidgets('style enforces required fields', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      buildFrame(const TextStyle(inherit: false, fontSize: 12.0)),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset vPos = textOffsetToPosition(
        tester,
        29,
      ); // Index of 'Bonav|enture'.
      final Offset wPos = textOffsetToPosition(
        tester,
        3,
      ); // Index of 'Atw|ater'.
  ...
  testWidgets(
    'selectionControls is passed to EditableText',
    (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Material(
          child: Scaffold(
            body: TextField(selectionControls: materialTextSelectionControls),
          ),
        ),
      ));
  ...
  group('Triple tap/click', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(MaterialApp(
          theme: ThemeData(useMaterial3: false),
          home:
              Material(child: Center(child: TextField(controller: controller))),
        ));
    ...
    testWidgets('triple click chains work', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        home: Material(
          child:
              Center(child: TextField(controller: controller, maxLines: null)),
        ),
      ));
      ...
      await tester.pumpAndSettle(kDoubleTapTimeout);
      expect(controller.selection, TextSelection(
        baseOffset: 0,
        extentOffset: platformSelectsByLine ? 19 : 20,
      ));
    ...
    testWidgets('triple click after a click on desktop platforms', (
      WidgetTester tester,
    ) async {
      final TextEditingController controller = TextEditingController(
        text: testValueA,
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final TestGesture gesture =
            await tester.startGesture(firstLinePos, pointer: 7);
        await tester.pump();
        await gesture.up();
        await tester.pump();
    ...
    testWidgets('Double click and triple click alternate on Windows', (
      WidgetTester tester,
    ) async {
      final TextEditingController controller = TextEditingController(
        text: testValueA,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        home: Material(
          child:
              Center(child: TextField(autofocus: true, controller: controller)),
        ),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset pPos = textOffsetToPosition(tester, 9); // Index of 'P|eel'.
      final Offset ePos = textOffsetToPosition(
        tester,
        6,
      ); // Index of 'Atwate|r'
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      firstCharEndpoint = renderEditable.getEndpointsForSelection(
        const TextSelection.collapsed(offset: 0), // First character's position.
      );
      expect(firstCharEndpoint.length, 1);
      // The first character is now offscreen to the left.
      expect(
        firstCharEndpoint[0].point.dx,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      // The first character is now offscreen to the left.
      expect(
        textOffsetToPosition(tester, 0).dx,
        moreOrLessEquals(-257.0, epsilon: 1),
      );
    },
    variant: TargetPlatformVariant.all(),
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        home: Material(
          child: Center(
            child:
                TextField(autofocus: true, maxLines: 2, controller: controller),
          ),
        ),
      ));
  ...
  testWidgets(
    'mouse click and drag can edge scroll vertically',
    (WidgetTester tester) async {
      final TextEditingController controller = TextEditingController(
        text:
            'Atwater Peel Sherbrooke Bonaventure Angrignon Peel Côte-des-Neiges Atwater Peel Sherbrooke Bonaventure Angrignon Peel Côte-des-Neiges',
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        home: Material(
          child:
              Center(child: TextField(maxLines: null, controller: controller)),
        ),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.tapAt(
        textOffsetToPosition(tester, 10) + const Offset(200.0, 0.0),
      );
      expect(controller.value.selection, isNotNull);
      expect(controller.value.selection.baseOffset, 10);
      expect(controller.value.selection.extentOffset, 10);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        ...
        home: const Material(
          child: Center(
            child: TextField(maxLines: 6, strutStyle: StrutStyle(fontSize: 25)),
          ),
        ),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final RenderEditable renderEditable = tester.state<EditableTextState>(
        find.byType(EditableText),
      ).renderEditable;
          ...
          child: Column(
            ...
            children: <Widget>[
              SizedBox(
                width: 100.0,
                child:
                    TextField(controller: controller1, focusNode: focusNode1),
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                mainAxisSize: MainAxisSize.min,
              ...
              SizedBox(
                width: 100.0,
                child:
                    TextField(controller: controller5, focusNode: focusNode5),
              ),
            ],
          ),
        ),
        ...
        child: MouseRegion(
          ...
          child: TextField(
            decoration: InputDecoration(
              ...
              prefixIcon:
                  IconButton(icon: const Icon(Icons.cabin), onPressed: () {}),
              suffixIcon:
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(controller.value.selection, TextSelection.collapsed(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
        ...
        return MaterialApp(
          theme: ThemeData(
            ...
            inputDecorationTheme:
                InputDecorationTheme(floatingLabelBehavior: behavior),
          ),
          home: Scaffold(
            body: TextField(
              focusNode: focusNode,
      ...
      await tester.pumpWidget(
        textFieldBuilder(behavior: FloatingLabelBehavior.never),
      );
      ...
      await tester.pumpWidget(
        textFieldBuilder(behavior: FloatingLabelBehavior.always),
      );
      await tester.pumpAndSettle(); // theme animation.
  ...
  testWidgets(
    'prefix/suffix buttons do not leak touch events',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(home: Material(child: Center(child: TextField()))),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      await tester.pumpWidget(MaterialApp(
        home: Material(child: Center(child: TextField(focusNode: focusNode))),
      ));
      await tester.showKeyboard(find.byType(TextField));
  ...
  testWidgets(
    'cursor blinking respects TickerMode',
    (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        boilerplate(child: TextField(focusNode: focusNode)),
      );
      expect(focusNode.hasFocus, isFalse);
      focusNode.requestFocus();
      await tester.pump();
      ...
      await tester.pumpWidget(boilerplate(
        child: TextField(focusNode: focusNode, canRequestFocus: false),
      ));
  ...
  group('context menu', () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(MaterialApp(
          home: Material(
            child:
                Column(children: <Widget>[TextField(controller: controller)]),
          ),
        ));
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(MaterialApp(
          home: Material(child: TextField(key: key, controller: controller)),
        ));
  ...
  group('magnifier', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          controller.selection.baseOffset,
          isTargetPlatformAndroid ? 4 : 5,
        );
        expect(
          controller.selection.extentOffset,
          isTargetPlatformAndroid ? 7 : 5,
        );
        expect(find.byKey(fakeMagnifier.key!), findsOneWidget);
        ...
        await gesture.moveTo(
          textOffsetToPosition(tester, testValue.indexOf('h')),
        );
        await tester.pumpAndSettle();
        expect(
          controller.selection.baseOffset,
          isTargetPlatformAndroid ? 4 : 9,
        );
        expect(
          controller.selection.extentOffset,
          isTargetPlatformAndroid ? 11 : 9,
        );
        expect(find.byKey(fakeMagnifier.key!), findsOneWidget);
        // Expect the position the magnifier gets to have moved.
        expect(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final EditableTextState editableTextState = tester
      ...
      switch (defaultTargetPlatform) {
        ...
        case TargetPlatform.macOS:
          expect(
            spellCheckToolbar,
            isA<CupertinoSpellCheckSuggestionsToolbar>(),
          );
        case TargetPlatform.android:
        case TargetPlatform.fuchsia:
        case TargetPlatform.linux:
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        home: Scaffold(body: Center(child: TextField(controller: controller))),
      ));
