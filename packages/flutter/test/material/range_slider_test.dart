...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(buildThemedApp(theme: theme, activeColor: activeColor, inactiveColor: inactiveColor));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        buildThemedApp(theme: theme, activeColor: activeColor, inactiveColor: inactiveColor, divisions: 3),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        buildThemedApp(theme: theme, activeColor: activeColor, inactiveColor: inactiveColor, enabled: false),
      );
  ...
  testWidgets('Range Slider top thumb gets stroked when overlapping', (WidgetTester tester) async {
    ...
    final ThemeData theme = ThemeData(
      platform: TargetPlatform.android,
      primarySwatch: Colors.blue,
      sliderTheme: const SliderThemeData(thumbColor: Color(0xff000001), overlappingShapeStrokeColor: Color(0xff000002)),
    );
    final SliderThemeData sliderTheme = theme.sliderTheme;
    ...
    await tester.pumpWidget(MaterialApp(
      home: Theme(
        ...
        child: Directionality(
          textDirection: TextDirection.ltr,
          child: Material(
            child: RangeSlider(values: const RangeValues(10.0, 30.0), max: 100.0, onChanged: (RangeValues v) {}),
          ),
        ),
      ),
    ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        theme: ThemeData(sliderTheme: const SliderThemeData(rangeTrackShape: RectangularRangeSliderTrackShape())),
        home: Directionality(
          textDirection: TextDirection.ltr,
          child: Material(
            child: Center(
  ...
  testWidgets('RangeSlider MaterialStateMouseCursor resolves correctly', (WidgetTester tester) async {
    ...
    await tester.timedDrag(find.byType(RangeSlider), const Offset(20.0, 0.0), const Duration(milliseconds: 100));
  ...
  testWidgets('RangeSlider overlayColor supports hovered and dragged states', (WidgetTester tester) async {
    ...
    // RangeSlider does not have overlay when enabled and not hovered.
    await tester.pumpAndSettle();
    expect(Material.of(tester.element(find.byType(RangeSlider))), isNot(paints..circle(color: hoverColor)));
    ...
    await gesture.moveTo(tester.getCenter(find.byType(RangeSlider)));
    await tester.pumpAndSettle();
    expect(Material.of(tester.element(find.byType(RangeSlider))), paints..circle(color: hoverColor));
    ...
    await tester.pumpWidget(buildApp());
    await tester.pumpAndSettle();
    expect(Material.of(tester.element(find.byType(RangeSlider))), isNot(paints..circle(color: draggedColor)));
    ...
    // RangeSlider has overlay when enabled and dragged.
    expect(Material.of(tester.element(find.byType(RangeSlider))), paints..circle(color: draggedColor));
