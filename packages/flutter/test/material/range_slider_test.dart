...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.dragFrom(
        leftTarget,
        topLeft + (bottomRight - topLeft) * -0.4,
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final RenderBox sliderBox = tester.firstRenderObject<RenderBox>(
        find.byType(RangeSlider),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        buildThemedApp(theme: theme, activeColor: activeColor),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        buildThemedApp(theme: theme, inactiveColor: inactiveColor),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        sliderBox,
        isNot(paints..rect(color: sliderTheme.activeTrackColor)),
      );
      expect(
        sliderBox,
        isNot(paints..rect(color: sliderTheme.inactiveTrackColor)),
      );
    },
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset topRight = tester.getTopRight(
        find.byType(RangeSlider),
      ).translate(-24, 0);
  ...
  testWidgets('Range Slider implements debugFillProperties', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    'RangeSlider changes mouse cursor when hovered',
    (WidgetTester tester) async {
