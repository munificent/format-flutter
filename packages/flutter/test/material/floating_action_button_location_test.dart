...
void main() {
  group('Basic floating action button locations', () {
    ...
    testWidgets(
      'moves fab from center to end and back',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'moves to and from custom-defined positions',
      (WidgetTester tester) async {
        await tester.pumpWidget(
    ...
    group('interrupts in-progress animations without jumps', () {
      ...
      void setupListener(WidgetTester tester) {
        ...
        void check() {
          ...
          final Iterable<RotationTransition> rotationTransitions = tester
              .widgetList(find.byType(RotationTransition));
          ...
          if (previousRotations != null &&
            ...
            if (deltas.where(
              (double delta) => delta < maxDeltaRotation,
            ).isEmpty) {
              fail(
      ...
      testWidgets(
        'interrupting entrance to remove the fab.',
        (WidgetTester tester) async {
          await tester.pumpWidget(_buildFrame(
            fab: null,
            location: FloatingActionButtonLocation.centerFloat,
  ...
  testWidgets('Mini-start-top floating action button location', (
    ...
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        ...
        body:
            const Column(children: <Widget>[ListTile(leading: CircleAvatar())]),
      ),
    ));
    expect(
    ...
    expect(
      tester.getCenter(find.byType(FloatingActionButton)).dy,
      kToolbarHeight,
    );
  });
  ...
  group('New Floating Action Button Locations', () {
    ...
    testWidgets('endTop', (WidgetTester tester) async {
      await tester.pumpWidget(
        _singleFabScaffold(FloatingActionButtonLocation.endTop),
      );
  ...
  group('Moves involving new locations', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          _singleFabScaffold(_AlmostEndFloatFabLocation(), animator: animator),
        );
    ...
    testWidgets('Animator can be updated', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        _singleFabScaffold(fabLocation, animator: fabAnimator),
      );
  ...
  group('Locations account for safe interactive areas', () {
    ...
    Future<void> runFloatTests(
      ...
      expect(
        tester.getRect(find.byKey(floatingActionButton)),
        rectMoreOrLessEquals(
          defaultRect.translate(0.0, viewPadding - keyboardHeight),
        ),
      );
      ...
      expect(
        ...
        rectMoreOrLessEquals(snackBarRect.translate(
          0.0,
          -keyboardHeight + kFloatingActionButtonMargin / 2,
        )),
      );
    }
    ...
    testWidgets('startFloat', (WidgetTester tester) async {
      ...
      const Rect bottomNavigationBarRect = Rect.fromLTRB(
        16.0,
        422.0,
        72.0,
        478.0,
    ...
    Future<void> runDockedTests(
      ...
      expect(
        tester.getRect(find.byKey(floatingActionButton)),
        rectMoreOrLessEquals(
          bottomSheetRect.translate(0.0, -keyboardHeight + bottomNavHeight),
        ),
      );
      // The FAB should be away from the keyboard
      expect(
...
Widget _buildFrame({
  FloatingActionButton?
  fab = const FloatingActionButton(onPressed: null, child: Text('1')),
  FloatingActionButtonLocation? location,
