...
void main() {
  ...
  testWidgets(
    'NavigationDrawer can update background color',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'NavigationDrawer can update elevation',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        _getMaterial(tester).surfaceTintColor,
...
InkWell? _getInkWell(WidgetTester tester) {
  return tester.firstWidget<InkWell>(find.descendant(
    of: find.byType(NavigationDrawer),
