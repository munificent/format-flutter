...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        anchorSize,
        useMaterial3 ? const Size(195.0, 60.0) : const Size(180.0, 56.0),
      );
      ...
      expect(
        menuSize,
        useMaterial3 ? const Size(195.0, 304.0) : const Size(180.0, 304.0),
      );
      ...
      expect(
        size,
        useMaterial3 ? const Size(200.0, 60.0) : const Size(200.0, 56.0),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      RenderBox box = tester.firstRenderObject(
        find.byType(DropdownMenu<ShortMenu>),
      );
      ...
      Size buttonSize = tester.getSize(
        find.widgetWithText(MenuItemButton, 'I0').last,
      );
  ...
  testWidgets('The width property update test', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      buildTest(themeData, shortMenuItems, width: customWidth),
    );
    RenderBox box = tester.firstRenderObject(
      find.byType(DropdownMenu<ShortMenu>),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Element firstItem = tester.element(
        find.widgetWithText(MenuItemButton, 'Item 0').last,
      );
      final RenderBox firstBox = firstItem.renderObject! as RenderBox;
      final Offset topLeft = firstBox.localToGlobal(
        firstBox.size.topLeft(Offset.zero),
      );
      final Element lastItem = tester.element(
        find.widgetWithText(MenuItemButton, 'Item 5').last,
      );
      final RenderBox lastBox = lastItem.renderObject! as RenderBox;
      final Offset bottomRight = lastBox.localToGlobal(
        lastBox.size.bottomRight(Offset.zero),
      );
      ...
      await tester.pumpWidget(Container());
      await tester.pumpWidget(
        buildTest(themeData, menuChildren, menuHeight: 100),
      );
      await tester.pumpAndSettle();
      ...
      expect(
        updatedMenuSize,
        material3 ? const Size(195.0, 100.0) : const Size(180.0, 100.0),
      );
    },
  );
  ...
  testWidgets('The text in the menu button should be aligned with the text of '
    ...
    final Finder largeLeadingIcon = find.widgetWithIcon(
      Container,
      Icons.search,
    );
  ...
  testWidgets('The text in the menu button should be aligned with the text of '
    ...
    final Finder leadingIcon = find.widgetWithIcon(Container, Icons.search);
    final double iconWidth = tester.getSize(leadingIcon).width;
    final Offset dropdownMenuTopRight = tester.getTopRight(
    ...
    expect(
      ...
      equals(dropdownMenuTopRight.dx - iconWidth),
    );
    ...
    await tester.pumpAndSettle();
    final Finder updatedItemText1 = find.text('Item 0').last;
    final Offset updatedItemTextTopRight1 = tester.getTopRight(
      updatedItemText1,
    );
  ...
  testWidgets(
    'DropdownMenu has default trailing icon button',
    (WidgetTester tester) async {
      final ThemeData themeData = ThemeData();
      await tester.pumpWidget(buildTest(themeData, menuChildren));
      await tester.pump();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        theme: themeData,
        home: Scaffold(
          body: DropdownMenu<TestMenu>(dropdownMenuEntries: menuChildren),
        ),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final List<DropdownMenuEntry<TestMenu>> menuWithDisabledItems =
        ...
        const DropdownMenuEntry<TestMenu>(
          value: TestMenu.mainMenu2,
          label: 'Item 2',
          enabled: false,
        ),
        const DropdownMenuEntry<TestMenu>(
          value: TestMenu.mainMenu3,
          label: 'Item 3',
        ),
        const DropdownMenuEntry<TestMenu>(
          value: TestMenu.mainMenu4,
          label: 'Item 4',
        ),
        const DropdownMenuEntry<TestMenu>(
          value: TestMenu.mainMenu5,
          label: 'Item 5',
          enabled: false,
        ),
      ];
  ...
  testWidgets('Enable filtering', (WidgetTester tester) async {
    ...
    for (final TestMenu menu in TestMenu.values) {
      ...
      if (menu.label == TestMenu.mainMenu1.label) {
        expect(
          find.widgetWithText(MenuItemButton, menu.label),
          findsNWidgets(2),
        );
      } else {
  ...
  testWidgets(
    'If requestFocusOnTap is true, the text input field can request focus, '
        'otherwise it cannot request focus',
    (WidgetTester tester) async {
      final ThemeData themeData = ThemeData();

      Widget buildDropdownMenu({
        required bool requestFocusOnTap,
      }) => MaterialApp(
        theme: themeData,
        home: Scaffold(
          body: Column(
