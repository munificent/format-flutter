...
void main() {
  ...
  test('DataTableThemeData copyWith dataRowHeight', () {
    const DataTableThemeData themeData = DataTableThemeData(dataRowMinHeight: 10, dataRowMaxHeight: 10);
    expect(themeData, themeData.copyWith());
    expect(themeData.copyWith(dataRowMinHeight: 20, dataRowMaxHeight: 20), themeData.copyWith(dataRowHeight: 20));
  });
  ...
  testWidgets('DataTableThemeData implements debugFillProperties', (WidgetTester tester) async {
    ...
    DataTableThemeData(
      ...
      dataRowColor: MaterialStateProperty.resolveWith<Color>((Set<MaterialState> states) => const Color(0xfffffff1)),
      dataRowMinHeight: 41.0,
      dataRowMaxHeight: 42.0,
      dataTextStyle: const TextStyle(fontSize: 12.0),
      headingRowColor: MaterialStateProperty.resolveWith<Color>((Set<MaterialState> states) => const Color(0xfffffff2)),
  ...
  testWidgets('DataTable is themeable', (WidgetTester tester) async {
    ...
    const MaterialStateProperty<MouseCursor> headingCellCursor = MaterialStatePropertyAll<MouseCursor>(
  ...
  testWidgets('DataTable properties are taken over the theme values', (WidgetTester tester) async {
    ...
    const MaterialStateProperty<MouseCursor> themeHeadingCellCursor = MaterialStatePropertyAll<MouseCursor>(
      SystemMouseCursors.copy,
    );
    const MaterialStateProperty<MouseCursor> themeDataRowCursor = MaterialStatePropertyAll<MouseCursor>(
      SystemMouseCursors.copy,
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        theme: ThemeData(dataTableTheme: const DataTableThemeData(dataRowHeight: themeDataRowHeight)),
        home: Scaffold(
          body: DataTable(
  ...
  testWidgets('Local DataTableTheme can override global DataTableTheme', (WidgetTester tester) async {
    ...
    const MaterialStateProperty<MouseCursor> globalHeadingCellCursor = MaterialStatePropertyAll<MouseCursor>(
      SystemMouseCursors.allScroll,
    );
    const MaterialStateProperty<MouseCursor> globalDataRowCursor = MaterialStatePropertyAll<MouseCursor>(
      SystemMouseCursors.allScroll,
    );
    ...
    const MaterialStateProperty<MouseCursor> localHeadingCellCursor = MaterialStatePropertyAll<MouseCursor>(
      SystemMouseCursors.move,
    );
    const MaterialStateProperty<MouseCursor> localDataRowCursor = MaterialStatePropertyAll<MouseCursor>(
      SystemMouseCursors.move,
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        theme: ThemeData(dataTableTheme: const DataTableThemeData(dataRowHeight: globalThemeDataRowHeight)),
        home: Scaffold(
          body: DataTableTheme(
