...
void main() {
  test('DataTableThemeData copyWith, ==, hashCode basics', () {
    ...
    expect(
      const DataTableThemeData().hashCode,
  ...
  test('DataTableThemeData defaults', () {
    ...
    const DataTableTheme theme = DataTableTheme(
  ...
  testWidgets('DataTable is themeable', (WidgetTester tester) async {
    ...
    expect(
      tester.getSize(_findFirstContainerFor('Data')).height,
      minMaxDataRowHeight,
    );
    ...
    expect(
      tester.getSize(_findFirstContainerFor('A')).height,
      headingRowHeight,
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        theme: ThemeData(
          dataTableTheme:
              const DataTableThemeData(dataRowHeight: dataRowHeight),
        ),
        home: Scaffold(
          body: DataTable(
            sortColumnIndex: 0,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      const BoxDecoration themeDecoration = BoxDecoration(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      const BoxDecoration globalThemeDecoration = BoxDecoration(
        color: Color(0xfffffff1),
      );
      ...
      const BoxDecoration localThemeDecoration = BoxDecoration(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        theme: ThemeData(
          dataTableTheme:
              const DataTableThemeData(dataRowHeight: globalThemeDataRowHeight),
        ),
        home: Scaffold(
          body: DataTableTheme(
            data: const DataTableThemeData(
