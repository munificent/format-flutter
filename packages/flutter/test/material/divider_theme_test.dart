  ...
  group('Horizontal Divider', () {
    testWidgets('Passing no DividerThemeData returns defaults', (
      ...
      await tester.pumpWidget(
        MaterialApp(theme: theme, home: const Scaffold(body: Divider())),
      );
    ...
    testWidgets(
      'Uses values from DividerThemeData',
  ...
  group('Vertical Divider', () {
    ...
    testWidgets('DividerTheme overrides defaults', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        ...
        home: Scaffold(
          body:
              DividerTheme(data: dividerTheme, child: const VerticalDivider()),
        ),
      ));
  ...
  group('Material 2', () {
    ...
    group('Horizontal Divider', () {
      ...
      testWidgets('DividerTheme overrides defaults', (
        ...
        await tester.pumpWidget(MaterialApp(
          home:
              Scaffold(body: DividerTheme(data: theme, child: const Divider())),
        ));
