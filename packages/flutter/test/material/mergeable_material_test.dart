...
void main() {
  ...
  testWidgets('MergeableMaterial dividers', (WidgetTester tester) async {
    ...
    List<Widget> animatedContainers =
        tester.widgetList(find.byType(AnimatedContainer)).toList();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      BoxDecoration boxDecoration = tester.widget<Container>(
        find.byType(Container).first,
      ).decoration! as BoxDecoration;
      expect(boxDecoration.color, materialSliceColor);

      boxDecoration = tester.widget<Container>(
