...
void main() {
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(localizations.pageRowsInfoTitle(1, 10, 100, true).contains(
        r'$firstRow',
      ), isFalse);
      expect(
      ...
      expect(localizations.pageRowsInfoTitle(1, 10, 100, false).contains(
        r'$firstRow',
      ), isFalse);
      expect(localizations.pageRowsInfoTitle(1, 10, 100, false).contains(
        r'$lastRow',
      ...
      expect(localizations.licensesPackageDetailText(100).contains(
        r'$licensesCount',
      ), isFalse);
    },
  );
