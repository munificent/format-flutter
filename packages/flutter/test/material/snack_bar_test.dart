...
void main() {
  ...
  testWidgets(
    'Light theme SnackBar has dark background',
  ...
  testWidgets(
    'Snackbar width can be customized from ThemeData',
    (WidgetTester tester) async {
      const double width = 200.0;
      await tester.pumpWidget(MaterialApp(
        theme: ThemeData(
          ...
          body: Builder(
            builder: (BuildContext context) {
              return GestureDetector(
                onTap: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Feeling snackish')),
                  );
                },
                child: const Text('X'),
              );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset snackBarBottomRight = tester.getBottomRight(materialFinder);
      expect(
        snackBarBottomLeft.dx,
        (800 - widgetWidth) / 2,
      ); // Device width is 800.
      expect(
        snackBarBottomRight.dx,
        (800 + widgetWidth) / 2,
      ); // Device width is 800.
    },
  );
  ...
  testWidgets(
    'Snackbar labels can be colored as MaterialColor (Material 2)',
    (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Scaffold(
          body: Builder(
      ...
      final DefaultTextStyle defaultTextStyle = DefaultTextStyle.of(
        actionTextBox,
      );
  ...
  testWidgets(
    'Snackbar labels can be colored as MaterialColor (Material 3)',
    (WidgetTester tester) async {
      ...
      final Element actionTextButton = tester.element(
  ...
  testWidgets('SnackBar button text alignment', (WidgetTester tester) async {
    ...
    final Offset textBottomLeft = tester.getBottomLeft(
      find.text('I am a snack bar.'),
    );
    final Offset textBottomRight = tester.getBottomRight(
      find.text('I am a snack bar.'),
    );
    final Offset actionTextBottomLeft = tester.getBottomLeft(
      find.text('ACTION'),
    );
    final Offset actionTextBottomRight = tester.getBottomRight(
      find.text('ACTION'),
    );
    final Offset snackBarBottomLeft = tester.getBottomLeft(
      find.byType(SnackBar),
    );
    final Offset snackBarBottomRight = tester.getBottomRight(
      find.byType(SnackBar),
    );

    expect(
      textBottomLeft.dx - snackBarBottomLeft.dx,
      24.0 + 10.0,
    ); // margin + left padding
    expect(
      snackBarBottomLeft.dy - textBottomLeft.dy,
      17.0 + 40.0,
    ); // margin + bottom padding
    expect(
      actionTextBottomLeft.dx - textBottomRight.dx,
      24.0 + 12.0,
  ...
  testWidgets('SnackBar should push FloatingActionButton above', (
    ...
    final Rect originalFabRect = tester.getRect(
          ...
          body: Builder(
            builder: (BuildContext context) {
              return GestureDetector(
                ...
                onTap: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text(helloSnackBar)),
                  );
                },
                behavior: HitTestBehavior.opaque,
                child: const SizedBox(height: 100.0, width: 100.0),
  ...
  group('SnackBar position', () {
    for (final SnackBarBehavior behavior in SnackBarBehavior.values) {
      ...
      testWidgets('$behavior should align SnackBar with the bottom of Scaffold '
        ...
        final Offset scaffoldBottomRight = tester.getBottomRight(
        ...
        final Offset scaffoldBottomLeft = tester.getBottomLeft(
          find.byType(Scaffold),
        );
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          final Offset bottomNavigationBarTopRight = tester.getTopRight(
            find.byKey(boxKey),
          );
          ...
          final Offset bottomNavigationBarTopLeft = tester.getTopLeft(
            find.byKey(boxKey),
          );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final Offset initialBottomLeft = tester.getBottomLeft(
          find.byType(SnackBar),
        );
        final Offset initialBottomRight = tester.getBottomRight(
          find.byType(SnackBar),
        );
        ...
        final Offset finalBottomLeft = tester.getBottomLeft(
          find.byType(SnackBar),
        );
        final Offset finalBottomRight = tester.getBottomRight(
          find.byType(SnackBar),
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final Offset fabTopRight = tester.getTopRight(
          find.byType(FloatingActionButton),
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final Offset snackBarTopRight = tester.getTopRight(
          find.byType(SnackBar),
        );
        final Offset actionTopRight = tester.getTopRight(
        ...
        return MaterialApp(
          routes: <String, WidgetBuilder>{
            ...
            '/second': (BuildContext context) => Scaffold(
                  appBar: AppBar(title: const Text(secondHeader)),
                ),
          },
        );
      }
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        doBuildApp(behavior: null, margin: const EdgeInsets.all(8.0)),
      );
      await tester.tap(find.text('X'));
      await tester.pump(); // start animation
      await tester.pump(const Duration(milliseconds: 750));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      // Regression test for https://github.com/flutter/flutter/issues/84935
      await tester.pumpWidget(
        doBuildApp(behavior: SnackBarBehavior.fixed, width: 5.0),
      );
      await tester.tap(find.text('X'));
      await tester.pump(); // start animation
      await tester.pump(const Duration(milliseconds: 750));
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final AssertionError exception =
            tester.takeException() as AssertionError;
        expect(
          exception.message,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await expectLater(
        find.byType(MaterialApp),
        matchesGoldenFile('snack_bar.goldenTest.fixedWithActionWithIcon.png'),
      );
    },
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await expectLater(
        find.byType(MaterialApp),
        matchesGoldenFile('snack_bar.goldenTest.fixedWithIcon.png'),
      );
    },
  );
  ...
  testWidgets(
    'SnackBarAction backgroundColor works as a Color',
    (WidgetTester tester) async {
      ...
      final Material materialBeforeDismissed = tester.widget<Material>(find
          .descendant(
      ...
      final Material materialAfterDismissed = tester.widget<Material>(find
          .descendant(
            of: find.widgetWithText(TextButton, 'ACTION'),
            matching: find.byType(Material),
          ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      final Color backgroundColor = MaterialStateColor.resolveWith(
        (Set<MaterialState> states) {
          if (states.contains(MaterialState.disabled)) {
            return Colors.blue;
          }
  ...
  testWidgets(
    'SnackBar material applies SnackBar.clipBehavior',
    (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(home: Scaffold(body: Container())));
