...
void main() {
  ...
  testWidgets('Dialog interaction', (WidgetTester tester) async {
    ...
    showDialog<void>(context: context, builder: (BuildContext context) => const SimpleDialog(title: Text('Dialog')));
  ...
  testWidgets('Autofocus shows keyboard', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(const MaterialApp(home: Material(child: Center(child: TextField(autofocus: true)))));
  ...
  testWidgets('Focus triggers keep-alive', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      home: Material(child: ListView(children: <Widget>[TextField(focusNode: focusNode), Container(height: 1000.0)])),
    ));
  ...
  testWidgets('TextField with decoration:null', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(const MaterialApp(home: Material(child: Center(child: TextField(decoration: null)))));
  ...
  testWidgets('A Focused text-field will not lose focus when clicking on its decoration', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      home: Material(
        child: ListView(
          children: <Widget>[
            TextField(focusNode: focusNodeA, decoration: InputDecoration(icon: Icon(Icons.copy_all, key: iconKey))),
          ],
        ),
      ),
    ));
