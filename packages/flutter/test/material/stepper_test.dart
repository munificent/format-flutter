...
void main() {
  testWidgets(
    'Material3 has sentence case labels',
        ...
        child: Material(
          child: Stepper(
            steps: const <Step>[
              ...
              Step(
                title: Text('Step 2'),
                content: SizedBox(width: 200.0, height: 200.0),
              ),
            ],
          ),
        ),
  ...
  testWidgets('Stepper scroll test', (WidgetTester tester) async {
      ...
      home: Material(
        child: Stepper(
          steps: const <Step>[
            Step(
              title: Text('Step 1'),
              content: SizedBox(width: 100.0, height: 300.0),
            ),
            Step(
              title: Text('Step 2'),
              content: SizedBox(width: 100.0, height: 300.0),
    ...
    final ScrollableState scrollableState = tester.firstState(
  ...
  testWidgets(
    'Stepper custom indexed controls test',
    (WidgetTester tester) async {
      int currentStep = 0;
      void setContinue() {
        currentStep += 1;
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final FocusNode disabledNode = Focus.of(
        tester.element(find.text('Step 0')),
        scopeOk: true,
      );
  ...
  testWidgets('Stepper disabled button styles', (WidgetTester tester) async {
    ...
    expect(
      buttonMaterial(continueStr).textStyle!.color!.value,
      material3Light
          ? themeLight.colorScheme.onSurface.withOpacity(0.38).value
          : 0x61000000,
    );
    ...
    expect(
      buttonMaterial(continueStr).textStyle!.color!.value,
      material3Dark
          ? themeDark.colorScheme.onSurface.withOpacity(0.38).value
          : 0x61ffffff,
    );
  ...
  testWidgets('Stepper horizontal size test', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      buildFrame(isActive: false, brightness: Brightness.light),
    );
    await tester.pumpAndSettle();
    ...
    await tester.pumpWidget(
      buildFrame(isActive: false, brightness: Brightness.dark),
    );
    await tester.pumpAndSettle();
  ...
  testWidgets(
    'Stepper horizontal preserves state',
    (WidgetTester tester) async {
      ...
      Color getColor() => tester.widget<ColoredBox>(find.descendant(
  ...
  testWidgets('Stepper custom margin', (WidgetTester tester) async {
    ...
    final Stepper material = tester.firstWidget<Stepper>(find.descendant(
  ...
  testWidgets('Stepper with Alternative Label', (WidgetTester tester) async {
    ...
    selectedLabelTextWidget = tester.widget<Text>(
      find.text('Label ${index + 1}'),
    );
