...
void main() {
  test('copyWith, ==, hashCode basics', () {
    ...
    expect(
      const DrawerThemeData().hashCode,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        _drawerMaterial(tester).color,
        useMaterial3 ? theme.colorScheme.surface : null,
      );
      expect(_drawerMaterial(tester).elevation, useMaterial3 ? 1.0 : 16.0);
      expect(
        _drawerMaterial(tester).shadowColor,
        useMaterial3 ? Colors.transparent : ThemeData().shadowColor,
      );
      expect(
        _drawerMaterial(tester).surfaceTintColor,
        useMaterial3 ? theme.colorScheme.surfaceTint : null,
      );
      expect(
  ...
  testWidgets(
    'Default values are used when no Drawer or DrawerThemeData properties are specified in end drawer',
    (WidgetTester tester) async {
      final GlobalKey<ScaffoldState> scaffoldKey = GlobalKey<ScaffoldState>();
      final ThemeData theme = ThemeData();
      final bool useMaterial3 = theme.useMaterial3;
      ...
      expect(
        _drawerMaterial(tester).surfaceTintColor,
        useMaterial3 ? ThemeData().colorScheme.surfaceTint : null,
      );
      expect(
        _drawerMaterial(tester).shape,
        useMaterial3
