...
void main() {
  ...
  testWidgets('NavigationBar adds bottom padding to height', (
    ...
    await tester.pumpWidget(_buildWidget(MediaQuery(
      data:
          const MediaQueryData(padding: EdgeInsets.only(bottom: bottomPadding)),
      child: NavigationBar(
        destinations: const <Widget>[
          NavigationDestination(icon: Icon(Icons.ac_unit), label: 'AC'),
          NavigationDestination(icon: Icon(Icons.access_alarm), label: 'Alarm'),
  ...
  testWidgets(
    'NavigationBar uses proper defaults when no parameters are given - M2',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'NavigationBar uses proper defaults when no parameters are given - M3',
    (WidgetTester tester) async {
  ...
  testWidgets('Navigation indicator renders ripple', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Navigation indicator ripple golden test', (
    WidgetTester tester,
  ) async {
