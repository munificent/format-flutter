        ...
        home: Scaffold(
          body: Center(
            child: AdaptiveTextSelectionToolbar.buttonItems(
              ...
              buttonItems: <ContextMenuButtonItem>[ContextMenuButtonItem(label: buttonText, onPressed: () {})],
            ),
          ),
        ),
      ));
            ...
            child: SizedBox(
              ...
              child: EditableText(
                ...
                contextMenuBuilder: (BuildContext context, EditableTextState editableTextState) {
                  return AdaptiveTextSelectionToolbar.editableText(key: key, editableTextState: editableTextState);
                },
              ),
            ),
          ),
          ...
          home: Scaffold(
            body: Center(
              child: EditableText(
                ...
                selectionControls: materialTextSelectionHandleControls,
                contextMenuBuilder: (BuildContext context, EditableTextState editableTextState) {
                  buttonTypes = editableTextState.contextMenuButtonItems.map(
            ...
            body: Center(
              child: Builder(
                builder: (BuildContext context) {
                  ...
                  return ListView(
                    children: AdaptiveTextSelectionToolbar.getAdaptiveButtons(context, buttonItems).toList(),
                  );
                },
              ),
            ),
