...
void main() {
  testWidgets('ButtonBar default control smoketest', (WidgetTester tester) async {
    await tester.pumpWidget(const Directionality(textDirection: TextDirection.ltr, child: ButtonBar()));
  });
      ...
      await tester.pumpWidget(
        const MaterialApp(
          home: ButtonBarTheme(
            data: ButtonBarThemeData(alignment: MainAxisAlignment.center),
            child:
                ButtonBar(alignment: MainAxisAlignment.start, children: <Widget>[SizedBox(width: 10.0, height: 10.0)]),
          ),
        ),
      );
  ...
  group("ButtonBar's children wrap when they overflow horizontally", () {
    ...
    testWidgets("ButtonBar's children overflow defaults - MainAxisAlignment.end", (WidgetTester tester) async {
      final Key keyOne = UniqueKey();
      final Key keyTwo = UniqueKey();
      await tester.pumpWidget(MaterialApp(
        home: ButtonBar(
    ...
    testWidgets("ButtonBar's children respects verticalDirection when overflowing", (WidgetTester tester) async {
      final Key keyOne = UniqueKey();
      final Key keyTwo = UniqueKey();
      await tester.pumpWidget(MaterialApp(
        home: ButtonBar(
    ...
    testWidgets('ButtonBar has no spacing by default when overflowing', (WidgetTester tester) async {
      final Key keyOne = UniqueKey();
      final Key keyTwo = UniqueKey();
      await tester.pumpWidget(MaterialApp(
        home: ButtonBar(
    ...
    testWidgets("ButtonBar's children respects overflowButtonSpacing when overflowing", (WidgetTester tester) async {
      final Key keyOne = UniqueKey();
      final Key keyTwo = UniqueKey();
      await tester.pumpWidget(MaterialApp(
        home: ButtonBar(
  ...
  testWidgets('_RenderButtonBarRow.constraints does not work before layout', (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(home: ButtonBar()), Duration.zero, EnginePhase.build);
