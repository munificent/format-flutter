...
void main() {
  testWidgets(
    'ButtonBar default control smoketest',
  ...
  group('alignment', () {
    ...
    testWidgets(
      'ButtonBarTheme.alignment overrides default',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          const MaterialApp(
            home: ButtonBarTheme(
  ...
  group('mainAxisSize', () {
    testWidgets(
      'Default mainAxisSize is MainAxisSize.max',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'ButtonBarTheme.mainAxisSize overrides default',
      (WidgetTester tester) async {
        const Key buttonBarKey = Key('row');
        const Key child0Key = Key('child0');
        const Key child1Key = Key('child1');
