...
void main() {
  ...
  testWidgets('PopupMenu inherits app theme', (WidgetTester tester) async {
    ...
    expect(
      Theme.of(tester.element(find.text('menuItem'))).brightness,
  ...
  testWidgets('Fallback theme', (WidgetTester tester) async {
    ...
    expect(
      ...
      equals(ThemeData.localize(
        ThemeData.fallback(useMaterial3: false),
        defaultGeometryTheme,
      )),
    );
    ...
    expect(
      ...
      equals(ThemeData.localize(
        ...
        defaultGeometryThemeM3,
      )),
    );
  });

  testWidgets(
    'ThemeData.localize memoizes the result',
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        Theme.of(tester.element(find.text('bottomSheet'))).brightness,
        equals(Brightness.light),
      );
    },
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pump(const Duration(seconds: 1));
      expect(
        Theme.of(tester.element(find.text('dialog'))).brightness,
        equals(Brightness.light),
      );
    },
  );
                    ...
                    showDialog<void>(
                      ...
                      builder: (BuildContext context) {
                        return const Scaffold(
                          body: SizedBox(width: 200.0, height: 200.0),
                        );
                      },
                    );
                  },
  ...
  testWidgets('IconThemes are applied', (WidgetTester tester) async {
    ...
    ); // Halfway through the theme transition

    glyphText = tester.renderObject(find.byType(RichText));

    expect(
      glyphText.text.style!.color,
  ...
  testWidgets(
    'Default Theme provides all basic TextStyle properties - M2',
    (WidgetTester tester) async {
      ...
      for (final TextTheme textTheme in <TextTheme>[
        ...
        for (final TextStyle style in extractStyles(textTheme).map<TextStyle>(
          (TextStyle style) => _TextStyleProxy(style),
        )) {
  ...
  testWidgets(
    'Default Theme provides all basic TextStyle properties - M3',
    (WidgetTester tester) async {
      late ThemeData theme;
      await tester.pumpWidget(Theme(
        data: ThemeData(useMaterial3: true),
  ...
  group('Cupertino theme', () {
    ...
    testWidgets(
      'Default light theme has defaults',
      (WidgetTester tester) async {
        ...
        expect(
          themeM3.scaffoldBackgroundColor,
    ...
    testWidgets('Can override material theme', (WidgetTester tester) async {
      ...
      expect(themeM2.primaryContrastingColor, Colors.white);
      expect(
        themeM2.scaffoldBackgroundColor,
    ...
    testWidgets(
      'Can override properties that are independent of material',
      (WidgetTester tester) async {
        final CupertinoThemeData themeM2 = await testTheme(tester, ThemeData(
          cupertinoOverrideTheme: const CupertinoThemeData(
    ...
    testWidgets(
      'Changing material theme triggers rebuilds - M2',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'Changing material theme triggers rebuilds - M3',
      (WidgetTester tester) async {
    ...
    testWidgets('Changing cupertino theme override triggers rebuilds', (
      WidgetTester tester,
    ) async {
