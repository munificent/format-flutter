...
void main() {
  ...
  test('Default primary text theme contrasts with primary brightness', () {
    ...
    expect(
      lightTheme.primaryTextTheme.titleLarge!.color,
      typography.black.titleLarge!.color,
    );
    expect(
      darkTheme.primaryTextTheme.titleLarge!.color,
      typography.white.titleLarge!.color,
    );
  });
  ...
  test('Can control fontFamily default', () {
    ...
    expect(
      themeData.primaryTextTheme.displaySmall!.fontFamily,
      equals('FlutterTest'),
    );
  ...
  test('Can estimate brightness - directly', () {
    ...
    expect(
      ThemeData.estimateBrightnessForColor(Colors.black),
      equals(Brightness.dark),
    );
    expect(
      ThemeData.estimateBrightnessForColor(Colors.blue),
      equals(Brightness.dark),
    );
    expect(
      ThemeData.estimateBrightnessForColor(Colors.yellow),
      equals(Brightness.light),
    );
    expect(
      ThemeData.estimateBrightnessForColor(Colors.deepOrange),
      equals(Brightness.dark),
    );
    expect(
      ThemeData.estimateBrightnessForColor(Colors.orange),
      equals(Brightness.light),
    );
    expect(
      ThemeData.estimateBrightnessForColor(Colors.lime),
      equals(Brightness.light),
    );
    expect(
      ThemeData.estimateBrightnessForColor(Colors.grey),
      equals(Brightness.light),
    );
    expect(
      ThemeData.estimateBrightnessForColor(Colors.teal),
      equals(Brightness.dark),
    );
    expect(
      ThemeData.estimateBrightnessForColor(Colors.indigo),
      equals(Brightness.dark),
    );
  });
  ...
  test('cursorColor', () {
    expect(
      const TextSelectionThemeData(cursorColor: Colors.red).cursorColor,
      Colors.red,
    );
  });
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      const BoxConstraints square = BoxConstraints.tightFor(
        width: 35,
        height: 35,
      );
  ...
  group('Theme extensions', () {
    ...
    testWidgets('can be obtained', (WidgetTester tester) async {
      ...
      expect(
        theme.extension<MyThemeExtensionB>()!.textStyle,
      ...
      await tester.pumpWidget(MaterialApp(
        theme: ThemeData(
          extensions: <ThemeExtension<dynamic>>{
            const MyThemeExtensionA(color1: Colors.black, color2: Colors.amber)
    ...
    testWidgets('can lerp', (WidgetTester tester) async {
      ...
      ThemeData lerped = ThemeData.lerp(
        ThemeData(
          extensions: const <ThemeExtension<dynamic>>[extensionA1, extensionB1],
        ),
        ThemeData(
          extensions: const <ThemeExtension<dynamic>>{extensionA2, extensionB2},
        ),
        0.5,
      );
  ...
  test('== and hashCode include focusColor and hoverColor', () {
    ...
    final ThemeData focusColorBlack = ThemeData(
      focusColor: Colors.black,
      buttonTheme: buttonTheme,
    );
    final ThemeData focusColorWhite = ThemeData(
    ...
    final ThemeData hoverColorBlack = ThemeData(
      hoverColor: Colors.black,
      buttonTheme: buttonTheme,
    );
    final ThemeData hoverColorWhite = ThemeData(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final ThemeData theme = ThemeData.raw(
        ...
        timePickerTheme:
            const TimePickerThemeData(backgroundColor: Colors.black),
      ...
      final SliderThemeData otherSliderTheme =
      ...
      final ThemeData otherTheme = ThemeData.raw(
        ...
        dataTableTheme: const DataTableThemeData(),
        datePickerTheme:
            const DatePickerThemeData(backgroundColor: Colors.amber),
      ...
      expect(
        themeDataCopy.dialogBackgroundColor,
      ...
      expect(
        themeDataCopy.primaryColorDark,
        equals(otherTheme.primaryColorDark),
      );
      expect(
        themeDataCopy.primaryColorLight,
        equals(otherTheme.primaryColorLight),
      );
      expect(
        themeDataCopy.scaffoldBackgroundColor,
        equals(otherTheme.scaffoldBackgroundColor),
      );
      expect(
        themeDataCopy.secondaryHeaderColor,
      ...
      expect(
        themeDataCopy.unselectedWidgetColor,
      ...
      expect(
        themeDataCopy.primaryIconTheme,
        equals(otherTheme.primaryIconTheme),
      );
      expect(
        themeDataCopy.primaryTextTheme,
        equals(otherTheme.primaryTextTheme),
      );
      ...
      expect(
        themeDataCopy.bottomAppBarTheme,
        equals(otherTheme.bottomAppBarTheme),
      );
      expect(
        themeDataCopy.bottomNavigationBarTheme,
        equals(otherTheme.bottomNavigationBarTheme),
      );
      expect(
        themeDataCopy.bottomSheetTheme,
        equals(otherTheme.bottomSheetTheme),
      );
      ...
      expect(
        themeDataCopy.elevatedButtonTheme,
        equals(otherTheme.elevatedButtonTheme),
      );
      expect(
        themeDataCopy.expansionTileTheme,
        equals(otherTheme.expansionTileTheme),
      );
      expect(
        themeDataCopy.filledButtonTheme,
        equals(otherTheme.filledButtonTheme),
      );
      expect(
        themeDataCopy.floatingActionButtonTheme,
      ...
      expect(
        themeDataCopy.textSelectionTheme,
      ...
      expect(
        themeDataCopy.toggleButtonsTheme,
      ...
      // DEPRECATED (newest deprecations at the bottom)
      expect(
        themeDataCopy.androidOverscrollIndicator,
        equals(otherTheme.androidOverscrollIndicator),
      );
      expect(
        themeDataCopy.toggleableActiveColor,
        equals(otherTheme.toggleableActiveColor),
      );
      expect(
        themeDataCopy.selectedRowColor,
        equals(otherTheme.selectedRowColor),
      );
      ...
      expect(
        themeDataCopy.bottomAppBarColor,
        equals(otherTheme.bottomAppBarColor),
      );
    },
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      const ColorScheme lightColors = ColorScheme.light();
      final ThemeData theme = ThemeData.from(colorScheme: lightColors).copyWith(
        brightness: Brightness.dark,
      );
  ...
  test('ThemeData diagnostics include all properties', () {
    ...
    final List<String> propertyNameList = properties.properties.map(
      (final DiagnosticsNode node) => node.name,
