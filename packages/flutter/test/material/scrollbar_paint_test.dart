...
void main() {
  testWidgets('Viewport basic test (LTR)', (WidgetTester tester) async {
    await tester.pumpWidget(
      _buildSingleChildScrollViewWithScrollbar(child: const SizedBox(width: 4000.0, height: 4000.0)),
    );
    ...
    await tester.pumpWidget(MaterialApp(
      home: MediaQuery(
        ...
        child: Scaffold(
          ...
          body: Scrollbar(child: ListView(children: const <Widget>[SizedBox(width: 4000, height: 4000)])),
        ),
      ),
    ));
  ...
  testWidgets("should not paint when there isn't enough space", (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
      home: MediaQuery(
        ...
        child: Scaffold(
          appBar: AppBar(title: const Text('Title')),
          body: Scrollbar(child: ListView(children: const <Widget>[SizedBox(width: 40, height: 40)])),
        ),
      ),
    ));
