...
void main() {
  ...
  testWidgets('Throw if enable drag without an animation controller', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      home: BottomSheet(
        onClosing: () {},
        builder: (_) => Container(height: 200, color: Colors.red, child: const Text('BottomSheet')),
      ),
    ));
  ...
  testWidgets('Disposing app while bottom sheet is disappearing does not crash', (WidgetTester tester) async {
    ...
    showModalBottomSheet<void>(context: savedContext, builder: (BuildContext context) => const Text('BottomSheet'))
  ...
  testWidgets('Swiping down a BottomSheet should not dismiss it when enableDrag is false', (WidgetTester tester) async {
    ...
    scaffoldKey.currentState!.showBottomSheet<void>((BuildContext context) {
      return const SizedBox(height: 200.0, child: Text('BottomSheet'));
    }, enableDrag: false).closed.whenComplete(() {
      showBottomSheetThenCalled = true;
    });
  ...
  testWidgets('Swiping down a BottomSheet should dismiss it when enableDrag is true', (WidgetTester tester) async {
    ...
    scaffoldKey.currentState!.showBottomSheet<void>((BuildContext context) {
      return const SizedBox(height: 200.0, child: Text('BottomSheet'));
    }, enableDrag: true).closed.whenComplete(() {
      showBottomSheetThenCalled = true;
    });
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      showModalBottomSheet<void>(context: homeContext, builder: (BuildContext context) => const Text('BottomSheet'));
      await tester.pump();
  ...
  testWidgets('modal BottomSheet has no top MediaQuery', (WidgetTester tester) async {
    ...
    expect(MediaQuery.of(innerContext).padding, const EdgeInsets.only(left: 50.0, right: 50.0, bottom: 50.0));
  });
            ...
            TestSemantics(
              children: <TestSemantics>[
                TestSemantics(
                  ...
                  children: <TestSemantics>[TestSemantics(label: 'BottomSheet', textDirection: TextDirection.ltr)],
                ),
              ],
            ),
            TestSemantics(
  ...
  testWidgets('BottomSheet uses fallback values in material3', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      theme: ThemeData(
        colorScheme: const ColorScheme.light(surface: surfaceColor, surfaceTint: surfaceTintColor),
        useMaterial3: true,
      ),
      home: Scaffold(
        body: BottomSheet(
    ...
    final Finder finder = find.descendant(of: find.byType(BottomSheet), matching: find.byType(Material));
              ...
              child: Column(
                children: <Widget>[
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      Scaffold.of(context).showBottomSheet<void>((BuildContext context) => const Text('BottomSheet 2'));
                    },
                  ),
                  ElevatedButton(
  ...
  testWidgets('ModalBottomSheetRoute shows BottomSheet correctly', (WidgetTester tester) async {
    ...
    navigator.push(
      ModalBottomSheetRoute<void>(isScrollControlled: false, builder: (BuildContext context) => Container()),
    );
    await tester.pumpAndSettle();
    expect(find.byType(BottomSheet), findsOneWidget);
  });
    ...
    testWidgets('default constraints are max width 640 in material 3', (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        ...
        home: const MediaQuery(
          ...
          child: Scaffold(body: Center(child: Text('body')), bottomSheet: Placeholder(fallbackWidth: 800)),
        ),
      ));
      ...
      child: TextButton(
        ...
        onPressed: () {
          if (useRootNavigator != null) {
            ...
            showModalBottomSheet<void>(context: context, builder: (_) => const Text('Modal bottom sheet'));
          }
        },
      ),
    );
