...
void main() {
        ...
        return MaterialApp(
          home: Scaffold(
            ...
            floatingActionButton:
                const FloatingActionButton(onPressed: null, child: Text('fab')),
          ),
        );
      }
  ...
  testWidgets('showBottomSheet()', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      MaterialApp(home: Scaffold(body: Placeholder(key: key))),
    );
  ...
  testWidgets('Scaffold.bottomSheet', (WidgetTester tester) async {
    ...
    expect(
      tester.getSize(find.byKey(bottomSheetKey)),
      const Size(800.0, 200.0),
    );
    expect(
      tester.getTopLeft(find.byKey(bottomSheetKey)),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final RenderParagraph renderBeforeUpdate = tester.renderObject(
