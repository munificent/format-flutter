  ...
  group('InputDatePickerFormField', () {
    ...
    testWidgets('Changing initial date is reflected in text value', (
      ...
      await tester.pumpWidget(
        inputDatePickerField(initialDate: updatedInitialDate),
      );
    ...
    testWidgets(
      'Invalid text entry shows errorFormat text',
    ...
    testWidgets(
      'Empty field shows hint text when focused',
      (WidgetTester tester) async {
        await tester.pumpWidget(inputDatePickerField());
        // Focus on it
        ...
        await tester.pumpWidget(
          inputDatePickerField(fieldHintText: 'Enter some date'),
        );
        await tester.pumpAndSettle();
    ...
    testWidgets('Label text', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        inputDatePickerField(fieldLabelText: 'Give me a date!'),
      );
    ...
    testWidgets('Date text localization', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        inputDatePickerField(localizationsDelegates: delegates),
      );
