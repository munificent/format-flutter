...
void main() {
  ...
  group('InputDatePickerFormField', () {
    ...
    testWidgets('Valid date entry', (WidgetTester tester) async {
      final GlobalKey<FormState> formKey = GlobalKey<FormState>();
      DateTime? inputDate;
      await tester.pumpWidget(inputDatePickerField(onDateSaved: (DateTime date) => inputDate = date, formKey: formKey));
    ...
    testWidgets('Date text localization', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(inputDatePickerField(initialDate: DateTime(2017), localizationsDelegates: delegates));
    });
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          inputDatePickerField(errorFormatText: errorFormatText, formKey: formKey, acceptEmptyDate: true),
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        final GlobalKey<FormState> formKey = GlobalKey<FormState>();
        const String errorFormatText = 'That is not a date.';
        await tester.pumpWidget(inputDatePickerField(errorFormatText: errorFormatText, formKey: formKey));
        await tester.enterText(find.byType(TextField), '');
        await tester.pumpAndSettle();
        formKey.currentState!.validate();
        await tester.pumpAndSettle();
