...
void main() {
        ...
        drawer: Drawer(
          child: ListView(
            children: <Widget>[
              DrawerHeader(
                child:
                    Container(key: containerKey, child: const Text('header')),
              ),
              const ListTile(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        const MaterialApp(home: Scaffold(drawer: Drawer())),
      );
  ...
  testWidgets(
    'Drawer dismiss barrier has no label',
    (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
      await tester.pumpWidget(
        const MaterialApp(home: Scaffold(drawer: Drawer())),
  ...
  testWidgets('Scaffold drawerScrimColor', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      buildFrame(drawerScrimColor: const Color(0xFF323232)),
    );
    scaffoldKey.currentState!.openDrawer();
    await tester.pumpAndSettle();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final ScaffoldState portraitScaffoldState = tester.firstState(
  ...
  testWidgets(
    'Drawer width defaults to Material spec',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(home: Scaffold(drawer: Drawer())),
      );
  ...
  testWidgets(
    'Drawer width can be customized by parameter',
    (WidgetTester tester) async {
      const double smallWidth = 200;

      await tester.pumpWidget(
        const MaterialApp(home: Scaffold(drawer: Drawer(width: smallWidth))),
      );
