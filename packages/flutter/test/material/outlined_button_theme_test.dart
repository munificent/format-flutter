...
void main() {
  ...
  testWidgets('Material3: Passing no OutlinedButtonTheme returns defaults', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: Scaffold(body: Center(child: OutlinedButton(onPressed: () {}, child: const Text('button')))),
    ));
        ...
        home: Scaffold(
          body: Center(
            ...
            child: themeStyle == null
                ? child
                : OutlinedButtonTheme(data: OutlinedButtonThemeData(style: themeStyle), child: child),
          ),
        ),
      );
    }

    final Finder findMaterial = find.descendant(of: find.byType(OutlinedButton), matching: find.byType(Material));

    final Finder findInkWell = find.descendant(of: find.byType(OutlinedButton), matching: find.byType(InkWell));
        ...
        home: Scaffold(
          body: Center(
            child: OutlinedButtonTheme(
              data: OutlinedButtonThemeData(style: OutlinedButton.styleFrom(shadowColor: themeShadowColor)),
              child: Builder(
                builder: (BuildContext context) {
