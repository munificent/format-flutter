...
void main() {
  ...
  testWidgets('Material3: Passing no TextButtonTheme returns defaults', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: Scaffold(body: Center(child: TextButton(onPressed: () {}, child: const Text('button')))),
    ));
  ...
  group('[Theme, TextTheme, TextButton style overrides]', () {
    ...
    final Finder findMaterial = find.descendant(of: find.byType(TextButton), matching: find.byType(Material));

    final Finder findInkWell = find.descendant(of: find.byType(TextButton), matching: find.byType(InkWell));
  ...
  testWidgets('Material3: Theme shadowColor', (WidgetTester tester) async {
    ...
    final Finder buttonMaterialFinder = find.descendant(of: find.byType(TextButton), matching: find.byType(Material));
