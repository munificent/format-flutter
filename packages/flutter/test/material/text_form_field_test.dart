...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      // Initially, the menu is not shown and there is no selection.
      expect(find.byType(CupertinoButton), findsNothing);
      const TextSelection invalidSelection = TextSelection(
        baseOffset: -1,
        extentOffset: -1,
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        home: Material(
          child: Center(
            child: TextFormField(obscureText: true, controller: controller),
          ),
        ),
      ));
  ...
  testWidgets('Passes textAlign to underlying TextField', (
    ...
    await tester.pumpWidget(MaterialApp(
      home: Material(child: Center(child: TextFormField(textAlign: alignment))),
    ));
  ...
  testWidgets('Passes textAlignVertical to underlying TextField', (
    ...
    await tester.pumpWidget(MaterialApp(
      home: Material(
        child:
            Center(child: TextFormField(textAlignVertical: textAlignVertical)),
      ),
    ));
  ...
  testWidgets('Passes textInputAction to underlying TextField', (
    ...
    await tester.pumpWidget(MaterialApp(
      home: Material(
        child:
            Center(child: TextFormField(textInputAction: TextInputAction.next)),
      ),
    ));
  ...
  testWidgets('Passes onEditingComplete to underlying TextField', (
    ...
    await tester.pumpWidget(MaterialApp(
      home: Material(
        child:
            Center(child: TextFormField(onEditingComplete: onEditingComplete)),
      ),
    ));
  ...
  testWidgets(
    'Disabled field hides helper and counter in M2',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Material(
          child: Center(
            child: TextFormField(initialValue: 'readonly', readOnly: true),
          ),
        ),
      ));
  ...
  testWidgets(
    'onTapOutside is called upon tap outside',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(home: Material(child: Center(child: TextFormField()))),
      );
  ...
  testWidgets('textSelectionControls is passed to super', (
    ...
    await tester.pumpWidget(MaterialApp(
      home: Material(
        child: Scaffold(
          body: TextFormField(selectionControls: materialTextSelectionControls),
        ),
      ),
    ));
  ...
  testWidgets(
    'TextFormField respects hintTextDirection',
    (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Material(
  ...
  testWidgets(
    'TextFormField changes mouse cursor when hovered',
    (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Material(
          child: MouseRegion(
  ...
  testWidgets('spellCheckConfiguration passes through to EditableText', (
    ...
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        body: TextFormField(spellCheckConfiguration: mySpellCheckConfiguration),
      ),
    ));
  ...
  testWidgets('magnifierConfiguration passes through to EditableText', (
    ...
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        body:
            TextFormField(magnifierConfiguration: myTextMagnifierConfiguration),
      ),
    ));
    ...
    final EditableText editableText = tester.widget(find.byType(EditableText));
    expect(
      editableText.magnifierConfiguration,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        home: Material(
          child: Center(
            child: TextFormField(cursorOpacityAnimates: cursorOpacityAnimates),
          ),
        ),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final TextField textFieldWidget = tester.widget(textFieldFinder);
      expect(
        textFieldWidget.contentInsertionConfiguration,
        contentInsertionConfiguration,
      );
    },
  );
  ...
  testWidgets(
    'Passes clipBehavior to clipBehavior TextField',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        home: Material(
          child: Center(
            child: TextFormField(onAppPrivateCommand: onAppPrivateCommand),
          ),
        ),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        home: Material(
          child: Center(
            child: TextFormField(selectionHeightStyle: selectionHeightStyle),
          ),
        ),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        home: Material(
          child: Center(
            child: TextFormField(selectionWidthStyle: selectionWidthStyle),
          ),
        ),
      ));
  ...
  testWidgets('Passes dragStartBehavior to dragStartBehavior TextField', (
    ...
    await tester.pumpWidget(MaterialApp(
      home: Material(
        child:
            Center(child: TextFormField(dragStartBehavior: dragStartBehavior)),
      ),
    ));
