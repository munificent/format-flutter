...
void main() {
  ...
  test('TextTheme merges properly in the presence of null fields.', () {
    const TextTheme partialTheme = TextTheme(
      titleLarge: TextStyle(color: Color(0xcafefeed)),
    );
    ...
    TextTheme merged = onlyHeadlineSmallAndTitleLarge.merge(
      onlyBodyMediumAndTitleLarge,
    );
    expect(merged.bodyLarge, isNull);
    expect(
      merged.bodyMedium!.color,
  ...
  test('TextTheme apply', () {
    ...
    expect(themeStyles.every(
      (TextStyle style) => style.fontFamilyFallback == fontFamilyFallback,
    ), true);
    expect(themeStyles.every(
  ...
  test('TextTheme apply fontSizeFactor fontSizeDelta', () {
    final Typography typography = Typography.material2018();
    final TextTheme baseTheme = Typography.englishLike2018.merge(
      typography.black,
    );
  ...
  test('TextTheme lerp with second parameter null', () {
    ...
    expect(
      lerped.displayMedium,
      TextStyle.lerp(theme.displayMedium, null, 0.25),
    );
    expect(lerped.displaySmall, TextStyle.lerp(theme.displaySmall, null, 0.25));
    expect(
      lerped.headlineLarge,
      TextStyle.lerp(theme.headlineLarge, null, 0.25),
    );
    expect(
      lerped.headlineMedium,
      TextStyle.lerp(theme.headlineMedium, null, 0.25),
    );
    expect(
      lerped.headlineSmall,
      TextStyle.lerp(theme.headlineSmall, null, 0.25),
    );
  ...
  test('TextTheme lerp with first parameter null', () {
    ...
    expect(
      lerped.displayMedium,
      TextStyle.lerp(null, theme.displayMedium, 0.25),
    );
    expect(lerped.displaySmall, TextStyle.lerp(null, theme.displaySmall, 0.25));
    expect(
      lerped.headlineLarge,
      TextStyle.lerp(null, theme.headlineLarge, 0.25),
    );
    expect(
      lerped.headlineMedium,
    ...
    expect(
      lerped.headlineSmall,
      TextStyle.lerp(null, theme.headlineSmall, 0.25),
    );
