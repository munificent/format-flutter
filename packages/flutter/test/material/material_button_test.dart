...
void main() {
  ...
  testWidgets(
    'Does MaterialButton work with hover',
  ...
  testWidgets(
    'Does MaterialButton work with focus',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Path expectedClipPath = Path()
        ..addRRect(
          RRect.fromRectAndRadius(expectedClipRect, const Radius.circular(2.0)),
        );
      expect(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        tester.widget<Material>(rawButtonMaterial).shape,
        const StadiumBorder(),
      );
    },
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final RawMaterialButton rawMaterialButton = tester.widget(
