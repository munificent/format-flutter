...
void main() {
  ...
  testWidgets('RadioListTile control tests', (WidgetTester tester) async {
    ...
    final Type radioType =
        const Radio<int>(value: 0, groupValue: 0, onChanged: null).runtimeType;
  ...
  testWidgets(
    'RadioListTile can autofocus unless disabled.',
    (WidgetTester tester) async {
  ...
  testWidgets('RadioListTile contentPadding test', (WidgetTester tester) async {
    ...
    final Rect tallerRect = radioRect.height > titleRect.height
        ? radioRect
        : titleRect;
    ...
    expect(
      paddingRect.top,
      tallerRect.top - extraHeight / 2 - 10,
    ); //top padding
    expect(
      paddingRect.bottom,
      tallerRect.bottom + extraHeight / 2 + 20,
    ); //bottom padding
  ...
  testWidgets(
    'RadioListTile respects visualDensity',
    (WidgetTester tester) async {
  ...
  testWidgets('Radio changes mouse cursor when hovered', (
    ...
    await tester.pumpWidget(wrap(
      child: MouseRegion(
        cursor: SystemMouseCursors.forbidden,
        child:
            RadioListTile<int>(value: 1, onChanged: (int? v) {}, groupValue: 2),
      ),
    ));
  ...
  group('feedback', () {
    ...
    testWidgets(
      'RadioListTile respects enableFeedback',
      (WidgetTester tester) async {
        const Key key = Key('test');
