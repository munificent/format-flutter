...
void main() {
  for (final MaterialType materialType in MaterialType.values) {
    ...
    group('Dial (${materialType.name})', () {
      ...
      testWidgets(
        'tap-select switches from hour to minute',
      ...
      testWidgets(
        'drag-select switches from hour to minute',
        (WidgetTester tester) async {
          late TimeOfDay result;
    ...
    group('Dial Haptic Feedback (${materialType.name})', () {
      ...
      testWidgets(
        'quick drag-select vibrates once',
        (WidgetTester tester) async {
          final Offset center = (await startPicker(
            tester,
            (TimeOfDay? time) {},
      ...
      testWidgets(
        'slow drag-select vibrates once',
        (WidgetTester tester) async {
          final Offset center = (await startPicker(
            tester,
            (TimeOfDay? time) {},
    ...
    group('Dialog (${materialType.name})', () {
      ...
      testWidgets(
        'Widgets have correct label capitalization',
        (WidgetTester tester) async {
          await startPicker(
            tester,
            (TimeOfDay? time) {},
      ...
      testWidgets(
        'Widgets have correct label capitalization in input mode',
        (WidgetTester tester) async {
          await startPicker(
            tester,
            (TimeOfDay? time) {},
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          // ignore: avoid_dynamic_calls
          expect(primaryLabels.map<String>(
            (dynamic tp) => tp.painter.text.text as String,
          ), labels12To11);
          ...
          // ignore: avoid_dynamic_calls
          expect(selectedLabels.map<String>(
            (dynamic tp) => tp.painter.text.text as String,
          ), labels12To11);
        },
      );
      ...
      switch (materialType) {
        case MaterialType.material2:
          ...
          testWidgets(
            ...
            (WidgetTester tester) async {
              ...
              final List<String> labels00To22 = List<String>.generate(
                12,
                (int index) {
        ...
        case MaterialType.material3:
          ...
          testWidgets('Dialog size - input mode', (WidgetTester tester) async {
            ...
            const EdgeInsets padding = EdgeInsets.all(24.0);
            final double height =
                timePickerMinInputSize.height * textScaleFactor +
                    padding.vertical;
            double width;
          ...
          testWidgets(
            ...
            (WidgetTester tester) async {
              ...
              final List<String> labels00To23 = List<String>.generate(
                24,
                (int index) {
                  return index == 0 ? '00' : index.toString();
                },
              );
              final List<bool> inner0To23 = List<bool>.generate(
                24,
                (int index) => index >= 12,
              );
              ...
              // ignore: avoid_dynamic_calls
              expect(
                primaryLabels.map<bool>((dynamic tp) => tp.inner as bool),
                inner0To23,
              );
              ...
              // ignore: avoid_dynamic_calls
              expect(
                selectedLabels.map<bool>((dynamic tp) => tp.inner as bool),
                inner0To23,
              );
            },
          );
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          RenderObject render = tester.renderObject(find.byWidgetPredicate(
          ...
          render = tester.renderObject(find.byWidgetPredicate(
            (Widget w) => '${w.runtimeType}' == '_DayPeriodInputPadding',
          ));
          expect(
            (render as dynamic).orientation,
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          final RenderObject render = tester.renderObject(find
              .byWidgetPredicate(
                (Widget w) => '${w.runtimeType}' == '_DayPeriodInputPadding',
              ));
          expect(
      ...
      testWidgets('OK Cancel button and helpText layout', (
        WidgetTester tester,
      ) async {
        Widget buildFrame(TextDirection textDirection) {
          return MaterialApp(
        ...
        switch (materialType) {
          ...
          case MaterialType.material3:
            ...
            expect(
              tester.getBottomRight(find.text(selectTimeString)),
              equals(const Offset(295.0, 149.0)),
            );
        ...
        switch (materialType) {
          ...
          case MaterialType.material3:
            expect(
              tester.getTopLeft(find.text(selectTimeString)),
              equals(const Offset(505.0, 129.0)),
            );
            expect(
              tester.getBottomRight(find.text(selectTimeString)),
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          expect(
            tester.getSize(find.text(amString)).height,
      ...
      group('showTimePicker avoids overlapping display features', () {
        testWidgets(
          ...
          (WidgetTester tester) async {
            ...
            expect(
              tester.getTopLeft(find.byType(TimePickerDialog)),
              const Offset(410, 0),
            );
            expect(
              tester.getBottomRight(find.byType(TimePickerDialog)),
      ...
      group('Works for various view sizes', () {
        for (final Size size in const <Size>[
          ...
          testWidgets(
            'Draws dial without overflows at $size',
            (WidgetTester tester) async {
          ...
          testWidgets(
            'Draws input without overflows at $size',
            (WidgetTester tester) async {
              tester.view.physicalSize = size;
              addTearDown(tester.view.reset);
    ...
    group('Time picker - A11y and Semantics (${materialType.name})', () {
      ...
      testWidgets(
        'provides semantics information for header and footer',
        (WidgetTester tester) async {
          final SemanticsTester semantics = SemanticsTester(tester);
          await mediaQueryBoilerplate(
            tester,
      ...
      testWidgets('can increment and decrement hours', (
        ...
        // ignore: avoid_dynamic_calls
        expect(
          pickerState.selectedTime.value,
      ...
      testWidgets(
        'can increment and decrement minutes',
        (WidgetTester tester) async {
          final SemanticsTester semantics = SemanticsTester(tester);
      ...
      testWidgets('header touch regions are large enough', (
        ...
        final Size dayPeriodControlSize = tester.getSize(find.byWidgetPredicate(
    ...
    group('Time picker - Input (${materialType.name})', () {
      ...
      testWidgets(
        'Help text is used in Material3 - Input',
        (WidgetTester tester) async {
          const String helpText = 'help';
          await mediaQueryBoilerplate(
            tester,
      ...
      testWidgets(
        'Can switch from input to dial entry mode',
        (WidgetTester tester) async {
          await mediaQueryBoilerplate(
            tester,
            alwaysUse24HourFormat: true,
      ...
      testWidgets(
        'Switching to input entry mode triggers entry callback',
        (WidgetTester tester) async {
          bool triggeredCallback = false;
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          final double hourFieldTop = tester.getTopLeft(find.byWidgetPredicate(
            (Widget w) => '${w.runtimeType}' == '_HourTextField',
          )).dy;
          final double minuteFieldTop = tester.getTopLeft(find
              .byWidgetPredicate(
                (Widget w) => '${w.runtimeType}' == '_MinuteTextField',
              )).dy;
          final double separatorTop = tester.getTopLeft(find.byWidgetPredicate(
