...
void main() {
  ...
  testWidgets(
    'DataTable overflow test - header with spaces',
    (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Material(
          child: DataTable(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(home: Material(child: buildTable(title: 'Name2'))),
      );
      await tester.pumpAndSettle();
      // The `tester.widget` ensures that there is exactly one upward arrow.
      transformOfArrow = tester.widget<Transform>(iconFinder);
  ...
  testWidgets('DataTable custom row height', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      home: Material(
        child: buildCustomTable(dataRowMinHeight: 30.0, dataRowMaxHeight: 30.0),
      ),
    ));
  ...
  testWidgets(
    'DataTable custom horizontal padding - checkbox',
    (WidgetTester tester) async {
  ...
  testWidgets('DataTable set border width test', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      home: Material(child: DataTable(columns: columns, rows: rows)),
    ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
...

      {
        ...
        final Finder nameCell = find.ancestor(
          of: find.text('Name'),
  ...
  testWidgets(
    'DataRow renders custom colors when pressed',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'DataTable can render inside an AlertDialog',
    (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Material(
          child: AlertDialog(
  ...
  testWidgets(
    'checkboxHorizontalMargin properly applied',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(() => createDataTable(), throwsA(predicate(
