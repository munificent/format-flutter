...
void main() {
  ...
  testWidgets('Passing no FilledButtonTheme returns defaults', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: Scaffold(body: Center(child: FilledButton(onPressed: () {}, child: const Text('button')))),
    ));
        ...
        home: Scaffold(
          body: Center(
            ...
            child: themeStyle == null
                ? child
                : FilledButtonTheme(data: FilledButtonThemeData(style: themeStyle), child: child),
          ),
        ),
      );
    }

    final Finder findMaterial = find.descendant(of: find.byType(FilledButton), matching: find.byType(Material));

    final Finder findInkWell = find.descendant(of: find.byType(FilledButton), matching: find.byType(InkWell));
  ...
  testWidgets('Theme shadowColor', (WidgetTester tester) async {
        ...
        home: Scaffold(
          body: Center(
            child: FilledButtonTheme(
              data: FilledButtonThemeData(style: FilledButton.styleFrom(shadowColor: themeShadowColor)),
              child: Builder(
                builder: (BuildContext context) {
                  return FilledButton(
    ...
    final Finder buttonMaterialFinder = find.descendant(of: find.byType(FilledButton), matching: find.byType(Material));
