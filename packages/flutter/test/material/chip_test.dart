...
RenderBox getMaterialBox(WidgetTester tester) {
  return tester.firstRenderObject<RenderBox>(find.descendant(
    ...
    child: Center(
      child: SizedBox(
        ...
        child: Chip(
          avatar: avatar,
          label:
              SizedBox(key: labelKey, width: labelWidth, height: labelHeight),
          onDeleted: onDeleted,
        ),
      ),
    ),
...
void main() {
  ...
  testWidgets(
    'Delete button takes up at most half of the chip',
    (WidgetTester tester) async {
  ...
  testWidgets('Chip uses ThemeData chip theme if present', (
    ...
    Widget buildChip(ChipThemeData data) {
      return wrapForChip(
        child: Theme(data: theme, child: const InputChip(label: Text('Label'))),
      );
    }

    await tester.pumpWidget(buildChip(chipTheme));

    final RenderBox materialBox = tester.firstRenderObject<RenderBox>(find
        .descendant(
          of: find.byType(RawChip),
          matching: find.byType(CustomPaint),
        ));
  ...
  group('Chip semantics', () {
    ...
    testWidgets('tapEnabled explicitly false', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        const MaterialApp(
          home:
              Material(child: RawChip(tapEnabled: false, label: Text('test'))),
        ),
      );
  ...
  testWidgets(
    'Chip elevation and shadow color work correctly',
    (WidgetTester tester) async {
      final ThemeData theme = ThemeData(
        useMaterial3: false,
        platform: TargetPlatform.android,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      // chip
      final Offset topRightOfInkwell = tester.getTopLeft(
        find.byType(InkWell).first,
      );
      final Offset tapLocationOfDeleteButton =
