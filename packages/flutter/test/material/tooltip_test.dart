...
void main() {
  testWidgetsWithLeakTracking(
     ...
     *********************/
      ...
      final Offset tipInGlobal = tip.localToGlobal(
        tip.size.topCenter(Offset.zero),
      );
  ...
  testWidgetsWithLeakTracking(
     ...
     *********************/
      ...
      expect(
        tip.localToGlobal(tip.size.topLeft(Offset.zero)).dy,
        equals(100.0),
      );
      expect(
        tip.localToGlobal(tip.size.bottomRight(Offset.zero)).dy,
        equals(200.0),
      );
    },
  );
  ...
  testWidgetsWithLeakTracking(
     ...
     *********************/
      ...
      expect(
        tip.localToGlobal(tip.size.bottomRight(Offset.zero)).dx,
        equals(790.0),
      );
      expect(
        tip.localToGlobal(tip.size.bottomRight(Offset.zero)).dy,
  ...
  testWidgetsWithLeakTracking(
    ...
    (WidgetTester tester) async {
      ...
      Offset tooltipTopRight = tip.localToGlobal(
        tip.size.topRight(Offset.zero),
      );
  ...
  testWidgetsWithLeakTracking(
    ...
    (WidgetTester tester) async {
      ...
      final Offset topLeftTooltipContentInGlobal = tester.getTopLeft(
        find.text(tooltipText),
      );
      expect(
        topLeftTooltipContentInGlobal.dx,
        topLeftTipInGlobal.dx + customMarginValue,
      );
      expect(
        topLeftTooltipContentInGlobal.dy,
      ...
      final Offset topRightTooltipContentInGlobal = tester.getTopRight(
        find.text(tooltipText),
      );
      expect(
        topRightTooltipContentInGlobal.dx,
        topRightTipInGlobal.dx - customMarginValue,
      );
      expect(
        topRightTooltipContentInGlobal.dy,
      ...
      final Offset bottomLeftTooltipContentInGlobal = tester.getBottomLeft(
        find.text(tooltipText),
      );
      expect(
        bottomLeftTooltipContentInGlobal.dx,
        bottomLeftTipInGlobal.dx + customMarginValue,
      );
      expect(
        bottomLeftTooltipContentInGlobal.dy,
      ...
      final Offset bottomRightTooltipContentInGlobal = tester.getBottomRight(
        find.text(tooltipText),
      );
      expect(
        bottomRightTooltipContentInGlobal.dx,
        bottomRightTipInGlobal.dx - customMarginValue,
      );
      expect(
        bottomRightTooltipContentInGlobal.dy,
    ...
    Future<void> pumpTooltipWithTextAlign({TextAlign? textAlign}) async {
      ...
      await tester.pumpWidget(MaterialApp(
        home: Tooltip(
          ...
          message: tooltipText,
          child:
              Container(width: 100.0, height: 100.0, color: Colors.green[500]),
        ),
      ));
      tooltipKey.currentState?.ensureTooltipVisible();
      await tester.pump(
  ...
  testWidgetsWithLeakTracking(
    'Tooltip overlay respects ambient Directionality',
    (WidgetTester tester) async {
      ...
      RenderParagraph tooltipRenderParagraph = tester
      ...
      await tester.longPress(find.byType(Tooltip));
      expect(find.text(tooltipText), findsOneWidget);
      tooltipRenderParagraph = tester.renderObject<RenderParagraph>(
        find.text(tooltipText),
      );
  ...
  testWidgetsWithLeakTracking(
    ...
    (WidgetTester tester) async {
      ...
      final RenderParagraph tooltipRenderParagraph = tester
          .renderObject<RenderParagraph>(find.text(tooltipText));
      expect(tooltipRenderParagraph.textSize.height, equals(12.0));

      final RenderBox tooltipRenderBox = tester.renderObject(
        _findTooltipContainer(tooltipText),
      );
  ...
  testWidgetsWithLeakTracking(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        const MaterialApp(home: Center(child: SizedBox.shrink())),
      );
  ...
  testWidgetsWithLeakTracking(
    ...
    (WidgetTester tester) async {
      ...
      tester.state<TooltipState>(
        find.byTooltip('message1'),
      ).ensureTooltipVisible();
      tester.state<TooltipState>(
        find.byTooltip('message2'),
      ).ensureTooltipVisible();
      await tester.pump();
      await tester.pump(waitDuration);
  ...
  testWidgetsWithLeakTracking(
    ...
    (WidgetTester tester) async {
      ...
      expect(find.text(tooltipText), findsOneWidget);
      expect(
        tester.getSize(find.text(tooltipText)),
        equals(const Size(42.0, 14.0)),
      );
      RenderBox tip = tester.renderObject(_findTooltipContainer(tooltipText));
      expect(tip.size.height, equals(32.0));
        ...
        MaterialApp(
          home: Tooltip(
            ...
            richMessage: const TextSpan(
              ...
              children: <InlineSpan>[
                TextSpan(text: 'I am another span of a rich tooltip.'),
              ],
            ),
            child: Container(
              width: 100.0,
  ...
  testWidgetsWithLeakTracking(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        const MaterialApp(
          home: Center(child: Tooltip(message: 'Foo', child: Text('Bar'))),
        ),
      );
  ...
  testWidgets(
    'dismissAllToolTips dismisses hovered tooltips',
    (WidgetTester tester) async {
      const Duration waitDuration = Duration.zero;
      final TestGesture gesture =
          await tester.createGesture(kind: PointerDeviceKind.mouse);
  ...
  testWidgetsWithLeakTracking(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(home: Tooltip(message: tooltipText)),
      );
      expect(find.text(tooltipText), findsNothing);
  ...
  testWidgetsWithLeakTracking(
    'Tooltip trigger mode ignores mouse events',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Tooltip(
  ...
  testWidgetsWithLeakTracking(
    'Tooltip does not block other mouse regions',
    (WidgetTester tester) async {
      bool entered = false;
  ...
  testWidgetsWithLeakTracking(
    'Does not rebuild on mouse connect/disconnect',
    (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
    'Mouse tap and hover over the Tooltip widget',
    (WidgetTester tester) async {
