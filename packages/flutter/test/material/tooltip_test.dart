...
void main() {
  ...
  testWidgetsWithLeakTracking('Tooltip should be fully visible when MediaQuery.viewInsets > 0', (
    WidgetTester tester,
  ) async {
    ...
    Widget materialAppWithViewInsets(double viewInsetsHeight) {
      final Widget scaffold = Scaffold(
        ...
        floatingActionButton:
            FloatingActionButton(tooltip: tooltipText, onPressed: () {/* do nothing */}, child: const Icon(Icons.add)),
      );
      return MediaQuery(
    ...
    Widget buildApp(String text, TextDirection textDirection) {
      return MaterialApp(
        home: Directionality(
          ...
          child: Center(
            child: Tooltip(message: text, child: Container(width: 100.0, height: 100.0, color: Colors.green[500])),
          ),
        ),
      );
    }
        ...
        child: Directionality(
          ...
          child: Overlay(
            initialEntries: <OverlayEntry>[
              OverlayEntry(
                builder: (BuildContext context) {
                  return Tooltip(key: tooltipKey, message: tooltipText, child: const SizedBox.shrink());
                },
              ),
            ],
          ),
  ...
  testWidgetsWithLeakTracking('Dispatch the mouse events before tip overlay detached', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      const MaterialApp(
        home: Center(
          child:
              Tooltip(message: tooltipText, waitDuration: waitDuration, child: SizedBox(width: 100.0, height: 100.0)),
        ),
      ),
    );
  ...
  testWidgetsWithLeakTracking(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        const MaterialApp(
          home: Center(child: Tooltip(message: tooltipText, child: SizedBox(width: 100.0, height: 100.0))),
        ),
      );
  ...
  testWidgetsWithLeakTracking('Tooltip text is also hoverable', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      const MaterialApp(
        home: Center(child: Tooltip(message: tooltipText, waitDuration: waitDuration, child: Text('I am tool tip'))),
      ),
    );
        ...
        home: Center(
          child: Tooltip(
            ...
            child: Container(
              ...
              child: Tooltip(message: 'Inner', child: SizedBox(key: innerKey, width: 25, height: 100)),
            ),
          ),
        ),
      ));
  ...
  testWidgetsWithLeakTracking('Does tooltip contribute semantics', (WidgetTester tester) async {
    ...
    final TestSemantics expected = TestSemantics.root(
      children: <TestSemantics>[TestSemantics.rootChild(id: 1, tooltip: 'TIP', textDirection: TextDirection.ltr)],
    );
  ...
  testWidgetsWithLeakTracking('Tooltip text displays with richMessage', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      home: Tooltip(
        key: tooltipKey,
        richMessage: const TextSpan(text: textSpan1Text, children: <InlineSpan>[TextSpan(text: textSpan2Text)]),
        child: Container(width: 100.0, height: 100.0, color: Colors.green[500]),
      ),
    ));
    tooltipKey.currentState?.ensureTooltipVisible();
  ...
  testWidgetsWithLeakTracking('Semantics included', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(const MaterialApp(home: Center(child: Tooltip(message: 'Foo', child: Text('Bar')))));
  ...
  testWidgetsWithLeakTracking('Semantics excluded', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      const MaterialApp(home: Center(child: Tooltip(message: 'Foo', excludeFromSemantics: true, child: Text('Bar')))),
    );
  ...
  testWidgetsWithLeakTracking('has semantic events', (WidgetTester tester) async {
    ...
    expect(semanticEvents, unorderedEquals(<dynamic>[
      <String, dynamic>{'type': 'longPress', 'nodeId': _findDebugSemantics(object).id, 'data': <String, dynamic>{}},
      <String, dynamic>{
        'type': 'tooltip',
  ...
  testWidgetsWithLeakTracking('default Tooltip debugFillProperties with richMessage', (WidgetTester tester) async {
    ...
    const Tooltip(richMessage: TextSpan(text: 'This is a ', children: <InlineSpan>[TextSpan(text: 'richMessage')]))
  ...
  testWidgetsWithLeakTracking(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(const MaterialApp(home: Tooltip(message: tooltipText, child: Text(tooltipText))));
      expect(find.text(tooltipText), findsOneWidget);
    },
  );
  ...
  testWidgetsWithLeakTracking('Tooltip trigger mode ignores mouse events', (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Tooltip(message: tooltipText, triggerMode: TooltipTriggerMode.longPress, child: SizedBox.expand()),
      ),
    );

    final TestGesture mouseGesture =
        await tester.startGesture(tester.getCenter(find.byTooltip(tooltipText)), kind: PointerDeviceKind.mouse);
  ...
  testWidgetsWithLeakTracking('Hold mouse button down and hover over the Tooltip widget', (WidgetTester tester) async {
    ...
    await tester.pump(const Duration(seconds: 1));
    await tester.pumpAndSettle();
    expect(find.text(tooltipText), findsNothing, reason: 'Tooltip should be dismissed with no hovering mouse cursor.');
  });
