...
void main() {
  ...
  testWidgets('Dialog is scrollable', (WidgetTester tester) async {
    ...
    final AlertDialog dialog = AlertDialog(
      content:
          Container(height: 5000.0, width: 300.0, color: Colors.green[500]),
      actions: <Widget>[
        TextButton(
          onPressed: () {
            didPressOk = true;
  ...
  testWidgets(
    'Dialog background color from AlertDialog',
  ...
  testWidgets(
    'Dialog hides underlying semantics tree',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'AlertDialog.actionsPadding defaults',
    (WidgetTester tester) async {
      final AlertDialog dialog = AlertDialog(
        title: const Text('title'),
  ...
  testWidgets('AlertDialog.buttonPadding defaults', (
    WidgetTester tester,
  ) async {
  ...
  group('Dialog children padding is correct', () {
    ...
    final Finder dialogFinder = find.descendant(
    ...
    void expectLeftEdgePadding(
      ...
      expect(tester.getTopLeft(dialogFinder).dx, moreOrLessEquals(
        tester.getTopLeft(finder).dx -
            unscaledValue * paddingScaleFactors[textScaleFactor]!,
      ));
      expect(tester.getBottomLeft(dialogFinder).dx, moreOrLessEquals(
    ...
    void expectRightEdgePadding(
      ...
      expect(tester.getTopRight(dialogFinder).dx, moreOrLessEquals(
        tester.getTopRight(finder).dx +
            unscaledValue * paddingScaleFactors[textScaleFactor]!,
      ));
      expect(tester.getBottomRight(dialogFinder).dx, moreOrLessEquals(
    ...
    void expectTopEdgePadding(
      ...
      expect(tester.getTopLeft(dialogFinder).dy, moreOrLessEquals(
        tester.getTopLeft(finder).dy -
            unscaledValue * paddingScaleFactors[textScaleFactor]!,
      ));
      expect(tester.getTopRight(dialogFinder).dy, moreOrLessEquals(
    ...
    void expectBottomEdgePadding(
      ...
      expect(tester.getBottomLeft(dialogFinder).dy, moreOrLessEquals(
        tester.getBottomRight(finder).dy +
            unscaledValue * paddingScaleFactors[textScaleFactor]!,
      ));
      expect(tester.getBottomRight(dialogFinder).dy, moreOrLessEquals(
        tester.getBottomRight(finder).dy +
            unscaledValue * paddingScaleFactors[textScaleFactor]!,
      ));
    }
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        const MediaQuery(
          data: MediaQueryData(),
          child: Dialog(insetPadding: null, child: Placeholder()),
        ),
      );
      await tester.pumpAndSettle();
  ...
  testWidgets(
    'SimpleDialog does not introduce additional node',
    (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgets(
    'Uses open focus traversal when overridden',
    (WidgetTester tester) async {
      final FocusNode okNode = FocusNode();
      final FocusNode cancelNode = FocusNode();
