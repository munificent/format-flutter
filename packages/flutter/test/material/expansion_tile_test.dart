...
void main() {
  ...
  testWidgets('ExpansionTile maintainState', (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
      theme:
          ThemeData(platform: TargetPlatform.iOS, dividerColor: dividerColor),
      home: const Material(
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
  ...
  testWidgets(
    'ExpansionTile expandedAlignment test',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Material(
  ...
  testWidgets(
    'ExpansionTile expandedCrossAxisAlignment test',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      ShapeDecoration shapeDecoration = tester.firstWidget<Container>(find
          .descendant(
