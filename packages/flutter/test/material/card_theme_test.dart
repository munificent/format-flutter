...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(theme: theme, home: const Scaffold(body: Card())),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(theme: themeData, home: const Scaffold(body: Card())),
      );
  ...
  testWidgets(
    'ThemeData properties are used when no CardTheme is set',
    (WidgetTester tester) async {
      ...
      expect(
        material.color,
        material3 ? themeData.colorScheme.surface : themeData.cardColor,
      );
    },
  );
...
Container _getCardContainer(WidgetTester tester) {
  return tester.widget<Container>(
    find.descendant(of: find.byType(Card), matching: find.byType(Container)),
  );
}
