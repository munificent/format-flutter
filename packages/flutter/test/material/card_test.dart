...
void main() {
  ...
  testWidgets('Card merges children when it is a semanticContainer', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      const Directionality(
        textDirection: TextDirection.ltr,
        child: Material(
          child: Center(child: Card(child: Column(children: <Widget>[Text('First child'), Text('Second child')]))),
        ),
      ),
    );
  ...
  testWidgets('Card margin', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Container(
      ...
      child: Card(child: Container(key: contentsKey, color: const Color(0xFF00FF00), width: 100.0, height: 100.0)),
    ));
    ...
    await tester.pumpWidget(Container(
      ...
      child: Card(
        ...
        child: Container(key: contentsKey, color: const Color(0xFF00FF00), width: 100.0, height: 100.0),
      ),
    ));
  ...
  testWidgets('Card clipBehavior property defers to theme when null', (WidgetTester tester) async {
    await tester.pumpWidget(Builder(
      builder: (BuildContext context) {
        ...
        return Theme(
          data: themeData.copyWith(cardTheme: themeData.cardTheme.copyWith(clipBehavior: Clip.antiAliasWithSaveLayer)),
          child: const Card(),
        );
      },
    ));
