...
void main() {
  testWidgets('ListTile geometry (LTR)', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      buildFrame(isThreeLine: true, textScaleFactor: 4.0),
    );
    testChildren();
    testHorizontalGeometry();
    testVerticalGeometry(hasIssue99933 ? 193 : 192.0);
  ...
  testWidgets(
    'ListTile.divideTiles with empty list',
  ...
  testWidgets(
    'ListTile.divideTiles with single item list',
    (WidgetTester tester) async {
      final Iterable<Widget> output = ListTile.divideTiles(
  ...
  testWidgets('ListTile contentPadding', (WidgetTester tester) async {
    ...
    expect(
      tester.getSize(find.byType(ListTile)),
      const Size(800.0, 126.0),
    ); // 126 = 56 + 30 + 40
  ...
  testWidgets('ListTile wide leading Widget', (WidgetTester tester) async {
    ...
    expect(
      tester.getBottomRight(find.byKey(leadingKey)),
    ...
    expect(tester.getSize(find.byType(ListTile)), const Size(800.0, 72.0));
    expect(
      tester.getTopRight(find.byKey(leadingKey)),
      const Offset(800.0, 20.0),
    );
    expect(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      const SizedBox oversizedWidget = SizedBox(
        height: 80.0,
        width: 24.0,
        child: Placeholder(),
      );
  ...
  testWidgets(
    'ListTile only accepts focus when enabled',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'ListTile can autofocus unless disabled.',
    (WidgetTester tester) async {
      final GlobalKey childKey = GlobalKey();
  ...
  testWidgets(
    'ListTile shape is painted correctly',
    (WidgetTester tester) async {
      ...
      Widget buildListTile(ShapeBorder shape) {
        return MaterialApp(
          home: Material(
            child: Center(child: ListTile(shape: shape, tileColor: tileColor)),
          ),
        );
      }
  ...
  group('feedback', () {
    ...
    testWidgets('ListTile with enabled feedback by default', (
      ...
      await tester.pumpWidget(MaterialApp(
        home:
            Material(child: ListTile(title: const Text('Title'), onTap: () {})),
      ));
  ...
  testWidgets('ListTile horizontalTitleGap = 0.0', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(buildFrame(
      TextDirection.ltr,
      themeHorizontalTitleGap: 10,
      widgetHorizontalTitleGap: 0,
    ));
    expect(tester.getSize(find.byType(ListTile)), const Size(800.0, 56.0));
    expect(left('title'), 40.0);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(buildFrame(
        TextDirection.ltr,
        themeMinVerticalPadding: 0,
        widgetMinVerticalPadding: 80,
      ));
      expect(tester.getSize(find.byType(ListTile)), const Size(800.0, 184.0));
  ...
  testWidgets('ListTile minLeadingWidth = 60.0', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      buildFrame(TextDirection.ltr, widgetMinLeadingWidth: 60),
    );
    expect(tester.getSize(find.byType(ListTile)), const Size(800.0, 56.0));
    ...
    await tester.pumpWidget(
      buildFrame(TextDirection.ltr, themeMinLeadingWidth: 60),
    );
    expect(tester.getSize(find.byType(ListTile)), const Size(800.0, 56.0));
    expect(left('title'), 92.0);
    ...
    await tester.pumpWidget(buildFrame(
      TextDirection.ltr,
      themeMinLeadingWidth: 0,
      widgetMinLeadingWidth: 60,
    ));
    expect(tester.getSize(find.byType(ListTile)), const Size(800.0, 56.0));
    expect(left('title'), 92.0);

    await tester.pumpWidget(
      buildFrame(TextDirection.rtl, widgetMinLeadingWidth: 60),
    );
    expect(tester.getSize(find.byType(ListTile)), const Size(800.0, 56.0));
    ...
    await tester.pumpWidget(
      buildFrame(TextDirection.rtl, themeMinLeadingWidth: 60),
    );
    expect(tester.getSize(find.byType(ListTile)), const Size(800.0, 56.0));
    expect(right('title'), 708.0);
  ...
  testWidgets(
    'selected, enabled ListTile default icon color',
    (WidgetTester tester) async {
      final ThemeData theme = ThemeData(useMaterial3: true);
  ...
  testWidgets(
    'ListTile.textColor respects MaterialStateColor',
    (WidgetTester tester) async {
      bool enabled = false;
      bool selected = false;
  ...
  testWidgets(
    'ListTile.iconColor respects MaterialStateColor',
    (WidgetTester tester) async {
      bool enabled = false;
      bool selected = false;
      const Color defaultColor = Colors.blue;
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
        ...
        return MaterialApp(
          theme: ThemeData(
            ...
            iconButtonTheme: IconButtonThemeData(
              style:
                  IconButton.styleFrom(foregroundColor: iconButtonThemeColor),
            ),
          ),
          home: Material(
            child: Center(
      ...
      expect(
        getIconStyle(tester, trailingIcon.icon!)?.color,
        listTileIconColor,
      );
    },
  );
  ...
  testWidgets(
    'ListTile.dense does not throw assertion',
    (WidgetTester tester) async {
  ...
  group('Material 2', () {
    ...
    testWidgets('ListTile geometry (LTR)', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        buildFrame(isTwoLine: true, textScaleFactor: 4.0),
      );
      testChildren();
      testHorizontalGeometry();
    ...
    testWidgets('ListTile font size', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        buildFrame(dense: true, style: ListTileStyle.drawer),
      );
      await tester.pumpAndSettle();
      leading = _getTextRenderObject(tester, 'leading');
      expect(leading.text.style!.fontSize, 14.0);
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          buildFrame(brightness: Brightness.light, selected: true),
        );
        ...
        await tester.pumpWidget(
          buildFrame(brightness: Brightness.dark, selected: true),
        );
        ...
        await tester.pumpWidget(
          buildFrame(brightness: Brightness.dark, selected: false),
        );
    ...
    testWidgets(
      'titleAlignment position with title widget',
      (WidgetTester tester) async {
        final Key leadingKey = GlobalKey();
        final Key trailingKey = GlobalKey();
        const double leadingHeight = 24.0;
