...
void main() {
  ...
  testWidgets('Chip uses ThemeData chip theme', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      theme:
          ThemeData.light(useMaterial3: false).copyWith(chipTheme: chipTheme),
      home: Directionality(
  ...
  testWidgets('ChipThemeData generates correct opacities for defaults', (
    ...
    final TextStyle customStyle = ThemeData.fallback()
        .textTheme
        .bodyLarge!
  ...
  testWidgets('ChipThemeData lerps correctly', (WidgetTester tester) async {
    ...
    expect(
      ...
      equals(Colors.white.withAlpha(0x40)),
    );
    ...
    expect(
      ...
      equals(Colors.white.withAlpha(0xbf)),
    );
    ...
    expect(
      ...
      equals(Colors.black.withAlpha(0xbf)),
    );
    ...
    expect(
      ...
      equals(Colors.black.withAlpha(0x40)),
    );
  ...
  testWidgets(
    'Chip uses stateful border side from chip theme',
    (WidgetTester tester) async {
      const Color selectedColor = Color(0x00000001);
      const Color defaultColor = Color(0x00000002);
  ...
  testWidgets(
    'Chip uses stateful shape from chip theme',
    (WidgetTester tester) async {
