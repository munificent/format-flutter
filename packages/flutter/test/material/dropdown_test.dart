...
void checkSelectedItemTextGeometry(WidgetTester tester, String value) {
  final List<RenderBox> boxes = tester.renderObjectList<RenderBox>(
    find.byKey(ValueKey<String>('${value}Text')),
  ).toList();
  expect(boxes.length, equals(2));
  final RenderBox box0 = boxes[0];
  final RenderBox box1 = boxes[1];
  expect(
    box0.localToGlobal(Offset.zero),
    equals(box1.localToGlobal(Offset.zero)),
  );
...
Future<void> checkDropdownColor(
  ...
  expect(
    find
        .ancestor(of: find.text(text).last, matching: find.byType(CustomPaint))
        .at(2),
    paints
      ..save()
      ..rrect()
...
void main() {
  ...
  testWidgets('Dropdown button control test', (WidgetTester tester) async {
    ...
    await tester.tap(
      find.text('three', skipOffstage: false),
      warnIfMissed: false,
    );
    await tester.pump();
    await tester.pump(const Duration(seconds: 1)); // finish the menu animation
  ...
  testWidgets(
    'DropdownButton does not allow duplicate item values',
  ...
  testWidgets('Dropdown form field uses form field state', (
          ...
          home: Material(
            child: Form(
              ...
              child: DropdownButtonFormField<String>(
                ...
                decoration:
                    const InputDecoration(prefixIcon: Icon(Icons.fastfood)),
    ...
    expect(getIndex(), 4);
    await tester.tap(
      find.text('Select Value', skipOffstage: false),
      warnIfMissed: false,
    );
  ...
  testWidgets(
    'Dropdown menu can position correctly inside a nested navigator',
    (WidgetTester tester) async {
      ...
      await tester.pump();
      final RenderBox secondItem = tester.renderObjectList<RenderBox>(
  ...
  testWidgets('Dropdown screen edges', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      home:
          Material(child: Align(alignment: Alignment.topCenter, child: button)),
    ));
    ...
    // button itself.
    expect(
      tester.elementList(find.text('5', skipOffstage: false)),
      hasLength(2),
    );

    expect(value, 4);
    await tester.tap(
      find.byWidget(button, skipOffstage: false),
      warnIfMissed: false,
    );
    expect(value, 4);
  ...
  testWidgets(
    'Arrow icon aligns with the edge of button when expanded',
    (WidgetTester tester) async {
      final Key buttonKey = UniqueKey();
    ...
    (WidgetTester tester) async {
      final Widget customWidget = Container(
        decoration: ShapeDecoration(
          shape: CircleBorder(
            side: BorderSide(width: 5.0, color: Colors.grey.shade700),
          ),
        ),
      );

      await tester.pumpWidget(
        buildFrame(icon: customWidget, onChanged: onChanged),
      );
      ...
      await tester.pumpWidget(
        buildFrame(icon: const Icon(Icons.assessment), onChanged: onChanged),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        buildFrame(icon: customIcon, onChanged: onChanged),
      );
  ...
  testWidgets('Dropdown menu scrolls to first item in long lists', (
    ...
    final RenderBox menuItemContainer = tester.renderObject<RenderBox>(
      menuItemFinder,
    );
    ...
    expect(
      ...
      equals(
        menuItemContainer.size.topCenter(
          menuItemContainer.localToGlobal(Offset.zero),
        ).dy,
      ),
    );
  });
  ...
  testWidgets(
    'Dropdown menu aligns selected item with button in long lists',
    (WidgetTester tester) async {
      // Open the dropdown menu
      final Key buttonKey = UniqueKey();
      await tester.pumpWidget(buildFrame(
      ...
      final RenderBox selectedItem = tester.renderObject<RenderBox>(find
          .descendant(
  ...
  testWidgets('Dropdown menu scrolls to last item in long lists', (
    ...
    final Offset menuItemContainerOffset = menuItemContainer.localToGlobal(
      menuPaddingOffset,
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(build());
      final RenderBox buttonBoxNullValue = tester.renderObject<RenderBox>(
        find.byKey(buttonKey),
      );
  ...
  testWidgets(
    'Size of DropdownButton with no items',
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(build());
      final RenderBox buttonBoxNullItems = tester.renderObject<RenderBox>(
        find.byKey(buttonKey),
      );
      ...
      items = <String>[];
      await tester.pumpWidget(build());
      final RenderBox buttonBoxEmptyItems = tester.renderObject<RenderBox>(
        find.byKey(buttonKey),
      );
  ...
  testWidgets('Layout of a DropdownButton with null value', (
    ...
    await tester.tap(
      find.byKey(buttonKey, skipOffstage: false),
      warnIfMissed: false,
    );
    await tester.pump();
    await tester.pump(const Duration(seconds: 1)); // finish the menu animation
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final RenderBox buttonBoxHintValue = tester.renderObject<RenderBox>(
        find.byKey(buttonKey),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      Rect getMenuRect() {
        late Rect menuRect;
        tester.element(find.byType(ListView)).visitAncestorElements(
          (Element element) {
      ...
      const EdgeInsets buttonPadding = EdgeInsets.only(
        top: 8.0,
        left: 16.0,
        right: 24.0,
      );
      ...
      Future<void> popUpAndDown(Widget frame) async {
        ...
        await tester.tap(
          find.byType(dropdownButtonType, skipOffstage: false),
          warnIfMissed: false,
        );
      }
  ...
  testWidgets('Dropdown menu includes semantics', (WidgetTester tester) async {
    ...
    const Key key = Key('test');
    await tester.pumpWidget(
      buildFrame(buttonKey: key, value: null, onChanged: onChanged),
    );
  ...
  testWidgets(
    'disabledHint displays on empty items or onChanged',
    (WidgetTester tester) async {
      final Key buttonKey = UniqueKey();
  ...
  testWidgets('disabledHint behavior test', (WidgetTester tester) async {
    ...
    expect(
      tester.getCenter(find.text('disabledHint')).dy,
      tester.getCenter(find.byType(Icon)).dy,
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(buildFrame(
        ...
        // [hint] widget is smaller than largest selected item widget
        disabledHint:
            const SizedBox(height: 50, width: 50, child: Text('hint')),
        items: items,
        itemHeight: null,
        selectedItemBuilder: (BuildContext context) {
          return items.map<Widget>((String item) {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(buildFrame(
        ...
        // [hint] widget is larger than largest selected item widget
        disabledHint:
            const SizedBox(height: 125, width: 125, child: Text('hint')),
        items: items,
        itemHeight: null,
        selectedItemBuilder: (BuildContext context) {
          return items.map<Widget>((String item) {
  ...
  testWidgets(
    'Dropdown in middle showing middle item',
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(home: Material(child: Align(child: button))),
      );
  ...
  testWidgets(
    'Dropdown in bottom showing top item',
    (WidgetTester tester) async {
      final List<DropdownMenuItem<int>> items =
          List<DropdownMenuItem<int>>.generate(
        100,
  ...
  testWidgets(
    'Dropdown in center showing bottom item',
    (WidgetTester tester) async {
      final List<DropdownMenuItem<int>> items =
          List<DropdownMenuItem<int>>.generate(
        100,
  ...
  testWidgets('Dropdown button will accept widgets as its underline', (
    ...
    final Widget customUnderline = Container(
      height: 4.0,
    ...
    expect(
      tester.widgetList<DecoratedBox>(decoratedBox).last.decoration,
      decoration,
    );

    await tester.pumpWidget(
      buildFrame(buttonKey: buttonKey, onChanged: onChanged),
    );
    expect(
      tester.widgetList<DecoratedBox>(decoratedBox).last.decoration,
      defaultDecoration,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.tap(
        find.text('Please select an item', skipOffstage: false),
        warnIfMissed: false,
      );
      await tester.pumpAndSettle();
  ...
  testWidgets('Variable size and oversized menu items', (
    ...
    final Finder item30 = find.byKey(
      const ValueKey<double>(30),
      skipOffstage: false,
    );
    final Finder item40 = find.byKey(
      const ValueKey<double>(40),
      skipOffstage: false,
    );
    final Finder item50 = find.byKey(
      const ValueKey<double>(50),
      skipOffstage: false,
    );
    final Finder item60 = find.byKey(
      const ValueKey<double>(60),
      skipOffstage: false,
    );
  ...
  testWidgets('DropdownButton hint is selected item', (
                ...
                child: StatefulBuilder(
                  builder: (BuildContext context, StateSetter setState) {
                    ...
                    return DropdownButton<String>(
                      ...
                      icon: Container(),
                      items: itemValues.map<DropdownMenuItem<String>>(
                        (String value) {
                          return DropdownMenuItem<String>(
                            value: value,
                            child: Text(value),
    ...
    // Show the popup menu.
    await tester.tap(
      find.text('-item0-', skipOffstage: false),
      warnIfMissed: false,
    );
    await tester.pumpAndSettle();
  ...
  testWidgets('DropdownButtonFormField can be focused, and has focusColor', (
    ...
    final FocusNode focusNode = FocusNode(
      debugLabel: 'DropdownButtonFormField',
    );
    await tester.pumpWidget(buildFrame(
      isFormField: true,
      buttonKey: buttonKey,
  ...
  testWidgets(
    'Selected element is focused when dropdown is opened',
    (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode(debugLabel: 'DropdownButton');
      String? value = 'one';
      await tester.pumpWidget(MaterialApp(
      ...
      await tester.pump(
        const Duration(seconds: 1),
      ); // finish the menu open animation
      expect(value, equals('one'));
      expect(
      ...
      ); // Select 'two' and close the dropdown.

      await tester.pump();
      await tester.pump(
        const Duration(seconds: 1),
      ); // finish the menu close animation
      ...
      final Element element = tester.element(
        find.byKey(const ValueKey<String>('two')).last,
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode(debugLabel: 'DropdownButton');
      int? value = 1;
      final List<int> hugeMenuItems = List<int>.generate(
        50,
        (int index) => index,
      );
      ...
      await tester.sendKeyEvent(
        LogicalKeyboardKey.enter,
      ); // Select '42' and close the dropdown.
      await tester.pumpAndSettle(
        const Duration(seconds: 1),
      ); // Finish the menu close animation
      ...
      expect(value, equals(42));
      final Element element = tester.element(
        find.byKey(const ValueKey<int>(42)).last,
      );
      final FocusNode node = Focus.of(element);
      expect(node.hasFocus, isTrue);
    },
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      // Tap dropdown button again.
      await tester.tap(
        find.text('two', skipOffstage: false),
        warnIfMissed: false,
      );
      await tester.pumpAndSettle();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      scrollController = PrimaryScrollController.of(
        tester.element(find.byType(ListView)),
      );
  ...
  testWidgets(
    'menu position test with `menuMaxHeight`',
    (WidgetTester tester) async {
      final Key buttonKey = UniqueKey();
      await tester.pumpWidget(buildFrame(
        buttonKey: buttonKey,
  ...
  testWidgets('Disabled item should not be focusable', (
    ...
    final Element disabledItem = tester.element(
      find.text('disabled').hitTestable(),
    );
    expect(
  ...
  testWidgets('alignment test', (WidgetTester tester) async {
    ...
    expect(
      ...
      selectedItemBox.localToGlobal(
        Offset(0.0, selectedItemBox.size.height / 2.0),
      ),
    );
    ...
    expect(
      buttonBox.localToGlobal(Offset(
        (buttonBox.size.width - 24.0) / 2.0,
        buttonBox.size.height / 2.0,
      )),
  ...
  group('feedback', () {
    ...
    testWidgets('Dropdown with enabled feedback', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        feedbackBoilerplate(enableFeedback: enableFeedback),
      );
    ...
    testWidgets(
      'Dropdown with enabled feedback by default',
      (WidgetTester tester) async {
  ...
  testWidgets('borderRadius property works properly', (
    ...
    expect(
      ...
      paints
        ...
        ..rrect()
        ..rrect(
          rrect: const RRect.fromLTRBXY(0.0, 0.0, 144.0, 208.0, radius, radius),
        ),
    );
  });
  ...
  testWidgets('DropdownButton hint alignment', (WidgetTester tester) async {
    ...
    expect(
      tester.getTopLeft(find.text(hintText, skipOffstage: false)).dx,
      348.0,
    );
    expect(
      tester.getTopLeft(find.text(hintText, skipOffstage: false)).dy,
      292.0,
    );
    ...
    expect(
      tester.getBottomLeft(find.text(hintText, skipOffstage: false)).dx,
      348.0,
    );
    expect(
      tester.getBottomLeft(find.text(hintText, skipOffstage: false)).dy,
      350.0,
    );
    ...
    expect(
      tester.getCenter(find.text(hintText, skipOffstage: false)).dx,
      388.0,
    );
    expect(
      tester.getCenter(find.text(hintText, skipOffstage: false)).dy,
      300.0,
    );
    ...
    expect(
      tester.getTopRight(find.text(hintText, skipOffstage: false)).dx,
      428.0,
    );
    expect(
      tester.getTopRight(find.text(hintText, skipOffstage: false)).dy,
      250.0,
    );
    ...
    expect(
      tester.getBottomRight(find.text(hintText, skipOffstage: false)).dx,
      776.0,
    );
    expect(
      tester.getBottomRight(find.text(hintText, skipOffstage: false)).dy,
      350.0,
    );
  });
  ...
  testWidgets(
    'Size of DropdownButton with padding',
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(build());
      final RenderBox buttonBoxNoPadding = tester.renderObject<RenderBox>(
        find.byKey(buttonKey),
      );
      ...
      await tester.pumpWidget(build());
      final RenderBox buttonBoxPadded = tester.renderObject<RenderBox>(
        find.byKey(buttonKey),
      );
