...
void main() {
  ...
  testWidgets(
    'Do not rebuild page during a route transition',
  ...
  testWidgets(
    'Do rebuild the home page if it changes',
    (WidgetTester tester) async {
      int buildCounter = 0;
      await tester.pumpWidget(MaterialApp(
        home: Builder(
  ...
  testWidgets(
    'MaterialApp theme animation can be turned off',
    (WidgetTester tester) async {
      final ThemeData lightTheme = ThemeData.light();
      final ThemeData darkTheme = ThemeData.dark();
  ...
  testWidgets('MaterialApp provides default overscroll color', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    'MaterialApp.navigatorKey can be updated',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'A ScrollBehavior can be set for MaterialApp',
    (WidgetTester tester) async {
      late BuildContext capturedContext;
      await tester.pumpWidget(MaterialApp(
  ...
  testWidgets(
    'ScrollBehavior stretch android overscroll indicator via useMaterial3 flag',
    (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
