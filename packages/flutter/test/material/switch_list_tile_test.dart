...
void main() {
  ...
  testWidgets('SwitchListTile contentPadding', (WidgetTester tester) async {
    ...
    expect(
      tester.getTopLeft(find.byType(Switch)).dx,
      20.0,
    ); // contentPadding.end = 20
    expect(
      tester.getTopRight(find.text('L')).dx,
      790.0,
    ); // 800 - contentPadding.start
  });

  testWidgets(
    'SwitchListTile can autofocus unless disabled.',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'SwitchListTile selected item text Color',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'SwitchListTile respects visualDensity',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      final FocusNode node = FocusNode(
        debugLabel: 'SwitchListTile onFocusChange',
      );
      bool gotFocus = false;
      await tester.pumpWidget(MaterialApp(
        home: Material(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      final FocusNode node = FocusNode(
        debugLabel: 'SwitchListTile.adaptive onFocusChange',
      );
      bool gotFocus = false;
      await tester.pumpWidget(MaterialApp(
        home: Material(
  ...
  group('feedback', () {
    ...
    testWidgets(
      'SwitchListTile respects enableFeedback',
      (WidgetTester tester) async {
  ...
  testWidgets('SwitchListTile respects thumbColor in active/enabled states', (
    WidgetTester tester,
  ) async {
    ...
    await tester.pumpWidget(
      buildSwitchListTile(enabled: false, selected: false),
    );
    await tester.pumpAndSettle();
    expect(
      Material.of(tester.element(find.byType(Switch))),
    ...
    await tester.pumpWidget(
      buildSwitchListTile(enabled: false, selected: true),
    );
    await tester.pumpAndSettle();
    expect(
      Material.of(tester.element(find.byType(Switch))),
    ...
    await tester.pumpWidget(
      buildSwitchListTile(enabled: true, selected: false),
    );
    await tester.pumpAndSettle();
  ...
  testWidgets(
    'SwitchListTile respects thumbColor in hovered/pressed states',
    (WidgetTester tester) async {
  ...
  testWidgets('SwitchListTile respects thumbIcon - M3', (
    ...
    expect(switchWidget0.thumbIcon
        ?.resolve(<MaterialState>{MaterialState.selected}), activeIcon);
    expect(
      Material.of(tester.element(find.byType(Switch))),
      paints
        ..rrect()
    ...
    expect(switchWidget2.thumbIcon
        ?.resolve(<MaterialState>{MaterialState.selected}), activeIcon);
    expect(
      Material.of(tester.element(find.byType(Switch))),
      paints
  ...
  testWidgets('SwitchListTile respects materialTapTargetSize', (
    WidgetTester tester,
  ) async {
    final ThemeData theme = ThemeData();
    final bool material3 = theme.useMaterial3;
    ...
    await tester.pumpWidget(
      buildSwitchListTile(MaterialTapTargetSize.shrinkWrap),
    );
    final Switch switchWidget1 = tester.widget<Switch>(find.byType(Switch));
    expect(
      switchWidget1.materialTapTargetSize,
  ...
  testWidgets(
    'SwitchListTile.adaptive respects applyCupertinoTheme',
    (WidgetTester tester) async {
      final ThemeData theme = ThemeData();
      Widget buildSwitchListTile(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        buildSwitchListTile(enabled: true, selected: true),
      );
      await tester.pumpAndSettle();
      ...
      expect(
        ...
        paints
          ..rrect(style: PaintingStyle.fill)
          ..rrect(
            color: activeEnabledTrackOutlineColor,
            style: PaintingStyle.stroke,
          ),
      );
    },
