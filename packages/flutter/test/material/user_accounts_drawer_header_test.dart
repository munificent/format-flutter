...
void main() {
  ...
  testWidgets('UserAccountsDrawerHeader test', (WidgetTester tester) async {
    ...
    expect(
      avatarATopLeft.dy - topLeft.dy,
      equals(16.0 + 20.0),
    ); // add top padding
    expect(
      topRight.dx - avatarDTopRight.dx,
      equals(16.0 + 30.0),
    ); // right padding
    expect(
      avatarDTopRight.dy - topRight.dy,
      equals(16.0 + 20.0),
    ); // add top padding
    expect(
      avatarDTopRight.dx - avatarCTopRight.dx,
      equals(40.0 + 16.0),
    ); // size + space between
  });
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final RenderBox currentAccountRenderBox = tester.renderObject(
        find.byKey(avatarA),
      );
      final RenderBox otherAccountRenderBox = tester.renderObject(
        find.byKey(avatarC),
      );
  ...
  testWidgets(
    'UserAccountsDrawerHeader icon color changes',
    (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Material(
          child: UserAccountsDrawerHeader(
  ...
  testWidgets(
    'UserAccountsDrawerHeader provides semantics',
    (WidgetTester tester) async {
