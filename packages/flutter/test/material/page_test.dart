...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      Offset widget2TopLeft = tester.getTopLeft(find.text('Page 2'));
      final RenderDecoratedBox box = tester.element(
        find.byKey(page2Key),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await expectLater(
        find.byKey(key),
        matchesGoldenFile('zoom_page_transition.small.png'),
      );
      ...
      await expectLater(
        find.byKey(key),
        matchesGoldenFile('zoom_page_transition.big.png'),
      );
    },
    variant: TargetPlatformVariant.only(TargetPlatform.android),
    skip: kIsWeb,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final TestGesture gesture =
          await tester.startGesture(const Offset(5, 200));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(tester.getTopLeft(
        find.ancestor(of: find.text('route'), matching: find.byType(Scaffold)),
      ), const Offset(400, 0));
  ...
  testWidgets(
    'MaterialPage can toggle MaintainState',
    (WidgetTester tester) async {
