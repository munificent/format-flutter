        ...
        child: CustomScrollView(
          ...
          slivers: <Widget>[
            SliverAppBar(
              ...
              snap: snap,
              bottom: TabBar(
                tabs: <String>['A', 'B', 'C'].map<Widget>(
                  (String t) => Tab(text: 'TAB $t'),
                ).toList(),
              ),
            ),
            SliverToBoxAdapter(
...
TextStyle? iconStyle(WidgetTester tester, IconData icon) {
  final RichText iconRichText = tester.widget<RichText>(find.descendant(
...
void main() {
  ...
  testWidgets('AppBar centers title on iOS', (WidgetTester tester) async {
    ...
    for (final TargetPlatform platform in <TargetPlatform>[
      ...
      expect(
        center.dx,
        greaterThan(400 - size.width / 2.0),
        reason: 'on ${platform.name}',
      );
      expect(
        center.dx,
        lessThan(400 + size.width / 2.0),
        reason: 'on ${platform.name}',
      );
      ...
      await tester.pumpWidget(MaterialApp(
        ...
        home: Scaffold(
          appBar: AppBar(
            title: const Text('X'),
            actions: const <Widget>[Icon(Icons.thumb_up)],
          ),
        ),
      ));
  ...
  testWidgets('AppBar centerTitle:false title start edge is 16.0 (LTR)', (
    ...
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        appBar:
            AppBar(centerTitle: false, title: const Placeholder(key: Key('X'))),
      ),
    ));
  ...
  testWidgets(
    'AppBar centerTitle:true title overflow OK (LTR)',
    (WidgetTester tester) async {
      // The app bar's title should be constrained to fit within the available space
  ...
  testWidgets(
    'AppBar drawer icon has default color',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'AppBar drawer icon is colored by iconTheme',
    (WidgetTester tester) async {
      final ThemeData themeData = ThemeData.from(
        colorScheme: const ColorScheme.light(),
      );
  ...
  testWidgets(
    'AppBar endDrawer icon has default size',
    (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Scaffold(
          appBar: AppBar(title: const Text('Howdy!')),
  ...
  testWidgets(
    'AppBar endDrawer icon has default color',
    (WidgetTester tester) async {
      final ThemeData themeData = ThemeData.from(
        colorScheme: const ColorScheme.light(),
      );
  ...
  testWidgets(
    'AppBar endDrawer icon is colored by iconTheme',
    (WidgetTester tester) async {
      final ThemeData themeData = ThemeData.from(
        colorScheme: const ColorScheme.light(),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        tester.getTopLeft(hamburger),
        material3 ? const Offset(4.0, 4.0) : Offset.zero,
      );
      expect(
        tester.getSize(hamburger),
        material3 ? const Size(48.0, 48.0) : const Size(56.0, 56.0),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        tester.getSize(shareButton),
        material3 ? const Size(48.0, 48.0) : const Size(48.0, 56.0),
      );
    },
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      TestGesture gesture =
          await tester.startGesture(const Offset(50.0, 200.0));
      await gesture.moveBy(const Offset(0.0, 100.0));
      await tester.pump();
  ...
  testWidgets('scrolledUnderElevation', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      buildAppBar(elevation: 2, scrolledUnderElevation: 10),
    );
    ...
    await tester.pumpWidget(Localizations(
      ...
      child: Directionality(
        ...
        child: MediaQuery(
          ...
          child: Scaffold(
            body:
                Column(children: <Widget>[AppBar(title: const Text('title'))]),
          ),
        ),
      ),
    ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(home: Scaffold(drawer: const Drawer(), appBar: AppBar())),
      );
  ...
  testWidgets('AppBar handles loose children 0', (WidgetTester tester) async {
    ...
    expect(tester.renderObject<RenderBox>(find.byKey(key)).localToGlobal(
      Offset.zero,
    ), Offset.zero);
    expect(
      tester.renderObject<RenderBox>(find.byKey(key)).size,
  ...
  testWidgets(
    'SliverAppBar provides correct semantics in LTR',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'SliverAppBar provides correct semantics in RTL',
    (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgets(
    'AppBar excludes header semantics correctly',
    (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      // Using a light theme.
      {
        ...
        final Material appBarMaterial = tester.widget<Material>(find.descendant(
          of: find.byType(AppBar),
          matching: find.byType(Material),
        ));
      ...
      {
        await tester.pumpWidget(
          buildAppBar(ThemeData.dark(useMaterial3: false)),
        );
        final Material appBarMaterial = tester.widget<Material>(find.descendant(
          of: find.byType(AppBar),
          matching: find.byType(Material),
              ...
              slivers: <Widget>[
                SliverAppBar(
                  ...
                  flexibleSpace: FlexibleSpaceBar(
                    background:
                        Container(height: appBarHeight, color: Colors.orange),
                  ),
                ),
                SliverList(
  ...
  testWidgets('AppBar shape default', (WidgetTester tester) async {
    ...
    Material getMaterialWidget(Finder finder) => tester.widget<Material>(
      finder,
    );
  ...
  testWidgets('SliverAppBar shape default', (WidgetTester tester) async {
    ...
    SliverAppBar getSliverAppBarWidget(Finder finder) => tester
        .widget<SliverAppBar>(finder);
  ...
  testWidgets("AppBar with EndDrawer doesn't have leading", (
    ...
    NavigationToolbar getAppBarWidget(Finder finder) => tester
        .widget<NavigationToolbar>(finder);
  ...
  group(
    ...
    () {
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          Color? leadingIconColor() =>
              iconStyle(tester, Icons.add_circle)?.color;
          Color? actionIconColor() => iconStyle(tester, Icons.ac_unit)?.color;
      ...
      testWidgets(
        'Action icons and IconButtons are colored by ActionIconTheme - M3',
        (WidgetTester tester) async {
          final ThemeData themeData = ThemeData.from(
            colorScheme: const ColorScheme.light(),
            useMaterial3: true,
      ...
      testWidgets(
        'The actionIconTheme property overrides iconTheme - M3',
        (WidgetTester tester) async {
          final ThemeData themeData = ThemeData.from(
            colorScheme: const ColorScheme.light(),
            useMaterial3: true,
      ...
      testWidgets(
        'AppBar.iconTheme should override any IconButtonTheme present in the theme - M3',
        (WidgetTester tester) async {
          ...
          Color? leadingIconButtonColor() =>
              iconStyle(tester, Icons.menu)?.color;
          double? leadingIconButtonSize() =>
              iconStyle(tester, Icons.menu)?.fontSize;
          Color? actionIconButtonColor() => iconStyle(tester, Icons.add)?.color;
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          Color? leadingIconButtonColor() =>
              iconStyle(tester, Icons.arrow_back)?.color;
          double? leadingIconButtonSize() =>
              iconStyle(tester, Icons.arrow_back)?.fontSize;
      ...
      testWidgets(
        'AppBar.actionsIconTheme should override any IconButtonTheme present in the theme - M3',
        (WidgetTester tester) async {
          final ThemeData themeData = ThemeData(
            iconButtonTheme: IconButtonThemeData(
              style: IconButton.styleFrom(
          ...
          Color? actionIconButtonColor() => iconStyle(tester, Icons.add)?.color;
          double? actionIconButtonSize() =>
              iconStyle(tester, Icons.add)?.fontSize;
  ...
  group('MaterialStateColor scrolledUnder', () {
    ...
    group('AppBar', () {
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          await tester.pumpWidget(
            buildAppBar(contentHeight: 200.0, reverse: true),
          );
          await tester.pump();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      final GlobalKey key = GlobalKey();
      await tester.pumpWidget(
        MaterialApp(home: Scaffold(key: key, appBar: AppBar())),
      );
      expect(find.byType(BackButton), findsNothing);
  ...
  testWidgets('AppBar.preferredHeightFor', (WidgetTester tester) async {
    ...
    Widget buildFrame({
      ...
      return MaterialApp(
        ...
        home: Builder(
          builder: (BuildContext context) {
            preferredHeight = AppBar.preferredHeightFor(
              context,
  ...
  testWidgets(
    'SliverAppBar.medium with bottom widget',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'SliverAppBar.large with bottom widget',
    (WidgetTester tester) async {
      // This is a regression test for https://github.com/flutter/flutter/issues/115091
      const double collapsedAppBarHeight = 64;
      const double expandedAppBarHeight = 152;
      ...
      return MaterialApp(
        home: Scaffold(
          ...
          body: Align(
            alignment: Alignment.topCenter,
            child:
                TextButton(onPressed: onPressed, child: const Text('press me')),
          ),
        ),
      );
    }
