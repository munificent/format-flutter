...
void main() {
  ...
  testWidgets(
    'Switch does not get distorted upon changing constraints with parent - M2',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'Switch has default colors when enabled - M2',
    (WidgetTester tester) async {
      bool value = false;
  ...
  testWidgets(
    'Switch has default colors when disabled - M2',
    (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        theme: ThemeData(useMaterial3: false),
        home: const Directionality(
          textDirection: TextDirection.rtl,
          child: Material(
            child: Center(child: Switch(value: false, onChanged: null)),
          ),
        ),
      ));
      ...
      await tester.pumpWidget(MaterialApp(
        ...
        home: const Directionality(
          textDirection: TextDirection.rtl,
          child: Material(
            child: Center(child: Switch(value: true, onChanged: null)),
          ),
        ),
      ));
  ...
  testWidgets(
    'Switch default overlayColor resolves hovered/focused state',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'Drag ends after animation completes',
    (WidgetTester tester) async {
  ...
  testWidgets('can veto switch dragging result', (WidgetTester tester) async {
    ...
    await tester.pump();
    expect(value, isFalse);
    final ToggleableStateMixin state = tester.state<ToggleableStateMixin>(find
        .descendant(
  ...
  testWidgets('Switch.adaptive', (WidgetTester tester) async {
    ...
    for (final TargetPlatform platform in <TargetPlatform>[
      ...
      final CupertinoSwitch adaptiveSwitch = tester.widget(
        find.byType(CupertinoSwitch),
      );
      expect(
      ...
      expect(
        adaptiveSwitch.trackColor,
        inactiveTrackColor,
        reason: 'on ${platform.name}',
      );
      expect(
        adaptiveSwitch.thumbColor,
        thumbColor,
        reason: 'on ${platform.name}',
      );
      expect(
        adaptiveSwitch.focusColor,
        focusColor,
        reason: 'on ${platform.name}',
      );
  ...
  testWidgets(
    'Switch is focusable and has correct focus color - M2',
    (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode(debugLabel: 'Switch');
      tester.binding.focusManager.highlightStrategy =
          FocusHighlightStrategy.alwaysTraditional;
  ...
  testWidgets(
    'Switch can be hovered and has correct hover color - M2',
    (WidgetTester tester) async {
      tester.binding.focusManager.highlightStrategy =
          FocusHighlightStrategy.alwaysTraditional;
      bool value = true;
  ...
  testWidgets(
    'Switch can be toggled by keyboard shortcuts',
    (WidgetTester tester) async {
      tester.binding.focusManager.highlightStrategy =
          FocusHighlightStrategy.alwaysTraditional;
      bool value = true;
  ...
  testWidgets(
    'Switch changes mouse cursor when hovered',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final ToggleableStateMixin oldSwitchState = tester.state(find
          .byWidgetPredicate(
            (Widget widget) =>
                widget.runtimeType.toString() == '_MaterialSwitch',
          ));
      ...
      final ToggleableStateMixin updatedSwitchState = tester.state(find
          .byWidgetPredicate(
            (Widget widget) =>
                widget.runtimeType.toString() == '_MaterialSwitch',
          ));
  ...
  testWidgets(
    'Switch thumb color resolves in active/enabled states - M2',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'Switch thumb color resolves in hovered/focused states - M2',
    (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode(debugLabel: 'Switch');
      tester.binding.focusManager.highlightStrategy =
          FocusHighlightStrategy.alwaysTraditional;
  ...
  testWidgets(
    'Track color resolves in active/enabled states - M2',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'Switch track color resolves in hovered/focused states - M2',
    (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode(debugLabel: 'Switch');
      tester.binding.focusManager.highlightStrategy =
          FocusHighlightStrategy.alwaysTraditional;
  ...
  testWidgets(
    'Switch thumb color is blended against surface color - M2',
    (WidgetTester tester) async {
  ...
  group('Switch M3 tests', () {
    ...
    testWidgets(
      'Switch track color resolves in hovered/focused states - M3',
      (WidgetTester tester) async {
        final ThemeData themeData = ThemeData(
          useMaterial3: true,
          colorSchemeSeed: const Color(0xff6750a4),
      ...
      (WidgetTester tester) async {
        ...
        expect(
          ...
          paints
            ..rrect(style: PaintingStyle.fill)
            ..rrect(
              color: focusedTrackOutlineColor,
              style: PaintingStyle.stroke,
            ),
        ...
        expect(
          ...
          paints
            ..rrect(style: PaintingStyle.fill)
            ..rrect(
              color: hoveredTrackOutlineColor,
              style: PaintingStyle.stroke,
            ),
          reason: 'Active enabled switch track outline should match this color',
        );
    ...
    testWidgets('Switch can set icon - M3', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(buildSwitch(
        enabled: true,
        active: true,
        inactiveIcon: const Icon(Icons.check),
      ));
      await tester.pumpAndSettle();
      expect(
        Material.of(tester.element(find.byType(Switch))),
