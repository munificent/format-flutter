...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      try {
        ...
        expect(
          material,
          isNot(paints..rrect(color: sliderTheme.activeTrackColor)),
        );
        expect(
          material,
  ...
  testWidgets(
    'Slider parameters overrides theme properties',
    (WidgetTester tester) async {
      debugDisableShadows = false;
  ...
  testWidgets(
    'Default slider track draws correctly',
    (WidgetTester tester) async {
      final ThemeData theme = ThemeData(
        platform: TargetPlatform.android,
        primarySwatch: Colors.blue,
  ...
  testWidgets(
    'Default slider overlay draws correctly',
    (WidgetTester tester) async {
      final ThemeData theme = ThemeData(
        platform: TargetPlatform.android,
        primarySwatch: Colors.blue,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      try {
        ...
        await tester.pumpWidget(
          buildApp('1000000', sliderValue: 0.0, textScale: 0.5),
        );
        center = tester.getCenter(find.byType(Slider));
        gesture = await tester.startGesture(center);
        // Wait for value indicator animation to finish.
        ...
        await tester.pumpWidget(
          buildApp('1000000', sliderValue: 0.0, textScale: 2.5),
        );
        center = tester.getCenter(find.byType(Slider));
        gesture = await tester.startGesture(center);
        // Wait for value indicator animation to finish.
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final SliderThemeData sliderTheme = ThemeData().sliderTheme.copyWith(
        overlayShape:
            const RoundSliderOverlayShape(overlayRadius: uniqueOverlayRadius),
      );
  ...
  testWidgets('The mouse cursor is themeable', (WidgetTester tester) async {
    await tester.pumpWidget(_buildApp(ThemeData().sliderTheme.copyWith(
      mouseCursor:
          const MaterialStatePropertyAll<MouseCursor>(SystemMouseCursors.text),
    )));
  ...
  testWidgets(
    'SliderTheme.allowedInteraction is themeable',
    (WidgetTester tester) async {
      double value = 0.0;
