...
void main() {
      ...
      await tester.pumpWidget(MaterialApp(
        home: Scaffold(
          floatingActionButton:
              FloatingActionButton(onPressed: () {}, tooltip: 'Add'),
        ),
      ));
  ...
  testWidgets(
    'Floating Action Button tooltip (no child)',
    (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Scaffold(
          floatingActionButton:
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            floatingActionButton:
                FloatingActionButton(onPressed: null, tooltip: 'Add'),
          ),
        ),
      );
  ...
  testWidgets('Floating Action Button elevation when highlighted - effect', (
    ...
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        floatingActionButton:
            FloatingActionButton(onPressed: () {}, highlightElevation: 20.0),
      ),
    ));
    await tester.pump();
    expect(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            floatingActionButton:
                FloatingActionButton(onPressed: null, disabledElevation: 0),
          ),
        ),
      );
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            floatingActionButton:
                FloatingActionButton(onPressed: null, disabledElevation: 3.0),
          ),
        ),
      );
      expect(
      ...
      await tester.pumpWidget(MaterialApp(
        home: Scaffold(
          floatingActionButton:
              FloatingActionButton(onPressed: () {}, disabledElevation: 3.0),
        ),
      ));
      expect(
        tester.widget<PhysicalShape>(find.byType(PhysicalShape)).elevation,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      PhysicalShape getFABWidget(Finder finder) => tester.widget<PhysicalShape>(
        finder,
      );
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        home: Theme(
          ...
          child: Scaffold(
            floatingActionButton:
                FloatingActionButton(key: key1, mini: true, onPressed: null),
          ),
        ),
      ));
      ...
      await tester.pumpWidget(MaterialApp(
        home: Theme(
          ...
          child: Scaffold(
            floatingActionButton:
                FloatingActionButton(key: key2, mini: true, onPressed: null),
          ),
        ),
      ));
  ...
  testWidgets(
    'Floating Action Button semantics (enabled)',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'Floating Action Button semantics (disabled)',
    (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgets(
    'Tooltip is used as semantics tooltip',
    (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        home: Scaffold(
          floatingActionButton:
              FloatingActionButton.large(key: key, onPressed: null),
        ),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final RawMaterialButton rawMaterialButton = tester
          .widget<RawMaterialButton>(find.descendant(
  ...
  group('Material 2', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final Finder fabFinder = find.byType(PhysicalShape);
        PhysicalShape getFABWidget(Finder finder) => tester
            .widget<PhysicalShape>(finder);
  ...
  group('feedback', () {
    ...
    testWidgets(
      'FloatingActionButton with enabled feedback',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'FloatingActionButton with disabled feedback',
      (WidgetTester tester) async {
