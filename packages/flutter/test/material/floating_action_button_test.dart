...
void main() {
  ...
  testWidgets('Floating Action Button tooltip', (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        floatingActionButton: FloatingActionButton(onPressed: () {}, tooltip: 'Add', child: const Icon(Icons.add)),
      ),
    ));
  ...
  testWidgets('Floating Action Button tooltip (long press button edge - no child)', (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(home: Scaffold(floatingActionButton: FloatingActionButton(onPressed: () {}, tooltip: 'Add'))),
    );
  ...
  testWidgets('Floating Action Button tooltip reacts when disabled', (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(home: Scaffold(floatingActionButton: FloatingActionButton(onPressed: null, tooltip: 'Add'))),
    );
  ...
  testWidgets('Floating Action Button elevation when highlighted - effect', (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(theme: material3Theme, home: Scaffold(floatingActionButton: FloatingActionButton(onPressed: () {}))),
    );
    ...
    expect(tester.widget<PhysicalShape>(find.byType(PhysicalShape)).elevation, 6.0);
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(floatingActionButton: FloatingActionButton(onPressed: () {}, highlightElevation: 20.0)),
    ));
    await tester.pump();
    expect(tester.widget<PhysicalShape>(find.byType(PhysicalShape)).elevation, 6.0);
    await tester.pump(const Duration(seconds: 1));
  ...
  testWidgets('Floating Action Button elevation when disabled - defaults', (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(home: Scaffold(floatingActionButton: FloatingActionButton(onPressed: null))),
    );
  ...
  testWidgets('Floating Action Button elevation when disabled - override', (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Scaffold(floatingActionButton: FloatingActionButton(onPressed: null, disabledElevation: 0)),
      ),
    );
  ...
  testWidgets('Floating Action Button elevation when disabled - effect', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      const MaterialApp(
        home: Scaffold(floatingActionButton: FloatingActionButton(onPressed: null, disabledElevation: 3.0)),
      ),
    );
    expect(tester.widget<PhysicalShape>(find.byType(PhysicalShape)).elevation, 6.0);
    await tester.pump(const Duration(seconds: 1));
    ...
    await tester.pumpWidget(
      MaterialApp(home: Scaffold(floatingActionButton: FloatingActionButton(onPressed: () {}, disabledElevation: 3.0))),
    );
    expect(tester.widget<PhysicalShape>(find.byType(PhysicalShape)).elevation, 3.0);
    await tester.pump(const Duration(seconds: 1));
    expect(tester.widget<PhysicalShape>(find.byType(PhysicalShape)).elevation, 6.0);
  ...
  testWidgets('Floating Action Button states elevation', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      theme: material3Theme,
      home: Scaffold(
        body: FloatingActionButton.extended(label: const Text('tooltip'), onPressed: () {}, focusNode: focusNode),
      ),
    ));
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        home: Theme(
          ...
          child: Scaffold(floatingActionButton: FloatingActionButton(key: key1, mini: true, onPressed: null)),
        ),
      ));
      ...
      await tester.pumpWidget(MaterialApp(
        home: Theme(
          ...
          child: Scaffold(floatingActionButton: FloatingActionButton(key: key2, mini: true, onPressed: null)),
        ),
      ));
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: const Scaffold(
        floatingActionButton:
            FloatingActionButton.extended(label: SizedBox(width: 100.0, child: Text('label')), onPressed: null),
      ),
    ));
  ...
  testWidgets('Floating Action Button semantics (enabled)', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Directionality(
      textDirection: TextDirection.ltr,
      child: Center(child: FloatingActionButton(onPressed: () {}, child: const Icon(Icons.add, semanticLabel: 'Add'))),
    ));
  ...
  testWidgets('Floating Action Button semantics (disabled)', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      const Directionality(
        textDirection: TextDirection.ltr,
        child: Center(child: FloatingActionButton(onPressed: null, child: Icon(Icons.add, semanticLabel: 'Add'))),
      ),
    );
  ...
  testWidgets('Tooltip is used as semantics tooltip', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        floatingActionButton:
            FloatingActionButton(onPressed: () {}, tooltip: 'Add Photo', child: const Icon(Icons.add_a_photo)),
      ),
    ));
  ...
  testWidgets('Floating Action Button clips ink splash and highlight', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: Scaffold(
        body: Center(
          child: RepaintBoundary(key: key, child: FloatingActionButton(onPressed: () {}, child: const Icon(Icons.add))),
        ),
      ),
    ));
  ...
  testWidgets('Floating Action Button changes mouse cursor when hovered', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      const MaterialApp(
        home: Scaffold(
          body:
              Align(alignment: Alignment.topLeft, child: FloatingActionButton(onPressed: null, child: Icon(Icons.add))),
        ),
      ),
    );
  ...
  testWidgets('Floating Action Button has no clip by default', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Directionality(
      textDirection: TextDirection.ltr,
      child: FloatingActionButton(focusNode: focusNode, onPressed: () {/* to make sure the button is enabled */}),
    ));

    focusNode.unfocus();
    await tester.pump();

    expect(tester.renderObject(find.byType(FloatingActionButton)), paintsExactlyCountTimes(#clipPath, 0));
  });
  ...
  testWidgets('Can find FloatingActionButton semantics', (WidgetTester tester) async {
    ...
    expect(
      ...
      matchesSemantics(hasTapAction: true, hasEnabledState: true, isButton: true, isEnabled: true, isFocusable: true),
    );
  });
  ...
  testWidgets('FloatingActionButton uses custom splash color', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: FloatingActionButton(onPressed: () {}, splashColor: splashColor, child: const Icon(Icons.access_alarm)),
    ));
  ...
  testWidgets('FloatingActionButton.large configures correct size', (WidgetTester tester) async {
    final Key key = UniqueKey();
    await tester.pumpWidget(
      MaterialApp(home: Scaffold(floatingActionButton: FloatingActionButton.large(key: key, onPressed: null))),
    );
  ...
  testWidgets('FloatingActionButton.extended can customize spacing', (WidgetTester tester) async {
    ...
    expect(
      tester.getTopLeft(find.byKey(iconKey)).dx - tester.getTopLeft(find.byType(FloatingActionButton)).dx,
      padding.start,
    );
    expect(
      tester.getTopRight(find.byType(FloatingActionButton)).dx - tester.getTopRight(find.byKey(labelKey)).dx,
      padding.end,
    );
  });
  ...
  testWidgets('FloatingActionButton.extended can customize text style', (WidgetTester tester) async {
    ...
    final RawMaterialButton rawMaterialButton = tester.widget<RawMaterialButton>(
      find.descendant(of: find.byType(FloatingActionButton), matching: find.byType(RawMaterialButton)),
    );
    ...
    testWidgets('Floating Action Button clips ink splash and highlight', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        ...
        home: Scaffold(
          body: Center(
            child:
                RepaintBoundary(key: key, child: FloatingActionButton(onPressed: () {}, child: const Icon(Icons.add))),
          ),
        ),
      ));
      ...
      await tester.pump();
      await tester.pump(const Duration(milliseconds: 1000));
      await expectLater(find.byKey(key), matchesGoldenFile('floating_action_button_test_m2.clip.png'));
    });
  });
  ...
  group('feedback', () {
    ...
    testWidgets('FloatingActionButton with enabled feedback by default', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(home: FloatingActionButton(onPressed: () {}, child: const Icon(Icons.access_alarm))),
      );
    ...
    testWidgets('FloatingActionButton with disabled feedback using FloatingActionButtonTheme', (
      ...
      final ThemeData theme = ThemeData(
        floatingActionButtonTheme: const FloatingActionButtonThemeData(enableFeedback: enableFeedbackTheme),
      );

      await tester.pumpWidget(MaterialApp(
        home: Theme(data: theme, child: FloatingActionButton(onPressed: () {}, child: const Icon(Icons.access_alarm))),
      ));
