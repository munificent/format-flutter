...
void main() {
  ...
  testWidgetsWithLeakTracking(
    "LicensePage's color must be same whether loading or done",
    (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('LicensePage master view layout position - ltr', (
    WidgetTester tester,
  ) async {
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: const Scaffold(
        body:
            Directionality(textDirection: textDirection, child: LicensePage()),
      ),
    ));
  ...
  testWidgetsWithLeakTracking('LicensePage master view layout position - rtl', (
    WidgetTester tester,
  ) async {
