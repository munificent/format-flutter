...
const Rect _kMaterialDesignInitialThumbRect = Rect.fromLTRB(
  790.0,
  0.0,
  798.0,
  90.0,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        buildFrame(ThemeData(colorScheme: const ColorScheme.light())),
      );
      await tester.pumpAndSettle();
      // Idle scrollbar behavior
      expect(
      ...
      await tester.pumpWidget(
        buildFrame(ThemeData(colorScheme: const ColorScheme.dark())),
      );
