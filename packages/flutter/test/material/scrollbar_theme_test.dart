...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        ...
        paints
          ..rrect(
            rrect: RRect.fromRectAndRadius(const Rect.fromLTRB(785.0, 10.0, 795.0, 97.0), const Radius.circular(6.0)),
      ...
      expect(
        find.byType(Scrollbar),
        paints
          ..rect(rect: const Rect.fromLTRB(770.0, 0.0, 800.0, 600.0), color: const Color(0xff000000))
          ..line(
      ...
      await tester.pumpWidget(MaterialApp(
        ...
        home: ScrollConfiguration(
          ...
          child: ScrollbarTheme(
            data: _scrollbarTheme().copyWith(thumbColor: MaterialStateProperty.all(const Color(0xFF000000))),
            child: Scrollbar(
              thumbVisibility: true,
              controller: scrollController,
              child: SingleChildScrollView(
  ...
  testWidgets('ScrollbarTheme can disable gestures', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: Scrollbar(
        ...
        controller: scrollController,
        child:
            SingleChildScrollView(controller: scrollController, child: const SizedBox(width: 4000.0, height: 4000.0)),
      ),
    ));
    await tester.pumpAndSettle();
    // Idle scrollbar behavior
  ...
  testWidgets('Scrollbar.interactive takes priority over ScrollbarTheme', (WidgetTester tester) async {
    ...
    expect(
      ...
      paints
        ..rrect(
          rrect: RRect.fromRectAndRadius(const Rect.fromLTRB(790.0, 10.0, 798.0, 100.0), _kDefaultThumbRadius),
          color: _kDefaultIdleThumbColor,
        ),
    );
  }, variant: const TargetPlatformVariant(<TargetPlatform>{TargetPlatform.fuchsia}));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        ...
        paints
          ..rrect(
            rrect: RRect.fromRectAndRadius(const Rect.fromLTRB(794.0, 0.0, 798.0, 90.0), const Radius.circular(3.0)),
            color: _kDefaultIdleThumbColor,
          ),
      );
      ...
      expect(
        ...
        paints
          ...
          ..rrect(
            rrect: RRect.fromRectAndRadius(const Rect.fromLTRB(786.0, 10.0, 798.0, 100.0), const Radius.circular(3.0)),
            // Hover color
            color: const Color(0x80000000),
          ),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(buildFrame(ThemeData(colorScheme: const ColorScheme.light())));
      await tester.pumpAndSettle();
      // Idle scrollbar behavior
      expect(
        find.byType(Scrollbar),
      ...
      await tester.pumpWidget(buildFrame(ThemeData(colorScheme: const ColorScheme.dark())));
      ...
      expect(
        find.byType(Scrollbar),
        paints
          ..rect(rect: const Rect.fromLTRB(784.0, 0.0, 800.0, 600.0), color: const Color(0x0dffffff))
          ..line(
            p1: const Offset(784.0, 0.0),
            p2: const Offset(784.0, 600.0),
            strokeWidth: 1.0,
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        theme: ThemeData(useMaterial3: false).copyWith(
          scrollbarTheme: _scrollbarTheme(trackVisibility: MaterialStateProperty.resolveWith(getTrackVisibility)),
        ),
        home: ScrollConfiguration(
          behavior: const NoScrollbarBehavior(),
          child: Scrollbar(
