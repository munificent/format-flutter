...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset leadingTopLeft = tester.getTopLeft(
        find.byIcon(Icons.umbrella),
      );
      expect(
        rowTopLeft.dy - materialTopLeft.dy,
        2.0,
      ); // Default single line top padding.
      expect(
        rowTopLeft.dx - materialTopLeft.dx,
        16.0,
      ); // Default single line start padding.
      expect(
        leadingTopLeft.dy - materialTopLeft.dy,
        16,
      ); // Default leading padding.
      expect(
        leadingTopLeft.dx - materialTopLeft.dx,
        16,
      ); // Default leading padding.
