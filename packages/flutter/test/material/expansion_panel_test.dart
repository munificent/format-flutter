...
void main() {
  ...
  testWidgets(
    'Radio mode has max of one panel open at a time',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final ExpansionPanelList expansionListRadio = ExpansionPanelList.radio(
        expansionCallback: (int index, bool isExpanded) {
          callbackHistory
              .add(<String, dynamic>{'index': index, 'isExpanded': isExpanded});
        },
        children: demoItemsRadio,
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      final ExpansionPanel expansionPanel = ExpansionPanel(
        headerBuilder:
            (BuildContext context, bool isExpanded) => const Text('Demo'),
        body: const SizedBox(height: 100.0),
      );
  ...
  testWidgets(
    'ExpansionPanelList respects expandIconColor',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'ExpansionPanelList respects materialGapSize',
    (WidgetTester tester) async {
