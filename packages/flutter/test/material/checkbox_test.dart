...
void main() {
  ...
  testWidgets('Checkbox size is configurable by ThemeData.materialTapTargetSize', (WidgetTester tester) async {
    await tester.pumpWidget(Theme(
      ...
      child: Directionality(
        ...
        child: Material(child: Center(child: Checkbox(value: true, onChanged: (bool? newValue) {}))),
      ),
    ));
  ...
  testWidgets('Checkbox semantics', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Theme(data: theme, child: Material(child: Checkbox(value: true, onChanged: (bool? b) {}))));
    ...
    await tester.pumpWidget(Theme(data: theme, child: const Material(child: Checkbox(value: false, onChanged: null))));
    ...
    expect(tester.getSemantics(find.byType(Checkbox)), matchesSemantics(hasCheckedState: true, hasEnabledState: true));

    await tester.pumpWidget(Theme(data: theme, child: const Material(child: Checkbox(value: true, onChanged: null))));
    ...
    await tester.pumpWidget(
      Theme(data: theme, child: const Material(child: Checkbox(value: null, tristate: true, onChanged: null))),
    );
    ...
    await tester.pumpWidget(
      Theme(data: theme, child: const Material(child: Checkbox(value: true, tristate: true, onChanged: null))),
    );
    ...
    await tester.pumpWidget(
      Theme(data: theme, child: const Material(child: Checkbox(value: false, tristate: true, onChanged: null))),
    );
    ...
    await tester.pumpWidget(Directionality(
      ...
      child: Theme(
        data: theme,
        child: Material(child: Checkbox(semanticLabel: 'checkbox', value: true, onChanged: (bool? b) {})),
      ),
    ));
  ...
  testWidgets('has semantics for tristate', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      Theme(data: theme, child: Material(child: Checkbox(tristate: true, value: null, onChanged: (bool? newValue) {}))),
    );
    ...
    await tester.pumpWidget(
      Theme(data: theme, child: Material(child: Checkbox(tristate: true, value: true, onChanged: (bool? newValue) {}))),
    );
    ...
    await tester.pumpWidget(Theme(
      data: theme,
      child: Material(child: Checkbox(tristate: true, value: false, onChanged: (bool? newValue) {})),
    ));
  ...
  testWidgets('Checkbox color rendering', (WidgetTester tester) async {
    ...
    expect(
      getCheckboxRenderer(),
      paints
        ..path(color: theme.useMaterial3 ? m3BorderColor : borderColor)
    ...
    await tester.pumpWidget(buildFrame(themeData: themeData));
    await tester.pumpAndSettle();
      ...
      paints
        ...
        ..drrect(
          ...
          outer: RRect.fromLTRBR(
            ...
            33.0,
            33.0,
            material3 ? const Radius.circular(2.0) : const Radius.circular(1.0),
          ),
  ...
  testWidgets('Checkbox responds to density changes.', (WidgetTester tester) async {
    ...
    Future<void> buildTest(VisualDensity visualDensity) async {
      return tester.pumpWidget(MaterialApp(
        ...
        home: Material(
          child:
              Center(child: Checkbox(visualDensity: visualDensity, key: key, onChanged: (bool? value) {}, value: true)),
        ),
      ));
    }
  ...
  testWidgets('Checkbox stops hover animation when removed from the tree.', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Theme(
      data: ThemeData(materialTapTargetSize: MaterialTapTargetSize.padded),
      child: Directionality(textDirection: TextDirection.ltr, child: Material(child: Center(child: Container()))),
    ));
        ...
        body: Align(
          ...
          child: Material(
            child: MouseRegion(
              ...
              child: Checkbox(mouseCursor: SystemMouseCursors.text, value: true, onChanged: (_) {}),
            ),
          ),
        ),
      ),
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: Scaffold(
        body: Align(
          alignment: Alignment.topLeft,
          child: Material(
            child: MouseRegion(cursor: SystemMouseCursors.forbidden, child: Checkbox(value: true, onChanged: (_) {})),
          ),
        ),
      ),
    ));
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: const Scaffold(
        body: Align(
          alignment: Alignment.topLeft,
          child: Material(
            child: MouseRegion(cursor: SystemMouseCursors.forbidden, child: Checkbox(value: true, onChanged: null)),
          ),
        ),
      ),
    ));
      ...
      home: const Scaffold(
        body: Align(
          ...
          child: Material(
            child: MouseRegion(
              cursor: SystemMouseCursors.forbidden,
              child: Checkbox(value: null, tristate: true, onChanged: null, mouseCursor: _SelectedGrabMouseCursor()),
            ),
          ),
        ),
      ),
    ...
    Widget buildFrame({required bool enabled}) {
      return Material(
        child: Theme(
          ...
          child: StatefulBuilder(
            builder: (BuildContext context, StateSetter setState) {
              return Checkbox(value: true, fillColor: fillColor, onChanged: enabled ? (bool? value) {} : null);
            },
          ),
        ),
      );
  ...
  testWidgets('Checkbox default overlay color in active/pressed/focused/hovered states', (WidgetTester tester) async {
    ...
    Widget buildCheckbox({bool active = false, bool focused = false}) {
      return MaterialApp(
        theme: theme,
        home: Scaffold(body: Checkbox(focusNode: focusNode, autofocus: focused, value: active, onChanged: (_) {})),
      );
    }
  ...
  testWidgets('Do not crash when widget disappears while pointer is down', (WidgetTester tester) async {
    Widget buildCheckbox(bool show) {
      return MaterialApp(
        theme: theme,
        home: Material(child: Center(child: show ? Checkbox(value: true, onChanged: (_) {}) : Container())),
      );
    }
      ...
      expect(
        ...
        paints
          ..drrect(
            color: borderColor,
            outer: material3
                ? RRect.fromLTRBR(15, 15, 33, 33, const Radius.circular(2))
                : RRect.fromLTRBR(15, 15, 33, 33, const Radius.circular(1)),
            inner: RRect.fromLTRBR(19, 19, 29, 29, Radius.zero),
          ),
      );
    }
  ...
  testWidgets('disabled checkbox shows tooltip', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      const MaterialApp(
        home: Material(child: Tooltip(message: longPressTooltip, child: Checkbox(value: true, onChanged: null))),
      ),
    );
  ...
  testWidgets('Checkbox respects fillColor when it is unchecked', (WidgetTester tester) async {
    ...
    expect(
      getCheckboxRenderer(),
      paints..drrect(color: theme.useMaterial3 ? theme.colorScheme.onSurfaceVariant : theme.unselectedWidgetColor),
    );
    ...
    expect(
      getCheckboxRenderer(),
      paints..drrect(color: theme.useMaterial3 ? theme.colorScheme.onSurface.withOpacity(0.38) : theme.disabledColor),
    );
    expect(getCheckboxRenderer(), paints..path(color: inactiveBackgroundColor));
  });
}
