...
void main() {
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(Theme(
        ...
        child: Directionality(
          ...
          child: Material(
            child: Center(
              child: Checkbox(value: true, onChanged: (bool? newValue) {}),
            ),
          ),
        ),
      ));
  ...
  testWidgets('Checkbox semantics', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Theme(
      ...
      child: const Material(
        child: Checkbox(value: null, tristate: true, onChanged: null),
      ),
    ));
    ...
    await tester.pumpWidget(Theme(
      data: theme,
      child: const Material(
        child: Checkbox(value: true, tristate: true, onChanged: null),
      ),
    ));
    ...
    await tester.pumpWidget(Theme(
      data: theme,
      child: const Material(
        child: Checkbox(value: false, tristate: true, onChanged: null),
      ),
    ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(buildApp());
      final Offset checkboxTopLeftGlobal = tester.getTopLeft(
        find.byType(Checkbox),
      );
      final Offset checkboxCenterGlobal = tester.getCenter(
        find.byType(Checkbox),
      );
  ...
  testWidgets('Checkbox can be hovered and has correct hover color', (
    ...
    expect(
      ...
      paints
        ..path(
          color: material3 ? const Color(0xff6750a4) : const Color(0xff2196f3),
        )
        ..path(
          color: material3
              ? theme.colorScheme.onPrimary
  ...
  testWidgets(
    'Checkbox responds to density changes.',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'Checkbox default overlay color in active/pressed/focused/hovered states',
    (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode(debugLabel: 'Checkbox');
      tester.binding.focusManager.highlightStrategy =
          FocusHighlightStrategy.alwaysTraditional;
      ...
      expect(
        ...
        material3
            ...
            : (paints
                ..circle(
                  color: theme.unselectedWidgetColor.withAlpha(
  ...
  testWidgets(
    'Checkbox MaterialStateBorderSide applies unconditionally',
    (WidgetTester tester) async {
      const Color borderColor = Color(0xfff44336);
      const BorderSide side = BorderSide(width: 4, color: borderColor);
      final bool material3 = theme.useMaterial3;
  ...
  testWidgets(
    'Checkbox MaterialStateBorderSide applies in error states - M3',
    (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode(debugLabel: 'Checkbox');
      final ThemeData themeData = ThemeData(useMaterial3: true);
  ...
  testWidgets('Checkbox has correct default shape - M3', (
    WidgetTester tester,
  ) async {
    final ThemeData themeData = ThemeData(useMaterial3: true);
  ...
  testWidgets('Checkbox respects fillColor when it is unchecked', (
    WidgetTester tester,
  ) async {
