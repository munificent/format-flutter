...
void main() {
  ...
  testWidgets('onPressed is triggered on button tap', (
    WidgetTester tester,
  ) async {
    TextStyle buttonTextStyle(String text) {
      return tester.widget<DefaultTextStyle>(find.descendant(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        buttonColor('Second child').color,
        theme.colorScheme.surface.withOpacity(0.0),
      );
    },
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      toggleButtonRenderObject = tester.allRenderObjects.firstWhere(
        (RenderObject object) {
  ...
  testWidgets(
    'ToggleButtons text baseline alignment',
    (WidgetTester tester) async {
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                textStyle:
                    const TextStyle(fontFamily: 'FlutterTest', fontSize: 20.0),
              ),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final List<RenderObject> toggleButtonRenderObject =
          tester.allRenderObjects.where((RenderObject object) {
            return object.runtimeType.toString() ==
                '_SelectToggleButtonRenderObject';
          }).toSet().toList();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        tester.getCenter(find.text('First child')),
        const Offset(400.0, 251.0),
      );
      expect(
        tester.getCenter(find.text('Second child')),
        const Offset(400.0, 300.0),
      );
      expect(
        tester.getCenter(find.text('Third child')),
    ...
    (WidgetTester tester) async {
      ...
      double toggleButtonElevation(String text) {
        return tester.widget<Material>(
          find.widgetWithText(Material, text).first,
        ).elevation;
      }
