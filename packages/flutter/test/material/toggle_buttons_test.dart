...
Widget boilerplate({bool? useMaterial3, MaterialTapTargetSize? tapTargetSize, required Widget child}) {
  return Theme(
    data: ThemeData(useMaterial3: useMaterial3, materialTapTargetSize: tapTargetSize),
    child: Directionality(textDirection: TextDirection.ltr, child: Center(child: Material(child: child))),
  );
}
...
void main() {
  testWidgets('Initial toggle state is reflected', (WidgetTester tester) async {
    TextStyle buttonTextStyle(String text) {
      return tester.widget<DefaultTextStyle>(
        find.descendant(of: find.widgetWithText(TextButton, text), matching: find.byType(DefaultTextStyle)),
      ).style;
    }
  ...
  testWidgets('onPressed that is null disables buttons', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(boilerplate(
      child: ToggleButtons(isSelected: isSelected, children: const <Widget>[Text('First child'), Text('Second child')]),
    ));
  ...
  testWidgets('Default text style is applied', (WidgetTester tester) async {
    ...
    TextStyle textStyle;
    textStyle = tester.widget<DefaultTextStyle>(
      find.descendant(of: find.widgetWithText(TextButton, 'First child'), matching: find.byType(DefaultTextStyle)),
    ).style;
    ...
    textStyle = tester.widget<DefaultTextStyle>(
      find.descendant(of: find.widgetWithText(TextButton, 'Second child'), matching: find.byType(DefaultTextStyle)),
    ).style;
    expect(textStyle.fontFamily, theme.textTheme.bodyMedium!.fontFamily);
    expect(textStyle.decoration, theme.textTheme.bodyMedium!.decoration);
  });
  ...
  testWidgets('Custom text style except color is applied', (WidgetTester tester) async {
    await tester.pumpWidget(boilerplate(
      child: ToggleButtons(
        isSelected: const <bool>[false, true],
        onPressed: (int index) {},
        textStyle: const TextStyle(textBaseline: TextBaseline.ideographic, fontSize: 20.0, color: Colors.orange),
        children: const <Widget>[Text('First child'), Text('Second child')],
      ),
    ));
  ...
  testWidgets('Default text/icon colors for enabled, selected and disabled states', (WidgetTester tester) async {
    TextStyle buttonTextStyle(String text) {
      return tester.widget<DefaultTextStyle>(
        find.descendant(of: find.widgetWithText(TextButton, text), matching: find.byType(DefaultTextStyle)),
      ).style;
    ...
    IconTheme iconTheme(IconData icon) {
      return tester.widget(
        find.descendant(of: find.widgetWithIcon(TextButton, icon), matching: find.byType(IconTheme)),
      );
    }
  ...
  testWidgets('Custom text/icon colors for enabled, selected and disabled states', (WidgetTester tester) async {
    TextStyle buttonTextStyle(String text) {
      return tester.widget<DefaultTextStyle>(
        find.descendant(of: find.widgetWithText(TextButton, text), matching: find.byType(DefaultTextStyle)),
      ).style;
  ...
  testWidgets('Default border width and border colors for enabled, selected and disabled states', (
    ...
    await tester.pumpWidget(
      boilerplate(child: ToggleButtons(isSelected: const <bool>[false], children: const <Widget>[Text('First child')])),
    );
  ...
  testWidgets('Height of segmented control is determined by tallest widget', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      boilerplate(child: ToggleButtons(isSelected: const <bool>[false, true, false], children: children)),
    );
    ...
    await tester.pumpWidget(boilerplate(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          ElevatedButton(
            onPressed: null,
            style: ElevatedButton.styleFrom(textStyle: const TextStyle(fontFamily: 'FlutterTest', fontSize: 20.0)),
  ...
  testWidgets('Directionality test', (WidgetTester tester) async {
    ...
    expect(tester.getTopRight(find.text('First child')).dx < tester.getTopRight(find.text('Second child')).dx, isTrue);
  ...
  testWidgets('Border radius paint test when there is only one button', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(RepaintBoundary), matchesGoldenFile('toggle_buttons.oneButton.boardsPaint.png'));
  });
  ...
  testWidgets('Border radius paint test when Radius.x or Radius.y equal 0.0', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(RepaintBoundary), matchesGoldenFile('toggle_buttons.oneButton.boardsPaint2.png'));
  });
