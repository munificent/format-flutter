...
void main() {
  testWidgets(
    'CircleAvatar with dark background color',
  ...
  testWidgets(
    'CircleAvatar with image background',
    (WidgetTester tester) async {
      await tester.pumpWidget(wrap(
        child: CircleAvatar(
  ...
  testWidgets(
    'CircleAvatar with image foreground',
    (WidgetTester tester) async {
      await tester.pumpWidget(wrap(
        child: CircleAvatar(
  ...
  testWidgets('CircleAvatar default colors', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(wrap(
      child: Theme(data: theme, child: const CircleAvatar(child: Text('Z'))),
    ));
  ...
  group('Material 2', () {
    ...
    testWidgets('CircleAvatar default colors with light theme', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('CircleAvatar default colors with dark theme', (
      WidgetTester tester,
    ) async {
      final ThemeData theme = ThemeData(
        useMaterial3: false,
