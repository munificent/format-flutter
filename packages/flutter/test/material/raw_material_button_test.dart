...
void main() {
          ...
          RawMaterialButton(
            ...
            child: const SizedBox(
              ...
              child: Column(
                ...
                children: <Widget>[
                  SizedBox(height: 50.0, width: 400.0, child: Text('Material')),
                ],
              ),
            ),
          ),
  ...
  testWidgets(
    'RawMaterialButton loses focus when disabled.',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      rawMaterialButton = find.byType(RawMaterialButton);
      expect(
        tester.widget<RawMaterialButton>(rawMaterialButton).enabled,
        false,
      );
    },
  );
