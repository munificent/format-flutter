...
void main() {
  ...
  group('MenuStyle', () {
    ...
    testWidgets('fixedSize affects geometry', (WidgetTester tester) async {
      ...
      expect(
        tester.getRect(findMenuPanels().first).size,
      ...
      expect(
        tester.getRect(findMenuPanels().at(1)).size,
