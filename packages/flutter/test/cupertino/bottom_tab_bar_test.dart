...
Future<void> main() async {
  ...
  testWidgets('Active and inactive colors dark mode', (
    ...
    final RenderDecoratedBox renderDecoratedBox = tester.renderObject(find
        .descendant(
  ...
  testWidgets('Tabs respects themes', (WidgetTester tester) async {
    ...
    expect(
      actualActive.text.style!.color,
      isSameColorAs(CupertinoColors.activeBlue.darkColor),
    );
  });

  testWidgets('Use active icon', (WidgetTester tester) async {
    final MemoryImage activeIcon = MemoryImage(
      Uint8List.fromList(kBlueSquarePng),
    );
    final MemoryImage inactiveIcon = MemoryImage(
  ...
  testWidgets('Label of items should be nullable', (WidgetTester tester) async {
    final MemoryImage iconProvider = MemoryImage(
      Uint8List.fromList(kTransparentImage),
    );
  ...
  testWidgets('Hide border hides the top border of the tabBar', (
    ...
    final DecoratedBox decoratedBoxHiddenBorder = tester.widget(
