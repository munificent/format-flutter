...
Finder flying(WidgetTester tester, Finder finder) {
  final ContainerRenderObjectMixin<RenderBox, StackParentData> theater = tester
...
void main() {
  ...
  testWidgets(
    'Popping mid-transition is symmetrical RTL',
    (WidgetTester tester) async {
      await startTransitionBetween(
        tester,
        fromTitle: 'Page 1',
  ...
  testWidgets(
    'DartPerformanceMode is latency mid-animation',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final RenderAnimatedOpacity userMiddleOpacity = tester.element(
        find.byWidget(userMiddle),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      checkOpacity(
        tester,
        flying(tester, find.text('Page 1')),
        0.9404401779174805,
      );
  ...
  testWidgets('Bottom leading fades in place', (WidgetTester tester) async {
    ...
    checkOpacity(
      tester,
      flying(tester, find.text('custom')),
      0.8948725312948227,
    );
    expect(
  ...
  testWidgets('Long title turns into the word back mid transition', (
    ...
    expect(
      flying(tester, find.text('A title too long to fit')),
      findsOneWidget,
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        bottomLargeTitle.text.style!.letterSpacing,
      ...
      expect(
        topBackLabel.text.style!.letterSpacing,
        moreOrLessEquals(0.38890619069337845),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      checkOpacity(
        tester,
        flying(tester, find.text('Page 2')),
        0.29867843724787235,
      );
      expect(
        tester.getTopLeft(flying(tester, find.text('Page 2'))),
  ...
  testWidgets(
    'textScaleFactor is set to 1.0 on transition',
    (WidgetTester tester) async {
      ...
      expect(
        tester.firstWidget<RichText>(
          flying(tester, find.byType(RichText)),
        ).textScaleFactor,
        1,
      );
    },
