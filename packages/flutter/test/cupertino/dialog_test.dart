...
void main() {
  testWidgets('Alert dialog control test', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(createAppWithButtonThatLaunchesDialog(
  ...
  testWidgets('Dialog not barrier dismissible by default', (WidgetTester tester) async {
    ...
    showCupertinoDialog<void>(
      ...
      builder: (BuildContext context) {
        return Container(width: 100.0, height: 100.0, alignment: Alignment.center, child: const Text('Dialog'));
      },
    );
  ...
  testWidgets('Dialog destructive action style', (WidgetTester tester) async {
    await tester.pumpWidget(boilerplate(const CupertinoDialogAction(isDestructiveAction: true, child: Text('Ok'))));
  ...
  testWidgets('Dialog dark theme', (WidgetTester tester) async {
    ...
    expect(find.byType(CupertinoAlertDialog), paints..rect(color: const Color(0xBF1E1E1E)));
  });
      ...
      const MaterialApp(
        home: Material(
          child: CupertinoAlertDialog(
            ...
            actions: <Widget>[CupertinoDialogAction(child: Text('Cancel')), CupertinoDialogAction(child: Text('OK'))],
          ),
        ),
      ),
    );
                    ...
                    TestSemantics(
                      ...
                      children: <TestSemantics>[
                        TestSemantics(
                          ...
                          children: <TestSemantics>[TestSemantics(label: 'The Title'), TestSemantics(label: 'Content')],
                        ),
                        TestSemantics(
                          flags: <SemanticsFlag>[SemanticsFlag.hasImplicitScrolling],
                          children: <TestSemantics>[
                            TestSemantics(flags: <SemanticsFlag>[SemanticsFlag.isButton], label: 'Cancel'),
                            TestSemantics(flags: <SemanticsFlag>[SemanticsFlag.isButton], label: 'OK'),
                          ],
                        ),
                      ],
                    ),
  ...
  testWidgets('Dialog default action style', (WidgetTester tester) async {
    await tester.pumpWidget(boilerplate(const CupertinoDialogAction(isDefaultAction: true, child: Text('Ok'))));
  ...
  testWidgets('Dialog default and destructive action styles', (WidgetTester tester) async {
    await tester.pumpWidget(
      boilerplate(const CupertinoDialogAction(isDefaultAction: true, isDestructiveAction: true, child: Text('Ok'))),
    );
  ...
  testWidgets('Dialog enabled action style', (WidgetTester tester) async {
    await tester.pumpWidget(boilerplate(CupertinoDialogAction(child: const Text('Ok'), onPressed: () {})));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(actionsSectionBox.size.width, okButtonBox.size.width + cancelButtonBox.size.width + dividerWidth);

      expect(actionsSectionBox.size.height, max(okButtonBox.size.height, cancelButtonBox.size.height));
    },
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(createAppWithButtonThatLaunchesDialog(
        dialogBuilder: (BuildContext context) {
          ...
          return CupertinoAlertDialog(
            ...
            actions: const <Widget>[
              CupertinoDialogAction(child: Text('OK')),
              CupertinoDialogAction(isDestructiveAction: true, child: Text('This is too long to fit')),
            ],
            scrollController: scrollController,
          );
        },
      ...
      expect(okButtonBox.size.height + dividerThickness + longButtonBox.size.height, actionsSectionBox.size.height);
    },
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(actionsSectionBox.size.height, 67.83333333333337);
    },
  );
          ...
          return MediaQuery(
            ...
            child: CupertinoAlertDialog(
              ...
              actions: const <Widget>[
                ...
                CupertinoDialogAction(isDestructiveAction: true, child: Text('This button is multi line')),
              ],
              scrollController: scrollController,
            ),
          );
  ...
  testWidgets('Actions section overscroll is painted white.', (WidgetTester tester) async {
    ...
    expect(
      actionsSectionBox,
      paints
        ..path(includes: <Offset>[Offset.zero, Offset(actionsSectionBox.size.width, actionsSectionBox.size.height)]),
    );
  });
    ...
    expect(
      ...
      paints
        ..path(
          ...
          includes: <Offset>[pressedButtonCenter],
          excludes: <Offset>[topDividerCenter, bottomDividerCenter],
        )
        ..path(color: pressedButtonBackgroundColor, excludes: <Offset>[pressedButtonCenter]),
    );
    ...
    expect(
      ...
      paints
        ..path(
          ...
          includes: <Offset>[topDividerCenter, bottomDividerCenter],
          // The background path should not include the tapped button background...
          excludes: <Offset>[pressedButtonCenter],
        )
        // For a pressed button, a dedicated path is painted with a pressed button
        // background color...
        ..path(color: pressedButtonBackgroundColor, includes: <Offset>[pressedButtonCenter]),
    );
  ...
  testWidgets('Default cupertino dialog golden', (WidgetTester tester) async {
        ...
        return MediaQuery(
          ...
          child: const RepaintBoundary(
            child: CupertinoAlertDialog(
              title: Text('Title'),
              content: Text('text'),
              actions: <Widget>[CupertinoDialogAction(child: Text('No')), CupertinoDialogAction(child: Text('OK'))],
            ),
          ),
        );
      },
    ...
    await expectLater(find.byType(CupertinoAlertDialog), matchesGoldenFile('dialog_test.cupertino.default.png'));
  });
  ...
  testWidgets('CupertinoDialogRoute is state restorable', (WidgetTester tester) async {
    await tester.pumpWidget(const CupertinoApp(restorationScopeId: 'app', home: _RestorableDialogTestWidget()));
  ...
  testWidgets('CupertinoAlertDialog scrollbars controllers should be different', (WidgetTester tester) async {
    ...
    final List<CupertinoScrollbar> scrollbars = find
        .descendant(of: find.byType(CupertinoAlertDialog), matching: find.byType(CupertinoScrollbar))
        .evaluate()
...
Widget createAppWithButtonThatLaunchesDialog({required WidgetBuilder dialogBuilder, bool? useMaterial3}) {
  return MaterialApp(
...
Widget createAppWithCenteredButton(Widget child) {
  return MaterialApp(home: Material(child: Center(child: ElevatedButton(onPressed: null, child: child))));
}
    ...
    return CupertinoDialogRoute<void>(
      ...
      builder: (BuildContext context) {
        return const CupertinoAlertDialog(
          title: Text('Title'),
          content: Text('Content'),
          actions: <Widget>[CupertinoDialogAction(child: Text('Yes')), CupertinoDialogAction(child: Text('No'))],
        );
      },
    );
  }
