...
void main() {
  ...
  testWidgets(
    'Dialog not barrier dismissible by default',
  ...
  testWidgets(
    'Dialog configurable to be barrier dismissible',
    (WidgetTester tester) async {
      await tester.pumpWidget(createAppWithCenteredButton(const Text('Go')));
  ...
  testWidgets('Dialog destructive action style', (WidgetTester tester) async {
    await tester.pumpWidget(boilerplate(
      const CupertinoDialogAction(isDestructiveAction: true, child: Text('Ok')),
    ));

    final DefaultTextStyle widget = tester.widget(
  ...
  testWidgets('Dialog default action style', (WidgetTester tester) async {
    ...
    expect(
      widget.style.color!.withAlpha(255),
  ...
  testWidgets('Dialog default action style', (WidgetTester tester) async {
    await tester.pumpWidget(boilerplate(
      const CupertinoDialogAction(isDefaultAction: true, child: Text('Ok')),
    ));
  ...
  testWidgets('Dialog disabled action style', (WidgetTester tester) async {
    await tester.pumpWidget(
      boilerplate(const CupertinoDialogAction(child: Text('Ok'))),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        ...
        equals(const Size(270.0, hasIssue99933 ? 133 : 132.0)),
      );
      expect(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        tester.getCenter(
          find.widgetWithText(CupertinoDialogAction, 'Three'),
        ).dx,
        equals(400.0),
      );
      expect(
        tester.getCenter(
          find.widgetWithText(CupertinoDialogAction, 'Chocolate Brownies'),
        ).dx,
        equals(400.0),
      );
      expect(
      ...
      expect(
        tester.getSize(
          find.widgetWithText(CupertinoDialogAction, 'One'),
        ).height,
        equals(98.0),
      );
      expect(
        tester.getSize(
          find.widgetWithText(CupertinoDialogAction, 'Two'),
        ).height,
        equals(98.0),
      );
      expect(
  ...
  testWidgets('Title Section is empty, Button section is not empty.', (
    ...
    final Finder contentSectionFinder = find.byElementPredicate(
      (Element element) {
  ...
  testWidgets(
    'Actions section height for 1 button is height of button.',
    (WidgetTester tester) async {
      final ScrollController scrollController = ScrollController();
      await tester.pumpWidget(createAppWithButtonThatLaunchesDialog(
        dialogBuilder: (BuildContext context) {
      ...
      final RenderBox okButtonBox = findActionButtonRenderBoxByTitle(
        tester,
        'OK',
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final RenderBox cancelButtonBox = findActionButtonRenderBoxByTitle(
        tester,
        'Cancel',
      );
      final RenderBox actionsSectionBox = findScrollableActionsSectionRenderBox(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final RenderBox option1ButtonBox = findActionButtonRenderBoxByTitle(
        tester,
        'Option 1',
      );
      final RenderBox option2ButtonBox = findActionButtonRenderBoxByTitle(
        tester,
        'Option 2',
      );
      final RenderBox actionsSectionBox = findScrollableActionsSectionRenderBox(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final RenderBox firstButtonBox = findActionButtonRenderBoxByTitle(
        tester,
        'Option 1',
      );
      final RenderBox secondButtonBox = findActionButtonRenderBoxByTitle(
        tester,
        'Option 2',
      );
      final RenderBox actionsSectionBox = findScrollableActionsSectionRenderBox(
      ...
      final TestGesture gesture = await tester.press(
        find.widgetWithText(CupertinoDialogAction, 'Option 2'),
      );
      await tester.pump();
  ...
  testWidgets('Dialog widget insets by MediaQuery viewInsets', (
    ...
    final Rect placeholderRectWithoutInsets = tester.getRect(
  ...
  testWidgets(
    'CupertinoAlertDialog scrollbars controllers should be different',
    (WidgetTester tester) async {
