...
void main() {
  ...
  void uiTestGroup() {
    testWidgets("doesn't invoke anything without user interaction", (WidgetTester tester) async {
      await tester.pumpWidget(CupertinoApp(
        home: CustomScrollView(
          slivers: <Widget>[CupertinoSliverRefreshControl(builder: mockHelper.builder), buildAListOfStuff()],
        ),
      ));
    ...
    testWidgets('drag past threshold triggers refresh task', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(CupertinoApp(
        home: CustomScrollView(
          slivers: <Widget>[
            CupertinoSliverRefreshControl(builder: mockHelper.builder, onRefresh: mockHelper.refreshTask),
            buildAListOfStuff(),
          ],
        ),
      ));
    ...
    testWidgets('refreshing task keeps the sliver expanded forever until completes with error', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('expanded refreshing sliver scrolls normally', (WidgetTester tester) async {
      ...
      expect(tester.getRect(find.widgetWithText(Center, '-1')), const Rect.fromLTRB(0.0, 0.0, 800.0, 150.0));
      ...
      if (debugDefaultTargetPlatformOverride == TargetPlatform.macOS) {
        expect(tester.getTopLeft(find.widgetWithText(Center, '-1', skipOffstage: false)).dy, moreOrLessEquals(-210.0));
        expect(
        ...
        expect(tester.getTopLeft(find.widgetWithText(Center, '0')).dy, moreOrLessEquals(-115.38461538461536));
      }
      ...
      expect(tester.getRect(find.widgetWithText(Center, '-1')), const Rect.fromLTRB(0.0, 0.0, 800.0, 60.0));
      expect(tester.getRect(find.widgetWithText(Center, '0')), const Rect.fromLTRB(0.0, 60.0, 800.0, 260.0));
    }, variant: const TargetPlatformVariant(<TargetPlatform>{TargetPlatform.iOS, TargetPlatform.macOS}));
    ...
    testWidgets('expanded refreshing sliver goes away when done', (WidgetTester tester) async {
      ...
      expect(tester.getRect(find.widgetWithText(Center, '0')), const Rect.fromLTRB(0.0, 0.0, 800.0, 200.0));
    }, variant: const TargetPlatformVariant(<TargetPlatform>{TargetPlatform.iOS, TargetPlatform.macOS}));
    ...
    testWidgets('builder still called when sliver snapped back more than 90%', (WidgetTester tester) async {
      ...
      if (debugDefaultTargetPlatformOverride == TargetPlatform.macOS) {
        ...
        expect(tester.getRect(find.widgetWithText(Center, '0')).top, moreOrLessEquals(3.0, epsilon: 4e-1));
        expect(tester.getRect(find.widgetWithText(Center, '-1')).height, moreOrLessEquals(3.0, epsilon: 4e-1));
        expect(mockHelper.invocations, contains(matchesBuilder(
          refreshState: RefreshIndicatorMode.inactive,
    ...
    testWidgets('retracting sliver during done cannot be pulled to refresh again until fully retracted', (
      WidgetTester tester,
    ) async {
      mockHelper.refreshIndicator = const Center(child: Text('-1'));
      ...
      if (debugDefaultTargetPlatformOverride == TargetPlatform.macOS) {
        ...
        expect(tester.getBottomLeft(find.widgetWithText(Center, '-1')).dy, moreOrLessEquals(90.13497854600749));
      } else {
        expect(mockHelper.invocations, contains(matchesBuilder(
          refreshState: RefreshIndicatorMode.done,
        ...
        expect(tester.getBottomLeft(find.widgetWithText(Center, '-1')).dy, moreOrLessEquals(91.311809131992776));
      }
    ...
    testWidgets('sliver held in overscroll when task finishes completes normally', (WidgetTester tester) async {
      mockHelper.refreshIndicator = const Center(child: Text('-1'));
      ...
      expect(tester.getRect(find.widgetWithText(Center, '0')), const Rect.fromLTRB(0.0, 150.0, 800.0, 350.0));
    ...
    testWidgets('sliver scrolled away when task completes properly removes itself', (WidgetTester tester) async {
      if (testListLength < 4) {
    ...
    testWidgets("don't do anything unless it can be overscrolled at the start of the list", (
      WidgetTester tester,
    ) async {
      mockHelper.refreshIndicator = const Center(child: Text('-1'));
    ...
    testWidgets('without an onRefresh, builder is called with arm for one frame then sliver goes away', (
      WidgetTester tester,
    ) async {
      mockHelper.refreshIndicator = const Center(child: Text('-1'));
    ...
    testWidgets('Should not crash when dragged', (WidgetTester tester) async {
      await tester.pumpWidget(CupertinoApp(
        home: CustomScrollView(
          ...
          slivers: <Widget>[
            CupertinoSliverRefreshControl(onRefresh: () async => Future<void>.delayed(const Duration(days: 2000))),
          ],
        ),
      ));
    ...
    testWidgets('properly displays when the refresh sliver is behind the large title nav bar sliver', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(CupertinoApp(
        home: CustomScrollView(
  ...
  void stateMachineTestGroup() {
    ...
    testWidgets('goes to armed the frame it passes the threshold', (WidgetTester tester) async {
      await tester.pumpWidget(CupertinoApp(
        home: CustomScrollView(
          slivers: <Widget>[
            CupertinoSliverRefreshControl(builder: mockHelper.builder, refreshTriggerPullDistance: 80.0),
            buildAListOfStuff(),
          ],
        ),
      ));
    ...
    testWidgets('goes to refresh the frame it crossed back the refresh threshold', (WidgetTester tester) async {
      await tester.pumpWidget(CupertinoApp(
        home: CustomScrollView(
          slivers: <Widget>[
            CupertinoSliverRefreshControl(
    ...
    testWidgets('goes to done internally as soon as the task finishes', (WidgetTester tester) async {
      await tester.pumpWidget(CupertinoApp(
        home: CustomScrollView(
          slivers: <Widget>[
            CupertinoSliverRefreshControl(builder: mockHelper.builder, onRefresh: mockHelper.refreshTask),
      ...
      expect(tester.getRect(find.widgetWithText(SizedBox, '0')), const Rect.fromLTRB(0.0, 60.0, 800.0, 260.0));
    ...
    testWidgets('goes back to inactive when retracting back past 10% of arming distance', (WidgetTester tester) async {
      await tester.pumpWidget(CupertinoApp(
        home: CustomScrollView(
          slivers: <Widget>[
            CupertinoSliverRefreshControl(builder: mockHelper.builder, onRefresh: mockHelper.refreshTask),
      ...
      if (debugDefaultTargetPlatformOverride == TargetPlatform.macOS) {
        ...
        expect(tester.getTopLeft(find.widgetWithText(SizedBox, '0')).dy, moreOrLessEquals(27.944444444444457));
      }
      ...
      if (debugDefaultTargetPlatformOverride == TargetPlatform.macOS) {
        ...
        expect(tester.getTopLeft(find.widgetWithText(SizedBox, '0')).dy, moreOrLessEquals(9.313890708161875));
      }
      expect(
        CupertinoSliverRefreshControl.state(tester.element(find.byType(LayoutBuilder))),
        RefreshIndicatorMode.inactive,
    ...
    testWidgets('goes back to inactive if already scrolled away when task completes', (WidgetTester tester) async {
      await tester.pumpWidget(CupertinoApp(
        home: CustomScrollView(
          slivers: <Widget>[
            CupertinoSliverRefreshControl(builder: mockHelper.builder, onRefresh: mockHelper.refreshTask),
      ...
      expect(tester.getTopLeft(find.widgetWithText(SizedBox, '0')).dy, moreOrLessEquals(indicatorDestinationPosition));
      expect(
        CupertinoSliverRefreshControl.state(tester.element(find.byType(LayoutBuilder, skipOffstage: false))),
        RefreshIndicatorMode.refresh,
      );
    ...
    testWidgets("don't have to build any indicators or occupy space during refresh", (WidgetTester tester) async {
      mockHelper.refreshIndicator = const Center(child: Text('-1'));
    ...
    testWidgets('buildRefreshIndicator progress', (WidgetTester tester) async {
      await tester.pumpWidget(CupertinoApp(
        home: Builder(
          builder: (BuildContext context) {
            return CupertinoSliverRefreshControl.buildRefreshIndicator(context, RefreshIndicatorMode.drag, 10, 100, 10);
          },
        ),
      ));
      ...
      await tester.pumpWidget(CupertinoApp(
        home: Builder(
          builder: (BuildContext context) {
            return CupertinoSliverRefreshControl.buildRefreshIndicator(context, RefreshIndicatorMode.drag, 26, 100, 10);
          },
        ),
      ));
  ...
  testWidgets('Does not crash when paintExtent > remainingPaintExtent', (WidgetTester tester) async {
