...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      DefaultTextStyle textStyle = tester.widget(
        find.widgetWithText(DefaultTextStyle, 'Child 1'),
      );
      IconTheme iconTheme = tester.widget(
        find.widgetWithIcon(IconTheme, const IconData(1)),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      IconThemeData iconTheme = IconTheme.of(
        tester.element(find.byIcon(const IconData(1))),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset centerOfSegmentedControl = tester.getCenter(
        find.text('Child 1'),
      );
