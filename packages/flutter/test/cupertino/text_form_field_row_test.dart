...
void main() {
  ...
  testWidgets('Passes textAlignVertical to underlying CupertinoTextField', (
    ...
    await tester.pumpWidget(CupertinoApp(
      home: Center(
        child: CupertinoTextFormFieldRow(textAlignVertical: textAlignVertical),
      ),
    ));
  ...
  testWidgets('Passes textInputAction to underlying CupertinoTextField', (
    ...
    await tester.pumpWidget(CupertinoApp(
      home: Center(
        child: CupertinoTextFormFieldRow(textInputAction: TextInputAction.next),
      ),
    ));
  ...
  testWidgets('Passes onEditingComplete to underlying CupertinoTextField', (
    ...
    await tester.pumpWidget(CupertinoApp(
      home: Center(
        child: CupertinoTextFormFieldRow(onEditingComplete: onEditingComplete),
      ),
    ));
