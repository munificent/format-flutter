...
void main() {
  group('Countdown timer picker', () {
    ...
    testWidgets('background color default value', (WidgetTester tester) async {
      await tester.pumpWidget(CupertinoApp(
        home: CupertinoTimerPicker(onTimerDurationChanged: (_) {}),
      ));

      final Iterable<CupertinoPicker> pickers =
          tester.allWidgets.whereType<CupertinoPicker>();
      expect(
        pickers.any((CupertinoPicker picker) => picker.backgroundColor != null),
        false,
      );
    });
    ...
    testWidgets(
      'specified item extent value is applied',
      (WidgetTester tester) async {
        await tester.pumpWidget(CupertinoApp(
          home: CupertinoTimerPicker(
            itemExtent: 42,
        ...
        final Iterable<CupertinoPicker> pickers =
            tester.allWidgets.whereType<CupertinoPicker>();
        expect(
          pickers.any((CupertinoPicker picker) => picker.itemExtent != 42),
          false,
        );
      },
    );
    ...
    testWidgets(
      'columns are ordered correctly when text direction is rtl',
      (WidgetTester tester) async {
        await tester.pumpWidget(CupertinoApp(
          home: Directionality(
  ...
  group('Date picker', () {
    ...
    testWidgets('background color default value', (WidgetTester tester) async {
      await tester.pumpWidget(
        CupertinoApp(home: CupertinoDatePicker(onDateTimeChanged: (_) {})),
      );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        await tester.pumpWidget(CupertinoApp(
          home: CupertinoDatePicker(itemExtent: 55, onDateTimeChanged: (_) {}),
        ));

        final Iterable<CupertinoPicker> pickers =
            tester.allWidgets.whereType<CupertinoPicker>();
        expect(
          pickers.any((CupertinoPicker picker) => picker.itemExtent != 55),
          false,
        );
      },
    );
    ...
    testWidgets(
      'datetime picker has expected string',
      (WidgetTester tester) async {
        await tester.pumpWidget(CupertinoApp(
          home: Center(
            child: SizedBox(
    ...
    testWidgets(
      'monthYear picker has expected string',
      (WidgetTester tester) async {
        await tester.pumpWidget(CupertinoApp(
          home: Center(
            child: SizedBox(
    ...
    testWidgets(
      'width of picker in monthYear mode is consistent',
      (WidgetTester tester) async {
        await tester.pumpWidget(CupertinoApp(
          home: Center(
            child: SizedBox(
    ...
    testWidgets('wheel does not bend outwards', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(CupertinoApp(
        home: CupertinoPageScaffold(
          child: Center(
            child: SizedBox(height: 200.0, width: 300.0, child: dateWidget),
          ),
        ),
      ));
      ...
      await tester.pumpWidget(CupertinoApp(
        home: CupertinoPageScaffold(
          child: Center(
            child: SizedBox(height: 200.0, width: 3000.0, child: dateWidget),
          ),
        ),
      ));
          ...
          child: SizedBox(
            ...
            child: CupertinoDatePicker(
              ...
              onDateTimeChanged: (DateTime newDate) {
                ...
                expect(
                  newDate.isAtSameMomentAs(minimum) || newDate.isAfter(minimum),
                  isTrue,
                );
                expect(
    ...
    testWidgets(
      'picker persists am/pm value when scrolling hours',
      (WidgetTester tester) async {
        late DateTime date;
        await tester.pumpWidget(CupertinoApp(
          home: Center(
    ...
    testWidgets(
      'monthYear DatePicker displays the date in correct order',
      (WidgetTester tester) async {
  ...
  testWidgets(
    'TimerPicker has intrinsic width and height',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        _buildPicker(onSelectedItemChanged: onSelectedItemChanged),
      );
  ...
  testWidgets('DatePicker adapts to MaterialApp dark mode', (
    ...
    expect(
      paragraph.text.style!.color.toString().contains('UNRESOLVED'),
      isFalse,
    );
