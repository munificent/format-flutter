...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        ...
        paints..rrect(color: _kScrollbarColor.color),
      );
  ...
  testWidgets('Scrollbar dark mode', (WidgetTester tester) async {
    ...
    expect(
      find.byType(CupertinoScrollbar),
      paints..rrect(color: _kScrollbarColor.darkColor),
    );
  });

  testWidgets(
    'Scrollbar thumb can be dragged with long press',
    (WidgetTester tester) async {
