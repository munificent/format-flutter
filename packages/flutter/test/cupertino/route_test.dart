...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final List<Element> titles = tester.elementList(
        find.text('An iPod'),
      ).toList()
              ...
              child: Center(
                child: Padding(
                  ...
                  child: Hero(
                    ...
                    transitionOnUserGestures: true,
                    child:
                        SizedBox(key: container, height: 150.0, width: 150.0),
                  ),
                ),
              ),
            );
  ...
  testWidgets(
    'CupertinoPage can toggle MaintainState',
    (WidgetTester tester) async {
