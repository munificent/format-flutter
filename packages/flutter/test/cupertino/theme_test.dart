...
void main() {
  ...
  testWidgets('Theme attributes cascade', (WidgetTester tester) async {
    final CupertinoThemeData theme =
        await testTheme(tester, const CupertinoThemeData(primaryColor: CupertinoColors.systemRed));
  ...
  testWidgets('copyWith works', (WidgetTester tester) async {
    const CupertinoThemeData originalTheme = CupertinoThemeData(brightness: Brightness.dark, applyThemeToAll: true);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Color darkColor = (await testIconTheme(tester, themeData.copyWith(brightness: Brightness.dark))).color!;
  ...
  testWidgets('CupertinoTheme diagnostics', (WidgetTester tester) async {
    ...
    expect(setEquals(description, <String>{
      'brightness',
      'primaryColor',
  ...
  testWidgets('CupertinoTheme.toStringDeep uses single-line style', (WidgetTester tester) async {
    ...
    expect(
      const CupertinoTheme(data: CupertinoThemeData(primaryColor: Color(0x00000000)), child: SizedBox())
          .toStringDeep()
          .trimRight(),
      isNot(contains('\n')),
    );
