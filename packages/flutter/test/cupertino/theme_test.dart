...
void main() {
    ...
    (WidgetTester tester) async {
      ...
      theme = await testTheme(
        ...
        const CupertinoThemeData(
          ...
          barBackgroundColor: Color(0x11223344),
          textTheme:
              CupertinoTextThemeData(textStyle: TextStyle(fontFamily: 'Flat')),
        ),
      );
  ...
  testWidgets('copyWith works', (WidgetTester tester) async {
    ...
    final CupertinoThemeData theme = await testTheme(tester, originalTheme
        .copyWith(
  ...
  testWidgets(
    'IconTheme.of creates a dependency on iconTheme',
    (WidgetTester tester) async {
  ...
  testWidgets('CupertinoTheme diagnostics', (WidgetTester tester) async {
    ...
    final Set<String> description = builder.properties.map(
      (DiagnosticsNode node) => node.name.toString(),
    ).toSet();
  ...
  void colorMatches(
    ...
    CupertinoDynamicColor expectedDynamicColor,
  ) {
