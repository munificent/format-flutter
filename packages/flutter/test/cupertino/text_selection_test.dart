...
void main() {
  ...
  bool appearsEnabled(WidgetTester tester, String text) {
    final CupertinoButton button = tester.widget<CupertinoButton>(
      find.ancestor(of: find.text(text), matching: find.byType(CupertinoButton)),
    );
  ...
  group('cupertino handles', () {
    testWidgets('draws transparent handle correctly', (WidgetTester tester) async {
            ...
            builder: (BuildContext context) {
              return Container(
                ...
                child: Padding(
                  ...
                  child: FittedBox(
                    child: cupertinoTextSelectionControls.buildHandle(context, TextSelectionHandleType.right, 10.0),
                  ),
                ),
              );
            },
      ...
      await expectLater(find.byType(RepaintBoundary), matchesGoldenFile('text_selection.handle.transparent.png'));
    });
  });
