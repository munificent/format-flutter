...
class _LongCupertinoLocalizationsDelegate
  ...
  @override
  Future<_LongCupertinoLocalizations> load(
    Locale locale,
...
void main() {
  ...
  bool appearsEnabled(WidgetTester tester, String text) {
    final CupertinoButton button = tester.widget<CupertinoButton>(find.ancestor(
      of: find.text(text),
  ...
  group('Text selection menu overflow (iOS)', () {
        ...
        await tester.pumpWidget(CupertinoApp(
          home: Directionality(
            ...
            child: MediaQuery(
              ...
              child: Center(
                child:
                    CupertinoTextField(autofocus: true, controller: controller),
              ),
            ),
          ),
        ));
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          selectionOffset.dy + 7.0 + 43.0 + 8.0 - 8.0,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Iterable<RenderBox> handles = tester.renderObjectList(find
          .descendant(
            of: find.byType(Overlay),
            matching: find.byType(CustomPaint),
          ));
