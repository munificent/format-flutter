...
void main() {
  ...
  testWidgets(
    'Switch is using default thumb color',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const Directionality(
          textDirection: TextDirection.ltr,
  ...
  testWidgets(
    'Switch is using thumb color when set',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset cupertinoSwitch = tester.getCenter(
        find.byType(CupertinoSwitch),
      );
  ...
  testWidgets(
    'CupertinoSwitch.onFocusChange callback',
    (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode(debugLabel: 'CupertinoSwitch');
      bool focused = false;
      await tester.pumpWidget(Directionality(
