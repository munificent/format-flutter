...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(boilerplate(CupertinoActionSheetAction(
      ...
      final DefaultTextStyle widget = tester.widget(
        find.widgetWithText(DefaultTextStyle, 'Ok'),
      );
  ...
  testWidgets('Action sheet dark mode', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      createAppWithButtonThatLaunchesActionSheet(StatefulBuilder(
  ...
  testWidgets('Action section is scrollable', (WidgetTester tester) async {
    ...
    expect(
      tester.getCenter(
        find.widgetWithText(CupertinoActionSheetAction, 'One'),
      ).dx,
      equals(400.0),
    );
    expect(
    ...
    expect(
      tester.getCenter(
        find.widgetWithText(CupertinoActionSheetAction, 'Three'),
      ).dx,
      equals(400.0),
    );
    expect(
      tester.getCenter(
        find.widgetWithText(CupertinoActionSheetAction, 'Four'),
      ).dx,
      equals(400.0),
    );
    expect(
      tester.getCenter(
        find.widgetWithText(CupertinoActionSheetAction, 'Five'),
      ).dx,
      equals(400.0),
    );
  ...
  testWidgets('Content section is scrollable', (WidgetTester tester) async {
    ...
    expect(
      tester.getSize(find.byType(CupertinoActionSheet)).height,
      screenHeight,
    );
  });
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        findScrollableActionsSectionRenderBox(tester).size.height,
  ...
  testWidgets('Enter/exit animation is correct', (WidgetTester tester) async {
    ...
    expect(
      tester.getTopLeft(find.byType(CupertinoActionSheet)).dy,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final ScrollController actionScrollController = ScrollController();
      await tester.pumpWidget(
        createAppWithButtonThatLaunchesActionSheet(Builder(
          builder: (BuildContext context) {
            return MediaQuery(
              data: MediaQuery.of(context).copyWith(textScaleFactor: 3.0),
              child: CupertinoActionSheet(
