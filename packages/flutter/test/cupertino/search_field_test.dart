...
void main() {
  testWidgets('default search field has a border radius', (WidgetTester tester) async {
    ...
    final BoxDecoration decoration = tester.widget<DecoratedBox>(
      find.descendant(of: find.byType(CupertinoSearchTextField), matching: find.byType(DecoratedBox)),
  ...
  testWidgets('decoration overrides default background color', (WidgetTester tester) async {
    await tester.pumpWidget(
      const CupertinoApp(
        home: Center(child: CupertinoSearchTextField(decoration: BoxDecoration(color: Color.fromARGB(1, 1, 1, 1)))),
      ),
    );
  ...
  testWidgets('decoration overrides default border radius', (WidgetTester tester) async {
    await tester.pumpWidget(
      const CupertinoApp(
        home: Center(child: CupertinoSearchTextField(decoration: BoxDecoration(borderRadius: BorderRadius.zero))),
      ),
    );
  ...
  testWidgets('text entries are padded by default', (WidgetTester tester) async {
    await tester.pumpWidget(
      CupertinoApp(home: Center(child: CupertinoSearchTextField(controller: TextEditingController(text: 'initial')))),
    );
  ...
  testWidgets('can change keyboard type', (WidgetTester tester) async {
    await tester.pumpWidget(
      const CupertinoApp(home: Center(child: CupertinoSearchTextField(keyboardType: TextInputType.number))),
    );
  ...
  testWidgets('can control text content via controller', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(CupertinoApp(home: Center(child: CupertinoSearchTextField(controller: controller))));
  ...
  testWidgets('prefix widget is in front of the text', (WidgetTester tester) async {
    await tester.pumpWidget(
      CupertinoApp(home: Center(child: CupertinoSearchTextField(controller: TextEditingController(text: 'input')))),
    );
  ...
  testWidgets('suffix widget is after the text', (WidgetTester tester) async {
    await tester.pumpWidget(
      CupertinoApp(home: Center(child: CupertinoSearchTextField(controller: TextEditingController(text: 'Hi')))),
    );
  ...
  testWidgets('prefix widget visibility', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      const CupertinoApp(
        home: Center(child: CupertinoSearchTextField(prefixIcon: SizedBox(key: prefixIcon, width: 50, height: 50))),
      ),
    );
  ...
  testWidgets('suffix widget respects visibility mode', (WidgetTester tester) async {
    await tester.pumpWidget(
      const CupertinoApp(home: Center(child: CupertinoSearchTextField(suffixMode: OverlayVisibilityMode.notEditing))),
    );
  ...
  testWidgets('clear button shows with right visibility mode', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(CupertinoApp(
      home: Center(
        child:
            CupertinoSearchTextField(controller: controller, placeholder: 'placeholder does not affect clear button'),
      ),
    ));
  ...
  testWidgets('custom suffix onTap overrides default clearing behavior', (WidgetTester tester) async {
    final TextEditingController controller = TextEditingController(text: 'Text');
    await tester.pumpWidget(
      CupertinoApp(home: Center(child: CupertinoSearchTextField(controller: controller, onSuffixTap: () {}))),
    );
  ...
  testWidgets('autocorrect is properly forwarded to the inner text field', (WidgetTester tester) async {
    await tester.pumpWidget(const CupertinoApp(home: Center(child: CupertinoSearchTextField(autocorrect: false))));
  ...
  testWidgets('enabled is properly forwarded to the inner text field', (WidgetTester tester) async {
    await tester.pumpWidget(const CupertinoApp(home: Center(child: CupertinoSearchTextField(enabled: false))));
  ...
  testWidgets('autofocus:true gives focus to the widget', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      CupertinoApp(home: Center(child: CupertinoSearchTextField(focusNode: focusNode, autofocus: true))),
    );
  ...
  testWidgets('smartQuotesType is properly forwarded to the inner text field', (WidgetTester tester) async {
    await tester.pumpWidget(
      const CupertinoApp(home: Center(child: CupertinoSearchTextField(smartQuotesType: SmartQuotesType.disabled))),
    );
  ...
  testWidgets('smartDashesType is properly forwarded to the inner text field', (WidgetTester tester) async {
    await tester.pumpWidget(
      const CupertinoApp(home: Center(child: CupertinoSearchTextField(smartDashesType: SmartDashesType.disabled))),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const CupertinoApp(home: Center(child: CupertinoSearchTextField(enableIMEPersonalizedLearning: false))),
      );
