...
void main() {
  testWidgets('default search field has a border radius', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('can change keyboard type', (WidgetTester tester) async {
    await tester.pumpWidget(
      const CupertinoApp(
        home: Center(
          child: CupertinoSearchTextField(keyboardType: TextInputType.number),
        ),
      ),
    );
  ...
  testWidgets('suffix widget respects visibility mode', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const CupertinoApp(
  ...
  testWidgets('clear button shows with right visibility mode', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const CupertinoApp(
          home: Center(child: CupertinoSearchTextField(autocorrect: false)),
        ),
      );

      final CupertinoTextField textField = tester.widget(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const CupertinoApp(
          home: Center(child: CupertinoSearchTextField(enabled: false)),
        ),
      );
  ...
  testWidgets('autofocus:true gives focus to the widget', (
    ...
    await tester.pumpWidget(CupertinoApp(
      home: Center(
        child: CupertinoSearchTextField(focusNode: focusNode, autofocus: true),
      ),
    ));
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const CupertinoApp(
          home: Center(
            child:
                CupertinoSearchTextField(enableIMEPersonalizedLearning: false),
          ),
        ),
      );
