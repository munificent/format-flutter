    ...
    await tester.pumpWidget(CupertinoApp(
      ...
      home: Builder(
        builder: (BuildContext context) {
          color =
              CupertinoTheme.of(context).primaryColor as CupertinoDynamicColor;
