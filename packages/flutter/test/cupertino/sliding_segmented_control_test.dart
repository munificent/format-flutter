...
void main() {
  ...
  testWidgets('SegmentedControl dark mode', (WidgetTester tester) async {
    ...
    final BoxDecoration decorationDark = tester.widget<Container>(find
        .descendant(
          of: find.byType(UnconstrainedBox),
          matching: find.byType(Container),
        )).decoration! as BoxDecoration;
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      double getChildOpacityByName(String childName) {
        return tester.renderObject<RenderAnimatedOpacity>(find.ancestor(
