...
void main() {
  ...
  testWidgets('Activity indicator 100% in progress', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Center(
      child: RepaintBoundary(
        key: key,
        child: const ColoredBox(color: CupertinoColors.white, child: CupertinoActivityIndicator.partiallyRevealed()),
      ),
    ));
  ...
  testWidgets('Can specify color', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Center(
      child: RepaintBoundary(
        ...
        child: const ColoredBox(
          color: CupertinoColors.white,
          child: CupertinoActivityIndicator(animating: false, color: Color(0xFF5D3FD3), radius: 100),
        ),
      ),
    ));
...
Widget buildCupertinoActivityIndicator([bool? animating]) {
  return MediaQuery(data: const MediaQueryData(), child: CupertinoActivityIndicator(animating: animating ?? true));
}
