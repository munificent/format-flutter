    ...
    await tester.pumpWidget(CupertinoApp(
      home: MediaQuery(
        ...
        child: CupertinoPageScaffold(
          navigationBar: const CupertinoNavigationBar(middle: Text('Title'), backgroundColor: Color(0x11111111)),
          child: CupertinoScrollbar(child: ListView(children: const <Widget>[SizedBox(width: 4000, height: 4000)])),
        ),
      ),
    ));
