...
class PathBoundsMatcher extends Matcher {
  ...
  Description describeMismatch(
    ...
    final Iterable<String> descriptions = map.entries.map<String>(
      (MapEntry<Matcher, dynamic> entry) => entry.key.describeMismatch(
        entry.value,
        StringDescription(),
        matchState,
        verbose,
    ...
    return description
      ..add('mismatch Rect: ${item.getBounds()}').addAll(
        ': ',
        ', ',
        '. ',
        descriptions,
...
class PathPointsMatcher extends Matcher {
  ...
  Description describeMismatch(
    ...
    final Description desc = super.describeMismatch(
      item,
      mismatchDescription,
      matchState,
      verbose,
...
void main() {
  ...
  Offset textOffsetToBottomLeftPosition(WidgetTester tester, int offset) {
    ...
    final List<TextSelectionPoint> endpoints = globalize(renderEditable
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        CupertinoApp(home: CupertinoTextField(focusNode: focusNode)),
      );
    ...
    (WidgetTester tester) async {
      ...
      expect(
        ...
        const Size(
          200,
          31,
        ), // 31 is the height of the default font + padding etc.
      );
    },
  );
    ...
    (WidgetTester tester) async {
      ...
      expect(
        ...
        const Size(
          200,
          31,
        ), // 31 is the height of the default font (17) + decoration (12).
      );
    },
  );
  ...
  testWidgets('default text field has a border', (WidgetTester tester) async {
    await tester.pumpWidget(
      const CupertinoApp(home: Center(child: CupertinoTextField())),
    );

    BoxDecoration decoration = tester.widget<DecoratedBox>(find.descendant(
    ...
    decoration = tester.widget<DecoratedBox>(find.descendant(
      of: find.byType(CupertinoTextField),
      matching: find.byType(DecoratedBox),
    )).decoration as BoxDecoration;
  ...
  testWidgets('decoration can be overridden', (WidgetTester tester) async {
    await tester.pumpWidget(
      const CupertinoApp(
        home: Center(child: CupertinoTextField(decoration: null)),
      ),
    );
  ...
  testWidgets('font style controls intrinsic height no-strut', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const CupertinoApp(
        home:
            Center(child: CupertinoTextField(strutStyle: StrutStyle.disabled)),
      ),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const CupertinoApp(
          home: Center(child: CupertinoTextField(maxLines: null)),
        ),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(CupertinoApp(
        home: Column(
          children: <Widget>[
            CupertinoTextField(controller: controller, readOnly: true),
          ],
        ),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(CupertinoApp(
        home: Center(
          child: CupertinoTextField(controller: controller, maxLines: 2),
        ),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      // on Mac.
      await tester.tapAt(
        textOffsetToPosition(tester, index) - const Offset(1.0, 0.0),
      );
      await tester.pump(const Duration(milliseconds: 50));
      await tester.tapAt(textOffsetToPosition(tester, index));
      await tester.pumpAndSettle();
  ...
  testWidgets('Readonly text field does not have tap action', (
    ...
    await tester.pumpWidget(
      const CupertinoApp(
        home: Center(child: CupertinoTextField(maxLength: 10, readOnly: true)),
      ),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(CupertinoApp(
        home: Center(
          child: CupertinoTextField(controller: controller, obscureText: true),
        ),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset textFieldStart = tester.getCenter(
        find.byType(CupertinoTextField),
      );
      ...
      final Offset textFieldEnd = tester.getTopRight(
        find.byType(CupertinoTextField),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      if (kIsWeb) {
        ...
        expect(
          find.byType(CupertinoButton),
          findsNWidgets(isTargetPlatformMobile ? 2 : 1),
        );
      }
      expect(controller.selection.isCollapsed, isTrue);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        lastCharEndpoint[0].point.dx,
        moreOrLessEquals(1094.73, epsilon: 0.25),
      );
      ...
      expect(
        lastCharEndpoint[0].point.dx,
        moreOrLessEquals(785.40, epsilon: 1),
      );
      ...
      expect(
        ...
        moreOrLessEquals(-310.30, epsilon: 1),
      );
    },
    variant: TargetPlatformVariant.all(
      excluding: <TargetPlatform>{TargetPlatform.iOS, TargetPlatform.macOS},
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        lastCharEndpoint[0].point.dx,
        moreOrLessEquals(784.73, epsilon: 0.25),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      if (isContextMenuProvidedByPlatform) {
        ...
        expect(
          find.byType(CupertinoButton),
          isTargetPlatformMobile ? findsNWidgets(2) : findsNWidgets(1),
        );
      }
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset textEndPos = textOffsetToPosition(
        tester,
        11,
  ...
  testWidgets('Mouse long press does not show handles nor toolbar', (
    WidgetTester tester,
  ) async {
    final TextEditingController controller = TextEditingController(
      text: 'abc def ghi',
    ...
    // Long press to trigger the text field.
    final Offset textFieldPos = tester.getCenter(
      find.byType(CupertinoTextField),
    );
    final TestGesture gesture =
        await tester.startGesture(textFieldPos, kind: PointerDeviceKind.mouse);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final TestGesture gesture =
          await tester.startGesture(textEndPos, kind: PointerDeviceKind.mouse);
      await tester.pump(const Duration(milliseconds: 50));
      await gesture.up();
      await tester.pump();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(CupertinoApp(
        home: Center(
          child: CupertinoTextField(enabled: false, onTap: () => tapCount++),
        ),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(CupertinoApp(
        home: Center(
          child: CupertinoTextField(enabled: false, focusNode: focusNode),
        ),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      Offset textFieldTopLeft = tester.getTopLeft(
        find.byType(CupertinoTextField),
      );
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        const CupertinoApp(
          theme: CupertinoThemeData(brightness: Brightness.dark),
          home: Center(
            child: CupertinoTextField(keyboardAppearance: Brightness.light),
          ),
        ),
      );
    ...
    () {
      testWidgets('Collapsed selection works', (WidgetTester tester) async {
          ...
          home: CupertinoPageScaffold(
            child: Align(
              ...
              child: SizedBox(
                ...
                height: 200,
                child:
                    CupertinoTextField(controller: controller, maxLines: null),
              ),
            ),
          ),
        ));
        ...
        controller = TextEditingController(
          text: List<String>.filled(200, 'a').join(),
        );
        await tester.pumpWidget(CupertinoApp(
          debugShowCheckedModeBanner: false,
          home: CupertinoPageScaffold(
          ...
          paints
            ..clipPath(
              pathMatcher: PathPointsMatcher(
                includes: <Offset>[
                  // Expected center of the arrow.
                  bottomLeftSelectionPosition.translate(
                    0,
                    -lineHeight - 8 - 0.1,
                  ),
                ],
          ...
          paints
            ..clipPath(
              pathMatcher: PathBoundsMatcher(
                ...
                topMatcher: moreOrLessEquals(
                  bottomLeftSelectionPosition.dy - 8 - lineHeight - 43,
                  epsilon: 0.01,
                ),
                rightMatcher: lessThanOrEqualTo(400 - 8),
                leftMatcher: greaterThanOrEqualTo(8),
      ...
      testWidgets('selecting multiple words works', (
        WidgetTester tester,
      ) async {
        tester.view.physicalSize = const Size(400, 400);
        tester.view.devicePixelRatio = 1;
        ...
        // it should point exactly to the caret.
        controller = TextEditingController(
          text: List<String>.filled(20, 'a').join('  '),
        );
        await tester.pumpWidget(CupertinoApp(
          debugShowCheckedModeBanner: false,
          home: CupertinoPageScaffold(
          ...
          paints
            ..clipPath(
              pathMatcher: PathBoundsMatcher(
                ...
                topMatcher: moreOrLessEquals(
                  selectionPosition.dy - 8 - lineHeight - 43,
                  epsilon: 0.01,
                ),
                rightMatcher: lessThanOrEqualTo(400 - 8),
                leftMatcher: greaterThanOrEqualTo(8),
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          await tester.pumpAndSettle();
          await tester.tapAt(
            textOffsetToPosition(tester, testValue.length ~/ 2),
          );
          await tester.pump(const Duration(milliseconds: 100));
          await tester.tapAt(
            textOffsetToPosition(tester, testValue.length ~/ 2),
  ...
  group('textAlignVertical position', () {
    group('simple case', () {
      testWidgets('align top (default)', (WidgetTester tester) async {
        ...
        await tester.pumpAndSettle();
        expect(focusNode.hasFocus, false);
        final Offset justInside = tester.getBottomLeft(
          find.byType(CupertinoTextField),
        ).translate(0.0, -1.0);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(CupertinoApp(
        home: Center(
          child: CupertinoTextField(selectionControls: selectionControl),
        ),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        const CupertinoApp(
          home: Center(child: CupertinoTextField(enabled: true)),
        ),
      );
  ...
  testWidgets('still gets disabled background color when decoration is null', (
    ...
    await tester.pumpWidget(
      const CupertinoApp(
        home:
            Center(child: CupertinoTextField(decoration: null, enabled: false)),
      ),
    );

    final Color disabledColor = tester.widget<ColoredBox>(find.descendant(
      of: find.byType(CupertinoTextField),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const CupertinoApp(
          home: CupertinoTextField(placeholder: 'placeholder text'),
        ),
      );
      await tester.tap(find.byType(CupertinoTextField));
  ...
  testWidgets('textDirection is passed to EditableText', (
    ...
    await tester.pumpWidget(
      const CupertinoApp(
        home:
            Center(child: CupertinoTextField(textDirection: TextDirection.ltr)),
      ),
    );
    ...
    await tester.pumpWidget(
      const CupertinoApp(
        home:
            Center(child: CupertinoTextField(textDirection: TextDirection.rtl)),
      ),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final CupertinoTextField textField = tester.firstWidget(
        find.byType(CupertinoTextField),
      );
    ...
    group('magnifier builder', () {
      ...
      group('defaults', () {
        testWidgets(
          ...
          (WidgetTester tester) async {
            await tester.pumpWidget(
              const CupertinoApp(home: CupertinoTextField()),
            );
