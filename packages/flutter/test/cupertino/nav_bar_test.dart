...
void main() {
  ...
  testWidgets('Middle still in center with back button', (WidgetTester tester) async {
    await tester.pumpWidget(const CupertinoApp(home: CupertinoNavigationBar(middle: Text('Title'))));
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        const CupertinoApp(
          ...
          home: CupertinoNavigationBar(middle: Text('Title'), backgroundColor: background),
        ),
      );
  ...
  testWidgets('Nav bar displays correctly', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      CupertinoApp(navigatorKey: navigator, home: const CupertinoNavigationBar(middle: Text('Page 1'))),
    );
    ...
    await tester.pumpWidget(CupertinoApp(
      home: Align(
        ...
        child: CupertinoNavigationBar(
          ...
          padding: const EdgeInsetsDirectional.only(start: 10.0, end: 20.0, top: 3.0, bottom: 4.0),
        ),
      ),
    ));
  ...
  testWidgets('System navigation bar properties are not overridden', (WidgetTester tester) async {
    await tester.pumpWidget(const CupertinoApp(home: CupertinoNavigationBar(backgroundColor: Color(0xF0F9F9F9))));
  ...
  testWidgets('Can specify custom brightness', (WidgetTester tester) async {
    await tester.pumpWidget(
      const CupertinoApp(home: CupertinoNavigationBar(backgroundColor: Color(0xF0F9F9F9), brightness: Brightness.dark)),
    );
    expectSameStatusBarStyle(SystemChrome.latestStyle!, SystemUiOverlayStyle.light);

    await tester.pumpWidget(
      const CupertinoApp(
        home: CupertinoNavigationBar(backgroundColor: Color(0xF01D1D1D), brightness: Brightness.light),
      ),
    );
    expectSameStatusBarStyle(SystemChrome.latestStyle!, SystemUiOverlayStyle.dark);
  ...
  testWidgets('Theme active color can be overridden', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(CupertinoApp(
      ...
      home: CupertinoNavigationBar(
        leading:
            CupertinoButton(onPressed: () {}, child: const _ExpectStyles(color: Color(0xFF001122), index: 0x000001)),
        middle: const _ExpectStyles(color: Color(0xFF000000), index: 0x000100),
        trailing:
            CupertinoButton(onPressed: () {}, child: const _ExpectStyles(color: Color(0xFF001122), index: 0x010000)),
      ),
    ));
    expect(count, 0x010101);
  });
  ...
  testWidgets('No slivers with no large titles', (WidgetTester tester) async {
    await tester.pumpWidget(
      const CupertinoApp(
        home: CupertinoPageScaffold(navigationBar: CupertinoNavigationBar(middle: Text('Title')), child: Center()),
      ),
    );
  ...
  testWidgets('Media padding is applied to CupertinoSliverNavigationBar', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(CupertinoApp(
      home: MediaQuery(
        data: const MediaQueryData(padding: EdgeInsets.only(top: 10.0, left: 20.0, bottom: 30.0, right: 40.0)),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
        ...
        home: CupertinoPageScaffold(
          child: CustomScrollView(
            ...
            slivers: const <Widget>[
              CupertinoSliverNavigationBar(largeTitle: Text('Large'), middle: Text('Middle'), alwaysShowMiddle: false),
      ...
      RenderAnimatedOpacity middleOpacity =
          tester.element(find.text('Middle')).findAncestorRenderObjectOfType<RenderAnimatedOpacity>()!;
  ...
  testWidgets('Small title can be overridden', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(CupertinoApp(
      home: CupertinoPageScaffold(
        child: CustomScrollView(
          controller: scrollController,
          slivers: <Widget>[
            const CupertinoSliverNavigationBar(middle: Text('Different title'), largeTitle: Text('Title')),
            SliverToBoxAdapter(child: Container(height: 1200.0)),
          ],
        ),
      ),
    ...
    expect(tester.element(find.text('Different title')).findAncestorRenderObjectOfType<RenderOpacity>(), isNull);
    ...
    largeTitleOpacity = tester.element(find.text('Title')).findAncestorRenderObjectOfType<RenderAnimatedOpacity>()!;
  ...
  testWidgets('Auto back/close button', (WidgetTester tester) async {
    await tester.pumpWidget(const CupertinoApp(home: CupertinoNavigationBar(middle: Text('Home page'))));
  ...
  testWidgets('Border should be displayed by default', (WidgetTester tester) async {
    ...
    final DecoratedBox decoratedBox = tester.widgetList(
      find.descendant(of: find.byType(CupertinoNavigationBar), matching: find.byType(DecoratedBox)),
  ...
  testWidgets('Border should not be displayed when null', (WidgetTester tester) async {
    await tester.pumpWidget(const CupertinoApp(home: CupertinoNavigationBar(middle: Text('Title'), border: null)));
  ...
  testWidgets('Border is displayed by default in sliver nav bar', (WidgetTester tester) async {
    await tester.pumpWidget(
      const CupertinoApp(
        home: CupertinoPageScaffold(
          child: CustomScrollView(slivers: <Widget>[CupertinoSliverNavigationBar(largeTitle: Text('Large Title'))]),
        ),
      ),
    );

    final DecoratedBox decoratedBox = tester.widgetList(
      find.descendant(of: find.byType(CupertinoSliverNavigationBar), matching: find.byType(DecoratedBox)),
    ).first as DecoratedBox;
    expect(decoratedBox.decoration.runtimeType, BoxDecoration);
  ...
  testWidgets('Border is not displayed when null in sliver nav bar', (WidgetTester tester) async {
    await tester.pumpWidget(
      const CupertinoApp(
        home: CupertinoPageScaffold(
          child: CustomScrollView(
            slivers: <Widget>[CupertinoSliverNavigationBar(largeTitle: Text('Large Title'), border: null)],
          ),
        ),
      ),
    );
  ...
  testWidgets('Standard title golden', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(RepaintBoundary).last, matchesGoldenFile('nav_bar_test.standard_title.png'));
  });
  ...
  testWidgets('Large title golden', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(RepaintBoundary).last, matchesGoldenFile('nav_bar_test.large_title.png'));
  });
    ...
    await tester.pumpWidget(WidgetsApp(
      ...
      onGenerateRoute: (RouteSettings settings) {
        return CupertinoPageRoute<void>(
          settings: settings,
          builder: (BuildContext context) {
            return const CupertinoNavigationBar(middle: Text('Test'), backgroundColor: Color(0xFF000000));
          },
        );
      },
    ));
    ...
    await tester.pumpWidget(WidgetsApp(
      ...
      onGenerateRoute: (RouteSettings settings) {
        return CupertinoPageRoute<void>(
          settings: settings,
          builder: (BuildContext context) {
            return const CupertinoNavigationBar(middle: Text('Test'), backgroundColor: Color(0xFFFFFFFF));
          },
        );
      },
    ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        exception.toString(),
        contains('CupertinoNavigationBarBackButton should only be used in routes that can be popped'),
      );
    },
  );
  ...
  testWidgets('CupertinoNavigationBarBackButton with a custom onPressed callback can be placed anywhere', (
    WidgetTester tester,
  ) async {
    bool backPressed = false;

    await tester.pumpWidget(CupertinoApp(home: CupertinoNavigationBarBackButton(onPressed: () => backPressed = true)));
  ...
  testWidgets('Manually inserted CupertinoNavigationBarBackButton still automatically '
    ...
    tester.state<NavigatorState>(find.byType(Navigator)).push(CupertinoPageRoute<void>(
      title: 'An iPod',
      builder: (BuildContext context) {
        return const CupertinoPageScaffold(navigationBar: CupertinoNavigationBar(), child: Placeholder());
      },
    ));
  ...
  testWidgets('CupertinoNavigationBarBackButton onPressed overrides default pop behavior', (WidgetTester tester) async {
    bool backPressed = false;
    await tester.pumpWidget(const CupertinoApp(home: Placeholder()));
    ...
    tester.state<NavigatorState>(find.byType(Navigator)).push(CupertinoPageRoute<void>(
      ...
      builder: (BuildContext context) {
        return CupertinoPageScaffold(
          navigationBar:
              CupertinoNavigationBar(leading: CupertinoNavigationBarBackButton(onPressed: () => backPressed = true)),
  ...
  testWidgets('textScaleFactor is set to 1.0', (WidgetTester tester) async {
    ...
    final Iterable<RichText> barItems = tester.widgetList<RichText>(
      find.descendant(of: find.byType(CupertinoSliverNavigationBar), matching: find.byType(RichText)),
    );
    ...
    tester.state<NavigatorState>(find.byType(Navigator)).push(CupertinoPageRoute<void>(
      ...
      builder: (BuildContext context) {
        return MediaQuery(
          ...
          child: const CupertinoPageScaffold(
            child:
                CustomScrollView(slivers: <Widget>[CupertinoSliverNavigationBar(previousPageTitle: 'previous title')]),
          ),
        );
      },
    ));
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(CupertinoApp(
        home: CupertinoPageScaffold(
          child: CustomScrollView(
            slivers: <Widget>[
              const CupertinoSliverNavigationBar(trailing: trailingText, largeTitle: titleText, stretch: true),
              SliverToBoxAdapter(child: Container(height: 1200.0)),
            ],
          ),
        ),
      ...
      expect(finalTrailingTextToLargeTitleOffset.dy.abs(), initialTrailingTextToLargeTitleOffset.dy.abs());
    },
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(stretchedTrailingTextToLargeTitleOffset.dy.abs(), initialTrailingTextToLargeTitleOffset.dy.abs());
  ...
  testWidgets('CupertinoSliverNavigationBar magnifies upon over-scroll and shrinks back once over-scroll ends', (
    WidgetTester tester,
  ) async {
    const Text titleText = Text('Large Title');
    ...
    final Offset magnifiedTitleTextOffset = tester.getBottomLeft(titleTextFinder) - tester.getTopLeft(titleTextFinder);
    ...
    final Offset finalTitleTextOffset = tester.getBottomLeft(titleTextFinder) - tester.getTopLeft(titleTextFinder);
  ...
  testWidgets('CupertinoSliverNavigationBar large title can be hit tested when magnified', (WidgetTester tester) async {
    final ScrollController scrollController = ScrollController();
