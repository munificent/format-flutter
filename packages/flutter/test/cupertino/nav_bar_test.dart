...
void main() {
  ...
  testWidgets(
    'Middle still in center with back button',
    (WidgetTester tester) async {
      await tester.pumpWidget(
  ...
  testWidgets('Can specify custom padding', (WidgetTester tester) async {
    ...
    expect(
      tester.getTopRight(find.widgetWithText(CupertinoButton, 'Puma')).dx,
      800.0 - 20.0,
    );
  ...
  void expectSameStatusBarStyle(
    ...
    SystemUiOverlayStyle expectedStyle,
  ) {
    ...
    expect(
      ...
      expectedStyle.statusBarIconBrightness,
    );
    expect(
  ...
  testWidgets(
    'System navigation bar properties are not overridden',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const CupertinoApp(
          home: CupertinoNavigationBar(backgroundColor: Color(0xF0F9F9F9)),
        ),
      );
  ...
  testWidgets('Padding works in RTL', (WidgetTester tester) async {
    ...
    expect(
      tester.getTopLeft(find.widgetWithText(CupertinoButton, 'Puma')).dx,
      20.0,
    );
    ...
    await tester.pumpWidget(CupertinoApp(
      home: CupertinoNavigationBar(
        leading: CupertinoButton(
          onPressed: () {},
          child: _ExpectStyles(
            color: CupertinoColors.systemBlue.color,
            index: 0x000001,
          ),
        ),
        middle:
            const _ExpectStyles(color: CupertinoColors.black, index: 0x000100),
  ...
  testWidgets('Nav bar respects themes', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(CupertinoApp(
      ...
      home: CupertinoNavigationBar(
        ...
        middle:
            const _ExpectStyles(color: CupertinoColors.white, index: 0x000100),
        trailing: CupertinoButton(
          onPressed: () {},
          child: _ExpectStyles(
            color: CupertinoColors.systemBlue.darkColor,
  ...
  testWidgets('Media padding is applied to CupertinoSliverNavigationBar', (
    ...
    await tester.pumpWidget(CupertinoApp(
      home: MediaQuery(
        data: const MediaQueryData(
          padding:
              EdgeInsets.only(top: 10.0, left: 20.0, bottom: 30.0, right: 40.0),
        ),
    ...
    expect(
      tester.getTopRight(find.byKey(trailingKey)),
  ...
  testWidgets('Large title nav bar scrolls', (WidgetTester tester) async {
    ...
    expect(
      tester.getTopLeft(find.widgetWithText(ClipRect, 'Title').first).dy,
      44.0,
    );
    expect(
      tester.getSize(find.widgetWithText(ClipRect, 'Title').first).height,
      52.0,
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      RenderAnimatedOpacity middleOpacity = tester.element(
        find.text('Middle'),
  ...
  testWidgets('Small title can be overridden', (WidgetTester tester) async {
    ...
    RenderAnimatedOpacity largeTitleOpacity = tester.element(
      find.text('Title'),
    ).findAncestorRenderObjectOfType<RenderAnimatedOpacity>()!;
    ...
    largeTitleOpacity = tester.element(
      find.text('Title'),
    ).findAncestorRenderObjectOfType<RenderAnimatedOpacity>()!;
  ...
  testWidgets('Auto back/close button', (WidgetTester tester) async {
    await tester.pumpWidget(
      const CupertinoApp(
        home: CupertinoNavigationBar(middle: Text('Home page')),
      ),
    );
  ...
  testWidgets('Long back label turns into "back"', (WidgetTester tester) async {
      ...
      CupertinoPageRoute<void>(
        builder: (BuildContext context) {
          return const CupertinoPageScaffold(
            navigationBar:
                CupertinoNavigationBar(previousPageTitle: '012345678901'),
            child: Placeholder(),
          );
        },
      ),
    ...
    expect(
      find.widgetWithText(CupertinoButton, '012345678901'),
      findsOneWidget,
    );
    ...
    tester.state<NavigatorState>(find.byType(Navigator)).push(
      CupertinoPageRoute<void>(
        builder: (BuildContext context) {
          return const CupertinoPageScaffold(
            navigationBar:
                CupertinoNavigationBar(previousPageTitle: '0123456789012'),
            child: Placeholder(),
          );
        },
      ),
    ...
    await tester.pumpWidget(
      const CupertinoApp(
        home: CupertinoNavigationBar(
          middle: Text('Title'),
          border:
              Border(bottom: BorderSide(color: Color(0xFFAABBCC), width: 0.0)),
        ),
      ),
    );
  ...
  testWidgets(
    'Border should not be displayed when null',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const CupertinoApp(
          home: CupertinoNavigationBar(middle: Text('Title'), border: null),
        ),
      );
      ...
      await tester.pumpWidget(
        const CupertinoApp(
          home: CupertinoPageScaffold(
            child: CustomScrollView(
              slivers: <Widget>[
                CupertinoSliverNavigationBar(largeTitle: Text('Large Title')),
              ],
            ),
          ),
        ),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(CupertinoApp(
        home: CupertinoPageScaffold(
          navigationBar:
              const CupertinoNavigationBar(middle: Text('Fixed Title')),
          child: Container(),
        ),
      ));
            ...
            child: CustomScrollView(
              slivers: <Widget>[
                CupertinoSliverNavigationBar(
                  largeTitle: Text('Large Title'),
                  border: Border(
                    bottom: BorderSide(color: Color(0xFFAABBCC), width: 0.0),
                  ),
                ),
              ],
            ),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const CupertinoApp(home: CupertinoNavigationBarBackButton()),
      );
  ...
  testWidgets('textScaleFactor is set to 1.0', (WidgetTester tester) async {
    ...
    final Iterable<RichText> barItems = tester.widgetList<RichText>(find
        .descendant(
          of: find.byType(CupertinoSliverNavigationBar),
          matching: find.byType(RichText),
        ));

    final Iterable<RichText> contents = tester.widgetList<RichText>(find
        .descendant(of: find.text('content'), matching: find.byType(RichText)));
    ...
    final Iterable<RichText> barItems2 = tester.widgetList<RichText>(find
        .descendant(
          of: find.byType(CupertinoSliverNavigationBar),
          matching: find.byType(RichText),
        ));
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        const CupertinoApp(
          home: CupertinoPageScaffold(
            navigationBar:
                CupertinoNavigationBar(middle: Text('Page 1'), border: null),
            child: Placeholder(),
          ),
        ),
      );
      ...
      tester.state<NavigatorState>(find.byType(Navigator)).push(
        CupertinoPageRoute<void>(
          builder: (BuildContext context) {
            return const CupertinoPageScaffold(
              navigationBar:
                  CupertinoNavigationBar(middle: Text('Page 2'), border: null),
              child: Placeholder(),
            );
          },
        ),
