...
void main() {
      ...
      await tester.pumpWidget(CupertinoApp(
        home: CupertinoTabScaffold(
          ...
          controller: CupertinoTabController(
            initialIndex: 1,
          ), // Programmatically change the tab now.
          tabBuilder: (BuildContext context, int index) {
            return CustomPaint(
              painter: TestCallbackPainter(
                onPaint: () {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        await getContentPaddingWithTabBarColor(const Color(0xAAFFFFFF)),
        isNot(EdgeInsets.zero),
      );
      expect(
        await getContentPaddingWithTabBarColor(const Color(0xFFFFFFFF)),
        EdgeInsets.zero,
      );
    },
  );
  ...
  testWidgets(
    'Adding new tabs does not crash the app',
    (WidgetTester tester) async {
      final List<int> tabsPainted = <int>[];
      final CupertinoTabController controller = CupertinoTabController();
  ...
  testWidgets('A controller can control more than one CupertinoTabScaffold, '
    ...
    MockCupertinoTabController controller = MockCupertinoTabController(
      initialIndex: 2,
    );
    ...
    try {
      await tester.pumpWidget(CupertinoApp(
        home: CupertinoTabScaffold(
          ...
          controller: controller,
          tabBuilder: (BuildContext context, int index) => Text(
                'Different page ${index + 1}',
              ),
        ),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final List<FocusScopeNode> scopes = List<FocusScopeNode>.filled(
        5,
        FocusScopeNode(),
      );
      await tester.pumpWidget(CupertinoApp(
        ...
        builder: (BuildContext context) {
          return MediaQuery(
            ...
            child: CupertinoTabScaffold(
              ...
              tabBuilder:
                  (BuildContext context, int index) => const Text('content'),
            ),
          );
        },
      ),
