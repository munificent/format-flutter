...
void main() {
      ...
      home: Material(
        child: CupertinoTabScaffold(
          ...
          tabBuilder: (BuildContext context, int index) {
            return Column(
              children: <Widget>[
                TextField(focusNode: focusNodes[index * 2], decoration: const InputDecoration(hintText: 'TextField 1')),
                TextField(
  ...
  testWidgets('dark mode background color', (WidgetTester tester) async {
    ...
    BoxDecoration tabDecoration = tester.firstWidget<DecoratedBox>(
      find.descendant(of: find.byType(CupertinoTabScaffold), matching: find.byType(DecoratedBox)),
    ).decoration as BoxDecoration;
