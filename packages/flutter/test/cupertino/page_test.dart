...
void main() {
  ...
  testWidgets('test iOS page transition (RTL)', (WidgetTester tester) async {
    await tester.pumpWidget(CupertinoApp(
      localizationsDelegates: const <LocalizationsDelegate<dynamic>>[RtlOverrideWidgetsDelegate()],
      onGenerateRoute: (RouteSettings settings) {
        return CupertinoPageRoute<void>(
          settings: settings,
          builder: (BuildContext context) {
  ...
  testWidgets('test edge swipes work with media query padding (LTR)', (WidgetTester tester) async {
    await tester.pumpWidget(CupertinoApp(
      builder: (BuildContext context, Widget? navigator) {
        return MediaQuery(data: const MediaQueryData(padding: EdgeInsets.only(left: 40)), child: navigator!);
      },
      home: const Placeholder(),
    ));

    tester.state<NavigatorState>(find.byType(Navigator)).push(
      CupertinoPageRoute<void>(builder: (BuildContext context) => const Center(child: Text('Page 1'))),
    );
    ...
    tester.state<NavigatorState>(find.byType(Navigator)).push(
      CupertinoPageRoute<void>(builder: (BuildContext context) => const Center(child: Text('Page 2'))),
    );
    await tester.pump();
    await tester.pumpAndSettle();
    ...
    await tester.pumpWidget(CupertinoApp(
      builder: (BuildContext context, Widget? navigator) {
        return Directionality(
          ...
          child: MediaQuery(data: const MediaQueryData(padding: EdgeInsets.only(right: 40)), child: navigator!),
        );
      },
      home: const Placeholder(),
    ));
        ...
        child: Directionality(
          ...
          child: Navigator(
            ...
            pages: const <Page<Object?>>[
              CupertinoPage<void>(restorationId: 'p1', child: TestRestorableWidget(restorationId: 'p1')),
            ],
