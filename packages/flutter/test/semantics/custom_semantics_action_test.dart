...
void main() {
  group(CustomSemanticsAction, () {
    test('is provided a canonical id based on the label', () {
      final CustomSemanticsAction action1 = CustomSemanticsAction(
        label: _nonconst('test'),
      );
      final CustomSemanticsAction action2 = CustomSemanticsAction(
        label: _nonconst('test'),
      );
      final CustomSemanticsAction action3 = CustomSemanticsAction(
        label: _nonconst('not test'),
      );
