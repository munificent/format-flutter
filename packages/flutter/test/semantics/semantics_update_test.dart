...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        SemanticsUpdateBuilderSpy.observations[1]!.label,
        'outer\ninner\ntext',
      );
  ...
  testWidgets(
    'Semantics update receives attributed text',
    (WidgetTester tester) async {
      final SemanticsHandle handle = tester.ensureSemantics();
      // Pumps a placeholder to trigger the warm up frame.
      await tester.pumpWidget(
      ...
      expect(
        SemanticsUpdateBuilderSpy.observations[1]!.labelAttributes!.length,
        1,
      );
      expect(
      ...
      expect(
        SemanticsUpdateBuilderSpy.observations[1]!.valueAttributes!.length,
        1,
      );
      expect(
      ...
      final LocaleStringAttribute localeAttribute = SemanticsUpdateBuilderSpy
          .observations[1]!
          .valueAttributes![0] as LocaleStringAttribute;
      ...
      expect(
        SemanticsUpdateBuilderSpy.observations[1]!.hintAttributes!.length,
        1,
      );
      expect(
