...
void main() {
  ...
  test('RoundedRectangleBorder copyWith, ==, hashCode', () {
    ...
    expect(
      const RoundedRectangleBorder().copyWith(
        side: side,
        borderRadius: directionalRadius,
      ),
  ...
  test('RoundedRectangleBorder and CircleBorder', () {
    ...
    expect(
      ShapeBorder.lerp(ShapeBorder.lerp(r, c, 0.9), r, 0.1)!.getOuterPath(rect),
      looksLikeC,
    );
    expect(
      ShapeBorder.lerp(ShapeBorder.lerp(r, c, 0.9), r, 0.9)!.getOuterPath(rect),
      looksLikeR,
    );
    expect(
      ShapeBorder.lerp(ShapeBorder.lerp(r, c, 0.1), c, 0.1)!.getOuterPath(rect),
      looksLikeR,
    );
    expect(
      ShapeBorder.lerp(ShapeBorder.lerp(r, c, 0.1), c, 0.9)!.getOuterPath(rect),
      looksLikeC,
    );
    ...
    expect(
      ShapeBorder.lerp(r, ShapeBorder.lerp(r, c, 0.9), 0.1)!.getOuterPath(rect),
      looksLikeR,
    );
    expect(
      ShapeBorder.lerp(r, ShapeBorder.lerp(r, c, 0.9), 0.9)!.getOuterPath(rect),
      looksLikeC,
    );
    expect(
      ShapeBorder.lerp(c, ShapeBorder.lerp(r, c, 0.1), 0.1)!.getOuterPath(rect),
      looksLikeC,
    );
    expect(
      ShapeBorder.lerp(c, ShapeBorder.lerp(r, c, 0.1), 0.9)!.getOuterPath(rect),
      looksLikeR,
    );
  ...
  test('RoundedRectangleBorder.dimensions and CircleBorder.dimensions', () {
    ...
    const CircleBorder insideCircleBorder = CircleBorder(
  ...
  test('RoundedRectangleBorder.lerp with different StrokeAlign', () {
    const RoundedRectangleBorder rInside = RoundedRectangleBorder(
      side: BorderSide(width: 10.0),
    );
