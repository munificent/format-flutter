...
void main() {
  test('applyBoxFit', () {
    ...
    result = applyBoxFit(
      BoxFit.scaleDown,
      const Size(100.0, 1000.0),
      const Size(200.0, 2000.0),
    );
    ...
    result = applyBoxFit(
      BoxFit.fitWidth,
      const Size(2000.0, 400.0),
      const Size(1000.0, 100.0),
    );
