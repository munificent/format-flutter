...
void main() {
  ...
  test('CircleBorder getInnerPath and getOuterPath', () {
    ...
    const CircleBorder o10 = CircleBorder(
      side: BorderSide(width: 10.0),
      eccentricity: 1.0,
    );
    expect(
      o10.getOuterPath(rect).getBounds(),
      Offset.zero & const Size(200, 100),
    );
    expect(
      o10.getInnerPath(rect).getBounds(),
  ...
  test('CircleBorder copyWith, ==, hashCode', () {
    ...
    expect(
      const CircleBorder().copyWith(side: side),
  ...
  test('CircleBorder', () {
    ...
    expect(c10.getInnerPath(
      Rect.fromCircle(center: Offset.zero, radius: 1.0).inflate(10.0),
    ), isUnitCircle);
    expect(
      c10.getOuterPath(Rect.fromCircle(center: Offset.zero, radius: 1.0)),
      isUnitCircle,
    );
    expect(
      (Canvas canvas) => c10.paint(
        canvas,
        const Rect.fromLTWH(10.0, 20.0, 30.0, 40.0),
      ),
