...
void main() {
  ...
  test('ShapeDecoration constructor', () {
    ...
    expect(
      () => ShapeDecoration(
        color: colorR,
        gradient: nonconst(gradient),
        shape: const Border(),
      ),
      throwsAssertionError,
    );
    expect(ShapeDecoration.fromBoxDecoration(
  ...
  test('ShapeDecoration.lerp and hit test', () {
    ...
    expect(
      Decoration.lerp(a, b, 0.1)!.hitTest(size, const Offset(20.0, 50.0)),
      isFalse,
    );
    expect(
      Decoration.lerp(a, b, 0.5)!.hitTest(size, const Offset(20.0, 50.0)),
      isFalse,
    );
    expect(
      Decoration.lerp(a, b, 0.9)!.hitTest(size, const Offset(20.0, 50.0)),
      isTrue,
    );
    expect(
      Decoration.lerp(a, c, 0.1)!.hitTest(size, const Offset(30.0, 50.0)),
      isFalse,
    );
    expect(
      Decoration.lerp(a, c, 0.5)!.hitTest(size, const Offset(30.0, 50.0)),
      isTrue,
    );
    expect(
      Decoration.lerp(a, c, 0.9)!.hitTest(size, const Offset(30.0, 50.0)),
      isTrue,
    );
    expect(
      Decoration.lerp(b, c, 0.1)!.hitTest(size, const Offset(45.0, 10.0)),
      isTrue,
    );
    expect(
      Decoration.lerp(b, c, 0.5)!.hitTest(size, const Offset(30.0, 10.0)),
      isTrue,
    );
    expect(
      Decoration.lerp(b, c, 0.9)!.hitTest(size, const Offset(10.0, 30.0)),
      isTrue,
    );
