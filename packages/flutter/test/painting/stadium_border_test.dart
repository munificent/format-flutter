...
void main() {
  ...
  test('StadiumBorder copyWith, ==, hashCode', () {
    ...
    expect(
      const StadiumBorder().hashCode,
      const StadiumBorder().copyWith().hashCode,
    );
    const BorderSide side = BorderSide(width: 10.0, color: Color(0xff123456));
    expect(
      const StadiumBorder().copyWith(side: side),
  ...
  test('StadiumBorder', () {
    ...
    expect(
      c1.getOuterPath(Rect.fromCircle(center: Offset.zero, radius: 1.0)),
      isUnitCircle,
    );
    const StadiumBorder c2 = StadiumBorder(side: BorderSide());
    expect(
      c2.getInnerPath(Rect.fromCircle(center: Offset.zero, radius: 2.0)),
      isUnitCircle,
    );
  ...
  test('StadiumBorder and CircleBorder', () {
    ...
    expect(
      ShapeBorder.lerp(stadium, circle, 0.1)!.getOuterPath(rect),
      looksLikeS,
    );
    expect(
      ShapeBorder.lerp(stadium, circle, 0.9)!.getOuterPath(rect),
      looksLikeC,
    );
    expect(
  ...
  test('StadiumBorder and RoundedRectBorder with BorderRadius.zero', () {
    ...
    expect(
      ShapeBorder.lerp(stadium, rrect, 0.1)!.getOuterPath(rect),
      looksLikeS,
    );
    expect(
      ShapeBorder.lerp(stadium, rrect, 0.9)!.getOuterPath(rect),
      looksLikeR,
    );
    expect(
    ...
    expect(ShapeBorder.lerp(ShapeBorder.lerp(stadium, rrect, 0.1), rrect, 0.1)!
        .getOuterPath(rect), looksLikeS);
    expect(ShapeBorder.lerp(ShapeBorder.lerp(stadium, rrect, 0.1), rrect, 0.9)!
        .getOuterPath(rect), looksLikeS);
    expect(ShapeBorder.lerp(
    ...
    expect(ShapeBorder.lerp(rrect, ShapeBorder.lerp(stadium, rrect, 0.1), 0.1)!
        .getOuterPath(rect), looksLikeS);
    expect(ShapeBorder.lerp(rrect, ShapeBorder.lerp(stadium, rrect, 0.1), 0.9)!
        .getOuterPath(rect), looksLikeS);
  ...
  test('StadiumBorder and RoundedRectBorder with BorderRadiusDirectional', () {
    ...
    expect(
      stadium.getOuterPath(rect, textDirection: TextDirection.rtl),
      looksLikeS,
    );
    expect(
      rrect.getOuterPath(rect, textDirection: TextDirection.rtl),
      looksLikeR,
    );
    expect(ShapeBorder.lerp(stadium, rrect, 0.1)!.getOuterPath(
      rect,
      textDirection: TextDirection.rtl,
    ), looksLikeS);
    expect(ShapeBorder.lerp(stadium, rrect, 0.9)!.getOuterPath(
      rect,
      textDirection: TextDirection.rtl,
    ), looksLikeR);
    expect(
