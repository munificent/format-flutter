...
void main() {
  ...
  test('StadiumBorder with StrokeAlign', () {
    ...
    expect(
      ...
      paints..rrect(rrect: RRect.fromRectAndRadius(rect, Radius.circular(rect.shortestSide / 2.0)), strokeWidth: 10.0),
    );
  ...
  test('StadiumBorder and CircleBorder', () {
    ...
    expect(ShapeBorder.lerp(ShapeBorder.lerp(stadium, circle, 0.1), ShapeBorder.lerp(stadium, circle, 0.9), 0.1)!
        .getOuterPath(rect), looksLikeS);
    expect(ShapeBorder.lerp(ShapeBorder.lerp(stadium, circle, 0.1), ShapeBorder.lerp(stadium, circle, 0.9), 0.9)!
        .getOuterPath(rect), looksLikeC);
    ...
    final ShapeBorder indirect50 =
        ShapeBorder.lerp(ShapeBorder.lerp(circle, stadium, 0.1), ShapeBorder.lerp(circle, stadium, 0.9), 0.5)!;
  ...
  test('StadiumBorder and RoundedRectBorder with BorderRadius.zero', () {
    ...
    expect(ShapeBorder.lerp(ShapeBorder.lerp(stadium, rrect, 0.1), ShapeBorder.lerp(stadium, rrect, 0.9), 0.1)!
        .getOuterPath(rect), looksLikeS);
    expect(ShapeBorder.lerp(ShapeBorder.lerp(stadium, rrect, 0.1), ShapeBorder.lerp(stadium, rrect, 0.9), 0.9)!
        .getOuterPath(rect), looksLikeR);
    ...
    final ShapeBorder indirect50 =
        ShapeBorder.lerp(ShapeBorder.lerp(rrect, stadium, 0.1), ShapeBorder.lerp(rrect, stadium, 0.9), 0.5)!;
    expect(direct50, indirect50);
    expect(direct50.hashCode, indirect50.hashCode);
    expect(direct50.toString(), indirect50.toString());
  });
  ...
  test('StadiumBorder and RoundedRectBorder with BorderRadiusDirectional', () {
    const StadiumBorder stadium = StadiumBorder();
    const RoundedRectangleBorder rrect = RoundedRectangleBorder(
      borderRadius: BorderRadiusDirectional.only(topStart: Radius.circular(10), bottomEnd: Radius.circular(10)),
    );
    const Rect rect = Rect.fromLTWH(0.0, 0.0, 100.0, 50.0);
    final Matcher looksLikeS = isPathThat(
      includes: const <Offset>[Offset(25.0, 25.0), Offset(50.0, 25.0), Offset(7.33, 7.33)],
    ...
    expect(ShapeBorder.lerp(ShapeBorder.lerp(stadium, rrect, 0.9), stadium, 0.1)!.getOuterPath(
      rect,
      textDirection: TextDirection.rtl,
    ), looksLikeR);
    expect(ShapeBorder.lerp(ShapeBorder.lerp(stadium, rrect, 0.9), stadium, 0.9)!.getOuterPath(
      rect,
      textDirection: TextDirection.rtl,
    ), looksLikeS);
    expect(ShapeBorder.lerp(ShapeBorder.lerp(stadium, rrect, 0.1), rrect, 0.1)!.getOuterPath(
      rect,
      textDirection: TextDirection.rtl,
    ), looksLikeS);
    expect(ShapeBorder.lerp(ShapeBorder.lerp(stadium, rrect, 0.1), rrect, 0.9)!.getOuterPath(
      rect,
      textDirection: TextDirection.rtl,
    ), looksLikeS);
    expect(ShapeBorder.lerp(ShapeBorder.lerp(stadium, rrect, 0.1), ShapeBorder.lerp(stadium, rrect, 0.9), 0.1)!
        .getOuterPath(rect, textDirection: TextDirection.rtl), looksLikeS);
    expect(ShapeBorder.lerp(ShapeBorder.lerp(stadium, rrect, 0.1), ShapeBorder.lerp(stadium, rrect, 0.9), 0.9)!
        .getOuterPath(rect, textDirection: TextDirection.rtl), looksLikeR);
    expect(ShapeBorder.lerp(stadium, ShapeBorder.lerp(stadium, rrect, 0.9), 0.1)!.getOuterPath(
      rect,
      textDirection: TextDirection.rtl,
    ), looksLikeS);
    expect(ShapeBorder.lerp(stadium, ShapeBorder.lerp(stadium, rrect, 0.9), 0.9)!.getOuterPath(
      rect,
      textDirection: TextDirection.rtl,
    ), looksLikeR);
    expect(ShapeBorder.lerp(rrect, ShapeBorder.lerp(stadium, rrect, 0.1), 0.1)!.getOuterPath(
      rect,
      textDirection: TextDirection.rtl,
    ), looksLikeS);
    expect(ShapeBorder.lerp(rrect, ShapeBorder.lerp(stadium, rrect, 0.1), 0.9)!.getOuterPath(
      rect,
      textDirection: TextDirection.rtl,
    ), looksLikeS);
