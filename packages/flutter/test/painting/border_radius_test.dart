...
void main() {
  test('BorderRadius control test', () {
    ...
    expect(const BorderRadius.only(topLeft: Radius.elliptical(1.0, 2.0))
        .subtract(
          const BorderRadius.only(topLeft: Radius.elliptical(3.0, 5.0)),
        ), const BorderRadius.only(topLeft: Radius.elliptical(-2.0, -3.0)));
    expect(
      const BorderRadius.only(topRight: Radius.elliptical(1.0, 2.0)).add(
        const BorderRadius.only(topLeft: Radius.elliptical(3.0, 5.0)),
      ),
  ...
  test('BorderRadius.lerp() invariants', () {
    ...
    expect(
      BorderRadius.lerp(a, b, 0.25),
      equals(a + BorderRadius.circular(2.5)),
    );
    expect(
      BorderRadius.lerp(a, b, 0.25),
      equals(b - BorderRadius.circular(7.5)),
    );
  ...
  test('BorderRadiusDirectional.lerp identical a,b', () {
    ...
    expect(
      identical(BorderRadiusDirectional.lerp(border, border, 0.5), border),
      true,
    );
  });
  ...
  test('BorderRadiusGeometry.lerp()', () {
    ...
    expect(
      BorderRadiusGeometry.lerp(a, b, 0.5)!.resolve(TextDirection.ltr),
      ltr,
    );
    expect(
      BorderRadiusGeometry.lerp(a, b, 0.5)!.resolve(TextDirection.rtl),
      rtl,
    );
  ...
  test('BorderRadiusGeometry.lerp identical a,b', () {
    ...
    expect(
      identical(BorderRadiusGeometry.lerp(border, border, 0.5), border),
      true,
    );
  });
  ...
  test('BorderRadiusGeometry operators', () {
    ...
    expect(
      a.add(b.subtract(a) * 1.0).resolve(TextDirection.rtl),
      b.resolve(TextDirection.rtl),
    );
  });
  ...
  test('BorderRadius copyWith parameters', () {
    ...
    expect(
      borderRadius.copyWith(bottomLeft: Radius.zero).bottomLeft,
      Radius.zero,
    );
    expect(borderRadius.copyWith(bottomLeft: Radius.zero).copyWith(
      bottomLeft: radius,
    ), borderRadius);
    expect(
      borderRadius.copyWith(bottomRight: Radius.zero).bottomRight,
      Radius.zero,
    );
    expect(borderRadius.copyWith(bottomRight: Radius.zero).copyWith(
      bottomRight: radius,
    ), borderRadius);
  });
}
