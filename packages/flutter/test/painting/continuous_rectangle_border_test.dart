...
void main() {
  ...
  test('ContinuousRectangleBorder copyWith, ==, hashCode', () {
    ...
    expect(const ContinuousRectangleBorder().copyWith(
      side: side,
      borderRadius: radius,
  ...
  test('ContinuousRectangleBorder BorderRadius.zero', () {
    ...
    expect(
      const ContinuousRectangleBorder().getOuterPath(rect1),
      looksLikeRect1,
    );
    expect(
      const ContinuousRectangleBorder().getInnerPath(rect1),
      looksLikeRect1,
    );
    ...
    expect(
      const ContinuousRectangleBorder(side: side).getOuterPath(rect1),
      looksLikeRect1,
    );
    expect(
      const ContinuousRectangleBorder(side: side).getInnerPath(rect1),
      looksLikeInnerPath,
    );
  });
  ...
  test('ContinuousRectangleBorder non-zero BorderRadiusDirectional', () {
    ...
    expect(
      border.getInnerPath(rect, textDirection: TextDirection.ltr),
      looksLikeRectLtr,
    );
    ...
    expect(
      border.getOuterPath(rect, textDirection: TextDirection.rtl),
      looksLikeRectRtl,
    );
    expect(
      border.getInnerPath(rect, textDirection: TextDirection.rtl),
      looksLikeRectRtl,
    );
  });
  ...
  testWidgets('Golden test topLeft radii', (WidgetTester tester) async {
    await tester.pumpWidget(RepaintBoundary(
      child: Material(
        ...
        shape: const ContinuousRectangleBorder(
          borderRadius:
              BorderRadius.only(topLeft: Radius.elliptical(100.0, 200.0)),
        ),
      ),
    ));
  ...
  testWidgets('Golden test bottomLeft radii', (WidgetTester tester) async {
    await tester.pumpWidget(RepaintBoundary(
      child: Material(
        ...
        shape: const ContinuousRectangleBorder(
          borderRadius:
              BorderRadius.only(bottomLeft: Radius.elliptical(2000.0, 100.0)),
        ),
      ),
    ));
