...
void main() {
  ...
  test('BoxDecoration with BorderRadiusDirectional', () {
    ...
    expect((Canvas canvas) {
      painter.paint(canvas, Offset.zero, const ImageConfiguration(size: size, textDirection: TextDirection.rtl));
    ...
    expect((Canvas canvas) {
      painter.paint(canvas, Offset.zero, const ImageConfiguration(size: size, textDirection: TextDirection.ltr));
  ...
  test('BoxDecorations with different blendModes are not equal', () {
    ...
    const BoxDecoration one = BoxDecoration(color: Color(0x00000000), backgroundBlendMode: BlendMode.color);
    const BoxDecoration two = BoxDecoration(color: Color(0x00000000), backgroundBlendMode: BlendMode.difference);
