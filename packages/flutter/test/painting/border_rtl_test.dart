...
void main() {
  test('BoxBorder.lerp', () {
    ...
    expect(
      ...
      Border(top: BorderSide(width: 5.0, color: Color.lerp(const Color(0xFFFFFF00), const Color(0xFFFF00FF), 0.25)!)),
    );
    ...
    expect(
      ...
      Border(top: BorderSide(width: 5.0, color: Color.lerp(const Color(0xFFFFFF00), const Color(0xFFFF00FF), 0.75)!)),
    );
  ...
  test('BorderDirectional.merge', () {
    ...
    expect(
      BorderDirectional.merge(const BorderDirectional(top: yellow2), const BorderDirectional(end: magenta3)),
      const BorderDirectional(top: yellow2, end: magenta3),
    );
    expect(
      BorderDirectional.merge(const BorderDirectional(bottom: magenta3), const BorderDirectional(bottom: magenta3)),
      const BorderDirectional(bottom: magenta6),
    );
    expect(BorderDirectional.merge(
    ...
    expect(BorderDirectional.merge(const BorderDirectional(), const BorderDirectional()), const BorderDirectional());
    expect(
      () => BorderDirectional.merge(const BorderDirectional(start: magenta3), const BorderDirectional(start: yellow2)),
  ...
  test('BoxDecoration.border takes a BorderDirectional', () {
    const BoxDecoration decoration2 = BoxDecoration(border: BorderDirectional(start: BorderSide(width: 2.0)));
    const BoxDecoration decoration4 = BoxDecoration(border: BorderDirectional(start: BorderSide(width: 4.0)));
    const BoxDecoration decoration6 = BoxDecoration(border: BorderDirectional(start: BorderSide(width: 6.0)));
    ...
    }, paints..path(includes: <Offset>[const Offset(49.0, 10.0)], excludes: <Offset>[const Offset(31.0, 10.0)]));
    expect((Canvas canvas) {
      painter.paint(
        canvas,
        const Offset(30.0, 0.0),
    ...
    }, paints..path(includes: <Offset>[const Offset(31.0, 10.0)], excludes: <Offset>[const Offset(49.0, 10.0)]));
