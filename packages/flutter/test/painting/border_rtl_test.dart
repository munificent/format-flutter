...
void main() {
  test('BoxBorder.lerp', () {
    ...
    const BoxBorder directionalWithTop10 = BorderDirectional(
    ...
    expect(
      BoxBorder.lerp(directionalWithTop10, visualWithTop100, -1.0),
      const Border(),
    );
    expect(
    ...
    expect(
      BoxBorder.lerp(Border.all(width: 10.0), null, 0.0),
    ...
    expect(
      BoxBorder.lerp(null, directionalWithTop10, 0.0),
      const BorderDirectional(),
    );
    expect(
    ...
    expect(
      BoxBorder.lerp(visualWithSides10, directionalWithMagentaTop5, 0.0),
      visualWithSides10,
    );
    expect(
    ...
    expect(
      BoxBorder.lerp(visualWithSides10, directionalWithSides10, 0.0),
      visualWithSides10,
    );
    expect(
    ...
    expect(
      () => BoxBorder.lerp(const SillyBorder(), const Border(), 0.0),
      throwsFlutterError,
    );

    expect(BoxBorder.lerp(null, null, 0.25), null);
    expect(
      BoxBorder.lerp(Border.all(width: 10.0), null, 0.25),
      Border.all(width: 7.5),
    );
    expect(
      BoxBorder.lerp(null, Border.all(width: 10.0), 0.25),
    ...
    expect(
      () => BoxBorder.lerp(const SillyBorder(), const Border(), 0.25),
      throwsFlutterError,
    );

    expect(BoxBorder.lerp(null, null, 0.75), null);
    expect(
      BoxBorder.lerp(Border.all(width: 10.0), null, 0.75),
      Border.all(width: 2.5),
    );
    expect(
      BoxBorder.lerp(null, Border.all(width: 10.0), 0.75),
      Border.all(width: 7.5),
    );
    expect(
    ...
    expect(
      BoxBorder.lerp(null, Border.all(width: 10.0), 2.0),
      Border.all(width: 20.0),
    );
    expect(
      BoxBorder.lerp(directionalWithTop10, null, 2.0),
      const BorderDirectional(),
    );
    expect(
    ...
    expect(
      BoxBorder.lerp(directionalWithTop10, visualWithTop100, 2.0),
      visualWithTop190,
    );
    expect(
  ...
  test('BorderDirectional.add', () {
    ...
    const BorderSide doubleSide1 = BorderSide(
      color: Color(0x11111111),
      width: 2.0,
    );
    const BorderSide side2 = BorderSide(color: Color(0x22222222));
    const BorderSide doubleSide2 = BorderSide(
    ...
    const Border borderWithLeft = Border(
      left: side1,
      top: side2,
      bottom: side2,
    );
    const Border borderWithRight = Border(
      right: side1,
      top: side2,
      bottom: side2,
    );
  ...
  test('BorderDirectional.lerp', () {
    const BorderDirectional directionalWithTop10 = BorderDirectional(
      top: BorderSide(width: 10.0),
    );
    ...
    expect(
      BorderDirectional.lerp(null, directionalWithTop10, 0.0),
      const BorderDirectional(),
    );
    ...
    expect(
      BorderDirectional.lerp(directionalWithTop10, null, 2.0),
      const BorderDirectional(),
    );
    expect(
