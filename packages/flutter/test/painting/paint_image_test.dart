...
void main() {
  ...
  test('Cover and align', () async {
    ...
    final Invocation command = canvas.invocations.firstWhere(
    ...
    expect(
      command.positionalArguments[1],
      equals(const Rect.fromLTWH(0.0, 75.0, 300.0, 150.0)),
    );
    expect(
      command.positionalArguments[2],
  ...
  test('debugInvertOversizedImages', () async {
    ...
    expect(PaintingBinding.instance.platformDispatcher.views.any(
