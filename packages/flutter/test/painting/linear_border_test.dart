...
final List<Offset> leftRectIncludes = rectIncludes(
  const Rect.fromLTWH(0, 0, 4, 100),
);
final List<Offset> rightRectIncludes = rectIncludes(
  const Rect.fromLTWH(96, 0, 4, 100),
);
final List<Offset> topRectIncludes = rectIncludes(
  const Rect.fromLTWH(0, 0, 100, 4),
);
final List<Offset> bottomRectIncludes = rectIncludes(
  const Rect.fromLTWH(0, 96, 100, 4),
);
...
void main() {
  ...
  test('LinearBorder copyWith, ==, hashCode', () {
    ...
    expect(
      LinearBorder.none.copyWith(side: side),
      const LinearBorder(side: side),
    );
  });
