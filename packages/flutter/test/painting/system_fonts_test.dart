...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(home: SelectableText('text widget')),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(CupertinoApp(
        home: CupertinoDatePicker(onDateTimeChanged: (DateTime dateTime) {}),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(CupertinoApp(
        home: CupertinoTimerPicker(onTimerDurationChanged: (Duration d) {}),
      ));
  ...
  testWidgets('RangeSlider relayout upon system fonts changes', (
    ...
    final RenderObject renderObject = tester.renderObject(find
        .byWidgetPredicate(
          (Widget widget) =>
  ...
  testWidgets(
    'Slider relayout upon system fonts changes',
    (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
