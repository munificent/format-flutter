...
void main() {
  ...
  test('FlutterLogoDecoration lerp from null to null is null', () {
    final FlutterLogoDecoration? logo = FlutterLogoDecoration.lerp(
      null,
      null,
      0.5,
    );
  ...
  test('FlutterLogoDecoration.lerpFrom and FlutterLogoDecoration.lerpTo', () {
    ...
    expect(
      Decoration.lerp(start, const BoxDecoration(), 1.0),
      const BoxDecoration(),
    );
    expect(
      Decoration.lerp(const BoxDecoration(), end, 0.0),
      const BoxDecoration(),
    );
  ...
  testWidgets('Flutter Logo golden test', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      Container(key: logo, decoration: const FlutterLogoDecoration()),
    );
