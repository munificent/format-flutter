...
void main() {
  ...
  test('maintains cache size', () async {
    ...
    final TestImageInfo a = await extractOneFrame(TestImageProvider(
      1,
      1,
      image: await createTestImage(),
    ).resolve(ImageConfiguration.empty)) as TestImageInfo;
    expect(a.value, equals(1));
    final TestImageInfo b = await extractOneFrame(TestImageProvider(
      1,
      2,
      image: await createTestImage(),
    ).resolve(ImageConfiguration.empty)) as TestImageInfo;
    expect(b.value, equals(1));
    final TestImageInfo c = await extractOneFrame(TestImageProvider(
      1,
      3,
      image: await createTestImage(),
    ).resolve(ImageConfiguration.empty)) as TestImageInfo;
    expect(c.value, equals(1));
    final TestImageInfo d = await extractOneFrame(TestImageProvider(
      1,
      4,
      image: await createTestImage(),
    ).resolve(ImageConfiguration.empty)) as TestImageInfo;
    expect(d.value, equals(1));
    final TestImageInfo e = await extractOneFrame(TestImageProvider(
      1,
      5,
      image: await createTestImage(),
    ).resolve(ImageConfiguration.empty)) as TestImageInfo;
    expect(e.value, equals(1));
    final TestImageInfo f = await extractOneFrame(TestImageProvider(
      1,
      6,
      image: await createTestImage(),
    ).resolve(ImageConfiguration.empty)) as TestImageInfo;
    ...
    final TestImageInfo g = await extractOneFrame(TestImageProvider(
      2,
      7,
      image: await createTestImage(),
    ).resolve(ImageConfiguration.empty)) as TestImageInfo;
    ...
    final TestImageInfo h = await extractOneFrame(TestImageProvider(
      1,
      8,
      image: await createTestImage(),
    ).resolve(ImageConfiguration.empty)) as TestImageInfo;
    ...
    final TestImageInfo i = await extractOneFrame(TestImageProvider(
      3,
      9,
      image: await createTestImage(),
    ).resolve(ImageConfiguration.empty)) as TestImageInfo;
    ...
    final TestImageInfo j = await extractOneFrame(TestImageProvider(
      1,
      10,
      image: await createTestImage(),
    ).resolve(ImageConfiguration.empty)) as TestImageInfo;
    ...
    final TestImageInfo k = await extractOneFrame(TestImageProvider(
      4,
      11,
      image: await createTestImage(),
    ).resolve(ImageConfiguration.empty)) as TestImageInfo;
    ...
    final TestImageInfo l = await extractOneFrame(TestImageProvider(
      1,
      12,
      image: await createTestImage(),
    ).resolve(ImageConfiguration.empty)) as TestImageInfo;
    ...
    final TestImageInfo m = await extractOneFrame(TestImageProvider(
      2,
      13,
      image: await createTestImage(),
    ).resolve(ImageConfiguration.empty)) as TestImageInfo;
    ...
    final TestImageInfo n = await extractOneFrame(TestImageProvider(
      3,
      14,
      image: await createTestImage(),
    ).resolve(ImageConfiguration.empty)) as TestImageInfo;
    ...
    final TestImageInfo o = await extractOneFrame(TestImageProvider(
      4,
      15,
      image: await createTestImage(),
    ).resolve(ImageConfiguration.empty)) as TestImageInfo;
    ...
    final TestImageInfo p = await extractOneFrame(TestImageProvider(
      1,
      16,
      image: await createTestImage(),
    ).resolve(ImageConfiguration.empty)) as TestImageInfo;
  ...
  test('putIfAbsent updates LRU properties of a live image', () async {
    ...
    expect(
      imageCache.statusForKey(testImage2).keepAlive,
      true,
    ); // took the LRU spot.
  ...
  test('Live image cache avoids leaks of unlistened streams', () async {
    ...
    TestImageProvider(1, 1, image: await createTestImage()).resolve(
      ImageConfiguration.empty,
    );
    TestImageProvider(2, 2, image: await createTestImage()).resolve(
      ImageConfiguration.empty,
    );
    TestImageProvider(3, 3, image: await createTestImage()).resolve(
      ImageConfiguration.empty,
    );
    TestImageProvider(4, 4, image: await createTestImage()).resolve(
      ImageConfiguration.empty,
    );
    TestImageProvider(5, 5, image: await createTestImage()).resolve(
      ImageConfiguration.empty,
    );
    TestImageProvider(6, 6, image: await createTestImage()).resolve(
      ImageConfiguration.empty,
    );
