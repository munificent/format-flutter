...
void main() {
  ...
  test('LinearGradient.lerp identical a,b', () {
    ...
    const LinearGradient gradient = LinearGradient(colors: <Color>[Color(0x33333333), Color(0x66666666)]);
  ...
  test('LinearGradient lerp test with unequal number of colors', () {
    const LinearGradient testGradient1 = LinearGradient(colors: <Color>[Color(0x22222222), Color(0x66666666)]);
    const LinearGradient testGradient2 = LinearGradient(
  ...
  test('LinearGradient lerp test with stops and unequal number of colors', () {
    ...
    expect(
      actual,
      const LinearGradient(
        colors: <Color>[Color(0x3B3B3B3B), Color(0x55555555), Color(0x57575757), Color(0x77777777)],
  ...
  test('LinearGradient with AlignmentDirectional', () {
    ...
    expect(() {
      return const LinearGradient(begin: Alignment.topLeft, colors: <Color>[Color(0xFFFFFFFF), Color(0xFFFFFFFF)])
          .createShader(const Rect.fromLTWH(0.0, 0.0, 100.0, 100.0));
    }, returnsNormally);
  });
  ...
  test('RadialGradient with AlignmentDirectional', () {
    ...
    expect(() {
      return const RadialGradient(center: Alignment.topLeft, colors: <Color>[Color(0xFFFFFFFF), Color(0xFFFFFFFF)])
          .createShader(const Rect.fromLTWH(0.0, 0.0, 100.0, 100.0));
    }, returnsNormally);
  });
  ...
  test('RadialGradient.lerp identical a,b', () {
    ...
    const RadialGradient gradient = RadialGradient(colors: <Color>[Color(0x33333333), Color(0x66666666)]);
  ...
  test('RadialGradient lerp test with unequal number of colors', () {
    const RadialGradient testGradient1 = RadialGradient(colors: <Color>[Color(0x22222222), Color(0x66666666)]);
    const RadialGradient testGradient2 = RadialGradient(
      colors: <Color>[Color(0x44444444), Color(0x66666666), Color(0x88888888)],
    );
  ...
  test('SweepGradient.lerp identical a,b', () {
    ...
    const SweepGradient gradient = SweepGradient(colors: <Color>[Color(0x33333333), Color(0x66666666)]);
  ...
  test('SweepGradient lerp test with unequal number of colors', () {
    const SweepGradient testGradient1 = SweepGradient(colors: <Color>[Color(0x22222222), Color(0x66666666)]);
    const SweepGradient testGradient2 = SweepGradient(
      colors: <Color>[Color(0x44444444), Color(0x66666666), Color(0x88888888)],
    );
    ...
    Future<void> runTest(WidgetTester tester, Gradient gradient, double degrees) async {
      ...
      await tester.pumpWidget(Center(
        child: SizedBox.fromSize(
          size: rect.size,
          child: RepaintBoundary(key: painterKey, child: CustomPaint(painter: GradientPainter(shader, rect))),
        ),
      ));
