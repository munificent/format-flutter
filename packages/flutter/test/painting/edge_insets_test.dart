...
void main() {
  ...
  test('EdgeInsetsGeometry.lerp(...)', () {
    ...
    expect(
      EdgeInsetsGeometry.lerp(
        ...
        const EdgeInsetsDirectional.only(start: 1.0, bottom: 1.0).add(const EdgeInsets.only(right: 2.0)),
        0.5,
      ),
    ...
    expect(
      EdgeInsetsGeometry.lerp(
        ...
        const EdgeInsetsDirectional.only(end: 1.0, bottom: 1.0).add(const EdgeInsets.only(right: 2.0)),
        0.5,
      ),
  ...
  test('EdgeInsetsGeometry.lerp(mixed, ...)', () {
    final EdgeInsetsGeometry a = const EdgeInsetsDirectional.only(start: 10.0, end: 10.0).add(
      const EdgeInsets.all(1.0),
    );
    final EdgeInsetsGeometry b = const EdgeInsetsDirectional.only(start: 20.0, end: 20.0).add(
