...
void main() {
  test('EdgeInsets constructors', () {
    // fromLTRB
    final EdgeInsets ltrbLtr = const EdgeInsets.fromLTRB(10, 20, 30, 40)
        .resolve(TextDirection.ltr);
    expect(ltrbLtr.left, 10);
    expect(ltrbLtr.top, 20);
    expect(ltrbLtr.right, 30);
    expect(ltrbLtr.bottom, 40);
    final EdgeInsets ltrbRtl = const EdgeInsets.fromLTRB(10, 20, 30, 40)
    ...
    expect(
      all.resolve(TextDirection.ltr),
      equals(const EdgeInsets.fromLTRB(10, 10, 10, 10)),
    );
    expect(
      all.resolve(TextDirection.rtl),
      equals(const EdgeInsets.fromLTRB(10, 10, 10, 10)),
    );

    // only
    const EdgeInsets only = EdgeInsets.only(
      left: 10,
      top: 20,
      right: 30,
      bottom: 40,
    ...
    expect(
      only.resolve(TextDirection.ltr),
      equals(const EdgeInsets.fromLTRB(10, 20, 30, 40)),
    );
    expect(
      only.resolve(TextDirection.rtl),
      equals(const EdgeInsets.fromLTRB(10, 20, 30, 40)),
    );

    // symmetric
    const EdgeInsets symmetric = EdgeInsets.symmetric(
      horizontal: 10,
      vertical: 20,
    );
    expect(
      symmetric.resolve(TextDirection.ltr),
      equals(const EdgeInsets.fromLTRB(10, 20, 10, 20)),
    );
    expect(
      symmetric.resolve(TextDirection.rtl),
      equals(const EdgeInsets.fromLTRB(10, 20, 10, 20)),
    );
  });
  ...
  test('EdgeInsetsDirectional constructors', () {
    ...
    expect(
      directional.resolve(TextDirection.ltr),
      const EdgeInsets.fromLTRB(10, 20, 30, 40),
    );
    expect(
      directional.resolve(TextDirection.rtl),
  ...
  test('EdgeInsets control test', () {
    ...
    expect(
      insets.inflateSize(const Size(100.0, 125.0)),
      const Size(116.0, 145.0),
    );
    expect(
      insets.deflateSize(const Size(100.0, 125.0)),
      const Size(84.0, 105.0),
    );
  ...
  test('EdgeInsets.resolve()', () {
    expect(const EdgeInsetsDirectional.fromSTEB(10.0, 20.0, 30.0, 40.0).resolve(
      TextDirection.ltr,
    ), const EdgeInsets.fromLTRB(10.0, 20.0, 30.0, 40.0));
    expect(const EdgeInsetsDirectional.fromSTEB(99.0, 98.0, 97.0, 96.0).resolve(
      TextDirection.rtl,
    ...
    expect(const EdgeInsetsDirectional.only(start: 963.25).resolve(
      TextDirection.ltr,
    ...
    expect(const EdgeInsetsDirectional.only(bottom: 963.25).resolve(
      TextDirection.ltr,
    ...
    expect(
      const EdgeInsetsDirectional.fromSTEB(10.0, 20.0, 30.0, 40.0).resolve(
        TextDirection.ltr,
      ),
      const EdgeInsetsDirectional.fromSTEB(30.0, 20.0, 10.0, 40.0).resolve(
        TextDirection.rtl,
      ),
    );
    expect(
  ...
  test('EdgeInsets equality', () {
    ...
    expect(
      const EdgeInsetsDirectional.only(end: 5.0).add(
        const EdgeInsets.only(right: 5.0),
      ),
      const EdgeInsetsDirectional.only(end: 5.0).add(
        const EdgeInsets.only(right: 5.0),
    ...
    expect(
      ...
      isNot(const EdgeInsetsDirectional.only(end: 5.0).add(
        const EdgeInsets.only(left: 5.0),
      )),
    );
    expect(const EdgeInsetsDirectional.only(top: 1.0).add(
  ...
  test('EdgeInsetsGeometry.lerp(...)', () {
    expect(EdgeInsetsGeometry.lerp(
    ...
    expect(
      ...
      const EdgeInsetsDirectional.only(start: 5.0).add(
    ...
    expect(
      EdgeInsetsGeometry.lerp(
        ...
        const EdgeInsetsDirectional.only(start: 1.0, bottom: 1.0).add(
          const EdgeInsets.only(right: 2.0),
        ),
        0.5,
      ),
      const EdgeInsetsDirectional.only(start: 0.5).add(
        const EdgeInsets.only(right: 1.0, bottom: 1.0),
      ),
    );
    expect(
      EdgeInsetsGeometry.lerp(
        const EdgeInsets.only(bottom: 1.0),
        const EdgeInsetsDirectional.only(end: 1.0, bottom: 1.0).add(
          const EdgeInsets.only(right: 2.0),
        ),
        0.5,
      ),
      const EdgeInsetsDirectional.only(end: 0.5).add(
        const EdgeInsets.only(right: 1.0, bottom: 1.0),
      ),
    );
  });
  ...
  test('EdgeInsetsGeometry.lerp identical a,b', () {
    ...
    expect(
      identical(EdgeInsetsGeometry.lerp(insets, insets, 0.5), insets),
      true,
    );
  });
  ...
  test('EdgeInsetsDirectional.lerp identical a,b', () {
    ...
    expect(
      identical(EdgeInsetsDirectional.lerp(insets, insets, 0.5), insets),
      true,
    );
  });
  ...
  test('EdgeInsetsGeometry.lerp(directional, ...)', () {
    const EdgeInsetsDirectional a = EdgeInsetsDirectional.only(
      start: 10.0,
      end: 10.0,
    );
    const EdgeInsetsDirectional b = EdgeInsetsDirectional.only(
      start: 20.0,
      end: 20.0,
    );
    expect(EdgeInsetsGeometry.lerp(a, b, 0.25), equals(a * 1.25));
  ...
  test('EdgeInsetsDirectional operators', () {
    const EdgeInsetsDirectional a = EdgeInsetsDirectional.fromSTEB(
      1.0,
      2.0,
      3.0,
      5.0,
  ...
  test('EdgeInsetsGeometry toString', () {
    ...
    expect(
      const EdgeInsetsDirectional.only(start: 4.0).add(
        const EdgeInsets.only(top: 3.0),
      ).toString(),
      'EdgeInsetsDirectional(4.0, 3.0, 0.0, 0.0)',
    );
    expect(
      const EdgeInsetsDirectional.only(top: 4.0).add(
