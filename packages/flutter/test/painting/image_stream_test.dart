...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final FrameInfo frame = FakeFrameInfo(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(emittedImages.every(
        (ImageInfo info) => info.image.isCloneOf(frame.image),
      ), true);
    },
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final FrameInfo frame1 = FakeFrameInfo(
        const Duration(milliseconds: 200),
        image20x10,
      );
      ...
      final FrameInfo frame2 = FakeFrameInfo(
  ...
  testWidgets('animation wraps back', (WidgetTester tester) async {
    ...
    final FakeFrameInfo frame1 = FakeFrameInfo(
      const Duration(milliseconds: 200),
      image20x10,
    );
    final FakeFrameInfo frame2 = FakeFrameInfo(
      const Duration(milliseconds: 400),
      image200x100,
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      final Image image10x10 = (await tester.runAsync(
  ...
  test(
    'Multi-frame complete unsubscribes to chunk events when disposed',
    () async {
