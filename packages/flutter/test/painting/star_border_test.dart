...
void main() {
  ...
  testWidgets('StarBorder parameters', (WidgetTester tester) async {
    ...
    await testBorder(
      tester,
      'inner_radius_0',
      const StarBorder(innerRadiusRatio: 0.0),
    );
    await testBorder(
      tester,
      'inner_radius_20',
      const StarBorder(innerRadiusRatio: 0.2),
    );
    await testBorder(
      tester,
      'inner_radius_70',
      const StarBorder(innerRadiusRatio: 0.7),
    );
    await testBorder(
      tester,
      'point_rounding_20',
      const StarBorder(pointRounding: 0.2),
    );
    await testBorder(
      tester,
      'point_rounding_70',
      const StarBorder(pointRounding: 0.7),
    );
    await testBorder(
      tester,
      'point_rounding_100',
      const StarBorder(pointRounding: 1.0),
    );
    await testBorder(
      tester,
      'valley_rounding_20',
      const StarBorder(valleyRounding: 0.2),
    );
    await testBorder(
      tester,
      'valley_rounding_70',
      const StarBorder(valleyRounding: 0.7),
    );
    await testBorder(
      tester,
      'valley_rounding_100',
      const StarBorder(valleyRounding: 1.0),
    );
  ...
  testWidgets('StarBorder.polygon parameters', (WidgetTester tester) async {
    await testBorder(
      tester,
      'poly_sides_6',
      const StarBorder.polygon(sides: 6),
    );
    await testBorder(
      tester,
      'poly_sides_2',
      const StarBorder.polygon(sides: 2),
    );
    await testBorder(
      tester,
    ...
    await testBorder(
      tester,
      'poly_squash_20',
      const StarBorder.polygon(squash: 0.2),
    );
    await testBorder(
      tester,
      'poly_squash_70',
      const StarBorder.polygon(squash: 0.7),
    );
    await testBorder(
      tester,
      'poly_squash_100',
      const StarBorder.polygon(squash: 1.0),
    );
    await testBorder(
      tester,
      'poly_rotate_27',
      const StarBorder.polygon(rotation: 27),
    );
    await testBorder(
      tester,
      'poly_rotate_270',
      const StarBorder.polygon(rotation: 270),
    );
    await testBorder(
      tester,
      'poly_rotate_360',
      const StarBorder.polygon(rotation: 360),
    );
    await testBorder(
      tester,
      'poly_side_none',
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await testBorder(
        tester,
        'to_stadium_border_20',
        from,
        lerpTo: stadiumBorder,
        lerpAmount: 0.2,
      );
      await testBorder(
        tester,
        'to_stadium_border_70',
        from,
        lerpTo: stadiumBorder,
        lerpAmount: 0.7,
      );
