...
void main() {
  test('throws flutter error when tweening types that do not fully satisfy tween requirements - Object', () {
    ...
    expect(() => objectTween.transform(0.1), throwsA(isA<FlutterError>().having(
  ...
  test('throws flutter error when tweening types that do not fully satisfy tween requirements - Color', () {
    final Tween<Color> colorTween = Tween<Color>(begin: const Color(0xFF000000), end: const Color(0xFFFFFFFF));

    expect(() => colorTween.transform(0.1), throwsA(isA<FlutterError>().having(
      (FlutterError error) => error.diagnostics.map((DiagnosticsNode node) => node.toString()),
      'diagnostics',
      <String>[
  ...
  test('ColorTween', () {
    final ColorTween tween = ColorTween(begin: const Color(0xff000000), end: const Color(0xffffffff));
