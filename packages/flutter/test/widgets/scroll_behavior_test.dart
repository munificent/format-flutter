...
void main() {
  ...
  testWidgets('Inherited ScrollConfiguration changed', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(ScrollConfiguration(behavior: const TestScrollBehavior(true), child: scrollView));
    ...
    await tester.pumpWidget(ScrollConfiguration(behavior: const TestScrollBehavior(false), child: scrollView));
  ...
  testWidgets('ScrollBehavior default android overscroll indicator', (WidgetTester tester) async {
    await tester.pumpWidget(Directionality(
      ...
      child: ScrollConfiguration(
        ...
        child: ListView(children: const <Widget>[SizedBox(height: 1000.0, width: 1000.0, child: Text('Test'))]),
      ),
    ));
  ...
  group('ScrollBehavior configuration is maintained over multiple copies', () {
    testWidgets('dragDevices', (WidgetTester tester) async {
      ...
      final ScrollBehavior onceCopiedBehavior = defaultBehavior.copyWith(dragDevices: PointerDeviceKind.values.toSet());
    ...
    Widget wrap(ScrollBehavior behavior) {
      return Directionality(
        ...
        child: MediaQuery(
          ...
          child: ScrollConfiguration(
            behavior: behavior,
            child: Builder(builder: (BuildContext context) => SingleChildScrollView(child: Container(height: 1000))),
          ),
        ),
      );
    }
