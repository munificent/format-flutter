...
void main() {
  ...
  testWidgets(
    '_WrappedScrollBehavior shouldNotify test',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        lastCreatedBuilder(const PointerDownEvent()),
        isA<VelocityTracker>(),
      );
  ...
  group('ScrollBehavior configuration is maintained over multiple copies', () {
    ...
    testWidgets('androidOverscrollIndicator', (WidgetTester tester) async {
      ...
      const ScrollBehavior defaultBehavior = ScrollBehavior();
      expect(
        defaultBehavior.androidOverscrollIndicator,
      ...
      expect(
        onceCopiedBehavior.androidOverscrollIndicator,
      ...
      final ScrollBehavior twiceCopiedBehavior = onceCopiedBehavior.copyWith();
      expect(
        twiceCopiedBehavior.androidOverscrollIndicator,
        AndroidOverscrollIndicator.stretch,
      );
    });
    ...
    testWidgets('physics', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(ScrollConfiguration(
        ...
        child: Builder(
          builder: (BuildContext context) {
            final ScrollBehavior defaultBehavior = ScrollConfiguration.of(
              context,
            );
            ...
            return ScrollConfiguration(
              ...
              child: Builder(
                builder: (BuildContext context) {
                  ...
                  onceCopiedPhysics = onceCopiedBehavior.getScrollPhysics(
                    context,
                  );
                  return ScrollConfiguration(
