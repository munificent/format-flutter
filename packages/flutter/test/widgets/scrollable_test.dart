...
void main() {
  ...
  testWidgets('Scroll pointer signals are handled on Fuchsia', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Scrolls horizontally when shift is pressed by default', (
    WidgetTester tester,
  ) async {
    await pumpTest(
      tester,
  ...
  testWidgets('Scroll axis is not flipped for trackpad', (
    WidgetTester tester,
  ) async {
    await pumpTest(
      tester,
  ...
  testWidgets('Scrolls horizontally when custom key is pressed', (
    WidgetTester tester,
  ) async {
    await pumpTest(
      tester,
  ...
  group('setCanDrag to false with active drag gesture: ', () {
      ...
      return tester.pumpWidget(MaterialApp(
        home: CustomScrollView(
          ...
          slivers: <Widget>[
            SliverToBoxAdapter(
              child:
                  SizedBox(height: 2000, child: GestureDetector(onTap: () {})),
            ),
          ],
        ),
      ));
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final RenderIgnorePointer renderIgnorePointer = tester
            .renderObject<RenderIgnorePointer>(find.descendant(
    ...
    testWidgets('Ballistic disables user interaction until it stops', (
      WidgetTester tester,
    ) async {
      await pumpTestWidget(tester, canDrag: true);
      final RenderIgnorePointer renderIgnorePointer = tester
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        widgetTracker.skip(17).every((String type) => type == 'cheap'),
        true,
      );
      ...
      expect(widgetTracker.skip(17).skip(25).take(70).every(
        (String type) => type == 'cheap',
      ), true);
      expect(widgetTracker.skip(17).skip(25).skip(70).every(
        (String type) => type == 'expensive',
      ), true);
    },
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        find.byKey(const ValueKey<String>('Cheap box 52')),
        findsOneWidget,
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset outerScrollable = tester.getCenter(
        find.text('SingleChildScrollView 3'),
      );
      final TestPointer testPointer = TestPointer(
        1,
        ui.PointerDeviceKind.mouse,
  ...
  testWidgets('Zero offset pointer scroll should not trigger an assertion.', (
    ...
    final Offset scrollable = tester.getCenter(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      Widget buildFrame(Set<ui.PointerDeviceKind>? dragDevices) {
        return MaterialApp(
          scrollBehavior:
              const NoScrollbarBehavior().copyWith(dragDevices: dragDevices),
  ...
  testWidgets('Scroll inertia cancel event', (WidgetTester tester) async {
    ...
    await tester.sendEventToBinding(
      testPointer.scrollInertiaCancel(),
