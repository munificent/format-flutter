...
void main() {
  ...
  testWidgets(
    'does not inject root bucket if inside scope',
  ...
  testWidgets(
    'injects root bucket when moved out of scope',
    (WidgetTester tester) async {
      ...
      final BucketSpyState state = tester.state(find.byType(BucketSpy));
      expect(state.bucket!.restorationId, 'root-child');
      expect((inScopeRawData[childrenMapKey] as Map<Object?, Object?>)
          .containsKey('root-child'), isTrue);
      ...
      expect(find.text('Hello'), findsOneWidget);
      expect(state.bucket!.restorationId, 'root-child');
      expect((outOfScopeRawData[childrenMapKey] as Map<Object?, Object?>)
          .containsKey('root-child'), isTrue);
  ...
  testWidgets(
    'injects null when rootBucket is null',
    (WidgetTester tester) async {
