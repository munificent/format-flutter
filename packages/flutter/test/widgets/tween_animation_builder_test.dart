...
void main() {
  testWidgets('Animates forward when built', (WidgetTester tester) async {
    ...
    int endCount = 0;
    await tester.pumpWidget(TweenAnimationBuilder<int>(
  ...
  testWidgets(
    'No initial animation when begin=null',
  ...
  testWidgets(
    'No initial animation when begin=end',
    (WidgetTester tester) async {
      final List<int> values = <int>[];
      int endCount = 0;
      await tester.pumpWidget(TweenAnimationBuilder<int>(
  ...
  group('Change tween gapless while', () {
    testWidgets('running forward', (WidgetTester tester) async {
      ...
      // Change tween
      await tester.pumpWidget(
        buildWidget(tween: IntTween(begin: 200, end: 300)),
      );
      expect(values, <int>[
        0,
        50,
        50,
      ]); // gapless: animation continues where it left off.
  ...
  testWidgets('Works with nullable tweens', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(TweenAnimationBuilder<Size?>(
      duration: const Duration(seconds: 1),
