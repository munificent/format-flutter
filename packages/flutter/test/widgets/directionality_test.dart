...
void main() {
  ...
  testWidgets('Directionality.maybeOf', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Container(
      ...
      child: Directionality(textDirection: TextDirection.rtl, child: Container(key: hasDirectionality)),
    ));
  ...
  testWidgets('Directionality.of', (WidgetTester tester) async {
    ...
    expect(() => Directionality.of(noDirectionality.currentContext!), throwsA(
      isAssertionError.having((AssertionError e) => e.message, 'message', contains('No Directionality widget found.')),
    ));
