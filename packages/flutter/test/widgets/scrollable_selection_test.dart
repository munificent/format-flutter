...
void main() {
  ...
  testWidgets('mouse can select multiple widgets - horizontal', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(MaterialApp(
      home: SelectionArea(
    ...
    await gesture.moveTo(
      textOffsetToPosition(paragraph2, 5) + const Offset(0, 5),
    );
    // Should select the rest of paragraph 1.
    expect(
      paragraph1.selections[0],
  ...
  testWidgets('select to scroll works for small scrollable', (
    WidgetTester tester,
  ) async {
    final ScrollController controller = ScrollController();
    await tester.pumpWidget(MaterialApp(
  ...
  testWidgets('select to scroll forward - horizontal', (
    WidgetTester tester,
  ) async {
    final ScrollController controller = ScrollController();
    await tester.pumpWidget(MaterialApp(
    ...
    expect(
      paragraph9.selections[0],
      const TextSelection(baseOffset: 0, extentOffset: 6),
    );
    expect(
      paragraph8.selections[0],
      const TextSelection(baseOffset: 0, extentOffset: 6),
    );
    expect(
      paragraph7.selections[0],
      const TextSelection(baseOffset: 0, extentOffset: 6),
    );
  ...
  testWidgets('select to scroll backward - horizontal', (
    WidgetTester tester,
  ) async {
    final ScrollController controller = ScrollController();
    await tester.pumpWidget(MaterialApp(
  ...
  testWidgets('preserve selection when out of view.', (
    WidgetTester tester,
  ) async {
    final ScrollController controller = ScrollController();
    await tester.pumpWidget(MaterialApp(
  ...
  testWidgets('select to scroll by dragging selection handles forward', (
    ...
    final List<TextBox> boxes = paragraph0.getBoxesForSelection(
      paragraph0.selections[0],
    );
    expect(boxes.length, 1);
    // Find end handle.
    final Offset handlePos = globalize(
  ...
  testWidgets('keyboard selection should auto scroll - vertical', (
    WidgetTester tester,
  ) async {
    final FocusNode node = FocusNode();
    final ScrollController controller = ScrollController();
    ...
    addTearDown(gesture.removePointer);
    await gesture.moveTo(
      textOffsetToPosition(paragraph9, 4) + const Offset(0, 5),
    );
    await tester.pumpAndSettle();
    await gesture.up();
    await tester.pump();
  ...
  testWidgets('keyboard selection should auto scroll - horizontal', (
    ...
    addTearDown(gesture.removePointer);
    await gesture.moveTo(
      textOffsetToPosition(paragraph2, 1) + const Offset(0, 5),
    );
    await tester.pumpAndSettle();
    await gesture.up();
    await tester.pump();
  ...
  testWidgets('keyboard selection should auto scroll - horizontal reversed', (
    ...
    addTearDown(gesture.removePointer);
    await gesture.moveTo(
      textOffsetToPosition(paragraph1, 4) + const Offset(0, 5),
    );
    await tester.pumpAndSettle();
    await gesture.up();
    await tester.pumpAndSettle();
  ...
  group('Complex cases', () {
    testWidgets(
      'selection starts outside of the scrollable',
      (WidgetTester tester) async {
        final ScrollController controller = ScrollController();
        await tester.pumpWidget(MaterialApp(
          home: SelectionArea(
        ...
        await gesture.moveTo(
          textOffsetToPosition(paragraph1, 2) + const Offset(0, 5),
        );
        await tester.pumpAndSettle();
        await gesture.up();
        ...
        final RenderParagraph innerParagraph = tester
            .renderObject<RenderParagraph>(find.descendant(
              of: find.text('Inner item 20'),
              matching: find.byType(RichText),
            ));
        expect(
          innerParagraph.selections[0],
    ...
    testWidgets(
      'nested scrollables keep selection alive',
      (WidgetTester tester) async {
        ...
        await gesture.up();
        expect(
          innerParagraph23.selections[0],
          const TextSelection(baseOffset: 2, extentOffset: 12),
        );
        expect(
          innerParagraph24.selections[0],
          const TextSelection(baseOffset: 0, extentOffset: 2),
        );
