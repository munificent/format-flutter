...
void main() {
  testWidgets('Visibility', (WidgetTester tester) async {
    ...
    final Matcher expectedSemanticsWhenAbsent = hasSemantics(
      TestSemantics.root(),
    );
    ...
    await tester.pumpWidget(
      Center(child: Visibility(visible: false, child: testChild)),
    );
    expect(find.byType(Text, skipOffstage: false), findsNothing);
    ...
    await tester.pumpWidget(Center(
      child: Visibility(visible: false, maintainState: true, child: testChild),
    ));
    expect(find.byType(Text, skipOffstage: false), findsOneWidget);
    expect(find.byType(Text), findsNothing);
    ...
    await tester.pumpWidget(
      Center(child: Visibility(maintainState: true, child: testChild)),
    );
  ...
  testWidgets('Visibility.of returns correct value', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const Directionality(
    ...
    expect(
      find.text('is visible ? false', skipOffstage: false),
      findsOneWidget,
    );
  });
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      Widget newWidget({
        required bool ancestorIsVisible,
        required bool descendantIsVisible,
      }) {
      ...
      expect(
        find.text('is visible ? true', skipOffstage: false),
        findsOneWidget,
      );
