...
void main() {
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        (first.parentData! as SliverPhysicalParentData).paintOffset.dy,
        equals(0.0),
      );
      expect(first.constraints.scrollOffset, equals(19 * 300.0));
      expect(
        (second.parentData! as SliverPhysicalParentData).paintOffset.dy,
        equals(1 * 300.0),
      );

      final RenderSliverMainAxisGroup renderGroup = tester
          .renderObject<RenderSliverMainAxisGroup>(
