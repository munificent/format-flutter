...
void main() {
  ...
  testWidgets('restorablePushNamedAndRemoveUntil', (WidgetTester tester) async {
    ...
    tester.state<NavigatorState>(find.byType(Navigator)).restorablePushNamedAndRemoveUntil(
      'Foo',
  ...
  testWidgets('restorablePushAndRemoveUntil', (WidgetTester tester) async {
    ...
    tester.state<NavigatorState>(find.byType(Navigator)).restorablePushAndRemoveUntil(
      _routeBuilder,
      (Route<dynamic> _) => false,
      arguments: 'Foo',
    );
  ...
  testWidgets('restorableReplaceRouteBelow', (WidgetTester tester) async {
    ...
    tester.state<NavigatorState>(find.byType(Navigator)).restorableReplaceRouteBelow(
      newRouteBuilder: _routeBuilder,
      arguments: 'Foo',
      anchorRoute: anchor,
    );
  ...
  testWidgets('RestorableRouteFuture', (WidgetTester tester) async {
    ...
    final RestorableRouteFuture<int> restoredRouteFuture =
        tester.state<RouteFutureWidgetState>(find.byType(RouteFutureWidget, skipOffstage: false)).routeFuture;
  ...
  testWidgets('Illegal arguments throw', (WidgetTester tester) async {
    ...
    expect(
      () => tester.state<NavigatorState>(find.byType(Navigator)).restorablePushReplacementNamed(
        'Foo',
        arguments: Object(),
      ),
      throwsArgumentsAssertionError,
    ...
    expect(
      () => tester.state<NavigatorState>(find.byType(Navigator)).restorablePushReplacement(
        _routeBuilder,
        arguments: Object(),
      ),
      throwsArgumentsAssertionError,
  ...
  testWidgets('Moving scopes', (WidgetTester tester) async {
    await tester.pumpWidget(const RootRestorationScope(restorationId: 'root', child: TestWidget(restorationId: null)));
    await tapRouteCounter('home', tester);
    tester.state<NavigatorState>(find.byType(Navigator)).restorablePushNamed('Foo');
    await tester.pumpAndSettle();
    expect(findRoute('Foo'), findsOneWidget);
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        ...
        onGenerateInitialRoutes: (String initialRoute) {
          return <MaterialPageRoute<void>>[MaterialPageRoute<void>(builder: (BuildContext context) => Container())];
        },
      ));
      await tester.restartAndRestore();
  ...
  Widget build(BuildContext context) {
    return RootRestorationScope(
      ...
      child: Directionality(
        ...
        child: MediaQuery(data: MediaQueryData.fromView(View.of(context)), child: const PagedTestNavigator()),
      ),
    );
  }
}
...
Finder findRoute(String name, {Object? arguments, int? count, bool skipOffstage = true}) => _RouteFinder(
  name,
  arguments: arguments,
  count: count,
