...
Future<void> testImageQuality(WidgetTester tester, ui.FilterQuality? quality) async {
  ...
  await tester.pumpWidget(
    quality == null ? Image(image: imageProvider) : Image(image: imageProvider, filterQuality: quality),
  );

  await expectLater(find.byType(Image), matchesGoldenFile('image_quality_${quality ?? 'default'}.png'));
}
