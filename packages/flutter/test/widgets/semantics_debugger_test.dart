...
void main() {
        ...
        child: Stack(
          children: <Widget>[
            ...
            Positioned(
              ...
              height: 100.0,
              child:
                  Semantics(label: 'label2', textDirection: TextDirection.ltr),
            ),
          ],
        ),
      ),
  ...
  testWidgets(
    'SemanticsDebugger interaction test',
    (WidgetTester tester) async {
  ...
  testWidgets('SemanticsDebugger scroll test', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Directionality(
      ...
      child: SemanticsDebugger(
        child: ListView(
          children: <Widget>[
            Container(key: childKey, height: 5000.0, color: Colors.green[500]),
          ],
        ),
      ),
    ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(_getMessageShownInSemanticsDebugger(
        widgetKey: checkbox,
...
dynamic _getSemanticsDebuggerPainter({
  ...
  expect(
    semanticsDebuggerPainter.runtimeType.toString(),
