...
void main() {
  ...
  testWidgets('GridView.count control test', (WidgetTester tester) async {
      ...
      child: GridView.count(
        ...
        children: kStates.map<Widget>((String state) {
          return GestureDetector(
            ...
            child:
                ColoredBox(color: const Color(0xFF0000FF), child: Text(state)),
          );
        }).toList(),
      ),
    ));
    ...
    expect(
      tester.getSize(find.text('Arkansas')),
    ...
    expect(
      tester.getCenter(find.text('Tennessee')),
  ...
  testWidgets('GridView.builder with undefined itemCount', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(Directionality(
      textDirection: TextDirection.ltr,
  ...
  testWidgets('GridView cross axis layout', (WidgetTester tester) async {
    ...
    expect(
      tester.getBottomRight(find.byKey(target)),
  ...
  testWidgets('GridView.builder respects clipBehavior', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(Directionality(
      textDirection: TextDirection.ltr,
  ...
  testWidgets('GridView.custom respects clipBehavior', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(Directionality(
      textDirection: TextDirection.ltr,
  ...
  testWidgets(
    'GridView.count respects clipBehavior',
    (WidgetTester tester) async {
      await tester.pumpWidget(Directionality(
        textDirection: TextDirection.ltr,
        child: GridView.count(
  ...
  testWidgets(
    'GridView.extent respects clipBehavior',
    (WidgetTester tester) async {
      await tester.pumpWidget(Directionality(
        textDirection: TextDirection.ltr,
        child: GridView.extent(
