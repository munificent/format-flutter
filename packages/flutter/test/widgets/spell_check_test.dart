...
void main() {
  ...
  testWidgets('buildTextSpanWithSpellCheckSuggestions ignores composing region when composing region out of range', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      const String text = 'Hello, wrold! Hey';
      const TextEditingValue value = TextEditingValue(text: text, composing: TextRange(start: 14, end: 17));
  ...
  testWidgets('buildTextSpanWithSpellCheckSuggestions, composing region and misspelled words overlap example', (
    WidgetTester tester,
  ) async {
    const String text = 'Right worng worng right';
    const TextEditingValue value = TextEditingValue(text: text, composing: TextRange(start: 12, end: 17));
    const bool composingRegionOutOfRange = false;
    const SpellCheckResults spellCheckResults = SpellCheckResults(text, <SuggestionSpan>[
  ...
  testWidgets('buildTextSpanWithSpellCheckSuggestions, consecutive misspelled words example', (
    WidgetTester tester,
  ) async {
    const String text = 'Right worng worng right';
    const TextEditingValue value = TextEditingValue(text: text);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      const TextSpan expectedTextSpanTree = TextSpan(children: <TextSpan>[TextSpan(text: 'Hello, wrold! Hey')]);
      final TextSpan textSpanTree = buildTextSpanWithSpellCheckSuggestions(
        value,
        composingRegionOutOfRange,
        null,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      const TextSpan expectedTextSpanTree = TextSpan(children: <TextSpan>[TextSpan(text: 'Hello, wroldd!')]);
      final TextSpan textSpanTree = buildTextSpanWithSpellCheckSuggestions(
        value,
        composingRegionOutOfRange,
        null,
