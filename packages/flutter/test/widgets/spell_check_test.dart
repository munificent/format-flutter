...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      const SpellCheckResults spellCheckResults = SpellCheckResults(
        text,
        <SuggestionSpan>[
          SuggestionSpan(TextRange(start: 7, end: 12), <String>[
            'world',
            'word',
            'old',
          ]),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      const SpellCheckResults spellCheckResults = SpellCheckResults(
        text,
        <SuggestionSpan>[
          SuggestionSpan(TextRange(start: 6, end: 11), <String>[
            'wrong',
            'worn',
            'wrung',
          ]),
          SuggestionSpan(TextRange(start: 12, end: 17), <String>[
            'wrong',
            'worn',
            'wrung',
          ]),
    ...
    (WidgetTester tester) async {
      ...
      const SpellCheckResults spellCheckResults = SpellCheckResults(
        ...
        <SuggestionSpan>[
          ...
          SuggestionSpan(TextRange(start: 17, end: 23), <String>[
            'friend',
            'fiend',
            'fern',
          ]),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      spellCheckResults = SpellCheckResults(resultsText, <SuggestionSpan>[
