...
void main() {
  ...
  group(FocusNode, () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          scope.traversalDescendants,
          equals(<FocusNode>[parent1, parent2]),
        );
  ...
  group(FocusScopeNode, () {
    ...
    testWidgets(
      'canRequestFocus affects children.',
      (WidgetTester tester) async {
        final BuildContext context = await setupWidget(tester);
        final FocusScopeNode scope = FocusScopeNode(debugLabel: 'Scope');
        final FocusAttachment scopeAttachment = scope.attach(context);
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(tester.binding.focusManager.primaryFocus, equals(child1));
        expect(scope.focusedChild, equals(child1));
        expect(tester.binding.focusManager.rootScope.traversalDescendants
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        child4.requestFocus();
        await tester.pump();
        expect(child4.ancestors, equals(<FocusNode>[
          parent2,
          scope2,
          tester.binding.focusManager.rootScope,
        ]));
        expect(tester.binding.focusManager.rootScope.descendants, equals(<
          FocusNode
        >[child1, child2, parent1, scope1, child3, child4, parent2, scope2]));
        ...
        expect(tester.binding.focusManager.rootScope.descendants, equals(<
          FocusNode
        >[child1, child3, child4, parent2, scope2, child2, parent1, scope1]));
      },
    );
    ...
    testWidgets('Key handling bubbles up and terminates when handled.', (
      ...
      final FocusAttachment scope1Attachment = scope1.attach(
        context,
        onKey: handleEvent,
      );
      final FocusScopeNode scope2 = FocusScopeNode(debugLabel: 'Scope 2');
      final FocusAttachment scope2Attachment = scope2.attach(
        context,
        onKey: handleEvent,
      );
      final FocusNode parent1 = FocusNode(
      ...
      final FocusAttachment parent2Attachment = parent2.attach(context);
      final FocusNode child1 = FocusNode(debugLabel: 'Child 1');
      final FocusAttachment child1Attachment = child1.attach(
        context,
        onKey: handleEvent,
      );
      final FocusNode child2 = FocusNode(debugLabel: 'Child 2');
      final FocusAttachment child2Attachment = child2.attach(
        context,
        onKey: handleEvent,
      );
      final FocusNode child3 = FocusNode(debugLabel: 'Child 3');
      final FocusAttachment child3Attachment = child3.attach(
        context,
        onKey: handleEvent,
      );
      final FocusNode child4 = FocusNode(debugLabel: 'Child 4');
      final FocusAttachment child4Attachment = child4.attach(
        context,
        onKey: handleEvent,
      );
      scope1Attachment.reparent(parent: tester.binding.focusManager.rootScope);
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        RendererBinding.instance
            .initMouseTracker(); // Clear out the mouse state.
  ...
  testWidgets('debugFocusChanges causes logging of focus changes', (
    ...
    expect(messagesStr, contains(RegExp(
