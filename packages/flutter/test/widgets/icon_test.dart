...
void main() {
  ...
  testWidgets('Icon sizing - sizeless theme, default size', (
    ...
    await tester.pumpWidget(
      const Directionality(
        textDirection: TextDirection.ltr,
        child:
            Center(child: IconTheme(data: IconThemeData(), child: Icon(null))),
      ),
    );
  ...
  testWidgets(
    'Icon with custom fontFamilyFallback',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const Directionality(
          textDirection: TextDirection.ltr,
  ...
  testWidgets("Changing semantic label from null doesn't rebuild tree ", (
    ...
    await tester.pumpWidget(
      const Directionality(
        textDirection: TextDirection.ltr,
        child:
            Center(child: Icon(Icons.time_to_leave, semanticLabel: 'a label')),
      ),
    );
