...
void main() {
  testWidgets(
    'SliverCrossAxisGroup is laid out properly',
    (WidgetTester tester) async {
      ...
      expect(
        (first.parentData! as SliverPhysicalParentData).paintOffset.dx,
        equals(0),
      );
      expect(
      ...
      final RenderSliverCrossAxisGroup renderGroup = tester
  ...
  testWidgets('SliverConstrainedCrossAxis is laid out properly', (
    ...
    final List<RenderSliverConstrainedCrossAxis> renderSliversConstrained =
        tester.renderObjectList<RenderSliverConstrainedCrossAxis>(
    ...
    expect(
      (firstConstrained.parentData! as SliverPhysicalParentData).paintOffset.dx,
      equals(0),
    );
    expect(
  ...
  testWidgets(
    'Mix of slivers is laid out properly',
    (WidgetTester tester) async {
      final List<int> items = List<int>.generate(20, (int i) => i);
      await tester.pumpWidget(_buildSliverCrossAxisGroup(
        slivers: <Widget>[
  ...
  testWidgets(
    'applyPaintTransform is implemented properly',
    (WidgetTester tester) async {
      await tester.pumpWidget(_buildSliverCrossAxisGroup(
        slivers: <Widget>[
      ...
      expect(
        second.localToGlobal(Offset.zero),
        const Offset(VIEWPORT_WIDTH / 2, 0),
      );
    },
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final RenderSliverCrossAxisGroup renderGroup = tester.renderObject(
        find.byType(SliverCrossAxisGroup),
      ) as RenderSliverCrossAxisGroup;
      expect(renderGroup.geometry!.scrollExtent, equals(600));
      controller.jumpTo(560);
      await tester.pumpAndSettle();
      final RenderSliverPersistentHeader renderHeader = tester.renderObject(
