  ...
  group('TwoDimensionalScrollView', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        horizontalController.jumpTo(
          horizontalController.position.maxScrollExtent + 100,
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          buildForPrimaryScrollController(mainAxis: Axis.horizontal),
        );
        await tester.pumpAndSettle();
        ...
        controller = ScrollController();
        await tester.pumpWidget(
          buildForPrimaryScrollController(explicitPrimary: true),
        );
        await tester.pumpAndSettle();
        ...
        controller = ScrollController();
        await tester.pumpWidget(
          buildForPrimaryScrollController(explicitPrimary: false),
        );
        await tester.pumpAndSettle();
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          scrollable.widget.horizontalDetails.direction,
          AxisDirection.right,
        );
        expect(
          scrollable.widget.diagonalDragBehavior,
        ...
        await tester.pumpWidget(MaterialApp(
          home: SimpleBuilderTableView(
            ...
            delegate:
                TwoDimensionalChildBuilderDelegate(builder: _testChildBuilder),
          ),
        ));
        await tester.pumpAndSettle();
