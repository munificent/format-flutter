  ...
  testWidgets('Semantics 7 - Merging', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Directionality(
      ...
      child: Stack(
        ...
        children: <Widget>[
          MergeSemantics(
            child: Semantics(checked: true, container: true, child: Semantics(container: true, label: label)),
          ),
          MergeSemantics(
            child: Stack(fit: StackFit.expand, children: <Widget>[Semantics(checked: true), Semantics(label: label)]),
          ),
        ],
      ),
    ));
