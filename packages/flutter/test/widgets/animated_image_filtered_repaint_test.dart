...
void main() {
  testWidgets('ImageFiltered avoids repainting child as it animates', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(ColoredBox(
      color: Colors.red,
      child: ImageFiltered(imageFilter: ImageFilter.blur(sigmaX: 5, sigmaY: 5), child: const TestWidget()),
    ));
    ...
    await tester.pumpWidget(ColoredBox(
      color: Colors.red,
      child: ImageFiltered(imageFilter: ImageFilter.blur(sigmaX: 6, sigmaY: 6), child: const TestWidget()),
    ));
