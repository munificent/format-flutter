...
void _tests() {
  ...
  testWidgets('Offscreen sliver are hidden in semantics tree', (WidgetTester tester) async {
    ...
    final ScrollController scrollController = ScrollController(initialScrollOffset: containerHeight * 1.5);
    final List<Widget> slivers = List<Widget>.generate(30, (int i) {
      return SliverToBoxAdapter(
        child: SizedBox(height: containerHeight, child: Text('Item $i', textDirection: TextDirection.ltr)),
      );
    });
    await tester.pumpWidget(Semantics(
      textDirection: TextDirection.ltr,
  ...
  testWidgets('SemanticsNodes of Slivers are in paint order', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Semantics(
      ...
      child: Localizations(
        ...
        child: Directionality(textDirection: TextDirection.ltr, child: CustomScrollView(slivers: slivers)),
      ),
    ));
    ...
    ), ignoreRect: true, ignoreTransform: true, ignoreId: true, childOrder: DebugSemanticsDumpOrder.inverseHitTest));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final List<Widget> forwardChildren = List<Widget>.generate(10, (int i) {
        return SizedBox(height: 200.0, child: Text('Forward Item $i', textDirection: TextDirection.ltr));
      });
      final List<Widget> backwardChildren = List<Widget>.generate(10, (int i) {
        return SizedBox(height: 200.0, child: Text('Backward Item $i', textDirection: TextDirection.ltr));
      });
      await tester.pumpWidget(Semantics(
        textDirection: TextDirection.ltr,
        child: Directionality(
                  ...
                  return Viewport(
                    ...
                    slivers: <Widget>[
                      ...
                      const SliverAppBar(
                        ...
                        flexibleSpace:
                            FlexibleSpaceBar(title: Text('Backward app bar', textDirection: TextDirection.ltr)),
                      ),
                      SliverAppBar(
                        pinned: true,
                        ...
                        expandedHeight: 100.0,
                        flexibleSpace:
                            const FlexibleSpaceBar(title: Text('Forward app bar', textDirection: TextDirection.ltr)),
                      ),
