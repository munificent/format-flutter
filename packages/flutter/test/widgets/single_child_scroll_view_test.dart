...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        SingleChildScrollView(child: Container(height: 2000.0)),
      );
  ...
  testWidgets(
    'SingleChildScrollView control test',
    (WidgetTester tester) async {
      await tester.pumpWidget(SingleChildScrollView(
  ...
  testWidgets(
    'Changing controllers changes scroll position',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final RenderObject scrollRenderObject = tester.renderObject(
        find.byKey(scrollView),
      );
      ...
      final RenderObject childRenderObject = tester.renderObject(
        find.byKey(childBox),
      );
      ...
      await tester.pumpWidget(Directionality(
        ...
        child: Center(
          child: SizedBox(
            ...
            child: SingleChildScrollView(
              controller:
                  controllerY = ScrollController(initialScrollOffset: 400.0),
              child: SingleChildScrollView(
                controller:
                    controllerX = ScrollController(initialScrollOffset: 400.0),
                scrollDirection: Axis.horizontal,
                child: Column(
