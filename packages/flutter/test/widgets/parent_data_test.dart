...
void main() {
  testWidgets('ParentDataWidget control test', (WidgetTester tester) async {
    ...
    checkTree(tester, <TestParentData>[kNonPositioned, TestParentData(top: 10.0, left: 10.0), kNonPositioned]);
    ...
    checkTree(tester, <TestParentData>[kNonPositioned, TestParentData(left: 11.0, right: 12.0), kNonPositioned]);
    ...
    checkTree(tester, <TestParentData>[kNonPositioned, TestParentData(right: 10.0), TestParentData(top: 8.0)]);

    await tester.pumpWidget(
      const Stack(
        textDirection: TextDirection.ltr,
        children: <Widget>[Positioned(right: 10.0, child: FlipWidget(left: kDecoratedBoxA, right: kDecoratedBoxB))],
      ),
    );
    ...
    await tester.pumpWidget(
      const Stack(
        textDirection: TextDirection.ltr,
        children: <Widget>[Positioned(top: 7.0, child: FlipWidget(left: kDecoratedBoxA, right: kDecoratedBoxB))],
      ),
    );
  ...
  testWidgets('ParentDataWidget conflicting data', (WidgetTester tester) async {
        ...
        child: Stack(
          ...
          children: <Widget>[
            Positioned(
              top: 5.0,
              bottom: 8.0,
              child: Positioned(top: 6.0, left: 7.0, child: DecoratedBox(decoration: kBoxDecorationB)),
            ),
          ],
        ),
      ),
    ...
    await tester.pumpWidget(
      const Directionality(
        ...
        child: DummyWidget(
          child: Row(
            children: <Widget>[Positioned(top: 6.0, left: 7.0, child: DecoratedBox(decoration: kBoxDecorationB))],
          ),
        ),
      ),
    );
  ...
  testWidgets('ParentDataWidget interacts with global keys', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Stack(
      textDirection: TextDirection.ltr,
      children: <Widget>[Positioned(top: 10.0, left: 10.0, child: DecoratedBox(key: key, decoration: kBoxDecorationA))],
    ));
    ...
    await tester.pumpWidget(Stack(
      ...
      children: <Widget>[
        Positioned(
          top: 10.0,
          left: 10.0,
          child: DecoratedBox(decoration: kBoxDecorationB, child: DecoratedBox(key: key, decoration: kBoxDecorationA)),
        ),
      ],
    ));
  ...
  testWidgets('Parent data invalid ancestor', (WidgetTester tester) async {
    await tester.pumpWidget(Directionality(
      ...
      child: Row(
        children: <Widget>[
          Stack(textDirection: TextDirection.ltr, children: <Widget>[Expanded(child: Container())]),
        ],
      ),
    ));
  ...
  testWidgets('ParentDataWidget can be used with different ancestor RenderObjectWidgets', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(OneAncestorWidget(child: TestParentDataWidget(string: 'Foo', child: Container())));
    parentData = tester.renderObject(find.byType(Container)).parentData! as DummyParentData;
    expect(parentData.string, 'Foo');

    await tester.pumpWidget(AnotherAncestorWidget(child: TestParentDataWidget(string: 'Bar', child: Container())));
    parentData = tester.renderObject(find.byType(Container)).parentData! as DummyParentData;
