...
void main() {
  ...
  testWidgets('Default text selection color', (WidgetTester tester) async {
    ...
    await _expectColors(tester, find.byType(Align), <Color>{const Color(0xFFFFFFFF), const Color(0xFF000000)});
...
Future<void> _expectColors(
  ...
  final ByteData bytes =
      (await binding.runAsync<ByteData?>(() => image.toByteData(format: ui.ImageByteFormat.rawStraightRgba)))!;
