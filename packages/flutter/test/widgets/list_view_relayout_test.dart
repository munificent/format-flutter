...
void main() {
    ...
    await tester.pumpWidget(Directionality(
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          ListView(
            shrinkWrap: true,
            children: const <Widget>[Text('4'), Text('5'), Text('6')],
          ),
        ],
      ),
    ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(Directionality(
        textDirection: TextDirection.ltr,
        child: ListView(
          children: const <Widget>[SizedBox(height: 100.0, child: Text('100'))],
        ),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final RenderSliverList list = tester.renderObject(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(Directionality(
        textDirection: TextDirection.ltr,
        child: ListView(
          children: const <Widget>[SizedBox(height: 300.0, child: Text('300'))],
        ),
      ));
  ...
  testWidgets(
    'Overflowing ListView should become scrollable',
    (WidgetTester tester) async {
