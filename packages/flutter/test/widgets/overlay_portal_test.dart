...
void main() {
  final OverlayPortalController controller1 = OverlayPortalController(
    debugLabel: 'controller1',
  );
  final OverlayPortalController controller2 = OverlayPortalController(
    debugLabel: 'controller2',
  );
  final OverlayPortalController controller3 = OverlayPortalController(
    debugLabel: 'controller3',
  );
  final OverlayPortalController controller4 = OverlayPortalController(
    debugLabel: 'controller4',
  );
                    ...
                    return Directionality(
                      ...
                      child: OverlayPortal(
                        ...
                        overlayChildBuilder: (BuildContext context) {
                          buildCount += 1;
                          directionSeenByOverlayChild = Directionality.maybeOf(
                            context,
                          );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(widget);
      expect(tester.takeException().toString(), stringContainsInOrder(<String>[
        'Failed to attach',
  ...
  group('GlobalKey Reparenting', () {
    ...
    testWidgets('Swap child and overlayChild', (WidgetTester tester) async {
      ...
      final Widget child1 = WidgetToRenderBoxAdapter(
        renderBox: overlayChildBox,
      );
    ...
    testWidgets('Nested overlay children: swap inner and outer', (
      ...
      final Widget child3 = WidgetToRenderBoxAdapter(
        renderBox: overlayChildBox,
      );
  ...
  group('Paint order', () {
    ...
    testWidgets('Paint order does not change after global key reparenting', (
      ...
      final RenderObject theater = tester.renderObject<RenderObject>(
        find.byType(Overlay),
      );
      ...
      expect(childrenVisited, containsAllInOrder(<RenderObject>[
        child1Box.parent!,
        child2Box.parent!,
      ]));
...
class OverlayStatefulEntry extends OverlayEntry {
  OverlayStatefulEntry({required StatefulWidgetBuilder builder})
    : super(
        builder: (BuildContext context) => StatefulBuilder(builder: builder),
      );
}
...
class _PaintOrder extends SingleChildRenderObjectWidget {
  ...
  void updateRenderObject(
    BuildContext context,
    _RenderPaintRecorder renderObject,
