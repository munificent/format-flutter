...
void main() {
  testWidgets('GlobalKey children of one node', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      const Stack(children: <Widget>[DummyWidget(key: GlobalObjectKey(0)), DummyWidget(key: GlobalObjectKey(0))]),
    );
...
class DummyWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return child ??
        LimitedBox(maxWidth: 0.0, maxHeight: 0.0, child: ConstrainedBox(constraints: const BoxConstraints.expand()));
  }
}
