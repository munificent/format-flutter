...
void main() {
  ...
  testWidgets('Icon opacity', (WidgetTester tester) async {
    await tester.pumpWidget(Center(child: IconTheme(data: const IconThemeData(opacity: 0.5), child: ImageIcon(image))));
  ...
  testWidgets('ImageIcon sizing - sized theme', (WidgetTester tester) async {
    await tester.pumpWidget(const Center(child: IconTheme(data: IconThemeData(size: 36.0), child: ImageIcon(null))));
  ...
  testWidgets('ImageIcon sizing - sized theme, explicit size', (WidgetTester tester) async {
    await tester.pumpWidget(
      const Center(child: IconTheme(data: IconThemeData(size: 36.0), child: ImageIcon(null, size: 48.0))),
    );
  ...
  testWidgets('ImageIcon sizing - sizeless theme, default size', (WidgetTester tester) async {
    await tester.pumpWidget(const Center(child: IconTheme(data: IconThemeData(), child: ImageIcon(null))));
  ...
  testWidgets('ImageIcon has semantics data', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      const Directionality(
        ...
        child: Center(child: IconTheme(data: IconThemeData(), child: ImageIcon(null, semanticLabel: 'test'))),
      ),
    );
