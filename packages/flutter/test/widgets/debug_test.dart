...
void main() {
  ...
  test('debugWidgetBuilderValue control test', () {
    ...
    try {
      ...
      expect(error.diagnostics[1].toStringDeep(), equalsIgnoringHashCodes(
  ...
  testWidgets('debugCheckHasWidgetsLocalizations throws', (WidgetTester tester) async {
    ...
    expect(() => debugCheckHasWidgetsLocalizations(noLocalizationsAvailable.currentContext!), throwsA(
      isAssertionError.having((AssertionError e) => e.message, 'message', contains('No WidgetsLocalizations found')),
    ));
        ...
        child: Material(
          child: Stack(
            children: <Widget>[
              ...
              ImageFiltered(imageFilter: ImageFilter.blur(sigmaX: 10.0, sigmaY: 10.0), child: const Placeholder()),
              BackdropFilter(filter: ImageFilter.blur(sigmaX: 10.0, sigmaY: 10.0), child: const Placeholder()),
              ShaderMask(
