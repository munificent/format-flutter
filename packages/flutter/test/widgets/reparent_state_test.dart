...
void main() {
  testWidgets('can reparent state', (WidgetTester tester) async {
    ...
    final StateMarkerState grandchildState = tester.state(
      find.byWidget(grandchild),
    );
    ...
    final StateMarkerState newGrandchildState = tester.state(
      find.byWidget(newGrandchild),
    );
  ...
  testWidgets(
    'Reparent to child during update children',
