...
void main() {
  testWidgets('can reparent state', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      Center(child: ColoredBox(color: Colors.green, child: StateMarker(key: left, child: Container()))),
    );
  ...
  testWidgets('can with scrollable list', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Directionality(
      ...
      child: ListView(
        itemExtent: 100.0,
        children: <Widget>[SizedBox(key: const Key('container'), height: 100.0, child: StateMarker(key: key))],
      ),
    ));
  ...
  testWidgets('Reparenting with multiple moves', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Row(
      ...
      children: <Widget>[
        StateMarker(
          key: key1,
          child:
              StateMarker(key: key2, child: StateMarker(key: key3, child: StateMarker(child: Container(width: 100.0)))),
        ),
      ],
    ));
    ...
    await tester.pumpWidget(Row(
      ...
      children: <Widget>[
        ...
        StateMarker(key: key1, child: StateMarker(key: key3, child: StateMarker(child: Container(width: 100.0)))),
      ],
    ));
  });
}
