...
void main() {
  ...
  testWidgets('ListView vertical', (WidgetTester tester) async {
    ...
    Widget builder() {
      return Directionality(
        textDirection: TextDirection.ltr,
        child: FlipWidget(
          left: ListView.builder(controller: ScrollController(initialScrollOffset: 300.0), itemBuilder: itemBuilder),
          right: const Text('Not Today'),
        ),
      );
    }
  ...
  testWidgets('ListView reinvoke builders', (WidgetTester tester) async {
    ...
    Widget builder() {
      return Directionality(textDirection: TextDirection.ltr, child: ListView.builder(itemBuilder: itemBuilder));
    }
  ...
  testWidgets('ListView padding', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Directionality(
      textDirection: TextDirection.ltr,
      child: ListView.builder(padding: const EdgeInsets.fromLTRB(7.0, 3.0, 5.0, 11.0), itemBuilder: itemBuilder),
    ));
  ...
  testWidgets('ListView underflow extents', (WidgetTester tester) async {
    await tester.pumpWidget(Directionality(
      ...
      child: ListView(
        ...
        children: <Widget>[Container(height: 100.0), Container(height: 100.0), Container(height: 100.0)],
      ),
    ));
    ...
    await tester.pumpWidget(Directionality(
      ...
      child: SizedBox(
        ...
        child: ListView.builder(
          ...
          itemCount: 10,
          itemBuilder:
              (_, int i) => Container(height: 200.0, width: 200.0, color: i.isEven ? Colors.black : Colors.red),
        ),
      ),
    ));
