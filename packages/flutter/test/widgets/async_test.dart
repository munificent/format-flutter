...
void main() {
  ...
  group('AsyncSnapshot', () {
    ...
    test('AsyncSnapshot basic constructors', () {
      expect(
        const AsyncSnapshot<int>.nothing().connectionState,
      ...
      expect(
        const AsyncSnapshot<int>.waiting().connectionState,
  ...
  group('FutureBuilder', () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        final SynchronousFuture<String> future = SynchronousFuture<String>(
          'flutter',
        );
        await tester.pumpWidget(FutureBuilder<String>(
          future: future,
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          FutureBuilder<String>(key: key, builder: snapshotText, future: null),
        );
        expect(find.text(
    ...
    testWidgets(
      'debugRethrowError rethrows caught error',
      (WidgetTester tester) async {
  ...
  group('StreamBuilder', () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        final GlobalKey key = GlobalKey();
        await tester.pumpWidget(
          StreamBuilder<String>(key: key, builder: snapshotText, stream: null),
        );
        expect(find.text(
          'AsyncSnapshot<String>(ConnectionState.none, null, null, null)',
        ), findsOneWidget);
  ...
  group('StreamBuilderBase', () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final StreamController<String> controller = StreamController<String>();
        await tester.pumpWidget(
          StringCollector(key: key, stream: controller.stream),
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final StreamController<String> controllerB = StreamController<String>();
        await tester.pumpWidget(
          StringCollector(key: key, stream: controllerA.stream),
        );
        await tester.pumpWidget(
          StringCollector(key: key, stream: controllerB.stream),
        );
        controllerA.add('A');
        controllerB.add('B');
        await eventFiring(tester);
    ...
    testWidgets(
      'tracks events and errors until completion',
      (WidgetTester tester) async {
        final GlobalKey key = GlobalKey();
        final StreamController<String> controller = StreamController<String>();
        await tester.pumpWidget(
