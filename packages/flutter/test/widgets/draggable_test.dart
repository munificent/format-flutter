...
void main() {
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          final Offset secondLocation =
              firstLocation + const Offset(300.0, 300.0);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(onDraggableCanceledCalled, isTrue);
      expect(
        onDraggableCanceledVelocity.pixelsPerSecond.dx.abs(),
        lessThan(0.0000001),
      );
      expect(
        (onDraggableCanceledVelocity.pixelsPerSecond.dy - 1000.0).abs(),
        lessThan(0.0000001),
      );
      expect(
        onDraggableCanceledOffset,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
            ...
            Stack(
              children: <Widget>[
                ...
                DragTarget<ExtendedDragTargetData>(
                  ...
                  onAcceptWithDetails:
                      acceptedExtendedDragTargetDataDetails.add,
                ),
              ],
            ),
          ],
      ...
      for (int i = 0; i < 2; i += 1) {
        final TestGesture gesture =
            await tester.startGesture(dragTargetLocation);
        await tester.pump();
        ...
        expect(
          acceptedDragTargetDataDetails.first.offset,
  ...
  testWidgets(
    'Tap above long-press draggable works',
    (WidgetTester tester) async {
      final List<String> events = <String>[];
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        tester.widget<Listener>(find.byType(Listener).first).behavior,
        hitTestBehavior,
      );
    },
  );
  ...
  testWidgets('configurable DragTarget hit test behavior', (
    ...
    expect(
      tester.widget<MetaData>(find.byType(MetaData)).behavior,
      hitTestBehavior,
    );
  });
  ...
  testWidgets('LongPressDraggable.dragAnchorStrategy', (
    ...
    expect(
      const LongPressDraggable<int>(feedback: widget2, child: widget1).feedback,
      widget2,
    );
    expect(
      LongPressDraggable<int>(
  ...
  testWidgets('Test allowedButtonsFilter', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      build((int buttons) => buttons == kSecondaryButton),
    );
    expect(find.text('Dragging'), findsNothing);
    final TestGesture gesture1 =
        await tester.startGesture(firstLocation, pointer: 8);
