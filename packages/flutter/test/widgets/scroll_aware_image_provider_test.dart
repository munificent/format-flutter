...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final DisposableBuildContext context = DisposableBuildContext(
        key.currentState!,
      );
      final TestImageProvider testImageProvider = TestImageProvider(
        testImage.clone(),
      );
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(Directionality(
        ...
        child: ListView(
          ...
          children: <Widget>[TestWidget(key)],
        ),
      ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final ControllablePhysics physics = findPhysics<ControllablePhysics>(
        tester,
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final TestImageProvider testImageProvider2 = TestImageProvider(
        testImage.clone(),
      );
      ...
      testImageProvider.complete();
      stream.setCompleter(testImageProvider.loadImage(
        testImageProvider,
        PaintingBinding.instance.instantiateImageCodecWithSize,
      ));
