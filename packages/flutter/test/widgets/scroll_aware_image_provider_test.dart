...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      scrollController.animateTo(100, duration: const Duration(seconds: 2), curve: Curves.fastLinearToSlowEaseIn);
      await tester.pump();
      ...
      expect(const ScrollPhysics().recommendDeferredLoading(
  ...
  testWidgets('ScrollAwareImageProvider delays if in scrollable that is scrolling fast', (WidgetTester tester) async {
    ...
    scrollController.animateTo(3000, duration: const Duration(seconds: 2), curve: Curves.fastLinearToSlowEaseIn);
    await tester.pump();
    final RecordingPhysics physics = findPhysics<RecordingPhysics>(tester);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(Directionality(
        textDirection: TextDirection.ltr,
        child:
            SingleChildScrollView(physics: ControllablePhysics(), controller: scrollController, child: TestWidget(key)),
      ));
      ...
      imageCache.putIfAbsent(
        testImageProvider,
        () => testImageProvider.loadImage(testImageProvider, PaintingBinding.instance.instantiateImageCodecWithSize),
      );
