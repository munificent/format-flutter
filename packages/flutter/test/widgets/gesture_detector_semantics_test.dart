  ...
  group("RawGestureDetector's custom semantics delegate", () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(Center(child: RawGestureDetector(gestures: gestures, child: Container())));

        expect(semantics, includesNodeWith(actions: <SemanticsAction>[SemanticsAction.longPress, SemanticsAction.tap]));
  ...
  group("RawGestureDetector's default semantics delegate", () {
    group('should map onTap to', () {
      testWidgets('null when there is no TapGR', (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          Center(child: RawGestureDetector(gestures: _buildGestureMap(null, null), child: Container())),
        );
      ...
      testWidgets('non-null when there is TapGR with no callbacks', (WidgetTester tester) async {
        final SemanticsTester semantics = SemanticsTester(tester);
        await tester.pumpWidget(Center(
          child: RawGestureDetector(gestures: _buildGestureMap(() => TapGestureRecognizer(), null), child: Container()),
        ));
    ...
    group('should map onLongPress to', () {
      testWidgets('null when there is no LongPressGR ', (WidgetTester tester) async {
        ...
        expect(semantics, isNot(includesNodeWith(actions: <SemanticsAction>[SemanticsAction.longPress])));
      ...
      testWidgets('a callback that correctly calls callbacks', (WidgetTester tester) async {
        ...
        await tester.pumpWidget(Center(
          child: RawGestureDetector(
            key: detectorKey,
            gestures: _buildGestureMap(() => LongPressGestureRecognizer(), (LongPressGestureRecognizer longPress) {
              longPress
                ..onLongPress = () {
                  logs.add('LP');
                }
    ...
    group('should map onHorizontalDragUpdate to', () {
      testWidgets('null when there is no matching recognizers ', (WidgetTester tester) async {
        ...
        expect(
          semantics,
          isNot(includesNodeWith(actions: <SemanticsAction>[SemanticsAction.scrollLeft, SemanticsAction.scrollRight])),
        );
      ...
      testWidgets('non-null when there is either matching recognizer with no callbacks', (WidgetTester tester) async {
        ...
        await tester.pumpWidget(Center(
          child: RawGestureDetector(gestures: _buildGestureMap(() => PanGestureRecognizer(), null), child: Container()),
        ));
      ...
      testWidgets('a callback that correctly calls callbacks', (WidgetTester tester) async {
        ...
        final Map<Type, GestureRecognizerFactory> gestures =
            _buildGestureMap(() => HorizontalDragGestureRecognizer(), (HorizontalDragGestureRecognizer horizontal) {
              horizontal
                ..onStart = (_) {
                  logs.add('HStart');
                }
            ...
            })..addAll(_buildGestureMap(() => PanGestureRecognizer(), (PanGestureRecognizer pan) {
              pan
                ..onStart = (_) {
                  logs.add('PStart');
                }
        ...
        await tester.pumpWidget(
          Center(child: RawGestureDetector(key: detectorKey, gestures: gestures, child: Container())),
        );

        final int detectorId = detectorKey.currentContext!.findRenderObject()!.debugSemantics!.id;
        tester.binding.pipelineOwner.semanticsOwner!.performAction(detectorId, SemanticsAction.scrollLeft);
        expect(logs, <String>['HDown', 'HStart', 'HUpdate', 'HEnd', 'PDown', 'PStart', 'PUpdate', 'PEnd']);
        logs.clear();
    ...
    group('should map onVerticalDragUpdate to', () {
      testWidgets('null when there is no matching recognizers ', (WidgetTester tester) async {
        ...
        expect(
          semantics,
          isNot(includesNodeWith(actions: <SemanticsAction>[SemanticsAction.scrollUp, SemanticsAction.scrollDown])),
        );
      ...
      testWidgets('a callback that correctly calls callbacks', (WidgetTester tester) async {
        ...
        final List<String> logs = <String>[];
        final Map<Type, GestureRecognizerFactory> gestures =
            _buildGestureMap(() => VerticalDragGestureRecognizer(), (VerticalDragGestureRecognizer horizontal) {
              horizontal
                ..onStart = (_) {
                  logs.add('VStart');
                }
        ...
        final int detectorId = detectorKey.currentContext!.findRenderObject()!.debugSemantics!.id;
        tester.binding.pipelineOwner.semanticsOwner!.performAction(detectorId, SemanticsAction.scrollUp);
        expect(logs, <String>['VDown', 'VStart', 'VUpdate', 'VEnd', 'PDown', 'PStart', 'PUpdate', 'PEnd']);
        logs.clear();
