...
void main() {
  testWidgets(
    'Vertical gesture detector has up/down actions',
  ...
  testWidgets(
    'Horizontal gesture detector has up/down actions',
    (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
  ...
  group("RawGestureDetector's default semantics delegate", () {
    ...
    group('should map onLongPress to', () {
      testWidgets(
        'null when there is no LongPressGR ',
        (WidgetTester tester) async {
          final SemanticsTester semantics = SemanticsTester(tester);
          await tester.pumpWidget(Center(
            child: RawGestureDetector(
    ...
    group('should map onHorizontalDragUpdate to', () {
      testWidgets(
        'null when there is no matching recognizers ',
        (WidgetTester tester) async {
          final SemanticsTester semantics = SemanticsTester(tester);
          await tester.pumpWidget(Center(
            child: RawGestureDetector(
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          await tester.pumpWidget(Center(
            child: RawGestureDetector(
              gestures:
                  _buildGestureMap(() => VerticalDragGestureRecognizer(), null),
              child: Container(),
            ),
          ));
