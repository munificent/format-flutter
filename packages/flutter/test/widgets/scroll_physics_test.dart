...
void main() {
  ...
  test(
    ...
    () {
      ...
      expect(
        bounce.createBallisticSimulation(position, 1000)!.dx(0),
        moreOrLessEquals(1000),
      );
      expect(
        clamp.createBallisticSimulation(position, 1000)!.dx(0),
        moreOrLessEquals(1000),
      );
      expect(
        page.createBallisticSimulation(position, 1000)!.dx(0),
        moreOrLessEquals(1000),
      );
    },
  );
  ...
  group('BouncingScrollPhysics test', () {
    ...
    test('no easing resistance for ScrollDecelerationRate.fast', () {
      ...
      final double easingApplied = desktop.applyPhysicsToUserOffset(
        overscrolledPosition,
        -10.0,
      );
      final double tensioningApplied = desktop.applyPhysicsToUserOffset(
        overscrolledPosition,
        10.0,
      );
