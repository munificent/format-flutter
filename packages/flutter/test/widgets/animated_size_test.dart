...
void main() {
  group('AnimatedSize', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        void verify({double? size, RenderAnimatedSizeState? state}) {
          ...
          final RenderAnimatedSize box = tester.renderObject(
    ...
    testWidgets('can set and update clipBehavior', (WidgetTester tester) async {
      ...
      final RenderAnimatedSize renderObject = tester.renderObject(
        find.byType(AnimatedSize),
      );
    ...
    testWidgets('works wrapped in IntrinsicHeight and Wrap', (
      WidgetTester tester,
    ) async {
