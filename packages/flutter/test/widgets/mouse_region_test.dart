...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        Center(child: MouseRegion(onEnter: (_) => onEnter = true)),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      PointerExitEvent? exit;
      await tester.pumpWidget(
        const Center(child: SizedBox(width: 100.0, height: 100.0)),
      );
      final TestGesture gesture =
          await tester.createGesture(kind: PointerDeviceKind.mouse);
      await gesture.addPointer(location: Offset.zero);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      RenderMouseRegion listener = tester.renderObject(
  ...
  testWidgets('works with transform', (WidgetTester tester) async {
    ...
    expect(
      events.single.delta,
      const Offset(0.0, scaleFactor * localHeight - 2),
    );
    events.clear();
  ...
  testWidgets('needsCompositing is always false', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      Transform.scale(scale: 2.0, child: const MouseRegion(opaque: false)),
    );
    final RenderMouseRegion mouseRegion = tester.renderObject(
  ...
  testWidgets(
    'detects pointer enter with closure arguments',
    (WidgetTester tester) async {
      ...
      await gesture.moveTo(
        tester.getBottomRight(find.byType(MouseRegion)) + const Offset(10, -10),
      );
      await tester.pumpAndSettle();
      expect(find.text('not hovering'), findsOneWidget);
  ...
  group('MouseRegion respects opacity:', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        final List<String> logs = <String>[];
        await tester.pumpWidget(
          tripleRegions(opaqueC: false, addLog: (String log) => logs.add(log)),
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        final List<String> logs = <String>[];
        await tester.pumpWidget(
          tripleRegions(opaqueC: true, addLog: (String log) => logs.add(log)),
        );
    ...
    testWidgets('opaque should default to true', (WidgetTester tester) async {
      final List<String> logs = <String>[];
      await tester.pumpWidget(
        tripleRegions(addLog: (String log) => logs.add(log)),
      );
  ...
  testWidgets('Changing MouseRegion.cursor is effective and repaints', (
    WidgetTester tester,
  ) async {
        ...
        topLeft: SizedBox(
          ...
          child: MouseRegion(
            ...
            child: MouseRegion(
              ...
              child: CustomPaint(
                painter: _DelegatedPainter(onPaint: onPaintChild),
              ),
            ),
          ),
        ),
  ...
  testWidgets(
    'Does not trigger side effects during a reparent',
    (WidgetTester tester) async {
      final List<String> logEnters = <String>[];
  ...
  testWidgets("RenderMouseRegion's debugFillProperties when default", (
    WidgetTester tester,
  ) async {
  ...
  testWidgets("RenderMouseRegion's debugFillProperties when full", (
    WidgetTester tester,
  ) async {
    final DiagnosticPropertiesBuilder builder = DiagnosticPropertiesBuilder();
    RenderMouseRegion(
      ...
      await tester.pumpWidget(MaterialApp(
        home: Center(
          child: Draggable<int>(
            ...
            child:
                ElevatedButton(child: const Text('Drag me'), onPressed: () {}),
          ),
        ),
      ));
