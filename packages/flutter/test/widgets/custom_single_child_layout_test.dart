...
void main() {
  testWidgets(
    'Control test for CustomSingleChildLayout',
  ...
  testWidgets(
    'Test SingleChildDelegate shouldRelayout method',
    (WidgetTester tester) async {
      ...
      expect(
        delegate.constraintsFromGetConstraintsForChild,
        isNotNull,
      ); // i.e. layout happened
  ...
  testWidgets('Can use listener for relayout', (WidgetTester tester) async {
    final ValueNotifier<Size> size = ValueNotifier<Size>(
