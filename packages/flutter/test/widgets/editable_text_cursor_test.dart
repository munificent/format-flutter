...
void main() {
  ...
  testWidgets(
    'cursor has expected width, height, and radius',
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      Future<void> verifyKeyFrame({
        ...
        await tester.pump(
          Duration(microseconds: at - delta - walltimeMicrosecond),
        );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(home: Material(child: TextField(maxLines: 3))),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      final Color defaultCursorColor = Color(
        ThemeData.fallback().colorScheme.primary.value,
      );
  ...
  testWidgets(
    'Cursor does not show when not focused',
    (WidgetTester tester) async {
  ...
  testWidgets("Drag the floating cursor, it won't blink.", (
    WidgetTester tester,
  ) async {
    const String text = 'hello world this is fun and cool and awesome!';
    controller.text = text;
  ...
  testWidgets('Turning showCursor off stops the cursor', (
    WidgetTester tester,
  ) async {
    ...
    late final EditableTextState editableTextState = tester.state(
      find.byKey(key),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      editable.selection = const TextSelection(
        baseOffset: 29,
        extentOffset: 29,
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      final bool debugDeterministicCursor =
  ...
  testWidgets(
    'getLocalRectForCaret with empty text',
    (WidgetTester tester) async {
      EditableText.debugDeterministicCursor = true;
      addTearDown(() {
        EditableText.debugDeterministicCursor = false;
