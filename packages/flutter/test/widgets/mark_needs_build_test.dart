...
void main() {
  testWidgets(
    ...
    (WidgetTester tester) async {
      // Initial build.
      await tester.pumpWidget(const Directionality(textDirection: TextDirection.ltr, child: TestWidget(value: 1)));
      ...
      // Change dependency.
      await tester.pumpWidget(Directionality(textDirection: TextDirection.rtl, // Changed. child: child));
...
class _TestWidgetState extends State<TestWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox.expand(child: Text(Directionality.of(context).toString()));
  }
}
