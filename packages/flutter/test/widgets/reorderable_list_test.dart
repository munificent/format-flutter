...
void main() {
  ...
  testWidgets(
    'zero itemCount should not build widget',
    (WidgetTester tester) async {
      final List<int> items = <int>[1, 2, 3];
      await tester.pumpWidget(MaterialApp(
        home: StatefulBuilder(
            ...
            return CustomScrollView(
              slivers: <Widget>[
                SliverFixedExtentList(
                  itemExtent: 50.0,
                  delegate:
                      SliverChildListDelegate(<Widget>[const Text('before')]),
                ),
                SliverReorderableList(
                  itemCount: 0,
                  onReorder: (int fromIndex, int toIndex) {
                ...
                SliverFixedExtentList(
                  itemExtent: 50.0,
                  delegate:
                      SliverChildListDelegate(<Widget>[const Text('after')]),
                ),
              ],
            );
          },
  ...
  testWidgets('SliverReorderableList - custom proxyDecorator', (
    ...
    const ValueKey<String> fadeTransitionKey = ValueKey<String>(
      'reordered-fade',
    );
      ...
      proxyDecorator: (Widget child, int index, Animation<double> animation) {
        return AnimatedBuilder(
          ...
          builder: (BuildContext context, Widget? child) {
            final Tween<double> fadeValues = Tween<double>(
              begin: 1.0,
              end: 0.5,
            );
