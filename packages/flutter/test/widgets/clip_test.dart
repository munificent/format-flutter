...
void main() {
  testWidgets('ClipRect with a FittedBox child sized to zero works with semantics', (WidgetTester tester) async {
    await tester.pumpWidget(Directionality(
      ...
      child: ClipRect(
        child: FittedBox(child: SizedBox.fromSize(size: Size.zero, child: Semantics(image: true, label: 'Image'))),
      ),
    ));
  ...
  testWidgets('ClipOval', (WidgetTester tester) async {
    await tester.pumpWidget(ClipOval(
      child: GestureDetector(
        behavior: HitTestBehavior.opaque,
        onTap: () {
          log.add('tap');
  ...
  testWidgets('Transparent ClipOval hit test', (WidgetTester tester) async {
    await tester.pumpWidget(Opacity(
      opacity: 0.0,
      child: ClipOval(
        child: GestureDetector(
          behavior: HitTestBehavior.opaque,
  ...
  testWidgets('ClipRect save, overlay, and antialiasing', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(RepaintBoundary).first, matchesGoldenFile('clip.ClipRectOverlay.png'));
  });
  ...
  testWidgets('PhysicalModel painting with Clip.antiAlias', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(RepaintBoundary).first, matchesGoldenFile('clip.PhysicalModel.antiAlias.png'));
  });
  ...
  testWidgets('PhysicalModel painting with Clip.hardEdge', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(RepaintBoundary).first, matchesGoldenFile('clip.PhysicalModel.hardEdge.png'));
  });
  ...
  testWidgets('Default PhysicalModel painting', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(RepaintBoundary).first, matchesGoldenFile('clip.PhysicalModel.default.png'));
  });
  ...
  testWidgets('PhysicalShape painting with Clip.antiAlias', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(RepaintBoundary).first, matchesGoldenFile('clip.PhysicalShape.antiAlias.png'));
  });
  ...
  testWidgets('PhysicalShape painting with Clip.hardEdge', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(RepaintBoundary).first, matchesGoldenFile('clip.PhysicalShape.hardEdge.png'));
  });
  ...
  testWidgets('PhysicalShape painting', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(RepaintBoundary).first, matchesGoldenFile('clip.PhysicalShape.default.png'));
  });
  ...
  testWidgets('ClipPath.shape', (WidgetTester tester) async {
    ...
    logs.add('--4');
    await tester.pumpWidget(Directionality(textDirection: TextDirection.rtl, child: buildClipPath()));
    logs.add('--5');
  ...
  testWidgets('CustomClipper reclips when notified', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(ClipRect(clipper: NotifyClipper<Rect>(clip: clip), child: const Placeholder()));
  ...
  testWidgets('ClipRRect supports BorderRadiusDirectional', (WidgetTester tester) async {
    ...
    Widget buildClipRRect(TextDirection textDirection) {
      return Directionality(
        ...
        child: const ClipRRect(borderRadius: BorderRadiusDirectional.horizontal(start: startRadius, end: endRadius)),
      );
    }
        ...
        builder: (BuildContext context, StateSetter setState) {
          return Directionality(
            ...
            child: SizedBox(
              ...
              height: 100.0,
              child: ClipRRect(
                borderRadius: const BorderRadiusDirectional.horizontal(start: startRadius, end: endRadius),
                child: GestureDetector(
                  onTap: () {
                    setState(() {
