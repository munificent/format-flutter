...
void main() {
      ...
      child: SizedBox(
        ...
        child: ClipRect(
          clipper: ValueClipper<Rect>(
            'a',
            const Rect.fromLTWH(5.0, 5.0, 10.0, 10.0),
          ),
          child: GestureDetector(
            behavior: HitTestBehavior.opaque,
            onTap: () {
    ...
    await tester.pumpWidget(Align(
      ...
      child: SizedBox(
        ...
        child: ClipRect(
          clipper: ValueClipper<Rect>(
            'c',
            const Rect.fromLTWH(25.0, 25.0, 10.0, 10.0),
          ),
          child: GestureDetector(
            behavior: HitTestBehavior.opaque,
            onTap: () {
  ...
  testWidgets(
    'PhysicalModel painting with Clip.antiAlias',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'PhysicalShape painting with Clip.antiAlias',
    (WidgetTester tester) async {
  ...
  testWidgets('ClipPath.shape', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      Directionality(textDirection: TextDirection.ltr, child: clipPath),
    );
    // verify that changing the text direction from LTR to RTL has an effect
    // even though the widget itself is identical
    logs.add('--3');
    await tester.pumpWidget(
      Directionality(textDirection: TextDirection.rtl, child: clipPath),
    );
  ...
  testWidgets('CustomClipper reclips when notified', (
    ...
    await tester.pumpWidget(ClipRect(
