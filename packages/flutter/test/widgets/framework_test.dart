...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
        ...
        builder: (BuildContext context, BoxConstraints constraints) {
          return Column(
            children: <Widget>[
              const _Stateful(
                child:
                    Text('Text1', textDirection: TextDirection.ltr, key: key1),
              ),
              _Stateful(
                child: const Text(
                  'Text2',
      ...
      final _StatefulState state = tester.firstState(
        find.byType(_Stateful).at(1),
      );
      state.rebuild();
      // Reorders the items
      await tester.pumpWidget(LayoutBuilder(
        ...
        builder: (BuildContext context, BoxConstraints constraints) {
          return Column(
            children: <Widget>[
              ...
              const _Stateful(
                child:
                    Text('Text3', textDirection: TextDirection.ltr, key: key3),
              ),
            ],
          );
        },
      ...
      await tester.pumpWidget(LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          return Column(
            children: <Widget>[
              const _Stateful(
                child: Text('Text1', textDirection: TextDirection.ltr),
              ),
              _Stateful(
                child: const Text(
                  'Text2',
              ...
              const _Stateful(
                child: Text('Text3', textDirection: TextDirection.ltr),
              ),
            ],
          );
        },
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(exception.toString(), equalsIgnoringHashCodes(
  ...
  testWidgets(
    'GlobalKey duplication 7 - appearing later',
    (WidgetTester tester) async {
      final Key key = GlobalKey(debugLabel: 'problematic');
      await tester.pumpWidget(Stack(
        textDirection: TextDirection.ltr,
  ...
  testWidgets(
    'GlobalKey duplication 8 - appearing earlier',
    (WidgetTester tester) async {
      final Key key = GlobalKey(debugLabel: 'problematic');
      await tester.pumpWidget(Stack(
        textDirection: TextDirection.ltr,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Key key2 = GlobalKey(
        debugLabel: 'problematic',
      ); // intentionally the same label
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        Column(children: <Widget>[Container(), const _EmptyWidget()]),
      );

      final dynamic exception = tester.takeException();
      expect(exception, isFlutterError);
      expect(exception.toString(), startsWith(
  ...
  testWidgets('Element diagnostics', (WidgetTester tester) async {
    ...
    expect(element.toStringDeep(), equalsIgnoringHashCodes(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        Inherited(1, child: DependentStatefulWidget(key: key)),
      );
      ...
      await tester.pumpWidget(
        Inherited(2, child: DependentStatefulWidget(key: key)),
      );
      expect(key.currentState, isNotNull);
  ...
  group('BuildContext.debugDoingbuild', () {
    testWidgets('StatelessWidget', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(StatelessWidgetSpy(
    ...
    testWidgets('StatefulWidget', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(Inherited(
        0,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      final GlobalKey key = GlobalKey();
      await tester.pumpWidget(
        _WidgetWithNoVisitChildren(_StatefulLeaf(key: key)),
      );
  ...
  testWidgets(
    'debugFillProperties sorts dependencies in alphabetical order',
    (WidgetTester tester) async {
      final DiagnosticPropertiesBuilder builder = DiagnosticPropertiesBuilder();
      ...
      final _TestInheritedElement buttonBarTheme = _TestInheritedElement(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final StatefulElement element = tester.element<StatefulElement>(
        find.byType(_StatefulLeaf),
      );
  ...
  testWidgets('Getting the render object of an unmounted element throws', (
    ...
    expect(() => element.findRenderObject(), throwsA(isA<FlutterError>().having(
...
The findRenderObject() method was called for the following element:
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      final StatefulElement statefulElement = StatefulElement(
        const _StatefulLeaf(),
      );
      expect(statefulElement.hashCode, identityHashCode(statefulElement));

      final StatelessElement statelessElement = StatelessElement(
        const Placeholder(),
      );
...
class _WidgetWithNoVisitChildren extends StatelessWidget {
  ...
  @override
  _WidgetWithNoVisitChildrenElement
  createElement() => _WidgetWithNoVisitChildrenElement(this);
}
...
class _TestLeaderLayerWidget extends SingleChildRenderObjectWidget {
  ...
  void updateRenderObject(
    ...
    _RenderTestLeaderLayerWidget renderObject,
  ) {
...
class _RenderTestLeaderLayerWidget extends RenderProxyBox {
  _RenderTestLeaderLayerWidget({LayerLink? link, RenderBox? child})
    : _link = link,
      super(child);
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    if (_link != null) {
      context.pushLayer(
        LeaderLayer(link: _link!, offset: offset),
        (_, __) {},
        Offset.zero,
      );
    }
