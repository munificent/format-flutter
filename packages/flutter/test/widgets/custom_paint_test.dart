...
void main() {
  ...
  testWidgets('CustomPaint sizing', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      Center(child: CustomPaint(key: target, child: Container())),
    );
    expect(target.currentContext!.size, const Size(800.0, 600.0));

    await tester.pumpWidget(
      Center(child: CustomPaint(key: target, size: const Size(20.0, 20.0))),
    );
  ...
  test(
    ...
    () {
      final RenderCustomPaint inner = RenderCustomPaint(
