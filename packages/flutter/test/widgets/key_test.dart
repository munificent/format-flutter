...
void main() {
  testWidgets('Keys', (WidgetTester tester) async {
    ...
    expect(
      const ValueKey<double>(double.nan) == const ValueKey<double>(double.nan),
      isFalse,
    );

    expect(Key(nonconst('')) == ValueKey<String>(nonconst('')), isTrue);
    expect(
      ValueKey<String>(nonconst('')) == ValueKey<String>(nonconst('')),
      isTrue,
    );
    expect(
      TestValueKey<String>(nonconst('')) == ValueKey<String>(nonconst('')),
      isFalse,
    );
    expect(
      TestValueKey<String>(nonconst('')) == TestValueKey<String>(nonconst('')),
      isTrue,
    );

    expect(
      ValueKey<String>(nonconst('')) == ValueKey<dynamic>(nonconst('')),
      isFalse,
    );
    expect(
      TestValueKey<String>(nonconst('')) == TestValueKey<dynamic>(nonconst('')),
      isFalse,
    );
    ...
    expect(
      ObjectKey(nonconst(Object())) == ObjectKey(nonconst(Object())),
      isFalse,
    );
