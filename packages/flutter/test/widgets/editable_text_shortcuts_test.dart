    ...
    return trueFalse.expand((bool control) {
      return trueFalse.expand((bool alt) {
        return trueFalse.map(
          (bool meta) => SingleActivator(trigger, shift: shift, control: control, alt: alt, meta: meta),
        );
      });
    });
  });
...
void main() {
    ...
    () {
      ...
      group('backspace', () {
        ...
        testWidgets('backspace', (WidgetTester tester) async {
          ...
          // character).
          controller.selection = const TextSelection.collapsed(offset: 20, affinity: TextAffinity.upstream);
        ...
        testWidgets('backspace readonly', (WidgetTester tester) async {
          ...
          expect(controller.selection, const TextSelection.collapsed(offset: 20, affinity: TextAffinity.upstream));
        ...
        testWidgets('backspace at end', (WidgetTester tester) async {
          controller.text = testText;
          controller.selection = const TextSelection.collapsed(offset: 72, affinity: TextAffinity.upstream);
        ...
        testWidgets('backspace inside of a cluster', (WidgetTester tester) async {
          ...
          controller.selection = const TextSelection.collapsed(offset: 1, affinity: TextAffinity.upstream);
        ...
        testWidgets('backspace at cluster boundary', (WidgetTester tester) async {
          controller.text = testCluster;
          controller.selection = const TextSelection.collapsed(offset: 8, affinity: TextAffinity.upstream);
      ...
      group('delete: ', () {
        ...
        testWidgets('delete at end', (WidgetTester tester) async {
          ...
          expect(controller.selection, const TextSelection.collapsed(offset: 72, affinity: TextAffinity.upstream));
        }, variant: TargetPlatformVariant.all());
      ...
      group('word modifier + backspace', () {
        ...
        testWidgets('WordModifier-backspace', (WidgetTester tester) async {
          ...
          controller.selection = const TextSelection.collapsed(offset: 29, affinity: TextAffinity.upstream);
        ...
        testWidgets('readonly', (WidgetTester tester) async {
          ...
          expect(controller.selection, const TextSelection.collapsed(offset: 29, affinity: TextAffinity.upstream));
        }, variant: TargetPlatformVariant.all());
      ...
      group('word modifier + delete', () {
        ...
        testWidgets('WordModifier-delete', (WidgetTester tester) async {
          ...
          controller.selection = const TextSelection.collapsed(offset: 23, affinity: TextAffinity.upstream);
        ...
        testWidgets('readonly', (WidgetTester tester) async {
          ...
          expect(controller.selection, const TextSelection.collapsed(offset: 23, affinity: TextAffinity.upstream));
        }, variant: TargetPlatformVariant.all());
      ...
      group('line modifier + backspace', () {
        ...
        testWidgets('softwrap line boundary, upstream', (WidgetTester tester) async {
          ...
          controller.selection = const TextSelection.collapsed(offset: 40, affinity: TextAffinity.upstream);
      ...
      group('line modifier + delete', () {
        ...
        testWidgets('softwrap line boundary, upstream', (WidgetTester tester) async {
          ...
          expect(controller.selection, const TextSelection.collapsed(offset: 40, affinity: TextAffinity.upstream));
        }, variant: TargetPlatformVariant.all());
      ...
      group('Arrow Movement', () {
        group('left', () {
          ...
          testWidgets('at start', (WidgetTester tester) async {
            ...
            for (final SingleActivator activator in allModifierVariants(trigger)) {
              ...
              expect(controller.selection, const TextSelection.collapsed(offset: 0), reason: activator.toString());
            }
          }, variant: TargetPlatformVariant.all());
        ...
        group('With initial non-collapsed selection', () {
          ...
          testWidgets('line modifier + arrow key movement', (WidgetTester tester) async {
            ...
            expect(
              controller.selection,
              const TextSelection.collapsed(offset: 54, // After "aid". affinity: TextAffinity.upstream),
            );
            ...
            expect(
              controller.selection,
              const TextSelection.collapsed(offset: 35, // After "people". affinity: TextAffinity.upstream),
            );
          }, variant: allExceptApple);
        });
        ...
        group('vertical movement', () {
          ...
          testWidgets('run', (WidgetTester tester) async {
            ...
            await sendKeyCombination(tester, const SingleActivator(LogicalKeyboardKey.arrowUp));
            await tester.pump();
            expect(controller.selection, const TextSelection.collapsed(offset: 2, affinity: TextAffinity.upstream));
          ...
          testWidgets('long run with fractional text height', (WidgetTester tester) async {
            ...
            for (int i = 1; i <= 49; i++) {
              await sendKeyCombination(tester, const SingleActivator(LogicalKeyboardKey.arrowDown));
              await tester.pump();
              expect(controller.selection, TextSelection.collapsed(offset: 2 + i * 7), reason: 'line $i');
            }

            for (int i = 49; i >= 1; i--) {
              await sendKeyCombination(tester, const SingleActivator(LogicalKeyboardKey.arrowUp));
              await tester.pump();
              expect(controller.selection, TextSelection.collapsed(offset: 2 + (i - 1) * 7), reason: 'line $i');
            }
          }, variant: TargetPlatformVariant.all());
        });
      });
  ...
  group('macOS shortcuts', () {
    ...
    testWidgets('line modifier + arrowRight', (WidgetTester tester) async {
      ...
      expect(
        controller.selection,
        const TextSelection.collapsed(offset: 35, // Before the newline character. affinity: TextAffinity.upstream),
      );
    }, variant: macOSOnly);
  ...
  group('Web does accept', () {
    ...
    testWidgets('select left', (WidgetTester tester) async {
      ...
      expect(controller.selection, const TextSelection(baseOffset: 5, extentOffset: 4), reason: selectLeft.toString());
    }, variant: TargetPlatformVariant.desktop());

    testWidgets('select right', (WidgetTester tester) async {
      const SingleActivator selectRight = SingleActivator(LogicalKeyboardKey.arrowRight, shift: true);
      controller.text = 'testing';
      controller.selection = const TextSelection.collapsed(offset: 5);
      ...
      expect(controller.text, 'testing');
      expect(controller.selection, const TextSelection(baseOffset: 5, extentOffset: 6), reason: selectRight.toString());
    }, variant: TargetPlatformVariant.desktop());

    testWidgets('select left should not expand selection if selection is disabled', (WidgetTester tester) async {
      const SingleActivator selectLeft = SingleActivator(LogicalKeyboardKey.arrowLeft, shift: true);
      controller.text = 'testing';
      controller.selection = const TextSelection.collapsed(offset: 5);
    ...
    testWidgets('select right should not expand selection if selection is disabled', (WidgetTester tester) async {
      const SingleActivator selectRight = SingleActivator(LogicalKeyboardKey.arrowRight, shift: true);
      controller.text = 'testing';
      controller.selection = const TextSelection.collapsed(offset: 5);
