...
void main() {
  ...
  group(
    ...
    () {
      ...
      group('line modifier + backspace', () {
        ...
        testWidgets(
          'softwrap line boundary, upstream',
          (WidgetTester tester) async {
        ...
        testWidgets(
          'softwrap line boundary, downstream',
          (WidgetTester tester) async {
            controller.text = testSoftwrapText;
      ...
      group('Arrow Movement', () {
        group('left', () {
          ...
          testWidgets(
            ...
            (WidgetTester tester) async {
              ...
              await sendKeyCombination(
                tester,
                const SingleActivator(trigger, control: true),
              );
              await tester.pump();
          ...
          testWidgets(
            ...
            (WidgetTester tester) async {
              ...
              await sendKeyCombination(
                tester,
                const SingleActivator(trigger, alt: true),
              );
              await tester.pump();
        ...
        group('vertical movement', () {
          ...
          testWidgets(
            ...
            (WidgetTester tester) async {
              ...
              await tester.pumpWidget(
                buildEditableText(textAlign: TextAlign.right),
              );
              await sendKeyCombination(
                tester,
                const SingleActivator(LogicalKeyboardKey.arrowDown),
          ...
          testWidgets(
            'long run with fractional text height',
            (WidgetTester tester) async {
  ...
  group('macOS shortcuts', () {
    final TargetPlatformVariant macOSOnly = TargetPlatformVariant.only(
      TargetPlatform.macOS,
    );
    ...
    group('macOS shortcuts', () {
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          expect(
            controller.selection,
            const TextSelection(baseOffset: 24, extentOffset: 43),
          );
          ...
          expect(
            controller.selection,
            const TextSelection(baseOffset: 43, extentOffset: 24),
          );
  ...
  group('Web does accept', () {
    testWidgets('select up', (WidgetTester tester) async {
      const SingleActivator selectUp = SingleActivator(
    ...
    testWidgets('select down', (WidgetTester tester) async {
      const SingleActivator selectDown = SingleActivator(
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          buildEditableText(enableInteractiveSelection: false),
        );
        await sendKeyCombination(tester, selectLeft);
        await tester.pump();
