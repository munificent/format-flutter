  ...
  testWidgets('Drawer drag cancel resume (LTR)', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        ...
        key: scaffoldKey,
        drawer: Drawer(
          child: ListView(children: <Widget>[const Text('drawer'), Container(height: 1000.0, color: Colors.blue[500])]),
        ),
        body: Container(),
      ),
    ));
    ...
    await tester.pumpWidget(MaterialApp(
      home: Directionality(
        ...
        child: Scaffold(
          ...
          drawer: Drawer(
            child:
                ListView(children: <Widget>[const Text('drawer'), Container(height: 1000.0, color: Colors.blue[500])]),
          ),
          body: Container(),
        ),
      ),
