...
void main() {
  ...
  testWidgets('Image for device pixel ratio 1.0', (WidgetTester tester) async {
    ...
    await pumpTreeToLayout(
      tester,
      buildImageAtRatio(image, key, ratio, false, images),
    );
    ...
    await pumpTreeToLayout(
      tester,
      buildImageAtRatio(image, key, ratio, true, images),
    );
  ...
  testWidgets(
    ...
    ''') as Map<Object?, Object?>;
      ...
      await pumpTreeToLayout(
        tester,
        buildImageAtRatio(image, key, ratio, false, images, bundle),
      );
      expect(getRenderImage(tester, key).size, const Size(200.0, 200.0));
      ...
      await pumpTreeToLayout(
        tester,
        buildImageAtRatio(image, key, ratio, true, images, bundle),
      );
  ...
  testWidgets(
    'Image cache resize upscale display 5',
    (WidgetTester tester) async {
      final Key key = GlobalKey();
      await pumpTreeToLayout(
        tester,
        buildImageCacheResized(image, key, 5, 5, 20, 20),
      );
  ...
  testWidgets(
    'Image cache resize upscale display 50',
    (WidgetTester tester) async {
      final Key key = GlobalKey();
      await pumpTreeToLayout(
        tester,
        buildImageCacheResized(image, key, 50, 50, 20, 20),
      );
  ...
  testWidgets(
    'Image cache resize downscale display 5',
    (WidgetTester tester) async {
      final Key key = GlobalKey();
      await pumpTreeToLayout(
        tester,
        buildImageCacheResized(image, key, 5, 5, 1, 1),
      );
      expect(getRenderImage(tester, key).size, const Size(5.0, 5.0));
    },
  );
