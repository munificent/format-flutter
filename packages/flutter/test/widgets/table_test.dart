...
void main() {
  ...
  testWidgets(
    'Table widget - column offset (RTL)',
    (WidgetTester tester) async {
      await tester.pumpWidget(Directionality(
      ...
      await tester.pumpWidget(Directionality(
        ...
        child: Table(
          children: const <TableRow>[
            ...
            TableRow(
              children: <Widget>[Text('e'), Text('f'), Text('g'), Text('h')],
            ),
          ],
        ),
      ));
  ...
  testWidgets('Table widget - keyed rows', (WidgetTester tester) async {
    ...
    final TestStatefulWidgetState state11 = tester.state(
      find.byKey(const ValueKey<int>(11)),
    );
    final TestStatefulWidgetState state12 = tester.state(
      find.byKey(const ValueKey<int>(12)),
    );
    final TestStatefulWidgetState state21 = tester.state(
      find.byKey(const ValueKey<int>(21)),
    );
    final TestStatefulWidgetState state22 = tester.state(
      find.byKey(const ValueKey<int>(22)),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final TestChildState state = tester.state(
        find.byType(TestChildWidget).last,
      );
      state.toggleMe();
      await tester.pump();
        ...
        return Directionality(
          ...
          child: Table(
            children: <TableRow>[
              TableRow(
                children: <Widget>[
                  KeyedSubtree(key: key, child: const Text('Hello')),
                ],
              ),
            ],
          ),
