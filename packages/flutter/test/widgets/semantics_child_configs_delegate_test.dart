...
void main() {
  ...
  testWidgets('Semantics can drop semantics config', (
    WidgetTester tester,
  ) async {
    final SemanticsTester semantics = SemanticsTester(tester);
    const SemanticsTag first = SemanticsTag('1');
...
class TestConfigDelegate extends SingleChildRenderObjectWidget {
  ...
  @override
  RenderTestConfigDelegate createRenderObject(
  ...
  void updateRenderObject(
    BuildContext context,
    RenderTestConfigDelegate renderObject,
  ) {
...
class RenderTestConfigDelegate extends RenderProxyBox {
  RenderTestConfigDelegate({ChildSemanticsConfigurationsDelegate? delegate})
    : _delegate = delegate;
