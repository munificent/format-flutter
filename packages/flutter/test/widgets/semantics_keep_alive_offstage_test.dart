  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final ScrollController controller = ScrollController(
        initialScrollOffset: bottomScrollOffset,
      );
      ...
      expect(
        tester.widgetList(
          find.widgetWithText(ProblemWidget, initialLabel, skipOffstage: false),
        ),
        hasLength(1),
      );
      ...
      expect(
        tester.widgetList(find.widgetWithText(ProblemWidget, newLabel)),
        hasLength(1),
      );
      expect(semantics, isNot(includesNodeWith(label: initialLabel)));
