...
void main() {
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(_buildTestWidget(extraPadding: false, text: initialLabel, controller: controller));
      ...
      await tester.pumpWidget(_buildTestWidget(extraPadding: true, text: initialLabel, controller: controller));
      ...
      await tester.pumpWidget(_buildTestWidget(extraPadding: true, text: newLabel, controller: controller));
...
Widget _buildTestWidget({required bool extraPadding, required String text, required ScrollController controller}) {
  return MaterialApp(
    home: Scaffold(
      body: Column(
        children: <Widget>[
          ...
          SizedBox(
            ...
            child: ListView(
              ...
              children: List<Widget>.generate(10, (int i) {
                return Container(color: i.isEven ? Colors.red : Colors.blue, height: 250.0, child: Text('Item $i'));
