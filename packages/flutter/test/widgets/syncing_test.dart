...
class TestWidget extends StatefulWidget {
  const TestWidget({super.key, required this.child, required this.persistentState, required this.syncedState});
...
void main() {
  testWidgets('no change', (WidgetTester tester) async {
    await tester.pumpWidget(ColoredBox(
      color: Colors.blue,
      child: ColoredBox(color: Colors.blue, child: TestWidget(persistentState: 1, syncedState: 0, child: Container())),
    ));
    ...
    await tester.pumpWidget(ColoredBox(
      color: Colors.blue,
      child: ColoredBox(color: Colors.blue, child: TestWidget(persistentState: 2, syncedState: 0, child: Container())),
    ));
  ...
  testWidgets('remove one', (WidgetTester tester) async {
    await tester.pumpWidget(ColoredBox(
      color: Colors.blue,
      child: ColoredBox(color: Colors.blue, child: TestWidget(persistentState: 10, syncedState: 0, child: Container())),
    ));
    ...
    await tester.pumpWidget(
      ColoredBox(color: Colors.green, child: TestWidget(persistentState: 11, syncedState: 0, child: Container())),
    );
  ...
  testWidgets('swap instances around', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Column(children: <Widget>[Container(key: keyA, child: a), Container(key: keyB, child: b)]));
    ...
    await tester.pumpWidget(Column(children: <Widget>[Container(key: keyA, child: b), Container(key: keyB, child: a)]));
