...
void main() {
  ...
  testWidgets(
    'handleLifecycleStateChanged callback',
  ...
  testWidgets(
    'didPushRouteInformation callback can handle url',
    (WidgetTester tester) async {
      final PushRouteInformationObserver observer =
          PushRouteInformationObserver();
      WidgetsBinding.instance.addObserver(observer);
      ...
      await ServicesBinding.instance.defaultBinaryMessenger
          .handlePlatformMessage('flutter/navigation', message, (_) {});
      expect(
        observer.pushedRouteInformation.location,
        '/abc?def=123&def=456#789',
      );
      expect(
  ...
  testWidgets(
    ...
    skip: kIsWeb,
  ); // https://github.com/flutter/flutter/issues/87875
}
