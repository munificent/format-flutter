...
void main() {
  ...
  testWidgets('Text Foreground', (WidgetTester tester) async {
    ...
    final Shader linearGradient = const LinearGradient(colors: <Color>[red, blue]).createShader(
    ...
    await expectLater(find.byType(RepaintBoundary), matchesGoldenFile('text_golden.Foreground.gradient.png'));
    ...
    await expectLater(find.byType(RepaintBoundary), matchesGoldenFile('text_golden.Foreground.stroke.png'));
  ...
  testWidgets('Text Background', (WidgetTester tester) async {
      ...
      child: RepaintBoundary(
        child: Container(
          ...
          child: Text.rich(TextSpan(
            text: 'text1 ',
            style: TextStyle(color: translucentGreen, background: Paint()..color = red.withOpacity(0.5)),
            children: <InlineSpan>[
              TextSpan(
                text: 'text2',
                style: TextStyle(color: translucentDarkRed, background: Paint()..color = blue.withOpacity(0.5)),
              ),
            ],
          ), textDirection: TextDirection.ltr),
        ),
    ...
    await expectLater(find.byType(RepaintBoundary), matchesGoldenFile('text_golden.Background.png'));
  });
  ...
  testWidgets('Text Fade', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(RepaintBoundary).first, matchesGoldenFile('text_golden.Fade.png'));
  });
  ...
  testWidgets('Decoration thickness', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(Container), matchesGoldenFile('text_golden.DecorationThickness.1.png'));
  });
  ...
  testWidgets('Text Inline widget', (WidgetTester tester) async {
              ...
              child: ConstrainedBox(
                ...
                child: const Text.rich(TextSpan(
                  ...
                  children: <InlineSpan>[
                        ...
                        child: DecoratedBox(
                          ...
                          child: Center(
                            child: SizedBox(
                              width: 10.0,
                              height: 15.0,
                              child: DecoratedBox(decoration: BoxDecoration(color: Color(0xffff0000))),
                            ),
                          ),
                        ),
                      ),
                    ...
                    WidgetSpan(child: Checkbox(value: false, onChanged: null)),
                    WidgetSpan(child: SizedBox(width: 20, height: 20, child: Checkbox(value: true, onChanged: null))),
                    WidgetSpan(
    ...
    await expectLater(find.byType(Container), matchesGoldenFile('text_golden.TextInlineWidget.1.png'));
  });
  ...
  testWidgets('Text Inline widget textfield', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(Container), matchesGoldenFile('text_golden.TextInlineWidget.2.png'));
  });
  ...
  testWidgets('Text Inline widget nesting', (WidgetTester tester) async {
                                    ...
                                    child: DecoratedBox(
                                      ...
                                      child: Center(
                                        child: SizedBox(
                                          width: 10.0,
                                          height: 15.0,
                                          child: DecoratedBox(decoration: BoxDecoration(color: Color(0xff5f00f0))),
                                        ),
                                      ),
                                    ),
                                  ),
                              ...
                              child: DecoratedBox(
                                ...
                                child: Center(
                                  child: SizedBox(
                                    width: 10.0,
                                    height: 15.0,
                                    child: DecoratedBox(decoration: BoxDecoration(color: Color(0xff5f0000))),
                                  ),
                                ),
                              ),
                            ),
                        ...
                        child: DecoratedBox(
                          ...
                          child: Center(
                            child: SizedBox(
                              width: 10.0,
                              height: 15.0,
                              child: DecoratedBox(decoration: BoxDecoration(color: Color(0xff0000ff))),
                            ),
                          ),
                        ),
                      ),
    ...
    await expectLater(find.byType(Container), matchesGoldenFile('text_golden.TextInlineWidgetNest.1.png'));
  });
  ...
  testWidgets('Text Inline widget baseline', (WidgetTester tester) async {
                  ...
                  child: const Text.rich(TextSpan(
                    ...
                    children: <InlineSpan>[
                      ...
                      WidgetSpan(
                        alignment: PlaceholderAlignment.baseline,
                        baseline: TextBaseline.alphabetic,
                        child: SizedBox(width: 20, height: 20, child: Checkbox(value: true, onChanged: null)),
                      ),
                      WidgetSpan(
                        alignment: PlaceholderAlignment.baseline,
                        baseline: TextBaseline.alphabetic,
    ...
    await expectLater(find.byType(Container), matchesGoldenFile('text_golden.TextInlineWidgetBaseline.1.png'));
  });
  ...
  testWidgets('Text Inline widget aboveBaseline', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(Container), matchesGoldenFile('text_golden.TextInlineWidgetAboveBaseline.1.png'));
  });
  ...
  testWidgets('Text Inline widget belowBaseline', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(Container), matchesGoldenFile('text_golden.TextInlineWidgetBelowBaseline.1.png'));
  });
  ...
  testWidgets('Text Inline widget top', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(Container), matchesGoldenFile('text_golden.TextInlineWidgetTop.1.png'));
  });
  ...
  testWidgets('Text Inline widget middle', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(Container), matchesGoldenFile('text_golden.TextInlineWidgetMiddle.1.png'));
  });
  ...
  testWidgets('Text TextHeightBehavior', (WidgetTester tester) async {
    await tester.pumpWidget(Center(
      child: RepaintBoundary(
        child: Container(
          ...
          child: const Column(
            children: <Widget>[
              Text('Hello\nLine 2\nLine 3', textDirection: TextDirection.ltr, style: TextStyle(height: 5)),
              Text(
                'Hello\nLine 2\nLine 3',
                textDirection: TextDirection.ltr,
    ...
    await expectLater(find.byType(Container), matchesGoldenFile('text_golden.TextHeightBehavior.1.png'));
  });
}
