      ...
      child: RepaintBoundary(
        child: Container(
          ...
          child: const Text.rich(
            ...
            textDirection: TextDirection.ltr,
            strutStyle:
                StrutStyle(fontSize: 14, height: 1.1, forceStrutHeight: true),
          ),
        ),
      ),
    ));
                        ...
                        child: DecoratedBox(
                          ...
                          child: Center(
                            child: SizedBox(
                              ...
                              child: DecoratedBox(
                                decoration:
                                    BoxDecoration(color: Color(0xffff0000)),
                              ),
                            ),
                          ),
                        ),
              ...
              child: ConstrainedBox(
                ...
                child: const Text.rich(TextSpan(
                  ...
                  children: <InlineSpan>[
                    WidgetSpan(
                      child:
                          SizedBox(width: 70, height: 25, child: TextField()),
                    ),
                    TextSpan(
                        ...
                        children: <InlineSpan>[
                          ...
                          WidgetSpan(
                            child: SizedBox(
                              ...
                              child: DecoratedBox(
                                decoration:
                                    BoxDecoration(color: Color(0xff5fff00)),
                                child: Center(
                                  child: SizedBox(
                                    width: 10.0,
                                    height: 15.0,
                        ...
                        child: DecoratedBox(
                          ...
                          child: Center(
                            child: SizedBox(
                              ...
                              child: DecoratedBox(
                                decoration:
                                    BoxDecoration(color: Color(0xff0000ff)),
                              ),
                            ),
                          ),
                        ),
