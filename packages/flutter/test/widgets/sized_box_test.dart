...
void main() {
  ...
  testWidgets('SizedBox - container child', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Center(child: SizedBox(key: patient, width: 100.0, height: 100.0, child: Container())));
    expect(patient.currentContext!.size, equals(const Size(100.0, 100.0)));

    await tester.pumpWidget(Center(child: SizedBox(key: patient, width: 1000.0, height: 1000.0, child: Container())));
    expect(patient.currentContext!.size, equals(const Size(800.0, 600.0)));
