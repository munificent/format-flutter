...
class _MediaQueryAspectVariant extends TestVariant<_MediaQueryAspectCase> {
  ...
  Future<void> tearDown(
    _MediaQueryAspectCase value,
    _MediaQueryAspectCase? memento,
  ) async {
    aspect = memento;
  }
}
...
void main() {
  ...
  testWidgets(
    'MediaQuery.maybeOf defaults to null',
    (WidgetTester tester) async {
      bool tested = false;
      // Cannot use tester.pumpWidget here because it wraps the widget in a View,
      // which introduces a MediaQuery ancestor.
  ...
  testWidgets('MediaQueryData.fromView uses platformData if provided', (
    WidgetTester tester,
  ) async {
    ...
    expect(data.padding, EdgeInsets.fromViewPadding(
      tester.view.padding,
      tester.view.devicePixelRatio,
    ));
    expect(data.viewPadding, EdgeInsets.fromViewPadding(
      tester.view.viewPadding,
      tester.view.devicePixelRatio,
    ));
    expect(data.viewInsets, EdgeInsets.fromViewPadding(
      tester.view.viewInsets,
      tester.view.devicePixelRatio,
    ));
    expect(data.systemGestureInsets, EdgeInsets.fromViewPadding(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      const DeviceGestureSettings gestureSettings = DeviceGestureSettings(
        touchSlop: 8.0,
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      const EdgeInsets viewPadding = EdgeInsets.only(
        top: 6.0,
        right: 8.0,
        left: 10.0,
        bottom: 12.0,
      );
      const EdgeInsets viewInsets = EdgeInsets.only(
        top: 5.0,
        right: 6.0,
        left: 7.0,
        bottom: 8.0,
  ...
  testWidgets('MediaQuery.fromView creates a MediaQuery', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MediaQuery.fromWindow(
        child: Builder(
          builder: (BuildContext context) {
  ...
  test('DeviceGestureSettings has reasonable hashCode', () {
    final DeviceGestureSettings settingsA = DeviceGestureSettings(
      touchSlop: nonconst(16),
    );
    final DeviceGestureSettings settingsB = DeviceGestureSettings(
      touchSlop: nonconst(8),
    );
    final DeviceGestureSettings settingsC = DeviceGestureSettings(
      touchSlop: nonconst(16),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(subScreenMediaQuery.boldText, true);
      expect(subScreenMediaQuery.highContrast, true);
      expect(subScreenMediaQuery.displayFeatures, <DisplayFeature>[
        cutoutDisplayFeature,
      ]);
    },
  );
  ...
  testWidgets(
    'MediaQuery can be partially depended-on',
    (WidgetTester tester) async {
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    onPressed: () {
                      setState(() {
                        data = data.copyWith(
                          textScaleFactor: data.textScaleFactor + 0.1,
                        );
                      });
                    },
