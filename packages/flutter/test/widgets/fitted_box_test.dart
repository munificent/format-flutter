...
void main() {
  testWidgets('Can size according to aspect ratio', (
    ...
    final Offset insidePoint = insideBox.localToGlobal(
  ...
  testWidgets('FittedBox with no child', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      Center(child: FittedBox(key: key, fit: BoxFit.cover)),
    );
  ...
  testWidgets('Child can be aligned multiple ways in a row', (
...

    {
      ...
      final RenderBox outsideBox = tester.firstRenderObject(
        find.byKey(outside),
      );
      ...
      final Offset outsideTopLeft = outsideBox.localToGlobal(
        const Offset(0.0, 90.0),
      );
      final Offset insideBottomRight = insideBox.localToGlobal(
        const Offset(10.0, 10.0),
      );
      final Offset outsideBottomRight = outsideBox.localToGlobal(
  ...
  testWidgets(
    'FittedBox layers - cover - horizontal',
  ...
  testWidgets(
    'FittedBox layers - cover - vertical',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const Center(
          child: SizedBox(
  ...
  testWidgets('BoxFit.scaleDown matches size of child', (
    WidgetTester tester,
  ) async {
    final Key outside = UniqueKey();
    final Key inside = UniqueKey();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const Center(
          child: SizedBox(width: 200.0, height: 200.0, child: FittedBox()),
        ),
      );
