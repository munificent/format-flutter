...
void main() {
  ...
  testWidgets(
    'Semantics tag only applies to immediate child',
  ...
  testWidgets('Semantics tooltip', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      Semantics(tooltip: 'test1', textDirection: TextDirection.ltr),
    );
  ...
  testWidgets(
    'Semantics and Directionality - RTL',
    (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgets(
    'Semantics and Directionality - LTR',
    (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgets(
    'Semantics value and hint can merge',
    (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        Semantics(key: const Key('b'), container: true, scopesRoute: false),
      );
  ...
  testWidgets('Actions can be replaced without triggering semantics update', (
    ...
    await tester.pumpWidget(
      Semantics(container: true, onTap: () => performedActions.add('first')),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        Semantics(container: true, onTap: () {}, onTapHint: 'test'),
      );
      ...
      await tester.pumpWidget(
        Semantics(container: true, onLongPress: () {}, onLongPressHint: 'foo'),
      );
    ...
    (WidgetTester tester) async {
      ...
      expect(semantics, hasSemantics(TestSemantics.root(
        children: <TestSemantics>[
          TestSemantics.rootChild(
            actions:
                SemanticsAction.increase.index | SemanticsAction.decrease.index,
            textDirection: TextDirection.ltr,
            value: '10s',
            increasedValue: '11s',
            decreasedValue: '9s',
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
      int semanticsUpdateCount = 0;
      final SemanticsHandle handle = tester.binding.pipelineOwner
          .ensureSemantics(
            listener: () {
              semanticsUpdateCount += 1;
            },
  ...
  testWidgets(
    'blocking user interaction on a merged child',
    (WidgetTester tester) async {
