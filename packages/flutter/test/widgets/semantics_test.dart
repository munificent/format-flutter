...
void main() {
  ...
  testWidgets('Semantics shutdown and restart', (WidgetTester tester) async {
    ...
    final TestSemantics expectedSemantics = TestSemantics.root(
      children: <TestSemantics>[TestSemantics.rootChild(label: 'test1', textDirection: TextDirection.ltr)],
    );

    await tester.pumpWidget(Semantics(label: 'test1', textDirection: TextDirection.ltr, child: Container()));
      ...
      child: ListView(
        children: <Widget>[
          SingleChildScrollView(
            child:
                Column(children: <Widget>[Container(padding: const EdgeInsets.only(top: 20.0)), const Text('label')]),
          ),
        ],
      ),
    ));
  ...
  testWidgets('Semantics tooltip', (WidgetTester tester) async {
    ...
    final TestSemantics expectedSemantics = TestSemantics.root(
      children: <TestSemantics>[TestSemantics.rootChild(tooltip: 'test1', textDirection: TextDirection.ltr)],
    );
  ...
  testWidgets('Detach and reattach assert', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Directionality(
      textDirection: TextDirection.ltr,
      child:
          Semantics(label: 'test1', child: Semantics(key: key, container: true, label: 'test2a', child: Container())),
    ));

    expect(semantics, hasSemantics(TestSemantics.root(
      children: <TestSemantics>[
        TestSemantics.rootChild(label: 'test1', children: <TestSemantics>[TestSemantics(label: 'test2a')]),
      ],
    ...
    expect(semantics, hasSemantics(TestSemantics.root(
      children: <TestSemantics>[
        TestSemantics.rootChild(
          label: 'test1',
          children: <TestSemantics>[
            TestSemantics(label: 'middle', children: <TestSemantics>[TestSemantics(label: 'test2b')]),
          ],
        ),
      ],
    ), ignoreId: true, ignoreRect: true, ignoreTransform: true));
  ...
  testWidgets('Semantics and Directionality - RTL', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      Directionality(textDirection: TextDirection.rtl, child: Semantics(label: 'test1', child: Container())),
    );
  ...
  testWidgets('Semantics and Directionality - LTR', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      Directionality(textDirection: TextDirection.ltr, child: Semantics(label: 'test1', child: Container())),
    );
  ...
  testWidgets('Semantics and Directionality - cannot override LTR with RTL', (WidgetTester tester) async {
    ...
    final TestSemantics expectedSemantics = TestSemantics.root(
      children: <TestSemantics>[TestSemantics.rootChild(label: 'test1', textDirection: TextDirection.rtl)],
    );
  ...
  testWidgets('Semantics label and hint', (WidgetTester tester) async {
    ...
    final TestSemantics expectedSemantics = TestSemantics.root(
      children: <TestSemantics>[
        TestSemantics.rootChild(label: 'label', hint: 'hint', value: 'value', textDirection: TextDirection.ltr),
      ],
    );
  ...
  testWidgets('Semantics hints can merge', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Directionality(
      ...
      child: Semantics(
        container: true,
        child: Column(children: <Widget>[Semantics(hint: 'hint one'), Semantics(hint: 'hint two')]),
      ),
    ));

    final TestSemantics expectedSemantics = TestSemantics.root(
      children: <TestSemantics>[TestSemantics.rootChild(hint: 'hint one\nhint two', textDirection: TextDirection.ltr)],
    );
    ...
    for (final SemanticsAction action in allActions) {
      switch (action) {
        ...
        case SemanticsAction.setSelection:
          semanticsOwner.performAction(expectedId, action, <dynamic, dynamic>{'base': 4, 'extent': 5});
  ...
  testWidgets('Semantics widget supports all flags', (WidgetTester tester) async {
    ...
    TestSemantics expectedSemantics = TestSemantics.root(
      children: <TestSemantics>[TestSemantics.rootChild(rect: TestSemantics.fullScreen, flags: flags)],
    );
    expect(semantics, hasSemantics(expectedSemantics, ignoreId: true));

    await tester.pumpWidget(Semantics(key: const Key('b'), container: true, scopesRoute: false));
    expectedSemantics = TestSemantics.root(
      children: <TestSemantics>[TestSemantics.rootChild(rect: TestSemantics.fullScreen, flags: <SemanticsFlag>[])],
    );
    expect(semantics, hasSemantics(expectedSemantics, ignoreId: true));
  ...
  testWidgets('Actions can be replaced without triggering semantics update', (WidgetTester tester) async {
    ...
    final TestSemantics expectedSemantics = TestSemantics.root(
      children: <TestSemantics>[
        TestSemantics.rootChild(id: expectedId, rect: TestSemantics.fullScreen, actions: SemanticsAction.tap.index),
      ],
    );
    ...
    await tester.pumpWidget(Semantics(container: true, onTap: () => performedActions.add('second')));
  ...
  testWidgets('onTapHint and onLongPressHint create custom actions', (WidgetTester tester) async {
    ...
    expect(tester.getSemantics(find.byType(Semantics)), matchesSemantics(hasTapAction: true, onTapHint: 'test'));
    ...
    await tester.pumpWidget(Directionality(
      ...
      child: Column(
        children: <Widget>[
          ...
          Transform.rotate(
            angle: pi / 2.0,
            child: const Row(children: <Widget>[Text('Label 3'), Text('Label 4'), Text('Label 5')]),
          ),
        ],
      ),
    ));
  ...
  testWidgets('Semantics excludeSemantics ignores children', (WidgetTester tester) async {
    ...
    expect(semantics, hasSemantics(
      TestSemantics(children: <TestSemantics>[TestSemantics(label: 'label', textDirection: TextDirection.ltr)]),
      ignoreId: true,
      ignoreRect: true,
  ...
  testWidgets('Can change handlers', (WidgetTester tester) async {
    await tester.pumpWidget(Semantics(container: true, label: 'foo', textDirection: TextDirection.ltr));
    ...
    await tester.pumpWidget(Semantics(container: true, label: 'foo', textDirection: TextDirection.ltr, onTap: () {}));
    ...
    await tester.pumpWidget(
      Semantics(container: true, label: 'foo', textDirection: TextDirection.ltr, onLongPress: () {}),
    );
    ...
    await tester.pumpWidget(
      Semantics(container: true, label: 'foo', textDirection: TextDirection.ltr, onScrollLeft: () {}),
    );
    ...
    await tester.pumpWidget(
      Semantics(container: true, label: 'foo', textDirection: TextDirection.ltr, onScrollRight: () {}),
    );
    ...
    await tester.pumpWidget(
      Semantics(container: true, label: 'foo', textDirection: TextDirection.ltr, onScrollDown: () {}),
    );
    ...
    await tester.pumpWidget(Semantics(container: true, label: 'foo', textDirection: TextDirection.ltr, onCopy: () {}));
    ...
    await tester.pumpWidget(Semantics(container: true, label: 'foo', textDirection: TextDirection.ltr, onCut: () {}));
    ...
    await tester.pumpWidget(Semantics(container: true, label: 'foo', textDirection: TextDirection.ltr, onPaste: () {}));
    ...
    await tester.pumpWidget(
      Semantics(container: true, label: 'foo', textDirection: TextDirection.ltr, onSetSelection: (TextSelection _) {}),
    );
    ...
    await tester.pumpWidget(
      Semantics(container: true, label: 'foo', textDirection: TextDirection.ltr, onDidGainAccessibilityFocus: () {}),
    );

    expect(
      tester.getSemantics(find.bySemanticsLabel('foo')),
      matchesSemantics(label: 'foo', hasDidGainAccessibilityFocusAction: true, textDirection: TextDirection.ltr),
    );
    ...
    await tester.pumpWidget(
      Semantics(container: true, label: 'foo', textDirection: TextDirection.ltr, onDidLoseAccessibilityFocus: () {}),
    );

    expect(
      tester.getSemantics(find.bySemanticsLabel('foo')),
      matchesSemantics(label: 'foo', hasDidLoseAccessibilityFocusAction: true, textDirection: TextDirection.ltr),
    );
      ...
      const Column(
        children: <Widget>[
          SizedBox(
            height: 0,
            width: 500,
            child: FittedBox(child: SizedBox(height: 55, width: 266, child: SingleChildScrollView(child: Column()))),
          ),
        ],
      ),
    );
  ...
  testWidgets('blocking user interaction works on explicit child node.', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      home: Semantics(
        ...
        child: Column(
          children: <Widget>[
            Semantics(key: key1, label: 'label1', onTap: () {}, child: const SizedBox(width: 10, height: 10)),
            Semantics(key: key2, label: 'label2', onTap: () {}, child: const SizedBox(width: 10, height: 10)),
          ],
        ),
      ),
    ));
      ...
      home: Semantics(
        ...
        child: Column(
          children: <Widget>[
            ...
            Semantics(label: 'label2', onLongPress: () {}, child: const SizedBox(width: 10, height: 10)),
          ],
        ),
      ),
    ));
  ...
  testWidgets('does not merge conflicting actions even if one of them is blocked', (WidgetTester tester) async {
      ...
      home: Semantics(
        ...
        child: Column(
          children: <Widget>[
            ...
            Semantics(label: 'label2', onTap: () {}, child: const SizedBox(width: 10, height: 10)),
          ],
        ),
      ),
    ));
    ...
    expect(
      node,
      matchesSemantics(children: <Matcher>[containsSemantics(label: 'label1'), containsSemantics(label: 'label2')]),
    );
  });
}
