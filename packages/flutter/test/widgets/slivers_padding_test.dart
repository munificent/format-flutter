...
void main() {
  ...
  testWidgets(
    'Viewport+SliverPadding hit testing',
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(tester.renderObject<RenderBox>(find.text('x')).localToGlobal(
        Offset.zero,
      ), const Offset(0.0, 200.0));
      expect(
        tester.renderObject<RenderSliverPadding>(
  ...
  testWidgets(
    'Viewport+SliverPadding changing direction',
    (WidgetTester tester) async {
      await tester.pumpWidget(Directionality(
        textDirection: TextDirection.ltr,
        child: Viewport(
