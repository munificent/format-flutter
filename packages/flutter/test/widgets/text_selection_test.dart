...
void main() {
  ...
  testWidgets(
    'a touch drag is recognized for text selection',
    (WidgetTester tester) async {
      await pumpGestureDetector(tester);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final FakeEditableTextState state = tester.state(
        find.byType(FakeEditableText),
      );
      final FakeRenderEditable renderEditable = tester.renderObject(
        find.byType(FakeEditable),
      );
      renderEditable.hasFocus = true;

      final TestGesture gesture =
          await tester.startGesture(const Offset(200.0, 200.0), pointer: 0);
      await tester.pump(const Duration(seconds: 2));
      await gesture.up();
      await tester.pumpAndSettle();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      renderEditable.text = const TextSpan(
      ...
      final Offset charLocation = renderEditable.getLocalRectForCaret(
      ...
      renderEditable.selection = const TextSelection(
        baseOffset: 3,
        extentOffset: 20,
      );
      await gesture.down(globalCharLocation);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final TestGesture gesture =
          await tester.startGesture(const Offset(25.0, 200.0), pointer: 0);
      await gesture.up();
      await tester.pumpAndSettle();
  ...
  testWidgets(
    'Mouse drag does not show handles nor toolbar',
    (WidgetTester tester) async {
      // Regression test for https://github.com/flutter/flutter/issues/69001
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(body: SelectableText('I love Flutter!')),
        ),
      );
  ...
  testWidgets(
    'Mouse drag selects and cannot drag cursor',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'Drag of unknown type moves the cursor',
    (WidgetTester tester) async {
      // Regression test for https://github.com/flutter/flutter/issues/102928
      final TextEditingController controller = TextEditingController(
        text: 'I love flutter!',
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      renderEditable.layout(
        const BoxConstraints.tightFor(width: 400, height: 300.0),
      );
      await tester.pumpAndSettle();
  ...
  testWidgets(
    'test TextSelectionGestureDetectorBuilder mouse drag disabled',
    (WidgetTester tester) async {
      await pumpTextSelectionGestureDetectorBuilder(
        tester,
        selectionEnabled: false,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        home:
            Scaffold(body: TextField(autofocus: true, controller: controller)),
      ));
  ...
  group('SelectionOverlay', () {
    ...
    testWidgets('can show and hide handles', (WidgetTester tester) async {
      ...
      final SelectionOverlay selectionOverlay =
          await pumpApp(tester, selectionControls: spy);
      selectionOverlay
    ...
    testWidgets(
      'only paints one collapsed handle',
      (WidgetTester tester) async {
        final TextSelectionControlsSpy spy = TextSelectionControlsSpy();
        final SelectionOverlay selectionOverlay =
            await pumpApp(tester, selectionControls: spy);
    ...
    testWidgets(
      'can trigger selection handle onTap',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'can trigger selection handle drag',
      (WidgetTester tester) async {
        ...
        await tester.pump(const Duration(milliseconds: 200));
        expect(
          endDragStartDetails!.globalPosition,
          tester.getCenter(find.byKey(spy.rightHandleKey)),
        );
    ...
    testWidgets(
      'can show magnifier when no handles exist',
      (WidgetTester tester) async {
...
class FakeEditableTextState extends EditableTextState {
  ...
  SuggestionSpan? findSuggestionSpanAtCursorIndex(int cursorIndex) {
    return markCurrentSelectionAsMisspelled
        ? const SuggestionSpan(TextRange(start: 7, end: 12), <String>[
            'word',
            'world',
            'old',
          ])
    ...
    switch (type) {
      case TextSelectionHandleType.left:
        return ElevatedButton(
          onPressed: onTap,
          child: Text('height ${textLineHeight.toInt()}', key: leftHandleKey),
        );
      case TextSelectionHandleType.right:
        return ElevatedButton(
          onPressed: onTap,
          child: Text('height ${textLineHeight.toInt()}', key: rightHandleKey),
        );
      case TextSelectionHandleType.collapsed:
        return ElevatedButton(
          onPressed: onTap,
          child:
              Text('height ${textLineHeight.toInt()}', key: collapsedHandleKey),
        );
    }
  }
