...
void main() {
  group('AndroidView', () {
    testWidgets('Create Android view', (WidgetTester tester) async {
      ...
      expect(viewsController.views, unorderedEquals(<FakeAndroidPlatformView>[
    ...
    testWidgets(
      'Zero sized Android view is not created',
    ...
    testWidgets('Dispose Android view', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        const Center(child: SizedBox(width: 200.0, height: 100.0)),
      );
    ...
    testWidgets(
      'Android view survives widget tree change',
      (WidgetTester tester) async {
        final int currentViewId = platformViewsRegistry.getNextPlatformViewId();
        final FakeAndroidPlatformViewsController viewsController =
            FakeAndroidPlatformViewsController();
    ...
    testWidgets(
      'Android view transparent hit test behavior',
      (WidgetTester tester) async {
        final int currentViewId = platformViewsRegistry.getNextPlatformViewId();
        final FakeAndroidPlatformViewsController viewsController =
            FakeAndroidPlatformViewsController();
    ...
    testWidgets(
      'Android view translucent hit test behavior',
      (WidgetTester tester) async {
        final int currentViewId = platformViewsRegistry.getNextPlatformViewId();
        final FakeAndroidPlatformViewsController viewsController =
            FakeAndroidPlatformViewsController();
    ...
    testWidgets(
      'Android view opaque hit test behavior',
      (WidgetTester tester) async {
        final int currentViewId = platformViewsRegistry.getNextPlatformViewId();
        final FakeAndroidPlatformViewsController viewsController =
            FakeAndroidPlatformViewsController();
    ...
    testWidgets(
      'Android view ambient directionality',
      (WidgetTester tester) async {
        final int currentViewId = platformViewsRegistry.getNextPlatformViewId();
        final FakeAndroidPlatformViewsController viewsController =
            FakeAndroidPlatformViewsController();
    ...
    testWidgets(
      'Android view can lose gesture arenas',
      (WidgetTester tester) async {
        final int currentViewId = platformViewsRegistry.getNextPlatformViewId();
        final FakeAndroidPlatformViewsController viewsController =
            FakeAndroidPlatformViewsController();
    ...
    testWidgets(
      'Android view drag gesture recognizer',
      (WidgetTester tester) async {
        final int currentViewId = platformViewsRegistry.getNextPlatformViewId();
        final FakeAndroidPlatformViewsController viewsController =
            FakeAndroidPlatformViewsController();
    ...
    testWidgets(
      'Android view long press gesture recognizer',
      (WidgetTester tester) async {
        final int currentViewId = platformViewsRegistry.getNextPlatformViewId();
        final FakeAndroidPlatformViewsController viewsController =
            FakeAndroidPlatformViewsController();
    ...
    testWidgets(
      'Android view tap gesture recognizer',
      (WidgetTester tester) async {
        final int currentViewId = platformViewsRegistry.getNextPlatformViewId();
        final FakeAndroidPlatformViewsController viewsController =
            FakeAndroidPlatformViewsController();
    ...
    testWidgets(
      'Android view rebuilt during gesture',
      (WidgetTester tester) async {
        final int currentViewId = platformViewsRegistry.getNextPlatformViewId();
        final FakeAndroidPlatformViewsController viewsController =
            FakeAndroidPlatformViewsController();
    ...
    testWidgets(
      'Android view with eager gesture recognizer',
      (WidgetTester tester) async {
        final int currentViewId = platformViewsRegistry.getNextPlatformViewId();
        final FakeAndroidPlatformViewsController viewsController =
            FakeAndroidPlatformViewsController();
    ...
    testWidgets(
      'AndroidView has correct semantics',
      (WidgetTester tester) async {
    ...
    testWidgets('AndroidView can take input focus', (
      ...
      final Focus androidViewFocusWidget = tester.widget(find.descendant(
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final Element containerElement = tester.element(
    ...
    testWidgets('can set and update clipBehavior', (WidgetTester tester) async {
      ...
      final RenderAndroidView renderObject = tester.renderObject(find
          .descendant(
            of: find.byType(AndroidView),
    ...
    testWidgets('clip is handled correctly during resizing', (
      ...
      expect(
        ...
        const Rect.fromLTWH(0.0, 0.0, 50.0, 100.0),
      );
    ...
    testWidgets('offset is sent to the platform', (WidgetTester tester) async {
      ...
      await tester.pump();
      expect(
        viewsController.offsets.values,
  ...
  group('AndroidViewSurface', () {
    ...
    testWidgets('AndroidViewSurface defaults to texture-based rendering', (
      ...
      expect(find.byWidgetPredicate(
        (Widget widget) =>
            widget.runtimeType.toString() == '_TextureBasedAndroidViewSurface',
      ), findsOneWidget);
    });
  ...
  group('UiKitView', () {
    testWidgets('Create UIView', (WidgetTester tester) async {
      ...
      expect(viewsController.views, unorderedEquals(<FakeUiKitView>[
    ...
    testWidgets(
      'Dispose UIView before creation completed ',
      (WidgetTester tester) async {
        final FakeIosPlatformViewsController viewsController =
            FakeIosPlatformViewsController();
        viewsController.registerViewType('webview');
    ...
    testWidgets(
      'UIView survives widget tree change',
      (WidgetTester tester) async {
        final int currentViewId = platformViewsRegistry.getNextPlatformViewId();
        final FakeIosPlatformViewsController viewsController =
            FakeIosPlatformViewsController();
    ...
    testWidgets(
      'UiKitView transparent hit test behavior',
      (WidgetTester tester) async {
        final int currentViewId = platformViewsRegistry.getNextPlatformViewId();
        final FakeIosPlatformViewsController viewsController =
            FakeIosPlatformViewsController();
    ...
    testWidgets(
      'UiKitView translucent hit test behavior',
      (WidgetTester tester) async {
        final int currentViewId = platformViewsRegistry.getNextPlatformViewId();
        final FakeIosPlatformViewsController viewsController =
            FakeIosPlatformViewsController();
    ...
    testWidgets(
      'UiKitView opaque hit test behavior',
      (WidgetTester tester) async {
        final int currentViewId = platformViewsRegistry.getNextPlatformViewId();
        final FakeIosPlatformViewsController viewsController =
            FakeIosPlatformViewsController();
    ...
    testWidgets(
      'UiKitView can lose gesture arenas',
      (WidgetTester tester) async {
        final int currentViewId = platformViewsRegistry.getNextPlatformViewId();
        final FakeIosPlatformViewsController viewsController =
            FakeIosPlatformViewsController();
    ...
    testWidgets(
      'UiKitView tap gesture recognizers',
      (WidgetTester tester) async {
        final int currentViewId = platformViewsRegistry.getNextPlatformViewId();
        final FakeIosPlatformViewsController viewsController =
            FakeIosPlatformViewsController();
    ...
    testWidgets(
      'UiKitView long press gesture recognizers',
      (WidgetTester tester) async {
        final int currentViewId = platformViewsRegistry.getNextPlatformViewId();
        final FakeIosPlatformViewsController viewsController =
            FakeIosPlatformViewsController();
    ...
    testWidgets(
      'UiKitView drag gesture recognizers',
      (WidgetTester tester) async {
        final int currentViewId = platformViewsRegistry.getNextPlatformViewId();
        final FakeIosPlatformViewsController viewsController =
            FakeIosPlatformViewsController();
    ...
    testWidgets(
      'UiKitView rebuilt during gesture',
      (WidgetTester tester) async {
        final int currentViewId = platformViewsRegistry.getNextPlatformViewId();
        final FakeIosPlatformViewsController viewsController =
            FakeIosPlatformViewsController();
    ...
    testWidgets(
      'UiKitView with eager gesture recognizer',
      (WidgetTester tester) async {
        final int currentViewId = platformViewsRegistry.getNextPlatformViewId();
        final FakeIosPlatformViewsController viewsController =
            FakeIosPlatformViewsController();
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(UiKitView(
          viewType: 'webview',
          gestureRecognizers: <Factory<OneSequenceGestureRecognizer>>{
            Factory<EagerGestureRecognizer>(constructRecognizer),
          },
    ...
    testWidgets('UiKitView can take input focus', (WidgetTester tester) async {
      ...
      final Focus uiKitViewFocusWidget = tester.widget(find.descendant(
    ...
    testWidgets(
      'FocusNode is disposed on UIView dispose',
      (WidgetTester tester) async {
        final FakeIosPlatformViewsController viewsController =
            FakeIosPlatformViewsController();
        viewsController.registerViewType('webview');
    ...
    testWidgets('UiKitView has correct semantics', (WidgetTester tester) async {
      ...
      final SemanticsNode semantics = tester.getSemantics(find.descendant(
        of: find.byType(UiKitView),
        matching: find.byWidgetPredicate(
          (Widget widget) =>
  ...
  group('Common PlatformView', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(surface);
        expect(
          () => tester.layers.whereType<PlatformViewLayer>().first,
          returnsNormally,
        );
      },
    );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          tester.allWidgets.map(
            (Widget widget) => widget.runtimeType.toString(),
          ).toList(),
        ...
        final Widget widget = Center(
          child: SizedBox(
            ...
            child: PlatformViewLink(
              viewType: 'webview',
              onCreatePlatformView: (PlatformViewCreationParams params) {
                controller = FakeAndroidViewController(
                  params.id,
                  requiresSize: true,
                );
                controller.create();
    ...
    testWidgets('PlatformViewLink re-initializes when view type changes', (
      ...
      expect(
        surfaceViewIds,
        unorderedEquals(<int>[currentViewId + 1, currentViewId + 2]),
      );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          () => tester.allWidgets.whereType<Container>().first,
          returnsNormally,
        );
      },
    );
    ...
    testWidgets('PlatformViewLink manages the focus properly', (
      ...
      final Focus platformViewFocusWidget = tester.widget(find.descendant(
  ...
  testWidgets('Platform views respect hitTestBehavior', (
            ...
            child: MouseRegion(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Center(
                    child: SizedBox(width: 200, height: 200, child: target),
                  ),
                ],
              ),
            ),
    ...
    // Test: Opaque
    await tester.pumpWidget(scaffold(PlatformViewSurface(
      controller: controller,
      hitTestBehavior: PlatformViewHitTestBehavior.opaque,
      gestureRecognizers: const <Factory<OneSequenceGestureRecognizer>>{},
    )));
    ...
    expect(controller.dispatchedPointerEvents[0], isA<PointerHoverEvent>());
    expect(
      controller.dispatchedPointerEvents[0].position,
      const Offset(401, 301),
    );
    expect(
      controller.dispatchedPointerEvents[0].localPosition,
