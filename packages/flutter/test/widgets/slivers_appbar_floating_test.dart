...
void verifyActualBoxPosition(
  ...
  final RenderBox box = tester.renderObjectList<RenderBox>(finder).elementAt(
    index,
  );
...
void main() {
  ...
  testWidgets('Sliver appbars - floating - normal behavior works', (
    ...
    verifyPaintPosition(
      key2,
      Offset(0.0, 600.0 - delegate.maxExtent * 2.0),
      true,
    );
    verifyActualBoxPosition(
      tester,
    ...
    verifyActualBoxPosition(
      ...
      Rect.fromLTWH(
        0.0,
        -delegate.maxExtent * 0.4,
        800.0,
        delegate.maxExtent * 0.5,
      ),
    );
  ...
  group('Pointer scrolled floating', () {
    ...
    testWidgets('SliverAppBar', (WidgetTester tester) async {
      ...
      await tester.sendEventToBinding(
        testPointer.scroll(const Offset(0.0, -250.0)),
      );
      await tester.pump();
      expect(find.text('Test Title'), findsOneWidget);
      expect(find.text('Item 1'), findsOneWidget);
