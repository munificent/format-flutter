...
void main() {
  group('FocusScope', () {
    ...
    testWidgets('Can unfocus', (WidgetTester tester) async {
      ...
      FocusScope.of(keyA.currentContext!).requestFocus(
        keyA.currentState!.focusNode,
      );
      await tester.pumpAndSettle();
      ...
      FocusScope.of(keyB.currentContext!).requestFocus(
        keyB.currentState!.focusNode,
      );
      await tester.pumpAndSettle();
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          FocusManager.instance.rootScope.toStringDeep(
        ...
        final FocusAttachment childAttachment = childFocusScope.attach(
          key.currentContext,
        );
    ...
    testWidgets('Setting first focus requests focus for the scope properly.', (
      ...
      final FocusScopeNode childFocusScope1 = FocusScopeNode(
        debugLabel: 'Child Scope Node 1',
      );
      final FocusScopeNode childFocusScope2 = FocusScopeNode(
        debugLabel: 'Child Scope Node 2',
      );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          Column(children: <Widget>[TestFocus(key: keyB, name: 'b')]),
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          Focus.of(keyA.currentContext!, scopeOk: true),
          equals(childFocusScope),
        );
        FocusManager.instance.rootScope.setFirstFocus(
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final FocusScopeNode insertedNode = FocusScopeNode(
          debugLabel: 'Inserted',
        );
        ...
        child: Column(
          children: <Widget>[
            ...
            FocusScope(
              ...
              child: Column(
                children: <Widget>[
                  TestFocus(debugLabel: 'Child B', key: keyB, name: 'b'),
                ],
              ),
            ),
          ],
          ...
          child: Column(
            children: <Widget>[
              FocusScope(
                ...
                child: Column(
                  children: <Widget>[
                    TestFocus(debugLabel: 'Child A', key: keyA),
                  ],
                ),
              ),
              FocusScope(
    ...
    testWidgets('Can autofocus a node.', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        Focus(autofocus: true, focusNode: focusNode, child: Container()),
      );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(Column(
          children: <Widget>[
            Focus(focusNode: focusNodeA, autofocus: true, child: Container()),
          ],
        ));
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          focusScopeWidget.skipTraversal,
          equals(focusScopeNode.skipTraversal),
        );
        expect(
          focusScopeWidget.canRequestFocus,
  ...
  group('Focus', () {
    testWidgets(
      'Focus.of stops at the nearest Focus widget.',
      (WidgetTester tester) async {
        final GlobalKey key1 = GlobalKey(debugLabel: '1');
    ...
    testWidgets(
      'Focus is ignored when set to not focusable.',
      (WidgetTester tester) async {
        final GlobalKey key1 = GlobalKey(debugLabel: '1');
        bool? gotFocus;
        await tester.pumpWidget(Focus(
    ...
    testWidgets(
      'Focus is lost when set to not focusable.',
      (WidgetTester tester) async {
        final GlobalKey key1 = GlobalKey(debugLabel: '1');
        bool? gotFocus;
        await tester.pumpWidget(Focus(
    ...
    testWidgets('Child of unfocusable Focus can get focus.', (
      ...
      await tester.pumpWidget(Focus(
        ...
        onFocusChange: (bool focused) => gotFocus = focused,
        child:
            Focus(key: key1, focusNode: focusNode, child: Container(key: key2)),
      ));
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          Focus.of(container1.currentContext!).hasFocus,
          isTrue,
        ); // focus2 has focus.
    ...
    testWidgets(
      'descendantsAreFocusable works as expected.',
      (WidgetTester tester) async {
        final GlobalKey key1 = GlobalKey(debugLabel: '1');
        final GlobalKey key2 = GlobalKey(debugLabel: '2');
        final FocusNode focusNode = FocusNode();
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          Focus(includeSemantics: false, child: Container()),
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          focusWidget.descendantsAreFocusable,
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          focusWidget.descendantsAreTraversable,
      ...
      (WidgetTester tester) async {
        ...
        Widget buildFocusTree({required bool parentCanRequestFocus}) {
          return FocusScope(
            ...
            child: Column(
              children: <Widget>[
                Focus(focusNode: childFocusNode, child: Container()),
              ],
            ),
          );
        }
