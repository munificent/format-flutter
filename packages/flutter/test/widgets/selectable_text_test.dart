...
void main() {
    ...
    await tester.pumpWidget(
      const Directionality(
        ...
        child: MediaQuery(
          ...
          child:
              Center(child: Material(child: SelectableText('I love Flutter!'))),
        ),
      ),
    );
  ...
  testWidgets('has expected defaults', (WidgetTester tester) async {
    ...
    final SelectableText selectableText = tester.firstWidget(
      find.byType(SelectableText),
    );
  ...
  testWidgets(
    'Rich selectable text has expected defaults',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const MediaQuery(
          data: MediaQueryData(),
  ...
  testWidgets(
    'Rich selectable text supports WidgetSpan',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const MediaQuery(
          data: MediaQueryData(),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        overlay(child: const SelectableText('selectable text')),
      );
  ...
  testWidgets('Selectable Text has adaptive size', (WidgetTester tester) async {
    ...
    RenderBox findSelectableTextBox() => tester.renderObject(
      find.byType(SelectableText),
    );
    ...
    await tester.pumpWidget(
      boilerplate(child: const SelectableText('very very long')),
    );
  ...
  testWidgets('can scale with textScaleFactor', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(boilerplate(
      child: const SelectableText('selectable text', textScaleFactor: 1.9),
    ));

    final RenderBox scaledBox = tester.renderObject(
      find.byType(SelectableText),
    );
  ...
  testWidgets('can switch between textWidthBasis', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(boilerplate(
      child: const SelectableText(text, textWidthBasis: TextWidthBasis.parent),
    ));
  ...
  testWidgets('can switch between textHeightBehavior', (
    ...
    await tester.pumpWidget(boilerplate(
      child: const SelectableText(text, textHeightBehavior: textHeightBehavior),
    ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        overlay(child: const SelectableText('some text', showCursor: true)),
      );
      await tester.tap(find.byType(SelectableText));
      await tester.idle();
  ...
  testWidgets('Caret position is updated on tap', (WidgetTester tester) async {
    await tester.pumpWidget(
      overlay(child: const SelectableText('abc def ghi')),
    );
  ...
  testWidgets(
    'Dragging handles calls onSelectionChanged',
    (WidgetTester tester) async {
  ...
  testWidgets('Can use selection toolbar', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      const MaterialApp(home: Material(child: SelectableText(testValue))),
    );
    final EditableText editableTextWidget = tester.widget(
      find.byType(EditableText),
    );
  ...
  testWidgets('Selectable height with maxLine', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      selectableTextBuilder(text: kThreeLines, maxLines: 3),
    );
    expect(findTextBox(), equals(textBox));
    ...
    await tester.pumpWidget(
      selectableTextBuilder(text: kThreeLines, maxLines: null),
    );
  ...
  testWidgets('Can scroll multiline input', (WidgetTester tester) async {
    ...
    final TextEditingController controller = editableTextWidget.controller;
    RenderBox findInputBox() => tester.renderObject(
      find.byType(SelectableText),
    );
      ...
      expect(
        () async {
          await tester.pumpWidget(overlay(
            child: SizedBox(
              width: 300.0,
              child: SelectableText('abcd', minLines: 4, maxLines: 3),
            ),
          ));
        },
  ...
  testWidgets('Can align to center within center', (WidgetTester tester) async {
    await tester.pumpWidget(overlay(
      child: const SizedBox(
        width: 300.0,
        child:
            Center(child: SelectableText('abcd', textAlign: TextAlign.center)),
      ),
    ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      EditableText editableTextWidget = tester.widget(
        find.byType(EditableText).first,
      );
  ...
  testWidgets('Changing focus test', (WidgetTester tester) async {
    ...
    final EditableText editableTextWidget1 = tester.widget(
      find.byType(EditableText).first,
    );
    final TextEditingController c1 = editableTextWidget1.controller;

    final EditableText editableTextWidget2 = tester.widget(
  ...
  testWidgets('SelectableText semantics', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      overlay(child: SelectableText('Guten Tag', key: key)),
    );
  ...
  testWidgets(
    'SelectableText semantics, with semanticsLabel',
    (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
      final Key key = UniqueKey();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        overlay(child: SelectableText(testValue, key: key)),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset selectableTextStart = tester.getTopLeft(
        find.byType(SelectableText),
      );
  ...
  testWidgets('tap moves cursor to the position tapped (Android)', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const MaterialApp(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        controller.selection,
        const TextSelection(baseOffset: 13, extentOffset: 66),
      );
      // Keep moving out.
...
//convert
  ...
  testWidgets('strut TextStyle increases height', (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
      ...
      home: const Material(
        child: Center(
          child: SelectableText('something', style: TextStyle(fontSize: 20)),
        ),
      ),
    ));
  ...
  testWidgets('strut basic multi line', (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
      theme: ThemeData(platform: TargetPlatform.android),
      home: const Material(
        child: Center(child: SelectableText('something', maxLines: 6)),
      ),
    ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        const MaterialApp(home: Material(child: SelectableText(testText))),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset selectableTextPos = tester.getCenter(
        find.byType(SelectableText),
      );
      final TestGesture gesture = await tester.startGesture(
        selectableTextPos,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        const MaterialApp(
          home: SelectableText.rich(TextSpan(text: 'Abcd', style: textStyle)),
        ),
      );
