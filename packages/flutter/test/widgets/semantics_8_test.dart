      ...
      child: Semantics(
        ...
        child: Semantics(
          ...
          child: Stack(
            ...
            children: <Widget>[Semantics(checked: true), Semantics(label: 'label', textDirection: TextDirection.ltr)],
          ),
        ),
      ),
    ));
    ...
    await tester.pumpWidget(MergeSemantics(
      child: Semantics(
        ...
        child: Semantics(
          ...
          child: Stack(
            textDirection: TextDirection.ltr,
            children: <Widget>[Semantics(label: 'label', textDirection: TextDirection.ltr), Semantics(checked: true)],
          ),
        ),
      ),
    ));
