...
class TestImageProvider extends ImageProvider<TestImageProvider> {
  ...
  ImageStreamCompleter load(TestImageProvider key, DecoderCallback decode) {
    return OneFrameImageStreamCompleter(future.then<ImageInfo>((void value) => ImageInfo(image: image)));
  }
}
...
Future<void> main() async {
  ...
  testWidgets('DecoratedBox handles loading images', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(KeyedSubtree(
      key: key,
      child:
          DecoratedBox(decoration: BoxDecoration(image: DecorationImage(image: TestImageProvider(completer.future)))),
    ));
  ...
  testWidgets('BoxDecoration paints its border correctly', (WidgetTester tester) async {
    ...
    Widget buildFrame(Border border) {
      return Center(child: Container(key: key, width: 100.0, height: 50.0, decoration: BoxDecoration(border: border)));
    }
    ...
    await tester.pumpWidget(Column(
      children: <Widget>[
        ...
        Container(
          width: 100.0,
          height: 100.0,
          decoration: BoxDecoration(border: Border.all(width: 10.0, color: const Color(0xFFFFFFFF))),
        ),
        Container(
          width: 100.0,
          height: 100.0,
        ...
        Container(
          ...
          height: 100.0,
          decoration:
              BoxDecoration(border: Border.all(width: 10.0, color: const Color(0xFFFFFFFF)), shape: BoxShape.circle),
        ),
      ],
    ));
    expect(
      ...
      paints
        ...
        ..drrect(
          outer: RRect.fromLTRBAndCorners(350.0, 200.0, 450.0, 300.0, topRight: const Radius.circular(10.0)),
    ...
    Widget buildFrame(Border border) {
      ...
      return Center(
        child: GestureDetector(
          ...
          child: Container(key: key, width: 100.0, height: 50.0, decoration: BoxDecoration(border: border)),
          onTap: () {
            itemsTapped.add(1);
          },
        ),
  ...
  testWidgets("BoxDecoration doesn't crash with BorderRadiusDirectional", (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Directionality(
      ...
      child: Container(
        decoration:
            BoxDecoration(border: Border.all(), borderRadius: const BorderRadiusDirectional.all(Radius.circular(1.0))),
      ),
    ));
  });
}
