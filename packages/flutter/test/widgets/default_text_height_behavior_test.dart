...
void main() {
  ...
  testWidgets('DefaultTextHeightBehavior changes propagate to Text', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(const DefaultTextHeightBehavior(textHeightBehavior: behavior1, child: textWidget));

    RichText text = tester.firstWidget(find.byType(RichText));
    expect(text, isNotNull);
    expect(text.textHeightBehavior, behavior1);

    await tester.pumpWidget(const DefaultTextHeightBehavior(textHeightBehavior: behavior2, child: textWidget));
