...
void main() {
  group('InteractiveViewer', () {
    testWidgets('child fits in viewport', (WidgetTester tester) async {
      ...
      final Offset scaleStart2 = Offset(
        childInterior.dx + 10.0,
        childInterior.dy,
      );
      final Offset scaleEnd1 = Offset(
        childInterior.dx - 10.0,
        childInterior.dy,
      );
      final Offset scaleEnd2 = Offset(
        childInterior.dx + 20.0,
        childInterior.dy,
      );
    ...
    testWidgets('child bigger than viewport', (WidgetTester tester) async {
      ...
      final Offset rotateStart2 = Offset(
        childInterior.dx + 10.0,
        childInterior.dy,
      );
      final Offset rotateEnd1 = Offset(
        childInterior.dx + 5.0,
        childInterior.dy + 5.0,
      );
      final Offset rotateEnd2 = Offset(
        childInterior.dx - 5.0,
        childInterior.dy - 5.0,
      );
    ...
    testWidgets('Scaling automatically causes a centering translation', (
      ...
      final Offset sceneFocalPoint = transformationController.toScene(
        viewportFocalPoint,
      );
      gesture = await tester.createGesture();
      ...
      await gesture2.up();
      await tester.pumpAndSettle();
      final Offset newSceneFocalPoint = transformationController.toScene(
        viewportFocalPoint,
      );
      expect(
        newSceneFocalPoint.dx,
        moreOrLessEquals(sceneFocalPoint.dx, epsilon: 1.0),
      );
      expect(
        newSceneFocalPoint.dy,
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final Offset scenePoint = transformationController.toScene(
          localFocalPoint,
        );
    ...
    testWidgets('gesture can start as pan and become scale', (
      ...
      await gesture.moveTo(
        Offset(childCenter.dx + 25.0, childCenter.dy + 25.0),
      );
    ...
    testWidgets(
      'Check if ClipRect is present in the tree',
      (WidgetTester tester) async {
        await tester.pumpWidget(MaterialApp(
          home: Scaffold(
            body: Center(
    ...
    testWidgets('scaleFactor', (WidgetTester tester) async {
      ...
      expect(
        scaleLowZoomedIn - scaleLowZoomedOut,
      ...
      expect(
        scaleHighZoomedIn - scaleHighZoomedOut,
        lessThan(scaleZoomedIn - scaleZoomedOut),
      );
    });

    testWidgets(
      'alignment argument is used properly',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'trackpad pointer scroll events cause scale',
      (WidgetTester tester) async {
        final TransformationController transformationController =
            TransformationController();
        const double boundaryMargin = 50.0;
  ...
  group('getNearestPointOnLine', () {
    test('does not modify parameters', () {
      ...
      final Vector3 closestPoint = InteractiveViewer.getNearestPointOnLine(
        point,
        a,
        b,
      );
  ...
  group('getNearestPointInside', () {
    test('point already inside quad', () {
      ...
      final Vector3 nearestPoint = InteractiveViewer.getNearestPointInside(
        point,
        quad,
      );
