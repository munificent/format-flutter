...
void main() {
  testWidgets('SemanticsNode ids are stable', (WidgetTester tester) async {
    ...
    final SemanticsNode nodeAfterRebuild = tester.getSemantics(
      find.text('Hallo Welt !!!'),
    );
    ...
    final SemanticsNode nodeAfterRemoval = tester.getSemantics(
      find.text('Hallo Welt '),
    );
    ...
    expect(find.text('Hallo Welt !!!'), findsOneWidget);
    final SemanticsNode nodeAfterAddition = tester.getSemantics(
      find.text('Hallo Welt !!!'),
    );
