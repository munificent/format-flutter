...
void main() {
  testWidgets(
    'Widgets running with runApp can find View',
  ...
  testWidgets(
    'Widgets running with pumpWidget can find View',
    (WidgetTester tester) async {
      FlutterView? view;
      FlutterView? viewMaybeOf;
  ...
  testWidgets(
    'cannot find View behind a LookupBoundary',
    (WidgetTester tester) async {
      ...
      expect(() => View.of(context), throwsA(isA<FlutterError>().having(
