...
void main() {
  testWidgets(
    'AnimatedContainer.debugFillProperties',
  ...
  testWidgets(
    'AnimatedContainer overanimate test',
    (WidgetTester tester) async {
      await tester.pumpWidget(AnimatedContainer(
        duration: const Duration(milliseconds: 200),
  ...
  testWidgets(
    'AnimatedContainer sets clipBehavior',
    (WidgetTester tester) async {
      await tester.pumpWidget(AnimatedContainer(
      ...
      expect(
        tester.firstWidget<Container>(find.byType(Container)).clipBehavior,
        Clip.none,
      );
      await tester.pumpWidget(AnimatedContainer(
        decoration: const BoxDecoration(color: Color(0xFFED1D7F)),
