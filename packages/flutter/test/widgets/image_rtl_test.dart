      ...
      Directionality(
        ...
        child: Center(
          child: Container(
            ...
            height: 50.0,
            decoration: BoxDecoration(
              image: DecorationImage(image: TestImageProvider(testImage), alignment: Alignment.centerRight),
            ),
          ),
        ),
      ),
    ...
    await tester.pumpWidget(Directionality(
      ...
      child: Center(
        child: SizedBox(
          width: 100.0,
          height: 50.0,
          child: Image(image: TestImageProvider(testImage), alignment: Alignment.centerRight, matchTextDirection: true),
        ),
      ),
    ));
    expect(
      ...
      Directionality(
        ...
        child: Center(
          child: SizedBox(
            width: 100.0,
            height: 50.0,
            child: Image(image: TestImageProvider(testImage), alignment: Alignment.centerRight),
          ),
        ),
      ),
      Duration.zero,
      ...
      Directionality(
        ...
        child: Center(
          child: SizedBox(
            ...
            height: 50.0,
            child:
                Image(image: TestImageProvider(testImage), alignment: Alignment.centerRight, matchTextDirection: true),
          ),
        ),
      ),
      Duration.zero,
