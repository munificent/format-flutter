...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        buildTest(dismissDirection: DismissDirection.endToStart),
      );
      expect(dismissedItems, isEmpty);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        buildTest(dismissDirection: DismissDirection.startToEnd),
      );
      expect(dismissedItems, isEmpty);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await dismissItem(
        ...
        0,
        mechanism: flingElement,
        gestureDirection: AxisDirection.down,
      );
      expect(find.text('0'), findsOneWidget);
      expect(dismissedItems, isEmpty);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        ...
        findsOneWidget,
      ); // The other four have been culled.
      final RenderBox backgroundBox = tester.firstRenderObject(
        find.text('background'),
      );
  ...
  testWidgets(
    'Checking fling item after movementDuration',
    (WidgetTester tester) async {
      await tester.pumpWidget(buildTest());
      expect(dismissedItems, isEmpty);
  ...
  testWidgets(
    'Horizontal fling less than threshold',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'Vertical fling less than threshold',
    (WidgetTester tester) async {
      await tester.pumpWidget(buildTest());
      expect(dismissedItems, isEmpty);
  ...
  testWidgets(
    'Pending confirmDismiss does not cause errors',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final RenderBox textRenderObjectBegin = tester.renderObject(
        find.text('I Love Flutter!'),
      );

      await tester.pumpWidget(buildFrame(DismissDirection.none));
      final RenderBox textRenderObjectEnd = tester.renderObject(
        find.text('I Love Flutter!'),
      );
