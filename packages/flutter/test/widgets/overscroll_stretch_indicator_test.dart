...
void main() {
        ...
        child: ScrollConfiguration(
          ...
          child: StretchingOverscrollIndicator(
            ...
            child: CustomScrollView(
              ...
              slivers: <Widget>[
                SliverToBoxAdapter(
                  child: Container(color: const Color(0xD0FF0000), key: box1Key, height: boxHeight, width: boxWidth),
                ),
                SliverToBoxAdapter(
                  child: Container(color: const Color(0xFFFFFF00), key: box2Key, height: boxHeight, width: boxWidth),
                ),
                SliverToBoxAdapter(
                  child: Container(color: const Color(0xFF6200EA), key: box3Key, height: boxHeight, width: boxWidth),
                ),
              ],
            ),
          ),
        ...
        child: ScrollConfiguration(
          ...
          child: StretchingOverscrollIndicator(
            ...
            child: CustomScrollView(
              controller: controller,
              slivers: <Widget>[
                SliverToBoxAdapter(child: Container(color: const Color(0xD0FF0000), key: box1Key, height: 250.0)),
                SliverToBoxAdapter(
                  child: Container(color: const Color(0xFFFFFF00), key: box2Key, height: 250.0, width: 300.0),
                ),
              ],
            ),
          ),
  ...
  testWidgets('Stretch overscroll vertically', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(CustomScrollView), matchesGoldenFile('overscroll_stretch.vertical.start.png'));
    ...
    await expectLater(find.byType(CustomScrollView), matchesGoldenFile('overscroll_stretch.vertical.end.png'));
  ...
  testWidgets('Stretch overscroll works in reverse - vertical', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(CustomScrollView), matchesGoldenFile('overscroll_stretch.vertical.reverse.png'));
  });
  ...
  testWidgets('Stretch overscroll works in reverse - horizontal', (WidgetTester tester) async {
    ...
    final GlobalKey box3Key = GlobalKey();
    final ScrollController controller = ScrollController();
    await tester.pumpWidget(buildTest(box1Key, box2Key, box3Key, controller, axis: Axis.horizontal, reverse: true));
    ...
    await expectLater(find.byType(CustomScrollView), matchesGoldenFile('overscroll_stretch.horizontal.reverse.png'));
  });
  ...
  testWidgets('Stretch overscroll horizontally', (WidgetTester tester) async {
    ...
    expect(box2.localToGlobal(Offset.zero), const Offset(300.0, 0.0));
    expect(box3.localToGlobal(Offset.zero), const Offset(600.0, 0.0));
    await expectLater(find.byType(CustomScrollView), matchesGoldenFile('overscroll_stretch.horizontal.start.png'));
    ...
    expect(box2.localToGlobal(Offset.zero).dx, 200.0);
    expect(box3.localToGlobal(Offset.zero).dx, 500.0);
    await expectLater(find.byType(CustomScrollView), matchesGoldenFile('overscroll_stretch.horizontal.end.png'));
  ...
  testWidgets('Stretch overscroll horizontally RTL', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      buildTest(box1Key, box2Key, box3Key, controller, axis: Axis.horizontal, textDirection: TextDirection.rtl),
    );
    ...
    expect(box2.localToGlobal(Offset.zero).dx, lessThan(200.0));
    expect(box3.localToGlobal(Offset.zero).dx, lessThan(-100.0));
    await expectLater(find.byType(CustomScrollView), matchesGoldenFile('overscroll_stretch.horizontal.rtl.png'));
  });
