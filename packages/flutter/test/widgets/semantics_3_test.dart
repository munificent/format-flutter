...
void main() {
  testWidgets('Semantics 3', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Semantics(
      container: true,
      child: Semantics(label: 'test', textDirection: TextDirection.ltr, child: Semantics(checked: true)),
    ));
    ...
    expect(semantics, hasSemantics(TestSemantics.root(
      children: <TestSemantics>[
        TestSemantics.rootChild(id: 1, label: 'test', textDirection: TextDirection.ltr, rect: TestSemantics.fullScreen),
      ],
    )));
    ...
    await tester.pumpWidget(Semantics(
      container: true,
      child: Semantics(checked: true, child: Semantics(label: 'test', textDirection: TextDirection.ltr)),
    ));
