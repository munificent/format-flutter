...
void main() {
  ...
  testWidgets('Nested overscrolls do not throw exceptions', (WidgetTester tester) async {
    await tester.pumpWidget(Directionality(
      ...
      child: PageView(
        children: <Widget>[
          ListView(children: <Widget>[Container(width: 2000.0, height: 2000.0, color: const Color(0xFF00FF00))]),
        ],
      ),
    ));
  ...
  testWidgets('The OverscrollIndicator should not overflow the scrollable view edge', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Directionality(
      ...
      child: NotificationListener<OverscrollIndicatorNotification>(
        ...
        child: const CustomScrollView(slivers: <Widget>[SliverToBoxAdapter(child: SizedBox(height: 2000.0))]),
      ),
    ));
    final RenderObject painter = tester.renderObject(find.byType(CustomPaint));
    await slowDrag(tester, const Offset(200.0, 200.0), const Offset(0.0, 5.0));
...
class TestScrollBehavior1 extends ScrollBehavior {
  ...
  Widget buildOverscrollIndicator(BuildContext context, Widget child, ScrollableDetails details) {
    return GlowingOverscrollIndicator(axisDirection: details.direction, color: const Color(0xFF00FF00), child: child);
  }
}
...
class TestScrollBehavior2 extends ScrollBehavior {
  ...
  @override
  Widget buildOverscrollIndicator(BuildContext context, Widget child, ScrollableDetails details) {
    return GlowingOverscrollIndicator(axisDirection: details.direction, color: const Color(0xFF0000FF), child: child);
  }
}
