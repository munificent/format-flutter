...
void main() {
  ...
  testWidgets('Nested scrollable', (WidgetTester tester) async {
    ...
    final RenderObject outerPainter = tester.renderObject(
      find.byType(CustomPaint).first,
    );
    final RenderObject innerPainter = tester.renderObject(
  ...
  group(
    "Flipping direction of scrollable doesn't change overscroll behavior",
    () {
