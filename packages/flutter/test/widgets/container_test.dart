...
void main() {
  group('Container control tests:', () {
    ...
    group('diagnostics', () {
      testWidgets(
        'has reasonable default diagnostics',
      ...
      testWidgets(
        'has expected debug diagnostics',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            Align(alignment: Alignment.topLeft, child: container),
          );
      ...
      testWidgets(
        'has expected hidden diagnostics',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            Align(alignment: Alignment.topLeft, child: container),
          );
      ...
      testWidgets(
        'painting error has expected diagnostics',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            Align(alignment: Alignment.topLeft, child: container),
          );

          final RenderBox decoratedBox = tester.renderObject(
    ...
    (WidgetTester tester) async {
      final Container container = Container(
        ...
        decoration: const BoxDecoration(
          ...
          color: Colors.red,
          boxShadow: <BoxShadow>[
            BoxShadow(color: Colors.blue, spreadRadius: 10, blurRadius: 20.0),
          ],
        ),
