      ...
      (WidgetTester tester) async {
        ...
        final Widget myApp = MaterialApp(
          ...
          routes: <String, WidgetBuilder>{
            ...
            '/a': (BuildContext context) => const Material(child: Hero(tag: kHeroTag, child: Text('a'))),
            '/b': (BuildContext context) => const Material(
                  child: Padding(padding: EdgeInsets.all(100.0), child: Hero(tag: kHeroTag, child: Text('b'))),
                ),
          },
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final Widget myApp = MaterialApp(
          ...
          initialRoute: '/',
          routes: <String, WidgetBuilder>{
            '/': (BuildContext context) => const Material(child: Hero(tag: kHeroTag, child: Text('home'))),
            '/a': (BuildContext context) => const Material(child: Text('a')),
            '/b': (BuildContext context) => const Material(
                  child: Padding(padding: EdgeInsets.all(100.0), child: Hero(tag: kHeroTag, child: Text('b'))),
                ),
