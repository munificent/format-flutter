...
void main() {
  ...
  testWidgets('OverflowBar horizontal layout', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      buildFrame(spacing: 0, textDirection: TextDirection.ltr),
    );
    expect(
    ...
    // Children are vertically centered, start at x=0
    await tester.pumpWidget(
      buildFrame(spacing: 10, textDirection: TextDirection.ltr),
    );
    expect(
      tester.getRect(find.byKey(child1Key)),
      const Rect.fromLTRB(0, 8, 48, 56),
    ...
    await tester.pumpWidget(
      buildFrame(spacing: 0, textDirection: TextDirection.rtl),
    );
    expect(
      tester.getRect(find.byKey(child3Key)),
    ...
    // Children appear in reverse order for RTL
    await tester.pumpWidget(
      buildFrame(spacing: 10, textDirection: TextDirection.rtl),
    );
    expect(
      tester.getRect(find.byKey(child3Key)),
      const Rect.fromLTRB(0, 16, 32, 48),
  ...
  testWidgets('OverflowBar vertical layout', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      buildFrame(overflowDirection: VerticalDirection.up),
    );
    expect(
      tester.getRect(find.byKey(child3Key)),
    ...
    await tester.pumpWidget(
      buildFrame(overflowAlignment: OverflowBarAlignment.end),
    );
    expect(
      tester.getRect(find.byKey(child1Key)),
    ...
    await tester.pumpWidget(
      buildFrame(overflowAlignment: OverflowBarAlignment.center),
    );
    expect(
      tester.getRect(find.byKey(child1Key)),
  ...
  testWidgets('OverflowBar intrinsic width', (WidgetTester tester) async {
    ...
    expect(
      tester.getSize(find.byType(OverflowBar)).width,
      152,
    ); // 152 = 48 + 4 + 64 + 4 + 32
  ...
  testWidgets('OverflowBar intrinsic height', (WidgetTester tester) async {
    ...
    expect(
      tester.getSize(find.byType(OverflowBar)).height,
      75,
    ); // 75 = max(50, 25, 75)
  ...
  testWidgets('OverflowBar is wider that its intrinsic width', (
    WidgetTester tester,
  ) async {
