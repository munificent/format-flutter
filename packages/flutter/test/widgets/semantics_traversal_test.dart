...
void main() {
  ...
  testTraversal('Semantics traverses horizontally left-to-right', (TraversalTester tester) async {
    await tester.test(
      ...
      children: <String, Rect>{'A': Offset.zero & tenByTen, 'B': const Offset(20.0, 0.0) & tenByTen},
  ...
  testTraversal('Semantics traverses vertically top-to-bottom', (TraversalTester tester) async {
    for (final TextDirection textDirection in TextDirection.values) {
      await tester.test(
        ...
        children: <String, Rect>{'A': Offset.zero & tenByTen, 'B': const Offset(0.0, 20.0) & tenByTen},
        expectedTraversal: 'A B',
      );
    }
  });
  ...
  testTraversal('Semantics traverses vertically overlapping nodes horizontally', (TraversalTester tester) async {
    ...
    await tester.test(textDirection: TextDirection.ltr, children: children, expectedTraversal: 'A B C');

    await tester.test(textDirection: TextDirection.rtl, children: children, expectedTraversal: 'C B A');
  });
