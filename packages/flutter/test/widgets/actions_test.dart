...
void main() {
  group(ActionDispatcher, () {
    testWidgets('ActionDispatcher invokes actions when asked.', (WidgetTester tester) async {
      ...
      final Object? result = dispatcher.invokeAction(TestAction(
  ...
  group(Actions, () {
    ...
    testWidgets('maybeInvoke returns null when no action is found', (WidgetTester tester) async {
      ...
      await tester.pump();
      final Object? result = Actions.maybeInvoke(containerKey.currentContext!, const DoNothingIntent());
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(Actions(
          dispatcher: TestDispatcher1(postInvoke: collect),
          actions: <Type, Action<Intent>>{TestIntent: testAction},
          child: Actions(actions: const <Type, Action<Intent>>{}, child: Container(key: containerKey)),
        ));
          ...
          await tester.pumpWidget(Center(
            child: Actions(
              ...
              child: FocusableActionDetector(
                enabled: enabled,
                focusNode: focusNode,
                shortcuts: const <ShortcutActivator, Intent>{SingleActivator(LogicalKeyboardKey.enter): intent},
                actions: <Type, Action<Intent>>{TestIntent: testAction},
    ...
    testWidgets('FocusableActionDetector changes mouse cursor when hovered', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MouseRegion(
        cursor: SystemMouseCursors.forbidden,
        child: FocusableActionDetector(onShowHoverHighlight: (_) {}, onShowFocusHighlight: (_) {}, child: Container()),
      ));
  ...
  group('Listening', () {
    testWidgets('can listen to enabled state of Actions', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(Actions(
        ...
        child:
            Actions(actions: <Type, Action<TestIntent>>{ThirdTestIntent: action3}, child: Container(key: containerKey)),
      ));
      ...
      await tester.pumpWidget(Actions(
        ...
        child: ActionListener(
          ...
          action: action2,
          child:
              Actions(actions: <Type, Action<Intent>>{ThirdTestIntent: action3}, child: Container(key: containerKey)),
        ),
      ));

      await tester.pump();
      result = Actions.maybeInvoke<TestIntent>(containerKey.currentContext!, const SecondTestIntent());
      ...
      await tester.pumpWidget(Actions(
        ...
        child: Actions(actions: <Type, Action<Intent>>{ThirdTestIntent: action3}, child: Container(key: containerKey)),
      ));
      ...
      await tester.pumpWidget(
        Actions(actions: <Type, Action<Intent>>{TestIntent: action1}, child: Container(key: containerKey)),
      );
  ...
  group(FocusableActionDetector, () {
    ...
    Future<void> pumpTest(
      ...
      await tester.pumpWidget(MediaQuery(
        data: MediaQueryData(navigationMode: directional ? NavigationMode.directional : NavigationMode.traditional),
        child: Center(
          child: Actions(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(MaterialApp(
          home: FocusableActionDetector(
            child: ElevatedButton(onPressed: () {}, focusNode: buttonNode, child: const Text('Test')),
          ),
        ));
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(MaterialApp(
          home: FocusableActionDetector(
            child: Column(
              children: <Widget>[
                ElevatedButton(onPressed: () {}, focusNode: buttonNode1, child: const Text('Node 1')),
                ElevatedButton(onPressed: () {}, focusNode: buttonNode2, child: const Text('Node 2')),
              ],
            ),
          ),
        ));
  ...
  group('Diagnostics', () {
    ...
    testWidgets('default Actions debugFillProperties', (WidgetTester tester) async {
      ...
      Actions(actions: const <Type, Action<Intent>>{}, dispatcher: const ActionDispatcher(), child: Container())
      ...
      expect(description, equalsIgnoringHashCodes(<String>['dispatcher: ActionDispatcher#00000', 'actions: {}']));
    });
  ...
  group('Action overriding', () {
    ...
    testWidgets('Throws on invoking invalid override', (WidgetTester tester) async {
      ...
      expect(exception?.toString(), contains('cannot be handled by an Action of runtime type TestContextAction.'));
    });
    ...
    testWidgets('Overriding Actions can change the intent', (WidgetTester tester) async {
      ...
      Actions.invoke(invokingContext!, LogIntent(log: invocations));
      expect(invocations, <String>['action1.invokeAsOverride-pre-super', 'action1.invokeAsOverride-post-super']);
