...
void main() {
  ...
  testWidgets('Wrap alignment (LTR)', (WidgetTester tester) async {
    ...
    verify(tester, <Offset>[const Offset(95.0, 0.0), const Offset(200.0, 0.0), const Offset(405.0, 0.0)]);
    ...
    expect(tester.renderObject<RenderBox>(find.byType(Wrap)).size, equals(const Size(800.0, 600.0)));
    verify(tester, <Offset>[const Offset(30.0, 0.0), const Offset(195.0, 0.0), const Offset(460.0, 0.0)]);
    ...
    expect(tester.renderObject<RenderBox>(find.byType(Wrap)).size, equals(const Size(800.0, 600.0)));
    verify(tester, <Offset>[const Offset(45.0, 0.0), const Offset(195.0, 0.0), const Offset(445.0, 0.0)]);
  });
  ...
  testWidgets('Wrap alignment (RTL)', (WidgetTester tester) async {
    ...
    expect(tester.renderObject<RenderBox>(find.byType(Wrap)).size, equals(const Size(800.0, 600.0)));
    verify(tester, <Offset>[const Offset(605.0, 0.0), const Offset(400.0, 0.0), const Offset(95.0, 0.0)]);
    ...
    expect(tester.renderObject<RenderBox>(find.byType(Wrap)).size, equals(const Size(800.0, 600.0)));
    verify(tester, <Offset>[const Offset(670.0, 0.0), const Offset(405.0, 0.0), const Offset(30.0, 0.0)]);
    ...
    expect(tester.renderObject<RenderBox>(find.byType(Wrap)).size, equals(const Size(800.0, 600.0)));
    verify(tester, <Offset>[const Offset(655.0, 0.0), const Offset(405.0, 0.0), const Offset(45.0, 0.0)]);
  });
  ...
  testWidgets('Wrap spacing test', (WidgetTester tester) async {
    ...
    verify(tester, <Offset>[Offset.zero, const Offset(0.0, 20.0), const Offset(0.0, 50.0), const Offset(0.0, 90.0)]);
  });
  ...
  testWidgets('Visual overflow generates a clip', (WidgetTester tester) async {
    await tester.pumpWidget(
      const Wrap(textDirection: TextDirection.ltr, children: <Widget>[SizedBox(width: 500.0, height: 500.0)]),
    );
    ...
    await tester.pumpWidget(
      const Wrap(
        ...
        children: <Widget>[SizedBox(width: 500.0, height: 500.0), SizedBox(width: 500.0, height: 500.0)],
      ),
    );
      ...
      const Center(
        child: Baseline(
          ...
          child: DefaultTextStyle(
            ...
            child:
                Wrap(textDirection: TextDirection.ltr, children: <Widget>[Text('X', textDirection: TextDirection.ltr)]),
          ),
        ),
      ),
    );
  ...
  testWidgets('Spacing with slight overflow', (WidgetTester tester) async {
    ...
    expect(tester.renderObject<RenderBox>(find.byType(Wrap)).size, equals(const Size(800.0, 600.0)));
    verify(tester, <Offset>[Offset.zero, const Offset(210.0, 0.0), const Offset(420.0, 0.0), const Offset(0.0, 20.0)]);
  });
      ...
      const Column(
        children: <Widget>[
          Wrap(
            ...
            spacing: 10.0,
            runSpacing: 10.0,
            children: <Widget>[SizedBox(width: 800.0, height: 10.0), SizedBox(width: 800.0, height: 10.0)],
          ),
        ],
      ),
    );
