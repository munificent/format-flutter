...
void main() {
    ...
    await tester.pumpWidget(Directionality(
      ...
      child: ListView(
        ...
        children: const <Widget>[
          ...
          AutomaticKeepAlive(
            child: SizedBox(key: GlobalObjectKey<_LeafState>(2), height: 400.0),
          ),
          AutomaticKeepAlive(
            child: SizedBox(key: GlobalObjectKey<_LeafState>(3), height: 400.0),
          ),
        ],
      ),
    ));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pump();
      expect(find.byKey(
        const GlobalObjectKey<_AlwaysKeepAliveState>(0),
        skipOffstage: false,
      ), findsOneWidget);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        find.text('keep me alive', skipOffstage: false),
        findsNWidgets(23),
      );
      expect(find.text('FooBar 1'), findsNothing);
  ...
  testWidgets(
    'AutomaticKeepAlive with SliverKeepAliveWidget',
    (WidgetTester tester) async {
...
class RenderSliverMultiBoxAdaptorAlt extends RenderSliver
  ...
  RenderSliverMultiBoxAdaptorAlt({RenderSliverBoxChildManager? childManager})
