...
void main() {
  testWidgets(
    'Router state restoration without RouteInformationProvider',
  ...
  testWidgets(
    'Router state restoration with RouteInformationProvider',
    (WidgetTester tester) async {
      final UniqueKey router = UniqueKey();
      _TestRouterDelegate delegate() =>
          tester.widget<Router<Object?>>(find.byKey(router)).routerDelegate
...
class _TestRouterDelegate extends RouterDelegate<String> with ChangeNotifier {
  ...
  Widget build(BuildContext context) {
    return Text(
      'Current config: $currentConfiguration',
  ...
  Widget build(BuildContext context) {
    return RootRestorationScope(
      ...
      child: Router<String>(
        ...
        routeInformationProvider: withInformationProvider
