...
void main() {
  ...
  group('iOS: do not handle delete/backspace events', () {
    ...
    testWidgets('backspace with and without word modifier', (
      ...
      await tester.pumpWidget(buildSpyAboveEditableText(
        editableFocusNode: editable,
        spyFocusNode: spy,
      ));
      editable.requestFocus();
      await tester.pump();
      final ActionSpyState state = tester.state<ActionSpyState>(
        find.byType(ActionSpy),
      );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        for (int keyState = 0; keyState < 1 << 2; keyState += 1) {
          ...
          final SingleActivator activator = SingleActivator(
            key,
            meta: true,
            shift: shift,
          );
