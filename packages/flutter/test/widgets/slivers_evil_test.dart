...
class TestScrollPhysics extends ClampingScrollPhysics {
  ...
  @override
  Tolerance toleranceFor(ScrollMetrics metrics) => const Tolerance(
    velocity: 20.0,
    distance: 1.0,
  );
}
...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        tester.getBottomLeft(find.widgetWithText(ColoredBox, '10')).dy,
        600.0,
      );
      ...
      expect(
        tester.getBottomLeft(find.widgetWithText(ColoredBox, '9')).dy,
        600.0,
      );
    },
  );
