              ...
              Positioned(
                ...
                child: const RawMagnifier(
                  ...
                  decoration: MagnifierDecoration(
                    shadows: <BoxShadow>[
                      BoxShadow(spreadRadius: 10, blurRadius: 10, color: Colors.green, offset: Offset(5, 5)),
                    ],
                  ),
                ),
              ),
    ...
    group('transition states', () {
      ...
      testWidgets('should immediately remove from overlay on no animation controller', (WidgetTester tester) async {
        await runFakeAsync((FakeAsync async) async {
          ...
          magnifierController.show(context: context, builder: (BuildContext context) => testMagnifier);
