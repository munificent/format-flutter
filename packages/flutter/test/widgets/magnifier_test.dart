    ...
    group('transition states', () {
      ...
      testWidgets('should update shown based on animation status', (
        ...
        await runFakeAsync((FakeAsync async) async {
          ...
          expect(
            magnifierController.animationController?.status,
  ...
  group('magnifier controller', () {
    ...
    group('show', () {
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          final OverlayEntry fakeBeforeOverlayEntry = OverlayEntry(
            builder: (_) => fakeBefore,
          );
          ...
          final Iterable<Element> allOverlayChildren = find.descendant(
    ...
    group('shift within bounds', () {
      ...
      for (int i = 0; i < boundsRects.length; i++) {
        test(
          'should shift ${inputRects[i]} to ${outputRects[
            i
          ]} for bounds ${boundsRects[i]}',
          () {
