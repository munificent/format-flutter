...
void main() {
  testWidgets('ListView control test', (WidgetTester tester) async {
    ...
    expect(
      tester.getCenter(find.text('Massachusetts')),
  ...
  testWidgets('ListView dismiss keyboard onDrag test', (
    WidgetTester tester,
  ) async {
    final List<FocusNode> focusNodes = List<FocusNode>.generate(
      50,
      (int i) => FocusNode(),
    );
  ...
  testWidgets('GridView.builder supports null items', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(textFieldBoilerplate(
      child: GridView.builder(
        gridDelegate:
            const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 42),
        itemCount: 42,
  ...
  testWidgets(
    'ListView.builder supports null items',
  ...
  testWidgets(
    'PageView supports null items in itemBuilder',
    (WidgetTester tester) async {
      await tester.pumpWidget(textFieldBoilerplate(
  ...
  testWidgets('ListView.builder dismiss keyboard onDrag test', (
    WidgetTester tester,
  ) async {
    final List<FocusNode> focusNodes = List<FocusNode>.generate(
      50,
  ...
  testWidgets('ListView.custom dismiss keyboard onDrag test', (
    WidgetTester tester,
  ) async {
    final List<FocusNode> focusNodes = List<FocusNode>.generate(
      50,
  ...
  testWidgets('ListView.separated dismiss keyboard onDrag test', (
    WidgetTester tester,
  ) async {
    final List<FocusNode> focusNodes = List<FocusNode>.generate(
      50,
  ...
  testWidgets('GridView dismiss keyboard onDrag test', (
    WidgetTester tester,
  ) async {
    final List<FocusNode> focusNodes = List<FocusNode>.generate(
      50,
  ...
  testWidgets('GridView.builder dismiss keyboard onDrag test', (
    WidgetTester tester,
  ) async {
    final List<FocusNode> focusNodes = List<FocusNode>.generate(
      50,
  ...
  testWidgets('GridView.count dismiss keyboard onDrag test', (
    WidgetTester tester,
  ) async {
    final List<FocusNode> focusNodes = List<FocusNode>.generate(
      50,
  ...
  testWidgets('GridView.extent dismiss keyboard onDrag test', (
    WidgetTester tester,
  ) async {
    final List<FocusNode> focusNodes = List<FocusNode>.generate(
      50,
  ...
  testWidgets('GridView.custom dismiss keyboard onDrag test', (
    WidgetTester tester,
  ) async {
    final List<FocusNode> focusNodes = List<FocusNode>.generate(
      50,
  ...
  testWidgets('ListView dismiss keyboard manual test', (
    WidgetTester tester,
  ) async {
    final List<FocusNode> focusNodes = List<FocusNode>.generate(
      50,
  ...
  testWidgets('ListView.builder dismiss keyboard manual test', (
    WidgetTester tester,
  ) async {
    final List<FocusNode> focusNodes = List<FocusNode>.generate(
      50,
  ...
  testWidgets('ListView.custom dismiss keyboard manual test', (
    WidgetTester tester,
  ) async {
    final List<FocusNode> focusNodes = List<FocusNode>.generate(
      50,
  ...
  testWidgets('ListView.separated dismiss keyboard manual test', (
    WidgetTester tester,
  ) async {
    final List<FocusNode> focusNodes = List<FocusNode>.generate(
      50,
  ...
  testWidgets('GridView dismiss keyboard manual test', (
    WidgetTester tester,
  ) async {
    final List<FocusNode> focusNodes = List<FocusNode>.generate(
      50,
  ...
  testWidgets('GridView.builder dismiss keyboard manual test', (
    WidgetTester tester,
  ) async {
    final List<FocusNode> focusNodes = List<FocusNode>.generate(
      50,
  ...
  testWidgets('GridView.count dismiss keyboard manual test', (
    WidgetTester tester,
  ) async {
    final List<FocusNode> focusNodes = List<FocusNode>.generate(
      50,
  ...
  testWidgets('GridView.extent dismiss keyboard manual test', (
    WidgetTester tester,
  ) async {
    final List<FocusNode> focusNodes = List<FocusNode>.generate(
      50,
  ...
  testWidgets('GridView.custom dismiss keyboard manual test', (
    WidgetTester tester,
  ) async {
    final List<FocusNode> focusNodes = List<FocusNode>.generate(
      50,
  ...
  testWidgets('GridViews with controllers are non-primary by default', (
    WidgetTester tester,
  ) async {
    final ScrollController controller = ScrollController();
    await tester.pumpWidget(primaryScrollControllerBoilerplate(
      child: GridView.count(controller: ScrollController(), crossAxisCount: 1),
      controller: controller,
    ));
    expect(controller.hasClients, isFalse);
  });
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Scrollable innerScrollable = tester.widget(find.descendant(
  ...
  testWidgets('primary:false leads to no scrolling', (
    WidgetTester tester,
  ) async {
    bool scrolled = false;
    await tester.pumpWidget(Directionality(
  ...
  testWidgets(
    'separatorBuilder must return something',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'when itemBuilder throws, creates Error Widget',
    (WidgetTester tester) async {
      const List<String> listOfValues = <String>[
        'ALPHA',
        'BETA',
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      expect(
        () => ListView(itemExtent: 100, prototypeItem: const SizedBox()),
          ...
          slivers: List<Widget>.generate(20, (int index) {
            return SliverToBoxAdapter(
              child: Focus(
                autofocus: index == 0,
                child:
                    SizedBox(key: ValueKey<String>('Box $index'), height: 50.0),
              ),
            );
          }),
        ),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
        home: Row(children: <Widget>[getScrollView(), getScrollView()]),
      ));
      await tester.pumpAndSettle();
      expect(
        tester.getRect(
          find.byKey(
            const ValueKey<String>('Box 0'),
            skipOffstage: false,
          ).first,
        ),
