...
void main() {
  group(LogicalKeySet, () {
    test('LogicalKeySet passes parameters correctly.', () {
      ...
      final LogicalKeySet setFromSet = LogicalKeySet.fromSet(
        <LogicalKeyboardKey>{
          LogicalKeyboardKey.keyA,
          LogicalKeyboardKey.keyB,
          LogicalKeyboardKey.keyC,
      ...
      expect(set2.keys, equals(<LogicalKeyboardKey>{
        LogicalKeyboardKey.keyA,
        LogicalKeyboardKey.keyB,
      }));
      expect(set3.keys, equals(<LogicalKeyboardKey>{
        LogicalKeyboardKey.keyA,
        LogicalKeyboardKey.keyB,
        LogicalKeyboardKey.keyC,
      }));
    ...
    testWidgets('isActivatedBy works as expected', (WidgetTester tester) async {
      ...
      final LogicalKeySet set = LogicalKeySet(
        LogicalKeyboardKey.keyA,
  ...
  group(SingleActivator, () {
    ...
    testWidgets('isActivatedBy works as expected', (WidgetTester tester) async {
      ...
      await tester.sendKeyUpEvent(LogicalKeyboardKey.keyA);
      expect(
        ShortcutActivator.isActivatedBy(singleActivator, events[1]),
        isTrue,
      );
      await tester.sendKeyUpEvent(LogicalKeyboardKey.controlLeft);
      expect(
    ...
    group('diagnostics.', () {
      test('single key', () {
        ...
        const SingleActivator(LogicalKeyboardKey.keyA).debugFillProperties(
          builder,
        );
  ...
  group(Shortcuts, () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final Shortcuts shortcuts = Shortcuts.manager(
          manager: manager,
          child: const SizedBox(),
        );
        await tester.pumpWidget(shortcuts);
    ...
    testWidgets('Shortcuts.manager passes on shortcuts', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets(
      'ShortcutManager handles shortcuts',
      (WidgetTester tester) async {
    ...
    test('Shortcuts diagnostics work.', () {
      ...
      Shortcuts(
        shortcuts: <LogicalKeySet, Intent>{
          LogicalKeySet(LogicalKeyboardKey.shift, LogicalKeyboardKey.keyA):
    ...
    test('Shortcuts diagnostics work when manager specified.', () {
      ...
      Shortcuts.manager(manager: testManager, child: const SizedBox())
          .debugFillProperties(builder);
      ...
      expect(description[1], equalsIgnoringHashCodes(
        'shortcuts: {{Key A + Key B}: ActivateIntent#00000}',
      ));
    });
  ...
  group('CharacterActivator', () {
    ...
    testWidgets('rejects repeated events if requested', (
      WidgetTester tester,
    ) async {
      int invoked = 0;
      await tester.pumpWidget(activatorTester(
    ...
    testWidgets('isActivatedBy works as expected', (WidgetTester tester) async {
      ...
      await tester.sendKeyUpEvent(LogicalKeyboardKey.keyA);
      expect(
        ShortcutActivator.isActivatedBy(characterActivator, events[0]),
        isTrue,
      );
    });
    ...
    group('diagnostics.', () {
      ...
      test('combination', () {
        ...
        const CharacterActivator('A', control: true, meta: true)
            .debugFillProperties(builder);
  ...
  group('ShortcutRegistrar', () {
    testWidgets(
      'trigger ShortcutRegistrar on key events',
      (WidgetTester tester) async {
        int invokedA = 0;
        int invokedB = 0;
    ...
    testWidgets(
      'MaterialApp has a ShortcutRegistrar listening',
      (WidgetTester tester) async {
        int invokedA = 0;
        int invokedB = 0;
        await tester.pumpWidget(MaterialApp(
    ...
    testWidgets(
      "doesn't override text field shortcuts",
      (WidgetTester tester) async {
    ...
    testWidgets('using a disposed token asserts', (WidgetTester tester) async {
      ...
      final ShortcutRegistryEntry token = registry.addAll(const <
        ShortcutActivator,
        Intent
    ...
    testWidgets(
      'setting duplicate bindings asserts',
      (WidgetTester tester) async {
        final ShortcutRegistry registry = ShortcutRegistry();
        final ShortcutRegistryEntry token = registry.addAll(const <
          ShortcutActivator,
        ...
        >{SingleActivator(LogicalKeyboardKey.keyA): DoNothingIntent()});
        expect(() {
          final ShortcutRegistryEntry token2 = registry.addAll(const <
            ShortcutActivator,
            Intent
