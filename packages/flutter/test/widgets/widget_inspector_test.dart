...
class ClockDemo extends StatelessWidget {
  ...
  Widget makeClock(String label, int utcOffset) {
    return Stack(children: <Widget>[const Icon(Icons.watch), Text(label), ClockText(utcOffset: utcOffset)]);
  }
}
...
class _TestWidgetInspectorService extends TestWidgetInspectorService {
  ...
  static void runTests() {
    ...
    testWidgets('WidgetInspector offstage', (WidgetTester tester) async {
        ...
        child: WidgetInspector(
          ...
          child: Overlay(
            initialEntries: <OverlayEntry>[
              OverlayEntry(maintainState: true, builder: (BuildContext _) => createSubtree(width: 94.0)),
              OverlayEntry(opaque: true, maintainState: true, builder: (BuildContext _) => createSubtree(width: 95.0)),
              OverlayEntry(
                maintainState: true,
      ...
      // ignore: avoid_dynamic_calls
      expect(
        inspectorState.selection.candidates.where((RenderObject object) => object is RenderParagraph).length,
        equals(2),
      );
    });
          ...
          child: Transform(
            ...
            child: Directionality(
              ...
              child: WidgetInspector(
                ...
                child: ColoredBox(
                  color: Colors.white,
                  child: Center(child: Container(key: childKey, height: 100.0, width: 50.0, color: Colors.red)),
                ),
              ),
            ),
          ),
    ...
    testWidgets('WidgetInspectorService defunct selection regression test', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(const SizedBox(child: Text('b', textDirection: TextDirection.ltr)));
      ...
      expect(elementA.toDiagnosticsNode().toJsonMap(
    ...
    testWidgets(
      'WidgetInspectorService creationLocation',
      (WidgetTester tester) async {
        await tester.pumpWidget(Directionality(
          textDirection: TextDirection.ltr,
          child:
              Stack(children: <Widget>[const Text('a'), const Text('b', textDirection: TextDirection.ltr), 'c'.text()]),
        ));
        final Element elementA = find.text('a').evaluate().first;
        final Element elementB = find.text('b').evaluate().first;
    ...
    group('pubRootDirectory', () {
      ...
      group('addPubRootDirectories', () {
        ...
        test('handles duplicates', () async {
          const List<String> directories = <String>[directoryA, 'file://$directoryA', directoryB, directoryB];
          service.addPubRootDirectories(directories);
      ...
      group('removePubRootDirectories', () {
        ...
        test('handles duplicates', () async {
          service.removePubRootDirectories(<String>['file://$directoryA', directoryA, directoryB, directoryB]);
    ...
    group(
      ...
      () {
        ...
        group('addPubRootDirectories', () {
          ...
          testWidgets('does not have createdByLocalProject when thePubRootDirectory has a different suffix', (
            WidgetTester tester,
          ) async {
            const Widget widget = Directionality(
              textDirection: TextDirection.ltr,
        ...
        group('createdByLocalProject', () {
          ...
          testWidgets('reacts to add and removing pubRootDirectories', (WidgetTester tester) async {
            ...
            service.addPubRootDirectories(<String>[pubRootTest, 'file://$pubRootTest', '/unrelated/$pubRootTest']);
          ...
          testWidgets('does not match when the package directory does not match', (WidgetTester tester) async {
            const Widget widget = Directionality(
              textDirection: TextDirection.ltr,
              child: Stack(
                children: <Widget>[
          ...
          testWidgets('can handle removing an unrelated pubRootDirectory', (WidgetTester tester) async {
            const Widget widget = Directionality(
              textDirection: TextDirection.ltr,
              child: Stack(
                children: <Widget>[
          ...
          testWidgets('can handle parent widget being part of a separate package', (WidgetTester tester) async {
            const Widget widget = Directionality(
              textDirection: TextDirection.ltr,
              child: Stack(
                children: <Widget>[
    ...
    test('ext.flutter.inspector.disposeGroup', () async {
      ...
      expect(service.toId(a, group3), equals(aId));
      await service
          .testExtension(WidgetInspectorServiceExtensions.disposeGroup.name, <String, String>{'objectGroup': group1});
      await service
          .testExtension(WidgetInspectorServiceExtensions.disposeGroup.name, <String, String>{'objectGroup': group2});
      expect(service.toObject(aId), equals(a));
      await service
          .testExtension(WidgetInspectorServiceExtensions.disposeGroup.name, <String, String>{'objectGroup': group3});
      expect(() => service.toObject(aId), throwsFlutterError);
    });
    ...
    testWidgets('ext.flutter.inspector.setSelection', (WidgetTester tester) async {
      ...
      await service.testExtension(WidgetInspectorServiceExtensions.setSelectionById.name, <String, String>{
    ...
    testWidgets(
      'ext.flutter.inspector.getRootWidgetSummaryTree on $DiagnosticsNode',
      (WidgetTester tester) async {
        ...
        service.resetPubRootDirectories();
        await service.testExtension(WidgetInspectorServiceExtensions.addPubRootDirectories.name, <String, String>{
          'arg0': pubRootTest,
        });
    ...
    testWidgets(
      'ext.flutter.inspector.getRootWidgetSummaryTree on $Diagnosticable',
      (WidgetTester tester) async {
        const String group = 'test-group';
      ...
      () {
        ...
        testWidgets(
          ...
          (WidgetTester tester) async {
            ...
            expect(
              await service.testExtension(WidgetInspectorServiceExtensions.getSelectedWidget.name, <String, String>{
                'objectGroup': 'my-group',
              }),
        ...
        testWidgets('widget is part of core framework and is the child of a widget in the package pubRootDirectories', (
          WidgetTester tester,
        ) async {
          await tester.pumpWidget(
            const Directionality(
    ...
    group(
      ...
      () {
        ...
        testWidgets('reacts to add and removing pubRootDirectories', (WidgetTester tester) async {
          ...
          await service.testExtension(WidgetInspectorServiceExtensions.removePubRootDirectories.name, <String, String>{
            'arg0': pubRootTest,
          });
          service.setSelection(elementA, 'my-group');
          expect(
        ...
        testWidgets('does not match when the package directory does not match', (WidgetTester tester) async {
          ...
          service.testExtension(WidgetInspectorServiceExtensions.addPubRootDirectories.name, <String, String>{
            'arg0': '$pubRootTest/different',
        ...
        testWidgets('can handle removing an unrelated pubRootDirectory', (WidgetTester tester) async {
          ...
          service.testExtension(WidgetInspectorServiceExtensions.removePubRootDirectories.name, <String, String>{
            'arg0': '/invalid/$pubRootTest',
          });
          expect(
            await service.testExtension(WidgetInspectorServiceExtensions.getSelectedWidget.name, <String, String>{
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        final Widget widget = Directionality(
          textDirection: TextDirection.ltr,
          child: WidgetInspector(selectButtonBuilder: null, child: _applyConstructor(_TrivialWidget.new)),
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final List<Map<Object, Object?>> rebuildEvents = service.dispatchedEvents('Flutter.RebuiltWidgets');
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final List<Map<Object, Object?>> repaintEvents = service.dispatchedEvents('Flutter.RepaintWidgets');
        expect(repaintEvents, isEmpty);

        expect(service.rebuildCount, equals(0));
        expect(
          await service.testBoolExtension(WidgetInspectorServiceExtensions.trackRepaintWidgets.name, <String, String>{
            'enabled': 'true',
          }),
          equals('true'),
        );
    ...
    testWidgets('ext.flutter.inspector.show', (WidgetTester tester) async {
      final Iterable<Map<Object, Object?>> extensionChangedEvents = service.getServiceExtensionStateChangedEvents(
      ...
      expect(
        await service
            .testBoolExtension(WidgetInspectorServiceExtensions.show.name, <String, String>{'enabled': 'true'}),
        equals('true'),
      );
      ...
      expect(service.rebuildCount, equals(1));
      expect(
        await service.testBoolExtension(WidgetInspectorServiceExtensions.show.name, <String, String>{}),
        equals('true'),
      );
      ...
      expect(
        await service
            .testBoolExtension(WidgetInspectorServiceExtensions.show.name, <String, String>{'enabled': 'false'}),
        equals('false'),
      );
    ...
    testWidgets('ext.flutter.inspector.screenshot', (WidgetTester tester) async {
                    ...
                    child: ColoredBox(
                      ...
                      child: ColoredBox(
                        ...
                        child: RepaintBoundary(
                          child: Center(child: Container(color: Colors.black, height: 10.0, width: 10.0)),
                        ),
                      ),
                    ),
                  ),
      ...
      // was handled.
      await expectLater(
        layer.toImage(renderObject.semanticBounds.inflate(50.0), pixelRatio: 0.5),
        matchesGoldenFile('inspector.repaint_boundary_margin_small.png'),
      );

      await expectLater(
        layer.toImage(renderObject.semanticBounds.inflate(50.0), pixelRatio: 2.0),
      ...
      await expectLater(
        service.screenshot(repaintBoundary, width: 300.0, height: 300.0),
      ...
      await expectLater(
        service.screenshot(repaintBoundary, width: 500.0, height: 500.0, margin: 50.0),
        matchesGoldenFile('inspector.repaint_boundary_margin.png'),
      );
      ...
      await expectLater(
        service.screenshot(repaintBoundary, width: 300.0, height: 300.0, debugPaint: true),
      ...
      // Full size image
      await expectLater(
        service.screenshot(find.byKey(outerContainerKey).evaluate().single, width: 100.0, height: 100.0),
...

      {
        ...
        final RenderObject container = find.byKey(outerContainerKey).evaluate().single.renderObject!;
        container
          ..markNeedsLayout()
          ..markNeedsPaint();
      ...
      // Small image
      await expectLater(
        service.screenshot(find.byKey(outerContainerKey).evaluate().single, width: 50.0, height: 100.0),
      ...
      // debug paint.
      await expectLater(
        service.screenshot(find.byType(ClipRRect).evaluate().single, width: 100.0, height: 100.0, debugPaint: true),
      ...
      await expectLater(clipRectScreenshot, matchesGoldenFile('inspector.clipRect_debugPaint_margin.png'));
      ...
      await expectLater(screenshotImage, matchesReferenceImage((await clipRectScreenshot)!));

      // Test with a very visible debug paint
      await expectLater(
        service.screenshot(find.byKey(paddingKey).evaluate().single, width: 300.0, height: 300.0, debugPaint: true),
        matchesGoldenFile('inspector.padding_debugPaint.png'),
      );

      // The bounds for this box crop its rendered content.
      await expectLater(
        service.screenshot(find.byKey(sizedBoxKey).evaluate().single, width: 300.0, height: 300.0, debugPaint: true),
    ...
    group('layout explorer', () {
      ...
      Future<void> pumpWidgetForLayoutExplorer(WidgetTester tester) async {
        const Widget widget = Directionality(
          ...
          child: Center(
            child:
                Row(children: <Widget>[Flexible(child: ColoredBox(color: Colors.green, child: Text('a'))), Text('b')]),
          ),
        );
        await tester.pumpWidget(widget);
      }
        ...
        (WidgetTester tester) async {
          ...
          await tester.pumpWidget(CupertinoApp(
            home: CupertinoPageScaffold(
              child: Builder(
                builder:
                    (BuildContext context) => ColoredBox(key: leafKey, color: CupertinoTheme.of(context).primaryColor),
              ),
            ),
          ));
          ...
          Object? error;
          try {
            await service.testExtension(WidgetInspectorServiceExtensions.getLayoutExplorerNode.name, <String, String>{
              'id': id,
              'groupName': group,
              'subtreeDepth': '1',
            });
    ...
    test('ext.flutter.inspector.structuredErrors', () async {
      ...
      try {
        ...
        expect(
          await service.testBoolExtension(WidgetInspectorServiceExtensions.structuredErrors.name, <String, String>{
            'enabled': 'true',
          }),
          equals('true'),
        );
        ...
        expect(error['renderedErrorText'], startsWith('══╡ EXCEPTION CAUGHT BY RENDERING LIBRARY ╞════════════'));
    ...
    testWidgets('Screenshot of composited transforms - only offsets', (WidgetTester tester) async {
                ...
                child: Stack(
                  ...
                  children: <Widget>[
                    ...
                    CompositedTransformFollower(
                      link: link,
                      child:
                          Container(key: key, height: 10.0, width: 10.0, color: const Color.fromARGB(128, 0, 255, 0)),
                    ),
                  ],
                ),
              ),
      ...
      await expectLater(find.byKey(mainStackKey), matchesGoldenFile('inspector.composited_transform.only_offsets.png'));
                ...
                Positioned(
                  ...
                  child: Transform.rotate(
                    ...
                    child: CompositedTransformTarget(
                      link: link,
                      child:
                          Container(key: key1, height: 20.0, width: 20.0, color: const Color.fromARGB(128, 255, 0, 0)),
                    ),
                  ),
                ),
              ],
                ...
                children: <Widget>[
                  ...
                  Transform.rotate(
                    ...
                    child: CompositedTransformFollower(
                      link: link,
                      child:
                          Container(key: key2, height: 10.0, width: 10.0, color: const Color.fromARGB(128, 0, 255, 0)),
                    ),
                  ),
                ],
              ),
    ...
    testWidgets(
      'getChildrenDetailsSubtree with $DiagnosticsNode',
      (WidgetTester tester) async {
        // TODO(polina-c): delete this test once getChildrenDetailsSubtree stops accepting DiagnosticsNode.
        // https://github.com/flutter/devtools/issues/3951
    ...
    testWidgets(
      'getChildrenDetailsSubtree with $Diagnosticable',
      (WidgetTester tester) async {
        await tester.pumpWidget(MaterialApp(
          title: 'Hello, World',
          theme: ThemeData(primarySwatch: Colors.blue),
...
void _addToKnownLocationsMap({
  ...
  newLocations.forEach((String file, Map<String, List<Object?>> entries) {
    ...
    for (int i = 0; i < ids.length; i++) {
      final int id = ids[i];
      knownLocations[id] = _CreationLocation(id: id, file: file, line: lines[i], column: columns[i], name: names[i]);
    }
  });
}
...
extension WidgetInspectorServiceExtension on WidgetInspectorService {
  Future<List<String>> get currentPubRootDirectories async {
    return ((await pubRootDirectories(<String, String>{}))['result'] as List<Object?>).cast<String>();
  }
}
