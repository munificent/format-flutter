...
class _TestWidgetInspectorService extends TestWidgetInspectorService {
  ...
  static void runTests() {
    ...
    test('objectToDiagnosticsNode returns null for non-diagnosticable', () {
      expect(
        WidgetInspectorService.objectToDiagnosticsNode(Alignment.bottomCenter),
        isNull,
      );
    });
    ...
    testWidgets('WidgetInspector interaction test', (
      ...
      expect(
        getInspectorState().selection.current,
        isNull,
      ...
      final InspectorSelection selection =
          getInspectorState().selection as InspectorSelection;
      expect(
        paragraphText(selection.current! as RenderParagraph),
        equals('TOP'),
      );
      ...
      // ignore: avoid_dynamic_calls
      expect(
        paragraphText(getInspectorState().selection.current as RenderParagraph),
        equals('TOP'),
      );
    ...
    testWidgets('WidgetInspector offstage', (WidgetTester tester) async {
        ...
        child: WidgetInspector(
          ...
          child: Overlay(
            initialEntries: <OverlayEntry>[
              ...
              OverlayEntry(
                maintainState: true,
                builder: (BuildContext _) => createSubtree(
                      width: 96.0,
                      key: clickTarget,
                    ),
              ),
      ...
      // ignore: avoid_dynamic_calls
      expect(
        inspectorState.selection.current.semanticBounds.width,
        equals(95.0),
      );
      ...
      // ignore: avoid_dynamic_calls
      expect(
        inspectorState.selection.candidates.where(
          (RenderObject object) => object is RenderParagraph,
        ).length,
        equals(2),
      );
    });
    ...
    test('WidgetInspectorService toObjectForSourceLocation', () {
      ...
      expect(
        () => service.toObjectForSourceLocation(elementId),
        throwsFlutterError,
      );
    });
      ...
      (WidgetTester tester) async {
        await tester.pumpWidget(
          const Directionality(
            textDirection: TextDirection.ltr,
            child: Stack(
              children: <Widget>[Text('a', textDirection: TextDirection.ltr)],
            ),
          ),
        );
        final Element elementA = find.text('a').evaluate().first;
    ...
    testWidgets('WidgetInspectorService getParentChain', (
      ...
      for (int i = 0; i < expectedChain.length; i += 1) {
        ...
        expect(
          service.toObject(jsonNode['valueId']! as String),
          equals(element),
        );
        expect(
          service.toObject(jsonNode['objectId']! as String),
          isA<DiagnosticsNode>(),
        );
        ...
        for (int j = 0; j < childrenElements.length; j += 1) {
          ...
          expect(
            service.toObject(childJson['objectId']! as String),
            isA<DiagnosticsNode>(),
          );
        }
      }
    ...
    test('WidgetInspectorService getProperties for $DiagnosticsNode', () {
      ...
      final DiagnosticsNode diagnostic =
          const Text('a', textDirection: TextDirection.ltr).toDiagnosticsNode();
      ...
      for (int i = 0; i < propertiesJson.length; ++i) {
        ...
        expect(
          service.toObject(propertyJson['objectId']! as String),
          isA<DiagnosticsNode>(),
        );
      }
    });
    ...
    test('WidgetInspectorService getProperties for $Diagnosticable', () {
      const Diagnosticable diagnosticable = Text(
        'a',
        textDirection: TextDirection.ltr,
      );
      const String group = 'group';
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final Map<String, Object?> jsonA = json.decode(
        ...
        final Map<String, Object?> jsonB = json.decode(
          service.getSelectedWidget(null, 'my-group'),
        ) as Map<String, Object?>;
        ...
        final Map<String, Object?> jsonC = json.decode(
          service.getSelectedWidget(null, 'my-group'),
        ) as Map<String, Object?>;
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final List<Map<Object, Object?>> navigateEventsPosted = service
            .dispatchedEvents('navigate', stream: 'ToolEvent');
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          objectsInspected,
          equals(<RenderObject?>[elementA.renderObject]),
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          objectsInspected,
          equals(<RenderObject?>[childElement.renderObject]),
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        if (widgetTracked) {
          ...
          expect(node.valueToString().startsWith(
    ...
    group('pubRootDirectory', () {
      ...
      group('removePubRootDirectories', () {
        ...
        test("does nothing if the directories doesn't exist ", () async {
          ...
          expect(
            pubRoots,
            unorderedEquals(<String>[directoryA, directoryB, directoryC]),
          );
        });
      });
    });
        ...
        group('addPubRootDirectories', () {
          ...
          testWidgets(
            ...
            (WidgetTester tester) async {
              ...
              final String pubRootFramework = '/${pathSegmentsFramework.take(
                pathSegmentsFramework.length - 3,
              ).join('/')}';
              service.resetPubRootDirectories();
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        for (int i = 0; i < childrenJson.length; ++i) {
          ...
          final DiagnosticsNode diagnosticsNode = service.toObject(
            childJson['objectId']! as String,
          )! as DiagnosticsNode;
          ...
          for (final Map<String, Object?> propertyJson
            ...
            final Object? property = service.toObject(
              propertyJson['objectId']! as String,
            );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        // cycle.
        expect(
          nestedRelatedProperty['description'],
          equals('CyclicDiagnostic-a'),
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        // included.
        final Object? rootWidget = service.toObject(
          rootJson['valueId']! as String,
        );
        ...
        List<Object?> alternateChildrenJson = (await service.testExtension(
          ...
          <String, String>{
            'arg': rootJson['objectId']! as String,
            'objectGroup': group,
          },
        ))! as List<Object?>;
        ...
        alternateChildrenJson = (await service.testExtension(
          WidgetInspectorServiceExtensions.getChildrenSummaryTree.name,
          <String, String>{
            'arg': childJson['objectId']! as String,
            'objectGroup': group,
          },
        ))! as List<Object?>;
        expect(alternateChildrenJson.length, equals(1));
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          service.toObject(summarySelection['valueId']! as String),
          elementA,
        );

        // Verify tha the regular getSelectedWidget method still returns
        // the RichText object not the Text element.
        final Map<String, Object?> regularSelection = (await service
            .testExtension(
              WidgetInspectorServiceExtensions.getSelectedWidget.name,
              <String, String>{'objectGroup': 'my-group'},
            ))! as Map<String, Object?>;
      ...
      () {
        ...
        testWidgets(
          ...
          (WidgetTester tester) async {
            ...
            final Map<String, Object?> jsonObject = (await service
                .testExtension(
                  WidgetInspectorServiceExtensions.getSelectedWidget.name,
                  <String, String>{'objectGroup': 'my-group'},
                ))! as Map<String, Object?>;
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final Element clockDemoElement =
            find.byType(ClockDemo).evaluate().first;
        ...
        final List<Map<Object, Object?>> rebuildEvents = service
            .dispatchedEvents('Flutter.RebuiltWidgets');
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final List<Map<Object, Object?>> repaintEvents = service
            .dispatchedEvents('Flutter.RepaintWidgets');
    ...
    group('layout explorer', () {
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          final Element flexibleElement = tester.element(
            find.byType(Flexible).first,
          );
          service.setSelection(flexibleElement, group);

          final DiagnosticsNode diagnostic =
              flexibleElement.toDiagnosticsNode();
          final String id = service.toId(diagnostic, group)!;
          final Map<String, Object?> result = (await service.testExtension(
            WidgetInspectorServiceExtensions.getLayoutExplorerNode.name,
            <String, String>{'id': id, 'groupName': group, 'subtreeDepth': '1'},
      ...
      testWidgets(
        'ext.flutter.inspector.getLayoutExplorerNode for RenderView',
        (WidgetTester tester) async {
          await pumpWidgetForLayoutExplorer(tester);
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          final Element childElement = tester.element(
            find.byType(Flexible).first,
          );
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          Map<String, Object?> mainAxisAlignmentProperties = properties
              .firstWhere(
                (Map<String, Object?> p) =>
                    p['type'] == 'EnumProperty<MainAxisAlignment>',
              );
          Map<String, Object?> crossAxisAlignmentProperties = properties
              .firstWhere(
                (Map<String, Object?> p) =>
    ...
    test('ext.flutter.inspector.structuredErrors', () async {
      List<Map<Object, Object?>> flutterErrorEvents = service.dispatchedEvents(
        'Flutter.Error',
      );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        service.setSelection(
          find.text('Hello, World!').evaluate().first,
          'my-group',
        );
            ...
            if (value is Element) {
              ...
              if (renderObject != null) {
                additionalJson['renderObject'] = renderObject
                    .toDiagnosticsNode()
                    .toJsonMap(delegate.copyWith(subtreeDepth: 0));
              }
            }
...
extension WidgetInspectorServiceExtension on WidgetInspectorService {
  Future<List<String>> get currentPubRootDirectories async {
    return ((await pubRootDirectories(<String, String>{}))['result']
            as List<Object?>)
        .cast<String>();
  }
}
