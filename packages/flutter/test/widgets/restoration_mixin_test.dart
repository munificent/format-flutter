...
void main() {
  testWidgets('claims bucket', (WidgetTester tester) async {
    ...
    final _TestRestorableWidgetState state = tester.state(
      find.byType(_TestRestorableWidget),
    );
    expect(state.bucket?.restorationId, id);
    expect(
      (rawData[childrenMapKey] as Map<Object?, Object?>).containsKey(id),
      isTrue,
    );
    ...
    expect(state.property.log, <String>[
      'createDefaultValue',
      'initWithValue',
      'toPrimitives',
    ]);
  ...
  testWidgets('Disposing widget removes its data', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      UnmanagedRestorationScope(bucket: root, child: Container()),
    );
    manager.doSerialization();
  ...
  testWidgets('move in and out of scope', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      _TestRestorableWidget(key: key, restorationId: 'child1'),
    );
    final _TestRestorableWidgetState state = tester.state(
      find.byType(_TestRestorableWidget),
    );
  ...
  testWidgets('moving scope moves its data', (WidgetTester tester) async {
    ...
    expect((((rawData[childrenMapKey] as Map<Object?, Object?>)['fixed']!
            as Map<String, dynamic>)[childrenMapKey] as Map<Object?, Object?>)
    ...
    expect((rawData[childrenMapKey] as Map<Object?, Object?>).containsKey(
      'moving-child',
    ), isTrue);
  });
  ...
  testWidgets('restartAndRestore', (WidgetTester tester) async {
    ...
    _TestRestorableWidgetState state = tester.state(
      find.byType(_TestRestorableWidget),
    );
    expect(state.bucket, isNotNull);
  ...
  testWidgets(
    'cannot register same property twice',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const RootRestorationScope(
          restorationId: 'root-child',
  ...
  testWidgets(
    'cannot register under ID that is already in use',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const RootRestorationScope(
          restorationId: 'root-child',
  ...
  testWidgets(
    'data of disabled property is not stored',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const RootRestorationScope(
          restorationId: 'root-child',
  ...
  testWidgets(
    'Enabling property stores its data again',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const RootRestorationScope(
          restorationId: 'root-child',
  ...
  testWidgets(
    'Unregistering a property removes its data',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const RootRestorationScope(
          restorationId: 'root-child',
      ...
      expect(
        () => state.additionalProperty!.value,
