...
void main() {
  ...
  testWidgets('Navigator can set clip behavior', (WidgetTester tester) async {
    ...
    expect(
      tester.widget<Overlay>(find.byType(Overlay)).clipBehavior,
      Clip.hardEdge,
    );
  ...
  testWidgets('Push and pop should trigger the observers', (
    ...
    observer.onPushed = (Route<dynamic>? route, Route<dynamic>? previousRoute) {
      ...
      expect(
        previousRoute is PageRoute && previousRoute.settings.name == '/',
        isTrue,
      );
      isPushed = true;
    };
  ...
  testWidgets(
    'initial route trigger observer in the right order',
    (WidgetTester tester) async {
      final Map<String, WidgetBuilder> routes = <String, WidgetBuilder>{
        '/': (BuildContext context) => const Text('/'),
  ...
  testWidgets(
    'Page-based route pop before push finishes',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'Pages update does update overlay correctly',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        routes['/A']!.secondaryAnimation!.value,
                  ...
                  onPressed: () {
                    key.currentState!.push<void>(MaterialPageRoute<int>(
                      ...
                      builder: (BuildContext context) {
                        log.add('building C');
                        log.add(
                          'found ${ModalRoute.of(context)!.settings.name}',
                        );
                        return TextButton(
                          child: const Text('C'),
                          onPressed: () {
  ...
  testWidgets('route semantics', (WidgetTester tester) async {
    ...
    expect(
      semantics,
      includesNodeWith(flags: <SemanticsFlag>[SemanticsFlag.scopesRoute]),
    );
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      onGenerateRoute: (RouteSettings settings) {
        ...
        return MaterialPageRoute<void>(
          settings: settings,
          builder:
              (BuildContext context) => Center(child: Text(settings.name!)),
        );
      },
    ));
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          Navigator(key: navigatorKey, onGenerateRoute: (_) => null),
        );
        final dynamic exception = tester.takeException();
        ...
        expect(
          error.diagnostics.last,
          isA<DiagnosticsProperty<NavigatorState>>(),
        );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        ModalRoute.of(topmost.currentContext!)!.overlayEntries.first.opaque,
        isTrue,
      );
  ...
  testWidgets('OverlayEntry of topmost route is set to opaque after Push', (
    ...
    final BuildContext topMostContext = tester.element(
  ...
  testWidgets('OverlayEntry of topmost route is set to opaque after Replace', (
    ...
    final Route<dynamic> oldRoute = ModalRoute.of(tester.element(
    ...
    navigator.currentState!.replace<void>(
      oldRoute: oldRoute,
      newRoute: newRoute,
    );
    await tester.pump();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        tester.state<StatefulTestState>(
      ...
      expect(
        tester.state<StatefulTestState>(find.byKey(topRoute)).rebuildCount,
        1,
      );
    },
  );
  ...
  testWidgets(
    'Can provide custom onGenerateInitialRoutes',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      final GlobalKey<NavigatorState> testKey = GlobalKey<NavigatorState>();
      await tester.pumpWidget(
        MaterialApp(navigatorKey: testKey, home: const Text('home')),
      );
  ...
  testWidgets(
    'Navigator.maybeOf throws when there is no navigator',
    (WidgetTester tester) async {
      final GlobalKey<NavigatorState> testKey = GlobalKey<NavigatorState>();
  ...
  testWidgets(
    'Navigator.maybeOf works when there is no navigator',
    (WidgetTester tester) async {
      final GlobalKey<NavigatorState> testKey = GlobalKey<NavigatorState>();
      await tester.pumpWidget(SizedBox(key: testKey));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final NavigatorState? state = Navigator.maybeOf(
        sub.currentContext!,
        rootNavigator: true,
      );
      expect(state, isNotNull);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      const Duration kFourTenthsOfTheTransitionDuration = Duration(
        milliseconds: 120,
      );
      final GlobalKey<NavigatorState> navigator = GlobalKey<NavigatorState>();
  ...
  testWidgets(
    'hero controller throws has correct error message',
    (WidgetTester tester) async {
      final HeroControllerSpy spy = HeroControllerSpy();
      await tester.pumpWidget(HeroControllerScope(
        controller: spy,
  ...
  group('Page api', () {
    ...
    testWidgets(
      'throw if onPopPage callback is not provided',
      (WidgetTester tester) async {
        final List<TestPage> myPages = <TestPage>[
          const TestPage(key: ValueKey<String>('1'), name: 'initial'),
          const TestPage(key: ValueKey<String>('2'), name: 'second'),
    ...
    testWidgets('can push and pop pages using page api', (
      ...
      expect(
        secondaryAnimationOfRouteOne.value,
      ...
      expect(primaryAnimationOfRouteOne.status, AnimationStatus.completed);
      expect(
        secondaryAnimationOfRouteTwo.value,
        primaryAnimationOfRouteThree.value,
      );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(primaryAnimationOfRouteTwo.status, AnimationStatus.completed);
        expect(
          secondaryAnimationOfRouteThree.status,
        ...
        expect(
          secondaryAnimationOfRouteThree.value,
          primaryAnimationOfRouteTwo.value,
        );
        expect(primaryAnimationOfRouteThree.status, AnimationStatus.completed);
        expect(
          secondaryAnimationOfRouteTwo.value,
          primaryAnimationOfRouteOne.value,
        );
        expect(primaryAnimationOfRouteTwo.status, AnimationStatus.completed);
    ...
    testWidgets(
      'can update pages before a pageless route has finished popping',
      (WidgetTester tester) async {
  ...
  testWidgets(
    "Navigator doesn't override FocusTraversalPolicy of ancestors",
    (WidgetTester tester) async {
  ...
  group('RouteSettings.toString', () {
    test('when name is not null, should have double quote', () {
      expect(
        const RouteSettings(name: '/home').toString(),
  ...
  Iterable<RouteTransitionRecord> resolve({
    ...
    void handleExitingRoute(RouteTransitionRecord? location) {
      ...
      if (exitingPageRoute.isWaitingForExitingDecision) {
        final bool hasPagelessRoute = pageRouteToPagelessRoutes.containsKey(
          exitingPageRoute,
        );
