...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final RenderSliver parentSliver1 = tester.renderObject(
        find.byKey(parentKey1),
      );
      final RenderSliver parentSliver2 = tester.renderObject(
        find.byKey(parentKey2),
      );
      ...
      final RenderSliver childSliver1 = tester.renderObject(
        find.byKey(childKey1),
      );
      final RenderSliver childSliver2 = tester.renderObject(
        find.byKey(childKey2),
      );
            ...
            child: SizedBox.fromSize(
              ...
              child: LayoutBuilder(
                builder: (BuildContext context, BoxConstraints constraints) {
                  buildCount++;
                  if (buildCount > 1) {
                    final _RenderLayoutSpy spy = tester.renderObject(
                      find.byType(_LayoutSpy),
                    );
                    childSize = spy.size;
                  }
