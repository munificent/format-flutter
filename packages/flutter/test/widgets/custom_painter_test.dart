...
void _defineTests() {
    ...
    expect(semanticsTester, hasSemantics(TestSemantics.root(
      children: <TestSemantics>[
        TestSemantics.rootChild(
          ...
          children: <TestSemantics>[
            TestSemantics(id: 2, label: 'foreground', rect: const Rect.fromLTRB(1.0, 1.0, 2.0, 2.0)),
          ],
        ),
      ],
    )));
    ...
    expect(semanticsTester, hasSemantics(TestSemantics.root(
      children: <TestSemantics>[
        TestSemantics.rootChild(
          ...
          rect: TestSemantics.fullScreen,
          children: <TestSemantics>[
            TestSemantics(id: 2, label: 'background', rect: const Rect.fromLTRB(1.0, 1.0, 2.0, 2.0)),
          ],
        ),
      ],
    )));
  ...
  testWidgets('combines background, child and foreground semantics', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(CustomPaint(
      ...
      child: Semantics(container: true, child: const Text('Hello', textDirection: TextDirection.ltr)),
    ));
    ...
    expect(semanticsTester, hasSemantics(TestSemantics.root(
      children: <TestSemantics>[
        TestSemantics.rootChild(
          ...
          rect: TestSemantics.fullScreen,
          children: <TestSemantics>[
            TestSemantics(id: 3, label: 'background', rect: const Rect.fromLTRB(1.0, 1.0, 2.0, 2.0)),
            TestSemantics(id: 2, label: 'Hello', rect: const Rect.fromLTRB(0.0, 0.0, 800.0, 600.0)),
            TestSemantics(id: 4, label: 'foreground', rect: const Rect.fromLTRB(1.0, 1.0, 2.0, 2.0)),
          ],
        ),
      ],
    )));
  ...
  testWidgets('Supports all flags', (WidgetTester tester) async {
    ...
    TestSemantics expectedSemantics = TestSemantics.root(
      children: <TestSemantics>[
        TestSemantics.rootChild(
          id: 1,
          children: <TestSemantics>[TestSemantics.rootChild(id: 2, rect: TestSemantics.fullScreen, flags: flags)],
        ),
      ],
    );
    expect(semantics, hasSemantics(expectedSemantics, ignoreRect: true, ignoreTransform: true));
