...
void main() {
  testWidgets('Padding RTL', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      const Directionality(textDirection: TextDirection.ltr, child: child),
    );
    expect(
    ...
    await tester.pumpWidget(
      const Directionality(textDirection: TextDirection.rtl, child: child),
    );
  ...
  testWidgets('Container padding/margin RTL', (WidgetTester tester) async {
    ...
    expect(
      tester.getTopRight(find.byType(Placeholder)),
    ...
    expect(
      tester.getTopRight(find.byType(Placeholder)),
      const Offset(790.0, 0.0),
    );
  });

  testWidgets(
    'Container padding/margin mixed RTL/absolute',
