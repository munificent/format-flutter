...
void main() {
  testWidgets('Padding RTL', (WidgetTester tester) async {
    const Widget child = Padding(padding: EdgeInsetsDirectional.only(start: 10.0), child: Placeholder());
    ...
    await tester.pumpWidget(
      const Padding(key: GlobalObjectKey<State<StatefulWidget>>(Object()), padding: EdgeInsets.only(left: 1.0)),
    );
    await tester.pumpWidget(
