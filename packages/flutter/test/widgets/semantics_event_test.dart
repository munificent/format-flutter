...
void main() {
  test('SemanticsEvent.toString', () {
    ...
    expect(TestSemanticsEvent(text: 'hello', number: 10).toString(), 'TestSemanticsEvent(number: 10, text: hello)');
  });
  ...
  test('FocusSemanticEvent.toMap', () {
    expect(const FocusSemanticEvent().toMap(), <String, dynamic>{'type': 'focus', 'data': <String, dynamic>{}});
  });
}
