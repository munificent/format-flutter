...
void main() {
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        nestedTickerModes(outerEnabled: false, innerEnabled: true),
      );
      ...
      await tester.pumpWidget(
        nestedTickerModes(outerEnabled: true, innerEnabled: false),
      );
      outerTickCount = 0;
      innerTickCount = 0;
      await tester.pump(const Duration(seconds: 1));
      ...
      await tester.pumpWidget(
        nestedTickerModes(outerEnabled: true, innerEnabled: true),
      );
      outerTickCount = 0;
      innerTickCount = 0;
      await tester.pump(const Duration(seconds: 1));
      ...
      await tester.pumpWidget(
        nestedTickerModes(outerEnabled: false, innerEnabled: false),
      );
      outerTickCount = 0;
      innerTickCount = 0;
      await tester.pump(const Duration(seconds: 1));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      _TickingWidgetState state() => tester.state<_TickingWidgetState>(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      Widget widgetUnderTest({
        required LocalKey tickerModeKey,
      ...
      final _TickingWidgetState tickingState = tester
          .state<_TickingWidgetState>(find.byType(_TickingWidget));
      ...
      expect(
        tester.state(find.byType(TickerMode)),
        isNot(same(tickerModeState)),
      );
      expect(
        tickingState,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(tickingState, same(tester.state<_MultiTickingWidgetState>(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      _MultiTickingWidgetState multiTickingState() => tester
          .state<_MultiTickingWidgetState>(
