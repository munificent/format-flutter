...
void main() {
  ...
  test('transforming events', () {
    ...
    _expectTransformedEvent(original: exit, transform: transform, localPosition: localPosition, localDelta: localDelta);
    ...
    _expectTransformedEvent(original: move, transform: transform, localPosition: localPosition, localDelta: localDelta);
    ...
    _expectTransformedEvent(original: panZoomStart, transform: transform, localPosition: localPosition);
    ...
    _expectTransformedEvent(original: panZoomUpdate, transform: transform, localPosition: localPosition);
    ...
    _expectTransformedEvent(original: panZoomEnd, transform: transform, localPosition: localPosition);
