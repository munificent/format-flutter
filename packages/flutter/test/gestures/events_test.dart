...
void main() {
  ...
  test('computed hit slop values are based on pointer device kind', () {
    expect(
      computeHitSlop(PointerDeviceKind.mouse, null),
    ...
    expect(
      computePanSlop(PointerDeviceKind.mouse, null),
  ...
  test(
    ...
    () {
      const DeviceGestureSettings settings = DeviceGestureSettings(
        touchSlop: 1,
      );

      expect(
        computeHitSlop(PointerDeviceKind.mouse, settings),
        kPrecisePointerHitSlop,
      );
      ...
      expect(
        computePanSlop(PointerDeviceKind.mouse, settings),
        kPrecisePointerPanSlop,
      );
  ...
  test('transformPosition', () {
    ...
    expect(
      PointerEvent.transformPosition(Matrix4.identity(), position),
      position,
    );
  ...
  group('copyWith', () {
    ...
    test('PointerAddedEvent.copyWith()', () {
      final PointerEvent event = added.copyWith(
        position: position,
        timeStamp: timeStamp,
      );
    ...
    test('PointerHoverEvent.copyWith()', () {
      final PointerEvent event = hover.copyWith(
        position: position,
        timeStamp: timeStamp,
      );
    ...
    test('PointerDownEvent.copyWith()', () {
      final PointerEvent event = down.copyWith(
        position: position,
        timeStamp: timeStamp,
      );
    ...
    test('PointerMoveEvent.copyWith()', () {
      final PointerEvent event = move.copyWith(
        position: position,
        timeStamp: timeStamp,
      );
    ...
    test('PointerUpEvent.copyWith()', () {
      final PointerEvent event = up.copyWith(
        position: position,
        timeStamp: timeStamp,
      );
    ...
    test('PointerRemovedEvent.copyWith()', () {
      final PointerEvent event = removed.copyWith(
        position: position,
        timeStamp: timeStamp,
      );
  ...
  test('Ensure certain event types are allowed', () {
    ...
    expect(
      const PointerScrollEvent(kind: PointerDeviceKind.trackpad),
      isNotNull,
    );
  ...
  test('Ensure certain event types are not allowed', () {
    expect(
      () => PointerDownEvent(kind: PointerDeviceKind.trackpad),
      throwsAssertionError,
    );
    expect(
      () => PointerMoveEvent(kind: PointerDeviceKind.trackpad),
      throwsAssertionError,
    );
    expect(
      () => PointerUpEvent(kind: PointerDeviceKind.trackpad),
      throwsAssertionError,
    );
  });
}
