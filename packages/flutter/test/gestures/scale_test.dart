...
void main() {
  ...
  testGesture(
    ...
    (GestureTester tester) {
      ...
      final PointerDownEvent down2 = mousePointer.down(
  ...
  testGesture('Scale gesture competes with drag', (GestureTester tester) {
    ...
    tester.route(
      pointer1.move(const Offset(10.0, 50.0)),
  ...
  testGesture('Scale gestures pointer count test', (GestureTester tester) {
    ...
    scale.onEnd = (ScaleEndDetails details) =>
        pointerCountOfEnd = details.pointerCount;
    ...
    expect(
      pointerCountOfEnd,
      2,
    ); // Additional pointer down will trigger an end event.

    tester.route(pointer2.move(const Offset(0.0, 10.0)));
    expect(
      pointerCountOfStart,
      2,
    ); // The new pointer move will trigger a start event.
  ...
  testGesture(
    'Should recognize scale gestures from pointer pan/zoom events',
    (GestureTester tester) {
      final ScaleGestureRecognizer scale = ScaleGestureRecognizer();
      final HorizontalDragGestureRecognizer drag =
          HorizontalDragGestureRecognizer();
  ...
  testGesture(
    'Pointer pan/zooms should work alongside touches',
    (GestureTester tester) {
      final ScaleGestureRecognizer scale = ScaleGestureRecognizer();
      final HorizontalDragGestureRecognizer drag =
          HorizontalDragGestureRecognizer();
      ...
      final TestPointer panZoomPointer = TestPointer(
        4,
        PointerDeviceKind.trackpad,
      );

      final PointerPanZoomStartEvent panZoomStart = panZoomPointer.panZoomStart(
        Offset.zero,
      );
      ...
      // Add a touch pointer.
      final PointerDownEvent touchStart1 = touchPointer1.down(
        const Offset(40, 40),
      );
      ...
      final PointerDownEvent touchStart2 = touchPointer2.down(
        const Offset(10, 40),
      );
      ...
      tester.route(panZoomPointer.panZoomUpdate(
        Offset.zero,
  ...
  testGesture(
    'Scale gesture competes with drag for trackpad gesture',
    (GestureTester tester) {
      final ScaleGestureRecognizer scale = ScaleGestureRecognizer();
      final HorizontalDragGestureRecognizer drag =
          HorizontalDragGestureRecognizer();
      ...
      final PointerPanZoomStartEvent down = pointer1.panZoomStart(
      ...
      tester.route(pointer1.panZoomUpdate(
        const Offset(10.0, 10.0),
        pan: const Offset(10.0, 40.0),
      )); // delta of 40.0 exceeds 18.0*2.
      expect(log, equals(<String>['scale-start', 'scale-update']));
      log.clear();

      final TestPointer pointer2 = TestPointer(3, PointerDeviceKind.trackpad);
      final PointerPanZoomStartEvent down2 = pointer2.panZoomStart(
        const Offset(10.0, 20.0),
      );
      ...
      tester.route(pointer2.panZoomUpdate(
        const Offset(10.0, 20.0),
      ...
      final PointerPanZoomStartEvent down3 = pointer3.panZoomStart(
      ...
      tester.route(pointer3.panZoomUpdate(
        const Offset(30.0, 30.0),
  ...
  testGesture(
    ...
    (GestureTester tester) {
      ...
      tester.route(
        pointer1.panZoomUpdate(Offset.zero, scale: 1.1, rotation: 1),
      );
      expect(didStartScale, isTrue);
      didStartScale = false;
      expect(updatedFocalPoint, Offset.zero);
      ...
      tester.route(
        pointer1.panZoomUpdate(Offset.zero, scale: 1.21, rotation: 1.5),
      );
      expect(updatedFocalPoint, Offset.zero);
      updatedFocalPoint = null;
      ...
      tester.route(
        pointer1.panZoomUpdate(Offset.zero, scale: 0.99, rotation: 1.0),
      );
      expect(updatedFocalPoint, Offset.zero);
      updatedFocalPoint = null;
  ...
  testGesture('scale trackpadScrollCausesScale', (GestureTester tester) {
    ...
    tester.route(
      pointer1.panZoomUpdate(Offset.zero, pan: const Offset(0, -200)),
    );
    expect(didStartScale, isFalse);
    expect(updatedFocalPoint, Offset.zero);
    updatedFocalPoint = null;
    ...
    tester.route(
      pointer1.panZoomUpdate(Offset.zero, pan: const Offset(125, 0)),
    );
    expect(didStartScale, isFalse);
    didStartScale = false;
    expect(updatedFocalPoint, Offset.zero);
