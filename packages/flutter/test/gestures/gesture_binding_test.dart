...
class TestGestureFlutterBinding extends BindingBase
  ...
  static TestGestureFlutterBinding get instance => BindingBase.checkInstance(
    _instance,
  );
...
void main() {
  ...
  test('Pointer tap events', () {
    ...
    GestureBinding.instance.platformDispatcher.onPointerDataPacket?.call(
      packet,
    );
  ...
  test('PointerEventConverter processes view IDs', () {
    ...
    const List<ui.PointerData> data = <ui.PointerData>[
      ...
      ui.PointerData(
        viewId: startID + 7,
        change: ui.PointerChange.panZoomStart,
      ),
      ui.PointerData(
        viewId: startID + 8,
        change: ui.PointerChange.panZoomUpdate,
      ),
    ...
    final List<int> expectedViewIds = List<int>.generate(
      10,
      (int index) => startID + index,
    );
