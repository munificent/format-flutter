  ...
  group('Horizontal', () {
    ...
    testWidgetsWithLeakTracking(
      ...
      (WidgetTester tester) async {
        ...
        await tester.drag(
          find.byKey(redContainer),
          const Offset(kTouchSlop + 1, 0),
        );
        ...
        expect(
          startDetails.single.globalPosition,
    ...
    testWidgetsWithLeakTracking(
      ...
      (WidgetTester tester) async {
        ...
        expect(updateDetails.single.globalPosition, within(
          distance: 0.0001,
