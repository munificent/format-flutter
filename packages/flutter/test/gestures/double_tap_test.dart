...
void main() {
  ...
  group('Enforce consistent-button restriction:', () {
    ...
    testGesture(
      ...
      (GestureTester tester) {
        final DoubleTapGestureRecognizer tapPrimary =
  ...
  testGesture(
    'Buttons filter should cancel invalid taps',
    (GestureTester tester) {
      final List<String> recognized = <String>[];
      final DoubleTapGestureRecognizer doubleTap = DoubleTapGestureRecognizer(
  ...
  testGesture(
    ...
    (GestureTester tester) {
      ...
      tester.closeArena(2);
      tester.route(down2);
      final PointerMoveEvent move2 = PointerMoveEvent(
        pointer: 2,
        position: down2.position,
      );
      tester.route(move2);
      tester.route(up2);
