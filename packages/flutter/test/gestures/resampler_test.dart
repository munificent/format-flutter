...
void main() {
  PointerEvent createSimulatedPointerAddedEvent(int timeStampUs, double x, double y) {
    return PointerAddedEvent(timeStamp: Duration(microseconds: timeStampUs), position: Offset(x, y));
  }

  PointerEvent createSimulatedPointerRemovedEvent(int timeStampUs, double x, double y) {
    return PointerRemovedEvent(timeStamp: Duration(microseconds: timeStampUs), position: Offset(x, y));
  }
  ...
  PointerEvent createSimulatedPointerMoveEvent(int timeStampUs, double x, double y, double deltaX, double deltaY) {
  ...
  PointerEvent createSimulatedPointerHoverEvent(int timeStampUs, double x, double y, double deltaX, double deltaY) {
