...
void main() {
  testWidgetsWithLeakTracking(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(title: 'Scroll Bug', home: NestedScrollableCase(testResult: result)));
  ...
  testWidgetsWithLeakTracking(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(title: 'Scroll Bug', home: NestedDraggableCase(testResult: result)));
