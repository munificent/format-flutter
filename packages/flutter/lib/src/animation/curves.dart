...
class Cubic extends Curve {
  ...
  @override
  String toString() {
    return '${objectRuntimeType(this, 'Cubic')}(${a.toStringAsFixed(2)}, ${b.toStringAsFixed(2)}, ${c.toStringAsFixed(
      2,
    )}, ${d.toStringAsFixed(2)})';
  }
}
...
class CatmullRomSpline extends Curve2D {
  ...
  static List<List<Offset>> _computeSegments(
    ...
    for (int i = 0; i < allPoints.length - 3; ++i) {
      ...
      final List<Offset> segment = <Offset>[diffCurve21 * -2.0 + sumM12, diffCurve21 * 3.0 - m1 - sumM12, m1, curve[1]];
      result.add(segment);
    }
    return result;
  }
...
class CatmullRomCurve extends Curve {
  ...
  CatmullRomCurve(
    ...
    this.tension = 0.0,
         ...
         () {
           return validateControlPoints(controlPoints, tension: tension, reasons: _debugAssertReasons..clear());
         }(),
  ...
  static bool validateControlPoints(List<Offset>? controlPoints, {double tension = 0.0, List<String>? reasons}) {
