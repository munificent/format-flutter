...
class FrictionSimulation extends Simulation {
  ...
  FrictionSimulation(double drag, double position, double velocity, {super.tolerance, double constantDeceleration = 0})
    : _drag = drag,
  ...
  @override
  String toString() => '${objectRuntimeType(this, 'FrictionSimulation')}(cₓ: ${_drag.toStringAsFixed(
    1,
  )}, x₀: ${_x.toStringAsFixed(1)}, dx₀: ${_v.toStringAsFixed(1)})';
}
...
class BoundedFrictionSimulation extends FrictionSimulation {
  ...
  @override
  String toString() => '${objectRuntimeType(this, 'BoundedFrictionSimulation')}(cₓ: ${_drag.toStringAsFixed(
    1,
  )}, x₀: ${_x.toStringAsFixed(1)}, dx₀: ${_v.toStringAsFixed(1)}, x: ${_minX.toStringAsFixed(
    1,
