...
class Velocity {
  ...
  @override
  String toString() => 'Velocity(${pixelsPerSecond.dx.toStringAsFixed(
    1,
...
class VelocityEstimate {
  ...
  String toString() => 'VelocityEstimate(${pixelsPerSecond.dx.toStringAsFixed(
    1,
  )}, ${pixelsPerSecond.dy.toStringAsFixed(
    1,
  )}; offset: $offset, duration: $duration, confidence: ${confidence.toStringAsFixed(
    1,
  )})';
}
...
class IOSScrollViewFlingVelocityTracker extends VelocityTracker {
  ...
  final List<_PointAtTime?> _touchSamples = List<_PointAtTime?>.filled(
    _sampleSize,
    null,
  );
