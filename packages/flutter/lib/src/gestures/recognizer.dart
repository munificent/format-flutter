...
abstract class GestureRecognizer extends GestureArenaMember
      ...
      assert(
        () {
          if (debugPrintRecognizerCallbacksTrace) {
            ...
            final String prefix = debugPrintGestureArenaDiagnostics
                ? '${' ' * 19}❙ '
                : '';
            debugPrint(
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
      DiagnosticsProperty<Object>('debugOwner', debugOwner, defaultValue: null),
    );
  }
}
...
abstract class OneSequenceGestureRecognizer extends GestureRecognizer {
  ...
  void resolve(GestureDisposition disposition) {
    final List<GestureArenaEntry> localEntries = List<GestureArenaEntry>.of(
      _entries.values,
    );
    _entries.clear();
...
class OffsetPair {
  ...
  static const OffsetPair zero = OffsetPair(
    local: Offset.zero,
    global: Offset.zero,
  );
