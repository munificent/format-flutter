...
class BorderSide with Diagnosticable {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(EnumProperty<BorderStyle>(
      'style',
      style,
...
class _CompoundBorder extends ShapeBorder {
  ...
  ShapeBorder scale(double t) {
    return _CompoundBorder(
      borders.map<ShapeBorder>(
        (ShapeBorder border) => border.scale(t),
      ).toList(),
    );
  }
  ...
  static _CompoundBorder lerp(ShapeBorder? a, ShapeBorder? b, double t) {
    ...
    final List<ShapeBorder?> aList = a is _CompoundBorder
        ? a.borders
        : <ShapeBorder?>[a];
    final List<ShapeBorder?> bList = b is _CompoundBorder
        ? b.borders
        : <ShapeBorder?>[b];
