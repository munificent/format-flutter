...
class CircleBorder extends OutlinedBorder {
  ...
  @override
  ShapeBorder scale(double t) => CircleBorder(
    side: side.scale(t),
    ...
    if (a is CircleBorder) {
      return CircleBorder(
        ...
        eccentricity: clampDouble(
          ui.lerpDouble(a.eccentricity, eccentricity, t)!,
          0.0,
          1.0,
        ),
      );
  ...
  ShapeBorder? lerpTo(ShapeBorder? b, double t) {
    if (b is CircleBorder) {
      return CircleBorder(
        ...
        eccentricity: clampDouble(
          ui.lerpDouble(eccentricity, b.eccentricity, t)!,
          0.0,
          1.0,
        ),
      );
  ...
  String toString() {
    if (eccentricity != 0.0) {
      return '${objectRuntimeType(
        this,
        'CircleBorder',
      )}($side, eccentricity: $eccentricity)';
    }
