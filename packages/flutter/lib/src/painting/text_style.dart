...
class TextStyle with Diagnosticable {
  ...
  List<String>? get fontFamilyFallback => _package == null
      ? _fontFamilyFallback
      : _fontFamilyFallback?.map(
          (String str) => 'packages/$_package/$str',
        ).toList();
  ...
  TextStyle apply({
    ...
    return TextStyle(
      ...
      fontWeight: fontWeight == null
          ? null
          : FontWeight.values[
              (fontWeight!.index + fontWeightDelta).clamp(
                0,
  ...
  static TextStyle? lerp(TextStyle? a, TextStyle? b, double t) {
    ...
    assert(
      () {
        lerpDebugLabel =
            'lerp(${a?.debugLabel ?? _kDefaultDebugLabel} ⎯${t.toStringAsFixed(
              1,
    ...
    assert(
      () {
        ...
        final List<String> nullFields = <String>[
          ...
          if (a.letterSpacing == null && b.letterSpacing == null)
            'letterSpacing',
    ...
    return TextStyle(
      ...
      fontFamilyFallback: t < 0.5
          ? a._fontFamilyFallback
          : b._fontFamilyFallback,
  ...
  ui.ParagraphStyle getParagraphStyle({
    ...
    final ui.TextLeadingDistribution? leadingDistribution =
        this.leadingDistribution;
    final ui.TextHeightBehavior?
    effectiveTextHeightBehavior = textHeightBehavior ??
        (leadingDistribution == null
            ? null
            : ui.TextHeightBehavior(leadingDistribution: leadingDistribution));
  ...
  void debugFillProperties(
    ...
    styles.add(EnumProperty<TextBaseline>(
      '${prefix}baseline',
      textBaseline,
      defaultValue: null,
    ));
    ...
    styles.add(DiagnosticsProperty<Locale>(
      '${prefix}locale',
      locale,
      defaultValue: null,
    ));
    styles.add(DiagnosticsProperty<Paint>(
      '${prefix}foreground',
      foreground,
      defaultValue: null,
    ));
    ...
    styles.add(EnumProperty<TextOverflow>(
      '${prefix}overflow',
      overflow,
      defaultValue: null,
    ));
