...
class _CompressedNode extends _TrieNode {
  ...
  _TrieNode put(int bitIndex, Object key, int keyHash, Object? value) {
    ...
    if ((occupiedIndices & bit) != 0) {
      ...
      if (occupiedCount >= 16) {
        ...
        return _inflate(bitIndex)..descendants[_TrieNode.trieIndex(keyHash, bitIndex)] = _CompressedNode.empty.put(
          bitIndex + _TrieNode.hashBitsPerLevel,
          key,
          keyHash,
          value,
  ...
  static _TrieNode _resolveCollision(
    ...
    return (existingKeyHash == keyHash)
        ...
        : _CompressedNode.empty.put(bitIndex, existingKey, existingKeyHash, existingValue).put(
            bitIndex,
            key,
            keyHash,
            value,
