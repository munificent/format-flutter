...
class RenderEditable extends RenderBox
  ...
  void _handleSetText(String text) {
    textSelectionDelegate.userUpdateTextEditingValue(TextEditingValue(
      text: text,
  ...
  void attach(PipelineOwner owner) {
    ...
    _tap = TapGestureRecognizer(debugOwner: this)
      ...
      ..onTap = _handleTap;
    _longPress = LongPressGestureRecognizer(debugOwner: this)..onLongPress =
        _handleLongPress;
    _offset.addListener(markNeedsPaint);
    _showHideCursor();
    _showCursor.addListener(_showHideCursor);
  ...
  bool hitTestChildren(BoxHitTestResult result, {required Offset position}) {
    ...
    if (textSpan != null) {
      ...
      final TextPosition textPosition = _textPainter.getPositionForOffset(
        effectivePosition,
      );
  ...
  void _layoutText({double minWidth = 0.0, double maxWidth = double.infinity}) {
    ...
    final double textMaxWidth = _isMultiline
        ? availableMaxWidth
        : double.infinity;
    final double textMinWidth = forceLine
        ? availableMaxWidth
        : availableMinWidth;
  ...
  void performLayout() {
    ...
    final Size contentSize = Size(
      textPainterSize.width + _caretMargin,
