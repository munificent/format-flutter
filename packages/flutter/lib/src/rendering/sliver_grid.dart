...
class RenderSliverGrid extends RenderSliverMultiBoxAdaptor {
  ...
  void performLayout() {
    ...
    if (firstChild != null) {
      ...
      final int leadingGarbage = (firstIndex - oldFirstIndex).clamp(
        0,
        childCount,
    ...
    final SliverGridGeometry firstChildGridGeometry = layout
        .getGeometryForChildIndex(firstIndex);
    ...
    if (firstChild == null) {
      if (!addInitialChild(
        ...
        final double max = layout.computeMaxScrollOffset(
