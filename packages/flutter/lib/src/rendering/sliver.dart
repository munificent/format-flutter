...
class SliverHitTestEntry extends HitTestEntry<RenderSliver> {
  ...
  SliverHitTestEntry(super.target, {required this.mainAxisPosition, required this.crossAxisPosition});
  ...
  void debugAssertDoesMeetConstraints() {
    assert(geometry!.debugAssertIsValid(
      informationCollector:
          () => <DiagnosticsNode>[describeForError('The RenderSliver that returned the offending geometry was')],
    ));
    assert(
      () {
