...
class ContainerLayer extends Layer {
  ...
  bool findAnnotations<S extends Object>(
    ...
    for (Layer? child = lastChild;
        child != null;
        child = child.previousSibling) {
      final bool isAbsorbed = child.findAnnotations<S>(
        result,
        localPosition,
        onlyFirst: onlyFirst,
      );
...
class ColorFilterLayer extends ContainerLayer {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(
      DiagnosticsProperty<ColorFilter>('colorFilter', colorFilter),
    );
  }
}
...
class ImageFilterLayer extends OffsetLayer {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(
      DiagnosticsProperty<ui.ImageFilter>('imageFilter', imageFilter),
    );
  }
}
...
class AnnotatedRegionLayer<T extends Object> extends ContainerLayer {
  ...
  bool findAnnotations<S extends Object>(
    ...
    bool isAbsorbed = super.findAnnotations(
      result,
      localPosition,
      onlyFirst: onlyFirst,
    );
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
      DiagnosticsProperty<bool>('opaque', opaque, defaultValue: false),
    );
  }
}
