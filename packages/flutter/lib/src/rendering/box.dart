...
class BoxConstraints extends Constraints {
  ...
  BoxConstraints widthConstraints() => BoxConstraints(
    minWidth: minWidth,
    maxWidth: maxWidth,
  );
  ...
  /// unconstrained width.
  BoxConstraints heightConstraints() => BoxConstraints(
    minHeight: minHeight,
    maxHeight: maxHeight,
  );
...
abstract class RenderBox extends RenderObject {
  ...
  Size getDryLayout(BoxConstraints constraints) {
    ...
    if (shouldCache) {
      ...
      final Size result = _cachedDryLayoutSizes!.putIfAbsent(
        constraints,
  ...
  double? getDistanceToActualBaseline(TextBaseline baseline) {
    ...
    return _cachedBaselines!.putIfAbsent(
      baseline,
