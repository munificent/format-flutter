...
class RenderFlex extends RenderBox
  ...
  double computeMinIntrinsicWidth(double height) {
    return _getIntrinsicSize(
      ...
      extent: height,
      childSize: (RenderBox child, double extent) => child.getMinIntrinsicWidth(
        extent,
      ),
    );
  }
  ...
  double computeMaxIntrinsicWidth(double height) {
    return _getIntrinsicSize(
      sizingDirection: Axis.horizontal,
      extent: height,
      childSize: (RenderBox child, double extent) => child.getMaxIntrinsicWidth(
        extent,
      ),
    );
  }
  ...
  double computeMinIntrinsicHeight(double width) {
    return _getIntrinsicSize(
      ...
      extent: width,
      childSize: (RenderBox child, double extent) => child
          .getMinIntrinsicHeight(extent),
    );
  }
  ...
  void performLayout() {
    ...
    if (crossAxisAlignment == CrossAxisAlignment.baseline) {
      ...
      while (child != null) {
        ...
        final double? distance = child.getDistanceToBaseline(
          textBaseline!,
          onlyReal: true,
        );
        if (distance != null) {
