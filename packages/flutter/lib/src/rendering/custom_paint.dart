...
abstract class CustomPainter extends Listenable {
  ...
  /// it was not null.
  @override
  void removeListener(VoidCallback listener) => _repaint?.removeListener(
    listener,
  );
...
class RenderCustomPaint extends RenderProxyBox {
  ...
  static List<SemanticsNode> _updateSemanticsChildren(
    ...
    assert(
      () {
        ...
        if (information.isNotEmpty) {
          information.insert(0, ErrorSummary(
    ...
    while ((oldChildrenTop <= oldChildrenBottom) &&
      ...
      final SemanticsNode newChild = _updateSemanticsChild(
        oldChild,
        newSemantics,
      );
    ...
    assert(
      newChildSemantics.length - newChildrenTop ==
  ...
  static SemanticsNode _updateSemanticsChild(
    ...
    final SemanticsNode newChild =
        oldChild ?? SemanticsNode(key: newSemantics.key);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
      DiagnosticsProperty<bool>('willChange', willChange, defaultValue: false),
    );
  }
}
