...
class _RenderOverflowBar extends RenderBox
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    ...
    if (actualWidth > constraints.maxWidth) {
      return constraints.constrain(
        Size(constraints.maxWidth, y - overflowSpacing),
      );
    } else {
      final double overallWidth = alignment == null
          ? actualWidth
  ...
  void performLayout() {
    ...
    if (actualWidth > constraints.maxWidth) {
      ...
      child = overflowDirection == VerticalDirection.down
          ? firstChild
          : lastChild;
      ...
      switch (alignment) {
        ...
        case MainAxisAlignment.spaceAround:
          layoutSpacing = childCount > 0
              ? (size.width - childrenWidth) / childCount
              : 0;
          x = rtl
      ...
      while (child != null) {
        ...
        childParentData.offset = Offset(
          x,
          (maxChildHeight - child.size.height) / 2,
        );
