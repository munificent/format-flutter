...
class DisplayFeatureSubScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Iterable<Rect> subScreens = subScreensInBounds(
      wantedBounds,
      avoidBounds(mediaQuery),
    );
    final Rect closestSubScreen = _closestToAnchorPoint(
      subScreens,
      resolvedAnchorPoint,
    );
  ...
  static Rect _closestToAnchorPoint(
    ...
    for (final Rect screen in subScreens) {
      final double subScreenDistance = _distanceFromPointToRect(
        anchorPoint,
        screen,
      );
