...
abstract mixin class WidgetsBindingObserver {
  ...
  Future<bool> didPushRouteInformation(RouteInformation routeInformation) {
    ...
    return didPushRoute(Uri.decodeComponent(
      Uri(
...
mixin WidgetsBinding
    ...
    if (!kReleaseMode) {
      ...
      registerServiceExtension(
        ...
        callback: (Map<String, Object> params) async {
          ...
          BindingBase.debugReassembleConfig = DebugReassembleConfig(
  ...
  ///  * [WidgetsBindingObserver], which has an example of using this method.
  bool removeObserver(WidgetsBindingObserver observer) => _observers.remove(
    observer,
  );
...
class RenderObjectToWidgetAdapter<T extends RenderObject>
  ...
  createElement() => RenderObjectToWidgetElement<T>(this);
...
class RenderObjectToWidgetElement<T extends RenderObject>
    extends RenderObjectElement with RootElementMixin {
