...
class _AnimatedContainerState
  ...
  void forEachTween(TweenVisitor<dynamic> visitor) {
    ...
    _padding = visitor(
      _padding,
      widget.padding,
      (dynamic value) => EdgeInsetsGeometryTween(
        begin: value as EdgeInsetsGeometry,
      ),
...
class _AnimatedPaddingState extends AnimatedWidgetBaseState<AnimatedPadding> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: _padding!.evaluate(animation).clamp(
        EdgeInsets.zero,
...
class AnimatedScale extends ImplicitlyAnimatedWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(EnumProperty<FilterQuality>(
      'filterQuality',
      filterQuality,
      defaultValue: null,
    ));
