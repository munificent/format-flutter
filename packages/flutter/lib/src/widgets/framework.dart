...
class ObjectKey extends LocalKey {
  ...
  String toString() {
    ...
    return '[${objectRuntimeType(this, 'ObjectKey')} ${describeIdentity(
      value,
    )}]';
  }
}
...
abstract class State<T extends StatefulWidget> with Diagnosticable {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(ObjectFlagProperty<StatefulElement>(
      '_element',
      _element,
      ifNull: 'not mounted',
    ));
...
abstract class MultiChildRenderObjectWidget extends RenderObjectWidget {
  ...
  createElement() => MultiChildRenderObjectElement(this);
}
...
abstract class Element extends DiagnosticableTree implements BuildContext {
  ...
  static DiagnosticsNode describeElements(
    ...
    return DiagnosticsBlock(
      name: name,
      children: elements.map<DiagnosticsNode>(
  ...
  ///    tree.
  void debugVisitOnstageChildren(ElementVisitor visitor) => visitChildren(
    visitor,
  );
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    if (deps != null && deps.isNotEmpty) {
      final List<InheritedElement> sortedDependencies = deps.toList()
        ..sort(
          (InheritedElement a, InheritedElement b) => a
              .toStringShort()
              .compareTo(b.toStringShort()),
        );
...
class StatefulElement extends ComponentElement {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<State<StatefulWidget>>(
      'state',
      _state,
      defaultValue: null,
    ));
...
class MultiChildRenderObjectElement extends RenderObjectElement {
  ...
  > get renderObject {
    return super.renderObject as ContainerRenderObjectMixin<
      RenderObject,
      ContainerParentDataMixin<RenderObject>
    >;
  }
  ...
  @protected
  @visibleForTesting
  Iterable<Element> get children => _children.where(
    (Element child) => !_forgottenChildren.contains(child),
  );
