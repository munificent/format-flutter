...
class AsyncSnapshot<T> {
  ...
  AsyncSnapshot<T> inState(ConnectionState state) => AsyncSnapshot<T>._(
    state,
    data,
    error,
    stackTrace,
  ...
  String toString() => '${objectRuntimeType(
        this,
        'AsyncSnapshot',
      )}($connectionState, $data, $error, $stackTrace)';
...
class StreamBuilder<T> extends StreamBuilderBase<T, AsyncSnapshot<T>> {
  ...
  @override
  AsyncSnapshot<T> afterConnected(AsyncSnapshot<T> current) => current.inState(
  ...
  @override
  AsyncSnapshot<T> afterDone(AsyncSnapshot<T> current) => current.inState(
    ConnectionState.done,
  );
