...
Future<Map<Type, dynamic>> _loadAll(
  ...
  for (final LocalizationsDelegate<dynamic> delegate in delegates) {
    ...
    final Future<dynamic> futureValue = inputValue.then<dynamic>(
      (dynamic value) {
...
class Localizations extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
      IterableProperty<LocalizationsDelegate<dynamic>>('delegates', delegates),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      ...
      child: _LocalizationsScope(
        ...
        child:
            Directionality(textDirection: _textDirection, child: widget.child!),
      ),
    );
  }
}
