...
class RawGestureDetectorState extends State<RawGestureDetector> {
  ...
  void _syncAll(Map<Type, GestureRecognizerFactory> gestures) {
    ...
    for (final Type type in gestures.keys) {
      ...
      assert(
        ...
        'GestureRecognizerFactory of type $type created a GestureRecognizer of type ${_recognizers![
          type
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    if (_recognizers == null) {
      ...
      properties.add(
        IterableProperty<GestureRecognizer>('recognizers', _recognizers!.values, level: DiagnosticLevel.fine),
      );
      properties.add(
        DiagnosticsProperty<bool>('excludeFromSemantics', widget.excludeFromSemantics, defaultValue: false),
      );
      if (!widget.excludeFromSemantics) {
        properties.add(
          DiagnosticsProperty<SemanticsGestureDelegate>('semantics', widget.semantics, defaultValue: null),
        );
      }
    }
...
class _GestureSemantics extends SingleChildRenderObjectWidget {
  ...
  RenderSemanticsGestureHandler createRenderObject(BuildContext context) {
    final RenderSemanticsGestureHandler renderObject = RenderSemanticsGestureHandler()..behavior = behavior;
