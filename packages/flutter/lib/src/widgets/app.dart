...
class _WidgetsAppState extends State<WidgetsApp> with WidgetsBindingObserver {
      ...
      if (widget.routeInformationProvider == null &&
        ...
        _defaultRouteInformationProvider ??= PlatformRouteInformationProvider(
          initialRouteInformation:
              RouteInformation(uri: Uri.parse(_initialRouteName)),
        );
      } else {
        _defaultRouteInformationProvider?.dispose();
        _defaultRouteInformationProvider = null;
  ...
  bool _debugCheckLocalizations(Locale appLocale) {
    assert(
      () {
        final Set<Type> unsupportedTypes = _localizationsDelegates.map<Type>(
          (LocalizationsDelegate<dynamic> delegate) => delegate.type,
        ).toSet();
        ...
        FlutterError.reportError(FlutterErrorDetails(
          ...
          informationCollector: () => <DiagnosticsNode>[
                ...
                if (unsupportedTypes.length == 1 &&
                    unsupportedTypes.single.toString() ==
