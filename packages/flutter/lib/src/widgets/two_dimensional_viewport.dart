...
class _TwoDimensionalViewportElement extends RenderObjectElement
  ...
  void moveRenderObjectChild(
    RenderBox child,
    ChildVicinity oldSlot,
    ChildVicinity newSlot,
  ) {
  ...
  void _buildChild(ChildVicinity vicinity) {
    ...
    owner!.buildScope(this, () {
      final Widget? newWidget = (widget as TwoDimensionalViewport)
          .delegate
          .build(this, vicinity);
      if (newWidget == null) {
        return;
...
abstract class RenderTwoDimensionalViewport extends RenderBox
  ...
  void visitChildrenForSemantics(RenderObjectVisitor visitor) {
    ...
    RenderBox? child = _firstChild;
    while (child != null) {
      final TwoDimensionalViewportParentData childParentData = parentDataOf(
        child,
      );
  ...
  List<DiagnosticsNode> debugDescribeChildren() {
    final List<DiagnosticsNode> debugChildren = <DiagnosticsNode>[
      ..._children.keys.map<DiagnosticsNode>((ChildVicinity vicinity) {
        return _children[vicinity]!.toDiagnosticsNode(
          name: vicinity.toString(),
        );
      }),
    ];
  ...
  void _moveChild(
    RenderBox child, {
    required ChildVicinity from,
    required ChildVicinity to,
  }) {
