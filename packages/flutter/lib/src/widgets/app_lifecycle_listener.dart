...
class AppLifecycleListener with WidgetsBindingObserver, Diagnosticable {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(FlagProperty(
      'onStateChange',
      value: onStateChange != null,
      ifTrue: 'onStateChange',
    ));
    properties.add(FlagProperty(
      'onInactive',
      value: onInactive != null,
      ifTrue: 'onInactive',
    ));
    properties.add(
    ...
    properties.add(
      FlagProperty('onHide', value: onHide != null, ifTrue: 'onHide'),
    );
    properties.add(
      FlagProperty('onShow', value: onShow != null, ifTrue: 'onShow'),
    );
    properties.add(
      FlagProperty('onPause', value: onPause != null, ifTrue: 'onPause'),
    );
    properties.add(
      FlagProperty('onRestart', value: onRestart != null, ifTrue: 'onRestart'),
    );
    properties.add(FlagProperty(
      'onExitRequested',
      value: onExitRequested != null,
