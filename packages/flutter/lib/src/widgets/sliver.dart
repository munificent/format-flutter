...
class SliverMultiBoxAdaptorElement extends RenderObjectElement implements RenderSliverBoxChildManager {
  ...
  double estimateMaxScrollOffset(
    ...
    return (widget as SliverMultiBoxAdaptorWidget).estimateMaxScrollOffset(
        ...
        _extrapolateMaxScrollOffset(firstIndex, lastIndex, leadingScrollOffset, trailingScrollOffset, childCount);
  }
...
class SliverConstrainedCrossAxis extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _SliverZeroFlexParentDataWidget(sliver: _SliverConstrainedCrossAxis(maxExtent: maxExtent, sliver: sliver));
  }
}
