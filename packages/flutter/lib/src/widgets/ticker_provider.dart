...
class _TickerModeState extends State<TickerMode> {
  ...
  Widget build(BuildContext context) {
    return _EffectiveTickerMode(enabled: _effectiveMode.value, notifier: _effectiveMode, child: widget.child);
  }
...
class _EffectiveTickerMode extends InheritedWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(
      FlagProperty('effective mode', value: enabled, ifTrue: 'enabled', ifFalse: 'disabled', showName: true),
    );
  }
}
