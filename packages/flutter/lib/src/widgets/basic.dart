...
class ShaderMask extends SingleChildRenderObjectWidget {
  ...
  const ShaderMask({super.key, required this.shaderCallback, this.blendMode = BlendMode.modulate, super.child});
...
class BackdropFilter extends SingleChildRenderObjectWidget {
  ...
  /// null if provided.
  const BackdropFilter({super.key, required this.filter, super.child, this.blendMode = BlendMode.srcOver});
...
class ClipPath extends SingleChildRenderObjectWidget {
  ...
  /// given [ShapeBorder].
  static Widget shape({Key? key, required ShapeBorder shape, Clip clipBehavior = Clip.antiAlias, Widget? child}) {
    return Builder(
      key: key,
...
class FractionalTranslation extends SingleChildRenderObjectWidget {
  ...
  RenderFractionalTranslation createRenderObject(BuildContext context) {
    return RenderFractionalTranslation(translation: translation, transformHitTests: transformHitTests);
  }
...
class LayoutId extends ParentDataWidget<MultiChildLayoutParentData> {
  ...
  LayoutId({Key? key, required this.id, required super.child}) : super(key: key ?? ValueKey<Object>(id));
...
class ConstraintsTransformBox extends SingleChildRenderObjectWidget {
  ...
  /// whichever is larger.
  static BoxConstraints maxHeightUnconstrained(BoxConstraints constraints) => constraints.copyWith(
  ...
  /// whichever is larger.
  static BoxConstraints maxWidthUnconstrained(BoxConstraints constraints) => constraints.copyWith(
  ...
  static BoxConstraints maxUnconstrained(BoxConstraints constraints) => constraints.copyWith(
    maxWidth: double.infinity,
    maxHeight: double.infinity,
  );
...
class SizedOverflowBox extends SingleChildRenderObjectWidget {
  ...
  RenderSizedOverflowBox createRenderObject(BuildContext context) {
    return RenderSizedOverflowBox(alignment: alignment, requestedSize: size, textDirection: Directionality.of(context));
  }
...
class Flow extends MultiChildRenderObjectWidget {
  ...
  ///
  /// The [delegate] argument must not be null.
  Flow({super.key, required this.delegate, List<Widget> children = const <Widget>[], this.clipBehavior = Clip.hardEdge})
  ...
  ///
  /// The [delegate] argument must not be null.
  const Flow.unwrapped({super.key, required this.delegate, super.children, this.clipBehavior = Clip.hardEdge});
...
class MetaData extends SingleChildRenderObjectWidget {
  ...
  ///
  /// The [behavior] argument defaults to [HitTestBehavior.deferToChild].
  const MetaData({super.key, this.metaData, this.behavior = HitTestBehavior.deferToChild, super.child});
...
class _RenderColoredBox extends RenderProxyBoxWithHitTestBehavior {
  _RenderColoredBox({required Color color}) : _color = color, super(behavior: HitTestBehavior.opaque);
