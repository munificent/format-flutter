...
class EditableTextState extends State<EditableText>
  ...
  void selectAll(SelectionChangedCause cause) {
    ...
    userUpdateTextEditingValue(textEditingValue.copyWith(
  ...
  Offset get _floatingCursorOffset => Offset(
    0,
  ...
  void updateFloatingCursor(RawFloatingCursorPoint point) {
    ...
    switch (point.state) {
      case FloatingCursorDragState.Start:
        ...
        _startCaretRect = renderEditable.getLocalRectForCaret(
          currentTextPosition,
        );
  ...
  void _scheduleShowCaretOnScreen({required bool withAnimation}) {
    ...
    SchedulerBinding.instance.addPostFrameCallback((Duration _) {
      ...
      final RevealedOffset targetOffset = _getOffsetToRevealCaret(
        _currentCaretRect!,
      );
  ...
  > _verticalSelectionUpdateAction = _UpdateTextSelectionVerticallyAction<
    DirectionalCaretMovementIntent
  >(this);
  ...
  Object? invoke(T intent, [BuildContext? context]) {
    ...
    final TextSelection newSelection = collapseSelection ||
        ...
        : isExpand
            ? selection.expandTo(
                newExtent,
                extentAtIndex || selection.isCollapsed,
              )
...
> extends ContextAction<T> {
  ...
  void invoke(T intent, [BuildContext? context]) {
    ...
    Actions.invoke(context!, UpdateSelectionIntent(
      value,
      newSelection,
      SelectionChangedCause.keyboard,
    ));
