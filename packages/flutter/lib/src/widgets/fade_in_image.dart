...
class _FadeInImageState extends State<FadeInImage> {
  ...
  final ProxyAnimation _placeholderAnimation = ProxyAnimation(
    _kOpaqueAnimation,
  );
...
class _AnimatedFadeOutFadeInState
  ...
  void didUpdateTweens() {
    ...
    _placeholderOpacityAnimation = animation.drive(TweenSequence<double>(
      <TweenSequenceItem<double>>[
        TweenSequenceItem<double>(
          tween: _placeholderOpacity!.chain(
            CurveTween(curve: widget.fadeOutCurve),
          ),
    ...
    _targetOpacityAnimation = animation.drive(TweenSequence<double>(
      <TweenSequenceItem<double>>[
        TweenSequenceItem<double>(
          tween: ConstantTween<double>(0),
          weight: widget.fadeOutDuration.inMilliseconds.toDouble(),
