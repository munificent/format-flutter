...
class MediaQueryData {
  ...
  factory MediaQueryData.fromWindow(
  ...
  MediaQueryData.fromView(ui.FlutterView view, {MediaQueryData? platformData})
    : size = view.physicalSize / view.devicePixelRatio,
      ...
      textScaleFactor = platformData?.textScaleFactor ??
  ...
  MediaQueryData removePadding({
    ...
    return copyWith(
      ...
      viewPadding: viewPadding.copyWith(
        left: removeLeft
            ? math.max(0.0, viewPadding.left - padding.left)
            : null,
  ...
  MediaQueryData removeDisplayFeatures(Rect subScreen) {
    ...
    return copyWith(
      ...
      displayFeatures: displayFeatures.where(
        (ui.DisplayFeature displayFeature) => subScreen.overlaps(
          displayFeature.bounds,
        ),
      ).toList(),
    );
  }
...
class _MediaQueryFromViewState extends State<_MediaQueryFromView>
  ...
  void _updateData() {
    final MediaQueryData newData = MediaQueryData.fromView(
      widget.view,
