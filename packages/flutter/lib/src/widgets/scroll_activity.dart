...
abstract class ScrollActivity {
  ...
  void dispatchScrollStartNotification(
    ...
    ScrollStartNotification(metrics: metrics, context: context).dispatch(
      context,
    );
  }
...
class ScrollDragController implements Drag {
  ...
  /// scroll activity.
  static const Duration momentumRetainStationaryDurationThreshold = Duration(
    milliseconds: 20,
  );
  ...
  static const Duration motionStoppedDurationThreshold = Duration(
    milliseconds: 50,
  );
