...
class OverlayEntry implements Listenable {
  ...
  final ValueNotifier<_OverlayEntryWidgetState?> _overlayEntryStateNotifier =
  ...
  String toString() => '${describeIdentity(
        this,
      )}(opaque: $opaque; maintainState: $maintainState)';
}
...
class _OverlayEntryWidgetState extends State<_OverlayEntryWidget> {
  ...
  void _add(_OverlayEntryLocation child) {
    ...
    _OverlayEntryLocation? insertPosition = children.isEmpty
        ? null
        : children.last;
  ...
  late final Iterable<RenderBox> _paintOrderIterable = _createChildIterable(
    reversed: false,
  );
  ...
  late final Iterable<RenderBox> _hitTestOrderIterable = _createChildIterable(
    reversed: true,
  );
  ...
  Iterable<RenderBox> _createChildIterable({required bool reversed}) sync* {
    ...
    _OverlayEntryLocation? candidate = reversed
        ? children.last
        : children.first;
    ...
    assert(
      () {
        ...
        return parentData.overlayEntry ==
            ((widget as _Theater).children[newSlot.index]
                    as _OverlayEntryWidget)
                .entry;
      }(),
    );
  }
...
mixin _RenderTheaterMixin on RenderBox {
  ...
  bool hitTestChildren(BoxHitTestResult result, {required Offset position}) {
    ...
    while (!isHit && iterator.moveNext()) {
      ...
      bool childHitTest(BoxHitTestResult result, Offset position) => localChild
...
class _TheaterParentData extends StackParentData {
  ...
  Iterator<RenderBox>? get hitTestOrderIterator => overlayEntry
      ...
      .iterator;
  void visitChildrenOfOverlayEntry(RenderObjectVisitor visitor) => overlayEntry
      ?._overlayEntryStateNotifier
      .value!
      ._paintOrderIterable
      .forEach(visitor);
  ...
  List<DiagnosticsNode> debugDescribeChildren() {
    ...
    while (child != null) {
      ...
      if (onstage) {
        ...
        offstageChildren.add(child.toDiagnosticsNode(
          name: 'offstage $count',
      ...
      childParentData.visitChildrenOfOverlayEntry((RenderObject renderObject) {
        ...
        if (onstage) {
          onstageChildren.add(
            child.toDiagnosticsNode(name: 'onstage $count - $subcount'),
          );
        } else {
          offstageChildren.add(child.toDiagnosticsNode(
...
class _OverlayPortalState extends State<OverlayPortal> {
  ...
  _OverlayEntryLocation _getLocation(int zOrderIndex, bool targetRootOverlay) {
    ...
    final _RenderTheaterMarker? marker = _RenderTheaterMarker.maybeOf(
      context,
    ...
    if (cachedLocation == null) {
      returnValue = _OverlayEntryLocation(
        zOrderIndex,
...
final class _OverlayEntryLocation
  ...
  void _moveChild(
    ...
    _OverlayEntryLocation fromLocation,
  ) {
  ...
  bool _debugNotDisposed() {
    ...
    throw StateError(
      '$this is already disposed. Stack trace: $_debugDisposedStackTrace',
    );
  }
...
class _OverlayPortalElement extends RenderObjectElement {
  ...
  void update(_OverlayPortal newWidget) {
    ...
    _overlayChild = updateChild(
      _overlayChild,
      newWidget.overlayChild,
      newWidget.overlayLocation,
    );
  }
  ...
  void insertRenderObjectChild(RenderBox child, _OverlayEntryLocation? slot) {
    assert(
      child.parent == null,
      "$child's parent is not null: ${child.parent}",
    );
    if (slot != null) {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(
      DiagnosticsProperty<Element>('child', _child, defaultValue: null),
    );
    properties.add(DiagnosticsProperty<Element>(
      'overlayChild',
      _overlayChild,
      defaultValue: null,
    ));
...
class _DeferredLayout extends SingleChildRenderObjectWidget {
  ...
  _RenderDeferredLayoutBox createRenderObject(BuildContext context) {
    ...
    final _RenderDeferredLayoutBox renderObject = _RenderDeferredLayoutBox(
      parent,
    );
  ...
  void updateRenderObject(
    BuildContext context,
    _RenderDeferredLayoutBox renderObject,
  ) {
