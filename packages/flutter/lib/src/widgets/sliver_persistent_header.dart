    ...
    owner!.buildScope(this, () {
      ...
      child = updateChild(
        ...
        floating
            ...
            : sliverPersistentHeaderRenderObjectWidget.delegate.build(
                this,
                shrinkOffset,
                overlapsContent,
              ),
...
abstract class _SliverPersistentHeaderRenderObjectWidget
  ...
  @override
  _SliverPersistentHeaderElement
  createElement() => _SliverPersistentHeaderElement(this, floating: floating);
...
class _SliverFloatingPersistentHeader
    extends _SliverPersistentHeaderRenderObjectWidget {
  const _SliverFloatingPersistentHeader({required super.delegate})
    : super(floating: true);
