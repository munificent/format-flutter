...
class _DraggableSheetExtent {
  ...
  _DraggableSheetExtent copyWith({
    ...
    return _DraggableSheetExtent(
      ...
      // hasn't changed yet.
      currentSize: ValueNotifier<double>(hasChanged ? clampDouble(_currentSize.value, minSize, maxSize) : initialSize),
...
class DraggableScrollableActuator extends StatelessWidget {
  ...
  DraggableScrollableActuator({super.key, required this.child});
