  ...
  Widget build(BuildContext context) {
    final ScrollPhysics scrollPhysics =
        widget.physics?.applyTo(const ClampingScrollPhysics()) ??
            widget.scrollBehavior?.getScrollPhysics(context).applyTo(
...
class _NestedScrollCoordinator
  ...
  ScrollActivity createInnerBallisticScrollActivity(
    ...
    return position.createBallisticScrollActivity(position.physics
  ...
  ScrollHoldController hold(VoidCallback holdCancelCallback) {
    beginActivity(
      ...
      (_NestedScrollPosition position) => HoldScrollActivity(
        delegate: position,
      ),
    );
    return this;
  ...
  String toString() => '${objectRuntimeType(
        this,
        '_NestedScrollCoordinator',
      )}(outer=$_outerController; inner=$_innerController)';
}
...
class SliverOverlapInjector extends SingleChildRenderObjectWidget {
  ...
  void updateRenderObject(
    BuildContext context,
    RenderSliverOverlapInjector renderObject,
  ) {
    renderObject.handle = handle;
  }
...
class NestedScrollViewViewport extends Viewport {
  ...
  void updateRenderObject(
    BuildContext context,
    RenderNestedScrollViewViewport renderObject,
  ) {
    renderObject
      ..axisDirection = axisDirection
      ..crossAxisDirection = crossAxisDirection ??
