...
abstract class SlottedMultiChildRenderObjectWidget<
  SlotType,
...
mixin SlottedMultiChildRenderObjectWidgetMixin<
  SlotType,
  ChildType extends RenderObject
> on RenderObjectWidget {
  ...
  createElement() => SlottedRenderObjectElement<SlotType, ChildType>(this);
}
...
///    list.
mixin SlottedContainerRenderObjectMixin<
  SlotType,
  ChildType extends RenderObject
> on RenderObject {
  ...
  List<DiagnosticsNode> debugDescribeChildren() {
    ...
    for (final ChildType child in children) {
      _addDiagnostics(
        child,
        value,
        debugNameForSlot(childToSlot[child] as SlotType),
      );
    }
    return value;
  }
...
class SlottedRenderObjectElement<SlotType, ChildType extends RenderObject>
  ...
  void _updateChildren() {
    ...
    for (final SlotType slot
      ...
      final Widget? widget = slottedMultiChildRenderObjectWidgetMixin
          .childForSlot(slot);
