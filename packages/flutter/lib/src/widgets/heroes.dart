...
class _HeroFlight {
  ...
  void _performAnimationUpdate(AnimationStatus status) {
    if (status == AnimationStatus.completed ||
      ...
      manifest.fromHero.endFlight(
        keepPlaceholder: status == AnimationStatus.completed,
      );
      manifest.toHero.endFlight(
        keepPlaceholder: status == AnimationStatus.dismissed,
      );
      onFlightEnded(this);
  ...
  void onTick() {
    ...
    if (toHeroOrigin != null && toHeroOrigin.isFinite) {
      ...
      _heroOpacity = _proxyAnimation.drive(_reverseTween.chain(
