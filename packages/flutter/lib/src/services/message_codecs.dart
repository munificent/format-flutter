...
class JSONMethodCodec implements MethodCodec {
  ...
  ByteData encodeMethodCall(MethodCall methodCall) {
    return const JSONMessageCodec()
        .encodeMessage(<String, Object?>{'method': methodCall.method, 'args': methodCall.arguments})!;
  }
  ...
  dynamic decodeEnvelope(ByteData envelope) {
    ...
    if (decoded.length == 3 && decoded[0] is String && (decoded[1] == null || decoded[1] is String)) {
      throw PlatformException(code: decoded[0] as String, message: decoded[1] as String?, details: decoded[2]);
    }
    if (decoded.length == 4 &&
        decoded[0] is String &&
