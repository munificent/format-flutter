...
class _NoopMouseCursor extends MouseCursor {
  ...
  @override
  @protected
  _NoopMouseCursorSession createSession(int device) => _NoopMouseCursorSession(
    this,
    device,
  );
...
class _SystemMouseCursorSession extends MouseCursorSession {
  ...
  Future<void> activate() {
    return SystemChannels.mouseCursor.invokeMethod<void>(
      ...
      <String, dynamic>{'device': device, 'kind': cursor.kind},
    );
  }
...
class SystemMouseCursor extends MouseCursor {
  ...
  @override
  @protected
  MouseCursorSession createSession(int device) => _SystemMouseCursorSession(
    this,
    device,
  );
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
      DiagnosticsProperty<String>('kind', kind, level: DiagnosticLevel.debug),
    );
  }
}
...
class SystemMouseCursors {
  ...
  ///    dropped.
  static const SystemMouseCursor forbidden = SystemMouseCursor._(
    kind: 'forbidden',
  );
  ...
  ///    interacted with.
  static const SystemMouseCursor progress = SystemMouseCursor._(
    kind: 'progress',
  );
  ...
  static const SystemMouseCursor contextMenu = SystemMouseCursor._(
    kind: 'contextMenu',
  );
  ...
  static const SystemMouseCursor verticalText = SystemMouseCursor._(
    kind: 'verticalText',
  );
  ...
  static const SystemMouseCursor grabbing = SystemMouseCursor._(
    kind: 'grabbing',
  );
  ...
  static const SystemMouseCursor disappearing = SystemMouseCursor._(
    kind: 'disappearing',
  );
  ...
  static const SystemMouseCursor allScroll = SystemMouseCursor._(
    kind: 'allScroll',
  );
  ...
  static const SystemMouseCursor resizeLeftRight = SystemMouseCursor._(
  ...
  static const SystemMouseCursor resizeUpDown = SystemMouseCursor._(
    kind: 'resizeUpDown',
  );
  ...
  static const SystemMouseCursor resizeUp = SystemMouseCursor._(
    kind: 'resizeUp',
  );
  ...
  static const SystemMouseCursor resizeDown = SystemMouseCursor._(
    kind: 'resizeDown',
  );
  ...
  static const SystemMouseCursor resizeLeft = SystemMouseCursor._(
    kind: 'resizeLeft',
  );
  ...
  static const SystemMouseCursor resizeRight = SystemMouseCursor._(
    kind: 'resizeRight',
  );
  ...
  ///  * Windows UWP: CoreCursorType::SizeNorthwestSoutheast
  ///  * Linux: nw-resize
  static const SystemMouseCursor resizeUpLeft = SystemMouseCursor._(
    kind: 'resizeUpLeft',
  );
  ...
  ///  * Windows UWP: CoreCursorType::SizeNortheastSouthwest
  ///  * Linux: ne-resize
  static const SystemMouseCursor resizeUpRight = SystemMouseCursor._(
    kind: 'resizeUpRight',
  );
  ...
  ///  * Windows UWP: CoreCursorType::SizeNortheastSouthwest
  ///  * Linux: sw-resize
  static const SystemMouseCursor resizeDownLeft = SystemMouseCursor._(
    kind: 'resizeDownLeft',
  );
  ...
  ///  * Windows UWP: CoreCursorType::SizeNorthwestSoutheast
  ///  * Linux: se-resize
  static const SystemMouseCursor resizeDownRight = SystemMouseCursor._(
  ...
  ///  * Linux: col-resize
  ///  * macOS: resizeLeftRightCursor
  static const SystemMouseCursor resizeColumn = SystemMouseCursor._(
    kind: 'resizeColumn',
  );
  ...
  ///  * Linux: row-resize
  ///  * macOS: resizeUpDownCursor
  static const SystemMouseCursor resizeRow = SystemMouseCursor._(
    kind: 'resizeRow',
  );
