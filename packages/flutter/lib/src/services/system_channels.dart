...
abstract final class SystemChannels {
  ...
  static const MethodChannel navigation = OptionalMethodChannel('flutter/navigation', JSONMethodCodec());
  ...
  static const MethodChannel undoManager = OptionalMethodChannel('flutter/undomanager', JSONMethodCodec());
  ...
  static const BasicMessageChannel<Object?> system = BasicMessageChannel<Object?>('flutter/system', JSONMessageCodec());
  ...
  static const MethodChannel localization = OptionalMethodChannel('flutter/localization', JSONMethodCodec());
  ...
  static const MethodChannel contextMenu = OptionalMethodChannel('flutter/contextmenu', JSONMethodCodec());
