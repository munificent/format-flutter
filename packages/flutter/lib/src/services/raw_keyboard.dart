...
abstract class RawKeyEvent with Diagnosticable {
  ...
  factory RawKeyEvent.fromMessage(Map<String, Object?> message) {
    ...
    final bool repeat = RawKeyboard.instance.physicalKeysPressed.contains(
      data.physicalKey,
    );
  ...
  bool isKeyPressed(LogicalKeyboardKey key) => RawKeyboard.instance.keysPressed
      .contains(key);
...
class RawKeyUpEvent extends RawKeyEvent {
  ...
  const RawKeyUpEvent({required super.data, super.character})
    : super(repeat: false);
}
...
class RawKeyboard {
  ...
  static final Map<PhysicalKeyboardKey, LogicalKeyboardKey> _allModifiers = <
    PhysicalKeyboardKey,
    LogicalKeyboardKey
  >{PhysicalKeyboardKey.fn: LogicalKeyboardKey.fn, ..._allModifiersExceptFn};
  ...
  void _synchronizeModifiers(RawKeyEvent event) {
    ...
    final Set<PhysicalKeyboardKey> keysPressedAfterEvent = <
      PhysicalKeyboardKey
    >{..._keysPressed.keys, if (event is RawKeyDownEvent) event.physicalKey};
