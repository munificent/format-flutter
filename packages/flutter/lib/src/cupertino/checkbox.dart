...
class _CupertinoCheckboxState extends State<CupertinoCheckbox>
  ...
  Widget build(BuildContext context) {
    ...
    final Color effectiveFocusOverlayColor = widget.focusColor ??
        ...
        ).withLightness(_kCupertinoFocusColorBrightness).withSaturation(
...
class _CheckboxPainter extends ToggleablePainter {
  ...
  void _drawCheck(Canvas canvas, Offset origin, Paint paint) {
    ...
    const Offset start = Offset(
      CupertinoCheckbox.width * 0.25,
      CupertinoCheckbox.width * 0.52,
    );
    const Offset mid = Offset(
      CupertinoCheckbox.width * 0.46,
      CupertinoCheckbox.width * 0.75,
    );
    const Offset end = Offset(
      CupertinoCheckbox.width * 0.72,
      CupertinoCheckbox.width * 0.29,
    );
