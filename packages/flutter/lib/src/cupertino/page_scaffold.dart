    ...
    if (widget.navigationBar != null) {
      ...
      if (fullObstruction) {
        paddedContent = MediaQuery(
          ...
          child: Padding(padding: EdgeInsets.only(top: topPadding, bottom: bottomPadding), child: paddedContent),
        );
      } else {
        paddedContent = MediaQuery(
      ...
      final double bottomPadding = widget.resizeToAvoidBottomInset ? existingMediaQuery.viewInsets.bottom : 0.0;
      paddedContent = Padding(padding: EdgeInsets.only(bottom: bottomPadding), child: paddedContent);
    }
        ...
        children: <Widget>[
          ...
          if (widget.navigationBar != null)
            Positioned(
              ...
              left: 0.0,
              right: 0.0,
              child: MediaQuery(data: existingMediaQuery.copyWith(textScaleFactor: 1), child: widget.navigationBar!),
            ),
