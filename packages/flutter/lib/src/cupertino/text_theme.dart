...
class _TextThemeDefaultsBuilder {
  ...
  TextStyle get tabLabelTextStyle => _applyLabelColor(
    _kDefaultTabLabelTextStyle,
    inactiveGrayColor,
  );
  TextStyle get navTitleTextStyle => _applyLabelColor(
    _kDefaultMiddleTitleTextStyle,
    labelColor,
  );
  TextStyle get navLargeTitleTextStyle => _applyLabelColor(
    _kDefaultLargeTitleTextStyle,
    labelColor,
  );
  TextStyle get pickerTextStyle => _applyLabelColor(
    _kDefaultPickerTextStyle,
    labelColor,
  );
  TextStyle get dateTimePickerTextStyle => _applyLabelColor(
  ...
  TextStyle navActionTextStyle({Color? primaryColor}) => actionTextStyle(
    primaryColor: primaryColor,
  );

  _TextThemeDefaultsBuilder resolveFrom(BuildContext context) {
    final Color resolvedLabelColor = CupertinoDynamicColor.resolve(
      labelColor,
      context,
    );
    final Color resolvedInactiveGray = CupertinoDynamicColor.resolve(
      inactiveGrayColor,
      context,
    );
