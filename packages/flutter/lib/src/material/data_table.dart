...
class DataTable extends StatelessWidget {
  ...
  static const Duration _sortArrowAnimationDuration = Duration(
    milliseconds: 150,
  );
  ...
  Widget build(BuildContext context) {
    ...
    final bool anyRowSelectable = rows.any(
    ...
    final Iterable<DataRow> rowsWithCheckbox = displayCheckboxColumn
        ...
        : <DataRow>[];
    final Iterable<DataRow> rowsChecked = rowsWithCheckbox.where(
      (DataRow row) => row.selected,
    );
    ...
    final List<TableRow> tableRows = List<TableRow>.generate(
      ...
      (int index) {
        ...
        final Color? resolvedDataRowColor = index > 0
            ...
            : null;
        final Color? resolvedHeadingRowColor = effectiveHeadingRowColor
    ...
    if (displayCheckboxColumn) {
      ...
      tableRows[0].children[0] = _buildCheckbox(
        ...
        onRowTap: null,
        onCheckboxChanged:
            (bool? checked) => _handleSelectAll(checked, someChecked),
        overlayColor: null,
        tristate: true,
      );
      rowIndex = 1;
