...
class AppBarTheme with Diagnosticable {
  ...
  static AppBarTheme lerp(AppBarTheme? a, AppBarTheme? b, double t) {
    ...
    return AppBarTheme(
      ...
      systemOverlayStyle: t < 0.5
          ? a?.systemOverlayStyle
          : b?.systemOverlayStyle,
    );
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
      DiagnosticsProperty<double>('elevation', elevation, defaultValue: null),
    );
    ...
    properties.add(
      DiagnosticsProperty<bool>('centerTitle', centerTitle, defaultValue: null),
    );
    properties.add(DiagnosticsProperty<double>(
      'titleSpacing',
      titleSpacing,
