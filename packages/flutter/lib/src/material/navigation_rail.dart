...
class _NavigationRailState extends State<NavigationRail> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle unselectedLabelTextStyle = widget.unselectedLabelTextStyle ??
...
class _RailDestination extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget styledLabel = DefaultTextStyle(style: labelTextStyle, child: label);
        ...
        if (extendedTransitionAnimation.value == 0) {
          content = Padding(
            ...
            child: Stack(
              children: <Widget>[
                ...
                SizedBox.shrink(child: Visibility.maintain(visible: false, child: label)),
              ],
            ),
          );
        } else {
          final Animation<double> labelFadeAnimation = extendedTransitionAnimation.drive(
          ...
          content = Padding(
            ...
            child: ConstrainedBox(
              constraints:
                  BoxConstraints(minWidth: lerpDouble(minWidth, minExtendedWidth, extendedTransitionAnimation.value)!),
              child: ClipRect(
                child: Row(
                  children: <Widget>[
                    iconPart,
                    Align(
                      ...
                      child:
                          FadeTransition(alwaysIncludeSemantics: true, opacity: labelFadeAnimation, child: styledLabel),
                    ),
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Align(
                  ...
                  widthFactor: 1.0,
                  child: FadeTransition(alwaysIncludeSemantics: true, opacity: labelFadeAnimation, child: styledLabel),
                ),
                bottomSpacing,
              ],
            ),
