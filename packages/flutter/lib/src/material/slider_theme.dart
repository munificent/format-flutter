...
class SliderThemeData with Diagnosticable {
  ...
  static SliderThemeData lerp(SliderThemeData a, SliderThemeData b, double t) {
    ...
    return SliderThemeData(
      ...
      valueIndicatorShape: t < 0.5
          ? a.valueIndicatorShape
          : b.valueIndicatorShape,
...
class RoundedRectSliderTrackShape extends SliderTrackShape
  ...
  void paint(
    ...
    context.canvas.drawRRect(RRect.fromLTRBAndCorners(
      trackRect.left,
      (textDirection == TextDirection.ltr)
...
mixin BaseRangeSliderTrackShape {
  ...
  Rect getPreferredRect({
    ...
    final double thumbWidth = sliderTheme.rangeThumbShape!.getPreferredSize(
      isEnabled,
      isDiscrete,
    ).width;
    final double overlayWidth =
...
class _PaddleSliderValueIndicatorPathPainter {
  ...
  static const Offset _topLobeCenter = Offset(
    0.0,
    -_distanceBetweenTopBottomCenters,
  );
  ...
  double getHorizontalShift({
    ...
    assert(!sizeWithOverflow.isEmpty);
    final double inverseTextScale = textScaleFactor != 0
        ? 1.0 / textScaleFactor
        : 0.0;
  ...
  void paint(
    ...
    // stretched we are.
    final double leftAmount = math.max(
      0.0,
      math.min(1.0, leftWidthNeeded / _neckTriangleBase),
    );
    final double rightAmount = math.max(
      0.0,
      math.min(1.0, rightWidthNeeded / _neckTriangleBase),
    );
    ...
    final double stretch = clampDouble(
