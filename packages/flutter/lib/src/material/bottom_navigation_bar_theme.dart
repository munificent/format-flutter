...
class BottomNavigationBarThemeData with Diagnosticable {
  ...
  static BottomNavigationBarThemeData lerp(
    ...
    return BottomNavigationBarThemeData(
      ...
      showSelectedLabels: t < 0.5
          ? a?.showSelectedLabels
          : b?.showSelectedLabels,
      showUnselectedLabels: t < 0.5
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
      ColorProperty('selectedItemColor', selectedItemColor, defaultValue: null),
    );
    ...
    properties.add(DiagnosticsProperty<BottomNavigationBarType>(
      'type',
      type,
      defaultValue: null,
    ));
