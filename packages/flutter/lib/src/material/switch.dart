  ...
  Size _getSwitchSize(BuildContext context) {
    ...
    switch (effectiveMaterialTapTargetSize) {
      ...
      case MaterialTapTargetSize.shrinkWrap:
        return Size(
          switchConfig.switchWidth,
          switchConfig.switchHeightCollapsed,
        );
    }
  }
...
class _SwitchPainter extends ToggleablePainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Size inactiveThumbSize = Size.fromRadius(
      _pressedInactiveThumbRadius ?? inactiveThumbRadius,
    );
    final Size activeThumbSize = Size.fromRadius(
      _pressedActiveThumbRadius ?? activeThumbRadius,
    );
...
class _SwitchConfigM2 with _SwitchConfig {
  ...
  get iconColor => MaterialStateProperty.all<Color>(Colors.transparent);
...
class _SwitchDefaultsM2 extends SwitchThemeData {
  ...
  get mouseCursor => MaterialStateProperty.resolveWith(
    (Set<MaterialState> states) => MaterialStateMouseCursor.clickable.resolve(
      states,
    ),
  );
...
class _SwitchDefaultsM3 extends SwitchThemeData {
  ...
  get trackOutlineWidth => const MaterialStatePropertyAll<double>(2.0);
