    ...
    Widget wrapTile(Widget tile) {
      return DecoratedBox(
        ...
        decoration: BoxDecoration(
          border:
              Border(bottom: Divider.createBorderSide(context, color: color)),
        ),
        child: tile,
      );
    }
...
class _LisTileDefaultsM3 extends ListTileThemeData {
  ...
  @override
  TextStyle? get titleTextStyle => _textTheme.bodyLarge!.copyWith(
  ...
  @override
  TextStyle? get leadingAndTrailingTextStyle => _textTheme.labelSmall!.copyWith(
    color: _colors.onSurfaceVariant,
  );
