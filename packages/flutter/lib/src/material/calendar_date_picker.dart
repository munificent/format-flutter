                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        RotationTransition(
                          turns: _controller,
                          child:
                              Icon(Icons.arrow_drop_down, color: controlColor),
                        ),
                      ],
                    ),
                  ),
...
class _MonthPickerState extends State<_MonthPicker> {
  ...
  @override
  Widget build(BuildContext context) {
    final Color controlColor = Theme.of(context)
        .colorScheme
        .onSurface
        .withOpacity(0.60);
...
class _DayPickerState extends State<_DayPicker> {
  ...
  Widget build(BuildContext context) {
      ...
      if (day < 1) {
        ...
        final MaterialStateProperty<Color?> dayOverlayColor =
          ...
          (Set<MaterialState> states) => effectiveValue(
            (DatePickerThemeData? theme) => theme?.dayOverlayColor?.resolve(
              states,
            ),
          ),
        );
        ...
        if (isDisabled) {
          ...
          dayWidget = InkResponse(
            ...
            child: Semantics(
              ...
              // formatted full date.
              label: '${localizations.formatDecimal(
                day,
    ...
    return Padding(
      padding:
          const EdgeInsets.symmetric(horizontal: _monthPickerHorizontalPadding),
...
class _YearPickerState extends State<YearPicker> {
  ...
  Widget _buildYearItem(BuildContext context, int index) {
    ...
    final TextStyle? itemStyle = (datePickerTheme.yearStyle ??
            defaults.yearStyle)
