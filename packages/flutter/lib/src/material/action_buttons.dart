...
abstract class _ActionButton extends StatelessWidget {
  ...
  const _ActionButton({super.key, this.color, required this.icon, required this.onPressed, this.style});
...
class BackButton extends _ActionButton {
  ...
  /// target platform.
  const BackButton({super.key, super.color, super.style, super.onPressed}) : super(icon: const BackButtonIcon());
...
class DrawerButton extends _ActionButton {
  ...
  const DrawerButton({super.key, super.style, super.onPressed}) : super(icon: const DrawerButtonIcon());
...
class EndDrawerButton extends _ActionButton {
  ...
  const EndDrawerButton({super.key, super.style, super.onPressed}) : super(icon: const EndDrawerButtonIcon());
