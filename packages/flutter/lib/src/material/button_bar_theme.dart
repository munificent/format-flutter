...
class ButtonBarThemeData with Diagnosticable {
  ...
  static ButtonBarThemeData? lerp(
    ButtonBarThemeData? a,
    ButtonBarThemeData? b,
    double t,
  ) {
    if (identical(a, b)) {
      return a;
    ...
    return ButtonBarThemeData(
      ...
      buttonAlignedDropdown: t < 0.5
          ? a?.buttonAlignedDropdown
          : b?.buttonAlignedDropdown,
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
      DoubleProperty('minWidth', buttonMinWidth, defaultValue: null),
    );
