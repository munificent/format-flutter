...
class ThemeData with Diagnosticable {
  ...
  /// text geometry.
  factory ThemeData.fallback({bool? useMaterial3}) => ThemeData.light(
    useMaterial3: useMaterial3,
  );
  ...
  static ThemeData lerp(ThemeData a, ThemeData b, double t) {
    ...
    return ThemeData.raw(
      ...
      pageTransitionsTheme: t < 0.5
          ? a.pageTransitionsTheme
          : b.pageTransitionsTheme,
      ...
      // DEPRECATED (newest deprecations at the bottom)
      androidOverscrollIndicator: t < 0.5
          ? a.androidOverscrollIndicator
          : b.androidOverscrollIndicator,
...
class VisualDensity with Diagnosticable {
  ...
  static VisualDensity get adaptivePlatformDensity => defaultDensityForPlatform(
  ...
  String toStringShort() {
    return '${super.toStringShort()}(h: ${debugFormatDouble(
      horizontal,
    )}, v: ${debugFormatDouble(vertical)})';
  }
}
