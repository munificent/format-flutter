...
class ToggleButtons extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final ToggleButtonsThemeData toggleButtonsTheme = ToggleButtonsTheme.of(
      context,
    );
    final TextDirection textDirection = Directionality.of(context);

    final List<Widget>
    buttons = List<Widget>.generate(children.length, (int index) {
      ...
      final BorderSide leadingBorderSide = _getLeadingBorderSide(
        index,
        theme,
        toggleButtonsTheme,
      );
      ...
      final Color effectiveFillColor = _ResolveFillColor(
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
      ColorProperty('disabledColor', disabledColor, defaultValue: null),
    );
    ...
    properties.add(
      ColorProperty('borderColor', borderColor, defaultValue: null),
    );
    ...
    properties.add(
      DoubleProperty('borderWidth', borderWidth, defaultValue: null),
    );
    properties.add(DiagnosticsProperty<Axis>(
      'direction',
      direction,
...
class _ToggleButtonDefaultOverlay extends MaterialStateProperty<Color?> {
  ...
  String toString() {
    ...
    {
      selected:
        hovered: $hoverColor, otherwise: ${colorScheme?.primary.withOpacity(
          0.04,
        )},
        focused: $focusColor, otherwise: ${colorScheme?.primary.withOpacity(
          0.12,
        )},
        pressed: $splashColor, otherwise: ${colorScheme?.primary.withOpacity(
          0.16,
        )},
      unselected:
        hovered: $hoverColor, otherwise: ${colorScheme?.onSurface.withOpacity(
          0.04,
        )},
        focused: $focusColor, otherwise: ${colorScheme?.onSurface.withOpacity(
          0.12,
        )},
        pressed: $splashColor, otherwise: ${colorScheme?.onSurface.withOpacity(
          0.16,
        )},
      otherwise: null,
    }
...
class _SelectToggleButton extends SingleChildRenderObjectWidget {
  ...
  void updateRenderObject(
    BuildContext context,
    _SelectToggleButtonRenderObject renderObject,
  ) {
    renderObject
      ..leadingBorderSide = leadingBorderSide
      ..borderSide = borderSide
...
class _SelectToggleButtonRenderObject extends RenderShiftedBox {
  ...
  Size _computeSize({
    ...
    final BoxConstraints innerConstraints = constraints.deflate(EdgeInsets.only(
      left: leftConstraint,
      top: topConstraint,
        ...
        case TextDirection.ltr:
          if (isLastButton) {
            ...
            horizontalPaths
              ...
              ..moveTo(
                rrect.left + borderSide.width / 2.0 + rrect.tlRadiusX,
                rrect.bottom,
              )
        ...
        case TextDirection.rtl:
          if (isLastButton) {
            ...
            horizontalPaths
              ...
              ..moveTo(
                rrect.right - borderSide.width / 2.0 + rrect.trRadiusX,
                rrect.bottom,
              )
