...
class ButtonThemeData with Diagnosticable {
  ...
  Color? getFillColor(MaterialButton button) {
    final Color? fillColor = button.enabled
        ? button.color
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(EnumProperty<ButtonTextTheme>(
      'textTheme',
      textTheme,
      defaultValue: defaultTheme.textTheme,
    ));
    properties.add(
      DoubleProperty('minWidth', minWidth, defaultValue: defaultTheme.minWidth),
    );
    properties.add(
    ...
    properties.add(
      ColorProperty('buttonColor', _buttonColor, defaultValue: null),
    );
    properties.add(
      ColorProperty('disabledColor', _disabledColor, defaultValue: null),
    );
    properties.add(
      ColorProperty('focusColor', _focusColor, defaultValue: null),
    );
    properties.add(
      ColorProperty('hoverColor', _hoverColor, defaultValue: null),
    );
    properties.add(
      ColorProperty('highlightColor', _highlightColor, defaultValue: null),
    );
    properties.add(
      ColorProperty('splashColor', _splashColor, defaultValue: null),
    );
