...
class DataTableThemeData with Diagnosticable {
  ...
  static DataTableThemeData lerp(
    DataTableThemeData a,
    DataTableThemeData b,
    double t,
  ) {
    if (identical(a, b)) {
      return a;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
      DoubleProperty('dataRowMinHeight', dataRowMinHeight, defaultValue: null),
    );
    properties.add(
      DoubleProperty('dataRowMaxHeight', dataRowMaxHeight, defaultValue: null),
    );
    ...
    properties.add(
      DoubleProperty('headingRowHeight', headingRowHeight, defaultValue: null),
    );
    properties.add(DiagnosticsProperty<TextStyle>(
      'headingTextStyle',
      headingTextStyle,
    ...
    properties.add(
      DoubleProperty('horizontalMargin', horizontalMargin, defaultValue: null),
    );
    properties.add(
      DoubleProperty('columnSpacing', columnSpacing, defaultValue: null),
    );
    properties.add(
      DoubleProperty('dividerThickness', dividerThickness, defaultValue: null),
    );
