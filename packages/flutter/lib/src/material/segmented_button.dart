...
class SegmentedButton<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final ButtonStyle segmentThemeStyle = segmentStyleFor(theme.style).merge(
      segmentStyleFor(defaults.style),
    );
    ...
    Widget buttonFor(ButtonSegment<T> segment) {
      ...
      final MaterialStatesController controller = MaterialStatesController(
        <MaterialState>{if (segmentSelected) MaterialState.selected},
      );
