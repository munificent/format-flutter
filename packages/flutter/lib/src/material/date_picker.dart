...
class _DatePickerHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle? helpStyle = (themeData.headerHelpStyle ??
  ...
  Widget _buildDayItem(
    ...
    final String semanticLabelSuffix =
        DateUtils.isSameDay(widget.currentDate, dayToBuild)
            ...
            : '';
    String semanticLabel = '${localizations.formatDecimal(
      day,
    )}, ${localizations.formatFullDate(dayToBuild)}$semanticLabelSuffix';
