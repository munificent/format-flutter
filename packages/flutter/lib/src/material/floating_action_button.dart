...
class FloatingActionButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget? resolvedChild = child != null
        ? IconTheme.merge(data: IconThemeData(size: iconSize), child: child!)
        : child;
...
class _FABDefaultsM2 extends FloatingActionButtonThemeData {
    ...
    : _theme = Theme.of(context),
      ...
      super(
        ...
        smallSizeConstraints:
            const BoxConstraints.tightFor(width: 40.0, height: 40.0),
        largeSizeConstraints:
            const BoxConstraints.tightFor(width: 96.0, height: 96.0),
  ...
  @override
  TextStyle? get extendedTextStyle => _theme.textTheme.labelLarge!.copyWith(
    letterSpacing: 1.2,
  );
}
