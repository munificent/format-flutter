    ...
    return AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget? child) {
        ...
        final double scale = animation.isDismissed
            ? 0.0
            : Tween<double>(begin: .4, end: 1.0).transform(CurveTween(
  ...
  Widget build(BuildContext context) {
    return MediaQuery(
      data: MediaQuery.of(context).copyWith(
        textScaleFactor:
            clampDouble(MediaQuery.textScaleFactorOf(context), 0.0, upperLimit),
      ),
      child: child,
    );
  }
...
class _NavigationBarDefaultsM2 extends NavigationBarThemeData {
  ...
  get labelTextStyle => MaterialStatePropertyAll<TextStyle?>(
