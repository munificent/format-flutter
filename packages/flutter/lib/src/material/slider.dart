...
class _SliderState extends State<Slider> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _actionMap = <Type, Action<Intent>>{
      _AdjustSliderIntent:
          CallbackAction<_AdjustSliderIntent>(onInvoke: _actionHandler),
    };
...
class _RenderSlider extends RenderBox with RelayoutWhenSystemFontsChangeMixin {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    switch (textDirection) {
      case TextDirection.rtl:
        ...
        secondaryVisualPosition = (secondaryValue != null)
            ? (1.0 - secondaryValue)
            : null;
      case TextDirection.ltr:
  ...
  void describeSemanticsConfiguration(SemanticsConfiguration config) {
    ...
    if (semanticFormatterCallback != null) {
      ...
      config.increasedValue = '${(clampDouble(
            value + _semanticActionUnit,
            0.0,
            1.0,
          ) * 100).round()}%';
      config.decreasedValue = '${(clampDouble(
            value - _semanticActionUnit,
            0.0,
            1.0,
          ) * 100).round()}%';
...
class _SliderDefaultsM2 extends SliderThemeData {
  ...
  @override
  Color? get disabledSecondaryActiveTrackColor => _colors.onSurface.withOpacity(
    0.12,
  );
  ...
  @override
  Color? get disabledInactiveTickMarkColor => _colors.onSurface.withOpacity(
    0.12,
  );
  ...
  Color? get disabledThumbColor => Color.alphaBlend(
    _colors.onSurface.withOpacity(.38),
    _colors.surface,
  );
  ...
  @override
  TextStyle? get valueIndicatorTextStyle => Theme.of(context)
      .textTheme
      .bodyLarge!
...
class _SliderDefaultsM3 extends SliderThemeData {
  ...
  @override
  Color? get inactiveTickMarkColor => _colors.onSurfaceVariant.withOpacity(
    0.38,
  );
  ...
  @override
  Color? get overlayColor => MaterialStateColor.resolveWith(
