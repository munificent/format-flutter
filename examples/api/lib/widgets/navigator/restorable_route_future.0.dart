...
class RestorableRouteFutureExampleApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(appBar: AppBar(title: const Text('RestorableRouteFuture Example')), body: const MyHome()),
    );
  }
}
...
class _MyHomeState extends State<MyHome> with RestorationMixin {
  ...
  static Route<int> _counterRouteBuilder(BuildContext context, Object? arguments) {
    return MaterialPageRoute<int>(builder: (BuildContext context) => MyCounter(title: arguments!.toString()));
  }
