  ...
  final DecorationTween decorationTween = DecorationTween(
    begin: BoxDecoration(
      ...
      boxShadow: const <BoxShadow>[
        BoxShadow(color: Color(0x66666666), blurRadius: 10.0, spreadRadius: 3.0, offset: Offset(0, 6.0)),
      ],
    ),
    end: BoxDecoration(
      color: const Color(0xFFFFFFFF),
    ...
    return ColoredBox(
      ...
      child: Center(
        child: DecoratedBoxTransition(
          ...
          child: Container(width: 200, height: 200, padding: const EdgeInsets.all(10), child: const FlutterLogo()),
        ),
      ),
    );
  }
