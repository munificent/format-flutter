        ...
        actions: <Type, Action<Intent>>{
          HelpMenuIntent: CallbackAction<HelpMenuIntent>(
            onInvoke: (HelpMenuIntent intent) {
              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Keep calm and carry on!')));
              return null;
            },
          ),
        },
        child: const Focus(autofocus: true, child: Column(children: <Widget>[Text('Press question mark for help')])),
      ),
    );
  }
}
