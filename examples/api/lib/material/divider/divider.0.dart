...
class DividerExample extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Column(
        children: <Widget>[
          const Expanded(child: ColoredBox(color: Colors.amber, child: Center(child: Text('Above')))),
          ...
          Container(
            ...
            child: Align(
              ...
              child: Text('Subheader', style: Theme.of(context).textTheme.bodySmall, textAlign: TextAlign.start),
            ),
          ),
          Expanded(
            child: ColoredBox(color: Theme.of(context).colorScheme.primary, child: const Center(child: Text('Below'))),
          ),
        ],
      ),
    );
