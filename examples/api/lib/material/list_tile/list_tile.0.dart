...
class ListTileApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: ThemeData(listTileTheme: const ListTileThemeData(textColor: Colors.white), useMaterial3: true),
...
class _LisTileExampleState extends State<LisTileExample> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _fadeController = AnimationController(duration: const Duration(seconds: 1), vsync: this)..repeat(reverse: true);
