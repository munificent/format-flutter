  ...
  Widget build(BuildContext context) {
    ...
    Widget schemeLabel(String brightness, ColorScheme colorScheme) {
      return Padding(
        ...
        child: Text(brightness, style: TextStyle(fontWeight: FontWeight.bold, color: colorScheme.onSecondaryContainer)),
      );
    }
            ...
            child: Card(
              ...
              child: Padding(
                ...
                child: ConstrainedBox(
                  ...
                  child: ClipRRect(borderRadius: BorderRadius.circular(8.0), child: Image(image: image)),
                ),
              ),
            ),
          ),
