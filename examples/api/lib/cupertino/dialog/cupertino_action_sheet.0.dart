...
class ActionSheetApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const CupertinoApp(theme: CupertinoThemeData(brightness: Brightness.light), home: ActionSheetExample());
  }
}
...
class ActionSheetExample extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      child: Center(
        child: CupertinoButton(onPressed: () => _showActionSheet(context), child: const Text('CupertinoActionSheet')),
      ),
    );
  }
}
