...
class CupertinoTabBarApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const CupertinoApp(theme: CupertinoThemeData(brightness: Brightness.light), home: CupertinoTabBarExample());
  }
}
    ...
    return CupertinoTabScaffold(
      tabBar: CupertinoTabBar(
        items: const <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(icon: Icon(CupertinoIcons.person_alt_circle_fill), label: 'Contacts'),
