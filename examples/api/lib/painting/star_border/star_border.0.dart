...
class OptionModel extends ChangeNotifier {
  ...
  String get starCode {
    return 'Container(\n'
        ...
        '      innerRadiusRatio: ${innerRadiusRatio.toStringAsFixed(
          _kParameterPrecision,
        )},\n'
        '      pointRounding: ${pointRounding.toStringAsFixed(
          _kParameterPrecision,
        )},\n'
        '      valleyRounding: ${valleyRounding.toStringAsFixed(
          _kParameterPrecision,
        )},\n'
  ...
  String get polygonCode {
    return 'Container(\n'
        ...
        '      rotation: ${rotation.toStringAsFixed(_kParameterPrecision)},\n'
        '      cornerRounding: ${pointRounding.toStringAsFixed(
          _kParameterPrecision,
        )},\n'
        '      squash: ${squash.toStringAsFixed(_kParameterPrecision)},\n'
        '    ),\n'
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Expanded(
            flex: 5,
            child:
                Slider(onChanged: onChanged, min: min, max: max, value: value),
          ),
