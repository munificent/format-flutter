...
void main() {
  testWidgets('Enter text using the VKB', (WidgetTester tester) async {
    ...
    await tester.tap(
      find.descendant(of: find.byType(example.MyVirtualKeyboard), matching: find.widgetWithText(ElevatedButton, 'A')),
    );
    await tester.pumpAndSettle();
    expect(find.widgetWithText(TextField, 'A'), findsOneWidget);

    await tester.tap(
      find.descendant(of: find.byType(example.MyVirtualKeyboard), matching: find.widgetWithText(ElevatedButton, 'B')),
    );
    await tester.pumpAndSettle();
    ...
    await tester.tap(
      find.descendant(of: find.byType(example.MyVirtualKeyboard), matching: find.widgetWithText(ElevatedButton, 'C')),
    );
    await tester.pumpAndSettle();
