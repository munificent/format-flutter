...
void main() {
  ...
  testWidgets('Shortcuts work', (WidgetTester tester) async {
    ...
    expect(
      tester.widget<Radio<Color>>(
        find.descendant(of: find.byType(RadioMenuButton<Color>).at(0), matching: find.byType(Radio<Color>)),
      ).groupValue,
      equals(Colors.green),
    );
    expect(tester.widget<Container>(find.byType(Container)).color, equals(Colors.green));
    ...
    expect(
      tester.widget<Radio<Color>>(
        find.descendant(of: find.byType(RadioMenuButton<Color>).at(1), matching: find.byType(Radio<Color>)),
      ).groupValue,
      equals(Colors.red),
    );
    expect(tester.widget<Container>(find.byType(Container)).color, equals(Colors.red));
    ...
    expect(
      tester.widget<Radio<Color>>(
        find.descendant(of: find.byType(RadioMenuButton<Color>).at(2), matching: find.byType(Radio<Color>)),
      ).groupValue,
      equals(Colors.blue),
    );
