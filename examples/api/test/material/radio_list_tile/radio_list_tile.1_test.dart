...
void main() {
  ...
  testWidgets('Radios can be checked', (WidgetTester tester) async {
    ...
    expect(tester.widget<RadioListTile<example.Groceries>>(radioListTile.at(0)).groupValue, example.Groceries.pickles);
    expect(tester.widget<RadioListTile<example.Groceries>>(radioListTile.at(1)).groupValue, example.Groceries.pickles);
    expect(tester.widget<RadioListTile<example.Groceries>>(radioListTile.at(2)).groupValue, example.Groceries.pickles);
    ...
    expect(tester.widget<RadioListTile<example.Groceries>>(radioListTile.at(0)).groupValue, example.Groceries.tomato);
    expect(tester.widget<RadioListTile<example.Groceries>>(radioListTile.at(1)).groupValue, example.Groceries.tomato);
    expect(tester.widget<RadioListTile<example.Groceries>>(radioListTile.at(2)).groupValue, example.Groceries.tomato);
    ...
    expect(tester.widget<RadioListTile<example.Groceries>>(radioListTile.at(0)).groupValue, example.Groceries.lettuce);
    expect(tester.widget<RadioListTile<example.Groceries>>(radioListTile.at(1)).groupValue, example.Groceries.lettuce);
    expect(tester.widget<RadioListTile<example.Groceries>>(radioListTile.at(2)).groupValue, example.Groceries.lettuce);
  });
}
