...
void main() {
  ...
  Future<void> showMagnifier(
    WidgetTester tester,
    String characterToTapOn,
  ) async {
    final Offset tapOffset = _textOffsetToPosition(
      tester,
      defaultText.indexOf(characterToTapOn),
    );
    ...
    final TextSelection selection = tester.firstWidget<TextField>(
  ...
  for (final TextDirection textDirection in TextDirection.values) {
    testWidgets('should show custom magnifier in $textDirection', (
      ...
      final String text = textDirection == TextDirection.rtl
          ? 'أثارت زر'
          : defaultText;
