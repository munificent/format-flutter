...
import 'package:flutter_api_samples/widgets/scroll_position/scroll_controller_on_attach.0.dart' as example;
...
void main() {
  testWidgets('Can toggle between scroll notification types', (WidgetTester tester) async {
    ...
    appBarMaterial = tester.widget<Material>(find.descendant(of: find.byType(AppBar), matching: find.byType(Material)));
