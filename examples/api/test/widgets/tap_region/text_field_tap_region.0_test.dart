...
void main() {
  ...
  testWidgets('tapping increment/decrement works', (WidgetTester tester) async {
    ...
    expect(getFieldValue(tester).selection, equals(const TextSelection(baseOffset: 0, extentOffset: 1)));
    ...
    expect(getFieldValue(tester).text, equals('-1'));
    expect(getFieldValue(tester).selection, equals(const TextSelection(baseOffset: 0, extentOffset: 2)));
  });
  ...
  testWidgets('entering text and then incrementing/decrementing works', (WidgetTester tester) async {
    ...
    expect(getFieldValue(tester).selection, equals(const TextSelection(baseOffset: 0, extentOffset: 3)));
    final FocusNode textFieldFocusNode = Focus.of(tester.element(find.byWidgetPredicate((Widget widget) {
