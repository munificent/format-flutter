...
void main() {
  ...
  testWidgets('gradient matches golden', (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
      ...
      home: const SizedBox(width: 800, height: 600, child: RepaintBoundary(child: example.MoodyGradient())),
    ));
    await expectLater(find.byType(example.MoodyGradient), matchesGoldenFile('linear_gradient.0_test.png'));
  });
}
