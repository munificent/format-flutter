...
void main() {
  ...
  void addAlignmentRow(CrossAxisAlignment crossAxisAlignment) {
    ...
    row.add(RenderDecoratedBox(
      ...
      child: RenderParagraph(TextSpan(style: style, text: 'foo foo foo'), textDirection: TextDirection.ltr),
    ));
    ...
    subrow.add(RenderDecoratedBox(
      ...
      child: RenderParagraph(TextSpan(style: style, text: 'foo foo foo foo'), textDirection: TextDirection.ltr),
    ));
