...
class SectorAppState extends State<SectorApp> {
  ...
  void doUpdates() {
    ...
    while (index < wantedSectorSizes.length) {
      final Color color = Color(
        ((0xFF << 24) + rand.nextInt(0xFFFFFF)) | 0x808080,
      );
      ring.add(
  ...
  RenderBoxToRenderSectorAdapter sectorAddIcon = initSector(
    const Color(0xFF00DD00),
  );
  RenderBoxToRenderSectorAdapter sectorRemoveIcon = initSector(
